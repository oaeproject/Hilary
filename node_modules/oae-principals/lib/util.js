...
const Config = require('oae-config').config('oae-principals');
 ...
 */
const getPrincipal = module.exports.getPrincipal = function(ctx, principalId, callback) {
 ...
 */
const touchLastModified = module.exports.touchLastModified = function(oldPrincipal, callback) {
 ...
 */
const verifyEmailAddress = module.exports.verifyEmailAddress = function(ctx, user, email, callback) {
 ...
 */
const createGroupId = module.exports.createGroupId = function(tenantAlias) {
 ...
 */
const isUser = module.exports.isUser = function(userId) {
 ...
 * @api private
 */
const hideUserData = module.exports.hideUserData = function(ctx, user) {
 ...
 */
const createUpdatedUser = module.exports.createUpdatedUser = function(user, fieldUpdates) {
 ...
 */
const createPersistentUserActivityEntity = module.exports.createPersistentUserActivityEntity = function(userId, user) {
 ...
 */
const transformPersistentUserActivityEntity = module.exports.transformPersistentUserActivityEntity = function(ctx, userId, user) {
 ...
 */
const transformPersistentUserActivityEntityToInternal = module.exports.transformPersistentUserActivityEntityToInternal = function(ctx, userId, user) {
    if (user) {
        // Signed user profile picture URLs will last forever
        hideUserData(ctx, user);
        _generatePictureURLs(ctx, user, -1);
 ...
 */
const createPersistentGroupActivityEntity = module.exports.createPersistentGroupActivityEntity = function(groupId, group) {
 ...
 */
const transformPersistentGroupActivityEntity = module.exports.transformPersistentGroupActivityEntity = function(ctx, groupId, group) {
    const tenant = ctx.tenant();
    const baseUrl = TenantsUtil.getBaseUrl(tenant);
 ...
 */
const transformPersistentGroupActivityEntityToInternal = module.exports.transformPersistentGroupActivityEntityToInternal = function(ctx, groupId, group) {
    if (group) {
        // Signed group picture URLs will last forever
        _generatePictureURLs(ctx, group, -1);
        return group;
