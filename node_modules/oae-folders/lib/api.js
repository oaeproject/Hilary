...
var createFolder = module.exports.createFolder = function(ctx, displayName, description, visibility, members, callback) {
    ...
    PrincipalsAPI.getOrCreateGuestUsers(ctx, _.keys(members), function(err, principalIds) {
        if (err) {
            return callback(err);
        }
        ...
        var memberIds = _.values(principalIds);
        PrincipalsDAO.getPrincipals(memberIds, null, function(err, principals) {
            ...
            AuthzAPI.canInteract(ctx, ctx.tenant().alias, principals, function(err, canInteract, illegalPrincipalIds) {
                ...
                var managerIds = _.filter(memberIds, function(principalId) {
