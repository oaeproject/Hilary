                                            ...
                                            RestAPI.Authentication.existsOnTenant(globalAdminRestContext, global.oaeTests.tenants.cam.alias, username, function(err) {
                                                ...
                                                RestAPI.Authentication.existsOnTenant(globalAdminRestContext, global.oaeTests.tenants.cam.alias, username.toLowerCase(), function(err) {
                                                    ...
                                                    RestAPI.Authentication.existsOnTenant(globalAdminRestContext, global.oaeTests.tenants.cam.alias, username.toUpperCase(), function(err) {
                                                        ...
                                                        // Verify that the username is still available on different tenants
                                                        RestAPI.Authentication.existsOnTenant(anonymousCamRestContext, global.oaeTests.tenants.gt.alias, username, function(err) {
                                                            assert.equal(err.code, 404);
    ...
    describe('#createUser', function() {
        ...
        it('verify creating a user fails if the local login id is already taken', function(callback) {
            ...
            AuthenticationAPI.createUser(ctx, loginId, 'Branden Visser', undefined, function(err, userObj) {
                ...
                // Try and create a new user with the same login id
                AuthenticationAPI.createUser(ctx, loginId, 'Evil Branden Visser', undefined, function(err, userObj) {
                    assert.ok(err);
                    assert.equal(err.code, 400);
                    return callback();
                });
                            ...
                            RestAPI.Authentication.login(testGlobalUserRestContext, userId1, userId1, function(err) {
                                ...
                                RestAPI.User.getMe(testGlobalUserRestContext, function(err, me) {
                                    ...
                                    RestAPI.Authentication.createGlobalAdminUser(globalAdminRestContext, userId1, userId1, userId1, function(err, user) {
                                        ...
                                        RestAPI.Authentication.createGlobalAdminUser(globalAdminRestContext, userId1, userId1, userId1, function(err, secondUser) {
                                            assert.ok(err);
                                            assert.equal(err.code, 400);
