 ...
 */
const Cleaner = module.exports = new EmitterAPI.EventEmitter();
 ...
 */
const start = module.exports.start = function(directory, interval) {
 ...
 */
const stop = module.exports.stop = function(directory) {
