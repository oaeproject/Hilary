...
describe('Folders', function() {
  ...
  var _setup = function(visibility, callback) {
    FoldersTestUtil.setupMultiTenantPrivacyEntities(function(
      ...
      TestsUtil.generateTestUsers(publicTenant1.adminRestContext, 1, function(
        err,
        users,
        simong,
      ) {
  ...
  describe('Searching in folders', function() {
    ...
    it('verify folders are searchable', function(callback) {
      TestsUtil.generateTestUsers(camAdminRestContext, 1, function(
        ...
        FoldersTestUtil.generateTestFolders(simong.restContext, 2, function(
          folder1,
          folder2,
        ) {
  ...
  describe('Searching for folders', function() {
    ...
    it('verify folder search results can contain a thumbnail', function(callback) {
      _setup('public', function(
        ...
        FoldersDAO.setPreviews(
          folder,
          {
            thumbnailUri: 'local:f/cam/bla/thumbnail.png',
            wideUri: 'local:f/cam/bla/wideUri',
          },
          function(err, folder) {
            assert.ok(!err);
    ...
    it('verify folders can be searched by messages', function(callback) {
      TestsUtil.generateTestUsers(camAdminRestContext, 1, function(
        ...
        FoldersTestUtil.generateTestFolders(simong.restContext, 20, function(
          folder1,
          folder2,
        ) {
                  ...
                  function() {
                    ...
                    SearchTestsUtil.searchAll(
                      ...
                      function(err, results) {
                        assert.ok(!err);
                        assert.ok(
                          _.findWhere(results.results, { id: folder.id }),
                        );
                      ...
                      function() {
                        ...
                        SearchTestsUtil.searchAll(
                          ...
                          function(err, results) {
                            assert.ok(!err);
                            assert.ok(
                              !_.findWhere(results.results, { id: link1.id }),
                            );
                            assert.ok(
                              !_.findWhere(results.results, { id: link2.id }),
                            );
