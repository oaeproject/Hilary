 ...
 * @FormParam   {string[]}      managers            Unique identifier(s) for manager(s) of the discussion (user creating discussion is always a manager)
 ...
 * @Return      {Discussion}                        The discussion object
 */
 ...
 * @FormParam   {string}        discussionId        Unique identifier for discusion to update
 * @FormParam   {string}        [description]       Description of discussion
 * @FormParam   {string}        [displayName]       Name to display for discussion
 * @FormParam   {string}        [visibility]        Visibility for discussion           [loggedin,private,public]
 * @Return      {Discussion}                        The discussion object
 ...
 * @Return      {DiscussionsLibrary}                        User's followers
 */
 ...
 * @Return      {DiscussionDetails}                         Detailed discussion profile
 */
