 ...
 * @Method      POST
 * @Path        /group/create
 * @BodyParam   {NewGroup}          body            Information about the group to create
 * @Return      {Group}                             Returns an object representing the new group
 */
 ...
 * @Return      {Group}                             Returns an object representing the group
 */
 ...
 * @BodyParam   {Group}         body                Updated profile for group
 * @Return      {Group}                             Returns an object representing the updated group
 */
 ...
 * @Return      {MembersResponse}                   Returns an object containing members of group
 */
 ...
 * @BodyParam   {Membership}    body                List of users to be added or removed from group
 */
 ...
 * @Return      {Group}                             Returns an object representing the profile of the group
 */
