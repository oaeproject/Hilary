...
var joinPad = module.exports.joinPad = function(ctx, contentId, padId, groupId, callback) {
    ...
    client.createAuthorIfNotExistsFor(args, function(err, author) {
        ...
        client.createSession(session, function(err, data) {
            ...
            // Construct the URL
            var url = getPadUrl(contentId, padId, data.sessionID, language, author.authorID, ctx.user().id);
 ...
 */
var getPadUrl = module.exports.getPadUrl = function(contentId, padId, sessionId, language, authorId, userId) {
