 ...
 *
 * @param  {User}       [user]                  The user for which to check access. If unspecified, indicates an anonymous user
 * @param  {Resource}   resource                The resource against which to check for access
 * @param  {String[]}   rolesPriority           An array of roles expressing the ordering of roles in order of least powerful to most powerful
 * @param  {Function}   callback                Standard callback function
 * @param  {Object}     callback.err            An error that occurred, if any
...
var resolveImplicitRole = module.exports.resolveImplicitRole = function(principal, resource, rolesPriority, callback) {
    if (principal && _.isFunction(principal.user)) {
        throw new Error('Needs to be updated to pass in user instead of ctx');
    }
    ...
    if (!principal) {
        ...
        if (resource.visibility === AuthzConstants.visibility.PUBLIC) {
            ...
            if (AuthzUtil.isUserId(principal.id) && resource.joinable === AuthzConstants.joinable.YES && tenantsCanInteract) {
                ...
                return callback(null, _.first(rolesPriority), tenantsCanInteract);
            } else if (resource.visibility === AuthzConstants.visibility.LOGGEDIN
