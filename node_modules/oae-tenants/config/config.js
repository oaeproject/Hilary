...
module.exports = {
    ...
    'domains': {
        'name': 'Tenant Specific domains',
        'description': 'Domains that belong to this tenant',
        'elements': {
            'email': new Fields.Text('Email domain regex', 'A regex that identifies email domains that are associated with a tenant', '', {'tenantOverride': false, 'suppress': true, 'globalAdminOnly': true})
        }
    }
};
