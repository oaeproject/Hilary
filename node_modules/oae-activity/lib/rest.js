 ...
 * @Return      {ActivityStream}                        Returns an object containing activity stream
 */
 ...
 * @PathParam   {string}            activityStreamId    Unique identifier for user/group whose activity stream is requested
 * @QueryParam  {string}            [format]            Desired format (defaults to activitystreams) [activitystreams,internal]
 * @QueryParam  {number}            [limit]             Maximum number of activities to return (defaults to 10, maximum of 25)
 * @QueryParam  {number}            [start]             Activity at which to start (defaults to 0)
 * @Return      {ActivityStream}                        Returns an object containing activity stream
 ...
 * @Return      {NotificationsRead}                     Returns an object of notifications read information
 */
