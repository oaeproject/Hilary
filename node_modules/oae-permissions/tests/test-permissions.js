...
describe('Permissions', function() {
    ...
    it('should verify that permissions check are negative when no permissions are obviously available', function(callback) {
    ...
    it('should verify that direct role assignments result in affirmative permissions checks', function(callback) {
    ...
    it('should ensure that permissions are properly propagated in a group hierarchy', function(callback) {
    ...
    it('should ensure that when a role is removed from a principal, the permissions are properly cleared', function(callback) {
    ...
    //
    it('should verify that aggregating multiple permissions for a resource VIA group hierarchy works properly', function(callback) {
    ...
    it('should verify that getting all directly granted permissions for a principal works properly', function(callback) {
    ...
    it('should verify that getting all indirectly granted permissions for a principal works properly', function(callback) {
        var tenantId = 'testGetAllPermissions-'+new Date().getMilliseconds();
        var tenant = new Tenant(tenantId, 'Cambridge', 'Description', 2001);
        var anonymousContext = new Context(tenant, null);
        var mrvisserUuid = roles.util.toUuid('u', tenantId, 'mrvisser');
