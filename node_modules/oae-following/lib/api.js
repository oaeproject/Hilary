 ...
 */
var FollowingAPI = module.exports = new EmitterAPI.EventEmitter();
...
var getFollowers = module.exports.getFollowers = function(ctx, userId, start, limit, callback) {
    ...
    PrincipalsDAO.getPrincipal(userId, function(err, user) {
        ...
        FollowingAuthz.canViewFollowers(ctx, user, function(err) {
            if (err) {
                return callback(err);
            }
            ...
            FollowingDAO.getFollowers(userId, start, limit, function(err, followerUserIds, nextToken) {
                ...
                AuthzUtil.filterDeletedIds(followerUserIds, function(err, followerUserIds) {
                    if (err) {
                        return callback(err);
                    }
                    ...
                    _expandUserIds(ctx, followerUserIds, function(err, users) {
                        ...
                        FollowingAPI.emit(FollowingConstants.events.GET_FOLLOWERS, ctx, userId, start, limit, users, function(err) {
                            if (err) {
                                return callback(err);
                            }
...
var getFollowing = module.exports.getFollowing = function(ctx, userId, start, limit, callback) {
    ...
    PrincipalsDAO.getPrincipal(userId, function(err, user) {
        ...
        FollowingAuthz.canViewFollowing(ctx, user, function(err) {
            if (err) {
                return callback(err);
            }
            ...
            FollowingDAO.getFollowing(userId, start, limit, function(err, followingUserIds, nextToken) {
                ...
                AuthzUtil.filterDeletedIds(followingUserIds, function(err, followingUserIds) {
                    if (err) {
                        return callback(err);
                    }
                    ...
                    _expandUserIds(ctx, followingUserIds, function(err, users) {
                        ...
                        FollowingAPI.emit(FollowingConstants.events.GET_FOLLOWING, ctx, userId, start, limit, users, function(err) {
                            if (err) {
                                return callback(err);
                            }
...
var follow = module.exports.follow = function(ctx, followedUserId, callback) {
    ...
    PrincipalsDAO.getPrincipal(followedUserId, function(err, followedUser) {
        ...
        FollowingAuthz.canFollow(ctx, followedUser, function(err) {
            if (err) {
                return callback(err);
            }

            FollowingDAO.isFollowing(ctx.user().id, [followedUserId], function(err, following) {
                if (err) {
                    return callback(err);
                } else if (following[followedUserId]) {
 ...
 * @api private
 */
 var deleteFollowing = module.exports.deleteFollowing = function(ctx, user, callback) {
 ...
 * @api private
 */
var deleteFollowers = module.exports.deleteFollowers = function(ctx, user, callback) {
