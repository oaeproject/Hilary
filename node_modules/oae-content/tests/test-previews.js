  ...
  it('verify downloading preview of a restored revision', function(callback) {
    createPreviews(function(contexts, content, previews) {
      ...
      RestAPI.Content.getPreviewItems(
        ...
        content.id,
        firstRevisionId,
        function(err, firstRevisionPreviews) {
          assert.ok(!err);
                  ...
                  RestAPI.Content.restoreRevision(
                    ...
                    function(err, revision3) {
                      ...
                      RestAPI.Content.getPreviewItems(
                        ...
                        function(err, thirdRevisionPreviews) {
                          assert.ok(!err);
                          assert.strictEqual(
                          ...
                          var firstRevisionMediumPicture = _.filter(
                            firstRevisionPreviews.files,
                            function(file) {
                              return file.size === 'medium';
                            }
                          )[0];
                          var thirdRevisionMediumPicture = _.filter(
    ...
    TestsUtil.generateTestUsers(globalAdminOnTenantRestContext, 1, function(err, users) {
      ...
      RestAPI.Content.createFile(
        ...
        function(err, contentObj) {
          ...
          RestAPI.Content.getRevisions(simon.restContext, contentObj.id, null, 1, function(
            err,
            revisions
          ) {
            assert.ok(!err);
            ...
            function(err, revisions) {
              ...
              RestAPI.Content.setPreviewItems(
                ...
                function(err) {
                  ...
                  RestAPI.Content.getContent(simon.restContext, contentObj.id, function(
                    err,
                    updatedContentObj
                  ) {
                    assert.ok(!err);
          ...
          function(err) {
            ...
            ActivityTestsUtil.collectAndGetActivityStream(
              ...
              function(err, activityStream) {
                ...
                var activity = _.find(activityStream.items, function(activity) {
                ...
                _verifySignedDownloadUrl(bert.restContext, activity.object.image.url, function() {
                  ...
                  RestAPI.Content.getContent(bert.restContext, contentObj.id, function(
                    err,
                    contentObjOnCamTenant
                  ) {
                    assert.ok(!err);
                          ...
                          function(err, updatedContentObj) {
                            ...
                            SearchTestsUtil.searchAll(
                              ...
                              function(err, results) {
                                assert.ok(!err);
                                var doc = _.find(results.results, function(doc) {
          ...
          RestAPI.Content.setPreviewItems(
            ...
            function(err) {
              ...
              SearchTestsUtil.searchAll(
                ...
                function(err, results) {
                  assert.ok(!err);
                  var contentDocA = _.find(results.results, function(result) {
                      ...
                      RestAPI.Content.restoreRevision(
                        ...
                        function(err, revisionObj) {
                          ...
                          SearchTestsUtil.searchAll(
                            ...
                            function(err, results) {
                              assert.ok(!err);
                              var contentDocB = _.find(results.results, function(result) {
                                return result.id === contentObj.id;
                              });
