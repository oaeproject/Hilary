...
describe('File previews', function() {
     ...
     */
    it('verify uploading new preview items removes older preview items and the thumbnailUrl', function(callback) {
        createPreviews(function(contexts, contentObj, previews) {
     ...
     * @param  {Function}       callback        Standard callback function
     */
    var _verifySignedDownloadUrl = function(restContext, downloadUrl, callback) {
    ...
    it('verify previews are downloadable from another tenant', function(callback) {
        ...
        createPreviews(function(contexts, contentObj, previews) {
            ...
            TestsUtil.generateTestUsers(camAdminRestContext, 1, function(err, users) {
                ...
                RestAPI.Content.shareContent(contexts['nicolaas'].restContext, contentObj.id, [bert.user.id], ContentConstants.roles.VIEWER, function(err) {
                    assert.ok(!err);
                    ...
                    ActivityTestsUtil.collectAndGetActivityStream(bert.restContext, bert.user.id, null, function(err, activityStream) {
                        ...
                        // Verify the activity
                        _verifySignedDownloadUrl(bert.restContext, activity.object.image.url, function() {
                            ...
                            RestAPI.Content.getContent(bert.restContext, contentObj.id, function(err, contentObjOnCamTenant) {
                                ...
                                _verifySignedDownloadUrl(bert.restContext, contentObjOnCamTenant.previews.thumbnailUrl, function() {
