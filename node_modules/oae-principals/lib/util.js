...
var rowToUser = function(row) {
    ...
    var user = new User(hash.tenant, hash.principal_id, hash.user_username, hash.visibility, hash.locale, timezone, hash.user_first_name, hash.user_last_name, hash.user_display_name, isGlobalAdmin, isTenantAdmin);
