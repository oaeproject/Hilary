...
describe('Users', function() {
    ...
    describe('Create user', function() {
        ...
        /**
         * Test that verifies when a user is created without a visibility, the visibility becomes the tenant default
         */
        it('verify user visibility defaults to the tenant default when created', function(callback) {
            ...
            // Ensure the tenant default is public to start
            RestAPI.User.createUser(camAdminRestContext, TestsUtil.generateTestUserId(), 'password', 'Test User', null, function(err, createdUser) {
                assert.ok(!err);
                assert.equal(createdUser.visibility, 'public');

                // Change the tenant default to loggedin
                ConfigTestUtil.updateConfigAndWait(globalAdminRestContext, camTenantAlias, {'oae-principals/user/visibility': 'loggedin'}, function(err) {
                    ...
                    // Create a user with the default visibility
                    RestAPI.User.createUser(camAdminRestContext, TestsUtil.generateTestUserId(), 'password', 'Test User', null, function(err, createdUser) {
                        assert.ok(!err);
                        assert.equal(createdUser.visibility, 'loggedin');

                        // Change the tenant default back to public
                        ConfigTestUtil.updateConfigAndWait(globalAdminRestContext, camTenantAlias, {'oae-principals/user/visibility': 'public'}, function(err) {
                            assert.ok(!err);

                            // Ensure visibility can be overridden on create
                            RestAPI.User.createUser(camAdminRestContext, TestsUtil.generateTestUserId(), 'password', 'Test User', {'visibility': 'private'}, function(err, createdUser) {
                                assert.ok(!err);
    ...
    describe('Import users', function() {
        ...
        /**
         * Returns a function that gets a stream to a file in the 'data' directory of
         * the current test directory
         *
         * @param  {String}     filename    The name of the file that exists inside the data directory
         * @return {Stream}                 A stream to the file with the provided name
         */
        ...
        it('verify import local users respects default user visibility of the tenant', function(callback) {
            ...
            // Create a user to test that the tenant default visibility for users is public
            PrincipalsTestsUtil.importUsers(globalAdminRestContext, camTenantAlias, getDataFileStream('users-default-visibility-test1.csv'), 'local', null, function(err) {
                assert.ok(!err);

                // Ensure the tenant default is currently public
                var mrvisser1RestContext = TestsUtil.createTenantRestContext(global.oaeTests.tenants.cam.host, 'userdefaultvisibilitytest1', 'password');
                RestAPI.User.getMe(mrvisser1RestContext, function(err, createdUser) {
                    ...
                    ConfigTestUtil.updateConfigAndWait(globalAdminRestContext, camTenantAlias, {'oae-principals/user/visibility': 'loggedin'}, function(err) {
                        ...
                        // Create a user with the default visibility
                        PrincipalsTestsUtil.importUsers(globalAdminRestContext, camTenantAlias, getDataFileStream('users-default-visibility-test2.csv'), 'local', null, function(err) {
                            assert.ok(!err);

                            // Ensure the tenant default is currently public
                            var mrvisser2RestContext = TestsUtil.createTenantRestContext(global.oaeTests.tenants.cam.host, 'userdefaultvisibilitytest2', 'password');
        ...
        it('verify import local users and display name override', function(callback) {
            ...
            PrincipalsTestsUtil.importUsers(globalAdminRestContext, global.oaeTests.tenants.cam.alias, getDataFileStream('users-with-password.csv'), 'local', null, function(err) {
                assert.ok(!err);
                 ...
                 */
                var _verifyUser = function(err, meObj, expectedDisplayName, expectedEmail) {
                    assert.ok(!err);
                    assert.ok(meObj);
                ...
                RestAPI.User.getMe(nicolaasRestContext, function(err, nicolaasMeObj) {
                    ...
                    RestAPI.User.getMe(simonRestContext, function(err, simonMeObj) {
                        _verifyUser(err, simonMeObj, 'Gaeremynck', 'simon@test.com');
                        ...
                        RestAPI.User.getMe(stuartRestContext, function(err, stuartMeObj) {
                            _verifyUser(err, stuartMeObj, 'Stuart D. Freeman', 'stuart@test.com');

                            // Last user in the csv
                            var stephenRestContext = TestsUtil.createTenantRestContext(global.oaeTests.tenants.cam.host, 'user-bbLwAWxpd', 'password26');
                            RestAPI.User.getMe(stephenRestContext, function(err, stephenMeObj) {
                                _verifyUser(err, stephenMeObj, 'Stephen Thomas', 'stephen@test.com');
                                ...
                                RestAPI.User.updateUser(nicolaasRestContext, nicolaasMeObj.id, {'displayName': 'user-zfdHliPLa'}, function (err, user) {
                                    ...
                                    RestAPI.User.getMe(nicolaasRestContext, function(err, nicolaasMeObj) {
                                        _verifyUser(err, nicolaasMeObj, 'user-zfdHliPLa', 'nicolaas@test.com');
                                        ...
                                        PrincipalsTestsUtil.importUsers(camAdminRestContext, null, getDataFileStream('users-with-password.csv'), 'local', null, function(err) {
                                            assert.ok(!err);
                                            ...
                                            RestAPI.User.getMe(nicolaasRestContext, function(err, nicolaasMeObj) {
                                                ...
                                                RestAPI.User.updateUser(nicolaasRestContext, nicolaasMeObj.id, {'displayName': 'N. Matthijs'}, function (err, user) {
                                                    ...
                                                    // Verify that the update is reflected in the me feed
                                                    RestAPI.User.getMe(nicolaasRestContext, function(err, nicolaasMeObj) {
                                                        _verifyUser(err, nicolaasMeObj, 'N. Matthijs', 'nicolaas@test.com');
                                                        ...
                                                        PrincipalsTestsUtil.importUsers(camAdminRestContext, null, getDataFileStream('users-with-password.csv'), 'local', null, function(err) {
                                                            ...
                                                            RestAPI.User.getMe(nicolaasRestContext, function(err, nicolaasMeObj) {
                                                                ...
                                                                PrincipalsTestsUtil.importUsers(camAdminRestContext, null, getDataFileStream('users-with-password.csv'), 'local', true, function(err) {
                                                                    assert.ok(!err);
        ...
        it('verify import external users', function(callback) {
            ...
            PrincipalsTestsUtil.importUsers(globalAdminRestContext, global.oaeTests.tenants.cam.alias, getDataFileStream('users-without-password.csv'), 'cas', null, function(err) {
                assert.ok(!err);
                                                ...
                                                RestAPI.User.getUser(camAdminRestContext, stuartUserId, function(err, stuartUserObj) {
                                                    ...
                                                    RestAPI.User.updateUser(camAdminRestContext, nicolaasUserId, {'displayName': 'user-TGdDSdadW'}, function (err, user) {
                                                        ...
                                                        RestAPI.User.getUser(camAdminRestContext, nicolaasUserId, function(err, nicolaasUserObj) {
                                                            ...
                                                            // Re-import the users to verify that the displayName is reverted back to the display name
                                                            // provided in the CSV file. This time, the import is attempted as a tenant admin
                                                            PrincipalsTestsUtil.importUsers(camAdminRestContext, null, getDataFileStream('users-without-password.csv'), 'cas', null, function(err) {
                                                                assert.ok(!err);
                                                                        ...
                                                                        RestAPI.User.getUser(camAdminRestContext, nicolaasUserId, function(err, nicolaasUserObj) {
                                                                            ...
                                                                            PrincipalsTestsUtil.importUsers(camAdminRestContext, null, getDataFileStream('users-without-password.csv'), 'cas', null, function(err) {
                                                                                ...
                                                                                RestAPI.User.getUser(camAdminRestContext, nicolaasUserId, function(err, nicolaasUserObj) {
                                                                                    ...
                                                                                    // Re-import the users using the `forceProfileUpdate` flag to verify that the displayName is reverted to
                                                                                    // the display name provided in the CSV file
                                                                                    PrincipalsTestsUtil.importUsers(camAdminRestContext, null, getDataFileStream('users-without-password.csv'), 'cas', true, function(err) {
                                                                                        assert.ok(!err);
        ...
        it('verify parameter validation', function(callback) {
            ...
            PrincipalsTestsUtil.importUsers(globalAdminRestContext, 'foobar', getDataFileStream('users-without-password.csv'), 'cas', null, function(err) {
                assert.ok(err);
                assert.ok(err.code, 400);

                // Verify that an authentication method is required
                PrincipalsTestsUtil.importUsers(globalAdminRestContext, global.oaeTests.tenants.cam.alias, getDataFileStream('users-without-password.csv'), null, null, function(err) {
                    assert.ok(err);
                    assert.ok(err.code, 400);

                    // Verify that an existing authentication method is required
                    PrincipalsTestsUtil.importUsers(globalAdminRestContext, global.oaeTests.tenants.cam.alias, getDataFileStream('users-without-password.csv'), 'foobar', null, function(err) {
                        assert.ok(err);
                        assert.ok(err.code, 400);

                        // Verify that a CSV file is required
                        PrincipalsTestsUtil.importUsers(globalAdminRestContext, global.oaeTests.tenants.cam.alias, null, 'cas', null, function(err) {
                            assert.ok(err);
                            assert.ok(err.code, 400);
                            callback();
                        });
        ...
        it('verify only admins can import users', function(callback) {
            ...
            PrincipalsTestsUtil.importUsers(anonymousGlobalRestContext, global.oaeTests.tenants.cam.alias, getDataFileStream('users-without-password.csv'), 'cas', null, function(err) {
                assert.ok(err);
                assert.ok(err.code, 401);

                // Verify that an anonymous user on a user tenant cannot import users
                PrincipalsTestsUtil.importUsers(anonymousRestContext, null, getDataFileStream('users-without-password.csv'), 'cas', null, function(err) {
                    assert.ok(err);
                    assert.ok(err.code, 401);
                    ...
                    RestAPI.User.createUser(camAdminRestContext, userId, 'password', 'Test User', {'visibility': 'public'}, function(err, createdUser) {
                        ...
                        PrincipalsTestsUtil.importUsers(userRestContext, null, getDataFileStream('users-without-password.csv'), 'cas', null, function(err) {
                            assert.ok(err);
                            assert.ok(err.code, 401);
                            callback();
                        });
