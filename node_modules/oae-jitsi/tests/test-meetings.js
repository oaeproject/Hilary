              ...
              function(err, meeting) {
                ...
                RestAPI.MeetingsJitsi.getMembers(
                  ...
                  function(err, members) {
                    ...
                    var memberIds = _.pluck(
                      _.pluck(members.results, 'profile'),
                      'id',
                    );
      ...
      TestsUtil.generateTestUsers(camAdminRestCtx, 3, function(err, user) {
        ...
        RestAPI.MeetingsJitsi.createMeeting(
          ...
          function(err, meeting) {
            ...
            // Delete the meeting
            RestAPI.MeetingsJitsi.deleteMeeting(
              riri.restContext,
              meeting.id,
              function(err) {
                assert.ok(!err);
