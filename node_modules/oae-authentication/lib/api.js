...
strategySetup[AuthenticationConstants.providers.GOOGLE] = function(tenant, strategyId) {
    ...
    var strategy = new GoogleStrategy({
        ...
        'callbackURL': 'http://' + tenant.host + '/api/auth/google/callback'
        ...
        if (profile['_json'].picture) {
            opts.smallPictureUri = 'remote:' + profile['_json'].picture;
            opts.mediumPictureUri = 'remote:' + profile['_json'].picture;
        }
...
strategySetup[AuthenticationConstants.providers.TWITTER] = function(tenant, strategyId) {
    ...
    var strategy = new TwitterStrategy({
        ...
        if (profile['_json']['profile_image_url_https']) {
            opts.smallPictureUri = 'remote:' + profile['_json']['profile_image_url_https'];
            opts.mediumPictureUri = 'remote:' + profile['_json']['profile_image_url_https'];
        }
