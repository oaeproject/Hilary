...
module.exports = {
    ...
    'cas': {
        ...
        'elements': {
            ...
            'basepath': new Fields.Text('Base path', 'The base path on the CAS authentication server. e.g.,: /cas', '/cas', {'valueVisibility': 'private'}),
            ...
            'mapTimezone': new Fields.Text('Timezone', 'The attibute(s) that should be used to construct the timezone. e.g., <%= timezone %>', '', {'valueVisibility': 'private'})
        }
    },
    'ldap': {
