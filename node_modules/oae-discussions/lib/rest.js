 ...
 */
OAE.tenantServer.post('/api/discussion/create', function(req, res) {
    req.telemetryUrl = '/api/discussion/create';
 ...
 * Update a discussion
 */
OAE.tenantServer.post('/api/discussion/:discussionId', function(req, res) {
    req.telemetryUrl = '/api/discussion/id';
 ...
 * Delete a discussion
 */
OAE.tenantServer.del('/api/discussion/:discussionId', function(req, res) {
    req.telemetryUrl = '/api/discussion/id/messages/created';
 ...
 */
OAE.tenantServer.get('/api/discussion/library/:principalId', function(req, res) {
    req.telemetryUrl = '/api/discussion/library/principalId';
 ...
 */
OAE.tenantServer.post('/api/discussion/library/:principalId/:discussionId', function(req, res) {
    req.telemetryUrl = '/api/discussion/library/principalId/id';
 ...
 */
OAE.tenantServer.get('/api/discussion/:discussionId', function(req, res) {
    req.telemetryUrl = '/api/discussion/id';
 ...
 * Share a discussion
 */
OAE.tenantServer.post('/api/discussion/:discussionId/share', function(req, res) {
    req.telemetryUrl = '/api/discussion/id/share';
 ...
 */
OAE.tenantServer.post('/api/discussion/:discussionId/members', function(req, res) {
    req.telemetryUrl = '/api/discussion/id/members';
 ...
 */
OAE.tenantServer.get('/api/discussion/:discussionId/members', function(req, res) {
    req.telemetryUrl = '/api/discussion/id/members';
    var limit = Util.getNumberParam(req.query.limit, 10, 1, 25);
    DiscussionsAPI.Discussions.getDiscussionMembers(req.ctx, req.params.discussionId, req.query.start, limit, function(err, members) {
        if (err) {
            return res.send(err.code, err.msg);
        }
 ...
 */
OAE.tenantServer.get('/api/discussion/:discussionId/messages', function(req, res) {
    req.telemetryUrl = '/api/discussion/id/messages';
    var limit = Util.getNumberParam(req.query.limit, 10, 1, 25);
    DiscussionsAPI.Discussions.getMessages(req.ctx, req.params.discussionId, req.query.start, limit, function(err, messages) {
        if (err) {
            return res.send(err.code, err.msg);
        }
 ...
 */
OAE.tenantServer.post('/api/discussion/:discussionId/messages', function(req, res) {
    req.telemetryUrl = '/api/discussion/id/messages';
 ...
 */
OAE.tenantServer.del('/api/discussion/:discussionId/messages/:created', function(req, res) {
    req.telemetryUrl = '/api/discussion/id/messages/created';
