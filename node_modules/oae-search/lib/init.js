...
var ensureSearchSchema = function(config, callback) {
    ...
    ElasticSearch.putMapping(SearchConstants.resourceMappingName, resourceSchema, null, callback);
}
...
var createBaseSchema = function() {
    return {
        ...
        // Where applicable, outlines the list of principal ids that have direct access to this resource. Used for access-scoped queries
        'access': {
            'type': 'string',
            'store': 'no',
            'index': 'not_analyzed'
