...
describe('Collaborative documents', function() {
    ...
    /**
     * Test that verifies the request parameters get validated when joining a collaborative document or spreadsheet
     */
                        ...
                        RestAPI.Content.joinCollabDoc(ctx, ' ', function(err) {
                            ...
                            RestAPI.Content.joinCollabDoc(ctx, 'invalid-id', function(err) {
                                ...
                                RestAPI.Content.joinCollabDoc(ctx, contentObj.id, function(err, data) {
                                    ...
                                    // Test collabsheets are created and can be joined
                                    RestAPI.Content.createCollabsheet(ctx, 'Test sheet', 'description', 'private', [], [], [], [], function(err, contentObj) {
                                        assert.ok(!err);
