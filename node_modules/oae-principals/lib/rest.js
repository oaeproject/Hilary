...
// Require the T&C related REST endpoints
require('oae-principals/lib/rest.termsAndConditions.js');

/*!
 * Crops the large picture that is associated with a principal.
 */
OAE.tenantServer.post('/api/crop', function(req, res) {
    req.telemetryUrl = '/api/crop';
 ...
 */
OAE.tenantServer.get('/api/timezones', function(req, res) {
    req.telemetryUrl = '/api/timezones';
