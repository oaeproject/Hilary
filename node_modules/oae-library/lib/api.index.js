...
var _isStaleLibraryIndex = function(start, limit, rows) {
    var slugHighColumn = _.findWhere(rows, {'rankedResourceId': SLUG_HIGH});
    var slugLowColumn = _.find(rows, {'rankedResourceId': SLUG_LOW});
...
var _adjustColumnsForSlugs = function(indexName, libraryId, start, limit, rows, nextToken) {
    ...
    _.each(rows, function(row) {
        var rankedResourceId = row.rankedResourceId;
        var value = null;
