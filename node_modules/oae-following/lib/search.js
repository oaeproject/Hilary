...
var init = module.exports.init = function(callback) {
    ...
    SearchAPI.registerChildSearchDocument('resource_followers', followersChildSearchDocumentOptions, function(err) {
        if (err) {
            return callback(err);
        }

        return SearchAPI.registerChildSearchDocument('resource_following', followingChildSearchDocumentOptions, callback);
    });
};
...
var _produceResourceFollowersDocuments = function(resources, callback, _documents) {
    ...
    _getAllIds(FollowingDAO.getFollowers, resource.id, null, 100, function(err, followerUserIds) {
        ...
        _documents.push(SearchUtil.createChildSearchDocument('resource_followers', resource.id, {'followers': followerUserIds}));
...
var _produceResourceFollowingDocuments = function(resources, callback, _documents) {
    ...
    _getAllIds(FollowingDAO.getFollowing, resource.id, null, 100, function(err, followingUserIds) {
        ...
        _documents.push(SearchUtil.createChildSearchDocument('resource_following', resource.id, {'following': followingUserIds}));
