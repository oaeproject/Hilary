...
describe('Group REST endpoints', function() {
    ...
    before(function(callback) {
        ...
        PrincipalAPI.createUser(tenantCtx, loginId('john-' + r), 'password', 'John Doe', {}, function(err, id) {
    ...
    describe('#createGroup()', function() {
        ...
        it('verify that members can be specified on group creation', function(callback) {
            ...
            var r = Math.floor(Math.random()*100000);
            PrincipalAPI.createUser(tenantCtx, loginId('jack-' + r), 'password', 'John Doe', {}, function(err, jack) {
                assert.ok(!err);
                PrincipalAPI.createUser(tenantCtx, loginId('jane-' + r), 'password', 'Jane Doe', {}, function(err, jane) {
                    assert.ok(!err);
        ...
        it('verify isMember and isManager', function(callback) {
            ...
            PrincipalAPI.createUser(tenantCtx, loginId('jack-' + r), 'password', 'John Doe', {}, function(err, jack) {
                ...
                PrincipalAPI.createUser(tenantCtx, loginId('jane-' + r), 'password', 'Jane Doe', {}, function(err, jane) {
                    ...
                    PrincipalAPI.createUser(tenantCtx, loginId('joe-' + r), 'password', 'Jane Doe', {}, function(err, joe) {
                        assert.ok(!err);
    ...
    describe('#getGroupMembers()', function() {
        it('verify paging', function(callback) {
            ...
            for (var i = 0; i < 10; i++) {
                ...
                PrincipalAPI.createUser(tenantCtx, loginId('random-user-' + r), 'password', 'John Doe', {}, userCreated);
            }
        });
