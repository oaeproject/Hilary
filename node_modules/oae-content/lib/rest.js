 ...
 * @FormParam   {string}            [managers]          Unique identifier(s) for manager(s) of the content (user creating discussion is always a manager); may also be array
 * @FormParam   {string}            resourceSubType     Content type                        [collabdoc]
 * @FormParam   {string}            [viewers]           Unique identifiers(s) for users(s) who can access the content; may also be array
