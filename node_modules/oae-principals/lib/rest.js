...
module.exports = function(tenant) {
    ...
    tenant.server.post('/api/user/create', function(req, res) {
        ...
        ConfigAPI.getConfig(req.ctx.tenant().alias, function(err, config) {
            ...
            recaptcha.checkAnswer(config['oae-principals']['recaptcha']['elements']['private-key'], req.connection.remoteAddress, req.body.recaptchaChallenge, req.body.recaptchaResponse);
        });
    });
