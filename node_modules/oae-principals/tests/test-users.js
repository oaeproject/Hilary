...
describe('Users', function() {
    ...
    describe('Full User Profile Decorators', function() {
        ...
        it('verify various user profile decorator response types', function(callback) {
            var testUndefinedNamespace = TestsUtil.generateTestUserId();
            var testNullNamespace = TestsUtil.generateTestUserId();
            var testZeroNamespace = TestsUtil.generateTestUserId();
            var testEmptyStringNamespace = TestsUtil.generateTestUserId();
            var testFalseNamespace = TestsUtil.generateTestUserId();
            var testErrorNamespace = TestsUtil.generateTestUserId();
        ...
        it('verify a user profile decorator cannot overwrite existing user properties', function(callback) {
            var testNamespace = TestsUtil.generateTestUserId();
