...
describe('Email Search', function() {
  ...
  it('verify email search returns all users that match a particular email', function(callback) {
    TestsUtil.generateTestUsers(camAdminRestContext, 3, function(
      ...
      var allUserIds = _.chain([userInfo0, userInfo1, userInfo2])
        .pluck('user')
        .pluck('id')
        .value();
      var updateUserIds = _.chain([userInfo1, userInfo2])
        .pluck('user')
        .pluck('id')
        .value();
      PrincipalsTestUtil.assertUpdateUsersSucceeds(
        ...
        function(users, tokens) {
          ...
          PrincipalsTestUtil.assertVerifyEmailsSucceeds(
            userInfoTokens,
            function() {
   ...
   */
  it('verify email search returns the tenant that matches the email domain', function(callback) {
    TestsUtil.setupMultiTenantPrivacyEntities(function(
      publicTenant0,
      publicTenant1,
      privateTenant0,
