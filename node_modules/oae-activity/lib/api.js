...
var refreshConfiguration = module.exports.refreshConfiguration = function(config, callback) {
    ...
    if (config && config.mail && config.mail.pollingFrequency > 3600) {
        log().warn('The activity-mail-polling frequency cannot be higher than an hour, it will be defaulted to 5 minutes')
    }
