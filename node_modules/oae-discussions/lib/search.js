 ...
 */
DiscussionsAPI.on(DiscussionsConstants.events.UPDATED_DISCUSSION, function(ctx, discussion) {
    SearchAPI.postIndexTask('discussion', [{'id': discussion.id}], {
        'resource': true
    });
});
 ...
 */
DiscussionsAPI.on(DiscussionsConstants.events.DELETED_DISCUSSION, function(ctx, discussion) {
