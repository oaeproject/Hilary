          ...
          function(err, content) {
            ...
            RestAPI.Content.getRevision(
              ...
              function(err, revision) {
                ...
                MediaCoreProcessor.test(mockPreviewContext, content, function(
                  err,
                  rank,
                ) {
  ...
  describe('#generatePreviews', function() {
            ...
            upload: {
              protocols: {
                form_data: {
                  ...
                  upload_url:
                    'http://localhost:' + port + '/api2/media/67890/upload',
          ...
          function(err, content) {
            ...
            var mockPreviewContext = {
              ...
              download: function(callback) {
                ...
                assert.fail(
                  'Should not have tried to download the video file to the PP',
                );
              },
              addPreview: function(name, value) {
                // Ensure the preview references apply to the proper preview sizes
      ...
      TestsUtil.generateTestUsers(camAdminRestContext, 1, function(err, user) {
        ...
        RestAPI.Content.createFile(
          ...
          function(err, content) {
            ...
            RestAPI.Content.getContent(user.restContext, content.id, function(
              err,
              content,
            ) {
              assert.ok(!err);
    ...
    it('verify video uploads from different tenants honour tenant-specific configuration', function(callback) {
      ...
      TestsUtil.createTestServer(function(
        ...
        var gtMediaCoreUrl = util.format(
          'http://127.0.0.1:%s',
          gtMediaCorePort,
        );
                    ...
                    RestAPI.Content.createFile(
                      ...
                      function(err, gtContent) {
                        ...
                        RestAPI.Content.getRevision(
                          ...
                          function(err, camRevision) {
                            assert.ok(!err);
                            RestAPI.Content.getRevision(
                              gtUser.restContext,
                              gtContent.id,
                              gtContent.latestRevisionId,
                              function(err, gtRevision) {
                                assert.ok(!err);
