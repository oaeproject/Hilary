 ...
 * @Property    {BasicTenant}   tenant                  Tenant for group
 ...
 *
 * @Required    []
 * @Property    {BasicGroup}    (basicGroup)                 Used when principal is a group
 * @Property    {BasicUser}     (basicUser)                  Used when principal is a user
 */
 ...
 * @Property    {boolean}       canFollow               Can the currently logged in user follow the referenced user
 * @Property    {boolean}       isFollowing             Is the currently logged in user following the referenced user
 */
 ...
 * @Property    {string}        profilePath             Relative URL for group's main page
 * @Property    {string}        resourceType            Type of resource (group)
 * @Property    {Signature}     signature               Key for accessing push notifications for group
 * @Property    {BasicTenant}   tenant                  Tenant for group
 * @Property    {string}        visibility              Visibility of group             [loggedin,private,public]
 */
 ...
 * @Property    {string}        resourceType            Type of resource (user)
 * @Property    {Signature}     signature               Key for accessing push notifications for user
 * @Property    {BasicTenant}   tenant                  User's tenant
 * @Property    {string}        visibility              Visibility of user              [loggedin,private,public]
 */
 ...
 * @Property    {BasicPrincipal}    profile                 Profile of member
 ...
 * @Property    {BasicGroup[]}  results                 Array of groups
 * @Property    {string}        nextToken               Marker to allow continuation of search (empty if search has been exhausted)
 */

/**
 * @RESTModel MembershipUpdate
 *
 * @Required    []
 * @Property    {boolean}       {principalId}           Should identified user or group be included in group, may be repeated for multiple users/groups
 */
 ...
 *
 * @Required    []
 * @Property    {Group}         (group)                 Used when principal is a group
 * @Property    {User}          (user)                  Used when principal is a user
 */
 ...
 * @Property    {string}        profilePath             URL for user's main page
 * @Property    {string}        resourceType            Type of resource                [user]
 * @Property    {BasicTenant}   tenant                  Tenant for user/group
 * @Property    {string}        visibility              Visibility of user/group        [loggedin,private,public]
 * @Property    {string}        email                   Email address for user
 * @Property    {string}        emailPreference         Email preferences for user      [daily,immediate,weekly]
 * @Property    {FollowingInfo} following               Following status of user
 * @Property    {string}        locale                  Locale for user (e.g. en_US)
 * @Property    {PictureInfo}   picture                 Thumbnail information
 * @Property    {string}        publicAlias             Public alias for user
 * @Property    {Signature}     signature               Key for accessing push notifications for user
