...
var _search = function(ctx, opts, callback) {
  ...
  SearchUtil.filterScopeAndAccess(
    ...
    function(err, filterScopeAndAccess) {
      if (err) {
        return callback(err);
      }
...
var _includesResourceType = function(opts, resourceType) {
  return (
    opts.searchAllResourceTypes || _.contains(opts.resourceTypes, resourceType)
  );
};
