...
var createTenantNetwork = (module.exports.createTenantNetwork = function(
  ...
  var tenantNetworkQuery = Cassandra.constructUpsertCQL(
    'TenantNetwork',
    'id',
    tenantNetwork.id,
  ...
  Cassandra.runQuery(
    tenantNetworkQuery.query,
    tenantNetworkQuery.parameters,
    function(err) {
      if (err) {
        return callback(err);
      }
 ...
 */
var getAllTenantNetworks = (module.exports.getAllTenantNetworks = function(
  callback,
) {
 ...
 */
var getTenantNetwork = (module.exports.getTenantNetwork = function(
  id,
  callback,
) {
  _ensureCache(function(err) {
    if (err) {
      ...
      return callback({
        code: 404,
        msg: util.format(
          'Attempted to access non-existing tenant network: "%s"',
          id,
        ),
      });
    }
...
var updateTenantNetwork = (module.exports.updateTenantNetwork = function(
  ...
  getTenantNetwork(id, function(err, tenantNetwork) {
    ...
    var query = Cassandra.constructUpsertCQL('TenantNetwork', 'id', id, {
    ...
    Cassandra.runQuery(query.query, query.parameters, function(err) {
      ...
      return callback(
        null,
        _.extend({}, tenantNetwork, { displayName: displayName }),
      );
    });
  });
});
 ...
 */
var getAllTenantNetworkTenantAliases = (module.exports.getAllTenantNetworkTenantAliases = function(
  callback,
) {
  _ensureCache(function(err) {
    if (err) {
...
var _getAllTenantNetworksFromCassandra = function(callback) {
  Cassandra.runQuery('SELECT * FROM "TenantNetwork"', null, function(
    err,
    rows,
  ) {
    if (err) {
    ...
    var tenantNetworks = _.chain(rows)
 ...
 * @api private
 */
var _getAllTenantNetworkTenantAliasesFromCassandra = function(
  tenantNetworkIds,
  callback,
) {
  ...
  Cassandra.runQuery(
    ...
    function(err, rows) {
      ...
      _.chain(rows)
        ...
        .each(function(rowHash) {
          tenantNetworkAliases[rowHash.tenantNetworkId] =
            tenantNetworkAliases[rowHash.tenantNetworkId] || [];
          tenantNetworkAliases[rowHash.tenantNetworkId].push(
            rowHash.tenantAlias,
          );
        });
...
var _ensureCache = function(callback) {
  ...
  _getAllTenantNetworksFromCassandra(function(err, tenantNetworks) {
    ...
    _getAllTenantNetworkTenantAliasesFromCassandra(
      ...
      function(err, tenantNetworkTenantAliases) {
        if (err) {
          return callback(err);
        }
        ...
        _.each(_cacheTenantAliasesByTenantNetworkId, function(
          tenantAliases,
          tenantNetworkId,
        ) {
          _.each(tenantAliases, function(tenantAlias) {
            _cacheTenantNetworkIdsByTenantAlias[tenantAlias] =
              _cacheTenantNetworkIdsByTenantAlias[tenantAlias] || [];
            _cacheTenantNetworkIdsByTenantAlias[tenantAlias].push(
              tenantNetworkId,
            );
          });
        });
