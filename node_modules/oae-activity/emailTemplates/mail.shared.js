...
var getEmailSummary = module.exports.getEmailSummary = function(util, emailPreference, activities, baseUrl) {
    if (emailPreference === 'immediate') {
        ...
        if (isSingleActor && actor.objectType !== 'collection') {
            ...
            var key = '__MSG__EMAIL_SUMMARY_IMMEDIATE_SINGLE_ACTOR_SINGLE_ACTIVITY__';
            if (activities.length > 1) {
                key = '__MSG__EMAIL_SUMMARY_IMMEDIATE_SINGLE_ACTOR_MULTIPLE_ACTIVITIES__';
            }
            ...
            return '__MSG__EMAIL_SUMMARY_IMMEDIATE_MULTIPLE_ACTORS__';
        }
    } else if (emailPreference === 'daily') {
        return '__MSG__EMAIL_SUMMARY_DAILY__';
    } else if (emailPreference === 'weekly') {
        return '__MSG__EMAIL_SUMMARY_WEEKLY__';
    }
};
