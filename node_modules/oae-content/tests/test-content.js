    ...
    describe('Content comments', function() {
        ...
        it('verify delete comment permissions', function(callback) {
            setUpUsers(function(contexts) {
                ...
                RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 1', 'Test content description 1', 'public', 'http://www.oaeproject.org/', [], [], function(err, publicContentObj) {
                    assert.ok(!err);
                    assert.ok(publicContentObj);
                    // Create a second piece of content where bert is a member
                    RestAPI.Content.createLink(contexts['nicolaas'].restContext, 'Test Content 2', 'Test content description 2', 'private', 'http://www.oaeproject.org/', [], [contexts['bert'].user.id], function(err, privateContentObj) {
                        assert.ok(!err);
                        ...
                        RestAPI.Content.createComment(contexts['bert'].restContext, privateContentObj.id, 'This is a first comment.', null, function(err, comment) {
                            ...
                            RestAPI.Content.createComment(contexts['bert'].restContext, privateContentObj.id, 'This is a second comment.', null, function(err, comment) {
                                ...
                                RestAPI.Content.getComments(contexts['bert'].restContext, privateContentObj.id, null, 10, function(err, comments) {
                                    ...
                                    assert.equal(comment2.createdBy.id, contexts['bert'].user.id);
                                    assert.equal(comment2.body, 'This is a second comment.');
                                    assert.equal(comment1.createdBy.id, contexts['bert'].user.id);
                                    assert.equal(comment1.body, 'This is a first comment.');

                                    // Try to delete a comment
                                    RestAPI.Content.deleteComment(contexts['bert'].restContext, privateContentObj.id, comment2.created, function(err, softDeleted) {
                                        assert.ok(!err);
                                        assert.ok(!softDeleted);
                                        ...
                                        RestAPI.Content.getComments(contexts['bert'].restContext, privateContentObj.id, null, 10, function(err, comments) {
                                            ...
                                            RestAPI.Content.updateMembers(contexts['nicolaas'].restContext, privateContentObj.id, permissions, function(err) {
                                                ...
                                                RestAPI.Content.deleteComment(contexts['bert'].restContext, publicContentObj.id, comment1.created, function(err, softDeleted) {
                                                    assert.ok(err);
                                                    assert.equal(err.code, 404);
                                                    assert.ok(!softDeleted);
                                                    ...
                                                    RestAPI.Content.getComments(contexts['nicolaas'].restContext, privateContentObj.id, null, 10, function(err, comments) {
                                                        ...
                                                        RestAPI.Content.createComment(contexts['bert'].restContext, publicContentObj.id, 'This reply on the comment shouldn\'t be accepted', comment1.created, function(err, comment) {
                                                            assert.ok(err);
                                                            assert.equal(err.code, 400);
                                                            assert.ok(!comment);
    ...
    describe('Create content', function() {
        ...
        it('verify create content with default members link', function(callback) {
            setUpUsers(function(contexts) {
                ...
                RestAPI.Content.createLink(contexts['nicolaas'].restContext, 'Test Content 1', 'Test content description 1', 'private', 'http://www.oaeproject.org/', [contexts['simon'].user.id], [contexts['bert'].user.id], function(err, contentObj) {
                    assert.ok(!err);
                    assert.ok(contentObj.id);
