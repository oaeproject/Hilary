...
var assertGetContentMembersFails = (module.exports.assertGetContentMembersFails = function(
  ...
  RestAPI.Content.getMembers(restContext, contentId, start, limit, function(
    err,
    result,
  ) {
    assert.ok(err);
            ...
            AuthzTestUtil.assertGetInvitationsSucceeds(
              ...
              function(result) {
                ...
                getAllContentMembers(
                  ...
                  contentId,
                  null,
                  function(membersAfterUpdate) {
                    AuthzTestUtil.assertMemberRolesEquals(
                      memberRolesBefore,
                      roleChange,
                      AuthzTestUtil.getMemberRolesFromResults(
                        membersAfterUpdate,
                      ),
                    );
 ...
 */
var generateTestLinks = (module.exports.generateTestLinks = function(
  restContext,
  total,
  callback,
) {
...
var _createMultiPrivacyContent = function(restCtx, callback) {
  _createContentWithVisibility(restCtx, 'public', function(publicContent) {
    _createContentWithVisibility(restCtx, 'loggedin', function(
      loggedinContent,
    ) {
      _createContentWithVisibility(restCtx, 'private', function(
        privateContent,
      ) {
...
var createCollabDoc = (module.exports.createCollabDoc = function(
  ...
  TestsUtil.generateTestUsers(adminRestContext, nrOfUsers, function(
    err,
    users,
  ) {
    assert.ok(!err);
 ...
 */
var publishCollabDoc = (module.exports.publishCollabDoc = function(
  contentId,
  userId,
  callback,
) {
  ...
  TaskQueue.submit(ContentConstants.queue.ETHERPAD_PUBLISH, data, function(
    err,
  ) {
    assert.ok(!err);
  });
