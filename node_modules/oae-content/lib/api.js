 ...
 * @param {String}      expires                         When the signature expires.
...
var verifySignedUri = module.exports.verifySignedUri = function(ctx, uri, expires, signature, callback) {
    ...
    validator.check(signature, {'code': 400, 'msg': 'Missing expires'}).notNull();
    validator.check(signature, {'code': 400, 'msg': 'Missing signature'}).notNull();
    validator.check(signature, {'code': 401, 'msg': 'Invalid signature'}).verifyExpiringSignature(uri, expires);
    if (validator.hasErrors()) {
        return callback(validator.getFirstError());
    }
