...
var assertMembershipsLibrariesEquals = module.exports.assertMembershipsLibrariesEquals = function(restCtx, expectedMemberships, callback, _userIds) {
    ...
    assertMembershipsLibraryEquals(restCtx, userId, expectedMemberships[userId], function() {
 ...
 * @throws {AssertionError}                 Thrown if the operation is unsuccessful or the mapping is incorrect
 */
var assertCreateRequestJoinGroupSucceeds = module.exports.assertCreateRequestJoinGroupSucceeds = function(restCtx, groupId, callback) {
    RestAPI.Group.createRequestJoinGroup(restCtx, groupId, function(err) {
        assert.ok(!err);
        return callback();
    });
};
 ...
 * @throws {AssertionError}                 Thrown if the operation is successful
 */
var assertCreateRequestJoinGroupFails = module.exports.assertCreateRequestJoinGroupFails = function(restCtx, groupId, httpCode, callback) {
    RestAPI.Group.createRequestJoinGroup(restCtx, groupId, function(err) {
        assert.ok(err);
        assert.strictEqual(err.code, httpCode);
        return callback();
 ...
 * @throws {AssertionError}                 Thrown if the operation is unsuccessful or the mapping is incorrect
 */
var assertGetJoinGroupRequestSucceeds = module.exports.assertGetJoinGroupRequestSucceeds = function(restCtx, groupId, callback) {
    RestAPI.Group.getJoinGroupRequest(restCtx, groupId, function(err, request) {
        assert.ok(!err);
 ...
 * @throws {AssertionError}                 Thrown if the operation is successful
 */
var assertGetJoinGroupRequestFails = module.exports.assertGetJoinGroupRequestFails = function(restCtx, groupId, httpCode, callback) {
    RestAPI.Group.getJoinGroupRequest(restCtx, groupId, function(err) {
        assert.ok(err);
        assert.strictEqual(err.code, httpCode);
        return callback();
    });
 ...
 * @throws {AssertionError}                 Thrown if the operation is unsuccessful or the mapping is incorrect
 */
var assertGetJoinGroupRequestsSucceeds = module.exports.assertGetJoinGroupRequestsSucceeds = function(restCtx, groupId, callback) {
    RestAPI.Group.getJoinGroupRequests(restCtx, groupId, function(err, requests) {
        assert.ok(!err);
 ...
 * @throws {AssertionError}                 Thrown if the operation is successful
 */
var assertGetJoinGroupRequestsFails = module.exports.assertGetJoinGroupRequestsFails = function(restCtx, groupId, httpCode, callback) {
    RestAPI.Group.getJoinGroupRequests(restCtx, groupId, function(err) {
        assert.ok(err);
        assert.strictEqual(err.code, httpCode);
        return callback();
    });
 ...
 * @throws {AssertionError}                 Thrown if the operation is unsuccessful or the mapping is incorrect
 */
var assertUpdateJoinGroupByRequestSucceeds = module.exports.assertUpdateJoinGroupByRequestSucceeds = function(restCtx, groupId, principalId, role, status, callback) {
    RestAPI.Group.updateJoinGroupByRequest(restCtx, groupId, principalId, role, status, function(err) {
        assert.ok(!err);
        return callback();
    });
};
 ...
 * @throws {AssertionError}                 Thrown if the operation is successful
 */
var assertUpdateJoinGroupByRequestFails = module.exports.assertUpdateJoinGroupByRequestFails = function(restCtx, groupId, principalId, role, status, httpCode, callback) {
    RestAPI.Group.updateJoinGroupByRequest(restCtx, groupId, principalId, role, status, function(err) {
        assert.ok(err);
        assert.strictEqual(err.code, httpCode);
        return callback();
