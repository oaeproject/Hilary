...
MessageBoxAPI.on(MessageBoxConstants.events.DELETED_MESSAGE, function(messageId, deleteType) {
    MQ.submit(SearchConstants.mq.TASK_DELETE_DOCUMENT, {'resourceType': 'message', 'id': messageId});
});


var _produceDiscussionMessageSearchDocuments = function(resources, callback) {
...
SearchAPI.registerSearchDocumentProducer('message', _produceDiscussionMessageSearchDocuments);
