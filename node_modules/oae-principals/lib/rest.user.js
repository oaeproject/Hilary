 ...
 *
 * Set a user's large picture for cropping
 *
 * @Server      tenant
 * @Method      POST
 * @Path        /user/{id}/picture
 * @PathParam   {string}        id                  The ID of the user
 * @FormParam   {File}          file                Image file for picture
 * @Return      {BasicUser}                         The profile of the user
 */
 ...
 * @Return      {MembershipsResponse}               Groups to which specified user belongs
 */
 ...
 * @Return      {TermsAndConditions}                Terms and conditions object
 */
 ...
 * @Return      {BasicUser}                         Updated user profile
 */
 ...
 * @Method      POST
 * @Path        /user/import
 * @FormParam   {string}            authenticationStrategy  How are users authenticated       [cas,facebook,google,ldap,local,oauth,shibboleth,twitter]
 ...
 * @FormParam   {string}        [publicAlias]       Public alias for user
 * @FormParam   {string}        [visibility]        Visibility of user              [loggedin,private,public]
 * @Return      {BasicUser}                         Updated profile of the user
 */
