...
OAE.tenantServer.get('/api/content/:contentId/comments', function(req, res) {
    var limit = OaeUtil.getNumberParam(req.query.limit, 10, 1, 25);
    ContentAPI.getComments(req.ctx, req.params.contentId, req.query.start, limit, function(err, comments) {
        if (err) {
            return res.send(err.code, err.msg);
        }
...
OAE.tenantServer.get('/api/content/library/:principalId', function(req, res) {
    ...
    ContentAPI.getLibraryItems(req.ctx, req.params.principalId, req.query.start, limit, function(err, items) {
        if (err) {
            return res.send(err.code, err.msg);
        }
