...
describe('Tenants', function() {
    ...
    describe('Update tenant', function() {
        ...
        /**
         * Test that verifies that a tenant's name can not be updated without specifying the new name
         */
        it('verify update tenant name requires a name', function(callback) {
