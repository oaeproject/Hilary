...
OAE.tenantServer.post('/api/user/:id/profile', function(req, res) {
    ...
    ProfileAPI.setSection(req.ctx, req.params.id, req.body.section, req.body.visibility, data, overwrite, function(err) {
        if (err) {
            return res.send(err.code, err.msg);
        }
