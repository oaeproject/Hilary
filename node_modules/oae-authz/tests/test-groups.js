...
describe('Authz-Groups', function() {
     ...
     * @return {Array<String>}      An array of user uuid's that were generated
     */
    ...
    describe('#addGroupMember()', function() {
        it('verify invalid group uuid error', function(callback) {
            AuthzAPI.addGroupMember('not a valid uuid', 'u:cam:mrvisser', 'member', function(err) {
                assert.ok(err);
        ...
        it('verify non-group group uuid error', function(callback) {
            AuthzAPI.addGroupMember('u:cam:mrvisser', 'u:cam:mrvisser', 'member', function(err) {
                assert.ok(err);
                assert.equal(err.code, 400);
                callback();
            });
        ...
        it('verify invalid member uuid error', function(callback) {
            AuthzAPI.addGroupMember('g:sakai:oae-team', 'not a valid uuid', 'member', function(err) {
                assert.ok(err);
                assert.equal(err.code, 400);
                callback();
            });
        ...
        it('verify non-principal member uuid error', function(callback) {
            AuthzAPI.addGroupMember('g:sakai:oae-team', 'c:content:uuid', 'member', function(err) {
                assert.ok(err);
                assert.equal(err.code, 400);
                callback();
            });
        ...
        it('verify null role error', function(callback) {
            AuthzAPI.addGroupMember('g:sakai:oae-team', 'u:cam:mrvisser', null, function(err) {
                assert.ok(err);
                assert.equal(err.code, 400);
                callback();
            });
        ...
        it('verify undefined role error', function(callback) {
            AuthzAPI.addGroupMember('g:sakai:oae-team', 'u:cam:mrvisser', undefined, function(err) {
                assert.ok(err);
                assert.equal(err.code, 400);
                callback();
            });
        ...
        it('verify false role error', function(callback) {
            AuthzAPI.addGroupMember('g:sakai:oae-team', 'u:cam:mrvisser', false, function(err) {
                assert.ok(err);
                assert.equal(err.code, 400);
                callback();
            });
        ...
        it('verify user gets added to group', function(callback) {
            ...
            AuthzAPI.addGroupMember(groupUuid, memberUuid, 'member', function(err) {
                assert.ok(!err);
        ...
        it('verify update user membership role', function(callback) {
            ...
            AuthzAPI.addGroupMember(groupUuid, memberUuid, 'member', function(err) {
                ...
                verifyBidirectionalGroupMembership(groupUuid, memberUuid, 'member', function() {
                    AuthzAPI.addGroupMember(groupUuid, memberUuid, 'manager', function(err) {
                        assert.ok(!err);
    ...
    describe('#removeGroupMember()', function() {
        ...
        it('verify invalid group uuid error', function(callback) {
            AuthzAPI.removeGroupMember('not a valid uuid', 'u:cam:mrvisser', function(err) {
                assert.ok(err);
                assert.equal(err.code, 400);
                callback();
            });
        ...
        it('verify non-group group uuid error', function(callback) {
            AuthzAPI.removeGroupMember('u:cam:mrvisser', 'u:cam:mrvisser', function(err) {
                assert.ok(err);
                assert.equal(err.code, 400);
                callback();
            });
        ...
        it('verify invalid member uuid error', function(callback) {
            AuthzAPI.removeGroupMember('g:sakai:oae-team', 'not a valid uuid', function(err) {
                assert.ok(err);
                assert.equal(err.code, 400);
                callback();
            });
        ...
        it('verify non-principal member uuid error', function(callback) {
            AuthzAPI.removeGroupMember('g:sakai:oae-team', 'c:content:uuid', function(err) {
                assert.ok(err);
                assert.equal(err.code, 400);
                callback();
            });
        ...
        it('verify user gets removed from group', function(callback) {
            ...
            AuthzAPI.addGroupMember(groupUuid, memberUuid, 'member', function(err) {
                ...
                verifyBidirectionalGroupMembership(groupUuid, memberUuid, 'member', function() {
                    ...
                    // 3. remove the user
                    AuthzAPI.removeGroupMember(groupUuid, memberUuid, function(err) {
                        assert.ok(!err);
        ...
        it('verify get user from group', function(callback) {
            ...
            AuthzAPI.addGroupMember(groupUuid, memberUuid, 'member', function(err) {
                ...
                AuthzAPI.getGroupMembers(groupUuid, null, null, function(err, members) {
                    ...
                    assert.equal(members[0], memberUuid);
                    callback();
                });
            });
        });
        ...
        it('verify user paging', function(callback) {
            ...
            AuthzAPI.applyGroupMembershipChanges(groupUuid, changes, function(err) {
                ...
                AuthzAPI.getGroupMembers(groupUuid, null, 10, function(err, members) {
                    ...
                    AuthzAPI.getGroupMembers(groupUuid, members[9], 10, function(err, members) {
                        assert.ok(!err);
                        assert.equal(members.length, 1);
                        callback();
                    });
    ...
    describe('#getMemberOf()', function() {
        ...
        it('verify simple group hierarchy', function(callback) {
            ...
            AuthzAPI.addGroupMember(groupUuid1, userUuid, 'member', function(err) {
                assert.ok(!err);
                AuthzAPI.addGroupMember(groupUuid1, nonMemberGroupUuid3, 'member', function(err) {
                    assert.ok(!err);
