 ...
 * and verb. Also assert that the activity contains the correct entities
 *
 ...
 * @param  {String}         actorId             The id of the entity that should be the actor, or an array of expected actor entity ids if the entity is expected to be an oae:collection aggregate
 * @param  {String}         [objectId]          The id of the entity that should be the object, or an array of expected object entity ids if the entity is expected to be an oae:collection aggregate
 * @param  {String}         [targetId]          The id of the entity that should be the target, or an array of expected target entity ids if the entity is expected to be an oae:collection aggregate
 * @param  {Function}       callback            Standard callback function
