...
describe('Folders - Activity', function() {
                      ...
                      ActivityTestsUtil.collectAndGetActivityStream(
                        ...
                        function(err, activityStream) {
                          ...
                          var reply = _.find(
                            ...
                            function(activityMessage) {
                              return (
                                activityMessage['oae:id'] === nicosMessage.id
                              );
                            },
                          );
                          assert.ok(reply);
                          ...
                          assert.equal(
                            ...
                            '/user/' +
                              ...
                              '/' +
                              AuthzUtil.getResourceFromId(simong.user.id)
                                .resourceId,
                          );
                            ...
                            function() {
                              ActivityTestsUtil.collectAndGetActivityStream(
                                ...
                                function(err, data) {
                                  ...
                                  var addToFolderActivities = _.filter(
                                    data.items,
                                    function(activity) {
                                      return (
          ...
          FoldersDAO.setPreviews(folder, previews, function(err, folder) {
            ...
            ActivityTestsUtil.collectAndGetActivityStream(
              ...
              function(err, response) {
                ...
                var createdFolderActivity = _.findWhere(response.items, {
                  'oae:activityType':
                    FoldersConstants.activity.ACTIVITY_FOLDER_CREATE,
                });
            ...
            function(err, link1) {
              ...
              ActivityTestsUtil.collectAndGetActivityStream(
                ...
                function(err, response) {
                  ...
                  var addToLibraryActivity = _.findWhere(response.items, {
                    'oae:activityType':
                      FoldersConstants.activity.ACTIVITY_FOLDER_ADD_TO_LIBRARY,
                  });
                  ...
                  assert.strictEqual(
                    contentCreateActivity.target['oae:id'],
                    folder.id,
                  );
                  return callback();
                },
  ...
  it('verify content-create activities are routed to the correct activity streams and contain the correct target information', function(callback) {
    TestsUtil.generateTestUsers(camAdminRestContext, 4, function(
      ...
      TestsUtil.generateTestGroups(nico.restContext, 2, function(
        nicosGroup1,
        nicosGroup2,
      ) {
