 ...
 */
ContentAPI.when(ContentConstants.events.CREATED_CONTENT, function(
  ctx,
  content,
  revision,
  memberChangeInfo,
 ...
 */
ContentAPI.when(ContentConstants.events.UPDATED_CONTENT_MEMBERS, function(
  ctx,
  content,
  memberChangeInfo,
  opts,
  ...
  ContentDAO.Content.updateContentLibraries(content, removedMemberIds, function(
    err,
    newContent,
  ) {
    if (err) {
    ...
    return _updateContentMembersLibrary(
      newContent || content,
      memberChangeInfo,
      callback,
    );
 ...
 * @api private
 */
var _updateContentMembersLibrary = function(
  content,
  memberChangeInfo,
  callback,
) {
  ...
  ContentMembersLibrary.insert(
    content,
    memberChangeInfo.members.added,
    function(err) {
      if (err) {
        log().warn(
          {
