...
var _setupTenant = function(tenant, callback) {
  _createMultiPrivacyDiscussions(tenant.adminRestContext, function(
    publicDiscussion,
    loggedinDiscussion,
    privateDiscussion,
  ) {
...
var _createMultiPrivacyDiscussions = function(restCtx, callback) {
  _createDiscussionWithVisibility(restCtx, 'public', function(
    publicDiscussion,
  ) {
    _createDiscussionWithVisibility(restCtx, 'loggedin', function(
      loggedinDiscussion,
    ) {
      _createDiscussionWithVisibility(restCtx, 'private', function(
        privateDiscussion,
      ) {
        return callback(
          publicDiscussion,
 ...
 */
var assertCreateDiscussionSucceeds = (module.exports.assertCreateDiscussionSucceeds = function(
  restContext,
  displayName,
  description,
  visibility,
  ...
  PrincipalsTestUtil.assertGetMeSucceeds(restContext, function(me) {
    RestAPI.Discussions.createDiscussion(
      ...
      function(err, discussion) {
        ...
        getAllDiscussionMembers(restContext, discussion.id, null, function(
          result,
        ) {
 ...
 * @throws {AssertionError}                         Thrown if any assertions fail
 */
var assertCreateDiscussionFails = (module.exports.assertCreateDiscussionFails = function(
  restContext,
  displayName,
  description,
  visibility,
 ...
 * @throws {AssertionError}                 Thrown if any assertions fail
 */
var assertGetDiscussionFails = (module.exports.assertGetDiscussionFails = function(
  restContext,
  discussionId,
  httpCode,
  callback,
) {
  RestAPI.Discussions.getDiscussion(restContext, discussionId, function(
    err,
    discussion,
  ) {
    assert.ok(err);
 ...
 * @throws {AssertionError}                         Thrown if any assertions fail
 */
var assertDeleteDiscussionSucceeds = (module.exports.assertDeleteDiscussionSucceeds = function(
  restContext,
  discussionId,
  callback,
) {
  RestAPI.Discussions.deleteDiscussion(restContext, discussionId, function(
    err,
  ) {
    assert.ok(!err);
 ...
 */
var assertUpdateDiscussionSucceeds = (module.exports.assertUpdateDiscussionSucceeds = function(
  restContext,
  discussionId,
  updates,
  callback,
 ...
 */
var assertShareDiscussionSucceeds = (module.exports.assertShareDiscussionSucceeds = function(
  managerRestContext,
  actorRestContext,
  discussionId,
  targetIds,
  ...
  getAllDiscussionMembers(managerRestContext, discussionId, null, function(
    result,
  ) {
 ...
 */
var assertShareDiscussionFails = (module.exports.assertShareDiscussionFails = function(
  managerRestContext,
  actorRestContext,
  discussionId,
  targetIds,
 ...
 * @throws {AssertionError}                 Thrown if the request fails
 */
var assertUpdateDiscussionMembersSucceeds = (module.exports.assertUpdateDiscussionMembersSucceeds = function(
  managerRestContext,
  actorRestContext,
  discussionId,
  updates,
 ...
 * @throws {AssertionError}                     Thrown if there is an error ensuring that the request fails in the specified manner
 */
var assertUpdateDiscussionMembersFails = (module.exports.assertUpdateDiscussionMembersFails = function(
  managerRestContext,
  actorRestContext,
  discussionId,
  updates,
 ...
 */
var getAllDiscussionMembers = (module.exports.getAllDiscussionMembers = function(
  restContext,
  discussionId,
  opts,
  callback,
 ...
 */
var assertGetAllDiscussionsLibrarySucceeds = (module.exports.assertGetAllDiscussionsLibrarySucceeds = function(
  restContext,
  principalId,
  opts,
  callback,
 ...
 */
var assertGetDiscussionsLibrarySucceeds = (module.exports.assertGetDiscussionsLibrarySucceeds = function(
  restContext,
  principalId,
  opts,
  callback,
