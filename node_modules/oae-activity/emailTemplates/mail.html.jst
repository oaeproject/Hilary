...
<html xmlns="http: //www.w3.org/1999/xhtml">
    <head>
        ...
        <style>
            ...
            .activity-row .activity-comment-container, .activity-row .activity-annotation-container {
                margin-top: 25px;
                min-height: 40px;
            }
            ...
            .activity-row .activity-annotation-container .activity-annotation-thumbnail-container {
                float: left;
            }

            .activity-row .activity-comment-container .activity-comment,
            .activity-row .activity-annotation-container .activity-annotation {
                padding-left: 52px;
                max-width: 650px;
            }
            ...
            .activity-row .activity-comment-container .activity-comment .activity-comment-message blockquote p:first-child {
                margin-top: 0;
            }
            ...
            .activity-row .activity-comment-container .activity-comment .activity-comment-message p:last-child {
                margin-bottom: 0;
            }
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            ...
                                            <% _.each(activity.allAnnotations, function(annotation) {
                                                %>
                                                <div class="activity-annotation-container" data-annotation-id="<%= annotation.id %>">
                                                    <div class="activity-annotation-thumbnail-container">
                                                        <% renderUserThumbnail(annotation.author); %>
                                                    </div>
                                                    <div class="activity-annotation">
                                                        <%
                                                            var authorLink = shared.ensureAbsoluteLink(annotation.author['oae:profilePath'], baseUrl);
                                                            if (authorLink) {
                                                                print('<a href="' + authorLink + '" title="' +  util.html.encodeForHTMLAttribute(annotation.author.displayName) + '" class="wrapped">');
                                                            }
                                                        %>
                                                            <%= util.html.encodeForHTML(annotation.author.displayName) %>
                                                        <%
                                                            if (authorLink) {
                                                                print('</a>');
                                                            }
                                                        %>
                                                        <div class="activity-annotation-quote wrapped">&quot;<%= util.text.toHtml(annotation['oae:annotation'].quote) %>&quot;</div>
                                                        <div class="activity-annotation-text wrapped"><%= util.text.toHtml(annotation['oae:annotation'].text) %></div>
                                                    </div>
                                                </div>
                                            <% }); %>
