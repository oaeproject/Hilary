...
describe('General Search', function() {
   ...
   */
  var searchForResource = function(
    restCtx,
    scope,
    resource,
    expectInResults,
        ...
        TestsUtil.generateTestGroups(doer.restContext, 1, function(xyzTeam) {
          ...
          SearchTestsUtil.searchRefreshed(
            ...
            function(err, results) {
              ...
              var displayName =
                'Team testverifyindexupdatedgroup' + xyzTeam.group.id;
  ...
  describe('Message Indexing', function() {
     ...
     */
    var _verifySearchResults = function(
      restContext,
      contentId,
      discussionId,
      canSearchContent,
      ...
      SearchTestsUtil.searchAll(
        ...
        function(err, results) {
          ...
          assert.strictEqual(
            _containsDoc(results, discussionId),
            canSearchDiscussion,
          );
          SearchTestsUtil.searchAll(
            restContext,
            ...
            function(err, results) {
              assert.ok(!err);
              assert.strictEqual(
                _containsDoc(results, contentId),
                canSearchContent,
              );
  ...
  describe('General Search Parameters', function() {
    ...
    it('verify a variety of valid and invalid values for the resourceTypes parameter', function(callback) {
      /*!
             ...
             * @return {Object}                             The search document. `null` if it didn't exist
             */
      var _verifyHasResourceTypes = function(
        results,
        shouldHaveUser,
        shouldHaveGroup,
        shouldHaveContent,
                    ...
                    RestAPI.Search.search(
                      ...
                      function(err, results) {
                        ...
                        RestAPI.Search.search(
                          ...
                          null,
                          {
                            resourceTypes: 'not-matching-anything',
                            q: jack.user.displayName,
                          },
                          function(err, results) {
                            assert.ok(!err);
              ...
              function(err) {
                ...
                TestsUtil.generateGroupHierarchy(
                  ...
                  function(err) {
                    ...
                    var uniqueString = TestsUtil.generateTestUserId(
                              ...
                              function(err, results) {
                                ...
                                SearchTestsUtil.searchRefreshed(
                                  ...
                                  function(err, results) {
                                    ...
                                    assert.ok(
                                      parseInt(contentDoc.lastModified) >=
                                        beforeCreated,
                                    );
                                  ...
                                  function(err, results) {
                                    ...
                                    SearchTestsUtil.searchRefreshed(
                                      ...
                                      function(err, results) {
                                        assert.ok(!err);
                                        assert.ok(
                                          !_getDocById(results, contentObj.id),
                                        );
                                            ...
                                            SearchTestsUtil.searchRefreshed(
                                              ...
                                              function(err, results) {
                                                ...
                                                TestsUtil.generateTestGroups(
                                                  doer.restContext,
                                                  1,
                                                  function(anotherGroup) {
                                                    var permissions = {};
                                                    permissions[jack.user.id] =
                                                      'member';
                                                    RestAPI.Group.setGroupMembers(
                                                      doer.restContext,
                        ...
                        function(err, results) {
                          ...
                          assert.equal(
                            ...
                            '/user/' +
                              jackDoc.tenant.alias +
                              '/' +
                              AuthzUtil.getResourceFromId(jackDoc.id)
                                .resourceId,
                          );
                          assert.equal(
                            jackDoc.tenantAlias,
  ...
  describe('Group Search Visibility', function() {
    ...
    it('verify public group is searchable by everyone', function(callback) {
      TestsUtil.generateTestUsers(camAdminRestContext, 2, function(
        ...
        TestsUtil.generateTestUsers(gtAdminRestContext, 2, function(
          err,
          users,
          darthVader,
          sith,
    ...
    it('verify loggedin group search visibility', function(callback) {
      var privateTenantAlias = TenantsTestUtil.generateTestTenantAlias(
        'privateTenant',
      );
      var tenantHost = TenantsTestUtil.generateTestTenantHost();
      var uniqueStringA = TestsUtil.generateTestUserId(
        'loggedin-group-visibility',
      );
      var uniqueStringB = TestsUtil.generateTestUserId(
        'loggedin-group-visibility',
      );
      var uniqueStringC = TestsUtil.generateTestUserId(
        'loggedin-group-visibility-skywalker',
      );
      ...
      TestsUtil.createTenantWithAdmin(privateTenantAlias, tenantHost, function(
        err,
        privateTenant,
        ...
        ConfigTestUtil.updateConfigAndWait(
          ...
          function(err) {
            ...
            TestsUtil.generateTestUsers(
              privateTenantAdminRestContext,
              1,
              function(err, users, lukeSkywalker) {
                assert.ok(!err);
                ...
                RestAPI.Group.createGroup(
                  ...
                  [],
                  [],
                  function(err, privateTenantGroup) {
                    assert.ok(!err);
          ...
          RestAPI.User.createUser(
            ...
            function(err, simonTheGreat) {
              ...
              SearchTestsUtil.searchRefreshed(
                ...
                function(err, results) {
                  assert.ok(!err);
                  var simonGaeremynckIndex = indexOfDocument(
                    results,
                    simonGaeremynck.id,
                  );
                  var simonTheGreatIndex = indexOfDocument(
                    results,
                    simonTheGreat.id,
                  );
  ...
  describe('Search Options', function() {
              ...
              function(err, content) {
                ...
                SearchTestsUtil.searchRefreshed(
                  ...
                  function(err, results) {
                    ...
                    assert.equal(
                      _.filter(results.results, function(result) {
    ...
    it('verify limit parameter validation', function(callback) {
      TestsUtil.generateTestUsers(camAdminRestContext, 35, function(
        err,
        users,
      ) {
        assert.ok(!err);
