...
var DEFAULT_MAIL_GRACE_PERIOD = 60; // 1 minute
...
var refreshConfiguration = (module.exports.refreshConfiguration = function(
  ...
  config = {
    ...
    activityTtl: OaeUtil.getNumberParam(
      _config.activityTtl,
      DEFAULT_ACTIVITY_TTL,
    ),
    ...
    collectionExpiry: OaeUtil.getNumberParam(
      _config.collectionExpiry,
      DEFAULT_COLLECTION_EXPIRY,
    ),
    ...
    mail: {
      ...
      gracePeriod: OaeUtil.getNumberParam(
        _config.mail.gracePeriod,
        DEFAULT_MAIL_GRACE_PERIOD,
      ),
      daily: {
        hour: OaeUtil.getNumberParam(
          _config.mail.daily.hour,
          DEFAULT_MAIL_DAILY_HOUR,
        ),
      },
      weekly: {
        day: OaeUtil.getNumberParam(
          _config.mail.weekly.day,
          DEFAULT_MAIL_WEEKLY_DAY,
        ),
        hour: OaeUtil.getNumberParam(
          _config.mail.weekly.hour,
          DEFAULT_MAIL_WEEKLY_HOUR,
        ),
      },
    },
