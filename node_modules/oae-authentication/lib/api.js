...
/**
 * Create a private tenant administrator user in the database with the provided login id
 *
 * @param  {Context}    ctx                 The current context
...
/**
 * Create a user in the database with the provided login id
 *
 * @param  {Context}    ctx                 The current context
 * @param  {LoginId}    loginId             The login id that will be associated with the user so they may log in
 * @param  {String}     displayName         The user's display name
...
/**
 * Internal utility function to create a user in the database. Validation on inputs should be performed
