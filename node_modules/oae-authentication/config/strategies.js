...
module.exports = {
    ...
    'ldap': {
        ...
        'elements': {
            ...
            'host': new Fields.Text('Host', 'The host or IP at which the LDAP server can be reached', '', {'suppress': true}),
            'port': new Fields.Text('Name', 'The port at which the LDAP server can be reached', '', {'suppress': true}),
            'ssl': new Fields.Bool('SSL', 'Whether or not a connection should be made over SSL', false, {'suppress': true}),
            'adminDn': new Fields.Text('Admin Distinguished Name', 'The DN that identifies an admin user. E.g. uid=admin,ou=users,o=example.com', '', {'suppress': true}),
            'adminPassword': new Fields.Text('Admin password', 'The password for the admin DN', '', {'suppress': true}),
            'searchBase': new Fields.Text('Base', 'The base DN from which to search for users by username. E.g. ou=users,o=example.com', '', {'suppress': true}),
            'searchFilter': new Fields.Text('Filter', 'LDAP search filter with which to find a user by username, e.g. (uid={{username}}). Use the literal `{{username}}` to have the given username be interpolated in for the LDAP search.', '', {'suppress': true}),
