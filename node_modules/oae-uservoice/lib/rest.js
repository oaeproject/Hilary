...
/**
 * @REST tenantPostUservoiceRedirect
 *
 * Redirect the current user to the UserVoice forum so they may browse it and post feedback
 *
 * @Server      tenant
 * @Method      POST
 * @Path        /uservoice/redirect
 * @Return      {void}                Returns an HTTP status of 302 (Moved Temporarily) and redirects to UserVoice site
 */
