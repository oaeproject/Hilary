...
const Activity = require('oae-activity/lib/model').Activity;
const ActivityConstants = require('oae-activity/lib/constants').ActivityConstants;
const ActivityEntity = require('oae-activity/lib/model').ActivityEntity;
...
const collectAllBuckets = function(callback) {
  ...
  const collectionExpiry = ActivitySystemConfig.getConfig().collectionExpiry;
                ...
                ActivityDAO.deleteActivities(activitiesToDelete, err => {
                  ...
                  ActivityDAO.indexAggregateData(statusUpdatesByActivityStreamId, err => {
                    ...
                    _.each(routedActivities, routedActivity => {
                      ...
                      const resourceId = activityStream.resourceId;
                      const streamType = activityStream.streamType;
...
const createAggregates = function(routedActivities) {
  ...
  _.each(routedActivities, routedActivity => {
    ...
    const route = routedActivity.route;
    const activity = routedActivity.activity;
