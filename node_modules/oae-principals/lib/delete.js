 ...
 */
const registerGroupDeleteHandler = (module.exports.registerGroupDeleteHandler = function(
  name,
  handler
) {
 ...
 */
const registerGroupRestoreHandler = (module.exports.registerGroupRestoreHandler = function(
  name,
  handler
) {
