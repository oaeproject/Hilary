 ...
 * @HttpResponse                400                     Only manager or member are accepted as a role for a principal
 * @HttpResponse                400                     Only valid principal IDs are accepted
 * @HttpResponse                400                     The joinable setting must be one of: ...
 * @HttpResponse                400                     The visibility setting must be one of: ...
 ...
 * @HttpResponse                400                 ... is not a recognized group profile field
 * @HttpResponse                400                 A description can only be 10000 characters long
 * @HttpResponse                400                 A display name can be at most 1000 characters long
 ...
 * @HttpResponse                400                 The joinable setting must be one of: ...
 * @HttpResponse                400                 The visibility setting must be one of: ...
 * @HttpResponse                400                 You should specify at least one field
 * @HttpResponse                401                 Permission denied
 * @HttpResponse                401                 You have to be logged in to be able to update a group
 */
 ...
 * @HttpResponse                        401             You are not authorized to make these users a member of the group: ...
 * @HttpResponse                        401             You are not authorized to update the members of this group
 * @HttpResponse                        401             You have to be logged in to be able to update group membership
 */
