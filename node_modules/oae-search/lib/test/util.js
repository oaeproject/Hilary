 ...
 */
var reindexAll = (module.exports.reindexAll = function(
  globalAdminRestCtx,
  callback,
) {
 ...
 */
var assertSearchSucceeds = (module.exports.assertSearchSucceeds = function(
  restCtx,
  searchType,
  params,
  opts,
  ...
  whenIndexingComplete(function() {
    RestAPI.Search.search(restCtx, searchType, params, opts, function(
      err,
      response,
    ) {
      assert.ok(!err);
 ...
 */
var assertSearchContains = (module.exports.assertSearchContains = function(
  restCtx,
  searchType,
  params,
  opts,
 ...
 */
var assertSearchNotContains = (module.exports.assertSearchNotContains = function(
  restCtx,
  searchType,
  params,
  opts,
 ...
 */
var assertSearchEquals = (module.exports.assertSearchEquals = function(
  restCtx,
  searchType,
  params,
  opts,
  ...
  searchAll(restCtx, searchType, params, opts, function(err, response) {
    assert.ok(!err);
    assert.deepEqual(
      _.pluck(response.results, 'id').sort(),
 ...
 */
var assertSearchFails = (module.exports.assertSearchFails = function(
  restCtx,
  searchType,
  params,
  opts,
 ...
 * @see RestAPI.Search#search for the meaning of the method parameters.
 */
var searchAll = (module.exports.searchAll = function(
  restCtx,
  searchType,
  params,
  opts,
 ...
 */
var whenIndexingComplete = (module.exports.whenIndexingComplete = function(
  callback,
) {
 ...
 * @see RestAPI.Search#search for the meaning of the method parameters.
 */
var searchRefreshed = (module.exports.searchRefreshed = function(
  restCtx,
  searchType,
  params,
  opts,
