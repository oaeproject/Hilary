...
describe('Profiles', function() {
    ...
    var createUsers = function(callback) {
        ...
        PrincipalAPI.createUser(_anonymousContext, simon.username, 'password', simon.privacy, simon.locale, simon.timezone, simon.firstName, simon.lastName, simon.displayName, function(err, userId) {
            assert.ok(!err);
            simon.id = userId;
            var simonContext = new Context(_tenant, simon);

            PrincipalAPI.createUser(_anonymousContext, bert.username, 'password', bert.privacy, bert.locale, bert.timezone, bert.firstName, bert.lastName, bert.displayName, function(err, userId) {
                assert.ok(!err);
                bert.id = userId;
