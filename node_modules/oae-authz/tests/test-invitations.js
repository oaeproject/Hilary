...
describe('Invitations', function() {
    ...
    var resourceFns = {
        ...
        'discussion': {
            'createSucceeds': _.partial(DiscussionsTestUtil.assertCreateDiscussionSucceeds, _, randomString, randomString, _, _, _, _, _),
            'createFails': _.partial(DiscussionsTestUtil.assertCreateDiscussionFails, _, randomString, randomString, _, _, _, _, _, _),
    ...
    var _testInvitationsAuthorizationForPublicShare = function(fns, publicTenant0, publicTenant1, privateTenant0, callback) {
        ...
        fns.createSucceeds(managerUser.restContext, 'public', [], [viewerUser.user.id], function(resource) {
            ...
            fns.shareSucceeds(managerUser.restContext, managerUser.restContext, resource.id, [_emailForTenant(publicTenant0)], function() {
                fns.shareSucceeds(managerUser.restContext, managerUser.restContext, resource.id, [_emailForTenant(publicTenant1)], function() {
                    fns.shareSucceeds(managerUser.restContext, managerUser.restContext, resource.id, ['thisemail0@defaultstoguest.local'], function() {
                        fns.shareFails(managerUser.restContext, managerUser.restContext, resource.id, [_emailForTenant(privateTenant0)], 401, function() {
                            // Ensure viewer user can invite users from all tenants except private
                            fns.shareSucceeds(managerUser.restContext, viewerUser.restContext, resource.id, [_emailForTenant(publicTenant0)], function() {
                                fns.shareSucceeds(managerUser.restContext, viewerUser.restContext, resource.id, [_emailForTenant(publicTenant1)], function() {
                                    fns.shareSucceeds(managerUser.restContext, viewerUser.restContext, resource.id, ['thisemail1@defaultstoguest.local'], function() {
                                        fns.shareFails(managerUser.restContext, viewerUser.restContext, resource.id, [_emailForTenant(privateTenant0)], 401, function() {
                                            return callback();
                                        });
                                    });
                                });
                ...
                fns.shareSucceeds(managerUser.restContext, managerUser.restContext, resource.id, [_emailForTenant(publicTenant1)], function() {
                    fns.shareSucceeds(managerUser.restContext, managerUser.restContext, resource.id, ['thisemail0@defaultstoguest.local'], function() {
                        fns.shareFails(managerUser.restContext, managerUser.restContext, resource.id, [_emailForTenant(privateTenant0)], 401, function() {
                            ...
                            fns.shareSucceeds(managerUser.restContext, viewerUser.restContext, resource.id, [_emailForTenant(publicTenant0)], function() {
                                fns.shareFails(managerUser.restContext, viewerUser.restContext, resource.id, [_emailForTenant(publicTenant1)], 401, function() {
                ...
                fns.shareSucceeds(managerUser.restContext, managerUser.restContext, resource.id, [_emailForTenant(publicTenant1)], function() {
                    fns.shareSucceeds(managerUser.restContext, managerUser.restContext, resource.id, ['thisemail@defaultstoguest.local'], function() {
                        fns.shareFails(managerUser.restContext, managerUser.restContext, resource.id, [_emailForTenant(privateTenant0)], 401, function() {
                            ...
                            fns.shareFails(managerUser.restContext, viewerUser.restContext, resource.id, [_emailForTenant(publicTenant0)], 401, function() {
                                fns.shareFails(managerUser.restContext, viewerUser.restContext, resource.id, [_emailForTenant(publicTenant1)], 401, function() {
        ...
        TestsUtil.setupMultiTenantPrivacyEntities(function(publicTenant0, publicTenant1, privateTenant0) {
            ...
            fns.createSucceeds(managerUser.restContext, 'public', [], [viewerUser.user.id], function(resource) {
                ...
                fns.setRolesFails(managerUser.restContext, viewerUser.restContext, resource.id, {'email1@oae.local': memberRole}, 401, function() {
                    ...
                    rolesSameTenant[_emailForTenant(publicTenant0)] = memberRole;
                    rolesExternalPublicTenant[_emailForTenant(publicTenant1)] = memberRole;
                    rolesExternalPrivateTenant[_emailForTenant(privateTenant0)] = memberRole;
