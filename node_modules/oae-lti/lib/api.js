...
var LtiToolLaunchParams = require('oae-lti/lib/model').LtiToolLaunchParams;
        ...
        PrincipalsApi.getMe(ctx, function(err, principal) {
            ...
            VersionAPI.getVersion(function(err, version) {
                ...
                LtiDAO.getLtiTool(id, groupId, function(err, tool) {
                    ...
                    var launchParams = new LtiLaunchParams(tool, version.hilary.version, group.tenant.alias, group.displayName, group.isManager, groupId, principal);
