...
var encoder = require('node-esapi').encoder();
 ...
 */
var encodeForHTML = module.exports.encodeForHTML = function(value) {
    if (!value) {
        return '';
    }
 ...
 */
var encodeForHTMLAttribute = module.exports.encodeForHTMLAttribute = function(value) {
    if (!value) {
        return '';
    }
 ...
 */
var encodeForURL = module.exports.encodeForURL = function(value) {
    if (!value) {
        return '';
    }
