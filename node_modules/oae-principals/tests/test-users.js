...
describe('Users', function() {
    ...
    describe('Create user', function() {
        ...
        /**
         * Test that verifies that the default tenant timezone is used when creating a user without an email preference
         */
        it('verify timezone preference defaults to the tenant default when created', function(callback) {
            var camTenantAlias = global.oaeTests.tenants.cam.alias;
    ...
    describe('Import users', function() {
        ...
        it('verify import local users and display name override', function(callback) {
            ...
            TestsUtil.createTenantWithAdmin(tenantAlias, tenantHost, function(err, tenant, tenantAdminRestContext) {
                ...
                PrincipalsTestsUtil.importUsers(globalAdminRestContext, tenant.alias, getDataFileStream('users-with-password.csv'), 'local', null, function(err) {
                    assert.ok(!err);
                                ...
                                RestAPI.User.getMe(stephenRestContext, function(err, stephenMeObj) {
                                    ...
                                    RestAPI.User.updateUser(nicolaasRestContext, nicolaasMeObj.id, {'displayName': 'user-zfdHliPLa'}, function (err, user) {
                                        ...
                                        RestAPI.User.getMe(nicolaasRestContext, function(err, nicolaasMeObj) {
                                            ...
                                            PrincipalsTestsUtil.importUsers(tenantAdminRestContext, null, getDataFileStream('users-with-password.csv'), 'local', null, function(err) {
                                                assert.ok(!err);
                                                        ...
                                                        RestAPI.User.getMe(nicolaasRestContext, function(err, nicolaasMeObj) {
                                                            ...
                                                            PrincipalsTestsUtil.importUsers(tenantAdminRestContext, null, getDataFileStream('users-with-password.csv'), 'local', null, function(err) {
                                                                ...
                                                                RestAPI.User.getMe(nicolaasRestContext, function(err, nicolaasMeObj) {
                                                                    ...
                                                                    PrincipalsTestsUtil.importUsers(tenantAdminRestContext, null, getDataFileStream('users-with-password.csv'), 'local', true, function(err) {
                                                                        assert.ok(!err);
        ...
        it('verify import local users respects default user visibility of the tenant', function(callback) {
            ...
            TestsUtil.createTenantWithAdmin(tenantAlias, tenantHost, function(err, tenant, tenantAdminRestContext) {
                ...
                PrincipalsTestsUtil.importUsers(globalAdminRestContext, tenant.alias, getDataFileStream('users-default-visibility-test1.csv'), 'local', null, function(err) {
                    assert.ok(!err);
                    ...
                    RestAPI.User.getMe(mrvisser1RestContext, function(err, createdUser) {
                        ...
                        ConfigTestUtil.updateConfigAndWait(globalAdminRestContext, tenant.alias, {'oae-principals/user/visibility': 'loggedin'}, function(err) {
                            ...
                            PrincipalsTestsUtil.importUsers(globalAdminRestContext, tenant.alias, getDataFileStream('users-default-visibility-test2.csv'), 'local', null, function(err) {
                                assert.ok(!err);
        ...
        it('verify import external users', function(callback) {
            ...
            TestsUtil.createTenantWithAdmin(tenantAlias, tenantHost, function(err, tenant, tenantAdminRestContext) {
                ...
                PrincipalsTestsUtil.importUsers(globalAdminRestContext, tenant.alias, getDataFileStream('users-without-password.csv'), 'cas', null, function(err) {
                    assert.ok(!err);
                                                    ...
                                                    RestAPI.User.getUser(tenantAdminRestContext, stuartUserId, function(err, stuartUserObj) {
                                                        ...
                                                        RestAPI.User.updateUser(tenantAdminRestContext, nicolaasUserId, {'displayName': 'user-TGdDSdadW'}, function (err, user) {
                                                            ...
                                                            RestAPI.User.getUser(tenantAdminRestContext, nicolaasUserId, function(err, nicolaasUserObj) {
                                                                ...
                                                                // Re-import the users to verify that the displayName is reverted back to the display name
                                                                // provided in the CSV file. This time, the import is attempted as a tenant admin
                                                                PrincipalsTestsUtil.importUsers(tenantAdminRestContext, null, getDataFileStream('users-without-password.csv'), 'cas', null, function(err) {
                                                                    assert.ok(!err);
                                                                            ...
                                                                            RestAPI.User.getUser(tenantAdminRestContext, nicolaasUserId, function(err, nicolaasUserObj) {
                                                                                ...
                                                                                PrincipalsTestsUtil.importUsers(tenantAdminRestContext, null, getDataFileStream('users-without-password.csv'), 'cas', null, function(err) {
                                                                                    ...
                                                                                    RestAPI.User.getUser(tenantAdminRestContext, nicolaasUserId, function(err, nicolaasUserObj) {
                                                                                        ...
                                                                                        // Re-import the users using the `forceProfileUpdate` flag to verify that the displayName is reverted to
                                                                                        // the display name provided in the CSV file
                                                                                        PrincipalsTestsUtil.importUsers(tenantAdminRestContext, null, getDataFileStream('users-without-password.csv'), 'cas', true, function(err) {
                                                                                            assert.ok(!err);
                ...
                RestAPI.User.setTenantAdmin(camAdminRestContext, simon.user.id, true, function(err) {
                    ...
                    RestAPI.Admin.loginAsUser(simon.restContext, mrvisser.user.id, util.format('http://%s', global.oaeTests.tenants.localhost.host), function(err, simonImpersonatingMrvisserRestContext) {
                        ...
                        RestAPI.User.getMe(simonImpersonatingMrvisserRestContext, function(err, me) {
                            ...
                            assert.ok(me.locale);
                            assert.equal(me.locale.locale, mrvisser.user.locale);
                            assert.ok(me.locale.timezone);
                            assert.equal(me.locale.timezone.name, mrvisser.user.timezone);
                            ...
                            assert.equal(me.imposter.timezone, simon.user.timezone);
    ...
    describe('Update user', function() {
        ...
        */
        ...
        /**
         * Test that verifies the parameters when updating a user
         */
        it('verify parameter validation', function(callback) {
            TestsUtil.generateTestUsers(camAdminRestContext, 1, function(err, users, simong) {
                assert.ok(!err);

                // Verify an invalid user id
                RestAPI.User.updateUser(simong.restContext, 'invalid userid', {'displayName': 'Simon'}, function(err) {
                    assert.equal(err.code, 400);

                    // Verify an empty update is invalid
                    RestAPI.User.updateUser(simong.restContext, simong.user.id, {}, function(err) {
                        assert.equal(err.code, 400);

                        // Verify an incorrect visibility is invalid
                        RestAPI.User.updateUser(simong.restContext, simong.user.id, {'visibility': 'so incorrect'}, function(err) {
                            assert.equal(err.code, 400);

                            // Verify an incorrect timezone is invalid
                            RestAPI.User.updateUser(simong.restContext, simong.user.id, {'timezone': 'so incorrect'}, function(err) {
                                assert.equal(err.code, 400);

                                // Verify an incorrect email preference is invalid
                                RestAPI.User.updateUser(simong.restContext, simong.user.id, {'emailPreference': 'so incorrect'}, function(err) {
                                    assert.equal(err.code, 400);

                                    // Sanity check
                                    RestAPI.User.updateUser(simong.restContext, simong.user.id, {'displayName': 'Simon'}, function(err) {
                                        assert.ok(!err);
                                        return callback();
                                    });
                                });
