...
describe('General Search', function() {
    ...
    describe('Search Quality', function() {
        ...
        it('verify displayName matches are boosted across spaces', function(callback) {
            ...
            RestAPI.User.createUser(camAdminRestContext, TestsUtil.generateRandomText(1), 'password', 'Simon Gaeremynck', {'email': email1}, function(err, simonGaeremynck) {
                assert.ok(!err);
                RestAPI.User.createUser(gtAdminRestContext, TestsUtil.generateRandomText(1), 'password', 'Simon The Great', {'email': email2}, function(err, simonTheGreat) {
                    assert.ok(!err);
        ...
        it('verify documents from the same tenant are boosted', function(callback) {
            ...
            var email1 = TestsUtil.generateTestEmailAddress();
            var email2 = TestsUtil.generateTestEmailAddress();
            RestAPI.User.createUser(camAdminRestContext, username, 'password', displayName, {'email': email1}, function(err, camUser) {
                assert.ok(!err);
                RestAPI.User.createUser(gtAdminRestContext, username, 'password', displayName, {'email': email2}, function(err, gtUser) {
                    assert.ok(!err);
