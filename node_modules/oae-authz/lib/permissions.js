...
var canManage = module.exports.canManage = function(ctx, resource, callback) {
    ...
    AuthzAPI.resolveImplicitRole(user, resource, [AuthzConstants.role.VIEWER, AuthzConstants.role.MANAGER], function(err, implicitRole, canInteract) {
        if (err) {
            return callback(err);
...
var canRemoveRole = module.exports.canRemoveRole = function(ctx, principal, resource, callback) {
    canManage(ctx, principal, function(err) {
        ...
        _validateRoleChanges(ctx, resource, {'principalRoles': principalRoles}, function(err, memberRoles, newMembers, updatedMembers, removedMembers) {
            if (err) {
                return callback(err);
