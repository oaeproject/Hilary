 ...
 */
const createUser = module.exports.createUser = function(user, callback) {
    const queries = [];
 ...
 */
const createGroup = module.exports.createGroup = function(groupId, tenantAlias, displayName, description, visibility, joinable, createdBy, callback) {
    ...
    const query = 'INSERT INTO "Principals" ("principalId", "tenantAlias", "displayName", "description", "visibility", "joinable", "lastModified", "createdBy", "created") VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)';
    const parameters = [groupId, tenantAlias, displayName, description, visibility, joinable, lastModified, createdBy, created];
 ...
 */
const getPrincipal = module.exports.getPrincipal = function(principalId, callback) {
 ...
 */
const getExistingPrincipals = module.exports.getExistingPrincipals = function(principalIds, fields, callback) {
 ...
 * @param  {Object}     callback.err    An error that occurred, if any
 */
const updatePrincipal = module.exports.updatePrincipal = function(principalId, profileFields, callback) {
 ...
 * @param  {Object}     callback.err    An error that occurred, if any
 */
const deletePrincipal = module.exports.deletePrincipal = function(principalId, callback) {
 ...
 * @param  {Object}     callback.err    An error that occurred, if any
 */
const restorePrincipal = module.exports.restorePrincipal = function(principalId, callback) {
 ...
 * @param  {Object}     callback.err    An error that occurred, if any
 */
const acceptTermsAndConditions = module.exports.acceptTermsAndConditions = function(userId, callback) {
    Cassandra.runQuery('UPDATE "Principals" SET "acceptedTC" = ? WHERE "principalId" = ?', [Date.now().toString(), userId], (err) => {
        if (err) {
            return callback(err);
        }
 ...
 * @param  {Object}         callback.err    An error that occurred, if any
 */
const setAdmin = module.exports.setAdmin = function(adminType, isAdmin, userId, callback) {
    ...
    Cassandra.runQuery(util.format('UPDATE "Principals" SET "%s" = ? WHERE "principalId" = ?', adminType), [sanitize(isAdmin).toBooleanStrict().toString(), userId], (err) => {
        if (err) {
            return callback(err);
        }
 ...
 */
const getEmailToken = module.exports.getEmailToken = function(userId, callback) {
 ...
 * @param  {Object}     callback.err        An error that occurred, if any
 */
const deleteEmailToken = module.exports.deleteEmailToken = function(userId, callback) {
 ...
 */
const getUserIdsByEmails = module.exports.getUserIdsByEmails = function(emails, callback) {
 ...
 * @param  {Object}     callback.err    An error object, if any
 */
const storeEmailToken = module.exports.storeEmailToken = function(userId, email, token, callback) {
    const q = Cassandra.constructUpsertCQL('PrincipalsEmailToken', 'principalId', userId, {email, token});
 ...
 */
const setEmailAddress = module.exports.setEmailAddress = function(user, email, callback) {
    const queries = [];
 ...
 */
const iterateAll = module.exports.iterateAll = function(properties, batchSize, onEach, callback) {
 ...
 */
const isGroup = module.exports.isGroup = function(groupId) {
 ...
 */
const getRestrictedFields = module.exports.getRestrictedFields = function() {
 ...
 * @param  {Object}     callback.err    An error object, if any
 */
const setLatestVisit = module.exports.setLatestVisit = function(user, group, visit, callback) {
    const q = Cassandra.constructUpsertCQL('UsersGroupVisits', ['userId', 'groupId'], [user.id, group.id], {'latestVisit': visit.getTime().toString()});
 ...
 */
const getVisitedGroups = module.exports.getVisitedGroups = function(userId, callback) {
    if (isUser(userId)) {
 ...
 * @api private
 */
const getAllUsersForTenant = module.exports.getAllUsersForTenant = function(tenantAlias, callback) {
