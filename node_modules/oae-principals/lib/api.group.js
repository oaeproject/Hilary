...
var setGroupMembers = module.exports.setGroupMembers = function(ctx, groupId, memberChanges, callback) {
    ...
    PrincipalsDAO.getPrincipal(groupId, function(err, group) {
        ...
        ResourceActions.setRoles(ctx, group, memberChanges, function(err, computedPermissions, newMembers, updatedMembers, removedMembers) {
            if (err) {
                return callback(err);
            }
...
var createGroup = module.exports.createGroup = function(ctx, displayName, description, visibility, joinable, permissions, callback) {
    ...
    permissions[ctx.user().id] = PrincipalsConstants.roles.MANAGER;
    ...
    ResourceActions.create(ctx, permissions, createFn, function(err, group) {
        if (err) {
            return callback(err);
        }
