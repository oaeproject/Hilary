 ...
 *
 * @param  {String[]}   [properties]            The names of the folder properties to return in the folder objects. If not specified (or is empty array), it returns just the `folderId`s
