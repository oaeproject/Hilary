    ...
    describe('Configuration', function() {
        ...
        it('verify get global config', function(callback) {
            RestAPI.Config.getTenantConfig(globalAdminRestContext, null, function(err, config) {
                ...
                console.log(config);
                assert.ok(config);
                assert.ok(config['oae-authentication']['twitter']['enabled']);
                callback();
            });
        });
        ...
        it('verify get tenant config through global server', function(callback) {
            RestAPI.Config.getTenantConfig(globalAdminRestContext, 'camtest', function(err, config) {
                assert.ok(!err);
                assert.ok(config);
        ...
        it('verify set tenant config value through global server', function(callback) {
            RestAPI.Config.updateConfig(globalAdminRestContext, 'camtest', 'oae-authentication/twitter/enabled', false, function(err) {
                assert.ok(!err);
