 ...
 */
var Content = module.exports.Content = function(tenantAlias, id, visibility, displayName, description, resourceSubType, createdBy, created, lastModified, latestRevisionId, previews, extra) {
    var that = {};
    ...
    that.extra = (_.isObject(extra)) ? extra : {};
