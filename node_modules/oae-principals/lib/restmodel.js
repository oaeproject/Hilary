...
/**
 * @RESTModel Permissions
 *
 * @Required    []
 * @Property    {string}        {principalId}           Permission for specified user/group, may be repeated for multiple principals [false,manager,viewer]
 */
 ...
 * @Property    {string}        email                   Email address for user
 * @Property    {string}        emailPreference         Email preferences for user      [daily,immediate,weekly]
 * @Property    {FollowingInfo} following               Following information (if requested user is not logged in user)
