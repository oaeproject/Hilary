 ...
 * @param  {Object}     [options.association]                               The description of the search association document to use for filtering library entities
 * @param  {String}     [options.association.name]                          The name of the resource document type that holds the library association
 * @param  {String}     [options.association.field]                         The name of the document field that holds the library association
