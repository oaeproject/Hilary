...
OAE.tenantServer.post('/api/user/create', function(req, res) {
    ...
    var createUser = function() {
        ...
        // The accept-language is all lower case comma delimited so we need to change something like `en-us,en` to `en_US`
        var browserLocale;
        if (req.headers['accept-language']) {
            browserLocale = req.headers['accept-language'].split(',')[0].replace(/-([^-]*$)/, function(match, capture) {
        ...
        var opts = {
            ...
            'locale': req.body.locale || browserLocale,
