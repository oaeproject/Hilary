...
var storePicture = module.exports.storePicture = function(ctx, principalId, file, callback) {
    ...
    _canManagePrincipal(ctx, principalId, function(err, principal) {
         ...
         * the correct mimetype and it can be spoofed. If the mimetype cannot be determined, the mime utility falls
         * back to application/octet-stream.
         */
        file.type = mime.lookup(file.name);

        // Only images can be uploaded
        if (!_.contains(['image/jpg', 'image/jpeg', 'image/png', 'image/gif', 'image/bmp'], file.type)) {
