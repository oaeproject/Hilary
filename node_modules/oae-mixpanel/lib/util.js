...
/**
 * Create an exporter options object
 ...
 * @return {Object}                 The exporter options object
 */
var createExporterOptions = module.exports.createExporterOptions = function(eventName, alias, params) {
    params = params || {};

    // Basic exporter options object to send to MixPanel
    var options = {
