 ...
 * @param  {Object}     callback.err        An error that occurred, if any
 */
var updateClient = (module.exports.updateClient = function(
  id,
  displayName,
  secret,
  callback,
 ...
 * @param  {Object}     callback.err    An error that occurred, if any
 */
var deleteClient = (module.exports.deleteClient = function(
  id,
  userId,
  callback,
) {
  var queries = [
    ...
    {
      query:
        'DELETE FROM "OAuthClientsByUser" WHERE "userId" = ? AND "clientId" = ?',
 ...
 */
var getClientsByUser = (module.exports.getClientsByUser = function(
  userId,
  callback,
) {
  Cassandra.runQuery(
    ...
    function(err, rows) {
      ...
      var clientIds = _.map(rows, function(row) {
