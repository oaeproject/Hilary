    ...
    describe('Discussions Library', function() {
        ...
        it('verify discussion user library privacy', function(callback) {
            DiscussionsTestsUtil.setupMultiTenantPrivacyEntities(function(publicTenant, publicTenant1, privateTenant, privateTenant1) {
                ...
                DiscussionsTestsUtil.assertUpdateDiscussionMembersSucceeds(publicTenant.adminRestContext, publicTenant.adminRestContext, publicTenant.publicDiscussion.id, updatePermissions, function() {
                                ...
                                RestAPI.Discussions.getDiscussionsLibrary(publicTenant1.publicUser.restContext, publicTenant.publicUser.user.id, null, null, function(err, items) {
                                    ...
                                    RestAPI.Discussions.getDiscussionsLibrary(publicTenant1.anonymousRestContext, publicTenant.publicUser.user.id, null, null, function(err, items) {
                                        ...
                                        RestAPI.Discussions.getDiscussionsLibrary(publicTenant1.adminRestContext, publicTenant.publicUser.user.id, null, null, function(err, items) {
                                            ...
                                            DiscussionsTestsUtil.assertUpdateDiscussionSucceeds(publicTenant.publicUser.restContext, publicTenant.publicDiscussion.id, {'visibility': 'loggedin'}, function() {
                                                            ...
                                                            RestAPI.Discussions.getDiscussionsLibrary(publicTenant1.publicUser.restContext, publicTenant.publicUser.user.id, null, null, function(err, items) {
                                                                ...
                                                                RestAPI.Discussions.getDiscussionsLibrary(publicTenant1.anonymousRestContext, publicTenant.publicUser.user.id, null, null, function(err, items) {
                                                                    ...
                                                                    RestAPI.Discussions.getDiscussionsLibrary(publicTenant1.adminRestContext, publicTenant.publicUser.user.id, null, null, function(err, items) {
                                                                        ...
                                                                        DiscussionsTestsUtil.assertUpdateDiscussionSucceeds(publicTenant.publicUser.restContext, publicTenant.publicDiscussion.id, {'visibility': 'private'}, function() {
                                                                            assert.ok(!err);
                                        ...
                                        RestAPI.Discussions.getDiscussionsLibrary(publicTenant.loggedinUser.restContext, publicTenant.loggedinUser.user.id, null, null, function(err, items) {
                                            ...
                                            RestAPI.Discussions.shareDiscussion(publicTenant.publicUser.restContext, publicTenant.loggedinDiscussion.id, [publicTenant.loggedinUser.user.id], function(err) {
                                                ...
                                                RestAPI.Discussions.removeDiscussionFromLibrary(publicTenant.publicUser.restContext, publicTenant.loggedinUser.user.id, publicTenant.loggedinDiscussion.id, function(err) {
                                                    assert.ok(err);
                                                    assert.equal(err.code, 401, JSON.stringify(err));
                        ...
                        RestAPI.Discussions.getDiscussion(user.restContext, discussion.id, function(err, discussion) {
                            ...
                            DiscussionsDAO.updateDiscussion(discussion, {'lastModified': lastModified0}, function(err, discussion) {
                                ...
                                RestAPI.Discussions.createMessage(user.restContext, discussion.id, 'My message', null, function(err, message) {
                                    ...
                                    // Wait a bit until the async process of touching the discussion has been processed
                                    setTimeout(function() {
