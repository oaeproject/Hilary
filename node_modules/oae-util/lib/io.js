 ...
 */
const getFileListForFolder = module.exports.getFileListForFolder = function(foldername, callback) {
 ...
 * @param  {Object}   callback.err  An error that occurred, if any
 */
const copyFile = module.exports.copyFile = function(source, dest, callback){
 ...
 * @param  {Object}   callback.err  An error that occurred, if any
 */
const moveFile = module.exports.moveFile = function(source, dest, callback){
 ...
 */
var destroyStream = module.exports.destroyStream = function(stream) {
 ...
 */
const exists = module.exports.exists = function(path, callback) {
    fs.open(path, 'r', (err) => {
        if (err) {
            if (err.code === 'ENOENT') {
