...
describe('Messagebox', function() {
  ...
  describe('#createMessage', function() {
    ...
    it('verify parameter validation', function(callback) {
      // Missing messagebox.
      MessageBoxAPI.createMessage(null, 'u:camtest:foo', 'body', {}, function(
        err,
        message,
      ) {
        ...
        MessageBoxAPI.createMessage('boxId', null, 'body', {}, function(
          err,
          message,
        ) {
          assert.equal(err.code, 400);
    ...
    it('verify replacing bare, absolute OAE links in new message', function(callback) {
      ...
      TestsUtil.createTenantWithAdmin(newTenantAlias, tenantHost, function(
        err,
        tenant,
                          ...
                          function(err, message) {
                            ...
                            MessageBoxAPI.getMessagesFromMessageBox(
                              ...
                              function(err, messages) {
                                ...
                                var quotedMarkdown = util.format(
                                  '`%s` ` text %s`\n    %s\n\n    %s\n    text %s',
                                  httpsUrl,
                                  httpsUrl,
                                  httpsUrl,
                                ...
                                MessageBoxAPI.createMessage(
                                  ...
                                  function(err, message) {
                                    ...
                                    MessageBoxAPI.getMessagesFromMessageBox(
                                      ...
                                      function(err, messages) {
                                        assert.ok(!err);
                                        var quotedExpected = util.format(
                                          '`%s` ` text %s`\n    %s\n\n    %s\n    text %s',
                                          httpsUrl,
                                          httpsUrl,
                                          markdownPath,
  ...
  describe('#updateMessageBody', function() {
     ...
     */
    it('verify replacing absolute links in updated message', function(callback) {
      var url = '/path/-Z9+&@#%=~_|!:,.;/file?query=parameter#hash';
      var messageBoxId = util.format('msg-box-test-%s', ShortId.generate());
      MessageBoxAPI.createMessage(
        messageBoxId,
  ...
  describe('#getMessagesFromMessageBox', function() {
    ...
    it('verify parameter validation', function(callback) {
      ...
      MessageBoxAPI.getMessagesFromMessageBox(null, null, null, null, function(
        err,
        messages,
      ) {
        assert.equal(err.code, 400);
                        ...
                        function(err, deleteType, deletedMessage) {
                          ...
                          MessageBoxAPI.getMessagesFromMessageBox(
                            ...
                            function(err, messages) {
                              ...
                              var deletedMessage = _.find(messages, function(
                                message,
                              ) {
  ...
  describe('#deleteMessage', function() {
    ...
    it('verify parameter validation', function(callback) {
      ...
      // Missing messagebox.
      MessageBoxAPI.deleteMessage(null, Date.now() - 1000, {}, function(
        err,
        deleteType,
        message,
      ) {
        ...
        // Invalid timestamps
        MessageBoxAPI.deleteMessage(messageBoxId, null, {}, function(
          err,
          deleteType,
          message,
        ) {
          ...
          MessageBoxAPI.deleteMessage(
            ...
            'not a timestamp',
            {},
            function(err, deleteType, message) {
              assert.equal(err.code, 400);
              assert.ok(!message);
              MessageBoxAPI.deleteMessage(
                messageBoxId,
          ...
          function(err, deleteType, message) {
            ...
            MessageBoxAPI.getMessagesFromMessageBox(
              ...
              function(err, messages) {
                ...
                var a3Message = _.find(messages, function(message) {
