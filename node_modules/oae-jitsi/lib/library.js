 ...
 */
LibraryAPI.Search.registerLibrarySearch('meeting-jitsi-library', [
  'meeting-jitsi',
]);
 ...
 */
MeetingsAPI.when(MeetingsConstants.events.CREATED_MEETING, function(
  ctx,
  meeting,
  memberChangeInfo,
  callback,
 ...
 */
MeetingsAPI.when(MeetingsConstants.events.DELETED_MEETING, function(
  ctx,
  meeting,
  removedMemberIds,
  callback,
 ...
 */
MeetingsAPI.when(MeetingsConstants.events.UPDATED_MEETING_MEMBERS, function(
  ctx,
  meeting,
  memberChangeInfo,
  opts,
