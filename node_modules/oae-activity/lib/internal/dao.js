...
var queueUsersForEmail = module.exports.queueUsersForEmail = function(users, callback) {
    var buckets = {};
    _.each(users, function(emailPreference, userId) {
        var bucket = _createEmailBucketForUser(userId, emailPreference);
 ...
 */
var getQueuedUsersForEmail = module.exports.getQueuedUsersForEmail = function(bucketNumber, emailPreference, start, limit, callback) {
    var bucket = _createEmailBucket(bucketNumber, emailPreference);
 ...
 * @param  {Object}     callback.err    Standard error object, if any
 */
var unqueueUsersForEmail = module.exports.unqueueUsersForEmail = function(bucketNumber, users, callback) {
    var queries = [];
    _.each(users, function(user) {
        var bucket = _createEmailBucket(bucketNumber, user.preference);
