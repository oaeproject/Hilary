            ...
            createAndGetUser(anonymousContext, 'mrvisser', 'password', 'public', 'Branden', 'Visser', 'tr123', function(err, mrvisser) {
                ...
                createAndGetUser(anonymousContext, 'simong', 'password', 'loggedin', 'Simong', 'Gaeremynck', 'simong', function(err, simong) {
                    ...
                    createAndGetUser(anonymousContext, 'nico', 'password', 'private', 'Nicolaas', 'Matthijs', 'nico', function(err, nico) {
                        ...
                        PrincipalsAPI.createGroup(mrvisserCtx, "public-group", "Public group", "This is a test group", 'public', 'yes', [], {}, function(err, publicGroup) {
                            assert.ok(!err);
                            PrincipalsAPI.createGroup(mrvisserCtx, "loggeding-group", "Logged in group", "This is a test group", 'loggedin', 'yes', [], {}, function(err, loggedinGroup) {
                                assert.ok(!err);
                                    PrincipalsAPI.createGroup(mrvisserCtx, "private-group", "Private group", "This is a test group", 'private', 'yes', [], {}, function(err, privateGroup) {
                                    assert.ok(!err);

                                    // 2. Create a group and add all those members.
                                    PrincipalsAPI.createGroup(mrvisserCtx, "top-group", "Top group", "This is a test group", 'public', 'yes', [], {}, function(err, topGroup) {
                                        assert.ok(!err);
                                        var members = {};
