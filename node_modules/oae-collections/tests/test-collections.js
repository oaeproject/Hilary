...
describe('Collections', function() {
    ...
    describe('Create Collection', function() {
        ...
        it('verify collection creation', function(callback) {
            TestsUtil.generateTestUsers(camAdminRestContext, 3, function(err, users, mrvisser, stuartf, sathomas) {
                ...
                CollectionsTestUtil.assertCreateCollectionSucceeds(mrvisser.restContext, 'test displayName', 'test description', 'private', [stuartf], [sathomas], function(createdCollection) {
                                                    ...
                                                    CollectionsTestUtil.assertCreateCollectionFails(mrvisser.restContext, 'test displayName', 'test description', 'private', [stuartf.user.id], ['c:oaetest:contentid'], 400, function() {
                                                        ...
                                                        CollectionsTestUtil.assertCreateCollectionFails(mrvisser.restContext, 'test displayName', 'test description', 'private', [stuartf.user.id], ['u:oaetest:nonexistinguserid'], 400, function() {
                                                            CollectionsTestUtil.assertCreateCollectionFails(mrvisser.restContext, 'test displayName', 'test description', 'private', [stuartf.user.id], ['g:oaetest:nonexistinggroupid'], 400, function() {
                                                                ...
                                                                CollectionsTestUtil.assertCreateCollectionSucceeds(mrvisser.restContext, 'test displayName', 'test description', 'private', [stuartf], [sathomas], function() {
                                                                    return callback();
                                                                });
                                                            });
                                                        });
        ...
        it('verify collection creation authorization', function(callback) {
            CollectionsTestUtil.setupMultiTenantPrivacyEntities(function(publicTenant, publicTenant1, privateTenant, privateTenant1) {
                ...
                CollectionsTestUtil.assertCreateCollectionFails(camAnonymousRestContext, 'test', 'test', 'private', null, null, 401, function() {
                    ...
                    CollectionsTestUtil.assertCreateCollectionSucceeds(publicTenant.loggedinUser.restContext, 'test', 'test', 'private', [publicTenant.publicUser], null, function() {
                        CollectionsTestUtil.assertCreateCollectionSucceeds(publicTenant.publicUser.restContext, 'test', 'test', 'private', [publicTenant.loggedinUser], null, function() {
                            CollectionsTestUtil.assertCreateCollectionFails(publicTenant.publicUser.restContext, 'test', 'test', 'private', [publicTenant.privateUser.user.id], null, 400, function() {
                                ...
                                CollectionsTestUtil.assertCreateCollectionSucceeds(publicTenant.publicUser.restContext, 'test', 'test', 'private', [publicTenant1.publicUser], null, function() {
                                                        ...
                                                        CollectionsTestUtil.assertCreateCollectionFails(privateTenant.publicUser.restContext, 'test', 'test', 'private', [publicTenant.publicUser.user.id], null, 400, function() {
                                                            CollectionsTestUtil.assertCreateCollectionFails(privateTenant.publicUser.restContext, 'test', 'test', 'private', [publicTenant.loggedinUser.user.id], null, 400, function() {
                                                                CollectionsTestUtil.assertCreateCollectionFails(privateTenant.publicUser.restContext, 'test', 'test', 'private', [publicTenant.privateUser.user.id], null, 400, function() {
                                                                    ...
                                                                    CollectionsTestUtil.assertCreateCollectionSucceeds(publicTenant.adminRestContext, 'test', 'test', 'private', [publicTenant.publicUser], null, function() {
                                                                        CollectionsTestUtil.assertCreateCollectionSucceeds(publicTenant.adminRestContext, 'test', 'test', 'private', [publicTenant.loggedinUser], null, function() {
                                                                            CollectionsTestUtil.assertCreateCollectionSucceeds(publicTenant.adminRestContext, 'test', 'test', 'private', [publicTenant.privateUser], null, function() {

                                                                                // Ensure an admin cannot createa  collection with a loggedin or private user from another tenant as a viewer
                                                                                CollectionsTestUtil.assertCreateCollectionSucceeds(publicTenant.adminRestContext, 'test', 'test', 'private', [publicTenant1.publicUser], null, function() {
    ...
    describe('Get Collection', function() {
        ...
        it('verify get collection authorization', function(callback) {
            CollectionsTestUtil.setupMultiTenantPrivacyEntities(function(publicTenant, publicTenant1) {
                ...
                CollectionsTestUtil.assertShareCollectionSucceeds(publicTenant.adminRestContext, publicTenant.privateCollection.id, [publicTenant.privateUser], function(err) {

                    // Make the public user from a different tenant a member of a loggedin and private collection
                    CollectionsTestUtil.assertShareCollectionSucceeds(publicTenant1.adminRestContext, publicTenant1.loggedinCollection.id, [publicTenant.publicUser], function(err) {
                        CollectionsTestUtil.assertShareCollectionSucceeds(publicTenant1.adminRestContext, publicTenant1.privateCollection.id, [publicTenant.publicUser], function(err) {
                    ...
                    CollectionsTestUtil.assertGetCollectionSucceeds(publicTenant.adminRestContext, publicTenant.publicCollection.id, function(fetchedCollection) {
                        ...
                        CollectionsTestUtil.assertGetCollectionSucceeds(publicTenant.publicUser.restContext, createdCollection.id, function(fetchedCollection) {
                            ...
                            CollectionsTestUtil.assertGetCollectionSucceeds(publicTenant.publicUser.restContext, publicTenant.loggedinCollection.id, function(fetchedCollection) {
                                ...
                                CollectionsTestUtil.assertShareCollectionSucceeds(publicTenant.adminRestContext, publicTenant.privateCollection.id, [publicTenant.publicUser], function() {
    ...
    describe('Share Collection', function() {
        ...
        it('verify sharing with multiple users gives all access to a collection', function(callback) {
            CollectionsTestUtil.setupMultiTenantPrivacyEntities(function(publicTenant) {
                ...
                CollectionsTestUtil.assertShareCollectionSucceeds(publicTenant.adminRestContext, publicTenant.privateCollection.id, userInfosToShare, function() {
        ...
        it('verify sharing does not demote a member from manager to viewer', function(callback) {
            TestsUtil.generateTestUsers(camAdminRestContext, 2, function(err, users, mrvisser, simong) {
                ...
                CollectionsTestUtil.generateTestCollections(mrvisser.restContext, 1, function(collection) {
                    ...
                    CollectionsTestUtil.assertShareCollectionSucceeds(simong.restContext, collection.id, [mrvisser], function() {
                                ...
                                CollectionsTestUtil.assertShareCollectionFails(camAdminRestContext, collection.id, ['c:oaetest:notaprincipalid'], 400, function() {
                                    ...
                                    CollectionsTestUtil.assertShareCollectionFails(camAdminRestContext, collection.id, ['u:oaetest:nonexistingid'], 400, function() {
                                        CollectionsTestUtil.assertShareCollectionFails(camAdminRestContext, collection.id, ['g:oaetest:nonexistingid'], 400, function() {
                                            ...
                                            return CollectionsTestUtil.assertShareCollectionSucceeds(camAdminRestContext, collection.id, [mrvisser], callback);
                                        });
                                    });
                                });
                            });
            ...
            TestsUtil.generateTestUsers(camAdminRestContext, 2, function(err, users, mrvisser, simong) {
                ...
                CollectionsTestUtil.generateTestCollections(camAdminRestContext, 1, function(collection) {
                    ...
                    CollectionsTestUtil.assertShareCollectionFails(camAnonymousRestContext, collection.id, [simong.user.id], 401, function() {
                        ...
                        return CollectionsTestUtil.assertShareCollectionSucceeds(mrvisser.restContext, collection.id, [simong], callback);
                    });
                });
            });
        });
        ...
        it('verify sharing authorization for a regular user', function(callback) {
            CollectionsTestUtil.setupMultiTenantPrivacyEntities(function(publicTenant, publicTenant1, privateTenant) {
                ...
                CollectionsTestUtil.assertShareCollectionSucceeds(publicTenant.publicUser.restContext, publicTenant.publicCollection.id, [publicTenant.loggedinUser], function() {
                    CollectionsTestUtil.assertShareCollectionSucceeds(publicTenant.publicUser.restContext, publicTenant.loggedinCollection.id, [publicTenant.loggedinUser], function() {
                        CollectionsTestUtil.assertShareCollectionFails(publicTenant.publicUser.restContext, publicTenant.privateCollection.id, [publicTenant.loggedinUser.user.id], 401, function() {
                            ...
                            CollectionsTestUtil.assertShareCollectionFails(publicTenant.publicUser.restContext, publicTenant.loggedinCollection.id, [publicTenant.privateUser.user.id], 400, function() {
                                CollectionsTestUtil.assertShareCollectionSucceeds(publicTenant.publicUser.restContext, publicTenant.loggedinCollection.id, [publicTenant1.publicUser], function() {
        ...
        it('verify sharing authorization for a cross-tenant user', function(callback) {
            CollectionsTestUtil.setupMultiTenantPrivacyEntities(function(publicTenant, publicTenant1, privateTenant) {
                ...
                CollectionsTestUtil.assertShareCollectionSucceeds(publicTenant1.publicUser.restContext, publicTenant.publicCollection.id, [publicTenant.publicUser], function() {
        ...
        it('verify sharing authorization for a manager user', function(callback) {
            CollectionsTestUtil.setupMultiTenantPrivacyEntities(function(publicTenant, publicTenant1, privateTenant) {
                ...
                CollectionsTestUtil.assertUpdateCollectionMembersSucceeds(publicTenant.adminRestContext, publicTenant.privateCollection.id, _memberUpdate(publicTenant.publicUser, 'manager'), function() {
                    // Ensure manager user can share all items in own tenant
                    CollectionsTestUtil.assertShareCollectionSucceeds(publicTenant.publicUser.restContext, publicTenant.publicCollection.id, [publicTenant.loggedinUser], function() {
                        CollectionsTestUtil.assertShareCollectionSucceeds(publicTenant.publicUser.restContext, publicTenant.loggedinCollection.id, [publicTenant.loggedinUser], function() {
                            CollectionsTestUtil.assertShareCollectionSucceeds(publicTenant.publicUser.restContext, publicTenant.privateCollection.id, [publicTenant.loggedinUser], function() {
                                ...
                                CollectionsTestUtil.assertShareCollectionFails(publicTenant.publicUser.restContext, publicTenant.privateCollection.id, [publicTenant.privateUser.user.id], 400, function() {
                                    CollectionsTestUtil.assertShareCollectionSucceeds(publicTenant.publicUser.restContext, publicTenant.privateCollection.id, [publicTenant1.publicUser], function() {
        ...
        it('verify sharing authorization for an admin user', function(callback) {
            CollectionsTestUtil.setupMultiTenantPrivacyEntities(function(publicTenant, publicTenant1, privateTenant) {
                ...
                CollectionsTestUtil.assertShareCollectionSucceeds(publicTenant.adminRestContext, publicTenant.publicCollection.id, [publicTenant.loggedinUser], function() {
                    CollectionsTestUtil.assertShareCollectionSucceeds(publicTenant.adminRestContext, publicTenant.loggedinCollection.id, [publicTenant.loggedinUser], function() {
                        CollectionsTestUtil.assertShareCollectionSucceeds(publicTenant.adminRestContext, publicTenant.privateCollection.id, [publicTenant.loggedinUser], function() {

                            // Ensure admin user cannot share with user profiles to which they cannot interact
                            CollectionsTestUtil.assertShareCollectionSucceeds(publicTenant.adminRestContext, publicTenant.privateCollection.id, [publicTenant.privateUser], function() {
                                CollectionsTestUtil.assertShareCollectionSucceeds(publicTenant.adminRestContext, publicTenant.privateCollection.id, [publicTenant1.publicUser], function() {
    ...
    describe('Get Collection Members', function() {
            ...
            TestsUtil.generateTestUsers(camAdminRestContext, 16, function(err, users, mrvisser) {
                ...
                CollectionsTestUtil.generateTestCollections(mrvisser.restContext, 1, function(collection) {
                    ...
                    CollectionsTestUtil.assertUpdateCollectionMembersSucceeds(camAdminRestContext, collection.id, memberUpdates, function() {
                        ...
                        return CollectionsTestUtil.assertFullCollectionMembersEquals(mrvisser.restContext, collection.id, expectedMembership, callback);
                    });
                });
            });
        });
                                                                        ...
                                                                        CollectionsTestUtil.assertGetCollectionMembersFails(publicTenant1.adminRestContext, publicTenant.privateCollection.id, null, null, 401, function() {
                                                                            ...
                                                                            CollectionsTestUtil.assertShareCollectionSucceeds(publicTenant.adminRestContext, publicTenant.privateCollection.id, [publicTenant.publicUser], function() {
                                                                                ...
                                                                                CollectionsTestUtil.assertGetCollectionMembersSucceeds(publicTenant.publicUser.restContext, publicTenant.privateCollection.id, null, null, function() {
                                                                                    ...
                                                                                    CollectionsTestUtil.assertShareCollectionSucceeds(publicTenant.adminRestContext, publicTenant.loggedinCollection.id, [publicTenant1.publicUser], function() {
                                                                                        CollectionsTestUtil.assertShareCollectionSucceeds(publicTenant.adminRestContext, publicTenant.privateCollection.id, [publicTenant1.publicUser], function() {
         ...
         */
        it('verify collection members are scrubbed in the members list', function(callback) {
            CollectionsTestUtil.setupMultiTenantPrivacyEntities(function(publicTenant) {

                // Put a private user in the members list of a collection
                CollectionsTestUtil.assertShareCollectionSucceeds(publicTenant.adminRestContext, publicTenant.publicCollection.id, [publicTenant.privateUser, publicTenant.publicUser], function() {

                    // The public user now looks at the members list of the public collection
                    CollectionsTestUtil.getAllCollectionMembers(publicTenant.publicUser.restContext, publicTenant.publicCollection.id, null, function(members) {
        ...
        it('verify viewers and managers can be set on and removed from a collection', function(callback) {
            ...
            TestsUtil.generateTestUsers(camAdminRestContext, 2, function(err, users, mrvisser, bert) {
                ...
                CollectionsTestUtil.assertCreateCollectionSucceeds(mrvisser.restContext, 'test', 'test', 'private', null, null, function(collection) {
                    ...
                    CollectionsTestUtil.assertUpdateCollectionMembersSucceeds(mrvisser.restContext, collection.id, _memberUpdate(bert), function() {
                        ...
                        CollectionsTestUtil.assertGetCollectionSucceeds(bert.restContext, collection.id, function() {
                            ...
                            CollectionsTestUtil.assertUpdateCollectionMembersSucceeds(mrvisser.restContext, collection.id, _memberUpdate(bert, false), function() {
                                ...
                                CollectionsTestUtil.assertGetCollectionFails(bert.restContext, collection.id, 401, function() {
                                    ...
                                    CollectionsTestUtil.assertUpdateCollectionMembersSucceeds(mrvisser.restContext, collection.id, _memberUpdate(bert, 'manager'), function() {

                                        // Ensure Bert can view the collection once again
                                        CollectionsTestUtil.assertGetCollectionSucceeds(bert.restContext, collection.id, function() {

                                            // Ensure Bert can now demote mrvisser to viewer, O noez!
                                            CollectionsTestUtil.assertUpdateCollectionMembersSucceeds(bert.restContext, collection.id, _memberUpdate(mrvisser), function() {
            ...
            TestsUtil.generateTestUsers(camAdminRestContext, 5, function(err, users, mrvisser, bert) {
                ...
                CollectionsTestUtil.generateTestCollections(mrvisser.restContext, 1, function(collection) {
                    ...
                    CollectionsTestUtil.assertUpdateCollectionMembersFails(mrvisser.restContext, collection.id, memberUpdates, 400, function() {
                        ...
                        CollectionsTestUtil.assertUpdateCollectionMembersSucceeds(mrvisser.restContext, collection.id, memberUpdateInfos, function() {
                                    ...
                                    CollectionsTestUtil.assertUpdateCollectionMembersFails(mrvisser.restContext, collection.id, {'c:oaetest:notaprincipalid': 'viewer'}, 400, function() {
                                        ...
                                        CollectionsTestUtil.assertUpdateCollectionMembersFails(mrvisser.restContext, collection.id, {'u:oaetest:nonexistingid': 'viewer'}, 400, function() {
                                            CollectionsTestUtil.assertUpdateCollectionMembersFails(mrvisser.restContext, collection.id, {'g:oaetest:nonexistingid': 'viewer'}, 400, function() {
                                                ...
                                                return CollectionsTestUtil.assertUpdateCollectionMembersSucceeds(mrvisser.restContext, collection.id, _memberUpdate(bert), callback);
                                            });
                                        });
                                    });
                                });
        ...
        it('verify set collection members authorization for an admin user', function(callback) {
            ...
            CollectionsTestUtil.setupMultiTenantPrivacyEntities(function(publicTenant, publicTenant1, privateTenant) {
                ...
                CollectionsTestUtil.generateTestCollections(publicTenant.publicUser.restContext, 1, function(collection) {
                    ...
                    CollectionsTestUtil.assertUpdateCollectionMembersSucceeds(publicTenant.adminRestContext, collection.id, _memberUpdate(publicTenant.loggedinUser, 'manager'), function() {

                        // Ensure admin cannot set members for user profiles with which they cannot interact
                        CollectionsTestUtil.assertUpdateCollectionMembersSucceeds(publicTenant.adminRestContext, publicTenant.loggedinCollection.id, _memberUpdate(publicTenant.privateUser), function() {
                            CollectionsTestUtil.assertUpdateCollectionMembersSucceeds(publicTenant.adminRestContext, publicTenant.loggedinCollection.id, _memberUpdate(publicTenant1.publicUser), function() {
        ...
        it('verify set collection members authorization for a regular user', function(callback) {
            ...
            CollectionsTestUtil.setupMultiTenantPrivacyEntities(function(publicTenant, publicTenant1, privateTenant) {
                ...
                CollectionsTestUtil.assertUpdateCollectionMembersFails(publicTenant.publicUser.restContext, publicTenant.publicCollection.id, _memberUpdate(publicTenant.loggedinUser.user.id), 401, function() {
                    ...
                    CollectionsTestUtil.assertUpdateCollectionMembersSucceeds(publicTenant.adminRestContext, publicTenant.publicCollection.id, _memberUpdate(publicTenant.publicUser), function() {
                        CollectionsTestUtil.assertUpdateCollectionMembersFails(publicTenant.publicUser.restContext, publicTenant.publicCollection.id, _memberUpdate(publicTenant.loggedinUser.user.id), 401, function() {

                            // Make the user a manager so they can update permissions
                            CollectionsTestUtil.assertUpdateCollectionMembersSucceeds(publicTenant.adminRestContext, publicTenant.publicCollection.id, _memberUpdate(publicTenant.publicUser, 'manager'), function() {
                                ...
                                CollectionsTestUtil.assertUpdateCollectionMembersFails(publicTenant.publicUser.restContext, publicTenant.publicCollection.id, _memberUpdate(publicTenant.privateUser.user.id), 400, function() {
                                    CollectionsTestUtil.assertUpdateCollectionMembersSucceeds(publicTenant.publicUser.restContext, publicTenant.publicCollection.id, _memberUpdate(publicTenant1.publicUser), function() {
                        ...
                        TestsUtil.generateTestGroups(camAdminRestContext, 3, function(group1, group2, group3) {
                            TestsUtil.generateGroupHierarchy(camAdminRestContext, [group1.group.id, group2.group.id, group3.group.id, mrvisser.user.id], 'member', function(err) {
                                ...
                                RestAPI.Group.setGroupMembers(camAdminRestContext, group1.group.id, _memberUpdate(simong.user.id), function(err) {
                                    ...
                                    CollectionsTestUtil.assertUpdateCollectionMembersSucceeds(camAdminRestContext, collection.id, _memberUpdate(group2), function() {
    ...
    describe('Content Integration', function() {
        ...
        it('verify a content item that belongs to collections and has groups as members can list their members', function(callback) {
            // Create a test user with which to do stuff
            TestsUtil.generateTestUsers(camAdminRestContext, 1, function(err, users, mrvisser) {
                assert.ok(!err);

                // Create a few collections that a content item will be added to
                CollectionsTestUtil.generateTestCollections(mrvisser.restContext, 3, function() {
                    var collectionIds = _.pluck(arguments, 'id');
                    ...
                    TestsUtil.generateTestGroups(mrvisser.restContext, 3, function() {
                        ...
                        // Create a content item to add to the collections
                        RestAPI.Content.createLink(camAdminRestContext, 'test', 'test', 'public', 'http://www.google.ca', null, groupIds, function(err, link) {
                            assert.ok(!err);

                            CollectionsTestUtil.assertAddContentItemToCollectionsSucceeds(mrvisser.restContext, collectionIds, link.id, function() {
