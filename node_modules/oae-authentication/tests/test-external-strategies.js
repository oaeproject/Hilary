...
describe('Authentication', function() {
    ...
    describe('Shibboleth authentication', function() {
        ...
        beforeEach(function(callback) {
            ...
            configUpdate['oae-authentication/shibboleth/mapDisplayName'] = '{edupersonprincipalname}';
            configUpdate['oae-authentication/shibboleth/mapEmail'] = '{eppn}';
            configUpdate['oae-authentication/shibboleth/mapLocale'] = '{locale}';
            ConfigTestUtil.updateConfigAndWait(globalAdminRestContext, global.oaeTests.tenants.localhost.alias, configUpdate, function(err) {
                assert.ok(!err);
            });
        ...
        afterEach(function(callback) {
            var keysToClear = [
                ...
                'oae-authentication/shibboleth/mapDisplayName',
                'oae-authentication/shibboleth/mapEmail',
                'oae-authentication/shibboleth/mapLocale'
            ];
         ...
         */
        var _initiateShibbolethAuthFlow = function(callback) {
            ...
            RestAPI.Authentication.shibbolethTenantRedirect(tenantRestContext, function(err, body, response) {
                assert.ok(!err);
                ...
                RestAPI.Authentication.shibbolethSPRedirect(spRestContext, params, function(err, body, response) {
                    ...
                    assert.strictEqual(location.query.target, '/api/auth/shibboleth/sp/callback');
         ...
         * @param  {Function}       callback            Standard callback function
         */
        var _callbackShibbolethAuthFlow = function(tenantRestContext, spRestContext, attributes, callback) {
            ...
            RestAPI.Authentication.shibbolethSPCallback(spRestContext, attributes, function(err, body, response) {
                ...
                RestAPI.Authentication.shibbolethTenantCallback(tenantRestContext, params, function(err, body, response) {
                    ...
                    // We should be redirected to the /me page
                    assert.equal(response.statusCode, 302);
                    assert.equal(response.headers.location, '/me');
            ...
            _enableStrategy('shibboleth', function(done) {
                ...
                _initiateShibbolethAuthFlow(function(tenantRestContext, spRestContext) {
                    ...
                    var attributes = {
                        ...
                        'eduPersonPrincipalName': 'Simon',
                        'eppn': 'simon@test.com',
                        'locale': 'en_UK'
                    };

                    // Perform the callback part of the authentication flow
                    _callbackShibbolethAuthFlow(tenantRestContext, spRestContext, attributes, function(){
         ...
         */
        it('verify tenant callback', function(callback) {
            _enableStrategy('shibboleth', function(done) {
                var restContext = TestsUtil.createTenantRestContext(global.oaeTests.tenants.localhost.host);
                restContext.followRedirect = false;
