...
ActivityEmitter.on(ActivityConstants.events.ROUTED_ACTIVITIES, function(activitySeed, allActivities) {
    ...
    var usersToMail = _.chain(allActivities).keys().filter(function(activityStreamId) {
        ...
        return (allActivities[activityStreamId].streamType === ActivityConstants.streams.EMAIL);
...
var _aggregate = function(userId, activities) {
    ...
    _.each(aggregates, function(aggregate, aggregateKey) {
        ...
        aggregatedActivities.push(new ActivityModel.Activity(aggregate[ActivityConstants.properties.OAE_ACTIVITY_TYPE], aggregate.activityIds[0], aggregate.verb, aggregate.published, actor, object, target));
    });
...
var _getBucketNumber = function(userId) {
    return ActivityBuckets.getBucketNumber(userId);
};
