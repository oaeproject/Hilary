 ...
 */
const getGroup = module.exports.getGroup = function(ctx, groupId, callback) {
 ...
 */
const getFullGroupProfile = module.exports.getFullGroupProfile = function(ctx, groupId, callback) {
 ...
 */
const getMembersLibrary = module.exports.getMembersLibrary = function(ctx, groupId, start, limit, callback) {
 ...
 */
const getGroupInvitations = module.exports.getGroupInvitations = function(ctx, groupId, callback) {
    const validator = new Validator();
 ...
 * @param  {Object}         callback.err    An error that occurred, if any
 */
const resendGroupInvitation = module.exports.resendGroupInvitation = function(ctx, groupId, email, callback) {
    const validator = new Validator();
    validator.check(groupId, {'code': 400, 'msg': 'A valid group id must be specified'}).isGroupId();
    if (validator.hasErrors()) {
        return callback(validator.getFirstError());
 ...
 * @param  {String}      callback.nextToken      The value to provide in the `start` parameter to get the next set of results
 */
const getMembershipsLibrary = module.exports.getMembershipsLibrary = function(ctx, principalId, start, limit, callback) {
    limit = OaeUtil.getNumberParam(limit, 10, 1);
 ...
 */
const getRecentGroupsForUserId = module.exports.getRecentGroupsForUserId = function(ctx, principalId, limit, callback) {
 ...
 */
const setGroupMembers = module.exports.setGroupMembers = function(ctx, groupId, changes, callback) {
    // Validation
    const validator = new Validator();
 ...
 * @param  {Object}     callback.err    An error that occurred, if any
 */
const leaveGroup = module.exports.leaveGroup = function(ctx, groupId, callback) {
    const validator = new Validator();
    validator.check(groupId, {'code': 400, 'msg': 'Invalid groupId specified'}).isGroupId();
 ...
 * @param  {Object}     callback.err    An error that occurred, if any
 */
const joinGroup = module.exports.joinGroup = function(ctx, groupId, callback) {
    const validator = new Validator();
    validator.check(groupId, {'code': 400, 'msg': 'Invalid groupId specified'}).isGroupId();
    validator.check(null, {'code': 401, 'msg': 'You have to be logged in to be able to join a group'}).isLoggedInUser(ctx);
    if (validator.hasErrors()) {
 ...
 */
const createGroup = module.exports.createGroup = function(ctx, displayName, description, visibility, joinable, roles, callback) {
 ...
 */
const updateGroup = module.exports.updateGroup = function(ctx, groupId, profileFields, callback) {
     // Parameter validation
 ...
 * @param  {Object}     callback.err    An error that occured, if any
 */
const deleteGroup = module.exports.deleteGroup = function(ctx, groupId, callback) {
    const validator = new Validator();
    validator.check(groupId, {'code': 400, 'msg': 'A valid group id must be provided'}).isGroupId();
    if (validator.hasErrors()) {
        return callback(validator.getFirstError());
 ...
 * @param  {Object}     callback.err    An error that occured, if any
 */
const restoreGroup = module.exports.restoreGroup = function(ctx, groupId, callback) {
    const validator = new Validator();
    validator.check(groupId, {'code': 400, 'msg': 'A valid group id must be provided'}).isGroupId();
    if (validator.hasErrors()) {
        return callback(validator.getFirstError());
 ...
 */
const canManageAny = module.exports.canManageAny = function(ctx, principalIds, callback) {
