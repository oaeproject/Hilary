...
var refreshSearchConfiguration = module.exports.refreshSearchConfiguration = function(indexName, serverOpts, _allowAnonRefreshIndex, processIndexJobs, callback) {
    ...
    if (processIndexJobs && !boundIndexWorkers) {
        ...
        MQ.bind(SearchConstants.mq.TASK_INDEX_DOCUMENT, null, _handleIndexDocumentTask, function() {
            MQ.bind(SearchConstants.mq.TASK_DELETE_DOCUMENT, null, _handleDeleteDocumentTask, callback);
        });
...
var search = module.exports.search = function(ctx, searchType, opts, callback) {
    ...
    registeredSearch(ctx, opts, function(err, queryData) {
        ...
        // Note: If we could somehow get an ES 'object' mapping to just 'store' all its data, this shouldn't be necessary. Then we could in theory disable the _source document (saves on server space)
