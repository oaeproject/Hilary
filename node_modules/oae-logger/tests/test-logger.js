...
describe('Logger', function() {
  ...
  it('verify that error logs are counted through the telemetry API', function(callback) {
    ...
    RestAPI.Telemetry.getTelemetryData(globalAdminRestContext, function(
      err,
      ...
      RestAPI.Telemetry.getTelemetryData(globalAdminRestContext, function(
        ...
        if (
          initialTelemetryData['logger'] &&
          initialTelemetryData['logger']['error.count']
        ) {
        ...
        assert.strictEqual(
          newTelemetryData['logger']['error.count'],
          initialTotalCount + 6,
        );
