    ...
    describe('Templates', function() {
        ...
        it('verify html doesnt include the HTML5 entity for the apostrophe', function(callback) {
            TestsUtil.generateTestUsers(camAdminRestContext, 1, function(err, users) {
                ...
                // Verify HTML only
                EmailTestsUtil.sendEmail('oae-email', 'test_html_with_apostrophes_only', mrvisser.user, null, null, function(err, message) {

                    assert.ok(!err);
                    assert.equal(message.html, '<html><body><b>test html with &#39;&#39;apostrophes&#39;&#39; only</b></body></html>');
