...
describe('Authentication', function() {
    ...
    after(function(callback) {
        RestAPI.Config.updateConfig(globalAdminRestContext, 'localhost', 'oae-authentication/signed/expires', 120000, function(err) {
            assert.ok(!err);
            callback();
        });
    });
    ...
    describe('Signed authentication', function() {
        ...
        describe('Get token', function() {
            ...
            it('verify anonymous users cannot generate a url', function(callback) {
                RestAPI.Authentication.loginOnTenant(anonymousGlobalRestContext, 'localhost', function(err, restCtx) {
                    assert.ok(err);
        ...
        describe('Login', function() {
            ...
            it('verify login on tenant works', function(callback) {
                RestAPI.Authentication.loginOnTenant(globalAdminRestContext, 'localhost', function(err, restCtx) {
                    assert.ok(!err);
            ...
            var performSignedTokenRequest = function(expires, signature, userId, isLoggedIn, callback) {
                ...
                var restCtx = new RestContext('http://' + global.oaeTests.tenants.localhost.host, userId, null, global.oaeTests.tenants.localhost.host);
             ...
             */
            it('verify parameter validation', function(callback) {
                RestAPI.Authentication.getSignedToken(globalAdminRestContext, 'localhost', function(err, token) {
                    assert.ok(!err);
            ...
            it('verify expiring signature', function(callback) {
                RestAPI.Config.updateConfig(globalAdminRestContext, 'localhost', 'oae-authentication/signed/expires', 2, function() {
                    RestAPI.Authentication.getSignedToken(globalAdminRestContext, 'localhost', function(err, token) {
                        assert.ok(!err);
