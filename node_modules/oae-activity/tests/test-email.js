                    ...
                    ConfigTestUtil.clearConfigAndWait(globalAdminRestContext, null, _.union(instanceConfigFields, hostingOrganizationConfigFields), function(err) {
                        ...
                        RestAPI.Content.createLink(mrvisser.restContext, 'Google', 'Google', 'public', 'http://www.google.ca', [nico.user.id], [], [], function(err, link) {
                            ...
                            EmailTestsUtil.collectAndFetchAllEmails(function(messages) {
                                assert.notEqual(messages[0].html.indexOf('Apereo <a href=\"http://www.oaeproject.org\" '), -1);
                                assert.notEqual(messages[0].html.indexOf('Open Academic Environment</a>'), -1);
                                assert.strictEqual(messages[0].html.indexOf(util.format('<a href=\"%s\" ', instanceURL)), -1);
                                assert.strictEqual(messages[0].html.indexOf(util.format('%s</a>', instanceName)), -1);
                                assert.strictEqual(messages[0].html.indexOf(util.format('<a href=\"%s\" ', hostingOrganizationURL)), -1);
                                assert.strictEqual(messages[0].html.indexOf(util.format('%s</a>', hostingOrganization)), -1);

                                assert.strictEqual(messages[0].text.indexOf(instanceName), -1);
                                assert.strictEqual(messages[0].text.indexOf(hostingOrganization), -1);
                                ...
                                ConfigTestUtil.updateConfigAndWait(globalAdminRestContext, null, updateConfigInstance, function(err) {
                                    ...
                                    RestAPI.Content.updateContent(mrvisser.restContext, link.id, {'displayName': 'Update 1'}, function(err, link) {
                                        ...
                                        EmailTestsUtil.collectAndFetchAllEmails(function(messages) {
                                            assert.notEqual(messages[0].html.indexOf('Apereo <a href=\"http://www.oaeproject.org\" '), -1);
                                            assert.notEqual(messages[0].html.indexOf('Open Academic Environment</a>'), -1);
                                            assert.notEqual(messages[0].html.indexOf(util.format('<a href=\"%s\" ', instanceURL)), -1);
                                            assert.notEqual(messages[0].html.indexOf(util.format('%s</a>', instanceName)), -1);
                                            assert.strictEqual(messages[0].html.indexOf(util.format('<a href=\"%s\" ', hostingOrganizationURL)), -1);
                                            assert.strictEqual(messages[0].html.indexOf(util.format('%s</a>', hostingOrganization)), -1);

                                            assert.notEqual(messages[0].text.indexOf(instanceName), -1);
                                            assert.strictEqual(messages[0].text.indexOf(hostingOrganization), -1);
                                                ...
                                                ConfigTestUtil.updateConfigAndWait(globalAdminRestContext, null, updateConfigHostingOrganization, function(err) {
                                                    ...
                                                    RestAPI.Content.updateContent(mrvisser.restContext, link.id, {'displayName': 'Update 2'}, function(err, link) {
                                                        ...
                                                        EmailTestsUtil.collectAndFetchAllEmails(function(messages) {
                                                            ...
                                                            assert.strictEqual(messages[0].html.indexOf(util.format('<a href=\"%s\" ', instanceURL)), -1);
                                                            assert.strictEqual(messages[0].html.indexOf(util.format('%s</a>', instanceName)), -1);
                                                            assert.notEqual(messages[0].html.indexOf(util.format('<a href=\"%s\" ', hostingOrganizationURL)), -1);
                                                            assert.notEqual(messages[0].html.indexOf(util.format('%s</a>', hostingOrganization)), -1);

                                                            assert.strictEqual(messages[0].text.indexOf(instanceName), -1);
                                                            assert.notEqual(messages[0].text.indexOf(hostingOrganization), -1);
                    ...
                    RestAPI.Discussions.createMessage(user2.restContext, discussion.id, markdownBody, null, function(err, comment) {
                        ...
                        EmailTestsUtil.collectAndFetchAllEmails(function(messages) {
                            ...
                            _.each(htmlBody, function(htmlFragment) {
                                assert.notEqual(mail.html.indexOf(htmlFragment), -1);
                            });
