 ...
 * ### Events
 *
 * The `ActivityAPI`, as enumerated in `ActivityConstants.events`, emits the following events:
 *
 ...
 * @param   {Boolean|Object}    [options.notifactions]                          Configuration about how this activity should notify users that they happened. If `true` or an object, this activity will deliver activities to the notification feed of the user. If not specified (or false), no notifications will be triggered for this type of activity
 * @param   {Boolean}           [options.notifications.email]                   Whether or not to send an email
 ...
 * @param   {String}            start               Number of millis since the epoc (or, last activity id) from which to start returning activities. Only activities older than this value will be returned.
 ...
 *
 * @param  {Context}            ctx                     The context of the current session
 * @param   {String}            start                   Number of millis since the epoc (or, last notification id) from which to start returning notifications. Only notifications older than this value will be returned.
...
var getNotificationStream = module.exports.getNotificationStream = function(ctx, start, limit, callback) {
    ...
    // Tag #notification to the end of the user id. This is basically the only thing that is being abstracted out of activity streams in `getActivityStream`
