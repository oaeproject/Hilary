 ...
 * @api private
 */
var _transferRight = function(ctx, user, archiveUser, listElementByMember, listIdElement, type, callback) {
    ...
    _getLibrary(ctx, user.id, type, function(err, elements) {
        ...
        if (_.isEmpty(elements)) {
            return callback(null, listElementByMember, listIdElement);
        }

        // Recursive loop
        _transferRightLoop(elements, ctx, user, archiveUser, listElementByMember, listIdElement, type, function(err, listElementByMember, listIdElement) {
            if (err) {
                return callback(err);
            }
            return callback(null, listElementByMember, listIdElement);
...
var _transferRightLoop = function(hashes, ctx, user, archiveUser, listElementByMember, listIdElement, type, callback, previousElement) {
                ...
                if (isManager) {
                    ...
                    if (_.isEmpty(newMemberList)) { 
                        ...
                        _updateRoles(ctx, element, archiveUser, type, function(err) {
                            ...
                            return _transferRightLoop(hashes, ctx, user, archiveUser, listElementByMember, listIdElement, type, callback, element);
                        });
...
var _removeFromLibrary = function(ctx, userId, previousElement, type, callback) {
    ...
    switch (type) {
        ...
        case 'group':
            ...
            AuthzAPI.updateRoles(previousElement.id, changes, function(err) {
                if (err) {
                    return callback(err);
                }
                return callback();
...
var _deleteFollowing = function(ctx, user, callback) {
    ...
    FollowingDAO.getFollowing(user.id, null, null, function(err, userIdsFollowing) {
        ...
        FollowingDAO.deleteFollows(user.id, userIdsFollowing, function(err) {
            ...
            async.eachSeries(userIdsFollowing, function(id, innerCallback) {
...
var _deleteFollowers = function(ctx, user, callback) {
    ...
    FollowingDAO.getFollowers(user.id, null, null, function(err, userIdsFollowers) {
        ...
        async.eachSeries(userIdsFollowers, function(id, innerCallback) {            
