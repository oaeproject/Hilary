...
var timezoneConfigValues = _.map(timezones, function(timezoneData, timezoneName) {
    return {
        'name': timezoneName,
        'value': timezoneName
    };
...
// Sort the timezones on their name
timezoneConfigValues = timezoneConfigValues.sort(function(timezoneA, timezoneB) {
    return timezoneA.name.localeCompare(timezoneB.name);
});
...
module.exports = {
    ...
    'user': {
        ...
        'elements': {
            ...
            'timezone': new Fields.List('Default Timezone', 'Default timezone for users. This should only be used in the backend', 'Etc/UTC', timezoneConfigValues),
