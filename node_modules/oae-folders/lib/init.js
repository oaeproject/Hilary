...
var FoldersSearch = require('./search');
...
var _ensureSchema = function(callback) {
    Cassandra.createColumnFamilies({
        'Folders': 'CREATE TABLE "Folders" ("id" text PRIMARY KEY, "tenantAlias" text, "groupId" text, "displayName" text, "visibility" text, "description" text, "createdBy" text, "created" timestamp, "lastModified" timestamp, "previews" text)',
