...
var SCOPES_ALL = [SearchConstants.general.SCOPE_ALL, SearchConstants.general.SCOPE_NETWORK, SearchConstants.general.SCOPE_TENANT];
...
/**
 * Determine if the given parameter is a valud scope parameter. If so, simply return the `val`, otherwise, return the
        ...
        if (scope === SearchConstants.general.SCOPE_ALL) {
            ...
            filter = filterOr(
                filterAnd(
                    ...
                    filterTerms('tenantAlias', _.union(tenant.alias, interactingTenantAliases))
                ),
