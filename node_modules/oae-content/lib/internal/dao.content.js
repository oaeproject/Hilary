  ...
  Cassandra.runQuery(
    ...
    function(err, rows) {
      if (err) {
        ...
        return callback(
          { code: 404, msg: "Couldn't find content: " + contentId },
          null,
        );
      }
 ...
 */
var getMultipleContentItems = (module.exports.getMultipleContentItems = function(
  contentIds,
  fields,
  callback,
) {
  ...
  if (fields) {
    ...
    query = util.format(
      'SELECT "%s" FROM "Content" WHERE "contentId" IN ?',
      fields.join('","'),
    );
  } else {
 ...
 */
var createContent = (module.exports.createContent = function(
  contentId,
  revisionId,
  createdBy,
  resourceSubType,
 ...
 */
var updateContent = (module.exports.updateContent = function(
  contentObj,
  profileUpdates,
  librariesUpdate,
  callback,
  ...
  Cassandra.runQuery(q.query, q.parameters, function(err) {
    ...
    if (newContentObj.resourceSubType === 'file') {
      newContentObj.downloadPath =
        ...
        newContentObj.id +
        '/download/' +
        newContentObj.latestRevisionId;
    }
 ...
 */
var updateContentLibraries = (module.exports.updateContentLibraries = function(
  contentObj,
  removedMembers,
  callback,
) {
 ...
 * @param  {Object}     [callback.err]      Error object containing the error message
 */
var _updateContentLibraries = function(
  contentObj,
  oldLastModified,
  newLastModified,
  removedMembers,
