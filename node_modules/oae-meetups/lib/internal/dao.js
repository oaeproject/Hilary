 ...
 */
var getMeetup = module.exports.getMeetup = function(meetingId, callback) {
    getMeetupsById([meetingId], null, function(err, meetings) {
        if (err) {
            return callback(err);
        }
 ...
 */
var getRecording = module.exports.getRecording = function(recordId, callback) {
    getRecordingsById([recordId], null, function(err, recordings) {
        if (err) {
            return callback(err);
        }

        return callback(null, recordings[0]);
    });
};
