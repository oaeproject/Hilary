 ...
 * TODO bla bla bla
 */
let _handleGetLogoConfig = function(req, res) {
    var tenantAlias = req.params.tenantAlias || req.ctx.tenant().alias;
    ConfigAPI.getTenantLogo(req.ctx, tenantAlias, (err, config) => {
        if(err) {
 ...
 * TODO bla bla bla
 */
OAE.tenantRouter.on('get', '/api/config/:tenantAlias/logo', _handleGetLogoConfig);
