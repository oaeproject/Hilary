                                        ...
                                        <td>
                                            ...
                                            <% if (shared.isEmail(recipient.id)) { %>
                                                <div class="activity-invitation-container">
                                                    <p>Hey, maybe you'd like to <a href="<%= baseUrl %>/me?invitationToken=<%= encodeURIComponent(recipient.token) %>&invitationEmail=<%= encodeURIComponent(recipient.email) %>">accept the invitation.</a>
                                                </div>
                                            <% } %>
