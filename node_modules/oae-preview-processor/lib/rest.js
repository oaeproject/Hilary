 ...
 *
 * Reprocess previews for content items that match a set of filters. This operation can be
 * extremely resource-intensive; use with care.
 *
 * @Server      admin
 * @Method      POST
 * @Path        /content/reprocessPreviews
 * @FormParam   {string[]}          [content_resourceSubType]     Content of specified sub-type; may be string or array of strings                      [collabdoc,file,link]
 ...
 * @FormParam   {string}            [revision_createdBy]          Content created by specified use, e.g. u:tenant:123def
 * @FormParam   {string[]}          [revision_mimeType]           Content of specified MIME type, e.g. application/pdf; may be string or array of strings
 * @FormParam   {string[]}          [revision_previewsStatus]     Content with any of specified preview status values; may be string or array of strings   [ignored,error]
 */
 ...
 * @PathParam   {string}        contentId       The ID of the content item that needs new preview items
 * @PathParam   {string}        revisionId      The ID of the revision for which we need to generate previews
 * @Return      {void}
 */
