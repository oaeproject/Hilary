...
var createGroup = module.exports.createGroup = function(ctx, displayName, description, visibility, joinable, members, otherValues, callback) {
    ...
    validator.check(displayName, {'code': 400, 'msg': 'A displayName should be a short-sized string.'}).isShortString();
    ...
    if (description) {
        validator.check(description, {'code': 400, 'msg': 'A description should be at most a medium-sized string'}).isMediumString();
    }
    if (validator.hasErrors()) {
        return callback(validator.getFirstError());
    }
...
var updateGroup = module.exports.updateGroup = function(ctx, groupId, profileFields, callback) {
    ...
    fieldNames.forEach(function(fieldName) {
        ...
        if (fieldName === 'visibility') {
            ...
            validator.check(profileFields['displayName'], {'code': 400, 'msg': 'A displayName should be a short-sized string'}).isShortString();
        } else if (fieldName === 'description') {
            validator.check(profileFields['description'], {'code': 400, 'msg': 'A description should be at most a medium-sized string'}).isMediumString();
        }
    });
