...
describe('File previews', function() {
  ...
  var createPreviews = function(callback) {
    TestsUtil.generateTestUsers(globalAdminOnTenantRestContext, 2, function(
      err,
      users,
    ) {
      assert.ok(!err);
  ...
  it('verify download non-existing previews is handled correctly', function(callback) {
    TestsUtil.generateTestUsers(globalAdminOnTenantRestContext, 1, function(
      err,
      users,
    ) {
      assert.ok(!err);
                ...
                _verifySignedDownloadUrl(
                  ...
                  function() {
                    ...
                    RestAPI.Content.getContent(
                      bert.restContext,
                      contentObj.id,
                      function(err, contentObjOnCamTenant) {
                        assert.ok(!err);
                              ...
                              function(err, updatedContentObj) {
                                ...
                                SearchTestsUtil.searchAll(
                                  ...
                                  function(err, results) {
                                    assert.ok(!err);
                                    var doc = _.find(results.results, function(
                                      doc,
                                    ) {
                            ...
                            function() {
                              ...
                              RestAPI.Content.restoreRevision(
                                ...
                                function(err, restoredRevision) {
                                  ...
                                  assert.equal(
                                    restoredRevision.previews.status,
                                    'done',
                                  );
                                  return callback();
                                },
                        ...
                        function(err, revisionObj) {
                          ...
                          SearchTestsUtil.searchAll(
                            ...
                            null,
                            {
                              ...
                              q: contentObj.description,
                            },
                            function(err, results) {
                              assert.ok(!err);
                              var contentDocB = _.find(
                                results.results,
                                function(result) {
                                  return result.id === contentObj.id;
                                },
