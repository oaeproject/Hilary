...
OAE.tenantServer.post('/api/user/create', function(req, res) {
    ...
    recaptcha.checkAnswer(PrincipalsConfig.getValue(tenant.alias, 'recaptcha', 'private-key'), req.connection.remoteAddress, req.body.recaptchaChallenge, req.body.recaptchaResponse);
});
...
OAE.tenantServer.post('/api/user/:id/admin', function(req, res) {
    ...
    PrincipalsAPI.setTenantAdmin(req.ctx, req.params.id, isAdmin, function(err) {
        if (err) {
