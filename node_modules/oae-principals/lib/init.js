...
var ensureSchema = function(callback) {
    Cassandra.createColumnFamilies({
        'Principals': "CREATE COLUMNFAMILY Principals (principal_id text PRIMARY KEY, alias text, tenant text, visibility text, alias text, user_institution_user_id text, user_first_name text, user_last_name text, user_email text, user_picture text, name text, description text, joinable text) WITH comment='Principal information';"
    }, callback);
};
