...
var getFoldersByIds = module.exports.getFoldersByIds = function(folderIds, callback) {
    ...
    Cassandra.runQuery('SELECT * FROM "Folders" WHERE "id" IN (?)', [folderIds], function(err, rows) {
        if (err) {
            return callback(err);
        }
...
var getFoldersByGroupIds = module.exports.getFoldersByGroupIds = function(groupIds, callback) {
    ...
    Cassandra.runQuery('SELECT * FROM "FoldersGroupId" WHERE "groupId" IN (?)', [groupIds], function(err, rows) {
        if (err) {
            return callback(err);
        }
