...
describe('Tenants', function() {
    ...
    describe('Get tenant', function() {
        ...
        it('verify get tenant by email domain', function(callback) {
            ...
            var exactMatchTenantHost = TenantsTestUtil.generateTestTenantHost();
            var exactMatchTenantOpts = {'emailDomain': TenantsTestUtil.generateTestTenantHost()};

            var suffixTenantAlias = TenantsTestUtil.generateTestTenantAlias();
            var suffixTenantDescription = TestsUtil.generateRandomText();
            var suffixTenantHost = TenantsTestUtil.generateTestTenantHost();
            var suffixTenantOpts = {'emailDomain': util.format('*.%s', exactMatchTenantOpts.emailDomain)};
                            ...
                            RestAPI.Tenants.updateTenant(camAdminRestContext, null, null, function(err) {
                                ...
                                RestAPI.Tenants.updateTenant(camAdminRestContext, null, {'alias': 'foobar'}, function(err) {
                                    ...
                                    RestAPI.Tenants.updateTenant(camAdminRestContext, null, {'alias': 'foobar', 'displayName': 'Anglia Ruskin University'}, function(err) {
                                        ...
                                        assert.equal(err.code, 400);
                                        // Verify update a non-existing property
                                        RestAPI.Tenants.updateTenant(camAdminRestContext, 'camtest', {'noneexisting': 'foobar'}, function(err) {
                                            assert.ok(err);
                                            assert.equal(err.code, 400);
    ...
    describe('Tenant email domains', function() {
