          ...
          function(simong1, emailToken) {
            PrincipalsTestUtil.assertVerifyEmailSucceeds(
              ...
              function() {
                ...
                PrincipalsDAO.getUserIdsByEmails([email], function(
                  err,
                  userIdsByEmail,
                ) {
                  assert.ok(!err);
            ...
            PrincipalsDAO.getPrincipal(mrvisser.id, function(err, mrvisserRaw) {
              ...
              PrincipalsDAO.updatePrincipal(
                ...
                function(err) {
                  ...
                  assert.equal(
                    err.msg,
                    'Attempted to update an invalid property',
                  );
      ...
      TestsUtil.generateTestUsers(camAdminRestContext, 1, function(err, users) {
        ...
        var _onEach = function(principalRows, done) {
          ...
          _.each(principalRows, function(principalRow) {
            ...
            assert.ok(
              principalRow.principalId,
              'Expected the row to have principalId',
            );
