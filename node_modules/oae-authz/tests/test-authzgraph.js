...
describe('Authz Graph', function() {
  ...
  it('verify adding and getting nodes', function(callback) {
    ...
    assert.ok(
      !graph.addNode('a', { myprop: 'anotherval', anotherprop: 'anotherval' }),
    );
    a = graph.getNode('a');
    assert.ok(a);
    assert.strictEqual(a.id, 'a');
  ...
  it('verify inbound and outbound traversal', function(callback) {
    ...
    assert.deepEqual(_.pluck(graph.traverseIn('a'), 'id'), [
      'a',
      'i',
      'h',
      'g',
    ...
    assert.deepEqual(_.pluck(graph.traverseOut('a'), 'id'), [
      'a',
      'b',
      'c',
      'd',
