    ...
    describe('General Search Parameters', function() {
        ...
        it('verifies a variety of valid and invalid values for the resourceTypes parameter', function(callback) {
            ...
            RestAPI.User.createUser(camAdminRestContext, jackUsername, 'password', 'Jacker', null, function(err, jack) {
                ...
                RestAPI.Group.createGroup(jackRestContext, groupAlias, 'A really awesome group', 'public', 'no', [], [], function(err, group) {
                    assert.ok(!err);
                    ...
                    RestAPI.Content.createLink(jackRestContext, 'Apereo Foundation', 'Link to Apereo Foundation Website', 'public', 'http://www.apereo.org', [], [], function(err, content) {
                        ...
                        SearchTestsUtil.searchAll(jackRestContext, 'general', null, null, function(err, results) {
                            ...
                            SearchTestsUtil.searchAll(jackRestContext, 'general', null, {'resourceTypes': ''}, function(err, results) {
                                assert.ok(!err);
                                _verifyHasResourceTypes(results, true, true, true);

                                // Verify non-matching single resource type returns nothing
                                SearchTestsUtil.searchAll(jackRestContext, 'general', null, {'resourceTypes': 'not-matching-anything'}, function(err, results) {
                                    assert.ok(!err);
                                    assert.equal(results.results.length, 0);

                                    // Verify each single resourceType searches just that one
                                    SearchTestsUtil.searchAll(jackRestContext, 'general', null, {'resourceTypes': 'user'}, function(err, results) {
                                        assert.ok(!err);
                                        _verifyHasResourceTypes(results, true, false, false);

                                        SearchTestsUtil.searchAll(jackRestContext, 'general', null, {'resourceTypes': 'group'}, function(err, results) {
                                            assert.ok(!err);
                                            _verifyHasResourceTypes(results, false, true, false);

                                            SearchTestsUtil.searchAll(jackRestContext, 'general', null, {'resourceTypes': 'content'}, function(err, results) {
                                                assert.ok(!err);
                                                _verifyHasResourceTypes(results, false, false, true);

                                                // Verify searching 2 returns just the 2 types
                                                SearchTestsUtil.searchAll(jackRestContext, 'general', null, {'resourceTypes': ['group', 'content']}, function(err, results) {
                                                    assert.ok(!err);
                                                    ...
                                                    SearchTestsUtil.searchAll(jackRestContext, 'general', null, {'resourceTypes': ['', '', 'content', '']}, function(err, results) {
                                                        ...
                                                        SearchTestsUtil.searchAll(jackRestContext, 'general', null, {'resourceTypes': ['', '', 'user', 'content', '', '']}, function(err, results) {
                                                            assert.ok(!err);
                                                            ...
                                                            SearchTestsUtil.searchAll(jackRestContext, 'general', null, {'resourceTypes': ['', '', 'non-matching', '', 'group', 'user']}, function(err, results) {
                                                                assert.ok(!err);
                                    ...
                                    TestsUtil.generateGroupHierarchy(doerRestContext, [groupIds[4], jack.id], 'member', function(err) {
                                        ...
                                        RestAPI.Content.createLink(doerRestContext, 'Test Content 1', 'Test content description 1', 'public', 'http://www.sakaiproject.org/',  [], [groupIds[0]], function(err, contentObj) {
                                            ...
                                            SearchTestsUtil.searchAll(anonymousRestContext, 'general', null, {'q': 'Content'}, function(err, results) {
                                                ...
                                                SearchTestsUtil.searchAll(camAdminRestContext, 'general', null, {'q': 'Content'}, function(err, results) {
                                                    assert.ok(!err);
                                                    ...
                                                    SearchTestsUtil.searchAll(janeRestContext, 'general', null, {'q': 'Content'}, function(err, results) {
                                                        assert.ok(!err);
                                                        ...
                                                        SearchTestsUtil.searchAll(janeRestContext, 'general', null, {'q': 'Content'}, function(err, results) {
                                                            ...
                                                            SearchTestsUtil.searchAll(jackRestContext, 'general', null, {'q': 'Content'}, function(err, results) {
                                                                assert.ok(!err);
                                    ...
                                    TestsUtil.generateGroupHierarchy(doerRestContext, [groupIds[4], jack.id], 'member', function(err) {
                                        ...
                                        RestAPI.Content.createLink(doerRestContext, 'Test Content 1', 'Test content description 1', 'loggedin', 'http://www.sakaiproject.org/',  [], [groupIds[0]], function(err, contentObj) {
                                            ...
                                            SearchTestsUtil.searchAll(anonymousRestContext, 'general', null, {'q': 'Content'}, function(err, results) {
                                                ...
                                                SearchTestsUtil.searchAll(darthVaderRestContext, 'general', null, {'q': 'Content', 'includeExternal': true}, function(err, results) {
                                                    assert.ok(!err);
                                                    assert.ok(!_getDocById(results, contentObj.id));
                ...
                RestAPI.User.createUser(camAdminRestContext, jackUsername, 'password', 'Jack McJackerson', jackOpts, function(err, jack) {
                    ...
                    RestAPI.User.createUser(camAdminRestContext, janeUsername, 'password', 'Janey McJaneFace', null, function(err, jane) {
                        ...
                        SearchTestsUtil.searchAll(darthVaderRestContext, 'general', null, {'resourceTypes': 'user', 'q': 'Jack'}, function(err, results) {
                            ...
                            SearchTestsUtil.searchAll(darthVaderRestContext, 'general', null, {'resourceTypes': 'user', 'q': 'Jack', 'includeExternal': true}, function(err, results) {
                                assert.ok(!err);
                                var jackDoc = _getDocById(results, jack.id);
                                assert.ok(jackDoc);
                                ...
                                SearchTestsUtil.searchAll(anonymousRestContext, 'general', null, {'resourceTypes': 'user', 'q': 'Jack'}, function(err, results) {
                                    assert.ok(!err);
                                    var jackDoc = _getDocById(results, jack.id);
                                    assert.ok(jackDoc);
                                    assert.equal(jackDoc.id, jack.id);
                                    ...
                                    SearchTestsUtil.searchAll(janeRestContext, 'general', null, {'resourceTypes': 'user', 'q': 'Jack'}, function(err, results) {
                                        assert.ok(!err);
                                        var jackDoc = _getDocById(results, jack.id);
                                        assert.ok(jackDoc);
                                        assert.equal(jackDoc.id, jack.id);
                                        ...
                                        SearchTestsUtil.searchAll(camAdminRestContext, 'general', null, {'resourceTypes': 'user', 'q': 'Jack'}, function(err, results) {
                                            assert.ok(!err);
                                            var jackDoc = _getDocById(results, jack.id);
                                            assert.ok(jackDoc);
                                            assert.equal(jackDoc.id, jack.id);
                ...
                RestAPI.User.createUser(gtAdminRestContext, sithUsername, 'password', 'Sithy Sitherson', null, function(err, sith) {
                    ...
                    RestAPI.User.createUser(camAdminRestContext, jackUsername, 'password', 'Jack McJackerson', null, function(err, jack) {
                        ...
                        RestAPI.User.createUser(camAdminRestContext, janeUsername, 'password', 'Janey McJaneFace', null, function(err, jane) {
                            ...
                            RestAPI.Group.createGroup(jackRestContext, groupAlias, 'A really awesome group', 'public', 'no', [], [sith.id], function(err, group) {
                                assert.ok(!err);
                                ...
                                SearchTestsUtil.searchAll(anonymousRestContext, 'general', null, {'resourceTypes': 'group', 'q': 'awesome'}, function(err, results) {
                                    ...
                                    SearchTestsUtil.searchAll(darthVaderRestContext, 'general', null, {'resourceTypes': 'group', 'q': 'awesome'}, function(err, results) {
                                        assert.ok(!err);
                                        var groupDoc = _getDocById(results, group.id);
                                        assert.ok(!groupDoc);

                                        // Verify cross-tenant user can query the group with includeExternal
                                        SearchTestsUtil.searchAll(darthVaderRestContext, 'general', null, {'resourceTypes': 'group', 'q': 'awesome', 'includeExternal': true}, function(err, results) {
                                            assert.ok(!err);
                                            var groupDoc = _getDocById(results, group.id);
                                            assert.ok(groupDoc);
                                            assert.equal(groupDoc.tenantAlias, group.tenant.alias);
                                            ...
                                            SearchTestsUtil.searchAll(sithRestContext, 'general', null, {'resourceTypes': 'group', 'q': 'awesome'}, function(err, results) {
                                                assert.ok(!err);
                                                var groupDoc = _getDocById(results, group.id);
                                                assert.ok(groupDoc);
                                                assert.equal(groupDoc.tenantAlias, group.tenant.alias);
                                                ...
                                                SearchTestsUtil.searchAll(janeRestContext, 'general', null, {'resourceTypes': 'group', 'q': 'awesome'}, function(err, results) {
                                                    assert.ok(!err);
                                                    var groupDoc = _getDocById(results, group.id);
                                                    assert.ok(groupDoc);
                                                    assert.equal(groupDoc.tenantAlias, group.tenant.alias);
                                                    ...
                                                    SearchTestsUtil.searchAll(jackRestContext, 'general', null, {'resourceTypes': 'group', 'q': 'awesome'}, function(err, results) {
                                                        assert.ok(!err);
                                                        var groupDoc = _getDocById(results, group.id);
                                                        assert.ok(groupDoc);
                                                        assert.equal(groupDoc.tenantAlias, group.tenant.alias);
            ...
            TestsUtil.createTenantWithAdmin(privateTenantAlias, privateTenantAlias, function(err, privateTenant, privateTenantAdminRestContext) {
                ...
                ConfigTestUtil.updateConfigAndWait(TestsUtil.createGlobalAdminRestContext(), privateTenantAlias, 'oae-tenants/tenantprivacy/tenantprivate', true, function(err) {
                    ...
                    RestAPI.User.createUser(privateTenantAdminRestContext, lukeSkywalkerUsername, 'password', 'Luke Skywalker', null, function(err, lukeSkywalker) {
                        ...
                        RestAPI.Group.createGroup(lukeSkywalkerRestContext, privateTenantGroupAlias, 'A luke skywalker tenant group', 'loggedin', 'yes', [], [], function(err, privateTenantGroup) {
                            assert.ok(!err);
                                ...
                                RestAPI.User.createUser(gtAdminRestContext, sithUsername, 'password', 'Sithy Sitherson', null, function(err, sith) {
                                    ...
                                    RestAPI.User.createUser(camAdminRestContext, jackUsername, 'password', 'Jack McJackerson', null, function(err, jack) {
                                        ...
                                        RestAPI.User.createUser(camAdminRestContext, janeUsername, 'password', 'Janey McJaneFace', null, function(err, jane) {
                                            ...
                                            // Create the group, including sith as a user
                                            RestAPI.Group.createGroup(jackRestContext, groupAlias, 'A really awesome group', 'loggedin', 'no', [], [sith.id], function(err, group) {
                                                assert.ok(!err);

                                                // Create the joinable group, including sith as a user
                                                RestAPI.Group.createGroup(jackRestContext, groupAliasJoinable, 'A really super joinable group', 'loggedin', 'request', [], [sith.id], function(err, groupJoinable) {
                                                    assert.ok(!err);
                                                    ...
                                                    SearchTestsUtil.searchAll(anonymousRestContext, 'general', null, {'resourceTypes': 'group', 'q': 'awesome'}, function(err, results) {
                                                        ...
                                                        SearchTestsUtil.searchAll(anonymousRestContext, 'general', null, {'resourceTypes': 'group', 'q': 'joinable'}, function(err, results) {
                                                            assert.ok(!err);
                                                            ...
                                                            SearchTestsUtil.searchAll(darthVaderRestContext, 'general', null, {'resourceTypes': 'group', 'q': 'awesome', 'includeExternal': true}, function(err, results) {
                                                                ...
                                                                SearchTestsUtil.searchAll(darthVaderRestContext, 'general', null, {'resourceTypes': 'group', 'q': 'joinable', 'includeExternal': true}, function(err, results) {
                                                                    assert.ok(!err);
                                                                    var groupDoc = _getDocById(results, groupJoinable.id);
                                                                    assert.ok(groupDoc);
                                                                    assert.equal(groupDoc.tenantAlias, groupJoinable.tenant.alias);
                                                                    assert.equal(groupDoc.resourceType, 'group');
                                                                    assert.equal(groupDoc.profilePath, '/group/' + groupDoc.tenant.alias + '/' + AuthzUtil.getResourceFromId(groupDoc.id).resourceId);
                                                                    ...
                                                                    SearchTestsUtil.searchAll(sithRestContext, 'general', null, {'resourceTypes': 'group', 'q': 'awesome'}, function(err, results) {
                                                                        ...
                                                                        SearchTestsUtil.searchAll(janeRestContext, 'general', null, {'resourceTypes': 'group', 'q': 'awesome'}, function(err, results) {
                                                                            ...
                                                                            SearchTestsUtil.searchAll(jackRestContext, 'general', null, {'resourceTypes': 'group', 'q': 'awesome'}, function(err, results) {
                                                                                ...
                                                                                SearchTestsUtil.searchAll(lukeSkywalkerRestContext, 'general', null, {'resourceTypes': 'group', 'q': 'skywalker'}, function(err, results) {
                                                                                    assert.ok(!err);
                                                                                    ...
                                                                                    SearchTestsUtil.searchAll(lukeSkywalkerRestContext, 'general', null, {'resourceTypes': 'group', 'q': 'joinable', 'includeExternal': true}, function(err, results) {
                                                                                        assert.ok(!err);
                                                                                        var groupDoc = _getDocById(results, groupJoinable.id);
                                                                                        assert.ok(!groupDoc);
                                                                                        ...
                                                                                        SearchTestsUtil.searchAll(jackRestContext, 'general', null, {'resourceTypes': 'group', 'q': 'skywalker', 'includeExternal': true}, function(err, results) {
                                                                                            assert.ok(!err);
                                                                                            var groupDoc = _getDocById(results, privateTenantGroup.id);
                                                                                            assert.ok(!groupDoc);
                                                                                            callback();
            ...
            TestsUtil.createTenantWithAdmin(privateTenantAlias, privateTenantAlias, function(err, privateTenant, privateTenantAdminRestContext) {
                ...
                ConfigTestUtil.updateConfigAndWait(TestsUtil.createGlobalAdminRestContext(), privateTenantAlias, 'oae-tenants/tenantprivacy/tenantprivate', true, function(err) {
                    ...
                    RestAPI.User.createUser(privateTenantAdminRestContext, lukeSkywalkerUsername, 'password', 'Luke Skywalker', null, function(err, lukeSkywalker) {
                        ...
                        RestAPI.Group.createGroup(lukeSkywalkerRestContext, privateTenantGroupAlias, 'A luke skywalker tenant group', 'private', 'yes', [], [], function(err, privateTenantGroup) {
                            assert.ok(!err);
                                ...
                                RestAPI.User.createUser(gtAdminRestContext, sithUsername, 'password', 'Sithy Sitherson', null, function(err, sith) {
                                    ...
                                    RestAPI.User.createUser(camAdminRestContext, jackUsername, 'password', 'Jack McJackerson', null, function(err, jack) {
                                        ...
                                        RestAPI.User.createUser(camAdminRestContext, janeUsername, 'password', 'Janey McJaneFace', null, function(err, jane) {
                                            ...
                                            // Create the group, including sith as a user
                                            RestAPI.Group.createGroup(jackRestContext, groupAlias, 'A really awesome group', 'private', 'no', [], [sith.id], function(err, group) {
                                                assert.ok(!err);

                                                // Create the joinable group, including sith as a user
                                                RestAPI.Group.createGroup(jackRestContext, groupAliasJoinable, 'A really super joinable group', 'private', 'request', [], [sith.id], function(err, groupJoinable) {
                                                    assert.ok(!err);
            ...
            TestsUtil.generateTestUsers(camAdminRestContext, 1, function(err, users) {
                ...
                RestAPI.Content.createLink(restCtx, 'Theological reasoning', null, 'public', 'http://www.sakaifoundation.org', [], [], function(err, contentA) {
                    ...
                    RestAPI.Content.createLink(restCtx, 'Independent workforce', null, 'public', 'http://www.sakaifoundation.org', [], [], function(err, contentB) {
                        ...
                        RestAPI.Group.createGroup(restCtx, groupAlias, 'A really awesome group', 'public', 'no', [], [], function(err, group) {
                            assert.ok(!err);
    ...
    describe('Search Options', function() {
        ...
        it('verify resourceType scope param', function(callback) {
            ...
            RestAPI.User.createUser(camAdminRestContext, jackUsername, 'password', 'Jack JickMackerson', null, function(err, jack) {
                ...
                RestAPI.Group.createGroup(camAdminRestContext, groupAlias, 'A really awesome group', 'public', 'no', [], [], function(err, group) {
                    assert.ok(!err);
        ...
        it('verify includeIndirect option', function(callback) {
            ...
            RestAPI.User.createUser(camAdminRestContext, jackUsername, 'password', 'Jack JickMackerson', null, function(err, jack) {
                ...
                RestAPI.Group.createGroup(camAdminRestContext, group1Alias, 'A really awesome group', 'private', 'no', [], [jack.id], function(err, group1) {
                    assert.ok(!err);

                    RestAPI.Group.createGroup(camAdminRestContext, group2Alias, 'A really awesome group', 'private', 'no', [], [group1.id], function(err, group2) {
                        assert.ok(!err);
                        ...
                        SearchTestsUtil.searchAll(jackCtx, 'general', null, {'q': 'awesome'}, function(err, results) {
                            ...
                            SearchTestsUtil.searchAll(jackCtx, 'general', null, {'q': 'awesome', 'includeIndirect': false}, function(err, results) {
                                assert.ok(!err);
