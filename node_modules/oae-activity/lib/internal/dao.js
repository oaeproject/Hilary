...
var deliverActivities = module.exports.deliverActivities = function(routedActivities, callback) {
    ...
    _.each(routedActivities, function(activities, route) {
        var query = Cassandra.constructUpsertCQL('ActivityStreams', 'activityStreamId', route, activities, null, ActivityConfig.getConfig().activityTtl);
        if (query) {
            queries.push(query);
        } else {
...
var updateAggregateStatus = module.exports.updateAggregateStatus = function(statusUpdates, callback) {
    ...
    aggregateKeys.forEach(function(aggregateKey) {
        var query = Cassandra.constructUpsertCQL('ActivityAggregateStatus', 'aggregateKey', aggregateKey, statusUpdates[aggregateKey], null, ActivityConfig.getConfig().aggregateMaxExpiry);
        if (query) {
            queries.push(query);
        } else {
...
var _getAggregatedEntityQuery = function(aggregateKey, aggregate, entityType) {
    ...
    return Cassandra.constructUpsertCQL('ActivityAggregateEntities', 'aggregateKey', key, aggregate[entityType], null, ActivityConfig.getConfig().aggregateMaxExpiry);
};
