...
var getFoldersByGroupIds = module.exports.getFoldersByGroupIds = function(groupIds, callback) {
    ...
    Cassandra.runInQuery('SELECT * FROM "FoldersGroupId"', null, 'groupId', groupIds, function(err, rows) {
        ...
        var folderIdsByGroupIds = _.indexBy(rows, 'groupId');
...
var updateFolder = module.exports.updateFolder = function(folder, profileFields, callback) {
    ...
    storageHash.lastModified = new Date(storageHash.lastModified);
...
var iterateAll = module.exports.iterateAll = function(properties, batchSize, onEach, callback) {
    ...
    var _iterateAllOnEach = function(rows, done) {
        // Delegate action to the caller onEach method
        return onEach(rows, done);
    };
...
var _createUpdatedFolderFromStorageHash = function(folder, updatedStorageHash) {
    var lastModifiedInMillis = (updatedStorageHash.lastModified ? updatedStorageHash.lastModified.getTime() : folder.lastModified);
    return new Folder(
        folder.tenant,
        folder.id,
        folder.groupId,
...
var _rowToFolder = function(row) {
    try {
        row.previews = JSON.parse(row.previews);
    } catch (err) {
        row.previews = {};
    }
    return _storageHashToFolder(row.id, row);
};
...
var _storageHashToFolder = function(folderId, storageHash) {
    return new Folder(
        ...
        storageHash.created.getTime(),
        storageHash.lastModified.getTime(),
