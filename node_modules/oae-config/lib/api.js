 ...
 *
 * @param  {Context}    ctx                 Standard context object, representing the currently logged in user and its tenant
 * @param  {String}     tenantAlias         The alias of the tenant for which we want to get the cached config
 * @param  {Function}   callback            Standard callback function
 * @param  {Object}     callback.err        An error that occurred, if any
...
var getTenantConfig = module.exports.getTenantConfig = function(ctx, tenantAlias, callback) {
    ...
    return callback(null, cachedPublicConfig[tenantAlias]);
};
 ...
 *
 * @param  {Function}   callback    Standard callback function executed when the schema has been cached
 * @api private
 */
...
/**
 * Determine if the current user is allowed to update the configuration value. This function does not do any permission checks.
...
var updateConfig = module.exports.updateConfig = function(ctx, tenantAlias, configValues, callback) {
    ...
    ConfigAPI.emit('preUpdate', tenantAlias, configValues);
 ...
 *
 * @param  {Context}    ctx             The current context
 * @param  {String}     tenantAlias     The alias of the tenant whose config to clear
...
var clearConfig = module.exports.clearConfig = function(ctx, tenantAlias, configFields, callback) {
    ...
    ConfigAPI.emit('preClear', tenantAlias, configFields);
