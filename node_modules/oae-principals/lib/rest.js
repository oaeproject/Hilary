...
module.exports = function(tenant) {
    ...
    tenant.server.post('/api/user/create', function(req, res) {
        var createUser = function() {
            var loginId = new LoginId(tenant.alias, 'local', req.body.username, { password: req.body.password });
            var opts = {
            ...
            AuthenticationAPI.createUser(req.ctx, loginId, req.body.displayName, opts, function(err, user) {
                if (err) {
                    return res.send(err.code, err.msg);
                }
