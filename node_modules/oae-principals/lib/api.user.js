...
var importUsers = module.exports.importUsers = function(ctx, tenantAlias, userCSV, authenticationStrategy, callback) {
    ...
    var validator = new Validator();
    validator.check(null, {'code': 400, 'msg': 'An existing tenant alias must be provided'}).isObject(tenant);
    validator.check(null, {'code': 400, 'msg': 'A CSV file must be provided'}).isObject(userCSV);
    if (userCSV) {
