...
var TokenDAO = require('./tokens');

var config = require('../../config');
var LoodleConfig = require('oae-config').config('oae-doodle');

/**
 * Get token
 *
 * @type {exports.getToken}
 */
...
var create = exports.createUserIfNeeded = function (ctx, userId, callback) {

    async.waterfall([
        // Check if the user has already a miror account or not
        function userHasAlreadyAccount (done) {
            TokenDAO.isInDb(userId, done);
        },
 ...
 * @param callback
 */
var createLoodleAccount = function (ctx, user, callback) {
 ...
 */
var createAccount = exports.createAccount = function (user, callback) {
