...
describe('Telemetry', function() {
  ...
  describe('Publish and Reset', function() {
    ...
    it('verify publish interval publishes the proper data while reset clears the data', function(callback) {
      ...
      TelemetryAPI.init(
        _createConfig({ publishInterval: 1, resetInterval: 2 }),
        function(err) {
          assert.ok(!err);
  ...
  describe('REST endpoint', function() {
    ...
    it('verify that only a global admin can request the telemetry data', function(callback) {
      TestsUtil.generateTestUsers(camAdminRestContext, 1, function(
        ...
        RestAPI.Telemetry.getTelemetryData(anonymousCamRestContext, function(
          err,
          res,
        ) {
          assert.ok(err);
          ...
          RestAPI.Telemetry.getTelemetryData(
            ...
            function(err, res) {
              ...
              RestAPI.Telemetry.getTelemetryData(john.restContext, function(
                err,
                res,
              ) {
                assert.ok(err);
