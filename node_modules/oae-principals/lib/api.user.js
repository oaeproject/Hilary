...
var createUser = module.exports.createUser = function(ctx, tenantAlias, displayName, opts, callback) {
    ...
    validator.check(opts.visibility, {'code': 400, 'msg': 'The specified visibility setting is unknown'}).isValidVisibility();
...
var updateUser = module.exports.updateUser = function(ctx, userId, profileFields, callback) {
    ...
    if (profileFields['visibility']) {
        validator.check(profileFields['visibility'], {'code': 400, 'msg': 'An invalid visibility option has been specified'}).isValidVisibility();
    }
