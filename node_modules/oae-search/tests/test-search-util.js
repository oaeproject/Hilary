...
describe('Search Util', function() {
    ...
    describe('Others', function() {
         ...
         */
        it('verify getSortDirParam', function(callback) {
            var validType = SearchConstants.sort.direction.ASC;
            var validType2 = SearchConstants.sort.direction.DESC;

            assert.equal(SearchUtil.getSortDirParam(validType, validType2), validType);
            assert.equal(SearchUtil.getSortDirParam(validType), validType);
            assert.equal(SearchUtil.getSortDirParam('not-valid', validType), validType);
            assert.equal(SearchUtil.getSortDirParam('not-valid', 'not-valid'), SearchConstants.sort.direction.ASC);
            assert.equal(SearchUtil.getSortDirParam(validType), validType);
            assert.equal(SearchUtil.getSortDirParam(null, validType), validType);
            assert.equal(SearchUtil.getSortDirParam(null, null), SearchConstants.sort.direction.ASC);
            assert.equal(SearchUtil.getSortDirParam(validType), validType);
            assert.equal(SearchUtil.getSortDirParam(undefined, validType), validType);
            assert.equal(SearchUtil.getSortDirParam(), SearchConstants.sort.direction.ASC);
            return callback();
        });
        ...
        it('verify getScopeParam', function(callback) {
            ...
            assert.equal(SearchUtil.getScopeParam(), SearchConstants.general.SCOPE_ALL);
            assert.equal(SearchUtil.getScopeParam('invalid'), SearchConstants.general.SCOPE_ALL);
            assert.equal(SearchUtil.getScopeParam('invalid', 'invalid'), SearchConstants.general.SCOPE_ALL);
            ...
            assert.equal(SearchUtil.getScopeParam(SearchConstants.general.SCOPE_MY, tenantAlias), SearchConstants.general.SCOPE_MY);
            return callback();
        });
    });
});
