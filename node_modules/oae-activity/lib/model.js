 ...
 */
var ActivitySeedResource = (module.exports.ActivitySeedResource = function(
  resourceType,
  resourceId,
  resourceData,
) {
 ...
 */
var ActivitySeed = (module.exports.ActivitySeed = function(
  activityType,
  published,
  verb,
  actorResource,
 ...
 */
var ActivityMediaLink = (module.exports.ActivityMediaLink = function(
  url,
  width,
  height,
  duration,
 ...
 */
var Activity = (module.exports.Activity = function(
  oaeActivityType,
  oaeActivityId,
  verb,
  published,
 ...
 */
var ActivityEntity = (module.exports.ActivityEntity = function(
  objectType,
  id,
  visibility,
  opts,
  ...
  var ext = opts.ext || {};
  delete opts.ext;
  return _.extend({}, ext, opts, {
    objectType: objectType,
    id: id,
    'oae:visibility': visibility,
  });
});
 ...
 */
var ActivityStream = (module.exports.ActivityStream = function(
  activities,
  nextToken,
) {
 ...
 */
var AssociationsSession = (module.exports.AssociationsSession = function(
  ...
  if (object) {
    ...
    _knownEntities[object.objectType][
  ...
  if (target) {
    ...
    _knownEntities[target.objectType][
   ...
   */
  associationsSession.getByEntityId = function(
    entityType,
    entityId,
    associationName,
    callback,
    ...
    var associationFunction =
      registeredAssociations[entityType] &&
      registeredAssociations[entityType][associationName];
    ...
    var entity =
      _knownEntities[entityType] && _knownEntities[entityType][entityId];
    if (!entity) {
      return callback();
    }
   ...
   */
  associationsSession.createAssociationsContext = function(
    entityType,
    entityId,
  ) {
    ...
    var get = (associationsContext.get = function(associationName, callback) {
      return getSession().getByEntityId(
        entityType,
        entityId,
        associationName,
        callback,
