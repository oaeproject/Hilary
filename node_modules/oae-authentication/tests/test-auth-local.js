...
describe('Authentication', function() {
    ...
    describe('Local authentication', function() {
        ...
        it('verify account creation locking', function(callback) {
            ...
            RestAPI.User.createUser(camAdminRestContext, userId, 'password', 'Test User', {'email': email1}, function(err, createdUser) {
                err1 = err;
                checkComplete();
            });
            RestAPI.User.createUser(camAdminRestContext, userId, 'password', 'Test User', {'email': email2}, function(err, createdUser) {
                err2 = err;
                checkComplete();
            });
        });
                            ...
                            RestAPI.Authentication.exists(anonymousCamRestContext, username.toUpperCase(), function(err) {
                                ...
                                RestAPI.Authentication.exists(anonymousGtRestContext, username, function(err) {
                                    ...
                                    RestAPI.Authentication.existsOnTenant(globalAdminRestContext, global.oaeTests.tenants.cam.alias, username, function(err) {
                                        ...
                                        // Create a user with this login id
                                        var email = TestsUtil.generateTestEmailAddress();
                                        RestAPI.User.createUserOnTenant(globalAdminRestContext, global.oaeTests.tenants.cam.alias, username, 'password', 'Test User', {'visibility': 'public', 'email': email}, function(err, createdUser) {
                                            assert.ok(!err);
                                            assert.ok(createdUser);
        ...
        it('verify tenant administrator profile parameters', function(callback) {
            ...
            RestAPI.User.createTenantAdminUserOnTenant(globalAdminRestContext, global.oaeTests.tenants.cam.alias, username, password, displayName, opts, function(err, user) {
                ...
                RestAPI.User.getUser(globalAdminRestContext, user.id, function(err, user) {
                    ...
                    username = TestsUtil.generateTestUserId();
                    opts.email = TestsUtil.generateTestEmailAddress();
