...
describe('MixPanel - Users', function() {
     ...
     */
    beforeEach(function() {
        require('../../../config').config.mixpanel.enabled = true;
    });
     ...
     */
    after(function() {
        require('../../../config').config.mixpanel.enabled = false;
    });

    describe('#getUniqueUsers()', function() {
    ...
    describe('#getUniqueUsersForTenant()', function() {
