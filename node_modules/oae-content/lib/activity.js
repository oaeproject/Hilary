 ...
 */
ContentAPI.on(ContentConstants.events.CREATED_CONTENT, function(
  ctx,
  content,
  revision,
  memberChangeInfo,
 ...
 */
ContentAPI.on(ContentConstants.events.UPDATED_CONTENT, function(
  ctx,
  newContent,
  oldContent,
  revision,
 ...
 */
ContentAPI.on(ContentConstants.events.UPDATED_CONTENT_BODY, function(
  ctx,
  newContentObj,
  oldContentObj,
  revision,
 ...
 */
ContentAPI.on(ContentConstants.events.EDITED_COLLABDOC, function(
  ctx,
  contentObj,
) {
  var millis = Date.now();
 ...
 */
ContentAPI.on(ContentConstants.events.RESTORED_REVISION, function(
  ctx,
  newContentObj,
  oldContentObj,
  restoredRevision,
 ...
 */
ContentAPI.on(ContentConstants.events.CREATED_COMMENT, function(
  ctx,
  message,
  content,
) {
  ...
  var objectResource = new ActivityModel.ActivitySeedResource(
    'content-comment',
    message.id,
    { contentId: content.id, message: message },
  );
 ...
 */
ContentAPI.on(ContentConstants.events.UPDATED_CONTENT_MEMBERS, function(
  ctx,
  content,
  memberChangeInfo,
  opts,
  ...
  var contentResource = new ActivityModel.ActivitySeedResource(
    'content',
    content.id,
    { content: content },
  );
...
var _contentProducer = function(resource, callback) {
  var content =
    resource.resourceData && resource.resourceData.content
      ? resource.resourceData.content
      : null;
  ...
  if (content) {
    return callback(
      null,
      ContentUtil.createPersistentContentActivityEntity(content),
    );
  }
...
var _contentCommentTransformer = function(ctx, activityEntities, callback) {
  ...
  _.keys(activityEntities).forEach(function(activityId) {
    ...
    _.keys(activityEntities[activityId]).forEach(function(entityId) {
      ...
      var profilePath =
        '/content/' +
        contentResource.tenantAlias +
        '/' +
        contentResource.resourceId;
 ...
 * @see ActivityAPI#registerActivityEntityType
 */
var _contentCommentInternalTransformer = function(
  ctx,
  activityEntities,
  callback,
) {
 ...
 */
ActivityAPI.registerActivityEntityAssociation('content', 'self', function(
  associationsCtx,
  entity,
  callback,
) {
 ...
 */
ActivityAPI.registerActivityEntityAssociation('content', 'members', function(
  associationsCtx,
  entity,
  callback,
) {
 ...
 */
ActivityAPI.registerActivityEntityAssociation('content', 'managers', function(
  associationsCtx,
  entity,
  callback,
) {
