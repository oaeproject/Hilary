...
var ensureSchema = function(callback) {
    Cassandra.createColumnFamily('Config', 'CREATE TABLE "Config" ("tenantAlias" text, "configKey" text, "value" text, PRIMARY KEY ("tenantAlias", "configKey")) WITH COMPACT STORAGE', callback);
};
