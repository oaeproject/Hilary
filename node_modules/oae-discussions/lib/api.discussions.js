...
var createDiscussion = module.exports.createDiscussion = function(ctx, displayName, description, visibility, members, opts, callback) {
    ...
    validator.check(displayName, {'code': 400, 'msg': 'A displayName can be at most a 1000 characters long'}).isShortString();
    validator.check(displayName, {'code': 400, 'msg': 'Must provide a description for the discussion'}).notEmpty();
...
var updateDiscussion = module.exports.updateDiscussion = function(ctx, discussionId, profileFields, callback) {
    ...
    _.each(profileFields, function(value, field) {
        ...
        if (field === 'visibility') {
            ...
            validator.check(value, {'code': 400, 'msg': 'A displayName can be at most a 1000 characters long'}).isShortString();
