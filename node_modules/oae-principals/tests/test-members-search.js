          ...
          RestAPI.User.updateUser(
            ...
            function(err, privateUser) {
              ...
              RestAPI.Group.createGroup(
                ...
                [],
                [],
                function(err, _targetPublicGroup) {
                  assert.ok(!err);
                  ...
                  RestAPI.Group.createGroup(
                    ...
                    [],
                    [],
                    function(err, _targetLoggedinGroup) {
                      assert.ok(!err);
                      ...
                      RestAPI.Group.createGroup(
                        ...
                        [],
                        [],
                        function(err, _targetPrivateGroup) {
                          assert.ok(!err);
                          ...
                          RestAPI.Group.createGroup(
                            ...
                            [],
                            [],
                            function(err, _publicGroupMember) {
                              assert.ok(!err);
                              ...
                              RestAPI.Group.createGroup(
                                ...
                                [],
                                [],
                                function(err, _privateGroupMember) {
                                  assert.ok(!err);
        ...
        RestAPI.Group.setGroupMembers(
          ...
          function(err) {
            ...
            SearchTestsUtil.searchAll(
              ...
              function(err, results) {
                assert.ok(!err);
                var publicUserResult = _getDocById(
                  results,
                  publicUserMember.id,
                );
                var loggedinUserResult = _getDocById(
                  results,
                  loggedinUserMember.id,
                );
                var privateUserResult = _getDocById(
                  results,
                  privateUserMember.id,
                );
                var privateGroupResult = _getDocById(
                  results,
                  privateGroupMember.id,
                );
                var publicGroupResult = _getDocById(
                  results,
                  publicGroupMember.id,
                );
                ...
                assert.equal(
                  ...
                  '/group/' +
                    ...
                    '/' +
                    AuthzUtil.getResourceFromId(publicGroupResult.id)
                      .resourceId,
                );
                  ...
                  function(err, results) {
                    ...
                    assert.equal(
                      ...
                      '/user/' +
                        publicUserResult.tenant.alias +
                        '/' +
                        AuthzUtil.getResourceFromId(publicUserResult.id)
                          .resourceId,
                    );
                    assert.equal(
                      publicGroupResult.profilePath,
                      ...
                      function(err, results) {
                        ...
                        assert.equal(
                          ...
                          '/user/' +
                            ...
                            '/' +
                            AuthzUtil.getResourceFromId(loggedinUserResult.id)
                              .resourceId,
                        );
                        assert.equal(
                          publicGroupResult.profilePath,
                        ...
                        SearchTestsUtil.searchAll(
                          ...
                          function(err, results) {
                            ...
                            assert.equal(publicUserResult.resourceType, 'user');
                            assert.equal(
                              loggedinUserResult.resourceType,
                              'user',
                            );
                            assert.equal(
                              privateUserResult.resourceType,
                              'user',
                            );
                            assert.equal(
                              publicGroupResult.resourceType,
                              'group',
                            );
                            assert.equal(
                              privateGroupResult.resourceType,
                              'group',
                            );
                            ...
                            assert.equal(
                              ...
                              '/user/' +
                                ...
                                AuthzUtil.getResourceFromId(
                                  loggedinUserResult.id,
                                ).resourceId,
                            );
                            assert.equal(
                              privateUserResult.profilePath,
                              undefined,
                            );
                            assert.equal(
                              publicGroupResult.profilePath,
