 ...
 */
var getAllIndirectPrincipalMemberships = module.exports.getAllIndirectPrincipalMemberships = function(principalId, callback, _groupIds, _nextToken) {
    var validator = new Validator();
    validator.check(principalId, {'code': 400, 'msg': 'Invalid principal id provided'}).isPrincipalId();
    if (validator.hasErrors()) {
        return callback(validator.getFirstError());
    ...
    getIndirectPrincipalMemberships(principalId, _nextToken, 100, function(err, groupIds, nextToken) {
        if (err) {
            return callback(err);
        }
