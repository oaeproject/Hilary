 ...
 * @param  {Boolean}    [options.globalAdminOnly]   Whether or not this config element is only available to global admin users. Defaults to `false`
 */
var Bool = (module.exports.Bool = function(
  name,
  description,
  defaultValue,
  options,
 ...
 * @param  {Boolean}    [options.globalAdminOnly]   Whether or not this config element is only available to global admin users. Defaults to `false`
 */
var Text = (module.exports.Text = function(
  name,
  description,
  defaultValue,
  options,
 ...
 * @param  {Boolean}    [options.globalAdminOnly]   Whether or not this config element is only available to global admin users. Defaults to `false`
 */
var InternationalizableText = (module.exports.InternationalizableText = function(
  name,
  description,
  defaultValue,
  options,
 ...
 * @param  {Boolean}    [options.globalAdminOnly]   Whether or not this config element is only available to global admin users. Defaults to `false`
 */
var Radio = (module.exports.Radio = function(
  name,
  description,
  defaultValue,
  group,
