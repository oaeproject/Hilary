 ...
 */
var getActivityStream = module.exports.getActivityStream = function(ctx, resourceId, activtyStreamType, start, limit, callback) {
    ...
    authorizationHandler(ctx, resourceId, null, function(err) {
        ...
        return _getActivityStream(ctx, resourceId + '#' + activtyStreamType, start, limit, callback);
    });
};
...
var _getActivityStream = function(ctx, activityStreamId, start, limit, callback) {
    ActivityDAO.getActivities(activityStreamId, start, limit, function(err, activities, nextToken) {
        ...
        ActivityTransformer.transformActivities(ctx, activities, ActivityConstants.transformerTypes.ACTIVITYSTREAMS, function(err) {
            if (err) {
                return callback(err);
            }
