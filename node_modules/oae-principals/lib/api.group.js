...
var createGroup = module.exports.createGroup = function(ctx, alias, name, description, visibility, joinable, members, otherValues, callback) {
    ...
    visibility = visibility || PrincipalsConfig.getValue(ctx.tenant().alias, 'grouppermissions', 'defaultaccess');
    joinable = joinable || PrincipalsConfig.getValue(ctx.tenant().alias, 'groupjoinrequests', 'defaultjoin');
