...
var init = module.exports.init = function(config, callback) {
    ...
    // document conversion.
    // We try to convert this file (office.js) to a pdf to verify libreoffice has been configured correctly.
    ...
    log().info('Executing %s to verify if the path to the office binary is correct.\nThis might take a couple of seconds.', cmd);
