...
module.exports = {
    ...
    'instance': {
        ...
        'elements': {
            ...
            'hostingOrganisation': new Fields.Text('Hosting organisation', 'The name of the organisation hosting the current instance', '', {'tenantOverride': false}),
            'hostingOrganisationURL': new Fields.Text('Hosting organisation URL', 'The URL of the hosting organisation website', '', {'tenantOverride': false})
        }
    },
    'actions': {
    ...
    'domains': {
        'name': 'Tenant domains',
        'description': 'Domains associated to this tenant',
        'elements': {
            'email': new Fields.Text('Email domain', 'A regular expression that identifies the email domains associated to this tenant', '', {'tenantOverride': false, 'suppress': true, 'globalAdminOnly': true})
        }
    }
};
