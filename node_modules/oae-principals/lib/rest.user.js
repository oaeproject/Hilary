...
/**
 * Handle the request to make a user a tenant admin.
 *
...
OAE.globalAdminServer.post('/api/user/:id/admin', _handleSetTenantAdmin);
...
OAE.tenantServer.post('/api/user/:id/admin', _handleSetTenantAdmin);
