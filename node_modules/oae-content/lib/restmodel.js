...
/**
 * @RESTModel BasicCollabdocContent
 *
 * @Required    [created,createdBy,displayName,etherpadGroupId,etherpadPadId,id,lastModified,previews,resourceSubType,tenantAlias,visibility]
 ...
 * @Property    {string}    etherpadGroupId     ID of etherpad group containing the collabdoc
 * @Property    {string}    etherpadPadId       ID of etherpad document
 ...
 *
 * @Required  []
 * @Property  {BasicCollabdocContent}   (basicCollabdocContent)     Used when content is a collabdoc
 * @Property  {BasicFileContent}        (basicFileContent)          Used when content is a file
 * @Property  {BasicLinkContent}        (basicLinkContent)          Used when content is a link
 */

/**
 * @RESTModel BasicFileContent
 *
 * @Required    [created,createdBy,displayName,downloadPath,filename,id,lastModified,mime,previews,resourceSubType,size,tenantAlias,visibility]
 * @Property    {number}    created             Timestamp at which this content item was created in milliseconds since epoch
 * @Property    {string}    createdBy           Unique identifier of the user who created this content item
 * @Property    {string}    description         Description of the content item
 * @Property    {string}    displayName         Title of the content item
 * @Property    {string}    downloadPath        Relative URL to retrieve original file
 * @Property    {string}    filename            Name of file
 * @Property    {string}    id                  Globally unique content ID for this content item
 * @Property    {number}    lastModified        Timestamp at which this content item was modified for the last time in milliseconds since epoch
 * @Property    {string}    mime                File type, e.g. application/pdf
 * @Property    {Previews}  previews            Preview data of the latest revision of the content item
 * @Property    {string}    resourceSubType     Type of content item                   [collabdoc,file,link]
...
/**
 * @RESTModel BasicLinkContent
 *
 * @Required    [created,createdBy,displayName,id,lastModified,previews,resourceSubType,tenantAlias,visibility]
 * @Property    {number}    created             Timestamp at which this content item was created in milliseconds since epoch
 * @Property    {string}    createdBy           Unique identifier of the user who created this content item
 * @Property    {string}    description         Description of the content item
 * @Property    {string}    displayName         Title of the content item
 ...
 *
 * @Required [contentId,created,createdBy,previews,previewsId,revisionId]
 ...
 * @Property    {BasicTenant}   tenant             Information about the tenant this content item is being created in
 * @Property    {string}        visibility         Visibility of the content item         [loggedin,private,public]
 */
 ...
 * @Property    {BasicContent[]}    results                 Array of content items associated with object
 ...
 *
 * @Required [contentId,created,createdBy,filename,mime,previews,previewsId,revisionId,size,uri]
 * @Property    {string}        contentId       Unique content ID of the content item
 * @Property    {number}        created         The timestamp that this revision was created (epoch format)
 * @Property    {User}          createdBy       User who created this revision
 ...
 * @Property    {boolean}    embeddable         Can link be embedded
 * @Property    {boolean}    httpsAccessible    Is link accessible via https
 ...
 *
 * @Required  []
 * @Property  {CollabdocRevision}   (collabdocRevision)     Used when content is a collabdoc
 * @Property  {FileRevision}        (fileRevision)          Used when content is a file
 * @Property  {LinkRevision}        (linkRevision)          Used when content is a link
 */
