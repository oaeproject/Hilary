...
const Discussion = require('oae-discussions/lib/model').Discussion;
 ...
 */
const createDiscussion = module.exports.createDiscussion = function(createdBy, displayName, description, visibility, opts, callback) {
    opts = opts || {};

    let created = opts.created || Date.now();
    created = created.toString();

    const tenantAlias = AuthzUtil.getPrincipalFromId(createdBy).tenantAlias;
 ...
 */
const updateDiscussion = module.exports.updateDiscussion = function(discussion, profileFields, callback) {
 ...
 */
const getDiscussion = module.exports.getDiscussion = function(discussionId, callback) {
 ...
 * @param  {Object}     callback.err        An error that occurred, if any
 */
const deleteDiscussion = module.exports.deleteDiscussion = function(discussionId, callback) {
...
var getDiscussionsById = module.exports.getDiscussionsById = function(discussionIds, fields, callback) {
    ...
    Cassandra.runQuery(query, parameters, (err, rows) => {
        ...
        const discussions = {};
        _.chain(rows).map(Cassandra.rowToHash).each((row) => {
