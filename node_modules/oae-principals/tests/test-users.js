...
describe('Users', function() {
    ...
    describe('Create user', function() {
        ...
        it('verify create user', function(callback) {
            ...
            TenantsTestUtil.createTenantAndWait(globalAdminRestContext, recaptchaTenantAlias, recaptchaTenantAlias, recaptchaTenantAlias, function(err, recaptchaTenant) {
                ...
                ConfigTestUtil.updateConfigAndWait(globalAdminRestContext, recaptchaTenantAlias, {'oae-principals/recaptcha/enabled': true}, function(err) {
                    ...
                    RestAPI.User.createUser(recaptchaAnonymousRestContext, username, 'password', 'Test User', {'visibility': 'public', 'email': email}, function(err, userObj) {
                        assert.ok(err);
                        assert.equal(err.code, 400);
                        assert.ok(!userObj);

                        RestAPI.User.createUser(camAdminRestContext, username, 'password', 'Test User', {'visibility': 'public', 'email': email}, function(err, createdUser) {
                            assert.ok(!err);
                            ...
                            RestAPI.User.createUser(camAdminRestContext, username, 'password', 'Test User', {'email': email2}, function(err, userObj) {
                                assert.ok(err);
                                assert.ok(!userObj);

                                // Try creating a new user as the created user
                                var newUsername = TestsUtil.generateTestUserId();
                                RestAPI.User.createUser(userRestContext, newUsername, 'password', 'Test User', {'email': email2}, function(err, userObj) {
                                    assert.ok(err);
                                    ...
                                    RestAPI.User.setTenantAdmin(globalAdminRestContext, createdUser.id, true, function(err) {
                                        ...
                                        RestAPI.User.createUser(userRestContext, newUsername, 'password', 'Test User', {'email': email2}, function(err, userObj) {
                                            ...
                                            RestAPI.User.createUserOnTenant(globalAdminRestContext, global.oaeTests.tenants.cam.alias, newUsername, 'password', 'Test User', {'visibility': 'public', 'email': email3}, function(err, userObj) {
                                                assert.ok(!err);
                                                assert.ok(userObj);
                                                ...
                                                RestAPI.User.createUserOnTenant(globalAdminRestContext, global.oaeTests.tenants.cam.alias, newUsername, 'password', 'Test User', {'visibility': 'public', 'email': email4}, function(err, userObj) {
                                                    assert.ok(!err);
                                                    assert.ok(userObj);
                                                    ...
                                                    RestAPI.User.createUserOnTenant(anonymousGlobalRestContext, 'admin', newUsername, 'password', 'Test User', {'email': email5}, function(err, userObj) {
                                                        assert.ok(err);
                                                        assert.equal(err.code, 401);

                                                        // Verify we cannot create a user on another tenant as global admin anonymous user
                                                        RestAPI.User.createUserOnTenant(anonymousGlobalRestContext, global.oaeTests.tenants.cam.alias, newUsername, 'password', 'Test User', {'email': email5}, function(err, userObj) {
                                                            assert.ok(err);
                                                            assert.equal(err.code, 401);
                                                            ...
                                                            newUsername = TestsUtil.generateTestUserId();
                                                            RestAPI.User.createUserOnTenant(camAdminRestContext, global.oaeTests.tenants.gt.alias, newUsername, 'password', 'Test User', {'visibility': 'public', 'email': email5}, function(err, userObj) {
                                                                assert.ok(err);
        ...
        it('verify an email address cannot be re-used', function(callback) {
            ...
            TenantsTestUtil.createTenantAndWait(globalAdminRestContext, tenantAlias, tenantAlias, tenantAlias, function(err, recaptchaTenant) {
                ...
                ConfigTestUtil.updateConfigAndWait(globalAdminRestContext, tenantAlias, {'oae-principals/recaptcha/enabled': false}, function(err) {
                    ...
                    var email = TestsUtil.generateTestEmailAddress();
                    RestAPI.User.createUser(anonymousRestContext, username1, 'password', 'Test User', {'visibility': 'public', 'email': email}, function(err, createdUser) {
                        assert.ok(!err);
                        RestAPI.User.createUser(anonymousRestContext, username2, 'password', 'Test User', {'visibility': 'public', 'email': email}, function(err, createdUser) {
                            assert.ok(err);
        ...
        it('verify user visibility defaults to the tenant default when created', function(callback) {
            ...
            RestAPI.User.createUser(camAdminRestContext, TestsUtil.generateTestUserId(), 'password', 'Bart', {'email': email1}, function(err, createdUser) {
                assert.ok(!err);
                assert.equal(createdUser.visibility, 'public');
                ...
                ConfigTestUtil.updateConfigAndWait(globalAdminRestContext, camTenantAlias, {'oae-principals/user/visibility': 'loggedin'}, function(err) {
                    ...
                    var email2 = TestsUtil.generateTestEmailAddress();
                    RestAPI.User.createUser(camAdminRestContext, TestsUtil.generateTestUserId(), 'password', 'Lisa', {'email': email2}, function(err, createdUser) {
                        assert.ok(!err);
                        ...
                        ConfigTestUtil.clearConfigAndWait(globalAdminRestContext, camTenantAlias, ['oae-principals/user/visibility'], function(err) {
                            ...
                            var email3 = TestsUtil.generateTestEmailAddress();
                            RestAPI.User.createUser(camAdminRestContext, TestsUtil.generateTestUserId(), 'password', 'Homer', {'visibility': 'private', 'email': email3}, function(err, createdUser) {
                                assert.ok(!err);
        ...
        it('verify email preference defaults to the tenant default when created', function(callback) {
            ...
            var email1 = TestsUtil.generateTestEmailAddress();
            RestAPI.User.createUser(camAdminRestContext, TestsUtil.generateTestUserId(), 'password', 'Bert', {'email': email1}, function(err, createdUser) {
                assert.ok(!err);
                ...
                ConfigTestUtil.updateConfigAndWait(globalAdminRestContext, camTenantAlias, {'oae-principals/user/emailPreference': 'weekly'}, function(err) {
                    ...
                    RestAPI.User.createUser(camAdminRestContext, TestsUtil.generateTestUserId(), 'password', 'Lisa', {'email': email2}, function(err, createdUser) {
                        ...
                        ConfigTestUtil.clearConfigAndWait(globalAdminRestContext, camTenantAlias, ['oae-principals/user/emailPreference'], function(err) {
                            ...
                            var email3 = TestsUtil.generateTestEmailAddress();
                            RestAPI.User.createUser(camAdminRestContext, TestsUtil.generateTestUserId(), 'password', 'Homer', {'emailPreference': 'daily', 'email': email3}, function(err, createdUser) {
                                assert.ok(!err);
        ...
        it('verify lowercasing of usernames', function(callback) {
            ...
            var email = TestsUtil.generateTestEmailAddress();
            RestAPI.User.createUser(camAdminRestContext, username, 'password', 'Test User', {'email': email}, function(err, createdUser) {
                assert.ok(!err);
        ...
        it('verify user gets default locale', function(callback) {
            ...
            var email1 = TestsUtil.generateTestEmailAddress();
            RestAPI.User.createUser(camAdminRestContext, userId1, 'password', 'Test User 1', {'email': email1}, function(err, createdUser1) {
                assert.ok(!err);
                ...
                ConfigTestUtil.updateConfigAndWait(globalAdminRestContext, global.oaeTests.tenants.cam.alias, {'oae-principals/user/defaultLanguage': 'es_ES'}, function(err) {
                    ...
                    // Create user without locale
                    var email2 = TestsUtil.generateTestEmailAddress();
                    RestAPI.User.createUser(camAdminRestContext, userId2, 'password', 'Test User 2', {'email': email2}, function(err, createdUser2) {
                        assert.ok(!err);
                        ...
                        ConfigTestUtil.updateConfigAndWait(camAdminRestContext, null, {'oae-principals/recaptcha/enabled': false}, function(err) {
                            ...
                            var email3 = TestsUtil.generateTestEmailAddress();
                            RestAPI.User.createUser(acceptLanguageRestContext, userId3, 'password', 'Test User 3', {'email': email3}, function(err, createdUser3) {
                                assert.ok(!err);
                ...
                RestAPI.User.createUser(camAdminRestContext, userId, null, 'Test User', null, function(err, userObj) {
                    ...
                    RestAPI.User.createUser(camAdminRestContext, userId, 'short', 'Test User', null, function(err, userObj) {
                        ...
                        RestAPI.User.createUser(camAdminRestContext, userId, 'password', null, null, function(err, userObj) {
                            ...
                            RestAPI.User.createUser(camAdminRestContext, userId, 'password', 'Alice Bar', {'email': 'invalid email'}, function(err, userObj) {
                                assert.ok(err);
                                assert.ok(!userObj);
                    ...
                    AuthenticationAPI.getUserIdFromLoginId(tenant.alias, 'cas', 'user-TGdDSdadW', function(err, nicolaasUserId) {
                        ...
                        AuthenticationAPI.getUserIdFromLoginId(tenant.alias, 'ldap', 'user-TGdDSdadW', function(err) {
                            ...
                            RestAPI.User.getUser(tenantAdminRestContext, nicolaasUserId, function(err, nicolaasUserObj) {
                                ...
                                assert.strictEqual(nicolaasUserObj.emailVerified, true);
                                ...
                                AuthenticationAPI.getUserIdFromLoginId(tenant.alias, 'cas', 'user-PQasQsaWQ', function(err, simonUserId) {
                                    ...
                                    AuthenticationAPI.getUserIdFromLoginId(tenant.alias, 'shibboleth', 'user-PQasQsaWQ', function(err) {
                                        ...
                                        RestAPI.User.getUser(tenantAdminRestContext, simonUserId, function(err, simonUserObj) {
                                            ...
                                            assert.strictEqual(simonUserObj.emailVerified, true);
                                            ...
                                            AuthenticationAPI.getUserIdFromLoginId(tenant.alias, 'cas', 'user-CXzsaWasX', function(err, stuartUserId) {
                                                ...
                                                AuthenticationAPI.getUserIdFromLoginId(tenant.alias, 'facebook', 'user-CXzsaWasX', function(err) {
                                                    ...
                                                    RestAPI.User.getUser(tenantAdminRestContext, stuartUserId, function(err, stuartUserObj) {
                                                        ...
                                                        assert.strictEqual(stuartUserObj.emailVerified, true);
    ...
    describe('Get user', function() {
        ...
        it('verify get user by ugly username', function(callback) {
            ...
            var email1 = TestsUtil.generateTestEmailAddress();
            RestAPI.User.createUser(camAdminRestContext, userId1, 'password', 'Test User', {'visibility': 'public', 'email': email1},  function(err, userObj1) {
                assert.ok(!err);
                assert.ok(userObj1);
                ...
                RestAPI.User.getUser(anonymousRestContext, userObj1.id, function(err, retrievedUser1) {
                    ...
                    var email2 = TestsUtil.generateTestEmailAddress();
                    RestAPI.User.createUser(camAdminRestContext, userId2, 'password', 'Кругом шумел', {'visibility': 'public', 'email': email2}, function(err, userObj2) {
                        assert.ok(!err);
                        assert.ok(userObj2);
    ...
    describe('User visibility', function() {
        ...
        it('verify user permissions', function(callback) {
            ...
            RestAPI.User.createUser(camAdminRestContext, jackUserId, 'password', 'Jack Doe', jackOpts, function(err, jack) {
                ...
                var email = TestsUtil.generateTestEmailAddress();
                RestAPI.User.createUser(camAdminRestContext, janeUserId, 'password', 'Jane Doe', {'visibility': 'public', 'email': email}, function(err, jane) {
                    assert.ok(!err);
                    assert.ok(jane);
        ...
        it('verify loggedin user is hidden beyond tenant scope', function(callback) {
            ...
            RestAPI.User.createUser(camAdminRestContext, usernameA, 'password', 'LoggedIn User', loggedInUserOpts, function(err, userA) {
                ...
                var email = TestsUtil.generateTestEmailAddress();
                RestAPI.User.createUser(gtAdminRestContext, usernameB, 'password', 'Private User', {'email': email}, function(err, userB) {
                    assert.ok(!err);
