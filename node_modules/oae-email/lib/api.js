...
var sendEmail = module.exports.sendEmail = function(templateModule, templateId, toUser, data, opts, callback) {
    ...
    var templateCtx = _.extend({}, data, {
        ...
        'shared': sharedLogic,
        'instance': {
            'name': TenantsConfig.getValue(toUser.tenant.alias, 'instance', 'instanceName'),
            'URL': TenantsConfig.getValue(toUser.tenant.alias, 'instance', 'instanceURL')
        },
        'hostingOrganization': {
            'name': TenantsConfig.getValue(toUser.tenant.alias, 'instance', 'hostingOrganization'),
            'URL': TenantsConfig.getValue(toUser.tenant.alias, 'instance', 'hostingOrganizationURL')
        }
    });
