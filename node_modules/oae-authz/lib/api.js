...
var getAuthzMembers = module.exports.getAuthzMembers = function(resourceId, start, limit, callback) {
    ...
    var members = [];
    Cassandra.runPagedColumnQuery('AuthzMembers', 'resourceId', resourceId, start, limit, null, function(err, row, startMatched, nextToken) {
        if (err) {
            return callback(err);
        }
...
var getPrincipalMemberships = module.exports.getPrincipalMemberships = function(principalId, start, limit, callback) {
    ...
    Cassandra.runPagedColumnQuery('AuthzMembershipsCache', 'principalId', principalId, start, limit, null, function(err, row, startMatched, nextToken) {
        if (err) {
            return callback(err);
        }
