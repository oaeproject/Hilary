...
describe('General Search', function() {
    ...
    var _getDocById = function(results, docId) {
        return _.find(results.results, function(result) {
    ...
    describe('Search Scopes', function() {
         ...
         */
        it('verify the _my search scope searches only items to which the current user is explicitly associated', function(callback) {
            TestsUtil.setupMultiTenantPrivacyEntities(function(publicTenant0, publicTenant1, privateTenant0, privateTenant1) {
                // Make the public user from publicTenant0 a member of a couple of the groups so we
                // can test explicit access
                var memberUpdate = _.oaeObj(publicTenant0.publicUser.user.id, 'member');
                PrincipalsTestUtil.assertSetGroupMembersSucceeds(publicTenant1.adminRestContext, publicTenant1.adminRestContext, publicTenant1.publicGroup.id, memberUpdate, function() {
                    PrincipalsTestUtil.assertSetGroupMembersSucceeds(publicTenant0.adminRestContext, publicTenant0.adminRestContext, publicTenant0.privateGroup.id, memberUpdate, function() {

                        // Items from the current tenant that are not explicitly associated to the current user should not be returned
                        searchForResource(publicTenant0.publicUser.restContext, '_my', publicTenant0.publicUser.user, false, function() {
                            searchForResource(publicTenant0.publicUser.restContext, '_my', publicTenant0.loggedinUser.user, false, function() {
                                searchForResource(publicTenant0.publicUser.restContext, '_my', publicTenant0.privateUser.user, false, function() {
                                    searchForResource(publicTenant0.publicUser.restContext, '_my', publicTenant0.loggedinGroup, false, function() {
                                        searchForResource(publicTenant0.publicUser.restContext, '_my', publicTenant1.publicUser.user, false, function() {
                                            searchForResource(publicTenant0.publicUser.restContext, '_my', publicTenant1.loggedinUser.user, false, function() {
                                                searchForResource(publicTenant0.publicUser.restContext, '_my', publicTenant1.privateUser.user, false, function() {
                                                    searchForResource(publicTenant0.publicUser.restContext, '_my', privateTenant0.publicUser.user, false, function() {
                                                        searchForResource(publicTenant0.publicUser.restContext, '_my', privateTenant0.loggedinUser.user, false, function() {
                                                            searchForResource(publicTenant0.publicUser.restContext, '_my', privateTenant0.privateUser.user, false, function() {

                                                                // The external public group and local public, private groups to which the user is associated should be returned
                                                                searchForResource(publicTenant0.publicUser.restContext, '_my', publicTenant0.publicGroup, true, function() {
                                                                    searchForResource(publicTenant0.publicUser.restContext, '_my', publicTenant0.privateGroup, true, function() {
                                                                        searchForResource(publicTenant0.publicUser.restContext, '_my', publicTenant1.publicGroup, true, function() {
                                                                            return callback();
                                                                        });
                                                                    });
                                                                });
            ...
            TestsUtil.generateTestUsers(camAdminRestContext, 2, function(err, users, jack, jane) {
                ...
                TestsUtil.generateTestUsers(gtAdminRestContext, 1, function(err, users, darthVader) {
                    ...
                    RestAPI.User.updateUser(jack.restContext, jack.user.id, jackOpts, function(err, jackUser) {
                        ...
                        SearchTestsUtil.searchRefreshed(darthVader.restContext, 'general', null, {'resourceTypes': 'user', 'q': jack.user.displayName, 'scope': global.oaeTests.tenants.gt.alias}, function(err, results) {
                            assert.ok(!err);
    ...
    describe('Group Search Visibility', function() {
        ...
        it('verify loggedin group search visibility', function(callback) {
            ...
            TestsUtil.createTenantWithAdmin(privateTenantAlias, tenantHost, function(err, privateTenant, privateTenantAdminRestContext) {
                assert.ok(!err);
