...
module.exports = {
    ...
    'google': {
        ...
        'elements': {
            ...
            'hostedDomain': new Fields.Text('Google hosted domain', 'Google hosted domain, ex: google apps domain (optional)', '', {'suppress': true}),
        }
    },
    'twitter': {
    ...
    'cas': {
        ...
        'elements': {
            ...
            'mapDisplayName': new Fields.Text('Display name', 'The attibute(s) that should be used to construct the displayname. ex: <%= first_name %> <%= last_name %>', '', {'suppress': true}),
            'mapEmail': new Fields.Text('Email', 'The attibute(s) that should be used to construct the email. ex: <%= mail %>', '', {'suppress': true}),
            'mapLocale': new Fields.Text('Locale', 'The attibute(s) that should be used to construct the locale. ex: <%= locale %>', '', {'suppress': true}),
