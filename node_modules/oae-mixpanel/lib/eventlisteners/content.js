...
module.exports = function(client) {
  ...
  MixpanelUtil.listen(
    ...
    function(ctx, principalId, visibility, start, limit, contentObjects) {
  ...
  MixpanelUtil.listen(
    ...
    function(ctx, content, revision, memberChangeInfo, folderIds) {
      var params = getBasicContentParameters(ctx, content);
  ...
  MixpanelUtil.listen(
    ...
    function(ctx, newContent, oldContent) {
      ...
      params.updatedDisplayName =
        newContent.displayName !== oldContent.displayName;
      params.updatedDescription =
        newContent.description !== oldContent.description;
  ...
  MixpanelUtil.listen(
    ...
    function(ctx, newContent, oldContent, revision) {
      var params = getBasicContentParameters(ctx, newContent);
  ...
  MixpanelUtil.listen(
    ...
    function(ctx, content, memberChangeInfo, opts) {
      var params = getBasicContentParameters(ctx, content);
  ...
  MixpanelUtil.listen(
    ...
    function(ctx, message, content, deleteType) {
      var params = getBasicContentParameters(ctx, content);
