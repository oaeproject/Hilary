...
describe('Principals', function() {
    ...
    describe('Groups', function() {
        ...
        var createPrincipals = function(ctx, callback) {
            ...
            PrincipalsAPI.createGroup(ctx, 'oae-team-' + r, 'oae-team-' + r, 'public', 'yes', [], {}, createPrincipalDone);
            PrincipalsAPI.createGroup(ctx, 'backend-team-' + r, 'backend-team-' + r, 'public', 'yes', [], {}, createPrincipalDone);
            PrincipalsAPI.createGroup(ctx, 'ui-team-' + r, 'ui-team-' + r, 'public', 'yes', [], {}, createPrincipalDone);
            PrincipalsAPI.createGroup(ctx, 'canadian-' + r, 'canadian-' + r, 'public', 'yes', [], {}, createPrincipalDone);
            PrincipalsAPI.createGroup(ctx, 'not-canadian-' + r, 'not-canadian-' + r, 'public', 'yes', [], {}, createPrincipalDone);
            PrincipalsAPI.createGroup(ctx, 'belgian-' + r, 'belgian-' + r, 'public', 'yes', [], {}, createPrincipalDone);
            PrincipalsAPI.createGroup(ctx, 'west-flemish-' + r, 'west-flemish' + r, 'public', 'yes', [], {}, createPrincipalDone);
            PrincipalsAPI.createGroup(ctx, 'east-flemish-' + r, 'east-flemish' + r, 'public', 'yes', [], {}, createPrincipalDone);
         ...
         */
        var getUserUuid = function(ctx, userId) {
            return 'u:' + ctx.tenant().alias + ':' + userId;
        };
        ...
        assertGroupMembers = function(ctx, group_id, expected_members, callback) {
            PrincipalsAPI.getGroupMembers(ctx, group_id, null, 1000, function(err, members) {
                ...
                for (var i = 0; i < expected_members.length; i++) {
                    assert.equal(memberHash[expected_members[i]].length, 1, "Group '" + group_id + "' does not contain: " + expected_members[i]);
                }
                callback();
            });
        };
        ...
        assertMemberOf = function(ctx, expected_groups, callback) {
            PrincipalsAPI.memberOf(ctx, ctx.user().id, 0, 1000, function(err, groups) {
                ...
                for (var i = 0; i < expected_groups.length; i++) {
                    assert.equal(groupsHash[expected_groups[i]].length, 1, "Principal '" + ctx.user().id + "' does not contain: " + expected_groups[i]);
                }
                callback();
            });
        };
        ...
        it('Test create group', function(callback) {
            createAndGetUser(anonymousContext, 'test-runner', 'password', 'public', 'Test', 'Runner', 'tr123', function(err, user) {
                var ctx = new Context(tenant, user);
                PrincipalsAPI.createGroup(ctx, "test-group-" + r, "This is a test group", 'public', 'yes', [], {}, function(err, group) {
                    if (err) {
            ...
            createAndGetUser(anonymousContext, 'mrvisser', 'password', 'public', 'Test', 'Runner', 'tr123', function(err, mrvisser) {
                ...
                createAndGetUser(anonymousContext, 'nicolaas', 'password', 'public', 'Test1', 'Runner1', 'nicolaas', function(err, nico) {
                    ...
                    createAndGetUser(anonymousContext, 'simong', 'password', 'public', 'Test2', 'Runner2', 'simong', function(err, simong) {
                        ...
                        PrincipalsAPI.createGroup(mrvisserCtx, 'managed-by-canadians', "Group", 'public', 'yes', [], {}, function(err, groupUuid) {
                            assert.ok(!err);
            ...
            createAndGetUser(anonymousContext, 'mrvisser', 'password', 'public', 'Test', 'Runner', 'tr123', function(err, mrvisser) {
                ...
                createAndGetUser(anonymousContext, 'nicolaas', 'password', 'public', 'Test1', 'Runner1', 'nicolaas', function(err, nico) {
                    ...
                    createAndGetUser(anonymousContext, 'simong', 'password', 'public', 'Test2', 'Runner2', 'simong', function(err, simong) {
                        ...
                        var simongCtx = new Context(tenant, simong);
                        PrincipalsAPI.createGroup(mrvisserCtx, 'managed-by-canadians', "Group", 'public', 'yes', [], {}, function(err, managedByCanadiansGroupUuid) {
                            assert.ok(!err);

                            // 2. Create and assign a group that will manage the managed-by-canadians group
                            PrincipalsAPI.createGroup(mrvisserCtx, 'canadians', "Group", 'public', 'yes', [], {}, function(err, canadiansGroupUuid) {
                                assert.ok(!err);
        ...
        it('Test memberOf only returns user context groups', function(callback) {
            ...
            createAndGetUser(anonymousContext, 'mrvisser', 'password', 'public', 'Test', 'Runner', 'tr123', function(err, mrvisser) {
                ...
                createAndGetUser(anonymousContext, 'simong', 'password', 'public', 'Test2', 'Runner2', 'simong', function(err, simong) {
                    ...
                    // 2. Create a group
                    PrincipalsAPI.createGroup(mrvisserCtx, 'canadians', "Group", 'private', 'yes', [], {}, function(err, canadiansGroupUuid) {
                        assert.ok(!err);
            ...
            createAndGetUser(anonymousContext, 'mrvisser', 'password', 'public', 'Branden', 'Visser', 'tr123', function(err, mrvisser) {
                ...
                createAndGetUser(anonymousContext, 'simong', 'password', 'loggedin', 'Simong', 'Gaeremynck', 'simong', function(err, simong) {
                    ...
                    createAndGetUser(anonymousContext, 'nico', 'password', 'private', 'Nicolaas', 'Matthijs', 'nico', function(err, nico) {
                        ...
                        PrincipalsAPI.createGroup(mrvisserCtx, "public-group", "This is a test group", 'public', 'yes', [], {}, function(err, publicGroup) {
                            assert.ok(!err);
                            PrincipalsAPI.createGroup(mrvisserCtx, "loggeding-group", "This is a test group", 'loggedin', 'yes', [], {}, function(err, loggedinGroup) {
                                assert.ok(!err);
                                    PrincipalsAPI.createGroup(mrvisserCtx, "private-group", "This is a test group", 'private', 'yes', [], {}, function(err, privateGroup) {
                                    assert.ok(!err);

                                    // 2. Create a group and add all those members.
                                    PrincipalsAPI.createGroup(mrvisserCtx, "top-group", "This is a test group", 'public', 'yes', [], {}, function(err, topGroup) {
                                        assert.ok(!err);
                                        var members = {};
                                        members[simong.id] = 'member';
                                        members[nico.id] = 'member';
                                        members[publicGroup] = 'member';
                                        members[loggedinGroup] = 'member';
                                        members[privateGroup] = 'member';
                                        PrincipalsAPI.setGroupMembers(mrvisserCtx, topGroup, members, function(err) {
                                            assert.ok(!err);
        ...
        it('Test that a group cannot be made a member of itself', function(callback) {
            createAndGetUser(anonymousContext, 'nico', 'password', 'private', 'Nicolaas', 'Matthijs', 'nico', function(err, nico) {
                ...
                PrincipalsAPI.createGroup(nicoCtx, "public-group", "This is a test group", 'public', 'yes', [], {}, function(err, publicGroup) {
                    assert.ok(!err);
