...
module.exports.setupServer = function(port, _config) {
    ...
    /*!
     * The bodyParser will parse the following type of request encoding:
     *
     *  * application/json
     *  * urlencoded (regular POST requests)
     *  * multipart (file uploads)
     *
     * The config.files config object is used, handling concerns such as maximum file upload limit and
 ...
 */
var postInitializeServer = module.exports.postInitializeServer = function(app) {
