 ...
 */
var isVideo = module.exports.isVideo = function(mimeType) {
    return _.contains(PreviewConstants.TYPES.VIDEO, mimeType);
};
 ...
 */
var isAudio = module.exports.isAudio = function(mimeType) {
    return _.contains(PreviewConstants.TYPES.AUDIO, mimeType);
};
