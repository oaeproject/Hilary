...
var createUser = module.exports.createUser = function(ctx, displayName, opts, callback) {
    ...
    validator.check(displayName, {'code': 400, 'msg': 'A display name must be a short string'}).isShortString();
...
var updateUser = module.exports.updateUser = function(ctx, userId, profileFields, callback) {
    ...
    if (profileFields['displayName']) {
        validator.check(profileFields['displayName'], {'code': 400, 'msg': 'A displayName should be a short string'}).isShortString();
    }
