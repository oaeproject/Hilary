...
describe('Content', function() {
    ...
    describe('Content comments', function() {
                                        ...
                                        RestAPI.Content.createComment(contexts['bert'].restContext, contentObj.id, 'A reply to the reply on the second comment in the list', comments.results[1].created, function(err, comment) {
                                            ...
                                            RestAPI.Content.createComment(contexts['bert'].restContext, contentObj.id, 'This comment should be first in the list', null, function(err, comment) {
                                                ...
                                                RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.id, null, 10, function(err, comments) {
                                                    ...
                                                    assert.equal(comments.results[1].id, comments.results[2].replyTo);
                                                    assert.equal(comments.results[2].id, comments.results[3].replyTo);
         ...
         */
        it('verify delete comment asdf', function(callback) {
            setUpUsers(function(contexts) {
