...
module.exports.Content = function(tenant, contentId, visibility, displayName, description, contentType, createdBy, created, lastModified) {
    var that = {};
 ...
 * The revision model.
 *
 * @param {String}  contentId   The ID of the piece of content that is getting a revision.
 ...
 */
module.exports.Revision = function(contentId, revisionId, created, createdBy, uri, opts) {
    var that = {};
    that.contentId = contentId;
