...
var ensureSchema = function(callback) {
    Cassandra.createColumnFamilies({
        'AuthenticationLoginId': "CREATE COLUMNFAMILY AuthenticationLoginId (loginId text PRIMARY KEY, userId text) WITH comment='Stores Login IDs that allow a user to authenticate in the system';",
        'AuthenticationUserLoginId': "CREATE COLUMNFAMILY AuthenticationUserLoginId (userId text PRIMARY KEY) WITH comment='Maps user ids to their login ids';"
    }, callback);
};
