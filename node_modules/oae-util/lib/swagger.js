...
var getApi = module.exports.getApi = function(ctx, swaggerResourcePath) {
    ...
    var api = resources[swaggerResourcePath];
    api.resourcePath = swaggerResourcePath + '/';
    api.basePath = url;
    var requiredModels = [];
...
var _getSwaggerModels = function(ctx) {
    return (ctx.tenant().isGlobalAdminServer) ? OAE.globalAdminServer.locals['swagger-models'] : OAE.tenantServer.locals['swagger-models'];
};
