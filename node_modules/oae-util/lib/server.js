...
module.exports.setupServer = function(port, config) {
    ...
    // Rather than using the bodyParser which includes a JSON parser,
    // we'll only register the parsers we want to support:
    //  * urlencoded (normal HTTP POST requests)
    //  * multipart (multipart HTTP POST requests, ex: uploads)
    server.use(express.urlencoded());
    server.use(express.multipart(config.files));
