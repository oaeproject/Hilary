...
describe('Preview processor - filters', function() {
    ...
    var _getMockData = function() {
        ...
        var content = [
            ...
            new Content('camtest', 'c:camtest:b', 'public', 'B', 'B', 'link', 'u:camtest:simon', times.B, times.B, 'b-1'),
            new Content('camtest', 'c:camtest:c', 'public', 'C', 'C', 'collabdoc', 'u:camtest:simon', times.B, times.D, 'c-3'),
