...
module.exports.testNoPermission = function(test) {
    ...
    principals.api.createUser(tenant, 'mrvisser', 'password', 'public', 'Branden', 'Visser', 'Branden Visser', function(err) {
        test.ok(!err);
...
module.exports.testIndirectPermission = function(test) {
    ...
    principals.api.createUser(tenant, 'runner', 'password', 'public', 'Runner', 'Runner', 'Runner Runner', function(err) {
        var runnerUuid = roles.util.toUuid('u', tenant.alias, 'runner');

        // 1. set up the group hierarchy
        principals.api.createUser(tenant, 'mrvisser', 'password', 'public', 'Branden', 'Visser', 'Branden Visser', function(err) {
            test.ok(!err);

            principals.api.createGroup(runnerUuid, tenant, 'toronto', 'The group of the city of Toronto', function(err) {
                test.ok(!err);

                principals.api.createGroup(runnerUuid, tenant, 'ontario', 'The group of the province of Ontario', function(err) {
                    test.ok(!err);

                    principals.api.createGroup(runnerUuid, tenant, 'canada', 'The group of the country of Canada', function(err) {
                        test.ok(!err);

                        principals.api.addGroupMember(runnerUuid, torontoUuid, mrvisserUuid, 'member', function(err) {
                            test.ok(!err);

                            principals.api.addGroupMember(runnerUuid, ontarioUuid, torontoUuid, 'member', function(err) {
                                test.ok(!err);

                                principals.api.addGroupMember(runnerUuid, canadaUuid, ontarioUuid, 'member', function(err) {
                                    test.ok(!err);
                                            ...
                                            permissions.api.isAllowed(torontoUuid, 'viewer', resourceUuid, function(err, isAllowed) {
                                                ...
                                                permissions.api.isAllowed(ontarioUuid, 'viewer', resourceUuid, function(err, isAllowed) {
                                                    ...
                                                    permissions.api.isAllowed(canadaUuid, 'viewer', resourceUuid, function(err, isAllowed) {
                                                        ...
                                                        principals.api.addGroupMember(runnerUuid, torontoUuid, canadaUuid, 'member', function(err) {
                                                            test.ok(!err);
...
module.exports.testGetAllPermissions = function(test) {
    test.expect(15);
    ...
    principals.api.createUser(tenant, 'mrvisser', 'password', 'public', 'Branden', 'Visser', 'Branden Visser', function(err) {
        ...
        principals.api.createGroup(tenant, 'toronto', 'The group of the city of Toronto', function(err) {
            test.ok(!err);

            principals.api.createGroup(tenant, 'ontario', 'The group of the province of Ontario', function(err) {
                test.ok(!err);

                principals.api.addGroupMember(torontoUuid, mrvisserUuid, function(err) {
                    test.ok(!err);

                    principals.api.addGroupMember(ontarioUuid, torontoUuid, function(err) {
                        test.ok(!err);
