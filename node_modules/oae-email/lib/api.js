...
var _getTemplatesForTemplateIds = function(basedir, module, templateIds, callback, _templates) {
    ...
    var templateSharedPath = _templatesPath(basedir, module, templateId + '.shared.jst');
    ...
    _getTemplateContents(templateMetaPath, function(err, metaTemplate) {
        ...
        _getTemplateContents(templateHtmlPath, function(err, htmlTemplate) {
            ...
            _getTemplateContents(templateTxtPath, function(err, txtTemplate) {
                ...
                _getTemplateContents(templateSharedPath, function(err, sharedTemplate) {
                    if (err) {
                        return callback(err);
                    }

                    // If there was a shared template, we prefix all the other templates with the content
                    // of this shared template. This is done so we can "share" logic across the templates
                    if (sharedTemplate) {
                        metaTemplate = sharedTemplate + metaTemplate;
                        htmlTemplate = sharedTemplate + htmlTemplate;
                        txtTemplate = sharedTemplate + txtTemplate;
                    }
