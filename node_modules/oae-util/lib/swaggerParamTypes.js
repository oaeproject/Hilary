 ...
 */
const query = module.exports.query = function(name, description, dataType, required, allowMultiple, allowableValues, defaultValue) {
    return {
        'paramType': 'query',
        name,
 ...
 */
const path = module.exports.path = function(name, description, dataType, allowableValues, defaultValue) {
    return {
        'paramType': 'path',
        name,
        'description': description || '',
 ...
 */
const body = module.exports.body = function(name, description, dataType, defaultValue) {
    return {
        'paramType': 'body',
        name,
        'description': description || '',
 ...
 */
const form = module.exports.form = function(name, description, dataType, required, allowableValues, defaultValue) {
    return {
        'paramType': 'form',
        name,
        'description': description || '',
 ...
 */
const header = module.exports.header = function(name, description, dataType, required) {
    return {
        'paramType': 'header',
        name,
        'description': description || '',
