...
var cacheSchema = function(callback) {
    ...
    /*!
     * Get the configuration files for a given module and creates the schema for global and tenant administrators
...
var updateConfig = module.exports.updateConfig = function(ctx, tenantAlias, configValues, callback) {
    ...
    _.each(configValues, function(value, key) {
        ...
        // Trim all values that are input into the API
        if (_.isString(value)) {
            value = value.trim();
        }
...
/**
 * Clear a configuration value for a particular tenant so it goes back to using the global setting
 *
 * @param  {Context}    ctx             The current context
 * @param  {String}     tenantAlias     The alias of the tenant to store config for
