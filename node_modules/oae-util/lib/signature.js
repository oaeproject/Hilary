 ...
 *
 * @param  {Context}    ctx         The context of the request that is asking for the signature
 ...
 */
var createExpiringResourceSignature = module.exports.createExpiringResourceSignature = function(ctx, resourceId, duration, offset) {
 ...
 *
 * @param  {Context}    ctx         The context of the request that is providing a signature
 ...
 */
var verifyExpiringResourceSignature = module.exports.verifyExpiringResourceSignature = function(ctx, resourceId, expires, signature) {
 ...
 *
 * @param  {Context}    ctx         The context of the request for which to create the data to sign
 ...
 * @api private
 */
var _createResourceData = function(ctx, resourceId) {
    var userId = (ctx.user()) ? ctx.user().id : '';
    return {'userId': userId, 'resourceId': resourceId};
};
