...
var contextMiddleware = function(req, res, next) {
    ...
    if (req.oaeAuthInfo && req.oaeAuthInfo.user) {
        ...
        // If the authentication strategy is available in the session, we store it on the context
        // It might not be available due to old cookies (pre 7.0.1 sessions) or pluggable authentication
        // strategies that do not provide it
