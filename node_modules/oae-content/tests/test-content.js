...
describe('Content', function() {
   ...
   */
  var checkPieceOfContent = function(
    restCtx,
    libraryToCheck,
    contentObj,
    expectAccess,
      ...
      setUpUsers(function(contexts) {
        ...
        RestAPI.Content.createLink(
          ...
          function(err, contentObj) {
            ...
            RestAPI.Content.getContent(contexts['nicolaas'].restContext, ' ', function(
              err,
              retrievedContentObj
            ) {
              ...
              RestAPI.Content.getContent(contexts['nicolaas'].restContext, 'invalid-id', function(
                err,
                retrievedContentObj
              ) {
                assert.equal(err.code, 400);
                ...
                RestAPI.Content.getContent(
                  contexts['nicolaas'].restContext,
                  contentObj.id,
                  function(err, retrievedContentObj) {
                    assert.ok(!err);
  ...
  describe('Download content', function() {
      ...
      setUpUsers(function(contexts) {
        ...
        RestAPI.Content.createFile(
          ...
          function(err, contentObj) {
            ...
            RestAPI.Content.getContent(contexts['nicolaas'].restContext, contentObj.id, function(
              err,
              contentObj
            ) {
              assert.ok(!err);
          ...
          function(err, contentObj) {
            ...
            RestAPI.Content.getRevisions(
              ...
              function(err, revisions) {
                ...
                var uri = revisions.results[0].uri
                  .split(':')
                  .slice(1)
                  .join(':');
    ...
    it('verify validation of signed urls', function(callback) {
      setUpUsers(function(contexts) {
        ...
        var signedDownloadUrl = ContentUtil.getSignedDownloadUrl(
  ...
  describe('Content comments', function() {
      ...
      setUpUsers(function(contexts) {
        ...
        RestAPI.Content.createLink(
          ...
          function(err, contentObj) {
            ...
            // Get the created piece of content
            RestAPI.Content.getContent(contexts['bert'].restContext, contentObj.id, function(
              err,
              retrievedContentObj
            ) {
              assert.ok(!err);
          ...
          function(err, contentObj) {
            ...
            createComments(_.values(users), contentObj.id, 8, null, function() {
              ...
              RestAPI.Content.getComments(ctx, contentObj.id, null, 3, function(err, comments) {
                ...
                RestAPI.Content.getComments(ctx, contentObj.id, comments.nextToken, 3, function(
                  err,
                  comments
                ) {
                  assert.ok(!err);
        ...
        RestAPI.Content.createLink(
          ...
          function(err, publicContentObj) {
            ...
            RestAPI.Content.createLink(
              ...
              [contexts['simon'].user.id],
              [],
              function(err, privateContentObj) {
                assert.ok(!err);
    ...
    var testDeleteCommentPermissions = function(contexts, visibility, expectedDelete, callback) {
      ...
      _canDelete(bert, bert, bert, visibility, [], [], true, function(err) {
        ...
        _canDelete(bert, simon, bert, visibility, [], [contexts['simon'].user.id], true, function(
          err,
          softDeleted
        ) {
          assert.ok(!err);
            ...
            function(err, softDeleted) {
              ...
              _canDelete(
                ...
                function(err, softDeleted) {
                  ...
                  _canDelete(bert, simon, simon, visibility, [], [], expectedDelete, function(
                    err,
                    softDeleted
                  ) {
                    if (expectedDelete) {
                    ...
                    _canDelete(bert, bert, anonymousRestContext, visibility, [], [], true, function(
                      err,
                      softDeleted
                    ) {
                      assert.ok(err);
  ...
  describe('Create content', function() {
        ...
        RestAPI.Content.createLink(
          ...
          function(err, contentObj) {
            ...
            RestAPI.Content.createLink(
              ...
              [],
              [],
              function(err, contentObj, response) {
                assert.ok(!err);
                assert.ok(contentObj.id);
    ...
    it('verify create content with a private user as another member', function(callback) {
      TestsUtil.generateTestUsers(camAdminRestContext, 2, function(err, users) {
        ...
        RestAPI.User.updateUser(bert.restContext, bert.user.id, { visibility: 'private' }, function(
          err
        ) {
          assert.ok(!err);
  ...
  describe('Update content', function() {
     ...
     * @param  {Function}           callback            Standard callback function
     */
    var checkNameAndDescription = function(
      contexts,
      contentId,
      expectedName,
      expectedDescription,
      ...
      // Check as user 0
      RestAPI.Content.getContent(contexts['nicolaas'].restContext, contentId, function(
        err,
        contentObj
      ) {
        assert.ok(!err);
        ...
        // Check as user 1
        RestAPI.Content.getContent(contexts['simon'].restContext, contentId, function(
          err,
          contentObj
        ) {
          assert.ok(!err);
                                                      ...
                                                      function(err) {
                                                        ...
                                                        checkNameAndDescription(
                                                          ...
                                                          function() {
                                                            ...
                                                            var longDisplayName = TestsUtil.generateRandomText(
                                                              100
                                                            );
                                                            RestAPI.Content.updateContent(
                                                              contexts['nicolaas'].restContext,
                                                              ...
                                                              function(err) {
                                                                ...
                                                                var longDescription = TestsUtil.generateRandomText(
                                                                  1000
                                                                );
                                                                RestAPI.Content.updateContent(
                                                                  contexts['nicolaas'].restContext,
     ...
     * @param  {Function}           callback                Standard callback function
     */
    var checkAccessAndLibrary = function(
      contexts,
      contentId,
                ...
                function(err, items) {
                  ...
                  RestAPI.Content.getLibrary(
                    ...
                    function(err, items) {
                      ...
                      RestAPI.Content.getContent(contexts['bert'].restContext, contentId, function(
                        err,
                        contentObj
                      ) {
                        if (expectLoggedInAccess) {
                ...
                RestAPI.Content.getRevision(
                  ...
                  function(err, revision) {
                    ...
                    RestAPI.Content.updateFileBody(
                      ...
                      contentObj.id,
                      getOAELogoStream,
                      function(err, updatedContentObj, response) {
                        assert.ok(!err);
  ...
  it("verify collabdoc editors can't delete", function(callback) {
    setUpUsers(function(contexts) {
      RestAPI.Content.createCollabDoc(
        ...
        function(err, contentObj) {
          assert.ok(!err);
          RestAPI.Content.deleteContent(contexts['stuart'].restContext, contentObj.id, function(
            err
          ) {
            assert.equal(err.code, 401);

            RestAPI.Content.deleteContent(contexts['nicolaas'].restContext, contentObj.id, function(
              err
            ) {
              assert.ok(!err);
              return callback();
  ...
  describe('Content permissions', function() {
      ...
      setUpUsers(function(contexts) {
        ...
        RestAPI.Content.createLink(
          ...
          function(err, contentObj) {
            ...
            var validPermissions = AuthzTestUtil.createRoleChange(
              [contexts['simon'].user.id],
              'manager'
            );
                  ...
                  function(err) {
                    ...
                    RestAPI.Content.updateMembers(
                      ...
                      function(err) {
                        ...
                        // Invalid role change
                        var permissions = AuthzTestUtil.createRoleChange(
                          [contexts['simon'].user.id],
                          'totally-wrong-role'
                        );
                        RestAPI.Content.updateMembers(
          ...
          function(err, groupObj) {
            ...
            RestAPI.Content.createLink(
              ...
              function(err, contentObj) {
                ...
                RestAPI.Content.updateMembers(nico.restContext, contentObj.id, update, function(
                  err
                ) {
                  assert.equal(err.code, 401);
                  callback();
    ...
    it('verify getting content members paging', function(callback) {
      TestsUtil.generateTestUsers(camAdminRestContext, 10, function(err, users) {
        ...
        var members = _.filter(_.values(users), function(user) {
    ...
    it('verify setting permissions with an email associated to a unique email account adds it to their library', function(callback) {
      TestsUtil.generateTestUsers(camAdminRestContext, 4, function(
        err,
        users,
        creatingUserInfo,
        targetUserInfoA,
  ...
  describe('Content sharing', function() {
    ...
    var testSharing = function(
      ...
      RestAPI.Content.shareContent(sharer.restContext, contentObj.id, [shareWith.user.id], function(
        err
      ) {
        if (expectShare) {
          assert.ok(!err);
        ...
        checkPieceOfContent(
          ...
          expectCanShare,
          function() {
            RestAPI.Content.getMembers(shareWith.restContext, contentObj.id, null, null, function(
              err,
              members
            ) {
              if (expectedMembers) {
