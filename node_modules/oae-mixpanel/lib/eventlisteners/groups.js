...
module.exports = function(client) {
     ...
     * Retrieving a group
     */
    MixpanelUtil.listen(PrincipalsAPI, PrincipalsConstants.events.GET_GROUP_PROFILE, function(ctx, group) {
        var params = getBasicGroupParameters(ctx, group);
     ...
     * Creating a group
     */
    MixpanelUtil.listen(PrincipalsAPI, PrincipalsConstants.events.CREATED_GROUP, function(ctx, group, memberChangeInfo) {
        var params = getBasicGroupParameters(ctx, group);
     ...
     * Updating a group
     */
    MixpanelUtil.listen(PrincipalsAPI, PrincipalsConstants.events.UPDATED_GROUP, function(ctx, newGroup, oldGroup) {
        var params = getBasicGroupParameters(ctx, newGroup);
     ...
     * Deleting a group
     */
    MixpanelUtil.listen(PrincipalsAPI, PrincipalsConstants.events.DELETED_GROUP, function(ctx, group) {
        var params = getBasicGroupParameters(ctx, group);
     ...
     * Restoring a group
     */
    MixpanelUtil.listen(PrincipalsAPI, PrincipalsConstants.events.RESTORED_GROUP, function(ctx, group) {
        var params = getBasicGroupParameters(ctx, group);
     ...
     */
    MixpanelUtil.listen(PrincipalsAPI, PrincipalsConstants.events.UPDATED_GROUP_MEMBERS, function(ctx, group, oldGroup, memberChangeInfo) {
        addedMemberIds = _.pluck(memberChangeInfo.members.added, 'id');
        updatedMemberIds = _.pluck(memberChangeInfo.members.updated, 'id');
        removedMemberIds = _.pluck(memberChangeInfo.members.removed, 'id');
     ...
     * Joining a group
     */
    MixpanelUtil.listen(PrincipalsAPI, PrincipalsConstants.events.JOINED_GROUP, function(ctx, group) {
        var params = getBasicGroupParameters(ctx, group);
     ...
     * Leaving a group
     */
    MixpanelUtil.listen(PrincipalsAPI, PrincipalsConstants.events.LEFT_GROUP, function(ctx, group) {
        var params = getBasicGroupParameters(ctx, group);
     ...
     */
    MixpanelUtil.listen(PrincipalsAPI, PrincipalsConstants.events.SET_GROUP_PICTURE, function(ctx, group) {
        var params = getBasicGroupParameters(ctx, group);
 ...
 * @api private
 */
var getBasicGroupParameters = function(ctx, group) {
