...
var getPushClient = module.exports.getPushClient = function(callback) {
    ...
    client.sendMessage = function(name, payload, callback) {
        ...
        var id = 'id' + Math.floor(Math.random() * 100000000);
     ...
     * @param  {String}    transformer          The format in which the activity entities should be returned
     * @param  {Function}  callback             A function that will be executed once this socket is registered on the feed
     */
    client.subscribe = function(resourceId, streamType, token, transformer, callback) {
        var payload = {
            'stream': {
 ...
 * @param  {Object}     [data.streams[i].transformer]       The format in which the activity entities should be returned
    ...
    getPushClient(function(client) {
        client.authenticate(data.authentication.userId, data.authentication.tenantAlias, data.authentication.signature, function(err) {
            ...
            _.each(data.streams, function(stream) {
                client.subscribe(stream.resourceId, stream.streamType, stream.token, stream.transformer, function(err) {
