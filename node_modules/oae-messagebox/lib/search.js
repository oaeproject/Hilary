 ...
 */
var registerMessageSearchDocument = (module.exports.registerMessageSearchDocument = function(
  name,
  resourceTypes,
  producer,
  callback,
  ...
  return SearchAPI.registerChildSearchDocument(
    name,
    messagesChildSearchDocumentOptions,
    callback,
  );
});
 ...
 */
var createAllMessageSearchDocuments = (module.exports.createAllMessageSearchDocuments = function(
  name,
  resourceId,
  messageBoxId,
  callback,
  ...
  _getAllMessages(messageBoxId, null, 100, function(err, messages) {
    ...
    return callback(
      null,
      createMessageSearchDocuments(name, resourceId, messages),
    );
  });
});
 ...
 */
var createMessageSearchDocuments = (module.exports.createMessageSearchDocuments = function(
  name,
  resourceId,
  messages,
) {
 ...
 */
var deleteMessageSearchDocument = (module.exports.deleteMessageSearchDocument = function(
  name,
  resourceId,
  message,
) {
  var children = {};
  children[name] = [
    SearchUtil.getChildSearchDocumentId(name, resourceId, message.id),
  ];
