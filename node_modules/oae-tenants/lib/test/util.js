 ...
 */
var generateTestTenants = function(globalAdminRestCtx, numToCreate, callback, _created) {
  _created = _created || [];
 ...
 */
var createTenantAndWait = function(globalAdminRestCtx, alias, displayName, host, opts, callback) {
 ...
 */
var generateTestTenantNetworks = function(globalAdminRestCtx, numToCreate, callback, _created) {
  _created = _created || [];
  if (_created.length === numToCreate) {
 ...
 */
var generateTestTenantAlias = function(seed) {
  seed = seed || 'tenant';
 ...
 */
var generateTestTenantHost = function(seed) {
  seed = seed || 'host';
