...
var hashToUser = function(hash) {
    var user = new User(hash.tenantAlias, hash.principalId, hash.displayName, {
        ...
        'emailPreference': hash.emailPreference || PrincipalsConstants.emailPreferences.IMMEDIATE,
...
var getExtraData = module.exports.getExtraData = function(user, data) {
    ...
    var blacklist = ['id', 'principalId', 'resourceType', 'tenantAlias', 'displayName', 'visibility', 'locale',
                     ...
                     'notificationsLastRead', 'profilePath', 'publicAlias', 'acceptedTC', 'extra',
                     'admin:global', 'admin:tenant', 'lastModified', 'emailPreference'];
