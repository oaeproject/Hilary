...
var ensureSchema = function(callback) {
    Cassandra.createColumnFamilies({
        ...
        'Comments': "CREATE COLUMNFAMILY Comments (commentId text PRIMARY KEY, contentId text, created text, createdBy text, body text, lastModified text, level int, replyTo text, deleted boolean);",
