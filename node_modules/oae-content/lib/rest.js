 ...
 */
OAE.tenantServer.post('/api/content/:contentId/publish', function(req, res) {
 ...
 */
OAE.tenantServer.post('/api/content/:contentId/join', function(req, res) {
 ...
 */
OAE.tenantServer.post('/api/content/:contentId/revisions/:revisionId/previews', function(req, res) {
    req.telemetryUrl = '/api/content/id/revisions/revisionId/previews';
 ...
 */
OAE.tenantServer.get('/api/content/:contentId/revisions/:revisionId/previews', function(req, res) {
    req.telemetryUrl = '/api/content/id/revisions/revisionId/previews';
 ...
 */
OAE.tenantServer.get('/api/content/:contentId/revisions/:revisionId/previews/:item', function(req, res) {
    req.telemetryUrl = '/api/content/id/revisions/:revisionId/previews/item';
    var signature = {
...
OAE.tenantServer.get('/api/content/:contentId/revisions', function(req, res) {
    ...
    ContentAPI.getRevisions(req.ctx, req.params.contentId, req.query.start, limit, function(err, revisions) {
        if (err) {
            return res.send(err.code, err.msg);
        }
 ...
 */
OAE.tenantServer.get('/api/content/:contentId/revisions/:revisionId', function(req, res) {
    req.telemetryUrl = '/api/content/id/revisions/revisionId';
    ContentAPI.getRevision(req.ctx, req.params.contentId, req.params.revisionId, function(err, revision) {
        if (err) {
            return res.send(err.code, err.msg);
        }
 ...
 */
OAE.tenantServer.post('/api/content/:contentId/revisions/:revisionId/restore', function(req, res) {
    req.telemetryUrl = '/api/content/id/revisions/revisionId/restore';
...
OAE.tenantServer.get('/api/content/:contentId/members', function(req, res) {
    ...
    var limit = OaeUtil.getNumberParam(req.query.limit, 10, 1, 25);
    ContentAPI.getContentMembers(req.ctx, req.params.contentId, req.query.start, limit, function(err, members){
        if (err) {
            return res.send(err.code, err.msg);
        }
 ...
 */
OAE.tenantServer.post('/api/content/:contentId/messages', function(req, res) {
    req.telemetryUrl = '/api/content/id/messages';
 ...
 */
OAE.tenantServer.get('/api/content/:contentId/messages', function(req, res) {
    req.telemetryUrl = '/api/content/id/messages';
    var limit = OaeUtil.getNumberParam(req.query.limit, 10, 1, 25);
    ContentAPI.getComments(req.ctx, req.params.contentId, req.query.start, limit, function(err, messages) {
        if (err) {
            return res.send(err.code, err.msg);
        }
 ...
 */
OAE.tenantServer.del('/api/content/:contentId/messages/:created', function(req, res) {
    req.telemetryUrl = '/api/content/id/messages/created';
...
OAE.tenantServer.get('/api/content/library/:principalId', function(req, res) {
    req.telemetryUrl = '/api/content/library/principalId';
 ...
 */
OAE.tenantServer.del('/api/content/library/:principalId/:contentId', function(req, res) {
    req.telemetryUrl = '/api/content/library/principalId/contentId';
