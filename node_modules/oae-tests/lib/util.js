...
var generateTestUsers = module.exports.generateTestUsers = function(restCtx, total, callback) {
    ...
    var userCreated = function(err, userObj, username) {
        ...
        createdUsers[userObj.id] = {
            'user': userObj,
            'restContext': new RestContext(restCtx.baseUrl, username, 'password')
        };
    ...
    for (var u = 0; u < total; u++) {
        (function() {
            ...
            RestAPI.User.createUser(createAdminRestContext(restCtx.baseUrl), username, 'password', 'John Doe', null, function(err, userObj) {
...
var createTenantAdminContext = module.exports.createTenantAdminContext = function(tenant) {
    return new Context(tenant, new User(tenant.alias, null, 'Tenant Administrator', { isTenantAdmin: true }));
}
