...
// listTimezones will retrieve a set of timezones that is known to the OS.
// These can then be used in the validator methods.
var validTimeZones = [];
 ...
 * We rely on a list rather than setting a timezone as some OS accept
 * all values. The only other one we'll accept is UTC as our servers
 * should be running on UTC.
 */
Validator.prototype.isValidTimeZone = function() {
    if (this.str !== 'UTC' && validTimeZones.indexOf(this.str) === -1) {
