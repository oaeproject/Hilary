 ...
 *                                  `25` will be used.
 * @param  {String} startIfEmpty    If the `start` parameter is null or undefined this value will be used.
 ...
 *                                                 be in the results.
 */
module.exports.getPagingParameters = function(start, limit, startIfEmpty) {
    var limit = limit || 25;
    var startIndex = 0;
