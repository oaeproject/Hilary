 ...
 */
var createGlobalAdminUser = module.exports.createGlobalAdminUser = function(ctx, authProvider, externalId, displayName, opts, callback) {
    var validator = new Validator();
    ...
    validator.check(authProvider, {'code': 400, 'msg': 'You must provide an authenticiation provider'}).notEmpty();
    validator.check(externalId, {'code': 400, 'msg': 'You must provide an external id'}).notEmpty();
    ...
    // Create the user. More advanced login id validation will be performed by the createUser function
