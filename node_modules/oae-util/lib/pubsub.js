...
const log = require('oae-logger').logger('oae-pubsub');

const EventEmitter = require('oae-emitter').EventEmitter;
 ...
 */
const publish = module.exports.publish = function(channel, message, callback) {
