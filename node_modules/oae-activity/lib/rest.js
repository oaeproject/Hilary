 ...
 * @Method      GET
 * @Path        /activity
 * @QueryParam  {string}            [format]            Desired format (defaults to activitystreams) [activitystreams,internal]
 * @QueryParam  {number}            [limit]             Maximum number of activities to return (defaults to 10, maximum of 25)
 * @QueryParam  {string}            [start]             Activity at which to start (defaults to 0)
 * @Return      {ActivityStream}                        The activity stream
 */
 ...
 * @Server      tenant
 * @Method      GET
 * @Path        /activity/{activityStreamId}
 * @PathParam   {string}            activityStreamId    The ID of the resource for which we want to retrieve a stream
 * @QueryParam  {string}            [format]            Desired format (defaults to activitystreams) [activitystreams,internal]
 * @QueryParam  {number}            [limit]             Maximum number of activities to return (defaults to 10, maximum of 25)
 * @QueryParam  {string}            [start]             Activity at which to start (defaults to beginning)
 * @Return      {ActivityStream}                        The activity stream
 */
 ...
 * @QueryParam  {string}            [format]            Desired format (defaults to activitystreams) [activitystreams,internal]
 * @QueryParam  {number}            [limit]             Maximum number of activities to return (defaults to 10, maximum of 25)
 * @QueryParam  {number}            [start]             Activity at which to start (defaults to beginning)
 ...
 * @Return      {NotificationsRead}                     Information about notifications read
 */
