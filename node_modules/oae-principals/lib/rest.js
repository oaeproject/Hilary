 ...
 * @Method      POST
 * @Path        /crop
 * @FormParam   {string}        principalId         The ID of the principal to crop the large picture for
 * @FormParam   {number}        width               The width of the square that needs to be cropped out
 * @FormParam   {number}        x                   The x coordinate of the topleft corner to start cropping
 * @FormParam   {number}        y                   The y coordinate of the topleft corner to start cropping
 * @Return      {Profile}                           Returns an object representing the profile of the principal
 */
