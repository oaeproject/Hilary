...
module.exports = {
    ...
    'shibboleth': {
        ...
        'elements': {
            ...
            'spCertificate': new Fields.Text('Certificate', 'Your X509 certificate', '', {'suppress': true}),
            'spCertificateSubjectName': new Fields.Text('Certificate subject name', 'Your X509 certificate subject name', '', {'suppress': true}),
            'spPrivateKey': new Fields.Text('Private Key', 'A private key that can be used to sign messages', '', {'suppress': true})
        }
    },
    'cas': {
