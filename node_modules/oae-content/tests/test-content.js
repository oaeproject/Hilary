...
describe('Content', function() {
    ...
    describe('Content comments', function() {
        ...
        var createComments = function(contexts, contentId, numComments, replyTo, callback) {
            ...
            var getRandomComment = function() {
                var commentArr = [
                    ...
                    'I\'m bookmarking this!', 'Nice work, thanks!',
        ...
        /**
         * Test that verifies that the profile picture urls for a user are present in comments
         */
        it('verify comments include profile picture urls', function(callback) {
            TestsUtil.generateTestUsers(camAdminRestContext, 1, function(err, users, bert) {
                assert.ok(!err);

                /**
                 * Returns a stream that points to an image
                 *
                 * @return {Stream} A stream that contains an image
                 */
                ...
                RestAPI.User.uploadPicture(bert.restContext, bert.user.id, getPictureStream, cropArea, function(err) {
                    ...
                    // Create a piece of content that we can comment on
                    RestAPI.Content.createLink(bert.restContext, 'displayName', 'description', 'public', 'http://www.oaeproject.org', [], [], function(err, contentObj) {
                        assert.ok(!err);
                        ...
                        RestAPI.Content.createComment(bert.restContext, contentObj.id, 'Bleh', null, function(err, comment) {
                            ...
                            RestAPI.Content.createComment(bert.restContext, contentObj.id, 'Bleh', comment.created, function(err, reply) {
                                assert.ok(!err);
                ...
                RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 1', 'Test content description 1', 'public', 'http://www.oaeproject.org/', [], [], function(err, contentObj) {
                    ...
                    RestAPI.Content.getContent(contexts['bert'].restContext, contentObj.id, function(err, retrievedContentObj) {
                        ...
                        RestAPI.Content.createComment(contexts['bert'].restContext, contentObj.id, 'This comment should be second in the list', null, function(err, comment) {
                            ...
                            var secondInListCreated = comment.created;
                            ...
                            RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.id, null, 10, function(err, comments) {
                                ...
                                RestAPI.Content.createComment(contexts['bert'].restContext, contentObj.id, 'Reply to second comment in the list', comments.results[0].created, function(err, comment) {
                                    assert.ok(!err);
                                    assert.equal(comment.createdBy.publicAlias, 'Bert Pareyn');
                                    assert.equal(comment.level, 1);
                                    assert.equal(comment.body, 'Reply to second comment in the list');
                                    assert.equal(comment.messageBoxId, contentObj.id);
                                    assert.equal(comment.threadKey, secondInListCreated + '#' + comment.created + '|');
                                    assert.ok(comment.id);
                                    assert.ok(comment.created);
                                    ...
                                    RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.id, null, 10, function(err, comments) {
                                        ...
                                        RestAPI.Content.createComment(contexts['bert'].restContext, contentObj.id, 'A reply to the reply on the second comment in the list', comments.results[1].created, function(err, comment) {
                                            assert.ok(!err);
                                            assert.ok(comment);
                                                                ...
                                                                RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.id, null, 10, function(err, comments) {
                                                                    ...
                                                                    createComments(contexts, contentObj.id, 10, comments.results[5].created, function() {
                                                                        ...
                                                                        RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.id, null, 10, function(err, comments) {
                                                                            ...
                                                                            RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.id, comments.results[9].threadKey, 10, function(err, comments) {
                                                                                assert.ok(!err);
                                                                                assert.equal(comments.results.length, 10);
