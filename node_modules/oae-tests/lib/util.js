...
/**
 * Create a new express test server on some port between 2000 and 3000
 *
...
var createTestServer = module.exports.createTestServer = function(callback, _attempts) {
    ...
    try {
        // Try and listen on the specified port, and return if successful
        var server = app.listen(port + _attempts, function() {
