...
/**
 * A passport authentication strategy
 *
 * @param  {Object}     options                 A set of options that determine where a user will be redirected towards
 * @param  {String}     options.idpEntityID     The Shibboleth entity ID of the Identity Provider that should be used
 * @param  {Function}   verify                  A standard passport verify function that gets called so you can get or create the OAE user account
 * @param  {Object}     verify.profile          An object that contains the profile information. The amount of information in this object depends on the amount of attributes the IdP has released
 * @param  {Function}   verify.done             A function that should be executed once you're done with getting or creating the OAE user account
