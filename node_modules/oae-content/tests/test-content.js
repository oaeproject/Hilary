...
describe('Content', function() {
    ...
    var setUpUsers = function(callback) {
        ...
        var loginIds = [
            new LoginId('local', 'nm417-' + r),
            new LoginId('local', 'simong-' + r),
            new LoginId('local', 'bp323-' + r),
            new LoginId('local', 'branden-' + r),
            new LoginId('local', 'arwhyte-' + r),
            new LoginId('local', 'stuart-' + r)
          ];
