...
var publishCollabDoc = module.exports.publishCollabDoc = function(ctx, contentId, callback) {
    ...
    ContentAPI.getContent(ctx, contentId, function(err, contentObj) {
        ...
        Etherpad.getHTML(contentObj, function(err, html) {
            ...
            ContentDAO.Revisions.createRevision(contentId, ctx.tenant().alias, ctx.user().id, {'collabdocHtml': html}, function(err, revision) {
                if (err) {
                ...
                ContentDAO.Content.updateContent(contentObj, {'collabdocHtml': html}, true, function(err, newContentObj) {
                    if (err) {
    ...
    getContent(ctx, contentId, function(err, contentObj) {
        ...
        if (!revisionId || revisionId === '') {
            ...
            getRevisions(ctx, contentId, null, 1, function(err, revisions) {
                ...
                ContentDAO.Revisions.getRevision(revisions[0].revisionId, addDownloadLink);
            });
        } else {
