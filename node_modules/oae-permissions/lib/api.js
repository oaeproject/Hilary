    ...
    rolesAPI.hasRole(principalUuid, resourceUuid, action, function(err, hasRole) {
        if (!err) {
            if (hasRole) {
                ...
                principalsAPI.memberOf(fakeCtx, false, null, null, function(err, groupUuids) {
                    if (!err) {
 ...
 */
 module.exports.getAllPermissions = function(principalUuid, resourceUuid, callback) {
    ...
    // TODO: Replace this
    var fakeCtx = new context.Context(null, new User('', principalUuid));
    principalsAPI.memberOf(fakeCtx, false, null, null, function(err, principalUuids) {
        if (!err) {
            principalUuids.push(principalUuid);
            numPrincipals = principalUuids.length;
