 ...
 */
const createLink = (module.exports.createLink = function(
    ctx,
    displayName,
    description,
    visibility,
 ...
 */
const createFile = (module.exports.createFile = function(
    ctx,
    displayName,
    description,
    visibility,
 ...
 */
const createCollabDoc = (module.exports.createCollabDoc = function(
    ctx,
    displayName,
    description,
    visibility,
 ...
 */
const createCollabSheet = (module.exports.createCollabSheet = function(
    ctx,
    displayName,
    description,
    visibility,
...
const _createContent = function(
    ...
    validator
        .check(resourceSubType, {
            code: 400,
            msg: 'A valid resourceSubType must be provided. This can be "file", "collabdoc", "collabsheet" or "link"'
        })
...
const canManageFolders = function(ctx, folderIds, callback) {
    ...
    require('oae-folders/lib/internal/dao').getFoldersByIds(folderIds, function(err, folders) {
        if (err) {
            ...
            return callback({
                code: 400,
                msg: 'One or more folders do not exist'
            });
        }
...
const joinCollabDoc = (module.exports.joinCollabDoc = function(ctx, contentId, callback) {
    ...
    _canEdit(ctx, contentId, function(err, contentObj) {
        if (err) {
            ...
            return callback({
                code: 400,
                msg: 'This is not a collaborative document or spreadsheet'
            });
        }
    });
});
        ...
        ContentDAO.Content.deleteContent(contentObj, function(err, members) {
            ...
            if (contentObj.resourceSubType === 'collabsheet') {
                Ethercalc.deleteRoom(contentObj.ethercalcRoomId, function(err) {
                    ...
                    ContentAPI.emit(ContentConstants.events.DELETED_CONTENT, ctx, contentObj, members, function(err) {
                        if (err) {
                            return callback(_.first(err));
                        }
 ...
 * @param  {Object}     callback.err    An error that occurred, if any
 */
const removeContentFromLibrary = (module.exports.removeContentFromLibrary = function(
    ctx,
    libraryOwnerId,
    contentId,
    callback
 ...
 */
const getContentMembersLibrary = (module.exports.getContentMembersLibrary = function(
    ctx,
    contentId,
    start,
    limit,
    ...
    ContentDAO.Content.getContent(contentId, function(err, content) {
        ...
        LibraryAPI.Authz.resolveTargetLibraryAccess(ctx, content.id, content, function(err, hasAccess, visibility) {
            ...
            ContentMembersLibrary.list(content, visibility, { start: start, limit: limit }, function(
                err,
                memberIds,
                nextToken
            ) {
...
const _updateFileBody = function(ctx, contentId, file, callback) {
    ...
    _canManage(ctx, contentId, function(err, contentObj) {
        if (err) {
            ...
            return callback({
                code: 400,
                msg: 'This content object is not a file.'
            });
        }
        ...
        ContentUtil.getStorageBackend(ctx).store(ctx.tenant().alias, file, options, function(err, uri) {
            ...
            ContentDAO.Revisions.createRevision(revisionId, contentObj.id, ctx.user().id, opts, function(
                err,
                revision
            ) {
                if (err) {
                ...
                opts.previews = {
                    status: ContentConstants.previews.PENDING
                };
 ...
 * @param  {Object}      callback.err        An error that occurred, if any
 */
const setPreviewItems = (module.exports.setPreviewItems = function(
    ctx,
    contentId,
    revisionId,
    status,
 ...
 */
const getSignedPreviewDownloadInfo = (module.exports.getSignedPreviewDownloadInfo = function(
    ctx,
    contentId,
    revisionId,
    previewItem,
 ...
 */
const updateContentMetadata = (module.exports.updateContentMetadata = function(
    ctx,
    contentId,
    profileFields,
    callback
 ...
 */
const createComment = (module.exports.createComment = function(
    ctx,
    contentId,
    body,
 ...
 * @param  {String}         callback.nextToken  The value to provide in the `start` parameter to get the next set of results
 */
const getContentLibraryItems = (module.exports.getContentLibraryItems = function(
    ctx,
    principalId,
    start,
    limit,
    ...
    PrincipalsDAO.getPrincipal(principalId, function(err, principal) {
        ...
        LibraryAPI.Authz.resolveTargetLibraryAccess(ctx, principal.id, principal, function(err, hasAccess, visibility) {
            ...
            ContentDAO.Content.getContentLibraryItems(principalId, visibility, start, limit, function(
                err,
                contentObjects,
                nextToken
            ) {
...
const _getRevisions = function(ctx, contentObj, start, limit, opts, callback) {
    ...
    ContentDAO.Revisions.getRevisions(contentObj.id, start, limit, opts, function(err, revisions, nextToken) {
        ...
        const userIds = _.map(revisions, function(revisions) {
 ...
 */
const getRevisionDownloadInfo = (module.exports.getRevisionDownloadInfo = function(
    ctx,
    contentId,
    revisionId,
    callback
...
const restoreRevision = (module.exports.restoreRevision = function(ctx, contentId, revisionId, callback) {
    ...
    _canManage(ctx, contentId, function(err, contentObj) {
        ...
        ContentDAO.Revisions.getRevision(revisionId, function(err, revision) {
            ...
            ContentDAO.Revisions.createRevision(newRevisionId, contentId, ctx.user().id, revision, function(
                err,
                newRevision
            ) {
                if (err) {
                ...
                ContentDAO.Content.updateContent(contentObj, updates, true, function(err, newContentObj) {
                    ...
                    if (contentObj.resourceSubType === 'collabdoc') {
                        ...
                        Ethercalc.setSheetContents(contentObj.ethercalcRoomId, revision.ethercalcSnapshot, function(
                            err
                        ) {
                            if (err) {
                                return callback(err);
