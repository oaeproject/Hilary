...
describe('Authz-Groups', function() {
     ...
     */
    var createUserIds = function(tenantId, num) {
        var uuids = [];
        for (var i = 0; i < num; i++) {
     ...
     *
     * @param {String}      groupId    The UUID of the group to check
     * @param {String}      memberId   The UUID of the principal to check
    ...
    var verifyNoBidirectionalGroupMembership = function(groupId, memberId, callback) {
        AuthzAPI.hasAnyRole(memberId, groupId, function(err, hasRole) {
            ...
            AuthzAPI.getAuthzMembers(groupId, null, null, function(err, members) {
                assert.ok(!err);
                assert.ok(members);
    ...
    describe('Add group member', function() {
        it('verify invalid group uuid error', function(callback) {
            AuthzAPI.updateRoles('not a valid uuid', makeMembershipChange('u:cam:mrvisser', 'member'), function(err) {
                assert.ok(err);
        ...
        it('verify invalid member uuid error', function(callback) {
            AuthzAPI.updateRoles('g:sakai:oae-team', makeMembershipChange('not a valid uuid', 'member'), function(err) {
                assert.ok(err);
                assert.equal(err.code, 400);
                callback();
            });
        ...
        it('verify non-principal member uuid error', function(callback) {
            AuthzAPI.updateRoles('g:sakai:oae-team', makeMembershipChange('c:content:uuid', 'member'), function(err) {
                assert.ok(err);
                assert.equal(err.code, 400);
                callback();
            });
        ...
        it('verify null role error', function(callback) {
            AuthzAPI.updateRoles('g:sakai:oae-team', makeMembershipChange('u:cam:mrvisser', null), function(err) {
                assert.ok(err);
                assert.equal(err.code, 400);
                callback();
            });
        ...
        it('verify undefined role error', function(callback) {
            AuthzAPI.updateRoles('g:sakai:oae-team', makeMembershipChange('u:cam:mrvisser', undefined), function(err) {
                assert.ok(err);
                assert.equal(err.code, 400);
                callback();
            });
    ...
    describe('Remove group member', function() {
        ...
        it('verify invalid group uuid error', function(callback) {
            AuthzAPI.updateRoles('not a valid uuid', makeMembershipChange('u:cam:mrvisser', false), function(err) {
                assert.ok(err);
                assert.equal(err.code, 400);
                callback();
            });
        ...
        it('verify invalid member uuid error', function(callback) {
            AuthzAPI.updateRoles('g:sakai:oae-team', makeMembershipChange('not a valid uuid', false), function(err) {
                assert.ok(err);
                assert.equal(err.code, 400);
                callback();
            });
        ...
        it('verify non-principal member uuid error', function(callback) {
            AuthzAPI.updateRoles('g:sakai:oae-team', makeMembershipChange('c:content:uuid', false), function(err) {
                assert.ok(err);
                assert.equal(err.code, 400);
                callback();
            });
    ...
    describe('#updateAuthzGroupMembers()', function() {
        ...
        it('verify invalid group uuid error', function(callback) {
            AuthzAPI.updateRoles('not a valid uuid', {'u:cam:mrvisser': 'member'}, function(err) {
                assert.ok(err);
                assert.equal(err.code, 400);
                callback();
            });
        ...
        it('verify invalid member uuid error', function(callback) {
            AuthzAPI.updateRoles('g:sakai:oae-team', {'not a valid uuid': 'member'}, function(err) {
                assert.ok(err);
                assert.equal(err.code, 400);
                callback();
            });
        ...
        it('verify non-principal member uuid error', function(callback) {
            AuthzAPI.updateRoles('g:sakai:oae-team', {'c:sakai:mrvisser': 'member'}, function(err) {
                assert.ok(err);
                assert.equal(err.code, 400);
                callback();
            });
        ...
        it('verify null role error', function(callback) {
            AuthzAPI.updateRoles('g:sakai:oae-team', {'u:cam:mrvisser': null}, function(err) {
                assert.ok(err);
                assert.equal(err.code, 400);
                callback();
            });
        ...
        it('verify undefined role error', function(callback) {
            AuthzAPI.updateRoles('g:sakai:oae-team', {'u:cam:mrvisser': undefined}, function(err) {
                assert.ok(err);
                assert.equal(err.code, 400);
                callback();
            });
        ...
        it('verify blank role error', function(callback) {
            AuthzAPI.updateRoles('g:sakai:oae-team', {'u:cam:mrvisser': '  '}, function(err) {
                assert.ok(err);
                assert.equal(err.code, 400);
                callback();
            });
    ...
    describe('#getAuthzMembers()', function() {
        ...
        it('verify invalid group uuid error', function(callback) {
            AuthzAPI.getAuthzMembers('not a valid uuid', null, null, function(err) {
                assert.ok(err);
                assert.equal(err.code, 400);
                callback();
            });
        ...
        it('verify non-group group uuid error', function(callback) {
            AuthzAPI.getAuthzMembers('u:cam:mrvisser', null, null, function(err) {
                assert.ok(err);
                assert.equal(err.code, 400);
                callback();
            });
        ...
        it('verify non-numeric limit error', function(callback) {
            AuthzAPI.getAuthzMembers('g:cam:mrvisser', null, 'not a number', function(err) {
                assert.ok(err);
                assert.equal(err.code, 400);
                callback();
            });
        ...
        it('verify get user from group', function(callback) {
            ...
            AuthzAPI.updateRoles(groupId, makeMembershipChange(memberId, 'member'), function(err) {
                ...
                AuthzAPI.getAuthzMembers(groupId, null, null, function(err, members) {
                    ...
                    assert.ok(members[0].id, memberId);
                    callback();
                });
            });
        });
        ...
        it('verify user paging', function(callback) {
            ...
            AuthzAPI.updateRoles(groupId, changes, function(err) {
                assert.ok(!err);
                AuthzAPI.getAuthzMembers(groupId, null, 10, function(err, members) {
                    assert.ok(!err);
    ...
    describe('#getPrincipalMemberships()', function() {
        ...
        it('verify invalid principal uuid', function(callback) {
            AuthzAPI.getPrincipalMemberships('not a uuid', function(err) {
                assert.ok(err);
                assert.equal(err.code, 400);
                callback();
            });
        ...
        it('verify non-principal uuid', function(callback) {
            AuthzAPI.getPrincipalMemberships('c:cam:Foo.docx', function(err) {
                assert.ok(err);
                assert.equal(err.code, 400);
                callback();
            });
        ...
        it('verify empty membership is empty array', function(callback) {
            var userId = AuthzUtil.toUuid('u', 'gmo-empty', 'mrvisser');
            AuthzAPI.getPrincipalMemberships(userId, function(err, groupIds) {
                assert.ok(!err);
                assert.ok(groupIds);
        ...
        it('verify single group membership', function(callback) {
            var groupId = AuthzUtil.toUuid('g', 'gmo-single', 'oae-team');
            var userId = AuthzUtil.toUuid('u', 'gmo-single', 'mrvisser');
        ...
        it('verify two direct group membership', function(callback) {
            var groupId1 = AuthzUtil.toUuid('g', 'gmo-two', 'oae-team');
            var groupId2 = AuthzUtil.toUuid('g', 'gmo-two', 'oae-backend-team');
            var userId = AuthzUtil.toUuid('u', 'gmo-two', 'mrvisser');
        ...
        it('verify simple group hierarchy', function(callback) {
            var groupId1 = AuthzUtil.toUuid('g', 'gmo-hier', 'oae-team');
            var groupId2 = AuthzUtil.toUuid('g', 'gmo-hier', 'oae-backend-team');
            var nonMemberGroupId3 = AuthzUtil.toUuid('g', 'gmo-hier', 'non-member');
            var userId = AuthzUtil.toUuid('u', 'gmo-hier', 'mrvisser');
            AuthzAPI.updateRoles(groupId1, makeMembershipChange(userId, 'member'), function(err) {
                assert.ok(!err);
        ...
        it('verify circular group hierarchy', function(callback) {
            var groupId1 = AuthzUtil.toUuid('g', 'gmo-circ', 'oae-team');
            var groupId2 = AuthzUtil.toUuid('g', 'gmo-circ', 'oae-backend-team');
            var groupId3 = AuthzUtil.toUuid('g', 'gmo-circ', 'oae-ui-team');
            var userId = AuthzUtil.toUuid('u', 'gmo-circ', 'mrvisser');
            AuthzAPI.updateRoles(groupId1, makeMembershipChange(userId, 'member'), function(err) {
                assert.ok(!err);
                AuthzAPI.updateRoles(groupId2, makeMembershipChange(groupId1, 'member'), function(err) {
                    assert.ok(!err);
    ...
    describe('Is Authz group member', function() {
        it('verify invalid principal uuid', function(callback) {
            AuthzAPI.hasAnyRole('not a uuid', 'g:oae:mrvisser', function(err) {
                assert.ok(err);
                assert.equal(err.code, 400);
                callback();
            });
        ...
        it('verify invalid group uuid error', function(callback) {
            AuthzAPI.hasAnyRole('u:oae:mrvisser', 'not a uuid', function(err) {
                assert.ok(err);
                assert.equal(err.code, 400);
                callback();
            });
        ...
        it('verify empty membership', function(callback) {
            var userId = AuthzUtil.toUuid('u', 'imo-empty', 'mrvisser');
        ...
        it('verify single group membership', function(callback) {
            var groupId = AuthzUtil.toUuid('g', 'imo-single', 'oae-team');
            var userId = AuthzUtil.toUuid('u', 'imo-single', 'mrvisser');
            AuthzAPI.updateRoles(groupId, makeMembershipChange(userId, 'member'), function(err) {
                assert.ok(!err);
        ...
        it('verify two direct group membership', function(callback) {
            var groupId1 = AuthzUtil.toUuid('g', 'imo-two', 'oae-team');
            var groupId2 = AuthzUtil.toUuid('g', 'imo-two', 'oae-backend-team');
            var userId = AuthzUtil.toUuid('u', 'imo-two', 'mrvisser');
            AuthzAPI.updateRoles(groupId1, makeMembershipChange(userId, 'member'), function(err) {
                assert.ok(!err);
                AuthzAPI.updateRoles(groupId2, makeMembershipChange(userId, 'member'), function(err) {
                    assert.ok(!err);
