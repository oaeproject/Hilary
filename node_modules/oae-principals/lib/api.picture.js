...
/**
 * Crops the picture attached to this principal and generates 32x32 and 128x128 versions of it.
 *
 * @param {Context}     ctx                 Context that holds the current user and tenant.
...
var generateSizes = module.exports.generateSizes = function(ctx, principalId, x, y, width, callback) {
    ...
    _canManagePrincipal(ctx, principalId, function(err, principal) {
        ...
        // Remove the small and medium sized picture.
...
/**
 * Internal method that crops the picture attached to this principal and generates 32x32 and 128x128 versions of it.
 *
 * @param {Context}     ctx                 Context that holds the current user and tenant.
