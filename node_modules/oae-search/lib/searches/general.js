...
var _search = function(ctx, opts, callback) {
    ...
    var accessFilter = (ctx.user() && ctx.user().isTenantAdmin(ctx.tenant().alias)) ?
            SearchUtil.filterTerm('tenantId', ctx.tenant().alias) : SearchUtil.filterTerms('access', opts.access);
        ...
        filter = SearchUtil.filterAnd(
            ...
            SearchUtil.filterOr(
                ...
                SearchUtil.filterAnd(
                    ...
                    (!opts.includeExternal) ? SearchUtil.filterTerm('tenantId', ctx.tenant().alias) : null,
                    ...
                    SearchUtil.filterOr(
                        ...
                        // I can see all joinable resources
                        // TODO: this gets further restricted to only public tenants when there is a distinction between public / private tenants
