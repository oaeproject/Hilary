...
describe('Principals', function() {
    ...
    describe('User REST endpoints', function() {
         ...
         */
        var createUserViaRest = function(username, visibility, displayName, callback) {
            request.post({
         ...
         * @param  {Function} callback    Callback method
         */
        var getProfile = function(userId, visibility, displayName, callback) {
        ...
        it('Test create user', function(callback) {
            TenantAPI.getTenantByPort(2001, function(err, tenant) {
                ...
                createUserViaRest(username, 'public', 'John Doe', function(err, response, body) {
                    assert.ok(!err);
                    ...
                    PrincipalsAPI.createUser(anonymousContext, new LoginId('local', tenant.alias, tenantAdmin), 'testtest', 'tenant admin', {}, function(err, tenantAdminId) {
                        assert.ok(!err);
                        login(tenantAdmin, 'testtest', function() {
                            ...
                            createUserViaRest(username, 'public', 'John Doe', function(err, response, body) {
                                ...
                                PrincipalsAPI.setTenantAdmin(globalAdminContext, tenantAdminId, true, function(err) {
                                    ...
                                    createUserViaRest(username, 'public', 'John Doe', function(err, response, body) {
                                        assert.ok(!err);
                                        assert.equal(201, response.statusCode, body);
                                        callback();
                                    });
                                });
                            });
        ...
        it('Test user permissions', function(callback) {
            ...
            TenantAPI.getTenantByPort(2001, function(err, tenant) {
                ...
                var loginId1 = new LoginId('local', tenant.alias, username1);
                PrincipalsAPI.createUser(anonymousContext, loginId1, 'testtest', 'John Doe', {}, function(err, userId1) {
                    assert.ok(!err);
                    
                    var loginId2 = new LoginId('local', tenant.alias, username2);
                    PrincipalsAPI.createUser(anonymousContext, loginId2, 'testtest', 'Jane Doe', {}, function(err, userId2) {
                        assert.ok(!err);
        ...
        it('Test timezones', function(callback) {
            ...
            TenantAPI.getTenantByPort(2001, function(err, tenant) {
                ...
                var loginId = new LoginId('local', tenant.alias, username);
                PrincipalsAPI.createUser(anonymousContext, loginId, 'testtest', 'John Doe', {}, function(err, userId) {
                    assert.ok(!err);
