 ...
 * @FormParam   {string}        description         Description of discussion
 * @FormParam   {string}        displayName         Name to display for discussion
 * @FormParam   {string}        [managers]          Unique identifier(s) for manager(s) of the discussion (user creating discussion is always a manager); may also be array
 * @FormParam   {string}        [members]           Unique identifiers(s) for participant(s) in the discussion; may also be array
 * @FormParam   {string}        visibility          Visibility for discussion           [loggedin,private,public]
 * @Return      {BasicDiscussion}                   The discussion object
 */
 ...
 * @FormParam   {string}        discussionId        Unique identifier for discussion to update
 * @FormParam   {string}        [description]       Description of discussion
 * @FormParam   {string}        [displayName]       Name to display for discussion
 * @FormParam   {string}        [visibility]        Visibility for discussion           [loggedin,private,public]
 * @Return      {BasicDiscussion}                   The discussion object
 ...
 * @Method      DELETE
 * @Path        /discussion/{discussionId}
 * @PathParam   {string}                discussionId        Unique identifier for discusion to delete
 */
 ...
 * @Return      {DiscussionsLibrary}                        User or group's discussions
 */
 ...
 * @Return      {Discussion}                                Detailed discussion profile
 */
 ...
 * @FormParam   {string[]}              members             Unique identifiers(s) for participant(s) in the discussion
 * @Return      {void}
 */
 ...
 * @FormParam   {boolean}               {userId}            Permission for specified user (false will revoke access)
 * @Return      {void}
 */
