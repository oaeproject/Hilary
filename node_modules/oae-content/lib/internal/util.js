 ...
 * @return {String}                 The signed S3 url that can be used in a browser to view the video
 */
var _getSignedVideoUrl = function(ctx, key) {
    ...
    var s3 = new S3();
    var params = { Bucket: config['amazons3-bucket'], Key: key, Expiration: TIME_1_WEEK_IN_SECONDS };
