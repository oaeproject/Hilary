...
describe('Principals', function(){
    describe('REST endpoints', function() {
        ...
        it('should only be able to create a user if there are valid reCaptcha tokens present or the current user is an admin', function(callback) {
        ...
        it('should only display personal information if the visibility has been set to public or loggedin (and the current user is not anonymous', function(callback) {
            var r = Math.floor(Math.random()*10000000);
        ...
        it('should respect the user his or her timezone.', function(callback) {
        ...
        it('should be able to change a user his or her password', function(callback) {
            var r = Math.floor(Math.random()*10000000);
            var username = 'johndoe-' + r;
