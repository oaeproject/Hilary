 ...
 * @param  {String}         messageBoxId    The id of the message box in which this message is contained
 ...
 */
var Message = module.exports.Message = function(id, messageBoxId, threadKey, body, createdBy, created, level, replyTo, deleted) {
    var that = {};
    that.id = id;
