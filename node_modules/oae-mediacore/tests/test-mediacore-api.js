...
describe('MediaCore API', function() {
  ...
  describe('#getEmbedCode', function() {
      ...
      TestsUtil.generateTestUsers(camAdminRestContext, 2, function(err, users) {
        ...
        RestAPI.Content.createFile(
          ...
          function(err, content) {
            ...
            mediaCoreApp.get('/api2/media/:mediaCoreId/embedcode', function(
              req,
              res,
            ) {
    ...
    it('verify fetching embed code goes to the configured MediaCore instance in multi-tenant scenario', function(callback) {
      ...
      TestsUtil.createTestServer(function(
        gtMediaCoreApp,
        gtMediaCoreServer,
        gtMediaCorePort,
      ) {
                              ...
                              function(err) {
                                ...
                                mediaCoreApp.get(
                                  ...
                                  function(req, res) {
                                    ...
                                    res.status(200).send({
                                      html:
                                        '<iframe src="http://cambridge.mediacore.tv"></iframe>',
                                    });
                                  },
                                );
                                ...
                                gtMediaCoreApp.get(
                                  ...
                                  function(req, res) {
                                    ...
                                    res.status(200).send({
                                      html:
                                        '<iframe src="http://gatech.mediacore.tv"></iframe>',
                                    });
                                  },
                                );
                        ...
                        RestAPI.Content.getContent(
                          ...
                          function(err, content) {
                            ...
                            assert.equal(
                              ...
                              'http://path/to/large/image',
                            );
                            assert.equal(
                              content.previews.mediumUrl,
                              'http://path/to/720p/image',
                            );
                            assert.equal(
                              content.previews.largeUrl,
                              'http://path/to/720p/image',
                            );
                            assert.equal(
                              content.previews.wideUrl,
                              'http://path/to/720p/image',
                            );
