...
describe('Version information', function() {
  ...
  it('should return the version information', function(callback) {
    ...
    var anonTenantRestContext = TestsUtil.createTenantRestContext(
      global.oaeTests.tenants.cam.host,
    );
    var adminTenantRestContext = TestsUtil.createTenantAdminRestContext(
      global.oaeTests.tenants.cam.host,
    );
    ...
    TestsUtil.generateTestUsers(adminTenantRestContext, 1, function(
      err,
      users,
      user,
    ) {
