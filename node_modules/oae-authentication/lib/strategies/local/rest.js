...
OAE.globalAdminServer.post('/api/auth/login', _handleLocalAuthentication, function(req, res, next) {
...
OAE.tenantServer.post('/api/auth/login', _handleLocalAuthentication, function(req, res, next) {
    // This callback only gets called when we log in succesfully.
    req.telemetryUrl = '/api/auth/login';
    return res.send(200, req.user);
});
