...
var VALID_CHARACTERS = '0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-_';
 ...
 */
var splitUri = module.exports.splitUri = function(uri) {
    var parts = uri.split(':');
    var storageType = parts.shift();
    var location = parts.join(':');
    return {'storageType': storageType, 'location': location};
};
...
var generateUri = module.exports.generateUri = function(file, options) {
    ...
    if (options.resourceId) {
        var r = AuthzUtil.getResourceFromId(options.resourceId);
    ...
    // In all other cases we generate a random hash.
        ...
        var tenantAlias = 'unspecified';
        var resourceId = ShortId.generate();
 ...
 */
var _hash = function(resourceType, tenantAlias, resourceId) {
    return util.format('%s/%s/%s/%s/%s/%s/%s', resourceType, tenantAlias, resourceId.substr(0, 2), resourceId.substr(2, 2), resourceId.substr(4, 2), resourceId.substr(6, 2), resourceId);
};
 ...
 */
var _padRight = function(str, minLength) {
