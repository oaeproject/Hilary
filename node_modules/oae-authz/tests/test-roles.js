...
describe('Authz-Roles', function() {
    ...
    var loadContentRoles = function(principalId, baseContentId, resourceType, numContentItems, role, callback) {
        ...
        var tenantId = AuthzUtil.getPrincipalFromId(principalId).tenantId;
        var resourceId = AuthzUtil.toId(resourceType, tenantId, baseContentId + '-' + numContentItems);
    ...
    describe('#getRolesForPrincipalsAndResourceType()', function() {
        ...
        it('verify validation', function(callback) {
            ...
            AuthzAPI.getRolesForPrincipalsAndResourceType(null, ResourceTypes.CONTENT, 1000, function(err, entries) {
                ...
                AuthzAPI.getRolesForPrincipalsAndResourceType([principalId1], null, 1000, function(err, entries) {
                    assert.ok(err);
                    assert.ok(!entries);
                    callback();
                });
