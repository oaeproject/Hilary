                ...
                ActivityDAO.saveAggregatedEntities(allAggregates, function(err) {
                    ...
                    ActivityDAO.getAggregatedEntities(activeAggregateKeys, function(err, fetchedEntities) {
                        ...
                        deliveredAggregateKeys.forEach(function(aggregateKey) {
                            ...
                            var actor = _createActivityEntity(actors);
                            var object = _createActivityEntity(objects);
                            var target = _createActivityEntity(targets);
...
var _createAggregates = function(routedActivities) {
    ...
    routedActivities.forEach(function(routedActivity) {
        ...
        groupBy.forEach(function(pivot) {
            ...
            // Determines whether or not this new aggregate is a legitimate second activity in the aggregate, or if it is a
            // duplicate action. This is a legitimate new aggregation if it actually adds a new entity to one of the entity
            // collections of the existing aggregate
