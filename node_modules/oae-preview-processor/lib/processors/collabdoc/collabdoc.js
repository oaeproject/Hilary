...
var options = {
    ...
    'script': function() {
        ...
        // Explicitly set the background to white as we would otherwise end
        // up with a transparent png.
        document.body.style.backgroundColor = '#ffffff';

        // Hide the editbar
        $('#editbar').hide();

        // Remove the sidebar with the line numbers
        var iframe = $('iframe[name=ace_outer]').contents();
        $('#sidediv', iframe).hide();

        // Remove the chat bar.
        $('#chaticon').remove();

        // Position the text area in the topleft corner
        $('#editorcontainer').css('top', '0px');
        $('#outerdocbody', iframe).css({'position': 'absolute', 'left': '-32px'});
    },
    'windowSize': {
