 ...
 */
module.exports.refreshLogConfiguration = function(newConfig) {
 ...
 *
 * @param   {String}         name       The name of the logger, this name will be used to identify this logger for potentially custom
 *                                      log configuration.
 * @return  {Function(ctx)}             A function that can be used to retrieve the logger.
 *          {Object}         return.ctx The request context of the current log (optional). If specified, will allow context-specific
