...
module.exports = function(config) {
  ...
  strategy.getPassportStrategy = function(tenant) {
    ...
    var idpEntityID = AuthenticationConfig.getValue(
      tenant.alias,
    ...
    var passportStrategy = new ShibbolethStrategy(
      ...
      function(req, headers, callback) {
        ...
        var externalId = _getBestAttributeValue(
          tenant.alias,
        ...
        var displayName = _getBestAttributeValue(
          tenant.alias,
          'mapDisplayName',
          headers,
          headers['remote_user'],
        ...
        // Get a locale, if any
        var locale = _getBestAttributeValue(
          tenant.alias,
          'mapLocale',
          headers,
          headers['locale'],
        ...
        AuthenticationUtil.handleExternalGetOrCreateUser(
          ...
          function(err, user, loginId, created) {
            ...
            if (!q) {
              ...
              return callback({
                code: 500,
                msg: 'Unable to store Shibboleth metadata',
              });
            }
 ...
 * @api private
 */
var _getBestAttributeValue = function(
  tenantAlias,
  configKey,
  headers,
  defaultValue,
  ...
  var priorityList = AuthenticationConfig.getValue(
    tenantAlias,
    AuthenticationConstants.providers.SHIBBOLETH,
    configKey,
  );
