...
module.exports = {
    ...
    'cas': {
        ...
        'elements': {
            ...
            'name': new Fields.Text('Name', 'A name that users will recognize as their identity provider', ''),
            'host': new Fields.Text('Host', 'The URL at which the CAS server can be reached (this should include http(s)://, any non-standard port and have no trailing slash)', '', {'suppress': true}),
