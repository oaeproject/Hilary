 ...
 * @throws {AssertionError}                 Thrown if any of the assertions fail
 */
var assertUpdateUsersSucceeds = module.exports.assertUpdateUsersSucceeds = function(restCtx, userIds, profileFields, callback, _userIdsToUpdate, _updatedUsers) {
    var _userIdsToUpdate = _userIdsToUpdate || userIds.slice();
    var _updatedUsers = _updatedUsers || {};
    if (_.isEmpty(_userIdsToUpdate)) {
        return callback(_updatedUsers);
    }

    var userId = _userIdsToUpdate.shift();
    assertUpdateUserSucceeds(restCtx, userId, profileFields, function(updatedUser) {
        _updatedUsers[userId] = updatedUser;
        return assertUpdateUsersSucceeds(restCtx, userIds, profileFields, callback, _userIdsToUpdate, _updatedUsers);
    });
};
...
var assertSetGroupMembersSucceeds = module.exports.assertSetGroupMembersSucceeds = function(restCtx, groupId, members, callback) {
    RestAPI.Group.setGroupMembers(restCtx, groupId, members, function(err) {
        ...
        SearchTestUtil.whenIndexingComplete(function() {
            LibraryAPI.Index.whenUpdatesComplete(function() {
                assertGetAllMembersLibrarySucceeds(restCtx, groupId, null, function(allMembers) {
