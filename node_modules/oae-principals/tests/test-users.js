...
describe('Users', function() {
    ...
    before(function(callback) {
        ...
        gtAdminRestContext = TestsUtil.getAdminRestContext(global.oaeTests.tenants.gt.baseUrl);
    ...
    describe('#get user', function() {
        ...
        it('verify get user', function(callback) {
            ...
            RestAPI.User.createUser(camAdminRestContext, userId, 'password', 'public', 'en_GB', 'Europe/London', 'Test', 'User', 'Test User', function(err, userObj) {
                ...
                RestAPI.User.getUser(anonymousRestContext, userObj.id, function(err, retrievedUser) {
                    ...
                    assert.equal(retrievedUser.profile.firstName, 'Test');
                    assert.equal(retrievedUser.profile.lastName, 'User');
        ...
        it('verify get user by ugly username', function(callback) {
            ...
            RestAPI.User.createUser(camAdminRestContext, userId1, 'password', 'public', 'en_GB', 'Europe/London', 'Test', 'User', 'Test User', function(err, userObj1) {
                assert.ok(!err);
                assert.ok(userObj1);
                ...
                RestAPI.User.getUser(anonymousRestContext, userObj1.id, function(err, retrievedUser1) {
                    ...
                    assert.equal(retrievedUser1.profile.firstName, 'Test');
                    assert.equal(retrievedUser1.profile.lastName, 'User');
                    ...
                    RestAPI.User.createUser(camAdminRestContext, userId2, 'password', 'public', 'en_GB', 'Europe/London', 'одиноко', 'спрятанного', 'Кругом шумел', function(err, userObj2) {
                        assert.ok(!err);
                        assert.ok(userObj2);
                        ...
                        RestAPI.User.getUser(anonymousRestContext, userObj2.id, function(err, retrievedUser2) {
                            ...
                            assert.equal(retrievedUser2.profile.firstName, 'одиноко');
                            assert.equal(retrievedUser2.profile.lastName, 'спрятанного');
    ...
    describe('#global and tenant admin', function() {
        ...
        it('Verify tenant admin separation', function(callback) {
            ...
            RestAPI.User.createUser(camAdminRestContext, jackUserId, 'password', 'public', 'en_GB', 'Europe/London', 'Jack', 'Doe', 'Jack Doe', function(err, jack) {
                ...
                RestAPI.User.createUser(camAdminRestContext, joeUserId, 'password', 'public', 'en_GB', 'Europe/London', 'Joe', 'Doe', 'Jane Doe', function(err, joe) {
                    assert.ok(!err);
                    assert.ok(joe);
                    var joeRestContext = new RestContext(global.oaeTests.tenants.cam.baseUrl, joeUserId, 'password');
                    
                    var janeUserId = TestsUtil.generateTestUserId('jane');
                    RestAPI.User.createUser(gtAdminRestContext, janeUserId, 'password', 'public', 'en_GB', 'Europe/London', 'Jane', 'Doe', 'Jane Doe', function(err, jane) {
                        assert.ok(!err);
                        assert.ok(jane);
                        var janeRestContext = new RestContext(global.oaeTests.tenants.gt.baseUrl, janeUserId, 'password');
                            ...
                            PrincipalsAPI.getTenantUser(new Context(global.oaeTests.tenants.cam), jackUserId, function(err, user) {
                                ...
                                RestAPI.User.updateUser(jackRestContext, joe.id, updateData, function(err) {
                                    ...
                                    RestAPI.User.getMe(joeRestContext, function(err, meObj) {
                                        assert.ok(!err);
                                        assert.ok(meObj);
                                        assert.equal(meObj.profile.lastName, 'Bar');
                                        ...
                                        RestAPI.User.updateUser(jackRestContext, jane.id, updateData, function(err) {
                                            ...
                                            RestAPI.User.getMe(janeRestContext, function(err, meObj) {
                                                assert.ok(!err);
                                                assert.ok(meObj);
                                                assert.equal(meObj.profile.lastName, 'Doe');
