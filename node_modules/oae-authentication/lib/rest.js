...
var _getResetPasswordSecret = function(req, res){
    AuthenticationAPI.getResetPasswordSecret(req.ctx, req.params.username, function(err, token) {
	if (err) {
...
var _resetPassword = function(req, res){
    AuthenticationAPI.resetPassword(req.ctx, req.params.username, req.body.secret, req.body.newPassword, function(err, changed) {
	if (err) {
        return res.status(err.code).send(err.msg);
    }
