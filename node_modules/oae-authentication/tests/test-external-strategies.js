...
describe('Authentication', function() {
    ...
    describe('Shibboleth authentication', function() {
        ...
        /**
         * Test that verifies that the user will be set to private if displayName resembles a shibboleth identifier
         */
        it('verify the user will be private if displayName resembles a Shibboleth identifier', function(callback) {
            _enableStrategy('shibboleth', function(done) {
                ...
                _initiateShibbolethAuthFlow('/content/bla', function(tenantRestContext, spRestContext) {
                    ...
                    var attributes = {
                        ...
                        // Generate an external id
                        'remote_user': 'shibboleth!' + Math.random(),
        ...
        /**
         * Test that verifies that the user will be set to private if displayName resembles an email
         */
        it('verify the user will be private if displayName resembles an email', function(callback) {
            _enableStrategy('shibboleth', function(done) {
        ...
        /**
         * Test that verifies that the user will be set to private if displayName starts with https
         */
        it('verify the user will be private if displayName starts with http(s)', function(callback) {
            _enableStrategy('shibboleth', function(done) {
                ...
                _initiateShibbolethAuthFlow('/content/bla', function(tenantRestContext, spRestContext) {
                    ...
                    var attributes = {
                        ...
                        // Generate an external id
                        'remote_user': 'https://idp.example.com/shibboleth#' + Math.random(),
