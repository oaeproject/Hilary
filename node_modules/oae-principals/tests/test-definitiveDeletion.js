...
describe('Delete user', function() {
                ...
                FollowingTestsUtil.createFollowerAndFollowed(camAdminRestContext, function(follower, followed) {
                    ...
                    FollowingTestsUtil.assertFollows(follower.user.id, follower.restContext, followed.user.id, followed.restContext, function() {
                        ...
                        PrincipalsTestUtil.assertDefinitiveDeletionUsersSucceeds(camAdminRestContext, followed, userArchive, function(err, userArchive) { 
                            ...
                            // Delete user
                            PrincipalsDefinitiveDeletionAPI.definitiveDeletion(camAdminRestContext, followed.user, userArchive.tenantAlias, function(err) {
                                assert.ok(!err); 
                ...
                FollowingTestsUtil.createFollowerAndFollowed(camAdminRestContext, function(follower, followed) {
                    ...
                    FollowingTestsUtil.assertFollows(follower.user.id, follower.restContext, followed.user.id, followed.restContext, function() {
                        ...
                        PrincipalsTestUtil.assertDefinitiveDeletionUsersSucceeds(camAdminRestContext, follower, userArchive, function(err, userArchive) { 
                            ...
                            // Delete user
                            PrincipalsDefinitiveDeletionAPI.definitiveDeletion(camAdminRestContext, follower.user, userArchive.tenantAlias, function(err) {
                                assert.ok(!err); 
    ...
    // describe('Delete user - Verify if when a user is deleted, there is no trace of him', function() {

    //     /**
    //      * Test that verifies definitive delation send one email to each users
    //      */
    //     it('Verify if there is no trace into the message tables', function(callback) {
    ...
    //             // Generate file
    //             PrincipalsTestUtil.generateFiles(userToDelete.restContext, 'public', 1,  function(err, file) {
    //                 assert.ok(!err);
