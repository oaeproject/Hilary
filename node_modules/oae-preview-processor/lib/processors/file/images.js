...
var cropThumbnail = module.exports.cropThumbnail = function(ctx, path, callback) {
    ...
    _cropIntelligently(ctx, path, PreviewConstants.SIZES.IMAGE.THUMBNAIL, PreviewConstants.SIZES.IMAGE.THUMBNAIL, 'thumbnail.png', function(err, thumbnailPath) {
        ...
        _cropIntelligently(ctx, path, PreviewConstants.SIZES.IMAGE.ACTIVITY_WIDTH, PreviewConstants.SIZES.IMAGE.ACTIVITY_HEIGHT, 'activity.png', function(err, activityPath) {
            if (err) {
                return callback(err);
            }

            ctx.addPreview(activityPath, 'activity');
            callback();
        });
    });
};
