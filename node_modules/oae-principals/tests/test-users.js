...
describe('Users', function() {
    ...
    describe('Import users', function() {
         ...
         */
        var _verifyUser = function(err, meObj, expectedDisplayName, expectedEmail, expectedPublicAlias) {
            assert.ok(!err);
            assert.ok(meObj);
        ...
        it('verify import local users and display name override', function(callback) {
            ...
            PrincipalsTestsUtil.importUsers(globalAdminRestContext, global.oaeTests.tenants.cam.alias, getDataFileStream('users-with-password.csv'), 'local', null, function(err) {
                ...
                RestAPI.User.getMe(nicolaasRestContext, function(err, nicolaasMeObj) {
                    _verifyUser(err, nicolaasMeObj, 'Nicolaas Matthijs', 'nicolaas@test.com', 'Nicolaas Matthijs');
                    ...
                    RestAPI.User.getMe(simonRestContext, function(err, simonMeObj) {
                        _verifyUser(err, simonMeObj, 'Gaeremynck', 'simon@test.com', 'Gaeremynck');
                        ...
                        RestAPI.User.getMe(stuartRestContext, function(err, stuartMeObj) {
                            _verifyUser(err, stuartMeObj, 'Stuart D. Freeman', 'stuart@test.com', 'Stuart D. Freeman');
                            ...
                            RestAPI.User.getMe(stephenRestContext, function(err, stephenMeObj) {
                                _verifyUser(err, stephenMeObj, 'Stephen Thomas', 'stephen@test.com', 'Stephen Thomas');
                                ...
                                RestAPI.User.updateUser(nicolaasRestContext, nicolaasMeObj.id, {'displayName': 'user-zfdHliPLa'}, function (err, user) {
                                    ...
                                    RestAPI.User.getMe(nicolaasRestContext, function(err, nicolaasMeObj) {
                                        _verifyUser(err, nicolaasMeObj, 'user-zfdHliPLa', 'nicolaas@test.com', 'Nicolaas Matthijs');
                                        ...
                                        PrincipalsTestsUtil.importUsers(camAdminRestContext, null, getDataFileStream('users-with-password.csv'), 'local', null, function(err) {
                                            ...
                                            RestAPI.User.getMe(nicolaasRestContext, function(err, nicolaasMeObj) {
                                                ...
                                                RestAPI.User.updateUser(nicolaasRestContext, nicolaasMeObj.id, {'displayName': 'N. Matthijs'}, function (err, user) {
                                                    ...
                                                    // Verify that the update is reflected in the me feed
                                                    RestAPI.User.getMe(nicolaasRestContext, function(err, nicolaasMeObj) {
                                                        _verifyUser(err, nicolaasMeObj, 'N. Matthijs', 'nicolaas@test.com', 'Nicolaas Matthijs');
                                        ...
                                        PrincipalsTestsUtil.importUsers(camAdminRestContext, null, getDataFileStream('users-with-password.csv'), 'local', null, function(err) {
                                            ...
                                            RestAPI.User.getMe(nicolaasRestContext, function(err, nicolaasMeObj) {
                                                ...
                                                RestAPI.User.updateUser(nicolaasRestContext, nicolaasMeObj.id, {'email': 'nicolaas@my.other.mail.address.com'}, function (err, user) {
                                                    ...
                                                    // Verify that the update is reflected in the me feed
                                                    RestAPI.User.getMe(nicolaasRestContext, function(err, nicolaasMeObj) {
                                                        _verifyUser(err, nicolaasMeObj, 'Nicolaas Matthijs', 'nicolaas@my.other.mail.address.com', 'Nicolaas Matthijs');
                                        ...
                                        PrincipalsTestsUtil.importUsers(camAdminRestContext, null, getDataFileStream('users-with-password.csv'), 'local', null, function(err) {
                                            ...
                                            RestAPI.User.getMe(nicolaasRestContext, function(err, nicolaasMeObj) {
                                                ...
                                                RestAPI.User.updateUser(nicolaasRestContext, nicolaasMeObj.id, {'publicAlias': 'Nico'}, function (err, user) {
                                                    ...
                                                    // Verify that the update is reflected in the me feed
                                                    RestAPI.User.getMe(nicolaasRestContext, function(err, nicolaasMeObj) {
                                                        _verifyUser(err, nicolaasMeObj, 'Nicolaas Matthijs', 'nicolaas@test.com', 'Nico');
                                                                ...
                                                                PrincipalsTestsUtil.importUsers(camAdminRestContext, null, getDataFileStream('users-with-password.csv'), 'local', true, function(err) {
                                                                    ...
                                                                    RestAPI.User.getMe(nicolaasRestContext, function(err, nicolaasMeObj) {
                                                                        ...
                                                                        RestAPI.User.updateUser(nicolaasRestContext, nicolaasMeObj.id, {'publicAlias': ''}, function (err, user) {
                                                                            ...
                                                                            // Re-import the users using the `forceProfileUpdate` flag to verify that the public aliass is correctly reverted to
                                                                            // the display name provided in the CSV file when providing the flag
                                                                            PrincipalsTestsUtil.importUsers(camAdminRestContext, null, getDataFileStream('users-with-password.csv'), 'local', true, function(err) {
                                                                                assert.ok(!err);
