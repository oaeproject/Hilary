 ...
 * @throws {TypeError} If body is null
 */
 ...
 * @throws {TypeError} If body and expires are null
 */
 ...
 * @throws {TypeError} If body and expires are null
 */
var verifyExpiringSignature = module.exports.verifyExpiringSignature = function(body, signature, expires) {
 ...
 * @throws {TypeError} If body and expires are null
 */
var createExpiresAtSignature = module.exports.createExpiresAtSignature = function(body, expiresAt) {
    body += '#' + expiresAt.getTime();
    var signature = sign(body);
    return {
        'signature': signature,
 ...
 * @throws {TypeError} If body is null
 */
Validator.prototype.verifyExpiringSignature = function(body, expires) {
    if (!this.str || !verifyExpiringSignature(body, this.str, expires)) {
        this.error(this.msg || 'Invalid signature');
    }
    return this;
};
