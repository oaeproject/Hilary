...
var _augmentContent = function(ctx, contentObj) {
    ...
    if (contentObj.previews) {
        ...
        if (contentObj.previews.smallUri) {
            contentObj.previews.smallUrl = ContentUtil.getDownloadUrlForUri(principalId, contentObj.tenant.alias, contentObj.previews.smallUri);
        }
        if (contentObj.previews.mediumUri) {
            contentObj.previews.mediumUrl = ContentUtil.getDownloadUrlForUri(principalId, contentObj.tenant.alias, contentObj.previews.mediumUri);
        }
        if (contentObj.previews.largeUri) {
            contentObj.previews.largeUrl = ContentUtil.getDownloadUrlForUri(principalId, contentObj.tenant.alias, contentObj.previews.largeUri);
        }
    }
};
