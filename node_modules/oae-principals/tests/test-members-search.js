                ...
                RestAPI.User.createUser(camAdminRestContext, loggedinUserMemberUsername, 'password', 'Loggedin User Member', loggedinOpts, function(err, _loggedinUserMember) {
                    ...
                    RestAPI.User.updateUser(camAdminRestContext, loggedinUserMember.id, {'extraProp': 'My extra prop'}, function(err) {
                        ...
                        RestAPI.User.createUser(camAdminRestContext, privateUserMemberUsername, 'password', 'Private User Member', privateOpts, function(err, _privateUserMember) {
                            ...
                            RestAPI.Group.createGroup(doerRestContext, targetPublicGroupAlias, targetPublicGroupAlias, 'public', 'no', [], [], function(err, _targetPublicGroup) {
                                assert.ok(!err);
                                targetPublicGroup = _targetPublicGroup;

                                RestAPI.Group.createGroup(doerRestContext, targetLoggedinGroupAlias, targetLoggedinGroupAlias, 'loggedin', 'no', [], [], function(err, _targetLoggedinGroup) {
                                    assert.ok(!err);
                                    targetLoggedinGroup = _targetLoggedinGroup;

                                    RestAPI.Group.createGroup(doerRestContext, targetPrivateGroupAlias, targetPrivateGroupAlias, 'private', 'no', [], [], function(err, _targetPrivateGroup) {
                                        assert.ok(!err);
                                        targetPrivateGroup = _targetPrivateGroup;

                                        RestAPI.Group.createGroup(doerRestContext, publicGroupMemberAlias, publicGroupMemberAlias, 'public', 'no', [], [], function(err, _publicGroupMember) {
                                            assert.ok(!err);
                                            publicGroupMember = _publicGroupMember;

                                            RestAPI.Group.createGroup(doerRestContext, privateGroupMemberAlias, privateGroupMemberAlias, 'public', 'no', [], [], function(err, _privateGroupMember) {
                                                assert.ok(!err);
