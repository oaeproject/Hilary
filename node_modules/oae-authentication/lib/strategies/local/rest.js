 ...
 * @HttpResponse                401                         A tenant must be provided
 * @HttpResponse                401                         You have to be logged in to be able to change a password
 * @HttpResponse                401                         You're not authorized to change this user's
 */
var _handleChangePassword = function(req, res) {
    AuthenticationAPI.changePassword(req.ctx, req.params.userId, req.body.oldPassword, req.body.newPassword, function(err, changed) {
        if (err) {
