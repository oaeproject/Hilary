...
<%
    ...
    var renderFooter = function() {
        ...
        var oaeLink = '<a href="http://www.oaeproject.org">' + oaeNameI18n + '</a>';
        var instanceLink = (instance.URL) ? '<a href="' + instance.URL + '">' + util.html.encodeForHTML(instance.name) + '</a>' :
            util.html.encodeForHTML(instance.name);
        var hostingOrganizationLink = (hostingOrganization.URL) ? '<a href="' + hostingOrganization.URL + '">' + util.html.encodeForHTML(hostingOrganization.name) + '</a>' :
            util.html.encodeForHTML(hostingOrganization.name);
        ...
        if (instanceLink && hostingOrganizationLink) {
            ...
            footerContent = '__MSG__POWERED_BY_APEREO_OAE__';
        }
        ...
        str +=       util.i18n.translate(footerContent, footerContentData);
        str +=   '</td>';
        str += '</tr>';
