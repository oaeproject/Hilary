...
var getBasicProfile = module.exports.getBasicProfile = function(ctx, userId, callback) {
    getUser(ctx, userId, function(err, user) {
        ...
        // Only stick picture stuff on there if it exists.
        if (user.smallPicture) {
            data.smallPicture = user.smallPicture;
        }
        if (user.mediumPicture) {
            data.mediumPicture = user.mediumPicture;
        }
        if (user.largePicture) {
            data.largePicture = user.largePicture;
        }
