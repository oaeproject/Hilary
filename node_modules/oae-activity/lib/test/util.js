 ...
 * @param  {String}         actorId             The expected actor id, or an array of expected actor ids if the entity is an oae:collections aggregate
 * @param  {String}         [objectId]          The expected object id, or an array of expected object ids if the entity is an oae:collections aggregate
 * @param  {String}         [targetId]          The expected target id, or an array of expected target ids if the entity is an oae:collections aggregate
 * @param  {Function}       callback            Standard callback function
