 ...
 * @param   {Object}    [resourceData]  A resourceType-specific blob of JSON data that provides more information needed to construct the Activity Object
 */
...
/**
 * An Activity seed object that can be used to gather all information that occurred in an activity and construct an Activity Object.
 *
 ...
 * @param   {String}                verb                The action that was performed, as per the activity verb in the ActivityStrea.ms specification
 ...
 */
var ActivityMediaLink = module.exports.ActivityMedialLink = function(url, width, height, duration) {
    var that = {};
    that.url = url;
    that.width = width;
    that.height = height;
 ...
 * @param   {ActivityObject}    actor               The actor Object that performed the action
 * @param   {ActivityObject}    object              The object Object on which the action was performed
 * @param   {ActivityObject}    target              The target Object of the activity, as described in the ActivityStrea.ms specification
 */
var Activity = module.exports.Activity = function(oaeActivityType, published, verb, actor, object, target) {
    var that = {};
...
/**
 * A very generic activity Object model, based on the ActivityStrea.ms model specification.
 *
 * @param   {String}    objectType          The type of object (e.g., user, content, etc...)
 ...
 */
var ActivityObject = module.exports.ActivityObject = function(objectType, id, opts) {
    var opts = opts || {};
    var ext = opts.ext || {};
    delete opts.ext;
