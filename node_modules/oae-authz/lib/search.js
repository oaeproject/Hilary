 ...
 */
var fireMembershipUpdateTasks = (module.exports.fireMembershipUpdateTasks = function(
  memberIds,
) {
  ...
  if (!_.isEmpty(groupResources)) {
    SearchAPI.postIndexTask('group', groupResources, {
      children: { resource_memberships: true },
    });
  }
 ...
 * @api private
 */
var _produceResourceMembersDocuments = function(
  resources,
  callback,
  _documents,
) {
 ...
 * @api private
 */
var _produceResourceMembershipsDocuments = function(
  resources,
  callback,
  _documents,
) {
  ...
  _getMembershipIds(resource, function(err, membershipIds) {
    ...
    return _produceResourceMembershipsDocuments(
      resources,
      callback,
      _documents,
    );
...
var _getMemberIds = function(resource, callback) {
  ...
  AuthzAPI.getAuthzMembers(resource.id, null, 10000, function(
    err,
    memberIdRoles,
  ) {
    if (err) {
...
var _getMembershipIds = function(resource, callback) {
  ...
  AuthzAPI.getRolesForPrincipalsAndResourceType(
    ...
    function(err, principalGroupRole) {
      if (err) {
        return callback(err);
      }
