...
describe('Utilities', function() {
    ...
    describe('Cassandra', function() {
        ...
        it('Test casting to a Boolean', function(callback) {
            Cassandra.runQuery('INSERT INTO testQuery (key_id, testbool, teststring) VALUES (?, ?, ?)', ['testkey', 'true', 'notaboolean'], function (err) {
                assert.ok(!err);
                Cassandra.runQuery('SELECT testbool, teststring FROM testQuery WHERE key_id = ?', ['testkey'], function (err, rows) {
                    assert.ok(!err);
