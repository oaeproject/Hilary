...
var ensureSchema = function(callback) {
    Cassandra.createColumnFamilies({
        'Tenant': 'CREATE COLUMNFAMILY Tenant (alias text PRIMARY KEY, displayName text, host text, active boolean, deleted boolean);',
        'TenantNetwork': 'CREATE COLUMNFAMILY TenantNetwork (id text PRIMARY KEY, displayName text);',
        'TenantNetworkTenants': 'CREATE COLUMNFAMILY TenantNetworkTenants (tenantNetworkId text PRIMARY KEY);'
    }, callback);
};
