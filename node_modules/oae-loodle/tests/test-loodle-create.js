...
describe('Loodle create', function () {
    ...
    describe('create a loodle in many groups', function () {
        ...
        it('should create a loodle type content');

        it('should be accessible for all the users who are part of the groups');

        it('should have the users who have been explicitly invated, the user who created the loodle and the groups users as participants');

        it('should add only one time as participants the users who have multiple access to the loodle');
