...
var close = (module.exports.close = function(callback) {
  client.shutdown(function(err) {
    if (err) {
      ...
      return callback({
        code: 500,
        msg: 'Error closing the cassandra connection pool',
      });
    }
 ...
 * @param  {Function} callback Standard callback function
 */
var columnFamilyExists = (module.exports.columnFamilyExists = function(
  name,
  callback,
) {
  runQuery(
 ...
 * @param  {Function} callback Standard callback function
 */
var dropColumnFamily = (module.exports.dropColumnFamily = function(
  name,
  callback,
) {
 ...
 * @param  {Object}        callback.err    An error that occurred, if any
 */
var dropColumnFamilies = (module.exports.dropColumnFamilies = function(
  families,
  callback,
) {
  callback = callback || function() {};
 ...
 */
var createColumnFamily = (module.exports.createColumnFamily = function(
  name,
  cql,
  callback,
) {
 ...
 * @param  {Object}        callback.err    An error that occurred, if any
 */
var createColumnFamilies = (module.exports.createColumnFamilies = function(
  families,
  callback,
) {
  callback = callback || function() {};
 ...
 * @param  {Object}   callback.err  An error that occurred, if any
 */
var runQuery = (module.exports.runQuery = function(
  query,
  parameters,
  callback,
) {
 ...
 */
let runAutoPagedQuery = (module.exports.runAutoPagedQuery = function(
  query,
  parameters,
  callback,
) {
 ...
 * @param  {Object}     callback.err        An error that occurred, if any
 */
var runBatchQuery = (module.exports.runBatchQuery = function(
  queries,
  callback,
) {
  callback = callback || function() {};
 ...
 */
var runPagedQuery = (module.exports.runPagedQuery = function(
  tableName,
  keyColumnName,
  keyColumnValue,
  rangeColumnName,
  ...
  runQuery(cql, params, function(err, rows) {
    ...
    var nextToken =
      results.length === limit ? _.last(results).get(rangeColumnName) : null;
 ...
 */
var runAllPagesQuery = (module.exports.runAllPagesQuery = function(
  tableName,
  keyColumnName,
  keyColumnValue,
  rangeColumnName,
 ...
 */
var iterateAll = (module.exports.iterateAll = function(
  columnNames,
  columnFamily,
  keyColumnName,
  opts,
  ...
  opts = opts || {};
  opts.batchSize = OaeUtil.getNumberParam(
    opts.batchSize,
    DEFAULT_ITERATEALL_BATCH_SIZE,
  );
...
var _iterateAll = function(
  ...
  var query = _buildIterateAllQuery(
    columnNames,
    columnFamily,
    keyColumnName,
    batchSize,
  ...
  runQuery(query.query, query.parameters, function(err, rows) {
    ...
    try {
      ...
      log().error(
        { err: ex },
        'Error invoking consumer onEach during iterateAll',
      );
 ...
 * @api private
 */
var _buildIterateAllQuery = function(
  columnNames,
  columnFamily,
  keyColumnName,
  batchSize,
 ...
 */
var constructUpsertCQL = (module.exports.constructUpsertCQL = function(
  cf,
  rowKey,
  rowValue,
  values,
...
var executeQuery = function(query, parameters, callback) {
  ...
  for (var p = 0; p < parameters.length; p++) {
    if (OaeUtil.isUnspecified(parameters[p])) {
      _logCustomError('Invalid cassandra query specified.', {
        query: query,
        parameters: parameters,
      });
      return callback({
  ...
  client.execute(query, parameters, { prepare: true }, function(
    err,
    resultSet,
  ) {
    if (err) {
...
var _logCustomError = function(msg, data) {
  ...
  log().error(
    _truncateLogParameters(data.err, data.query, data.parameters),
    msg,
  );
};
