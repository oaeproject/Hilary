...
var _produceGroupSearchDocument = function(group) {
    var general = _.compact([group.displayName, group.alias, group.description]).join(' ');
...
var _transformUserDocuments = function(ctx, docs, callback) {
    ...
    for (var i = 0; i < docIds.length; i++) {
        ...
        // Create a user from the search document to transform, including the extras
        ...
        // Promote the user extension properties (extra) to the doc from the "_extra" search field
        result.extra = result._extra.userExtra;

        // Remove the general and sort fields that are placed on the search document. these should not go into the view model
