...
var getGroup = (module.exports.getGroup = function(ctx, groupId, callback) {
  ...
  validator
    .check(groupId, { code: 400, msg: 'An invalid group id was specified' })
    .isGroupId();
 ...
 */
var getFullGroupProfile = (module.exports.getFullGroupProfile = function(
  ctx,
  groupId,
  callback,
) {
  getGroup(ctx, groupId, function(err, group) {
    if (err) {
      ...
      return callback({
        code: 404,
        msg: util.format("Couldn't find principal: %s", groupId),
      });
    }

    AuthzPermissions.resolveEffectivePermissions(ctx, group, function(
      err,
      permissions,
      effectiveRole,
    ) {
      ...
      OaeUtil.invokeIfNecessary(
        ...
        function(err, hasAnyRole) {
          ...
          if (group.isMember) {
            ...
            group.signature = Signature.createExpiringResourceSignature(
              ctx,
              groupId,
            );
          }
          ...
          OaeUtil.invokeIfNecessary(
            ...
            function(err, createdBy) {
              ...
              _getMembersLibrary(ctx, group, hasAnyRole, null, 8, function(
                err,
                members,
              ) {
                if (err) {
                ...
                PrincipalsEmitter.emit(
                  PrincipalsConstants.events.GET_GROUP_PROFILE,
                  ctx,
                  group,
                );

                if (currentUser && PrincipalsUtil.isUser(currentUserId)) {
                  PrincipalsDAO.setLatestVisit(
                    currentUser,
                    group,
                    new Date(),
 ...
 */
var getMembersLibrary = (module.exports.getMembersLibrary = function(
  ctx,
  groupId,
  start,
  limit,
 ...
 */
var getGroupInvitations = (module.exports.getGroupInvitations = function(
  ctx,
  groupId,
  callback,
) {
  var validator = new Validator();
  validator
    .check(groupId, { code: 400, msg: 'A valid group id must be specified' })
    .isGroupId();
  if (validator.hasErrors()) {
    return callback(validator.getFirstError());
  }
 ...
 * @param  {Object}         callback.err    An error that occurred, if any
 */
var resendGroupInvitation = (module.exports.resendGroupInvitation = function(
  ctx,
  groupId,
  email,
  callback,
  ...
  OaeUtil.invokeIfNecessary(
    ...
    function(err, hasAccess, visibility) {
      ...
      PrincipalsMembersLibrary.list(
        ...
        function(err, memberEntries, nextToken) {
          if (err) {
            return callback(err);
          }
 ...
 * @param  {String}      callback.nextToken      The value to provide in the `start` parameter to get the next set of results
 */
var getMembershipsLibrary = (module.exports.getMembershipsLibrary = function(
  ctx,
  principalId,
  start,
  limit,
  ...
  PrincipalsDAO.getPrincipal(principalId, function(err, principal) {
    if (err) {
      ...
      return callback({
        code: 404,
        msg: util.format("Couldn't find principal: %s", principalId),
      });
    }
    ...
    LibraryAPI.Authz.resolveTargetLibraryAccess(
      ...
      function(err, hasAccess, visibility) {
        if (err) {
          ...
          return callback({
            code: 401,
            msg: 'You do not have access to this memberships library',
          });
        }
 ...
 * @api private
 */
var _getMembershipsLibrary = function(
  ctx,
  principalId,
  visibility,
  start,
 ...
 */
var getRecentGroupsForUserId = (module.exports.getRecentGroupsForUserId = function(
  ctx,
  principalId,
  limit,
  callback,
  ...
  if (!PrincipalsDAO.isUser(principalId)) {
    return callback({
      code: 400,
      msg: util.format("Couldn't find user: %s", principalId),
    });
  }
...
var _getRecentGroupsForUserId = function(ctx, principalId, limit, callback) {
  PrincipalsDAO.getVisitedGroups(principalId, function(err, items) {
    var sorted = _.sortBy(items, 'latestVisit')
      .reverse()
      .slice(0, 5);
 ...
 */
var setGroupMembers = (module.exports.setGroupMembers = function(
  ctx,
  groupId,
  changes,
  callback,
  ...
  var validator = new Validator();
  validator
    .check(groupId, { code: 400, msg: 'Invalid groupId specified' })
    .isGroupId();
  validator
    .check(null, {
      code: 401,
  ...
  PrincipalsDAO.getPrincipal(groupId, function(err, group) {
    ...
    ResourceActions.setRoles(ctx, group, changes, function(
      err,
      memberChangeInfo,
    ) {
      if (err) {
...
var leaveGroup = (module.exports.leaveGroup = function(ctx, groupId, callback) {
  ...
  PrincipalsDAO.getPrincipal(groupId, function(err, group) {
    if (err) {
      ...
      return callback({
        code: 404,
        msg: util.format('Group not found: %s', group.id),
      });
    }

    AuthzPermissions.canRemoveRole(ctx, ctx.user(), group, function(
      err,
      memberChangeInfo,
    ) {
      if (err) {
 ...
 */
var createGroup = (module.exports.createGroup = function(
  ctx,
  displayName,
  description,
  visibility,
  ...
  visibility =
    visibility || Config.getValue(tenantAlias, 'group', 'visibility');
  ...
  validator
    .check(visibility, {
      code: 400,
      msg:
        'The visibility setting must be one of: ' +
        _.values(AuthzConstants.visibility),
    })
  ...
  validator
    .check(joinable, {
      code: 400,
      msg:
        'The joinable setting must be one of: ' +
        _.values(AuthzConstants.joinable),
    })
 ...
 */
var updateGroup = (module.exports.updateGroup = function(
  ctx,
  groupId,
  profileFields,
  callback,
 ...
 * @param  {Object}     callback.err    An error that occured, if any
 */
var deleteGroup = (module.exports.deleteGroup = function(
  ctx,
  groupId,
  callback,
) {
 ...
 * @param  {Object}     callback.err    An error that occured, if any
 */
var restoreGroup = (module.exports.restoreGroup = function(
  ctx,
  groupId,
  callback,
) {
  ...
  canRestoreGroup(ctx, groupId, function(err, canRestore, group) {
    if (err) {
      ...
      return callback({
        code: 401,
        msg: 'You are not authorized to restore this group',
      });
    }
 ...
 */
var canRestoreGroup = (module.exports.canRestoreGroup = function(
  ctx,
  groupId,
  callback,
) {
 ...
 */
var canManageAny = (module.exports.canManageAny = function(
  ctx,
  principalIds,
  callback,
) {
