    ...
    if (!connection) {
        ...
        connection.on('close', function() {
            if (connectionError) {
                ...
                log().info('Closed connection to RabbitMQ. Reconnecting.');
...
var bind = module.exports.bind = function(name, listener, options, callback) {
    ...
    getOrCreateQueue(name, options.queue, function(queue) {
 ...
 * @param  {Object}     options         The queue options. Check PreviewConstants.DEFAULT_TASK_QUEUE_OPTS to see which options are available.
 * @param  {Function}   callback        Standard callback method.
 * @param  {Queue}      callback.queue  The created or retrieved queue.
 */
var getOrCreateQueue = module.exports.getOrCreateQueue = function(name, options, callback) {
