 ...
 */
var postInvitationAcceptActivity = (module.exports.postInvitationAcceptActivity = function(
  ctx,
  resource,
  inviterUser,
) {
  var millis = Date.now();
  var actorResource = new ActivityModel.ActivitySeedResource.fromResource(
    ctx.user(),
  );
  var objectResource = new ActivityModel.ActivitySeedResource.fromResource(
    inviterUser,
  );
  var targetResource = new ActivityModel.ActivitySeedResource.fromResource(
    resource,
  );
