...
describe('Collaborative documents', function() {
    ...
    it('verify different servers get selected depending on the content ID', function() {
        ...
        var hostA = Etherpad.getPadUrl('c:cam:abc123', 'userId', 'sesionId', 'padId', 'authorId', 'language');
        var hostB = Etherpad.getPadUrl('c:cam:abc1231', 'userId', 'sesionId', 'padId', 'authorId', 'language');
        ...
        for (var i = 0; i < total; i++) {
            ...
            var etherpadUrl = Etherpad.getPadUrl(id, 'userId', 'sesionId', 'padId', 'authorId', 'language');
