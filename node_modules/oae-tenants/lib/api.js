...
/**
 * Get all available tenants from cache. The global admin tenant will be excluded from the resulting tenant list
 *
...
var getTenants = module.exports.getTenants = function(excludeDisabled) {
    ...
    _.each(tenants, function(tenant, tenantAlias) {
        // Exclude the global admin tenant. Also exclude all disabled tenants when
...
var getTenantByHost = module.exports.getTenantByHost = function(tenantHost) {
    return tenantsByHost[tenantHost];
};
