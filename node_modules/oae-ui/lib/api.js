...
/**
 * Sorts an array of sections and the subsections in each section just like they appear in the less file.
...
var sortSections = function(sections) {
     ...
     *
     * @param  {Section}    sectionA    A section to compare.
     * @param  {Section}    sectionB    A section to compare.
     * @return {Integer}                An integer that expresses the relative order of the passed in 2 sections.
     */
    var comparator = function(sectionA, sectionB) {
        if (sectionA.index < sectionB.index) {
            return -1;
        } else if (sectionA.index > sectionB.index) {
            return 1;
        } else {
            return 0;
        }
