...
describe('Authz-Permissions', function() {
  ...
  describe('#hasRole()', function() {
    it('verify invalid principal id error', function(callback) {
      AuthzAPI.hasRole('not a id', 'c:cam:Foo.docx', 'member', function(
        err,
        hasRole,
      ) {
        assert.ok(err);
    ...
    it('verify non-principal member id error', function(callback) {
      AuthzAPI.hasRole('c:cam:mrvisser', 'c:cam:Foo.docx', 'member', function(
        err,
        hasRole,
      ) {
        assert.ok(err);
    ...
    it('verify null role error', function(callback) {
      AuthzAPI.hasRole('u:cam:mrvisser', 'c:cam:Foo.docx', null, function(
        err,
        hasRole,
      ) {
        assert.ok(err);
    ...
    it('verify undefined role error', function(callback) {
      AuthzAPI.hasRole('u:cam:mrvisser', 'c:cam:Foo.docx', undefined, function(
        err,
        hasRole,
      ) {
        assert.ok(err);
    ...
    it('verify false role error', function(callback) {
      AuthzAPI.hasRole('u:cam:mrvisser', 'c:cam:Foo.docx', false, function(
        err,
        hasRole,
      ) {
        assert.ok(err);
    ...
    it('verify invalid resource id error', function(callback) {
      AuthzAPI.hasRole('u:cam:mrvisser', 'not a id', 'member', function(
        err,
        hasRole,
      ) {
        assert.ok(err);
    ...
    it('verify direct single group permission', function(callback) {
      ...
      AuthzAPI.updateRoles(groupId, makeChange(userId, 'member'), function(
        ...
        AuthzAPI.updateRoles(
          ...
          function(err) {
            assert.ok(!err);
            AuthzAPI.hasRole(userId, resourceId, 'viewer', function(
              err,
              hasRole,
            ) {
              assert.ok(!err);
              ...
              AuthzAPI.updateRoles(
                ...
                function(err) {
                  ...
                  AuthzAPI.hasRole(userId, resourceId, 'viewer', function(
                    ...
                    assert.ok(!err);
                    assert.ok(hasRole);
                    AuthzAPI.hasRole(userId, resourceId, 'manager', function(
                      err,
                      hasRole,
                    ) {
                      assert.ok(!err);
    ...
    it('verify no direct multi group permission', function(callback) {
      ...
      AuthzAPI.updateRoles(resourceId, makeChange(groupId1, 'viewer'), function(
        err,
      ) {
        assert.ok(!err);
        AuthzAPI.updateRoles(
    ...
    it('verify multi group hierarchy permission', function(callback) {
      ...
      AuthzAPI.updateRoles(groupId1, makeChange(groupId2, 'member'), function(
        err,
      ) {
        assert.ok(!err);
        AuthzAPI.updateRoles(groupId2, makeChange(userId, 'member'), function(
  ...
  describe('#hasAnyRole()', function() {
    it('verify invalid principal id error', function(callback) {
      AuthzAPI.hasAnyRole('not a id', 'c:cam:Foo.docx', function(
        err,
        hasAnyRole,
      ) {
        assert.ok(err);
    ...
    it('verify non-principal id error', function(callback) {
      AuthzAPI.hasAnyRole('c:cam:mrvisser', 'c:cam:Foo.docx', function(
        err,
        hasAnyRole,
      ) {
        assert.ok(err);
    ...
    it('verify invalid resource id error', function(callback) {
      AuthzAPI.hasAnyRole('u:cam:mrvisser', 'not a id', function(
        err,
        hasAnyRole,
      ) {
        assert.ok(err);
    ...
    it('verify no direct single group permission', function(callback) {
      ...
      AuthzAPI.updateRoles(resourceId, makeChange(groupId, 'viewer'), function(
        err,
      ) {
        assert.ok(!err);
        AuthzAPI.hasAnyRole(userId, resourceId, function(err, hasAnyRole) {
