 ...
 */
var createFollowerAndFollowed = (module.exports.createFollowerAndFollowed = function(
  restCtx,
  callback,
) {
  TestsUtil.generateTestUsers(restCtx, 2, function(err, testUsers) {
    ...
    RestAPI.Following.follow(follower.restContext, following.user.id, function(
      err,
    ) {
      assert.ok(!err);
 ...
 * @param  {Function}       callback                            Standard callback function
 */
var followByAll = (module.exports.followByAll = function(
  followedUserId,
  followerUserInfos,
  callback,
) {
 ...
 * @param  {Function}       callback            Standard callback function
 */
var followAll = (module.exports.followAll = function(
  restContext,
  followedUserIds,
  callback,
) {
 ...
 */
var assertGetAllFollowersEquals = (module.exports.assertGetAllFollowersEquals = function(
  restCtx,
  userId,
  opts,
  expectedFollowerIds,
  ...
  assertGetAllFollowersSucceeds(restCtx, userId, opts, function(followers) {
    assert.deepEqual(
      _.pluck(followers, 'id').sort(),
      expectedFollowerIds.slice().sort(),
    );
 ...
 * @throws {AssertionError}                         Thrown if any assertions fail
 */
var assertGetAllFollowersSucceeds = (module.exports.assertGetAllFollowersSucceeds = function(
  restCtx,
  userId,
  opts,
  callback,
 ...
 * @throws {AssertionError}                         Thrown if any assertions fail
 */
var assertGetFollowersSucceeds = (module.exports.assertGetFollowersSucceeds = function(
  restCtx,
  userId,
  opts,
  callback,
 ...
 * @throws {AssertionError}                         Thrown if any assertions fail
 */
var assertGetAllFollowingEquals = (module.exports.assertGetAllFollowingEquals = function(
  restCtx,
  userId,
  opts,
  ...
  assertGetAllFollowingSucceeds(restCtx, userId, opts, function(following) {
    assert.deepEqual(
      _.pluck(following, 'id').sort(),
      expectedFollowingIds.slice().sort(),
    );
 ...
 * @throws {AssertionError}                         Thrown if any assertions fail
 */
var assertGetAllFollowingSucceeds = (module.exports.assertGetAllFollowingSucceeds = function(
  restCtx,
  userId,
  opts,
  callback,
 ...
 * @throws {AssertionError}                         Thrown if any assertions fail
 */
var assertGetFollowingSucceeds = (module.exports.assertGetFollowingSucceeds = function(
  restCtx,
  userId,
  opts,
  callback,
 ...
 * @param  {Function}       callback            Standard callback function
 */
var assertFollows = (module.exports.assertFollows = function(
  followerUserId,
  followerRestCtx,
  followedUserId,
  followedRestCtx,
 ...
 * @param  {Function}       callback            Standard callback function
 */
var assertDoesNotFollow = (module.exports.assertDoesNotFollow = function(
  followerUserId,
  followerRestCtx,
  followedUserId,
  followedRestCtx,
 ...
 */
var assertNoFollowFeedAccess = (module.exports.assertNoFollowFeedAccess = function(
  restCtx,
  userIds,
  httpCode,
  callback,
 ...
 * @param  {Function}       callback    Standard callback function
 */
var assertHasFollowFeedAccess = (module.exports.assertHasFollowFeedAccess = function(
  restCtx,
  userIds,
  callback,
) {
 ...
 * @param  {Function}       callback    Standard callback function
 */
var assertNoSearchFeedAccess = (module.exports.assertNoSearchFeedAccess = function(
  restCtx,
  userIds,
  httpCode,
  callback,
  ...
  var userId = userIds.shift();
  RestAPI.Search.search(restCtx, 'following', [userId], null, function(
    err,
    response,
  ) {
    assert.ok(err);
    ...
    RestAPI.Search.search(restCtx, 'followers', [userId], null, function(
      err,
      response,
    ) {
      assert.ok(err);
 ...
 * @param  {Function}       callback        Standard callback function
 */
var assertHasSearchFeedAccess = (module.exports.assertHasSearchFeedAccess = function(
  restCtx,
  userIds,
  callback,
) {
 ...
 */
var searchFollowerAndFollowing = (module.exports.searchFollowerAndFollowing = function(
  followerUserId,
  followerRestCtx,
  followedUserId,
  followedRestCtx,
  ...
  SearchTestUtil.searchAll(
    ...
    [followerUserId],
    null,
    function(err, followingResponse) {
      assert.ok(!err);
 ...
 * @api private
 */
var _findFollowerAndFollowing = function(
  followerUserId,
  followerRestCtx,
  followedUserId,
  followedRestCtx,
  ...
  assertGetAllFollowingSucceeds(followerRestCtx, followerUserId, null, function(
    following,
  ) {
