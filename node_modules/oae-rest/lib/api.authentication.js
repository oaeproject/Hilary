 ...
 *                                                     user credentials. For this function to work, the passed in restCtx should be an
 *                                                     anonymous REST context
 * @param {String}                 userId              User id for the user logging in. This should not be the globally unique userid (e.g. u:cam:nm417), 
 *                                                     but the login id a user would actually use (e.g. nm417)
 ...
 * @param {RestContext}            restCtx             Standard REST Context object that contains the current tenant URL and the current
 *                                                     user credentials. This is the user that will be logged out
 * @param {Function(err)}          callback            Standard callback method
 * @param {Object}                 callback.err        Error object containing error code and error message   
 */
