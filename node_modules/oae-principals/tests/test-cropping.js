...
describe('Profile pictures', function() {
     ...
     * the back-end URIs
     */
    it('verify that upload and crop response principals contain picture URLs and not back-end URIs', function(callback) {
        TestsUtil.generateTestUsers(camAdminRestContext, 1, function(err, users, mrvisser) {
            ...
            PrincipalsTestUtil.uploadAndCropPicture(mrvisser.restContext, mrvisser.user.id, _getPictureStream, {'x': 10, 'y': 10, 'width': 200}, function(uploadPrincipal, cropPrincipal) {
                ...
                // Ensure the principal from the upload picture response has only the large picture URL, and no other
                // URIs or URLs
                ...
                // Ensure the principal from the crop picture response has all the picture URLs, and none of the URIs
