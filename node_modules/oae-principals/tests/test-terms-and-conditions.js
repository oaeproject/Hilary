          ...
          enableAndSetTC(
            ...
            function() {
              enableAndSetTC(
                camAdminRestContext,
                'en_GB',
                'British English legalese',
                true,
                function() {
                  enableAndSetTC(
                    camAdminRestContext,
                    'en_CA',
                    'Canadian English legalese',
                    true,
                    function() {
  ...
  it('verify the Terms and Conditions are suppressed in the config', function(callback) {
    TestsUtil.generateTestUsers(camAdminRestContext, 1, function(err, users) {
      ...
      RestAPI.Config.getTenantConfig(anonymousCamRestContext, null, function(
        ...
        RestAPI.Config.getTenantConfig(mrvisser.restContext, null, function(
          err,
          config,
        ) {
          assert.ok(!err);
