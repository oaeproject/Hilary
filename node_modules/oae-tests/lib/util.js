...
var generateTestUsers = module.exports.generateTestUsers = function(restCtx, total, callback) {
    ...
    var userCreated = function(err, userObj) {
        ...
        createdUsers[userObj.id] = {
            'user': userObj,
            'restContext': new RestContext(restCtx.host, userObj.username, 'password')
        };
    ...
    for (var u = 0; u < total; u++) {
        RestAPI.User.createUser(createAdminRestContext(restCtx.host), generateTestUserId('random-user'), 'password', 'John Doe', null, userCreated);
    }
};
 ...
 *                                              tenant
 */
var createAnonymousRestContext = module.exports.createAnonymousRestContext = function(host) {
    return new RestContext(host, null, null);
};
 ...
 *                                              tenant
 */
var createAdminRestContext = module.exports.createAdminRestContext = function(host) {
    return new RestContext(host, 'administrator', 'administrator');
};
