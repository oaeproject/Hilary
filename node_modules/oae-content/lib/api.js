 ...
 * * `deletedContent(ctx, contentObj, members)`: A content item was deleted. The `ctx` and the `contentObj` of the deleted item are provided as well as the authz principals who had this content item in their library.
