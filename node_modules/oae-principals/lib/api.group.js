...
/**
 * Determine whether or not the user in the context is allowed to create the given group. If this
 * method completes without error, then the current user in context is able to create a group with
