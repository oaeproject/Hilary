...
describe('Collaborative documents', function() {
    ...
    /**
     * Test that verifies that publishing an unchanged document does not generate a new activity
     */
    ...
    it('verify empty revisions can be restored', function(callback) {
        TestsUtil.generateTestUsers(camAdminRestContext, 1, function(err, users, simon) {
            ...
            RestAPI.Content.createCollabDoc(simon.restContext, 'Test doc', 'description', 'private', [], [], function(err, contentObj) {
                assert.ok(!err);
                ...
                RestAPI.Content.publishCollabDoc(simon.restContext, contentObj.id, function(err) {
                    ...
                    editAndPublish(simon.restContext, contentObj, ['Some text'], function() {
