...
var SCOPES_ALL = [
  ...
  SearchConstants.general.SCOPE_INTERACT,
 ...
 */
var transformSearchResults = (module.exports.transformSearchResults = function(
  ctx,
  transformers,
  results,
  callback,
...
var createQuery = (module.exports.createQuery = function(query, filter, opts) {
  ...
  validator
    .check(null, new Error('createQuery expects a query object.'))
    .isObject(query);
  ...
  opts = {
    ...
    min_score: _.isNumber(opts.minScore)
      ? opts.minScore
      : SearchConstants.query.MINIMUM_SCORE,
  };
 ...
 */
var createFilteredQuery = (module.exports.createFilteredQuery = function(
  query,
  filter,
) {
  var filteredQuery = {
 ...
 */
var createBulkIndexOperations = (module.exports.createBulkIndexOperations = function(
  docs,
) {
  var cmds = [];
 ...
 */
var filterResources = (module.exports.filterResources = function(
  resourceTypes,
  deleted,
) {
  ...
  return filterAnd(
    ...
    !_.isEmpty(resourceTypes)
      ? filterTerms('resourceType', resourceTypes)
      : null,
 ...
 */
var filterInteractingTenants = (module.exports.filterInteractingTenants = function(
  tenantAlias,
) {
  if (TenantsUtil.isPrivate(tenantAlias)) {
    ...
    var nonInteractingTenantAliases = _.pluck(
      TenantsAPI.getNonInteractingTenants(),
      'alias',
    );
 ...
 */
var filterScopeAndAccess = (module.exports.filterScopeAndAccess = function(
  ctx,
  scope,
  ...
  var user = ctx.user();
  var interactingTenantAliasesFilter = filterInteractingTenants(tenant.alias);
  ...
  OaeUtil.invokeIfNecessary(
    ...
    ctx,
    function(err, explicitAccessFilter) {
      if (err) {
        return callback(err);
      } else if (
        user &&
        ...
        if (!user) {
          ...
          return callback({
            code: 401,
            msg:
              'Anonymous users are not authorized to interact with any resources',
          });
        }
 ...
 */
var filterImplicitAccess = (module.exports.filterImplicitAccess = function(
  ctx,
) {
  var user = ctx.user();
    ...
    filterLoggedIn = filterAnd(
      ...
      filterOr(
        ...
        filterAnd(
          ...
          filterTerms('joinable', [
            AuthzConstants.joinable.YES,
            AuthzConstants.joinable.REQUEST,
          ]),
        ),
      ),
    );
 ...
 */
var filterExplicitAccess = (module.exports.filterExplicitAccess = function(
  ctx,
  callback,
) {
  var user = ctx.user();
  ...
  AuthzAPI.getAllIndirectPrincipalMemberships(ctx.user().id, function(
    err,
    indirectGroupIds,
  ) {
    if (err) {
      ...
      createHasChildQuery(
        ...
        createFilteredQuery(
          ...
          filterOr(
            ...
            filterTerms(
              'direct_members',
              _.union([ctx.user().id], indirectGroupIds),
            ),
 ...
 */
var createQueryStringQuery = (module.exports.createQueryStringQuery = function(
  q,
  fields,
  boost,
) {
 ...
 * @return {Object}             A Query object that can be used in the query portion of the ElasticSearch Query DSL
 */
var createEmailQuery = (module.exports.createEmailQuery = function(email) {
 ...
 * @return {Object}                     A Query object that can be used in the query portion of the ElasticSearch Query DSL
 */
var createHasChildQuery = (module.exports.createHasChildQuery = function(
  type,
  childQuery,
  scoreType,
  boost,
 ...
 * @return {Object}                 A Query object that can be used in the query portion of the ElasticSearch Query DSL
 */
var createMoreLikeThisQuery = (module.exports.createMoreLikeThisQuery = function(
  val,
  fields,
) {
 ...
 */
var createChildSearchDocument = (module.exports.createChildSearchDocument = function(
  type,
  resourceId,
  fields,
) {
 ...
 */
var getChildSearchDocumentId = (module.exports.getChildSearchDocumentId = function(
  type,
  resourceId,
  childId,
) {
