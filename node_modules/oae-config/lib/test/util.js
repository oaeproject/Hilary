...
var updateEmitter = new EmitterAPI.EventEmitter();
 ...
 */
var updateConfigAndWait = (module.exports.updateConfigAndWait = function(
  restCtx,
  tenantAlias,
  configUpdate,
  callback,
) {
  RestAPI.Config.updateConfig(restCtx, tenantAlias, configUpdate, function(
    err,
  ) {
    if (err) {
      return callback(err);
 ...
 */
var clearConfigAndWait = (module.exports.clearConfigAndWait = function(
  restCtx,
  tenantAlias,
  configFields,
  callback,
