...
var ensureSchema = function(callback) {
    Cassandra.createColumnFamilies({
        ...
        'Comments': "CREATE COLUMNFAMILY Comments (contentId text PRIMARY KEY, commentId text);",
        'CommentsByCommentId': "CREATE COLUMNFAMILY CommentsByCommentId (commentId text PRIMARY KEY, commenter text, comment text, lastModified text);"
    }, callback);
};
