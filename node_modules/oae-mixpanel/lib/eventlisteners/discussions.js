...
module.exports = function(client) {
  ...
  MixpanelUtil.listen(
    ...
    function(ctx, principalId, visibility, start, limit, discussions) {
  ...
  MixpanelUtil.listen(
    ...
    function(ctx, discussion, memberChangeInfo) {
      var params = getBasicDiscussionParameters(ctx, discussion);
      params.id = discussion.id;
      params.visibility = discussion.visibility;
  ...
  MixpanelUtil.listen(
    ...
    function(ctx, newDiscussion, oldDiscussion) {
      ...
      params.updatedDisplayName =
        newDiscussion.displayName !== oldDiscussion.displayName;
      params.updatedDescription =
        newDiscussion.description !== oldDiscussion.description;
