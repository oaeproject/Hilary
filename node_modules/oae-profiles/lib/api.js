...
var _setSection = function(principal_id, profileSection, callback) {
    ...
    Cassandra.runQuery("UPDATE Profiles USING CONSISTENCY QUORUM SET ?=?, ?=? WHERE principal_id=?", [columnVisibilityName, profileSection.visibility, columnDataName, data, principal_id], callback);
};
