...
module.exports = {
    ...
    'google': {
        ...
        'elements': {
            ...
            'hostedDomain': new Fields.Text('Google hosted domain', 'Google hosted domain. e.g., Google apps domain (optional)', '', {'valueVisibility': 'private'})
        }
    },
    'twitter': {
    ...
    'cas': {
        ...
        'elements': {
            ...
            'basepath': new Fields.Text('Base path', 'The base path on the CAS authentication server. ex: /cas', '', {'valueVisibility': 'private'}),
            ...
            'logoutpath': new Fields.Text('Logout path', 'The path where the user should be redirected to when logging out.', '/logout', {'valueVisibility': 'private'}),
            ...
            'mapDisplayName': new Fields.Text('Display name', 'The attibute(s) that should be used to construct the displayname. ex: <%= first_name %> <%= last_name %>', '', {'valueVisibility': 'private'}),
            'mapEmail': new Fields.Text('Email', 'The attibute(s) that should be used to construct the email. ex: <%= mail %>', '', {'valueVisibility': 'private'}),
            'mapLocale': new Fields.Text('Locale', 'The attibute(s) that should be used to construct the locale. ex: <%= locale %>', '', {'valueVisibility': 'private'}),
            'mapTimezone': new Fields.Text('Timezone', 'The attibute(s) that should be used to construct the timezone. <%= timezone %>', '', {'valueVisibility': 'private'})
        }
    },
    'ldap': {
    ...
    'signed': {
        ...
        'elements': {
            'expires': new Fields.Text('Expires', 'Expresses how long a token is valid in milliseconds', '120000', {'valueVisibility': 'admin'})
        }
    }
};
