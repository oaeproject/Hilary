 ...
 */
var createAccessToken = (module.exports.createAccessToken = function(
  token,
  userId,
  clientId,
  callback,
 ...
 */
var getAccessToken = (module.exports.getAccessToken = function(
  token,
  callback,
) {
 ...
 * @param  {AccessToken}    callback.accessToken    The access token object which contains the user for which the token can be used
 */
var getAccessTokenForUserAndClient = (module.exports.getAccessTokenForUserAndClient = function(
  userId,
  clientId,
  callback,
) {
