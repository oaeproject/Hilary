 ...
 * @param {Stream}      stream          The file body that needs to be stored.
 * @param {Object}      headers         Some storage backends require extra headers or options. If possible you should pass in an object with the following keys: `Content-Type` holds the file mimetype, `Content-Length` the size of the file in bytes and `Content-Filename`, the original name of the file.
