                            ...
                            ActivityTestsUtil.assertFeedContainsActivity(stuart.restContext, stuart.user.id, FoldersConstants.activity.ACTIVITY_FOLDER_CREATE, ActivityConstants.verbs.CREATE, simong.user.id, folder.id, null, function() {
                                ActivityTestsUtil.assertFeedContainsActivity(groupMemberA.restContext, groupA.group.id, FoldersConstants.activity.ACTIVITY_FOLDER_CREATE, ActivityConstants.verbs.CREATE, simong.user.id, folder.id, null, function() {
                                    ...
                                    ActivityTestsUtil.assertFeedDoesNotContainActivity(stephen.restContext, stephen.user.id, FoldersConstants.activity.ACTIVITY_FOLDER_CREATE, function() {
                                        ActivityTestsUtil.assertFeedDoesNotContainActivity(groupMemberB.restContext, groupB.group.id, FoldersConstants.activity.ACTIVITY_FOLDER_CREATE, function() {
                    ...
                    FoldersTestUtil.assertCreateFolderSucceeds(simong.restContext, 'test displayName', 'test description', 'public', [nicosGroup1, bertsGroup, stuart], [], function(folder1) {
                        FoldersTestUtil.assertCreateFolderSucceeds(simong.restContext, 'test displayName', 'test description', 'public', [nicosGroup2], [], function(folder2) {
                            ...
                            RestAPI.Content.createLink(simong.restContext, 'test', 'test', 'public', 'http://www.google.ca', null, null, [folder1.id, folder2.id], function(err, link) {
                                ...
                                ActivityTestsUtil.assertFeedContainsActivity(simong.restContext, simong.user.id, 'content-create', ActivityConstants.verbs.CREATE, simong.user.id, link.id, [folder1.id, folder2.id], function() {

                                    // Nico sees both folders in his personal stream and each one
                                    // distinctly in his two groups
                                    ActivityTestsUtil.assertFeedContainsActivity(nico.restContext, nico.user.id, 'content-create', ActivityConstants.verbs.CREATE, simong.user.id, link.id, [folder1.id, folder2.id], function() {
                                        ActivityTestsUtil.assertFeedContainsActivity(nico.restContext, nicosGroup1.group.id, 'content-create', ActivityConstants.verbs.CREATE, simong.user.id, link.id, folder1.id, function() {
                                            ActivityTestsUtil.assertFeedContainsActivity(nico.restContext, nicosGroup2.group.id, 'content-create', ActivityConstants.verbs.CREATE, simong.user.id, link.id, folder2.id, function() {

                                                // Bert only sees folder1 in his personal stream and in his group's stream
                                                ActivityTestsUtil.assertFeedContainsActivity(bert.restContext, bert.user.id, 'content-create', ActivityConstants.verbs.CREATE, simong.user.id, link.id, folder1.id, function() {
                                                    ActivityTestsUtil.assertFeedContainsActivity(bert.restContext, bertsGroup.group.id, 'content-create', ActivityConstants.verbs.CREATE, simong.user.id, link.id, folder1.id, function() {

                                                        // Stuart only sees the first folder
                                                        ActivityTestsUtil.assertFeedContainsActivity(stuart.restContext, stuart.user.id, 'content-create', ActivityConstants.verbs.CREATE, simong.user.id, link.id, folder1.id, function() {
                                                            return callback();
                                                        });
                                                    });
                                                });
