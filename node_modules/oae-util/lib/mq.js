...
OAE.on('ready', function() {
    ...
    _.each(deferredTaskHandlers, function(handlerInfo, taskId) {
        bind(handlerInfo.name, handlerInfo.listener);
        delete deferredTaskHandlers[taskId];
    });
});
...
var bind = module.exports.bind = function(name, listener, callback) {
    ...
    if (!ready) {
        ...
        deferredTaskHandlers[name] = {'name': name, 'listener': listener};
        return callback();
    }
