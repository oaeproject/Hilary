...
var ensureSchema = function(callback) {
    Cassandra.createColumnFamilies({
        ...
        // Invitations schema
        'AuthzInvitations': 'CREATE TABLE "AuthzInvitations" ("resourceId" text, "email" text, "inviterUserId" text, "role" text, PRIMARY KEY ("resourceId", "email"))',
        'AuthzInvitationsResourceIdByEmail': 'CREATE TABLE "AuthzInvitationsResourceIdByEmail" ("email" text, "resourceId" text, PRIMARY KEY ("email", "resourceId"))',
