...
describe('Content', function() {
    ...
    describe('Content comments', function() {
         ...
         *
         * @param    {RestContext[]}   contexts       Array of REST Contexts
                                            ...
                                            RestAPI.Content.createReply(contexts['bert'].restContext, contentObj.contentId, comments.results[1].commentId, 'This is a reply on the reply on a comment that will be deleted.', function(err) {
                                                ...
                                                RestAPI.Content.deleteComment(contexts['bert'].restContext, contentObj.contentId, comments.results[1].commentId, function(err) {
                                                    ...
                                                    RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, null, 10, function(err, comments) {
                                                        ...
                                                        assert.equal(comments.results[1].level, undefined);
                ...
                var checkAccess = function(linkContext, commentContext, deleteContext, visibility, managers, members, _callback) {
                    RestAPI.Content.createLink(linkContext, 'Test Content', 'Test content description', visibility, 'http://www.sakaiproject.org/', [], members, function(err, contentObj) {
                        ...
                        RestAPI.Content.createComment(commentContext, contentObj.contentId, 'Comment to check access', function(err) {
                            ...
                            RestAPI.Content.getComments(linkContext, contentObj.contentId, null, 10, function(err, comments) {
                                assert.ok(!err);
