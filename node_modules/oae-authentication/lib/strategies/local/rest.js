 ...
 * @Method      POST
 * @Path        /auth/login
 * @FormParam   {string}        password        Password for local user
 * @FormParam   {string}        username        Username for local user
 * @Return      {User}                          User object if login successful
 */
 ...
 * @FormParam   {string}        newPassword         New password for user
 * @FormParam   {string}        [oldPassword]       Previous password, required if user is not an administrator
 */
 ...
 * @PathParam   {string}        tenantAlias         Tenant identifier
 * @FormParam   {string}        username            User name to check
 * @Return      {void}                              HTTP status code of 200 or 404
 */
