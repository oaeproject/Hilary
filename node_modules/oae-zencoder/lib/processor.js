...
var generatePreviews = module.exports.generatePreviews = function(ctx, content, callback) {
    ...
    var downloadPath = ContentUtil.getSignedDownloadUrl(ctx, content);
    var tenantAlias = content.tenant.alias;

    // Create a media item
    ZencoderUtil.job(tenantAlias, downloadPath, content.id, revision.id, _isVideo(mimeType), function(err, res, body) {
