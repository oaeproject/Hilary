 ...
 * @param  {Boolean}    [opts.deleted]              Whether or not the tenant is deleted. Default: `false`
 * @param  {Boolean}    [opts.isGlobalAdminServer]  Whether or not the tenant is the global admin tenant. Default: `false`
 */
var Tenant = module.exports.Tenant = function(alias, displayName, host, opts) {
    opts = opts || {};
    ...
    that.deleted = (opts.deleted === true);
 ...
 */
var TenantNetwork = module.exports.TenantNetwork = function(id, displayName) {
    var that = {};
