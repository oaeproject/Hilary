 ...
 */
var getServiceProviderUrl = (module.exports.getServiceProviderUrl = function(
  ctx,
) {
 ...
 */
var validateInitiateParameters = (module.exports.validateInitiateParameters = function(
  tenantAlias,
  signature,
  expires,
  callback,
  ...
  validator
    .check(signature, { code: 400, msg: 'Missing signature parameter' })
    .notEmpty(signature);
  validator
    .check(expires, { code: 400, msg: 'Missing expires parameter' })
    .notEmpty(expires);
  validator
    .check(expires, { code: 400, msg: 'Invalid expires parameter' })
    .isNumeric();
  validator
    .check(expires, { code: 400, msg: 'Invalid expires parameter' })
    .min(Date.now());
  ...
  if (!isValid) {
    return callback({
      code: 401,
      msg: 'Invalid or missing signature parameters',
    });
  }
 ...
 * @param  {Tenant}     callback.tenant     The full tenant object for the given tenant alias
 */
var getShibbolethEnabledTenant = (module.exports.getShibbolethEnabledTenant = function(
  tenantAlias,
  callback,
) {
  ...
  if (!isEnabled(tenant.alias)) {
    return callback({
      code: 400,
      msg: 'Shibboleth is not enabled for this tenant',
    });
  }
 ...
 */
var getAuthenticatedUserRedirectUrl = (module.exports.getAuthenticatedUserRedirectUrl = function(
  tenant,
  user,
) {
 ...
 */
var getUser = (module.exports.getUser = function(
  tenant,
  userId,
  signature,
  expires,
  ...
  var validator = new Validator();
  validator
    .check(userId, { code: 400, msg: 'Missing user id parameter' })
    .notEmpty(userId);
  validator
    .check(signature, { code: 400, msg: 'Missing signature parameter' })
    .notEmpty(signature);
