    ...
    describe('Modules', function() {
        it('Test getting all available modules succeeds', function(callback) {
            request.get({
                ...
                assert.ok(body['oae-authentication'].title);
                callback();
            });
        });
    });
        ...
        it('Test global configuration value overrides config.json value', function(callback) {
            request.get({
                ...
                for (module in modules) {
                    if (module === 'oae-authentication') {
                        if (modules[module]['twitter-authentication']) {
                            for (var el in modules[module]['twitter-authentication'].elements) {
                                if (modules[module]['twitter-authentication'].elements[el].id === 'twitter-authentication-enabled') {
                                    if (modules[module]['twitter-authentication'].elements[el].defaultValue === false) {
                                        val = modules[module]['twitter-authentication'].elements[el].defaultValue;
                                    }
                                }
                            }
                        }
                ...
                for (module in modules) {
                    if (module === 'oae-authentication') {
                        if (modules[module]['twitter-authentication']) {
                            for (var el in modules[module]['twitter-authentication'].elements) {
                                if (modules[module]['twitter-authentication'].elements[el].id === 'twitter-authentication-enabled') {
                                    if (modules[module]['twitter-authentication'].elements[el].defaultValue === true) {
                                        val = modules[module]['twitter-authentication'].elements[el].defaultValue;
                                    }
                                }
                            }
