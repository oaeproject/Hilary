        ...
        <table cellspacing="10" cellpadding="0">
            <tbody>
                ...
                <tr class="row content">
                    <td>
                        <p>__MSG__EMAIL_VERIFY_BODY_EXPLANATION__</p>
                        <%
                            var url = baseUrl + '/email-verification?token=' + util.url.encode(token);
                            url += '&email=' + util.url.encode(user.email);
                        %>
                        <p><a href="<%= url %>">__MSG__EMAIL_VERIFY_LINK__</a></p>
                    </td>
                </tr>
