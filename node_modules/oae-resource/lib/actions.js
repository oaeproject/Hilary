 ...
 * @param  {Object}     roles                       The roles, keyed by memberId (principal id or email address), whose value is the role they should have
 * @param  {Function}   callback                    Standard callback function
 * @param  {Object}     callback.err                An error that occurred, if any
 * @param  {Object}     callback.createFnResult     The result(s) of the create function (e.g., the created resource). If the create function returned multiple results (e.g., a content item and a revision), then there are 2 parameters
 */
