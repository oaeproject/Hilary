 ...
 */
const getTimezoneFromRails = module.exports.getTimezoneFromRails = function(zone) {
 ...
 */
const getClosestSupportedTimezone = module.exports.getClosestSupportedTimezone = function(zone) {
    ...
    try {
        ...
        const availableOffsets = _.keys(railsOffsets);
...
var _getMostSimilarZone = function(orig, candidates) {
    ...
    _.each(candidates, (candidate, index) => {
 ...
 */
const getZones = module.exports.getZones = function() {
    const railsZones = {};
    _.each(RailsMappings, (value, key) => {
        const mappingDate = new tz.Date(value);
        railsZones[value] = {
