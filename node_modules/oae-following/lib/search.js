 ...
 * @api private
 */
var _produceResourceFollowersDocuments = function(
  resources,
  callback,
  _documents,
  _errs,
  ...
  _getAllIds(FollowingDAO.getFollowers, resource.id, null, 100, function(
    err,
    followerUserIds,
  ) {
    if (err) {
      _errs = _.union(_errs, [err]);
      return _produceResourceFollowersDocuments(
        resources,
        callback,
        _documents,
        _errs,
 ...
 * @api private
 */
var _produceResourceFollowingDocuments = function(
  resources,
  callback,
  _documents,
  _errs,
  ...
  // Get all of the followers ids for the next resource in the list
  var resource = resources.pop();
  _getAllIds(FollowingDAO.getFollowing, resource.id, null, 100, function(
    err,
    followingUserIds,
  ) {
    if (err) {
 ...
 */
FollowingAPI.on(FollowingConstants.events.FOLLOW, function(
  ctx,
  followingUser,
  followedUser,
) {
 ...
 */
FollowingAPI.on(FollowingConstants.events.UNFOLLOW, function(
  ctx,
  followingUser,
  unfollowedUserId,
) {
