 ...
 */
var createTenant = module.exports.createTenant = function(restCtx, alias, displayName, host, opts, callback) {
    opts = opts || {};
    var params = {
        'alias': alias,
 ...
 */
var getLandingPage = module.exports.getLandingPage = function(restCtx, callback) {
    RestUtil.RestRequest(restCtx, '/api/tenant/landingPage', 'GET', null, callback);
};
