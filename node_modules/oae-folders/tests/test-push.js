    ...
    it('verify visibility updates trigger a push notification', function(callback) {
      setupFixture(function(contexts, folder, client) {
        ...
        client.on('message', function(message) {
          ...
          assert.equal(
            message.activities[0].object['oae:visibility'],
            'loggedin',
          );
      ...
      setupFixture(function(contexts, folder, client) {
        ...
        client.on('message', function(message) {
          if (!seenFirstComment) {
            ...
            assert.strictEqual(
              message.activities[0].object.body,
              initialComment.body,
            );
            assert.strictEqual(
              message.activities[0].object.created,
            ...
            assert.strictEqual(
              message.activities[0].object.replyTo,
              initialComment.created,
            );
            client.close(callback);
          }
