...
module.exports = function(app, callback) {
    ensureSchema(function() {
        ConfigAPI.initializeConfig(callback);
    });
...
var registerConfigAdminRestEndpoints = function(app) {
    ...
    app.server.get('/api/config/:tenantId', function(req, res, next) {
    ...
    app.server.post('/api/config/:tenantId', function(req, res, next) {
