...
describe('Authentication', function() {
  ...
  describe('Local authentication', function() {
    ...
    it('verify local authentication', function(callback) {
      ...
      TestsUtil.generateTestUsers(camAdminRestContext, 1, function(
        ...
        RestAPI.Authentication.logout(user.restContext, function(
          err,
          body,
          response,
        ) {
                ...
                function(err) {
                  ...
                  RestAPI.Authentication.login(
                    ...
                    function(err) {
                      ...
                      RestAPI.User.getMe(user.restContext, function(
                        err,
                        meObj,
                      ) {
                        assert.ok(!err);
    ...
    it('verify tenant login separation', function(callback) {
      ...
      TestsUtil.generateTestUsers(camAdminRestContext, 1, function(
        ...
        var anonymousGtRestContext = TestsUtil.createTenantRestContext(
          global.oaeTests.tenants.gt.host,
        );
        RestAPI.Authentication.login(
          ...
          function(err) {
            ...
            var anonymousCamRestContext = TestsUtil.createTenantRestContext(
              global.oaeTests.tenants.cam.host,
            );
            RestAPI.Authentication.login(
              anonymousCamRestContext,
    ...
    it('verify disable local authentication', function(callback) {
      ...
      TestsUtil.generateTestUsers(camAdminRestContext, 1, function(
        ...
        RestAPI.User.getMe(jack.restContext, function(err, me) {
          ...
          RestAPI.Authentication.logout(jack.restContext, function(
            err,
            body,
            response,
          ) {
    ...
    it('verify you need to be logged in to be able to log out', function(callback) {
      RestAPI.Authentication.logout(anonymousCamRestContext, function(
        err,
        body,
        response,
      ) {
  ...
  describe('Admin login', function() {
    ...
    it('verify global administrator authentication', function(callback) {
      ...
      RestAPI.User.getMe(globalAdminRestContext, function(err, meObj) {
        ...
        // Logout
        RestAPI.Authentication.logout(globalAdminRestContext, function(
          err,
          body,
          response,
        ) {
  ...
  describe('Login id exists', function() {
    ...
    it('verify username exists', function(callback) {
      ...
      RestAPI.Authentication.exists(anonymousCamRestContext, username, function(
        err,
      ) {
        assert.ok(err);
    ...
    it('verify login id exists validation', function(callback) {
      ...
      RestAPI.Authentication.exists(anonymousCamRestContext, null, function(
        err,
      ) {
        assert.ok(err);

        // Verify that the existence cannot be checked when an empty string username is provided
        RestAPI.Authentication.exists(anonymousCamRestContext, '', function(
          err,
        ) {
          assert.ok(err);
          return callback();
  ...
  describe('#getOrCreateUser', function() {
    ...
    it('verify getOrCreateUser', function(callback) {
      ...
      AuthenticationAPI.getOrCreateUser(
        ...
        'Nicolaas Matthijs',
        { email: email },
        function(err, userObj, loginId, created) {
          assert.ok(!err);
          assert.ok(userObj);
  ...
  describe('#createUser', function() {
    ...
    it('verify create without provider', function(callback) {
      ...
      var loginId = new LoginId(ctx.tenant().alias, undefined, username, {
        password: 'password',
      });
      AuthenticationAPI.createUser(
        ctx,
    ...
    it('verify create user with non-local loginId', function(callback) {
      ...
      var userRestContext = new RestContext(
        global.oaeTests.tenants.cam.baseUrl,
        {
          username: username,
        ...
        function(err, userObj) {
          ...
          AuthenticationAPI.createUser(
            ...
            function(err) {
              ...
              RestAPI.User.getUser(globalAdminRestContext, userObj.id, function(
                err,
                userObj,
              ) {
                assert.ok(!err);
    ...
    it('verify tenant administrator profile parameters', function(callback) {
      ...
      RestAPI.User.createTenantAdminUserOnTenant(
        ...
        function(err, user) {
          ...
          RestAPI.User.getUser(globalAdminRestContext, user.id, function(
            err,
            user,
          ) {
            assert.ok(!err);
            ...
            RestAPI.User.createTenantAdminUser(
              ...
              function(err, user) {
                ...
                RestAPI.User.getUser(camAdminRestContext, user.id, function(
                  err,
                  user,
                ) {
                  assert.ok(!err);
                ...
                function(err, user) {
                  ...
                  RestAPI.Authentication.login(
                    ...
                    function(err) {
                      ...
                      RestAPI.User.getMe(testGlobalUserRestContext, function(
                        err,
                        me,
                      ) {
                        assert.ok(!err);
        ...
        function(err, user) {
          ...
          RestAPI.Authentication.login(
            ...
            function(err) {
              ...
              RestAPI.User.getMe(createdGlobalAdminRestContext, function(
                err,
                me,
              ) {
                assert.ok(!err);
  ...
  describe('#associateLoginId', function() {
    ...
    it('verify associate without tenant', function(callback) {
      TestsUtil.generateTestUsers(camAdminRestContext, 1, function(
        ...
        AuthenticationAPI.associateLoginId(ctx, loginId, user.user.id, function(
          err,
        ) {
          assert.ok(err);
          assert.equal(err.code, 400);
    ...
    it('verify associate without provider', function(callback) {
      TestsUtil.generateTestUsers(camAdminRestContext, 1, function(
        ...
        var ctx = new Context(global.oaeTests.tenants.cam, user.user);
        var loginId = new LoginId(ctx.tenant().alias, undefined, user.user.id, {
          password: 'password',
        });
        AuthenticationAPI.associateLoginId(ctx, loginId, user.id, function(
          err,
        ) {
          assert.ok(err);
          assert.equal(err.code, 400);
    ...
    it('verify associate without user id', function(callback) {
      ...
      PrincipalsAPI.createUser(
        ...
        function(err, user) {
          ...
          AuthenticationAPI.associateLoginId(ctx, loginId, undefined, function(
            err,
          ) {
            assert.ok(err);
            assert.equal(err.code, 400);
    ...
    it('verify admin re-associate login id', function(callback) {
      var adminCtx = TestsUtil.createTenantAdminContext(
        global.oaeTests.tenants.cam,
      );
      var mrvisserUsername = TestsUtil.generateTestUserId() + ':withcolon';
      var mrvisserLoginId = new LoginId(
        global.oaeTests.tenants.cam.alias,
        AuthenticationConstants.providers.TWITTER,
        mrvisserUsername,
      );
  ...
  describe('Password reset', function() {
     ...
     */
    it('verify that when a user requests a password reset, a secret is generated and can be used to set the new password', function(callback) {
      // Create a test user
      TestsUtil.generateTestUsers(camAdminRestContext, 1, function(
        err,
        users,
        ...
        assert.ok(!err);
        var userRestContext = user.restContext;
        var username = userRestContext.username;
        // Log the user out first
        RestAPI.Authentication.logout(userRestContext, function(
          err,
          body,
          response,
        ) {
