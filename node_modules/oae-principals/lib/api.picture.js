...
var _saveUrisToCassandra = function(ctx, principal, smallPictureUri, mediumPictureUri, callback) {
    ...
    Cassandra.runQuery(q.query, q.parameters, function(err) {
        ...
        principal.smallPicture = PrincipalsUtil.getSignedPictureUrl(ctx, ctx.tenant().alias, smallPictureUri);
        principal.mediumPicture = PrincipalsUtil.getSignedPictureUrl(ctx, ctx.tenant().alias, mediumPictureUri);
