...
describe('Content', function() {
    ...
    describe('Tenant separation', function() {
        ...
        it('verify user can access public content from external tenant', function(callback) {
            ...
            RestAPI.User.createUser(anonymousRestContext, usernameA, 'password', 'Public User', null, function(err, userA) {
                assert.ok(!err);
                var restCtxA = TestsUtil.createTenantRestContext(global.oaeTests.tenants.cam.host, usernameA, 'password');

                // Create tenant B
                RestAPI.Tenant.createTenant(globalAdminRestContext, tenantAliasB, tenantAliasB, tenantAliasB, function(err, tenantB) {
                    assert.ok(!err);
                    var restCtxB = TestsUtil.createTenantRestContext(tenantAliasB);
                    var usernameB = TestsUtil.generateTestUserId();

                    // Create user for tenant B
                    RestAPI.User.createUser(restCtxB, usernameB, 'password', 'Private User', null, function(err, userB) {
                        assert.ok(!err);
                        restCtxB = TestsUtil.createTenantRestContext(tenantAliasB, usernameB, 'password');
        ...
        it('verify user sees only public libraries of external tenant users', function(callback) {
            ...
            RestAPI.User.createUser(anonymousRestContext, usernameA, 'password', 'Public User', null, function(err, userA) {
                ...
                RestAPI.User.createUser(anonymousRestContext, usernameA2, 'password', 'Public User A2', null, function(err, userA2) {
                    assert.ok(!err);
                            ...
                            RestAPI.Content.createLink(restCtxA, 'Yahoo', 'Yahoo Website', 'public', 'http://www.yahoo.ca', [ userA.id ], [ groupA.id ], function(err, publicContentA) {
                                ...
                                RestAPI.Content.createLink(restCtxA, 'Google', 'Google Website', 'loggedin', 'http://google.com', [ userA.id ], [ groupA.id ], function(err, loggedInContentA) {
                                    ...
                                    RestAPI.Content.getLibrary(restCtxA, groupA.id, null, 10, function(err, libraryA) {
                                        ...
                                        // Verify user B cannot see the loggedin content item, but can see the public content item
                                        RestAPI.Content.getLibrary(restCtxB, groupA.id, null, 10, function(err, libraryA) {
                                            assert.ok(!err);
                                            assert.equal(libraryA.results.length, 1);
                                            assert.equal(libraryA.results[0].contentId, publicContentA.contentId);
                                            callback();
    ...
    describe('Content comments', function() {
        ...
        var createComments = function(contexts, contentId, numComments, replyTo, callback) {
             ...
             */
            var commentCreated = function(err) {
                assert.ok(!err);
                if (done !== numComments) {
                    done++;
                    createComment();
                ...
                RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 1', 'Test content description 1', 'public', 'http://www.sakaiproject.org/',  [], [], function(err, contentObj) {
                    ...
                    RestAPI.Content.getContent(contexts['bert'].restContext, contentObj.contentId, function(err, retrievedContentObj) {
                        ...
                        createComments(contexts, contentObj.contentId, 10, null, function() {
                            ...
                            RestAPI.Content.createComment(contexts['bert'].restContext, contentObj.contentId, 'This comment should be on top of the list', null, function(err) {
            ...
            setUpUsers(function(contexts) {
                ...
                RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 1', 'Test content description 1', 'public', 'http://www.sakaiproject.org/',  [], [], function(err, contentObj) {
                    ...
                    RestAPI.Content.getContent(contexts['bert'].restContext, contentObj.contentId, function(err, retrievedContentObj) {
                        ...
                        RestAPI.Content.createComment(contexts['bert'].restContext, contentObj.contentId, 'This comment should be second in the list', null, function(err) {
                            assert.ok(!err);
                            ...
                            RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, null, 10, function(err, comments) {
                                ...
                                RestAPI.Content.createComment(contexts['bert'].restContext, contentObj.contentId, 'Reply to second comment in the list', comments.results[0].commentId, function(err) {
                                    assert.ok(!err);
                                    ...
                                    RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, null, 10, function(err, comments) {
                                        ...
                                        RestAPI.Content.createComment(contexts['bert'].restContext, contentObj.contentId, 'A reply to the reply on the second comment in the list', comments.results[1].commentId, function(err) {
                                            assert.ok(!err);

                                            // Add a second comment to the content item
                                            RestAPI.Content.createComment(contexts['bert'].restContext, contentObj.contentId, 'This comment should be first in the list', null, function(err) {
                                                assert.ok(!err);
                                                ...
                                                RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, null, 10, function(err, comments) {
                                                    ...
                                                    RestAPI.Content.createComment(contexts['bert'].restContext, null, 'This is an updated comment', '1231654351', function(err) {
                                                        assert.ok(err);
            ...
            setUpUsers(function(contexts) {
                ...
                RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 1', 'Test content description 1', 'public', 'http://www.sakaiproject.org/',  [], [], function(err, contentObj) {
                    ...
                    RestAPI.Content.getContent(contexts['bert'].restContext, contentObj.contentId, function(err, retrievedContentObj) {
                        ...
                        // Create a comment
                        RestAPI.Content.createComment(contexts['bert'].restContext, contentObj.contentId, 'This comment will be deleted.', null, function(err) {
                            assert.ok(!err);
                            ...
                            RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, null, 10, function(err, comments) {
                                ...
                                RestAPI.Content.createComment(contexts['bert'].restContext, contentObj.contentId, 'This is a reply on the comment that will be deleted.', comments.results[0].commentId, function(err) {
                                    assert.ok(!err);

                                    // Delete the comment
                                    RestAPI.Content.deleteComment(contexts['bert'].restContext, contentObj.contentId, comments.results[0].commentId, function(err) {
                                        assert.ok(!err);
                                        ...
                                        RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, null, 10, function(err, comments) {
                                            ...
                                            RestAPI.Content.createComment(contexts['bert'].restContext, contentObj.contentId, 'This is a reply on the reply on a comment that will be deleted.', comments.results[1].commentId, function(err) {
                                                assert.ok(!err);

                                                // Delete reply on comment
                                                RestAPI.Content.deleteComment(contexts['bert'].restContext, contentObj.contentId, comments.results[1].commentId, function(err) {
                                                    assert.ok(!err);
                                                    ...
                                                    RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, null, 10, function(err, comments) {
                                                        ...
                                                        assert.equal(comments.results[1].created, undefined);
                                                        assert.equal(comments.results[1].body, undefined);

                                                        // Delete reply on reply
                                                        RestAPI.Content.deleteComment(contexts['bert'].restContext, contentObj.contentId, comments.results[2].commentId, function(err) {
                                                            assert.ok(!err);
            ...
            setUpUsers(function(contexts) {
                ...
                RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 1', 'Test content description 1', 'public', 'http://www.sakaiproject.org/',  [], [], function(err, publicContentObj) {
                    ...
                    RestAPI.Content.createLink(contexts['nicolaas'].restContext, 'Test Content 2', 'Test content description 2', 'private', 'http://www.sakaiproject.org/',  [], [contexts['bert'].user.id], function(err, privateContentObj) {
                        ...
                        RestAPI.Content.createComment(contexts['bert'].restContext, privateContentObj.contentId, 'This is a first comment.', null, function(err) {
                            assert.ok(!err);
                            RestAPI.Content.createComment(contexts['bert'].restContext, privateContentObj.contentId, 'This is a second comment.', null, function(err) {
                                assert.ok(!err);
                                ...
                                RestAPI.Content.getComments(contexts['bert'].restContext, privateContentObj.contentId, null, 10, function(err, comments) {
                                    ...
                                    RestAPI.Content.deleteComment(contexts['bert'].restContext, privateContentObj.contentId, comment2, function(err) {
                                        assert.ok(!err);
                                        ...
                                        RestAPI.Content.getComments(contexts['bert'].restContext, privateContentObj.contentId, null, 10, function(err, comments) {
                                            ...
                                            RestAPI.Content.updateMembers(contexts['nicolaas'].restContext, privateContentObj.contentId, permissions, function(err) {
                                                ...
                                                RestAPI.Content.deleteComment(contexts['bert'].restContext, publicContentObj.contentId, comment1, function(err) {
                                                    assert.ok(err);
                                                    ...
                                                    RestAPI.Content.getComments(contexts['nicolaas'].restContext, privateContentObj.contentId, null, 10, function(err, comments) {
                                                        ...
                                                        RestAPI.Content.createComment(contexts['bert'].restContext, publicContentObj.contentId, 'This reply on the comment shouldn\'t be accepted', comment1, function(err) {
                                                            assert.ok(err);
                                                            assert.ok(err.code, 400);
        ...
        it('verify delete comment validation', function(callback) {
            setUpUsers(function(contexts) {
                ...
                RestAPI.Content.createLink(contexts['nicolaas'].restContext, 'Test Content 1', 'Test content description 1', 'public', 'http://www.sakaiproject.org/',  [], [], function(err, contentObj) {
                    ...
                    RestAPI.Content.createComment(contexts['bert'].restContext, contentObj.contentId, 'This is a comment.', null, function(err) {
                        assert.ok(!err);
                        ...
                        RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, null, 10, function(err, comments) {
                            ...
                            RestAPI.Content.deleteComment(contexts['bert'].restContext, contentObj.contentId, null, function(err) {
                                assert.ok(err);
                                assert.ok(err.code, 400);

                                // Try to delete a comment without specifying the contentId
                                RestAPI.Content.deleteComment(contexts['bert'].restContext, null, commentId, function(err) {
                                    assert.ok(err);
                                    assert.ok(err.code, 400);
        ...
        var testDeleteCommentPermissions = function(contexts, visibility, expectedDelete, callback) {
            ...
            var _canDelete = function(linkContext, commentContext, deleteContext, visibility, managers, members, expectedDelete, callback) {
                RestAPI.Content.createLink(linkContext.restContext, 'Test Content', 'Test content description', visibility, 'http://www.sakaiproject.org/', [], members, function(err, contentObj) {
                    ...
                    RestAPI.Content.createComment(commentContext.restContext, contentObj.contentId, 'Comment to check access', null, function(err) {
                        if (expectedDelete) {
                            assert.ok(!err);
                        } else {
                            assert.ok(err);
                        ...
                        RestAPI.Content.getComments(linkContext.restContext, contentObj.contentId, null, 10, function(err, comments) {
                            ...
                            RestAPI.Content.deleteComment(deleteContext.restContext || deleteContext, contentObj.contentId, comments.results[0].commentId, function(err) {
                                callback(err);
                            });
                        });
                    });
            ...
            _canDelete(bert, bert, bert, visibility, [], [], true, function(err) {
                ...
                _canDelete(bert, simon, bert, visibility, [], [contexts['simon'].user.id], true, function(err) {
                    assert.ok(!err);
                    // Delete own comment as member on piece of content (--> success)
                    _canDelete(bert, simon, simon, visibility, [], [contexts['simon'].user.id], true, function(err) {
                        assert.ok(!err);
                        // Delete other's comment as member on piece of content (--> fail)
                        _canDelete(bert, bert, simon, visibility, [], [contexts['simon'].user.id], true, function(err) {
                            assert.ok(err);
                            // Delete own comment as logged in on piece of content (--> success)
                            _canDelete(bert, simon, simon, visibility, [], [], expectedDelete, function(err) {
                                if (expectedDelete) {
                                    assert.ok(!err);
                                } else {
                                    assert.ok(err);
                                ...
                                _canDelete(bert, bert, anonymousRestContext, visibility, [], [], true, function(err) {
                                    assert.ok(err);
                                    callback();
                                });
                            });
        ...
        it('verify create comment validation', function(callback) {
            setUpUsers(function(contexts) {
                ...
                RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 1', 'Test content description 1', 'public', 'http://www.sakaiproject.org/',  [], [], function(err, contentObj) {
                    ...
                    RestAPI.Content.createComment(contexts['bert'].restContext, null, 'This comment should be on top of the list', null, function(err) {
                        assert.ok(err);
                        assert.equal(err.code, 404);
                        ...
                        RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, null, 10, function(err, comments) {
                            ...
                            RestAPI.Content.createComment(contexts['bert'].restContext, contentObj.contentId, null, null, function(err) {
                                assert.ok(err);
                                assert.equal(err.code, 400);
                                // Verify that the comment wasn't created
                                RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, null, 10, function(err, comments) {
                                    ...
                                    RestAPI.Content.createComment(anonymousRestContext, contentObj.contentId, 'This comment should be on top of the list', null, function(err) {
                                        assert.ok(err);
                                        assert.equal(err.code, 401);
                                        // Verify that the comment wasn't created
                                        RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, null, 10, function(err, comments) {
        ...
        var testCommentPermissions = function(contexts, visibility, expectLoggedInComment, callback){
            ...
            RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 1', 'Test content description 1', visibility, 'http://www.sakaiproject.org/', [], [contexts['nicolaas'].user.id], function(err, contentObj) {
                ...
                RestAPI.Content.createComment(contexts['bert'].restContext, contentObj.contentId, 'Try to comment as manager', null, function(err) {
                    assert.ok(!err);
                    ...
                    RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, null, 1, function(err, comments) {
                        ...
                        RestAPI.Content.createComment(contexts['nicolaas'].restContext, contentObj.contentId, 'Try to comment as member', null, function(err) {
                            assert.ok(!err);
                            ...
                            RestAPI.Content.getComments(contexts['nicolaas'].restContext, contentObj.contentId, null, 1, function(err, comments) {
                                ...
                                RestAPI.Content.createComment(contexts['simon'].restContext, contentObj.contentId, 'Try to comment as logged in user', null, function(err) {
                                    ...
                                    RestAPI.Content.getComments(contexts['simon'].restContext, contentObj.contentId, null, 1, function(err, comments) {
                                        ...
                                        RestAPI.Content.createComment(anonymousRestContext, contentObj.contentId, 'Try to comment as an anonymous user', null, function(err) {
                                            assert.ok(err);
