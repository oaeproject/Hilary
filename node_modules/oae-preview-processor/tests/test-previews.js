...
describe('Preview processor', function() {
    ...
    describe('Preview generation', function() {
        ...
        /**
         * Test that verifies that folders are reprocessed when on of their content items theirs visibililty changes
         */
        it('verify folders are reprocessed when one of their content items their visibility changes', function(callback) {
            // Ignore this test if the PP is disabled
            if (!defaultConfig.previews.enabled) {
                return callback();
            }
