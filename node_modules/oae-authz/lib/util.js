...
var isGroupId = (module.exports.isGroupId = function(groupId) {
  return (
    isResourceId(groupId) &&
    groupId.indexOf(AuthzConstants.resourceTypes.GROUP + ':') === 0
  );
});
...
var isUserId = (module.exports.isUserId = function(userId) {
  return (
    isResourceId(userId) &&
    userId.indexOf(AuthzConstants.principalTypes.USER + ':') === 0
  );
});
 ...
 */
var parseShareTarget = (module.exports.parseShareTarget = function(
  shareTargetStr,
) {
  ...
  if (isEmail(shareTargetSplit[0])) {
    var email = shareTargetSplit[0].toLowerCase();
 ...
 */
var filterDeletedIds = (module.exports.filterDeletedIds = function(
  ids,
  callback,
) {
 ...
 */
var computeRoleChanges = (module.exports.computeRoleChanges = function(
  rolesBefore,
  roleChanges,
  opts,
) {
