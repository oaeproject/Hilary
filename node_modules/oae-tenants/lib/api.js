 ...
 */
var createTenant = module.exports.createTenant = function(alias, name, port, baseUrl, callback) {
    callback = callback || function() {};
 ...
 * @param   {Object}    callback.err   An error object (if any)
 */
var updateTenant = module.exports.updateTenant = function(port, name, callback) {
    var validator = new Validator();
    validator.check(name, {'code': 400, 'msg': 'Missing name'}).notEmpty();
    validator.check(port, {'code': 400, 'msg': 'Missing port'}).notEmpty();
    if (validator.hasErrors()) {
