...
var getActivities = module.exports.getActivities = function(activityStreamId, start, limit, callback) {
    ...
    Cassandra.runPagedColumnQuery('ActivityStreams', 'activityStreamId', activityStreamId, start, limit, {'reversed': true, 'consistency': 'ONE'}, function(err, columns, nextToken) {
        ...
        var isActivityStream = (activityStreamId.split('#')[1] === 'activity');
        if (!isActivityStream) {
        ...
        var oldActivityStreamId = activityStreamId.split('#')[0];
        var oldActivityStreamLimit = limit - activities.length;
        Cassandra.runPagedColumnQuery('ActivityStreams', 'activityStreamId', oldActivityStreamId, start, oldActivityStreamLimit, {'reversed': true, 'consistency': 'ONE'}, function(err, columns, nextToken) {
            if (err) {
                return callback(err);
            }
