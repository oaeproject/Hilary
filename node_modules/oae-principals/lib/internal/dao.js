...
var createRequestJoinGroup = module.exports.createRequestJoinGroup = function(principalId, groupId, role, callback) {
    ...
    queries.push({'query': 'INSERT INTO "RequestByGroup" ("groupId", "principalId", "role") VALUES (?, ?, ?)', 'parameters': [groupId, principalId, role]});
...
var updateRequestJoinGroup = module.exports.updateRequestJoinGroup = function(principalId, groupId, role, callback) {
    ...
    queries.push({'query': 'UPDATE "RequestByGroup" SET "role" = ? WHERE "groupId" = ?', 'parameters': [role, groupId]});
...
var removeJoinGroupByRequest = module.exports.removeJoinGroupByRequest = function(principalId, groupId, callback) {
    ...
    queries.push({'query': 'DELETE FROM "RequestByGroup" WHERE "groupId" = ?', 'parameters': [groupId]});
...
var getRequestsJoinGroup = module.exports.getRequestsJoinGroup = function(groupId, callback) {
    Cassandra.runQuery('SELECT * FROM "RequestByGroup" WHERE "groupId" = ?', [groupId], function (err, rows) {
        if (err) {
            return callback(err);
        }
        if (_.isEmpty(rows)) {
        ...
        var requests = _.map(rows, Cassandra.rowToHash);
