 ...
 */
LibraryAPI.Search.registerLibrarySearch('members', ['user', 'group'], {
    'association': {
        'name': AuthzConstants.search.MAPPING_RESOURCE_MEMBERSHIPS,
        'field': 'direct_memberships'
    }
...
var _updatePrincipalInMembersLibraries = function(ctx, updatedPrincipal, oldPrincipal) {
    ...
    // any updates
    if (!_xor(_hasProfilePicture(updatedPrincipal), _hasProfilePicture(oldPrincipal)) &&
...
var _hasProfilePicture = function(principal) {
    return (principal.picture && principal.picture.smallUri);
};
