...
describe('Content', function() {
    ...
    describe('Create comments on content', function() {
                ...
                RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 1', 'Test content description 1', 'public', 'http://www.sakaiproject.org/',  [], [], function(err, contentObj) {
                    ...
                    RestAPI.Content.getContent(contexts['bert'].restContext, contentObj.contentId, function(err, retrievedContentObj) {
                        ...
                        postComments(contentObj.contentId, contexts, 10, function() {
                            ...
                            RestAPI.Content.postComment(contexts['bert'].restContext, contentObj.contentId, 'This comments should be on top of the list', function(err) {
         ...
         * Test that will create a comment on content
         */
        it('verify retrieving comment', function(callback) {
            setUpUsers(function(contexts) {
                // Create a piece of content
                RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 1', 'Test content description 1', 'public', 'http://www.sakaiproject.org/',  [], [], function(err, contentObj) {
                    assert.ok(!err);
            ...
            setUpUsers(function(contexts) {
                ...
                RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 1', 'Test content description 1', 'public', 'http://www.sakaiproject.org/',  [], [], function(err, contentObj) {
                    ...
                    RestAPI.Content.getContent(contexts['bert'].restContext, contentObj.contentId, function(err, retrievedContentObj) {
                        ...
                        RestAPI.Content.postComment(contexts['bert'].restContext, null, 'This comments should be on top of the list', function(err) {
                            assert.ok(err);
