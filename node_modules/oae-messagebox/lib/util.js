 ...
 */
var transformPersistentMessageActivityEntity = module.exports.transformPersistentMessageActivityEntity = function(ctx, entity, profilePath, urlFormat) {
    var context = entity.messageContext || {};
    var tenant = ctx.tenant();
    var transformedEntity = _transformMessageActivityEntity(ctx, entity, entity.message, urlFormat, profilePath);

    // Transform the parent if there is one
    if (context.parent) {
        transformedEntity[MessageBoxConstants.activity.IN_REPLY_TO] = _transformMessageActivityEntity(ctx, entity, context.parent, urlFormat, profilePath);
    }
 ...
 * @api private
 */
var _transformMessageActivityEntity = function(ctx, entity, message, urlFormat, profilePath) {
    var tenant = ctx.tenant();
    ...
    return new ActivityModel.ActivityEntity(entity.objectType, globalId, opts);
};
 ...
 */
var transformPersistentMessageActivityEntityToInternal = module.exports.transformPersistentMessageActivityEntityToInternal = function(ctx, message) {
    message.createdBy = PrincipalsUtil.transformPersistentUserActivityEntityToInternal(ctx, message.createdBy.id, message.createdBy);
    return message;
};
