    ...
    describe('Email', function() {
        ...
        describe('Content', function() {
            ...
            it('verify content invitation email html', function(callback) {
                var assertions = {
                    'oneResourceSummaryMatch': 'has invited you to share the link ',
            ...
            it('verify email aggregation and summary for accepting an invitation to content', function(callback) {
                var assertions = {
                    'oneResourceSummaryMatch': [
                        ' has accepted an invitation to add the link ',
                        ' to their library'
                    ],
                    'twoResourceSummaryMatch': [' has accepted an invitation to collaborate on '],
                    'threeResourceSummaryMatch': [' has accepted an invitation to collaborate on '],
                };
        ...
        describe('Discussion', function() {
            ...
            it('verify discussion invitation email html', function(callback) {
                var assertions = {
                    'oneResourceSummaryMatch': ' has invited you to share the discussion ',
                    'twoResourceSummaryMatch': ' has invited you to share the discussions ',
                    'threeResourceSummaryMatch': ' has invited you to share the discussion '
                };
            ...
            it('verify email aggregation and summary for accepting an invitation to discussion', function(callback) {
                var assertions = {
                    'oneResourceSummaryMatch': [
                        ' has accepted an invitation to add the discussion ',
                        ' to their library'
                    ],
                    'twoResourceSummaryMatch': [' has accepted an invitation to add the discussions '],
                    'threeResourceSummaryMatch': [' has accepted an invitation to add the discussion '],
                };
        ...
        describe('Folder', function() {
            ...
            it('verify folder invitation email html', function(callback) {
                var assertions = {
                    'oneResourceSummaryMatch': 'has invited you to share the folder ',
                    'twoResourceSummaryMatch': 'has invited you to share the folders ',
                    'threeResourceSummaryMatch': 'has invited you to share the folder '
                };
            ...
            it('verify email aggregation and summary for accepting an invitation to folder', function(callback) {
                var assertions = {
                    'oneResourceSummaryMatch': [
                        ' has accepted an invitation to add the folder ',
                        ' to their library'
                    ],
                    'twoResourceSummaryMatch': [' has accepted an invitation to add the folders '],
                    'threeResourceSummaryMatch': [' has accepted an invitation to add the folder '],
                };
        ...
        describe('Group', function() {
            ...
            it('verify email aggregation and summary for accepting an invitation to group', function(callback) {
                var assertions = {
                    'oneResourceSummaryMatch': [' has accepted an invitation to join the group '],
                    'twoResourceSummaryMatch': [' has accepted an invitation to join the groups '],
                    'threeResourceSummaryMatch': [' has accepted an invitation to join the group '],
                };
        ...
        TestsUtil.generateTestUsers(camAdminRestContext, 2, function(err, users, sharingUserInfo, acceptingUserInfo) {
            ...
            EmailTestUtil.collectAndFetchAllEmails(function() {
                ...
                fns.createSucceeds(sharingUserInfo.restContext, 'private', [email], [], function(resourceA) {
                    ...
                    _assertAcceptEmailInvitation(sharingUserInfo, acceptingUserInfo, [resourceA], emailAssertions, function() {
                        EmailTestUtil.collectAndFetchAllEmails(function(messages) {
                            ...
                            fns.createSucceeds(sharingUserInfo.restContext, 'private', [email], [], function(resourceB1) {
                                fns.createSucceeds(sharingUserInfo.restContext, 'private', [email], [], function(resourceB2) {
                                    ...
                                    _assertAcceptEmailInvitation(sharingUserInfo, acceptingUserInfo, [resourceB1, resourceB2], emailAssertions, function() {
                                        EmailTestUtil.collectAndFetchAllEmails(function(messages) {
                                            assert.strictEqual(messages.length, 1);
                                            ...
                                            fns.createSucceeds(sharingUserInfo.restContext, 'private', [email], [], function(resourceC1) {
                                                fns.createSucceeds(sharingUserInfo.restContext, 'private', [email], [], function(resourceC2) {
                                                    fns.createSucceeds(sharingUserInfo.restContext, 'private', [email], [], function(resourceC3) {
                                                        ...
                                                        _assertAcceptEmailInvitation(sharingUserInfo, acceptingUserInfo, [resourceC1, resourceC2, resourceC3], emailAssertions, function() {
                                                            EmailTestUtil.collectAndFetchAllEmails(function(messages) {
                                                                assert.strictEqual(messages.length, 1);
