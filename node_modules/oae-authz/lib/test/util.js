 ...
 */
var assertSetDeletedSucceeds = (module.exports.assertSetDeletedSucceeds = function(
  resourceId,
  callback,
) {
 ...
 * @throws {AssertionError}                 Thrown if any assertions fail
 */
var assertUnsetDeletedSucceeds = (module.exports.assertUnsetDeletedSucceeds = function(
  resourceId,
  callback,
) {
  // Apply the delete operation
 ...
 * @throws {AssertionError}                         Thrown if any assertions fail
 */
var assertAcceptInvitationForEmailSucceeds = (module.exports.assertAcceptInvitationForEmailSucceeds = function(
  restContext,
  email,
  callback,
) {
  ...
  AuthzInvitationsDAO.getTokensByEmails([email], function(err, emailTokens) {
    ...
    assertAcceptInvitationSucceeds(restContext, token, function(
      result,
      invitations,
    ) {
 ...
 * @throws {AssertionError}                         Thrown if any assertions fail
 */
var assertAcceptInvitationSucceeds = (module.exports.assertAcceptInvitationSucceeds = function(
  restContext,
  token,
  callback,
) {
  PrincipalsTestUtil.assertGetMeSucceeds(restContext, function(me) {
    AuthzInvitationsDAO.getEmailByToken(token, function(err, email) {
      ...
      AuthzInvitationsDAO.getAllInvitationsByEmail(email, function(
        err,
        invitationsBefore,
      ) {
        assert.ok(!err);
        ...
        RestAPI.Invitations.acceptInvitation(restContext, token, function(
          err,
          result,
        ) {
          assert.ok(!err);
 ...
 * @throws {AssertionError}                         Thrown if any assertions fail
 */
var assertAcceptInvitationFails = (module.exports.assertAcceptInvitationFails = function(
  restContext,
  token,
  httpCode,
  callback,
  ...
  OaeUtil.invokeIfNecessary(
    ...
    function(err, email) {
      OaeUtil.invokeIfNecessary(
        ...
        email,
        function(err, invitationsBefore) {
          // Perform the accept
          RestAPI.Invitations.acceptInvitation(restContext, token, function(
            err,
          ) {
 ...
 * @throws {AssertionError}                         Thrown if any assertions fail
 */
var assertGetInvitationsSucceeds = (module.exports.assertGetInvitationsSucceeds = function(
  restContext,
  resourceType,
  resourceId,
  callback,
) {
  RestAPI.Invitations.getInvitations(
    restContext,
    resourceType,
    resourceId,
    function(err, result) {
 ...
 * @throws {AssertionError}                         Thrown if any assertions fail
 */
var assertGetInvitationsFails = (module.exports.assertGetInvitationsFails = function(
  restContext,
  resourceType,
  resourceId,
  httpCode,
 ...
 * @throws {AssertionError}                         Thrown if any assertions fail
 */
var assertResendInvitationSucceeds = (module.exports.assertResendInvitationSucceeds = function(
  restContext,
  resourceType,
  resourceId,
  email,
  ...
  RestAPI.Invitations.resendInvitation(
    restContext,
    resourceType,
    resourceId,
    email,
 ...
 * @throws {AssertionError}                         Thrown if any assertions fail
 */
var assertResendInvitationFails = (module.exports.assertResendInvitationFails = function(
  restContext,
  resourceType,
  resourceId,
  email,
 ...
 * @throws {AssertionError}                     Thrown if any assertions fail
 */
var assertIsDeletedSucceeds = (module.exports.assertIsDeletedSucceeds = function(
  resourceIdsToCheck,
  deletedResourceIds,
  callback,
) {
 ...
 */
var assertAuthzMembersGraphIdsEqual = (module.exports.assertAuthzMembersGraphIdsEqual = function(
  resourceIds,
  expectedIds,
  callback,
) {
  AuthzAPI.getAuthzMembersGraph(resourceIds, function(err, graph) {
    ...
    var actualIds = _.chain(resourceIds)
 ...
 * @throws {AssertionError}                 Thrown if the graph wasn't as expected
 */
var assertPrincipalMembershipsGraphIdsEqual = (module.exports.assertPrincipalMembershipsGraphIdsEqual = function(
  principalId,
  expectedIds,
  callback,
) {
 ...
 */
var assertMemberRolesEquals = (module.exports.assertMemberRolesEquals = function(
  before,
  delta,
  after,
) {
 ...
 * @throws {AssertionError}                     Thrown if the membership after the delta is not equal to the initial membership with the delta applied
 */
var assertEmailRolesEquals = (module.exports.assertEmailRolesEquals = function(
  before,
  delta,
  after,
) {
 ...
 */
var assertCreateMembershipsGraphSucceeds = (module.exports.assertCreateMembershipsGraphSucceeds = function(
  graph,
  callback,
  _ops,
) {
 ...
 */
var createRoleChange = (module.exports.createRoleChange = function(
  principalIds,
  role,
) {
  var roleChange = {};
 ...
 */
var getMemberRolesFromResults = (module.exports.getMemberRolesFromResults = function(
  members,
) {
  var memberRoles = {};
 ...
 */
var getEmailRolesFromResults = (module.exports.getEmailRolesFromResults = function(
  invitations,
) {
  var emailRoles = {};
 ...
 */
var parseInvitationUrlFromMessage = (module.exports.parseInvitationUrlFromMessage = function(
  message,
) {
  var match = message.html.match(
