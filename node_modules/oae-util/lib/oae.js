...
var registerAPI = function(server, config, callback) {
    ...
    server.post('/api/tenant/start', function(req, res, next) {
        tenantAPI.putTenantInMaintenanceMode(req.body, false, function(err) {
            if (err) {
                return res.send(err.code, err.msg);
            }
    ...
    server.post('/api/tenant/stop', function(req, res, next) {
        tenantAPI.putTenantInMaintenanceMode(req.body, true, function(err) {
            if (err) {
                return res.send(err.code, err.msg);
            }
    ...
    server.post('/api/tenant/delete', function(req, res, next) {
        tenantAPI.deleteTenant(req.body, function(err) {
            if (err) {
                return res.send(err.code, err.msg);
            }
 ...
 */
var startTenants = function(server, callback) {
    tenantAPI.getAllTenants(function(err, tenants) {
        if (err) {
            throw err;
        }
