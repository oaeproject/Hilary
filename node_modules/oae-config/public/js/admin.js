...
(function(){
    ...
    var getCtx = function(meData, callback) {
        ...
        // Returns true if the server accessed is the main tenant server
        // If a tenant is accessed through the global server false is returned
        adminContext.tenant.isMainTenantServer = function() {
            return (adminContext.tenant.context !== 'tenant' &&
                       (adminContext.tenant.context === 'global' &&
                        ...
                        adminContext.tenant.context === 'tenant';
        };
