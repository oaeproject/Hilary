 ...
 * @FormParam   {string[]}          [managers]          Unique identifier(s) for users and groups to add, or email addresses to invite, as managers of the folder. The user creating the folder will be added as a manager automatically
 * @FormParam   {string[]}          [viewers]           Unique identifier(s) for users and groups to add, or email addresses to invite, as viewers of the folder
 ...
 * @FormParam   {string[]}          members             Unique identifier(s), or email addresses, for users and groups to share the folder with
 * @Return      {void}
