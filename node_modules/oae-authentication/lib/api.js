...
/**
 * Refreshes tenant authentication strategies. In case the global tenant alias (or none)
 * was specified, all authentication strategies will be refreshed. In case an alias was
 * provided, only the authentication strategies for that tenant will be refreshed.
 *
 * @param  {String}     [tenantAlias]       The alias of the tenant for which to refresh the authentication strategies. If left `null` or the global tenant alias was specified, all strategies will be refreshed
 * @api private
 */
