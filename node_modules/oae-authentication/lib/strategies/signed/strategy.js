...
Strategy.prototype.authenticate = function(req) {
    ...
    AuthenticationSignedUtil.verifySignedAuthenticationBody(req.ctx, req.body, function(err, userId, becomeUserId) {
        if (err) {
        ...
        PrincipalsDAO.getPrincipal(userId, function(err, user) {
            if (err && err.code !== 404) {
                ...
                authObj = {'user': user, 'strategyId': AuthenticationConstants.providers.SIGNED};
            ...
            PrincipalsDAO.getPrincipal(becomeUserId, function(err, becomeUser) {
                ...
                var authObj = {'user': becomeUser, 'imposter': user, 'strategyId': AuthenticationConstants.providers.SIGNED};
                AuthenticationUtil.logAuthenticationSuccess(req, authObj, self.name);
                return self.success(authObj);
            });
        });
