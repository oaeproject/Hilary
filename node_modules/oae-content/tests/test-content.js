...
describe('Content', function() {
    ...
    describe('Content comments', function() {
         ...
         */
        it('test delete comment permissions public', function(callback) {
            setUpUsers(function(contexts) {
         ...
         */
        it('test delete comment permissions loggedin', function(callback) {
            setUpUsers(function(contexts) {
         ...
         */
        it('test delete comment permissions private', function(callback) {
            setUpUsers(function(contexts) {
        ...
        it('test create comment permissions public', function(callback) {
            setUpUsers(function(contexts) {
                testCommentPermissions(contexts, 'public', true, callback);
            });
        });

        it('test create comment permissions loggedin', function(callback) {
            setUpUsers(function(contexts) {
                testCommentPermissions(contexts, 'loggedin', true, callback);
            });
        });

        it('test create comment permissions private', function(callback) {
            setUpUsers(function(contexts) {
