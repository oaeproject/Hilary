...
module.exports = {
    ...
    'cas': {
        ...
        'elements': {
            ...
            'loginPath': new Fields.Text('Login Path', 'The path where the user should be redirected to in order to start the authentication flow', '/login', {'suppress': true}),
            'useSaml': new Fields.Bool('Use SAML', 'Use SAML to get CAS attributes, you probably need to set the Validate Path to "/samlValidate" when using this', false, {'suppress': true}),
            ...
            'logoutUrl': new Fields.Text('Logout URL', 'The URL where the user should be redirected to when logging out of OAE. This should be a full url including a valid protocol (e.g., https://my.cas.server/cas/logout)', '', {'suppress': true}),
