...
var PreviewLinkDefault = require('oae-preview-processor/lib/retrievers/default');
...
describe('Preview processor', function() {
    ...
    describe('Default link preview processor', function() {

        it('verify non-http links cannot be opened with the webshot preview processor', function(callback) {
            PreviewLinkDefault.getImage(null, 'file://localhost/etc/passwd', function(err) {
                assert.equal(err.code, 400);

                PreviewLinkDefault.getImage(null, 'ftp://localhost:21/etc/passwd', function(err) {
                    assert.equal(err.code, 400);
                    callback();
                });
            });
