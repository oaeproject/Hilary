...
var addDataToArchive = module.exports.addDataToArchive = function(archiveId, principalId, resourceId, date, callback) {
    ...
    Cassandra.runQuery('INSERT INTO "DataArchive" ("archiveId", "principalId", "resourceId", "deletionDate") VALUES (?, ?, ?, ?)', [archiveId, principalId, stringResource, date], function(err, rows) {
        if (err) {
            return callback(err);
        }
        return callback();
 ...
 * @param  [User]           callback.users      The list of users for the given tenancy
 */
var removePrincipalFromDataArchive = module.exports.removePrincipalFromDataArchive = function(archiveId, principalId, callback) {
...
var getExpiredUser = module.exports.getExpiredUser = function(actualDate, callback) {
    ...
    Cassandra.runQuery('SELECT * FROM "DataArchive"', [], function(err, rows) {
        ...
        users = _.filter(users, function(user) { return new Date(user.deletionDate) < actualDate; });
        return callback(null, users);
    });
};
