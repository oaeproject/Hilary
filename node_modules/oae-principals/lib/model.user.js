 ...
 * @param  {String}     [opts.emailChange]              The email address the user wants to use but hasn't confirmed yet
 * @param  {String}     [opts.emailPreference]          The user's email preference. One of {@see PrincipalConstants.emailPreferences}
 * @param  {Boolean}    [opts.emailVerified]            Whether or not the user's email address is verified
...
module.exports.User = function(tenantAlias, id, displayName, email, opts) {
    ...
    that.emailChange = opts.emailChange;
    that.emailPreference = opts.emailPreference;
    that.emailVerified = opts.emailVerified;
