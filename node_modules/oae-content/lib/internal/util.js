...
var augmentContent = module.exports.augmentContent = function(ctx, content, duration, offset) {
    ...
    if (content.previews) {
        ...
        if (content.previews.video) {
            content.previews.video = _getSignedVideoUrl(ctx, content.previews.key);
        }
    }
};
 ...
 * @return {String}                 The signed S3 url that can be used to view the video
 */
var _getSignedVideoUrl = function(ctx, key) {
    ...
    var params = _.extend({}, headParams, {
        'Expiration': TIME_1_WEEK_IN_SECONDS
    });
