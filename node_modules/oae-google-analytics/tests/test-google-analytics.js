    ...
    it('verify the config feed contains Google Analytics config values', function(callback) {
        ...
        TestsUtil.generateTestUsers(camAdminRestContext, 1, function(err, users) {
            ...
            RestAPI.Config.getTenantConfig(johnRestContext, null, function(err, config) {
                assert.ok(!err);
                assert.ok(config);
                assert.equal(config['oae-google-analytics']['google-analytics']['enabled'], true);
                assert.equal(config['oae-google-analytics']['google-analytics']['id'], 'UA-40243987-3');
                assert.equal(config['oae-google-analytics']['google-analytics']['tenant-enabled'], false);
                assert.equal(config['oae-google-analytics']['google-analytics']['tenant-id'], '');
