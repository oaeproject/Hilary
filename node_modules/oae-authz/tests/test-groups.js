...
describe('Authz-Groups', function() {
    ...
    var createUserIds = function(tenantId, num) {
        var ids = [];
        for (var i = 0; i < num; i++) {
            ids.push(AuthzUtil.toUuid('u', tenantId, i));
        }
        return ids;
    };
    ...
    describe('Add group member', function() {
        ...
        it('verify invalid member id error', function(callback) {
            AuthzAPI.updateRoles('g:sakai:oae-team', makeMembershipChange('not a valid id', 'member'), function(err) {
                assert.ok(err);
                assert.equal(err.code, 400);
                callback();
            });
        ...
        it('verify non-principal member id error', function(callback) {
            AuthzAPI.updateRoles('g:sakai:oae-team', makeMembershipChange('c:content:id', 'member'), function(err) {
                assert.ok(err);
                assert.equal(err.code, 400);
                callback();
            });
    ...
    describe('Remove group member', function() {
        ...
        it('verify invalid member id error', function(callback) {
            AuthzAPI.updateRoles('g:sakai:oae-team', makeMembershipChange('not a valid id', false), function(err) {
                assert.ok(err);
                assert.equal(err.code, 400);
                callback();
            });
        ...
        it('verify non-principal member id error', function(callback) {
            AuthzAPI.updateRoles('g:sakai:oae-team', makeMembershipChange('c:content:id', false), function(err) {
                assert.ok(err);
                assert.equal(err.code, 400);
                callback();
            });
    ...
    describe('#updateAuthzGroupMembers()', function() {
        ...
        it('verify invalid member id error', function(callback) {
            AuthzAPI.updateRoles('g:sakai:oae-team', {'not a valid id': 'member'}, function(err) {
                assert.ok(err);
                assert.equal(err.code, 400);
                callback();
            });
    ...
    describe('#getAuthzMembers()', function() {
        ...
        it('verify invalid group id error', function(callback) {
            AuthzAPI.getAuthzMembers('not a valid id', null, null, function(err) {
                assert.ok(err);
                assert.equal(err.code, 400);
                callback();
            });
    ...
    describe('#getPrincipalMemberships()', function() {
        ...
        it('verify invalid principal id', function(callback) {
            AuthzAPI.getPrincipalMemberships('not an id', function(err) {
                assert.ok(err);
                assert.equal(err.code, 400);
                callback();
            });
