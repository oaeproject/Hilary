...
var init = module.exports.init = function(mqConfig, callback) {
    if (!connection) {
        ...
        connection.on('close', function() {
            log().warn('Closed connection to RabbitMQ');
        });
        ...
        connection.on('ready', function() {
            ...
            connection.exchange(Constants.DEFAULT_TASK_EXCHANGE_NAME, _.extend({}, Constants.DEFAULT_TASK_EXCHANGE_OPTS), function(exchange) {
