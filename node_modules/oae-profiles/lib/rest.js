...
// Get all sections.
OAE.tenantServer.get('/api/user/:id/profile', function(req, res) {
...
// Get all the profile section visibility settions.
OAE.tenantServer.get('/api/user/:id/visibility', function(req, res) {
