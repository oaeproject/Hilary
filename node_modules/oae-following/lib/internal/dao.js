 ...
 */
var isFollowing = (module.exports.isFollowing = function(
  followingUserId,
  followedUserIds,
  callback,
) {
 ...
 * @param  {Object}     callback.err        An error that occurred, if any
 */
var saveFollows = (module.exports.saveFollows = function(
  followerUserId,
  followedUserIds,
  callback,
) {
 ...
 * @param  {Object}     callback.err        An error that occurred, if any
 */
var deleteFollows = (module.exports.deleteFollows = function(
  followerUserId,
  followedUserIds,
  callback,
) {
  ...
  _.each(followedUserIds, function(followedUserId) {
    queries.push(
      ...
      {
        query:
          'DELETE FROM "FollowingUsersFollowing" WHERE "userId" = ? AND "followingId" = ?',
      ...
      {
        query:
          'DELETE FROM "FollowingUsersFollowers" WHERE "userId" = ? AND "followerId" = ?',
