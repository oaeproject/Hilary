...
var canInteract = module.exports.canInteract = function(ctx, resourceTenantAlias, principalIds, callback) {
    ...
    var illegalPrincipalIds =  _.filter(principalIds, function(principalId) {
        return !TenantsUtil.canInteract(resourceTenantAlias, AuthzUtil.getPrincipalFromId(principalId).tenantAlias);
    });
    ...
    // Now check if there are any access violations between the actor and the principals
