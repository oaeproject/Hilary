                ...
                function() {
                  ...
                  RestAPI.Content.getContent(
                    ...
                    function(err, updatedContent) {
                      ...
                      assert.strictEqual(
                        updatedContent.previews.status,
                        'done',
                      );
          ...
          function(err, link) {
            ...
            SearchTestsUtil.searchAll(
              ...
              null,
              {
                ...
                q: 'index-without-full-content-item',
              },
      ...
      _purgeAndEnable(function() {
        ConfigTestUtil.updateConfigAndWait(
          ...
          function(err) {
            ...
            var pdfStream = function() {
              return fs.createReadStream(__dirname + '/data/test.pdf');
            };
