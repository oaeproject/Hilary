...
var documentModule = module.exports.documentModule = function(module, callback) {
    ...
    readdirp({'root': 'node_modules/' + module, 'directoryFilter': dirsToProcess, 'fileFilter': '*.js'})
        ...
        try {
            ...
            _.each(doc.endpoints, function(endpoint, nickname) {
                ...
                _.each(endpoint.queryParams, function(queryParam) {
                    endpoint.parameters.push(SwaggerParamTypes.query(queryParam.name, queryParam.description, _convertRJDArrayDefToSwagger(queryParam.type), queryParam.required, queryParam.multiple, _constructSwaggerValue(queryParam.validValues), queryParam.defaultValue));
                });
