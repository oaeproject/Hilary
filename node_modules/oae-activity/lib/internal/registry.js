 ...
 */
var getRegisteredActivityStreamType = module.exports.getRegisteredActivityStreamType = function(activityStreamType) {
    ...
    _.each(options.streams, function(streamConfig, streamName) {
        ...
        _.each(options.streams[streamName].router, function(assocations, entityName) {
            if (_.isEmpty(assocations)) {
                throw new Error(util.format('Missing or empty associations for stream "%s" and entity "%s"', streamName, entityName));
            }
        });
    });
