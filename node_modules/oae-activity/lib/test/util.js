 ...
 * @param  {Object}     extraConfig         Extra configuration that should be passed to the Activity API
 * @param  {Function}   callback            Standard callback function
 * @param  {Object}     callback.config     The configuration object that was used to refresh the activity API
 * @throws {AssertionError}                 An assertion error is thrown if the configuration could not be refreshed
 */
var refreshMailConfiguration = module.exports.refreshMailConfiguration = function(timezoneString, expectDaily, expectWeekly, extraConfig, callback) {
    ...
    refreshConfiguration(config, function(err) {
        assert.ok(!err);
