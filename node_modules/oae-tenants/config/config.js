...
var timezoneConfigValues = _.chain(TZ.getZones())
  ...
  .map(function(timezone) {
    ...
    var offsetHoursStr =
      offsetHours < 10 ? '0' + offsetHours.toString() : offsetHours.toString();
    var offsetMinutesStr =
      offsetMinutes < 10
...
module.exports = {
  ...
  instance: {
    ...
    elements: {
      instanceName: new Fields.Text(
        'Instance name',
        'The name of the current instance',
        '',
        { tenantOverride: false },
      ),
      instanceURL: new Fields.Text(
        'Instance URL',
        'The URL of the main instance website',
        '',
        { tenantOverride: false },
      ),
  ...
  tenantprivacy: {
    ...
    elements: {
      tenantprivate: new Fields.Bool(
        'Private Tenant',
        'The tenant is private',
        false,
        { tenantOverride: false, suppress: false },
      ),
    },
  },
  timezone: {
  ...
  guests: {
    ...
    elements: {
      allow: new Fields.Bool(
        'Tenant Guests',
        'Allow guests to be invited from this tenant',
        true,
        { tenantOverride: true },
      ),
    },
