...
OAE.tenantServer.post('/api/content/create', function(req, res) {
    ...
    // File creation
        ...
        ContentAPI.createFile(req.ctx, req.body.displayName, req.body.description, req.body.visibility, req.body.additionalMembers, uploadedFile, function(err, contentObj) {
            if (err) {
