  ...
  describe('Registration', function() {
    ...
    it('verify registering multiple delete and restore handlers with the same name results in an exception', function(callback) {
      ...
      PrincipalsDelete.registerGroupDeleteHandler(
        ...
        function(group, membershipsGraph, membersGraph, callback) {
          return callback();
        },
      );
                      ...
                      function() {
                        ...
                        PrincipalsTestUtil.assertDeleteGroupFails(
                          ...
                          function() {
                            ...
                            permissionChanges[
                              publicTenant1.adminUser.user.id
                            ] = false;
                            permissionChanges[
                ...
                PrincipalsTestUtil.assertDeleteUserFails(
                  ...
                  function() {
                    ...
                    PrincipalsTestUtil.assertGetUserSucceeds(
                      user1.restContext,
                      user1.user.id,
                      function(user1AfterFailedDeletes) {
                        assert.strictEqual(
                          user1AfterFailedDeletes.id,
                          user1.user.id,
                        );
  ...
  describe('Profile', function() {
              ...
              PrincipalsTestUtil.assertRestoreGroupSucceeds(
                ...
                function() {
                  ...
                  PrincipalsTestUtil.assertGetGroupSucceeds(
                    ...
                    group.group.id,
                    expectedFields,
                    function(restoredGroup) {
                      assert.strictEqual(
                        group.group.createdBy.id,
                        restoredGroup.createdBy.id,
                      );
                      return callback();
                    },
                  );
    ...
    it('verify deleting and restoring groups removes and restores access to its memberships library', function(callback) {
      ...
      TestsUtil.generateTestUsers(camAdminRestContext, 1, function(
        ...
        TestsUtil.generateTestGroups(manager.restContext, 2, function(
          childGroup,
          parentGroup,
        ) {
            ...
            PrincipalsTestUtil.assertDeleteUserSucceeds(
              ...
              function() {
                ...
                PrincipalsTestUtil.assertRestoreUserSucceeds(
                  camAdminRestContext,
                  user1.user.id,
                  function(user1AfterRestore) {
                    PrincipalsTestUtil.assertRestoreUserSucceeds(
                      camAdminRestContext,
                      user2.user.id,
                      function(user2AfterRestore) {
                        ...
                        PrincipalsTestUtil.assertGetMeSucceeds(
                          ...
                          function(me) {
                            ...
                            var user2RestContext = TestsUtil.createTenantRestContext(
                              host,
                              username,
                              password,
                            );
                    ...
                    function() {
                      ...
                      PrincipalsTestUtil.assertGetMembersLibrarySucceeds(
                        ...
                        function(result) {
                          ...
                          var userEntry = _.findWhere(result, {
                            id: user1.user.id,
                          });
                          assert.ok(userEntry);
              ...
              PrincipalsTestUtil.assertDeleteGroupSucceeds(
                ...
                function() {
                  ...
                  PrincipalsTestUtil.assertGetAllMembersLibraryEquals(
                    ...
                    function(members) {
                      var childGroupEntry = _.find(members, function(
                        memberEntry,
                      ) {
                          ...
                          PrincipalsTestUtil.assertGetAllMembersLibraryEquals(
                            ...
                            function(members) {
                              var childGroupEntry = _.find(members, function(
                                ...
                                return (
                                  memberEntry.profile.id === childGroup.group.id
                                );
                              });
  ...
  describe('Following', function() {
    ...
    it('verify deleting and restoring a user removes and restores them in followers lists', function(callback) {
      ...
      TestsUtil.generateTestUsers(camAdminRestContext, 10, function(
        ...
        FollowingTestUtil.followByAll(
          userToFollow.user.id,
          followerUserInfos,
          function() {
            // Ensure that all users appear in the userToFollow's followers list
            var followerUserIds = _.chain(followerUserInfos)
              .pluck('user')
              .pluck('id')
              .value();
            var followerUserIdsAfterDelete = _.without(
              followerUserIds,
    ...
    it('verify deleting and restoring a user removes and restores them in following lists', function(callback) {
      ...
      TestsUtil.generateTestUsers(camAdminRestContext, 10, function(
        ...
        var followingUserIds = _.chain(followingUserInfos)
          .pluck('user')
          .pluck('id')
          .value();
        var followingUserIdsAfterDelete = _.without(
          followingUserIds,
          userToDelete0.user.id,
          userToDelete1.user.id,
        );
        FollowingTestUtil.followAll(
    ...
    describe('Memberships', function() {
      ...
      it('verify deleting and restoring a group removes and adds indirect groups in memberships search', function(callback) {
        ...
        TestsUtil.generateTestUsers(camAdminRestContext, 2, function(
          ...
          TestsUtil.generateTestGroups(manager.restContext, 4, function(
            group1,
            group2,
            group3,
            group4,
                      ...
                      function() {
                        SearchTestUtil.assertSearchContains(
                          ...
                          function(response) {
                            ...
                            // no profile path
                            var childGroup1Document = _.findWhere(
                              response.results,
    ...
    describe('Deleted', function() {
      ...
      it('verify scope resolution of deleted search for global admin', function(callback) {
        ...
        TestsUtil.setupMultiTenantPrivacyEntities(function(
          ...
          var tenant1GroupIds = _.chain(tenant1Groups)
            .pluck('id')
            .value();
          var tenant2GroupIds = _.chain(tenant2Groups)
            .pluck('id')
            .value();
          var tenant1UserIds = _.chain(tenant1Users)
            .pluck('user')
            .pluck('id')
            .value();
          var tenant2UserIds = _.chain(tenant2Users)
            .pluck('user')
            .pluck('id')
            .value();
          ...
          PrincipalsTestUtil.assertUpdateGroupsSucceeds(
            ...
            function(tenant1GroupsUpdated) {
              PrincipalsTestUtil.assertUpdateGroupsSucceeds(
                publicTenant2.adminRestContext,
                tenant2GroupIds,
                { description: description },
                function(tenant2GroupsUpdated) {
                  PrincipalsTestUtil.assertUpdateUsersSucceeds(
                    publicTenant1.adminRestContext,
                    tenant1UserIds,
                    { displayName: description },
                    function(tenant1UsersUpdated) {
                      PrincipalsTestUtil.assertUpdateUsersSucceeds(
                        publicTenant2.adminRestContext,
                        tenant2UserIds,
                        { displayName: description },
                        function(tenant2UsersUpdated) {
