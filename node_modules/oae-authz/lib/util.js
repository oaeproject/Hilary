...
/**
 * Construct an id based on the given type, tenantId and instanceId of a resource or principal.
 * 
 ...
 * @return {String}                 The ID constructed from the given parameters, i.e., "type:tenantId:instanceId"
 */
var toId = module.exports.toId = function(type, tenantId, instanceId) {
