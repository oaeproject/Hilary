...
describe('Activity', function() {
    ...
    /**
     * Assert that an activity stream contains the correct activities
     *
     * @param  {RestContext}    restContext             The rest context of the user who should fetch the activity stream
     * @param  {String}         resourceId              The id of the resource of which to get the activity stream
    ...
    var _assertStream = function(restContext, resourceId, nrOfShareActivities, objectEntities, targetEntities, callback) {
        ActivityTestUtil.collectAndGetActivityStream(restContext, resourceId, null, function(err, result) {
            ...
            // Only retain the unique entity ids and sort them for easier comparisn
