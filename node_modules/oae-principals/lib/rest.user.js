...
OAE.globalAdminServer.post('/api/user/import', function(req, res) {
    ...
    PrincipalsAPI.importUsers(req.ctx, req.body.tenantAlias, req.files.file, req.body.authentication, function(err) {
        if (err) {
            return res.send(err.code, err.msg);
        }
...
OAE.tenantServer.post('/api/user/import', function(req, res) {
    req.telemetryUrl = '/api/user/import';
    PrincipalsAPI.importUsers(req.ctx, null, req.files.file, req.body.authentication, function(err) {
        if (err) {
            return res.send(err.code, err.msg);
        }
