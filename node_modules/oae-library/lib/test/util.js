 ...
 */
var assertPurgeFreshLibraries = (module.exports.assertPurgeFreshLibraries = function(
  indexName,
  libraryId,
  callback,
) {
 ...
 */
var assertNotStale = (module.exports.assertNotStale = function(
  indexName,
  libraryId,
  visibility,
  callback,
) {
  LibraryAPI.Index.isStale(indexName, libraryId, visibility, function(
    err,
    isStale,
  ) {
    assert.ok(!err);
...
var _assertPurgeFreshLibraries = function(indexName, libraryIds, callback) {
  ...
  LibraryAPI.Index.isStale(indexName, libraryId, 'private', function(
    err,
    isStale,
  ) {
    assert.ok(!err);
