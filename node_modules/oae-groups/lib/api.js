...
module.exports.getGroup = function(group_id, callback) {
    if (group_id.slice(0, 2) !== "g:") {
        return callback("The provided group_id is not a group identifier.", null);
    }
 ...
 * @param  {Boolean}  retrieve_metadata Whether or not the profile should be retrieved. If false, only the principal_ids for each group will be returned.
...
/**
 * Takes all the keys of a hash and returns them as a simple array.
 * @param  {Object} hash The hash to grab the keys from
 * @return {Array}
 */
