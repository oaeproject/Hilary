...
var _generateThumbnail = function(ctx, path, pagesDir, callback) {
    // Convert the first page to a png file
    var width = PreviewConstants.SIZES.PDF.LARGE;
    var output = pagesDir + '/page.1.png';
    var cmd = util.format('gm convert +adjoin -define pdf:use-cropbox=true -density 150 -resize %s -quality 100 "%s[0]" "%s"', width, path, output);
