 ...
 * @FormParam   {string}            deleteContent       Whether or not to delete the content items that are in the folder
 ...
 * @Return      {FoldersLibrary}                            The folders the current user has in his or her folder library
 ...
 * @Return      {ContentLibrary}                            The content items in a folder
 * @HttpResponse                        200                 The content items in a folder
 * @HttpResponse                        400                 An invalid folder id has been specified
 * @HttpResponse                        400                 You do not have access to one or more of the specified content items
