 ...
 * @param  {Objetc}     callback.personalData   Object containing all the data
 */
var exportData = module.exports.exportData = function(ctx, userId, exportType, callback) {
    ...
    PrincipalsDAO.getPrincipal(userId, function(err, principal) {
        ...
        _extractProfilePicture(ctx, principal, function(err, profilePicture) {
            ...
            // Get personal data 
            _exportContentData(ctx, userId, exportType, function(err, data) {
                if (err) {
                    return callback(err);
                }
                ...
                _assemblePersonalData(personalDetails, profilePicture, data, function(err, personalData) {
                    ...
                    _objectToZipFile(personalData, function(err, zipFile) {
                        if (err) {
                            log.error('An error occurred while creating the zip file');
                            return callback(err);
                        }
 ...
 */
var _extractProfilePicture = function(ctx, principal, callback) {
 ...
 */
var _assemblePersonalData = function(personalDetails, profilePicture, data, callback) {
 ...
 */
var _exportContentData = function(ctx, userId, exportType, callback) {
 ...
 */
var _getUploadedFiles = function(ctx, uploadedFiles, callback) {
 ...
 */
var _collabdocToTxt = function(ctx, collabdocs, callback) {
 ...
 */
var _linkToTxt = function(ctx, links, callback) {
    if (_.isEmpty(links)) {
        return callback();
    }
 ...
 */
var _meetingToTxt = function(ctx, meetings, callback) {
 ...
 */
var _discussionToTxt = function(ctx, discussions, callback) {
