 ...
 */
module.exports.Content = function(tenantAlias, id, visibility, displayName, description, resourceSubType, createdBy, created, lastModified, latestRevisionId, previews) {
    var that = {};
 ...
 */
module.exports.DownloadStrategy = function(strategy, target) {
    var that = {};
