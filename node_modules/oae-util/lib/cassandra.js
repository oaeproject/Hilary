...
var dropColumnFamily = module.exports.dropColumnFamily = function(name, callback) {
    ...
    columnFamilyExists(name, function(err, exists) {
        ...
        runQuery(util.format('DROP TABLE "%s"', name), [], function(err) {
            ...
            // Helenus caches the CF schema internally and there is no way of refreshing it synchronously. To refresh it,
            // we close and re-open the connection pool, which makes it not suitable to use in production runtime!
