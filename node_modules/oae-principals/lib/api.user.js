...
module.exports.createUser = function(tenant, username, password, privacy, firstName, lastName, displayName, callback) {
    ...
    module.exports.getUser(id, function(err, user) {
        ...
        utils.hashPassword(password, function(hash) {
            ...
            // Create the group.
            cassandra.runQuery('INSERT INTO Principals (principal_id, tenant, privacy_setting, user_username, user_password, user_first_name, user_last_name, user_display_name) VALUES (?, ?, ?, ?, ?, ?, ?, ?)', 
                               [id, tenant.alias, privacy, username, hash, firstName, lastName, displayName], function (err) {
                if (err) {
