 ...
 */
var initializeDocs = (module.exports.initializeDocs = function(
  uiConfig,
  callback,
) {
...
var _parseDocs = function(dir, exclude, callback) {
  ...
  IO.getFileListForFolder(dir, function(err, fileNames) {
    if (err) {
      log().warn(
        { err: err, dir: dir },
        'Failed getting file list to parse dox documentation.',
      );
      return callback({
        code: 404,
 ...
 */
var getModuleDocumentation = (module.exports.getModuleDocumentation = function(
  moduleId,
  type,
  callback,
) {
