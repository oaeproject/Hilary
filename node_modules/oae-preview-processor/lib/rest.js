 ...
 * @FormParam   {string}            [content_resourceSubType]     Content of specified sub-type; may also be array                      [collabdoc,file,link]
 ...
 * @FormParam   {string}            [revision_mimeType]           Content of specified MIME type, e.g. application/pdf; may also be array
 * @FormParam   {string}            [revision_previewsStatus]     Content with any of specified preview status values; may also be array   [ignored,error]
 */
