...
describe('Messagebox', function() {
    ...
    describe('#createMessage', function() {
        ...
        it('verify creating a message', function(callback) {
            var messageBoxId = util.format('msg-box-test-%s', ShortId.generate());
            MessageBoxAPI.createMessage(messageBoxId, 'u:camtest:foo',
                'http://cambridge.oae.com/content/camtest/beta ' +
                'http://cambridge.oae.com/discussion/camtest/gamma ' +
                'http://cambridge.oae.com/folder/camtest/delta ' +
                'http://cambridge.oae.com/group/camtest/epsilon ', {}, function(err, message) {
                assert.ok(!err);
                ...
                MessageBoxAPI.getMessagesFromMessageBox(messageBoxId, null, null, null, function(err, messages) {
                    ...
                    verifyMessage(message.id,
                        '[/content/camtest/beta](/content/camtest/beta) ' +
                        '[/discussion/camtest/gamma](/discussion/camtest/gamma) ' +
                        '[/folder/camtest/delta](/folder/camtest/delta) ' +
                        '[/group/camtest/epsilon](/group/camtest/epsilon) ', null, messages);
                    callback();
                });
            });
        });
        ...
        it('verify updating a message', function(callback) {
            ...
            MessageBoxAPI.createMessage(messageBoxId, 'u:camtest:foo', 'alfa', {}, function(err, message) {
                ...
                MessageBoxAPI.getMessagesFromMessageBox(messageBoxId, null, null, null, function(err, messages) {
                    ...
                    // Update the message.
                    MessageBoxAPI.updateMessageBody(messageBoxId, message.created,
                        'http://cambridge.oae.com/content/camtest/beta ' +
                        'http://cambridge.oae.com/discussion/camtest/gamma ' +
                        'http://cambridge.oae.com/folder/camtest/delta ' +
                        'http://cambridge.oae.com/group/camtest/epsilon ', function(err) {
                        assert.ok(!err);
                        MessageBoxAPI.getMessagesFromMessageBox(messageBoxId, null, null, null, function(err, messages) {
                            assert.ok(!err);
                            ...
                            verifyMessage(message.id,
                                ...
                                '[/discussion/camtest/gamma](/discussion/camtest/gamma) ' +
                                '[/folder/camtest/delta](/folder/camtest/delta) ' +
                                '[/group/camtest/epsilon](/group/camtest/epsilon) ',
                                null, messages);
                            callback();
                        });
                    });
