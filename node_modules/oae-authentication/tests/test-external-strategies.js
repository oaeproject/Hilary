...
describe('Authentication', function() {
    ...
    describe('Google authentication', function() {
        ...
        var _assertGoogleLogin = function(email, expectSuccess, callback) {
            if (expectSuccess) {
                AuthenticationTestUtil.assertGoogleLoginSucceeds(global.oaeTests.tenants.localhost.host, email, callback);
            } else {
                AuthenticationTestUtil.assertGoogleLoginFails(global.oaeTests.tenants.localhost.host, email, 'domain_not_allowed', callback);
            }
        };
