...
MQ.on('postHandle', (err, queueName) => {
    _decrement(queueName, 1);
});

MQ.on('postPurge', (name, count) => {
 ...
 */
const whenTasksEmpty = module.exports.whenTasksEmpty = function(name, handler) {
