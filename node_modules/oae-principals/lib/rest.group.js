 ...
 * @FormParam  {string[]}      managers                Unique identifier(s) for manager(s) of the group
 * @FormParam  {string[]}      members                 Unique identifiers(s) for member(s) of the group
 * @FormParam  {string}        visibility              Visibility for group            [loggedin,private,public]
 * @Return      {Group}                                New group object
 */
 ...
 * @FormParam   {string}        canJoin             Can current user join group
 * @FormParam   {string}        description         Description of group
 * @FormParam   {string}        displayName         Name to display for group
 * @FormParam   {string}        id                  Unique identifier for group
 * @FormParam   {boolean}       isManager           Is current user manager of group
 * @FormParam   {boolean}       isMember            Is current user a member of group
 * @FormParam   {string}        joinable            Can users join group            [no,request,yes]
 * @FormParam   {number}        lastModified        Time information was last modified (epoch format)
 * @FormParam   {PictureInfo}   picture             Thumbnail information
 * @FormParam   {string}        profilePath         URL for group's main page
 * @FormParam   {string}        resourceType        Type of resource (group)
 * @FormParam   {Signature}     signature           Access control for group
 * @FormParam   {TenantInfo}    tenant              Tenant for group
 ...
 * @FormParam   {boolean}       {userId}            Should identified user be included in group, may be repeated for multiple users
 */
