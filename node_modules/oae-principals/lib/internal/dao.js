...
/**
 * Validate a user's email address and remove its token from the database
 *
 ...
 * @param  {Object}     callback.err    An error object, if any
 */
var validateEmailAddress = module.exports.validateEmailAddress = function(token, user, callback) {
    var queries = [];
