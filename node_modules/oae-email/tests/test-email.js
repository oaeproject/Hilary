...
describe('Emails', function() {
  ...
  describe('Templates', function() {
      ...
      TestsUtil.generateTestUsers(camAdminRestContext, 1, function(err, users) {
        ...
        EmailTestsUtil.sendEmail(
          ...
          function(err, message) {
            ...
            assert.equal(
              message.html,
              '<html><body><b>test html only</b></body></html>',
            );
                ...
                EmailTestsUtil.sendEmail(
                  ...
                  function(err, message) {
                    ...
                    assert.equal(
                      ...
                      util.format(
                        'noreply@%s',
                        mrvisser.restContext.hostHeader,
                      ),
                    );
     ...
     */
    it('verify html doesnt include the HTML5 entity for the apostrophe', function(callback) {
      TestsUtil.generateTestUsers(camAdminRestContext, 1, function(err, users) {
        assert.ok(!err);
        ...
        EmailTestsUtil.sendEmail(
          ...
          function(err, message) {
            ...
            assert.equal(message.text, "test html with ''apostrophes'' only");
      ...
      TestsUtil.generateTestUsers(camAdminRestContext, 1, function(err, users) {
        ...
        EmailTestsUtil.sendEmail(
          ...
          function(err, message) {
            ...
            assert.equal(err.code, 500);
            assert.strictEqual(
              err.msg.indexOf('Error parsing email metadata'),
              0,
            );
                  ...
                  function(err, message) {
                    ...
                    EmailTestsUtil.sendEmail(
                      ...
                      function(err, message) {
                        ...
                        assert.strictEqual(
                          err.msg.indexOf(
                            'Could not parse a suitable content template',
                          ),
                          0,
                        );
                        return callback();
  ...
  describe('Email configuration', function() {
    ...
    it('verify transport validation', function(callback) {
      EmailAPI.init(
        _createDefaultConfig({ debug: false, transport: 'wrong' }),
        function(err) {
          assert.equal(err.code, 400);
          ...
          EmailAPI.init(_createDefaultConfig(mailConfigOverrides), function(
            err,
          ) {
            assert.ok(!err);
              ...
              function(err, link) {
                ...
                EmailTestsUtil.collectAndFetchAllEmails(function(messages) {
                  ...
                  assert.equal(
                    ...
                    'The Cambridge Collaborative system',
                  );
                  assert.strictEqual(
                    messages[0].from[0].address,
                    'noreply@blahblahblah.com',
                  );
        ...
        RestAPI.Content.createLink(
          ...
          function(err, link) {
            ...
            EmailTestsUtil.collectAndFetchAllEmails(function(messages) {
              ...
              assert.ok(
                messages[0].headers['message-id'].match(transformedUserId),
              );
              return callback();
            });
          },
  ...
  describe('Email de-duplication', function() {
    ...
    it('verify de-duplication is limited to a configurable interval', function(callback) {
      TestsUtil.generateTestUsers(camAdminRestContext, 1, function(
        ...
        EmailAPI.init(
          _createDefaultConfig({ deduplicationInterval: 2 }),
          function(err) {
            assert.ok(!err);
            // Send out the first e-mail
            EmailTestsUtil.sendEmail(
  ...
  describe('Throttling', function() {
    ...
    it('verify email throttling', function(callback) {
      ...
      EmailAPI.init(
        _createDefaultConfig({ throttling: { timespan: 2, count: 2 } }),
        function(err) {
          TestsUtil.generateTestUsers(camAdminRestContext, 1, function(
            err,
            users,
