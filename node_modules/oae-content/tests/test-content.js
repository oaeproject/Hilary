...
describe('Content', function() {
     ...
     * @param    {Function}    callback       Standard callback function executed when all checks have finished
     */
    var postComments = function(contentId, contexts, numComments, callback) {
        ...
        /**
         * Returns a random user REST Context from the contexts passed in to `postComments`
        ...
        var postComment = function() {
            RestAPI.Content.postComment(getRandomCommenter(), contentId, getRandomComment(), function(err) {
                assert.ok(!err);
                if (numComments) {
                    numComments--;
                    postComment();
    ...
    describe('Commenting', function() {
            ...
            setUpUsers(function(contexts) {
                ...
                RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 1', 'Test content description 1', 'public', 'http://www.sakaiproject.org/',  [], [], function(err, contentObj) {
                    ...
                    RestAPI.Content.getContent(contexts['bert'].restContext, contentObj.contentId, function(err, retrievedContentObj) {
                        ...
                        // Create 50 comments
                        postComments(contentObj.contentId, contexts, 10, function() {
                            // Create one more and verify that it comes back as the first comment in the list
                            RestAPI.Content.postComment(contexts['bert'].restContext, contentObj.contentId, 'This comment should be on top of the list', function(err) {
                                ...
                                RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, '', 10, function(err, comments) {
                                    ...
                                    assert.equal(comments[0].createdBy.publicAlias, 'Bert Pareyn');
                                    callback();
                                });
                            });
                        });
            ...
            setUpUsers(function(contexts) {
                ...
                RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 1', 'Test content description 1', 'public', 'http://www.sakaiproject.org/',  [], [], function(err, contentObj) {
                    ...
                    RestAPI.Content.getContent(contexts['bert'].restContext, contentObj.contentId, function(err, retrievedContentObj) {
                        ...
                        // Create one more and verify that it comes back as the first comment in the list
                        RestAPI.Content.postComment(contexts['bert'].restContext, contentObj.contentId, 'This comment will get an update', function(err) {
                            ...
                            RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, '', 10, function(err, comments) {
                                ...
                                RestAPI.Content.updateComment(contexts['bert'].restContext, contentObj.contentId, comments[0].created, 'This is an updated comment', function(err) {
                                    assert.ok(!err);

                                    // Get the comment and verify that it was updated properly
                                    RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, '', 10, function(err, comments) {
                                        assert.ok(!err);
                                        assert.equal(comments.length, 1);
                                        assert.equal(comments[0].createdBy.publicAlias, 'Bert Pareyn');
                                        assert.equal(comments[0].comment, 'This is an updated comment');
            ...
            setUpUsers(function(contexts) {
                ...
                RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 1', 'Test content description 1', 'public', 'http://www.sakaiproject.org/',  [], [], function(err, contentObj) {
                    ...
                    RestAPI.Content.getContent(contexts['bert'].restContext, contentObj.contentId, function(err, retrievedContentObj) {
                        ...
                        RestAPI.Content.postComment(contexts['bert'].restContext, contentObj.contentId, 'This comment should be second in the list', function(err) {
                            assert.ok(!err);
                            ...
                            RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, '', 10, function(err, comments) {
                                ...
                                RestAPI.Content.postReply(contexts['bert'].restContext, contentObj.contentId, comments[0].created, 'Reply to second comment in the list', function(err) {
                                    assert.ok(!err);
                                    ...
                                    RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, '', 10, function(err, comments) {
                                        ...
                                        RestAPI.Content.postReply(contexts['bert'].restContext, contentObj.contentId, comments[1].created, 'A reply to the reply on the second comment in the list', function(err) {
                                            assert.ok(!err);

                                            // Add a second comment to the content item
                                            RestAPI.Content.postComment(contexts['bert'].restContext, contentObj.contentId, 'This comment should be first in the list', function(err) {
                                                assert.ok(!err);
                                                ...
                                                RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, '', 10, function(err, comments) {
                                                    ...
                                                    assert.equal(comments[0].level, '0'); // Last level 0 comment made
                                                    assert.equal(comments[1].level, '0'); // First level 0 comment made
                                                    assert.equal(comments[2].level, '1'); // First reply to first comment made
                                                    assert.equal(comments[3].level, '2'); // Reply to the reply

                                                    // Check that replies to a comment reference the correct comment
                                                    assert.equal(comments[1].created, comments[2].replyTo);
                                                    assert.equal(comments[2].created, comments[3].replyTo);
            ...
            setUpUsers(function(contexts) {
                ...
                RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 1', 'Test content description 1', 'public', 'http://www.sakaiproject.org/',  [], [], function(err, contentObj) {
                    ...
                    RestAPI.Content.getContent(contexts['bert'].restContext, contentObj.contentId, function(err, retrievedContentObj) {
                        ...
                        // Create a comment
                        RestAPI.Content.postComment(contexts['bert'].restContext, contentObj.contentId, 'This comment will be deleted.', function(err) {
                            ...
                            RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, '', 10, function(err, comments) {
                                ...
                                // Delete the comment
                                RestAPI.Content.deleteComment(contexts['bert'].restContext, contentObj.contentId, comments[0].created, function(err) {
                                    assert.ok(!err);
        ...
        /**
         * Test that will test the validation for comments
         */
        it('verify comment validation', function(callback) {
            setUpUsers(function(contexts) {
                // Create a piece of content
                RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 1', 'Test content description 1', 'public', 'http://www.sakaiproject.org/',  [], [], function(err, contentObj) {
                    assert.ok(!err);
                    ...
                    RestAPI.Content.getContent(contexts['bert'].restContext, contentObj.contentId, function(err, retrievedContentObj) {
                        ...
                        RestAPI.Content.postComment(contexts['bert'].restContext, null, 'This comment should be on top of the list', function(err) {
                            assert.ok(err);
                            assert.equal(err.code, 400);

                            // Try to create a comment without a comment
                            RestAPI.Content.postComment(contexts['bert'].restContext, contentObj.contentId, null, function(err) {
                                assert.ok(err);
                                assert.equal(err.code, 400);
                                ...
                                // Try to get the comments for a content item without specifying the content ID
                                 RestAPI.Content.getComments(contexts['bert'].restContext, null, '', 10, function(err, comments) {
                                    ...
                                    // Try to get the comments for a content item without specifying a valid limit
                                    RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, '', 'test', function(err, comments) {
                                        assert.ok(err);
                                        assert.equal(err.code, 400);

                                       // Try to post a reply without a content ID
                                        RestAPI.Content.postReply(contexts['bert'].restContext, null, '1231654351', 'This is an updated comment', function(err) {
                                            assert.ok(err);

                                            // Try to post a reply without a creation date of the comment to update
                                            RestAPI.Content.postReply(contexts['bert'].restContext, 'contentId', null, 'This is an updated comment', function(err) {
                                                assert.ok(err);

                                                // Try to post a reply without a comment
                                                RestAPI.Content.postReply(contexts['bert'].restContext, 'contentId', '1231654351', null, function(err) {
                                                    assert.ok(err);

                                                    // Try to post an update without a content ID
                                                    RestAPI.Content.updateComment(contexts['bert'].restContext, null, '1231654351', 'This is an updated comment', function(err) {
                                                        assert.ok(err);

                                                        // Try to post an update without a creation date of the comment to update
                                                        RestAPI.Content.updateComment(contexts['bert'].restContext, 'contentId', null, 'This is an updated comment', function(err) {
                                                            assert.ok(err);

                                                            // Try to post an update without a comment
                                                            RestAPI.Content.updateComment(contexts['bert'].restContext, 'contentId', '1231654351', null, function(err) {
                                                                assert.ok(err);

                                                                // Delete a comment without specifying a valid contentId
                                                                RestAPI.Content.deleteComment(contexts['bert'].restContext, null, '652312465', function(err) {
                                                                    assert.ok(err);

                                                                    // Delete a comment without specifying a valid creation date for the comment
                                                                    RestAPI.Content.deleteComment(contexts['bert'].restContext, 'contentid', null, function(err) {
                                                                        assert.ok(err);
                                                                        callback();
                                                                    });
                                                                });
