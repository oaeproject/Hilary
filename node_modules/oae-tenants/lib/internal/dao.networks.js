...
var _getAllTenantNetworkTenantAliasesFromCassandra = function(tenantNetworkIds, callback) {
    ...
    Cassandra.runQuery('SELECT "tenantNetworkId", "tenantAlias" FROM "TenantNetworkTenants" WHERE "tenantNetworkId" IN ?', [tenantNetworkIds], function(err, rows) {
        if (err) {
            return callback(err);
        }
        ...
        _.chain(rows).map(Cassandra.rowToHash).each(function(rowHash) {
