 ...
 */
var collectAndGetActivityStream = module.exports.collectAndGetActivityStream = function(restCtx, resourceId, opts, callback) {
 ...
 */
var assertGetActivityStreamFails = module.exports.assertGetActivityStreamFails = function(restCtx, resourceId, opts, code, callback) {
    RestAPI.Activity.getActivityStream(restCtx, resourceId, opts, function(err, activityStream) {
        assert.ok(err);
...
var parseActivityHtml = module.exports.parseActivityHtml = function(html) {
    ...
    $('tr.activity-row').each(function() {
        var $activity = $(this);
        var $summary = $activity.find('.activity-summary-container > div:first-child');
 ...
 */
var waitForPushActivity = module.exports.waitForPushActivity = function(client, activityType, verb, actorId, objectId, targetId, callback) {
    ...
    var _onMessage = function(message) {
        var targetActivity = _.find(message.activities, function(activity) {
            if (activity[ActivityConstants.properties.OAE_ACTIVITY_TYPE] !== activityType) {
                ...
                return false;
            } else if (activity.actor[ActivityConstants.properties.OAE_ID] !== actorId) {
                return false;
            } else if (objectId && activity.object[ActivityConstants.properties.OAE_ID] !== objectId) {
                return false;
            } else if (targetId) {
                if (!activity.target) {
                    return false;
                } else if (activity.target[ActivityConstants.properties.OAE_ID] !== targetId) {
                    return false;
                }
            }
