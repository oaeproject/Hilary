...
module.exports = function(config, callback) {
    ...
    ensureSchema(function(err) {
        ...
        TenantsAPI.initializeTenantMiddleware(config, callback);
    });
};
...
var ensureSchema = function(callback) {
    Cassandra.createColumnFamily('Tenant', 'CREATE COLUMNFAMILY Tenant (alias text PRIMARY KEY, displayName text, host text, active boolean, deleted boolean);', callback);
};
