 ...
 * @Property    {ActivityImage} image                   Display image for actor
 * @Property    {string}        oae:id                  Unique identifier for actor
 * @Property    {Object[]}      oae:collection          Array of actors (instead of the individual properties in this model)
 * @Property    {string}        oae:profilePath         Path to actor's profile in OAE
 * @Property    {BasicTenant}   oae:tenant              Tenant of actor
 ...
 * @Property    {ActivityImage} image                   Display image for object
 * @Property    {Object[]}      oae:collection          Array of objects (instead of the individual properties in this model)
 ...
 * @Property    {Picture}       oae:thumbnail           Thumbnail image for object
 * @Property    {string}        oae:visibility          Visibility of object [loggedin,private,public]
 * @Property    {ActivityImage} oae:wideImage           Display image for object
 ...
 * @Property    {string}        id                      API URL for target
 * @Property    {ActivityImage} image                   Display image for target
 * @Property    {Object[]}      oae:collection          Array of targets (instead of the individual properties in this model)
 * @Property    {string}        oae:id                  Unique identifier for target
 * @Property    {string}        oae:joinable            Can current user join group [no,request,yes]
 * @Property    {string}        oae:profilePath         Path to target's profile in OAE
 * @Property    {string}        oae:resourceSubType     Subtype of content object [collabdoc,file,link]
 * @Property    {string}        oae:revisionId          Unique identifier for revision of content object
 * @Property    {BasicTenant}   oae:tenant              Tenant of target
 * @Property    {Picture}       oae:thumbnail           Thumbnail image for target
 * @Property    {string}        oae:visibility          Visibility of target [loggedin,private,public]
 * @Property    {ActivityImage} oae:wideImage           Display image for object
 * @Property    {string}        objectType              Type of target [collection,content,content-comment,discussion,discussion-message,group,user]
 * @Property    {string}        url                     Full URL to target's profile in OAE
 */
