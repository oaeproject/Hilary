...
var _ensureSchema = function(callback) {
    ...
    Cassandra.createColumnFamilies({
        ...
        // 
        'GroupJoinRequestsByGroup': 'CREATE TABLE "GroupJoinRequestsByGroup" ("groupId" text, "principalId" text, "created_at" text, "updated_at" text, "status" text, PRIMARY KEY ("groupId", "principalId"))'
