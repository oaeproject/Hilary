...
OAE.tenantServer.get('/api/auth/google/callback', function(req, res, next) {
    ...
    var strategyId = AuthenticationUtil.getStrategyId(req.tenant, AuthenticationConstants.providers.GOOGLE);
    passport.authenticate(strategyId, {'successRedirect': '/', 'failureRedirect': '/'})(req, res, _handlePassportError(req, res, next));
});
...
OAE.tenantServer.get('/api/auth/saml2', function(req, res, next) {
    ...
    var strategyId = AuthenticationUtil.getStrategyId(req.tenant, AuthenticationConstants.providers.SAML2);
    passport.authenticate(strategyId)(req, res, _handlePassportError(req, res, next));
});
