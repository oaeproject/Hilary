...
var resolveEffectivePermissions = module.exports.resolveEffectivePermissions = function(ctx, resource, callback) {
    AuthzAPI.resolveEffectiveRole(ctx.user(), resource, AuthzConstants.role.ALL_PRIORITY, function(err, effectiveRole, canInteract) {
        ...
        var canInteract = canInteract || (resource.joinable === AuthzConstants.joinable.REQUEST);
        var canView = _.isString(effectiveRole) || (resource.joinable === AuthzConstants.joinable.REQUEST);
        ...
        var canJoin = (canInteract && (resource.joinable === AuthzConstants.joinable.YES)) || (resource.joinable === AuthzConstants.joinable.REQUEST);
        var canRequest = (resource.joinable === AuthzConstants.joinable.REQUEST);
