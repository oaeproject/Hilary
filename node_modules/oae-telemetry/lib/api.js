 ...
 * @param {Regexp}  regex   A regex that can be used to match a request against a URL. Keep in mind that the first regex that matches when checking will be used. This means that the order you call registerURL is important.
