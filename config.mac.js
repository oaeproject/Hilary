...
config.previews.office.binary = '/Applications/LibreOffice.app/Contents/MacOS/soffice';
config.previews.office.timeout = 300000;
config.previews.pdf2htmlEX.timeout = 300000;
config.previews.pdftotext.timeout = 30000;
config.previews.link.renderDelay = 30000;
config.previews.link.renderTimeout = 30000;
config.previews.link.embeddableCheckTimeout = 30000;
