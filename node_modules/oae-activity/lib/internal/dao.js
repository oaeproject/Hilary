...
var getActivities = module.exports.getActivities = function(activityStreamId, start, limit, callback) {
    ...
    Cassandra.runPagedColumnQuery('ActivityStreams', 'activityStreamId', activityStreamId, start, limit, {'reversed': true, 'consistency': 'ONE'}, function(err, row, startMatched, nextToken) {
        if (err) {
            return callback(err);
        }

        return callback(null, _rowToActivities(row), nextToken);
    });
};
