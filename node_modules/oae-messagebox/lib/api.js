...
var _storageHashToMessage = function(messageId, hash) {
    ...
    if (hash.threadKey) {
        ...
        var replyTo = _parseReplyToIdFromThreadKey(messageBoxId, threadKey);
...
/**
 * Given a messagebox id and threadKey, determine the message to which it is a reply, if applicable
 *
 * @param  {String}     messageBoxId    The messagebox id
 * @param  {String}     threadKey       The threadKey to parse
 * @return {String}                     The id of the message to which the specified threadKey is a reply. If not a reply, this will return null
 * @api private
 */
var _parseReplyToIdFromThreadKey = function(messageBoxId, threadKey) {
