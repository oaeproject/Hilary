 ...
 */
const deleteAll = module.exports.deleteAll = function(callback) {
 ...
 */
const reindexAll = module.exports.reindexAll = function(globalAdminRestCtx, callback) {
 ...
 */
const assertSearchSucceeds = module.exports.assertSearchSucceeds = function(restCtx, searchType, params, opts, callback) {
    whenIndexingComplete(() => {
 ...
 */
const assertSearchContains = module.exports.assertSearchContains = function(restCtx, searchType, params, opts, containIds, callback) {
 ...
 */
const assertSearchNotContains = module.exports.assertSearchNotContains = function(restCtx, searchType, params, opts, notContainIds, callback) {
    searchAll(restCtx, searchType, params, opts, (err, response) => {
        assert.ok(!err);
 ...
 */
const assertSearchEquals = module.exports.assertSearchEquals = function(restCtx, searchType, params, opts, expectedIds, callback) {
    searchAll(restCtx, searchType, params, opts, (err, response) => {
        assert.ok(!err);
 ...
 */
const assertSearchFails = module.exports.assertSearchFails = function(restCtx, searchType, params, opts, httpCode, callback) {
    whenIndexingComplete(() => {
