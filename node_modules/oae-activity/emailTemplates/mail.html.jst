                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <% if (shared.isEmail(recipient.id)) { %>
                                                <div class="activity-invitation-container">
                                                    <%
                                                        var tokenUrlEncoded = encodeURIComponent(recipient.token);
                                                        var emailUrlEncoded = encodeURIComponent(recipient.email);
                                                    %>
                                                    <p>Hey, maybe you'd like to <a href="<%= baseUrl %>/me?invitationToken=<%= util.html.encodeForHTMLAttribute(tokenUrlEncoded) %>&invitationEmail=<%= util.html.encodeForHTMLAttribute(emailUrlEncoded) %>">accept the invitation.</a>
                                                </div>
                                            <% } %>
