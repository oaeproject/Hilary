 ...
 * @Method      GET
 * @Path        /tenantNetworks
 * @Return      {TenantNetworks}                Tenant networks and their associated tenants
 */
 ...
 * @Return      {TenantNetwork}                         (via HTTP status 201) object representing newly created network
 */
 ...
 * @FormParam   {string}                displayName     Display name for tenant network
 * @Return      {TenantNetwork}                         Updated network
 */
 ...
 * @FormParam   {string[]}                  alias       Tenant or array of tenants identified by short alias
 */
 ...
 * @Method      GET
 * @Path        /tenants
 * @Return      {Tenants}                       Tenants defined for server
 */
 ...
 * @Method      GET
 * @Path        /tenant
 * @Return      {Tenant}                        Information about the current tenant
 */
 ...
 * @Return      {Tenant}                        Information about the specified tenant
 */
 ...
 * @Method      POST
 * @Path        /tenant/start
 * @FormParam   {string[]}          aliases         Tenant or array of tenants identified by short alias
 */
