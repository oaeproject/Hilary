...
describe('Meeting libraries', function() {
  ...
  var checkLibrary = function(
    ...
    RestAPI.MeetingsJitsi.getMeetingsLibrary(restCtx, libraryOwnerId, function(
      err,
      items,
    ) {
      if (!expectAccess) {
        ...
        _.each(expectedItems, function(expectedMeeting) {
          assert.ok(
            _.filter(items.results, function(meeting) {
  ...
  describe('User libraries', function() {
    ...
    it('should send all the meeting library items for the owner of the library', function(callback) {
      checkLibrary(
        ...
        true,
        [
          users.private.privateMeeting,
          users.private.loggedinMeeting,
          users.private.publicMeeting,
        ],
        function() {
          checkLibrary(
  ...
  describe('Group libraries', function() {
    ...
    beforeEach(function(callback) {
      createGroupAndLibrary(camAdminRestCtx, 'private', function(
        group,
        privateMeeting,
        loggedinMeeting,
        publicMeeting,
        ...
        createGroupAndLibrary(camAdminRestCtx, 'loggedin', function(
          group,
          privateMeeting,
          loggedinMeeting,
          publicMeeting,
          ...
          createGroupAndLibrary(camAdminRestCtx, 'public', function(
            group,
            privateMeeting,
            loggedinMeeting,
            publicMeeting,
    ...
    it('should send all the meeting library items for a member of the group', function(callback) {
      checkLibrary(
        ...
        [
          groups.public.publicMeeting,
          groups.public.loggedinMeeting,
          groups.public.privateMeeting,
        ],
        function() {
          checkLibrary(
            camAdminRestCtx,
