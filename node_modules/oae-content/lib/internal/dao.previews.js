 ...
 */
var getContentPreviews = (module.exports.getContentPreviews = function(
  revisionId,
  callback,
) {
  Cassandra.runQuery(
 ...
 */
var getContentPreview = (module.exports.getContentPreview = function(
  revisionId,
  previewItem,
  callback,
) {
 ...
 */
var getPreviewUris = (module.exports.getPreviewUris = function(
  revisionIds,
  callback,
) {
 ...
 * @param  {Object}      callback.err    An error that occurred, if any
 */
var storeMetadata = (module.exports.storeMetadata = function(
  contentObj,
  revisionId,
  status,
  thumbnailUri,
  ...
  _.each(fileData, function(value, name) {
    ...
    queries.push({
      query:
        'INSERT INTO "PreviewItems" ("revisionId", "name", "value") VALUES (?, ?, ?)',
 ...
 * @api private
 */
var copyPreviewItems = (module.exports.copyPreviewItems = function(
  fromRevisionId,
  toRevisionId,
  callback,
) {
...
var _getUriInFileData = function(fileData, size) {
  var file = _.find(fileData, function(val, filename) {
