...
/*!
 * When a content item is updated, we need to rebuild all the folders that
 * contain it. This ensure that the content item is not leaked in the folder
 * libraries when its visibility is changed to something less open.
 */
