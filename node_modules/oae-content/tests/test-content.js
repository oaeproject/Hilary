                                                                ...
                                                                RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.id, null, 10, function(err, comments) {
                                                                    ...
                                                                    createComments(contexts, contentObj.id, 10, comments.results[5].created, function() {
                                                                        ...
                                                                        RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.id, null, 10, function(err, comments) {
                                                                            ...
                                                                            assert.equal(comments.results[0].level, 0); // First 6 comments are level 0 comments
                                                                            assert.equal(comments.results[1].level, 0); // First 6 comments are level 0 comments
                                                                            assert.equal(comments.results[2].level, 0); // First 6 comments are level 0 comments
                                                                            assert.equal(comments.results[3].level, 0); // First 6 comments are level 0 comments
                                                                            assert.equal(comments.results[4].level, 0); // First 6 comments are level 0 comments
                ...
                RestAPI.Content.createFile(contexts['nicolaas'].restContext, 'Test Content 2', 'Test content description 2', 'public', getFileStream, [], [], function(err, contentObj) {
                    ...
                    RestAPI.Content.getRevisions(contexts['nicolaas'].restContext, contentObj.id, null, null, function(err, revisions) {
                        ...
                        RestAPI.Content.getRevision(contexts['nicolaas'].restContext, contentObj.id, revisions[0].revisionId, function(err, revision) {
                            ...
                            assert.equal(revision.filename, 'sakaiger.png');
                            assert.equal(revision.mime, 'image/png');


                            // Upload a new version.
                            RestAPI.Content.updateFileBody(contexts['nicolaas'].restContext, contentObj.id, getSakaiLogoStream, function(err, updatedContentObj, response) {
                                assert.ok(!err);
                                ...
                                RestAPI.Content.getRevisions(contexts['nicolaas'].restContext, contentObj.id, null, null, function(err, revisions) {
                                    ...
                                    RestAPI.Content.getRevision(contexts['nicolaas'].restContext, contentObj.id, revisions[0].revisionId, function(err, revision) {
                                        assert.ok(!err);
                                        assert.equal(revision.filename, 'sakai-logo.png');
                                        assert.equal(revision.mime, 'image/png');
            ...
            setUpUsers(function(contexts) {
                ...
                RestAPI.Content.createFile(contexts['simon'].restContext, 'Test Content', 'Test content description', 'private', getFileStream,  [], [], function(err, contentObj) {
                    ...
                    var createRevisions = function(callback) {
                        RestAPI.Content.updateFileBody(contexts['simon'].restContext, contentObj.id, getSakaiLogoStream, function(err, revision) {
                            assert.ok(!err);
