...
describe('General Search', function() {
    ...
    describe('Content Search', function() {
        ...
        /**
         * Simple test that ensures that when on a tenant that enabled the tenant permeability feature,
         * you can only find content from tenants who have also enabled the feature.
         */
        it('verify content from non-permeable tenants do not show up in external searches', function(callback) {
    ...
    describe('User Search Visibility', function() {
        ...
        /**
         * Simple test that ensures that when on a tenant that enabled the tenant permeability feature,
         * you can only find users from tenants who have also enabled the feature.
         */
    ...
    describe('Group Search Visibility', function() {
        ...
        /**
         * Simple test that ensures that when on a tenant that enabled the tenant permeability feature,
         * you can only find groups from tenants who have also enabled the feature.
         */
