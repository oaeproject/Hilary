...
OAE.tenantRouter.on('get', '/api/group/:groupId', function(req, res) {
  PrincipalsAPI.getFullGroupProfile(req.ctx, req.params.groupId, function(
    err,
    group,
  ) {
    if (err) {
...
OAE.tenantRouter.on('post', '/api/group/:groupId', function(req, res) {
  ...
  PrincipalsAPI.updateGroup(req.ctx, req.params.groupId, req.body, function(
    err,
    updatedGroup,
  ) {
    if (err) {
...
OAE.tenantRouter.on('post', '/api/group/:groupId/members', function(req, res) {
  ...
  PrincipalsAPI.setGroupMembers(req.ctx, req.params.groupId, members, function(
    err,
  ) {
    if (err) {
      return res.status(err.code).send(err.msg);
 ...
 */
OAE.tenantRouter.on('get', '/api/group/:groupId/invitations', function(
  req,
  res,
) {
  PrincipalsAPI.getGroupInvitations(req.ctx, req.params.groupId, function(
    err,
    invitations,
  ) {
    if (err) {
...
OAE.tenantRouter.on(
  'post',
  '/api/group/:groupId/invitations/:email/resend',
  function(req, res) {
    PrincipalsAPI.resendGroupInvitation(
      req.ctx,
      req.params.groupId,
      req.params.email,
      function(err) {
