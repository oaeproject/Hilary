 ...
 * @param  {Object} version             Hilary version
 * @param  {Object} tenantAlias         The alias of the current tenant
 * @param  {Object} groupDisplayName    The display name of the group
 * @param  {Object} isGroupManager      Boolean holding whether the user is a manager or not
 * @param  {String} groupId             The globally unique id for the group that owns the tool
 * @param  {Object} principal           The object representing the user launching the tool
*/
module.exports.LtiLaunchParams = function (tool, version, tenantAlias, groupDisplayName, isGroupManager, groupId, principal) {
