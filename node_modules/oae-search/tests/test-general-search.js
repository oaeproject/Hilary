    ...
    describe('Search Scopes', function() {
        ...
        it('verify the _my search scope searches only items to which the current user is explicitly associated', function(callback) {
            TestsUtil.setupMultiTenantPrivacyEntities(function(publicTenant0, publicTenant1, privateTenant0, privateTenant1) {
                ...
                PrincipalsTestUtil.assertSetGroupMembersSucceeds(publicTenant1.adminRestContext, publicTenant1.publicGroup.id, memberUpdate, function() {
                    PrincipalsTestUtil.assertSetGroupMembersSucceeds(publicTenant0.adminRestContext, publicTenant0.privateGroup.id, memberUpdate, function() {
            ...
            RestAPI.User.createUser(gtAdminRestContext, darthVaderUsername, 'password', 'Darth Vader', null, function(err, darthVader) {
                ...
                RestAPI.User.createUser(camAdminRestContext, jackUsername, 'password', uniqueString, jackOpts, function(err, jack) {
                    ...
                    RestAPI.User.createUser(camAdminRestContext, janeUsername, 'password', 'Janey McJaneFace', null, function(err, jane) {
                        ...
                        SearchTestsUtil.searchRefreshed(darthVaderRestContext, 'general', null, {'resourceTypes': 'user', 'q': uniqueString, 'scope': global.oaeTests.tenants.gt.alias}, function(err, results) {
                            assert.ok(!err);
