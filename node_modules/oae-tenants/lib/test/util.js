...
var generateTestTenants = module.exports.generateTestTenants = function(globalAdminRestCtx, numToCreate, callback, _created) {
    ...
    createTenantAndWait(globalAdminRestCtx, alias, description, host, null, function(err, tenant) {
        assert.ok(!err);
 ...
 */
var createTenantAndWait = module.exports.createTenantAndWait = function(globalAdminRestCtx, alias, displayName, host, opts, callback) {
    RestAPI.Tenants.createTenant(globalAdminRestCtx, alias, displayName, host, opts, function(err, tenant) {
        if (err) {
            return callback(err);
        }
