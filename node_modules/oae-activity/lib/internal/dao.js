...
var queueUsersForEmail = module.exports.queueUsersForEmail = function(users, callback) {
    ...
    var queries = _.map(users, function(user) {
 ...
 */
var getQueuedUserIdsForEmail = module.exports.getQueuedUserIdsForEmail = function(bucketNumber, emailPreference, hour, start, limit, callback) {
