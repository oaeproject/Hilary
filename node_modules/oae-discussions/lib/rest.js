...
OAE.tenantRouter.on('post', '/api/discussion/create', (req, res) => {
    ...
    DiscussionsAPI.Discussions.createDiscussion(req.ctx, req.body.displayName, req.body.description, req.body.visibility, roles, null, (err, discussion) => {
        if (err) {
...
OAE.tenantRouter.on('get', '/api/discussion/library/:principalId', (req, res) => {
    ...
    DiscussionsAPI.Discussions.getDiscussionsLibrary(req.ctx, req.params.principalId, req.query.start, limit, (err, discussions, nextToken) => {
        if (err) {
            return res.status(err.code).send(err.msg);
        }
...
OAE.tenantRouter.on('delete', '/api/discussion/library/:principalId/:discussionId', (req, res) => {
    DiscussionsAPI.Discussions.removeDiscussionFromLibrary(req.ctx, req.params.principalId, req.params.discussionId, (err) => {
        if (err) {
            return res.status(err.code).send(err.msg);
        }
...
OAE.tenantRouter.on('get', '/api/discussion/:discussionId/members', (req, res) => {
    ...
    DiscussionsAPI.Discussions.getDiscussionMembers(req.ctx, req.params.discussionId, req.query.start, limit, (err, members, nextToken) => {
        if (err) {
            return res.status(err.code).send(err.msg);
        }
...
OAE.tenantRouter.on('get', '/api/discussion/:discussionId/messages', (req, res) => {
    const limit = OaeUtil.getNumberParam(req.query.limit, 10, 1, 25);
    DiscussionsAPI.Discussions.getMessages(req.ctx, req.params.discussionId, req.query.start, limit, (err, messages, nextToken) => {
        if (err) {
            return res.status(err.code).send(err.msg);
        }
...
OAE.tenantRouter.on('post', '/api/discussion/:discussionId/messages', (req, res) => {
    DiscussionsAPI.Discussions.createMessage(req.ctx, req.params.discussionId, req.body.body, req.body.replyTo, (err, message) => {
        if (err) {
            return res.status(err.code).send(err.msg);
        }
