...
var canShare = module.exports.canShare = function(ctx, resource, targets, role, callback) {
    ...
    resolveEffectivePermissions(ctx, resource, function(err, permissions) {
        ...
        validateRoleChanges(ctx, resource, targets, {'promoteOnly': true}, function(err, memberChangeInfo, emailChangeInfo) {
            if (err) {
                return callback(err);
...
var canJoin = module.exports.canJoin = function(ctx, resource, callback) {
    ...
    canInteract(ctx, resource, function(err) {
        ...
        validateRoleChanges(ctx, resource, targetRoles, {'promoteOnly': false}, function(err, memberChangeInfo) {
            if (err) {
                return callback(err);
...
var canSetRoles = module.exports.canSetRoles = function(ctx, resource, targetRoles, callback) {
    canManage(ctx, resource, function(err) {
        ...
        validateRoleChanges(ctx, resource, targetRoles, {'promoteOnly': false}, function(err, memberChangeInfo, emailChangeInfo) {
            if (err) {
                return callback(err);
...
var canCreate = module.exports.canCreate = function(ctx, targetRoles, callback) {
    ...
    validateRoleChanges(ctx, null, targetRoles, {'promoteOnly': false}, function(err, memberChangeInfo, emailChangeInfo) {
        if (err) {
            return callback(err);
        }
 ...
 * @api private
 */
var validateRoleChanges = function(ctx, resource, targetRoles, opts, callback) {
