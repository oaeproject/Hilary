...
// Swagger calls the schema for a JSON object a model. Documentation for any object we accept as a parameter or return as a result gets stored in here
var models = {};
// Swagger calls REST endpoints resources. We keep the documentation for the endpoints here
var tenantResources = {};
var adminResources = {};
...
var documentModule = module.exports.documentModule = function(moduleName, callback) {
    var files = [];
    readdirp({'root': util.format('node_modules/%s/lib', moduleName), 'fileFilter': '*.js'})
...
var _appendToApi = function(rootResource, api, spec) {
    ...
    spec.responseClass = spec.responseClass || 'void';
...
var _recurseModel = function(resource, modelName) {
    ...
    if (!model || resource.models[modelName]) {
        return;
    }
    log().trace('Recursively adding ' + modelName);
