...
describe('OAE Util', function() {
    ...
    describe('#getObjectProperty', function() {
        ...
        /**
         * Test that verifies a variety of inputs for getObjectProperty
         */
        it('verify a variety of inputs for getObjectProperty', function(callback) {
            var data = {
                'people': {
                    'simon': {
                        'name': {
            ...
            // Assert valid expressions
            assert.strictEqual(OaeUtil.getObjectProperty(data, 'people.simon.name.first', 'Nico'), 'Simon');
            assert.strictEqual(OaeUtil.getObjectProperty(data, 'foo', 'Nico'), 'bar');

            // Assert that expressions that do not exist in the object return the default value
            assert.strictEqual(OaeUtil.getObjectProperty(data, 'non.existing.property', 'Nico'), 'Nico');
            assert.strictEqual(OaeUtil.getObjectProperty(data, 'nothing', 'Nico'), 'Nico');
            assert.strictEqual(OaeUtil.getObjectProperty(data, '', 'Nico'), 'Nico');
            assert.strictEqual(OaeUtil.getObjectProperty(data, null, 'Nico'), 'Nico');
            return callback();
        });
    });
});
