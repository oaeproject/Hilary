                ...
                verifyShare(publicTenantB.adminRestCtx, publicTenantB.publicContent, publicTenantA.publicGroup.id, publicTenantA.publicUser.restCtx, 200, function() {
                    verifyShare(publicTenantB.adminRestCtx, publicTenantB.loggedinContent, publicTenantA.publicGroup.id, publicTenantA.publicUser.restCtx, 200, function() {
                        verifyShare(publicTenantB.adminRestCtx, publicTenantB.privateContent, publicTenantA.publicGroup.id, publicTenantA.publicUser.restCtx, 200, function() {
                            ...
                            // These cases should fail.
                            verifyShare(publicTenantB.adminRestCtx, publicTenantB.publicContent, privateTenantA.loggedinGroup.id, privateTenantA.loggedinUser.restCtx, 400, function() {
                                verifyShare(publicTenantB.adminRestCtx, publicTenantB.loggedinContent, privateTenantA.loggedinGroup.id, privateTenantA.loggedinUser.restCtx, 400, function() {
                                    verifyShare(publicTenantB.adminRestCtx, publicTenantB.privateContent, privateTenantA.loggedinGroup.id, privateTenantA.loggedinUser.restCtx, 400, function() {
                                        verifyShare(publicTenantB.adminRestCtx, publicTenantB.publicContent, privateTenantA.privateGroup.id, privateTenantA.privateUser.restCtx, 400, function() {
                                            verifyShare(publicTenantB.adminRestCtx, publicTenantB.loggedinContent, privateTenantA.privateGroup.id, privateTenantA.privateUser.restCtx, 400, function() {
                                                verifyShare(publicTenantB.adminRestCtx, publicTenantB.privateContent, privateTenantA.privateGroup.id, privateTenantA.privateUser.restCtx, 400, function() {
