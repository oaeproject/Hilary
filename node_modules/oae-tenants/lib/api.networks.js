...
var getTenantNetworks = (module.exports.getTenantNetworks = function(
  ...
  TenantNetworksDAO.getAllTenantNetworks(function(err, tenantNetworks) {
    ...
    TenantNetworksDAO.getAllTenantNetworkTenantAliases(function(
      err,
      tenantNetworkTenantAliases,
    ) {
      if (err) {
        return callback(err);
      }
      ...
      _.each(tenantNetworks, function(tenantNetwork, tenantNetworkId) {
        ...
        tenantNetwork.tenants = _.chain(
          tenantNetworkTenantAliases[tenantNetworkId],
        )
...
var updateTenantNetwork = (module.exports.updateTenantNetwork = function(
  ...
  validator
    ...
    .isGlobalAdministratorUser(ctx);
  validator
    .check(id, { code: 400, msg: 'Must specify a tenant network id' })
    .notEmpty();
  validator
    .check(displayName, {
      code: 400,
...
var addTenantAliases = (module.exports.addTenantAliases = function(
  ...
  return TenantNetworksDAO.addTenantAliases(
    tenantNetworkId,
    tenantAliases,
    callback,
  );
...
var removeTenantAliases = (module.exports.removeTenantAliases = function(
  ...
  return TenantNetworksDAO.removeTenantAliases(
    tenantNetworkId,
    tenantAliases,
    callback,
  );
