...
describe('TZ', function() {
    ...
    describe('#getRailsTimeZoneFromTZInfo()', function() {
        ...
        it('verify proper rails conversion', function() {
            ...
            assert.equal(TZ.getClosestSupportedTimezone('Canada/Yukon'), 'America/Los_Angeles');
            assert.equal(TZ.getClosestSupportedTimezone('Europe/Zurich'), 'Europe/Amsterdam');
        });
    });
