...
describe('Content Libraries', function() {
  ...
  beforeEach(function() {
    ...
    gtAnonymousRestCtx = TestsUtil.createTenantAdminRestContext(
      global.oaeTests.tenants.gt.host,
    );
    gtAdminRestCtx = TestsUtil.createTenantAdminRestContext(
      global.oaeTests.tenants.gt.host,
    );
  ...
  it('verify getLibrary parameter validation', function(callback) {
    TestsUtil.generateTestUsers(camAdminRestCtx, 1, function(err, users) {
      ...
      RestAPI.Content.getLibrary(simon.restContext, ' ', null, null, function(
        err,
        data,
      ) {
  ...
  var checkLibrary = function(
    ...
    RestAPI.Content.getLibrary(restCtx, libraryOwnerId, null, null, function(
      err,
      items,
    ) {
      if (!expectAccess) {
