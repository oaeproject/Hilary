 ...
 * @FormParam   {string}        role                The role the viewers should be assigned
 * @Return      {void}
...
OAE.tenantRouter.on('post', '/api/content/:contentId/share', function(req, res) {
    ...
    req.body.viewers = OaeUtil.toArray(req.body.viewers);
    ContentAPI.shareContent(req.ctx, req.params.contentId, req.body.viewers, req.body.role, function(err) {
        if (err) {
            return res.send(err.code, err.msg);
        }
        res.send(200);
