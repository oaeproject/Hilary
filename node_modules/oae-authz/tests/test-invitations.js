...
describe('Invitations', function() {
  ...
  var _partialWithFns = function(firstFn) {
    ...
    return function() {
      ...
      var firstFnPartial = _.partial.apply(
        null,
        [firstFn].concat(firstArgsApplied),
      );
  ...
  var resourceFns = {
    content: {
      ...
      deleteSucceeds: function(
        adminRestContext,
        deleterRestContext,
        contentId,
        callback,
      ) {
        ContentTestUtil.assertDeleteContentSucceeds(
          deleterRestContext,
          contentId,
          callback,
        );
  ...
  describe('Set Roles', function() {
    describe('Content', function() {
       ...
       */
      it('verify removing one of multiple content invitations for an email', function(callback) {
    ...
    describe('Discussion', function() {
       ...
       */
      it('verify removing one of multiple discussion invitations for an email', function(callback) {
    ...
    describe('Folder', function() {
       ...
       */
      it('verify removing one of multiple folder invitations for an email', function(callback) {
    ...
    describe('Group', function() {
       ...
       */
      it('verify removing one of multiple group invitations for an email', function(callback) {
  ...
  describe('Email', function() {
    ...
    it('verify email invitation links to the proper tenant based on email domain', function(callback) {
      ...
      TestsUtil.generateTestUsers(camAdminRestContext, 1, function(
        ...
        var guestEmail = _emailForDomain(
          TenantsTestUtil.generateTestTenantHost(),
        );
        fns.createSucceeds(
          user.restContext,
          'public',
          ...
          function(resource) {
            EmailTestUtil.collectAndFetchAllEmails(function(messages) {
              ...
              var cambridgeInvitationUrl = AuthzTestUtil.parseInvitationUrlFromMessage(
                cambridgeMessage,
              );
              var guestInvitationUrl = AuthzTestUtil.parseInvitationUrlFromMessage(
                guestMessage,
              );

              // Ensure the links are to the proper tenancy
              assert.strictEqual(
                cambridgeInvitationUrl.host,
                global.oaeTests.tenants.cam.host,
              );
              assert.strictEqual(
                guestInvitationUrl.host,
                TenantsAPI.getTenant('guest').host,
              );
          ...
          fns.createSucceeds(
            ...
            function(resource) {
              EmailTestUtil.collectAndFetchAllEmails(function(messages) {
                ...
                var invitationUrl = AuthzTestUtil.parseInvitationUrlFromMessage(
                  message,
                );
    ...
    describe('Content', function() {
      ...
      it('verify email aggregation and summary for accepting an invitation to content', function(callback) {
        var assertions = {
          oneResourceSummaryMatch: [
            ' has accepted your invitation to the link &quot;',
          ],
          twoResourceSummaryMatch: [' has accepted your invitation to &quot;'],
          threeResourceSummaryMatch: [
            ' has accepted your invitation to &quot;',
          ],
        };
    ...
    describe('Discussion', function() {
      ...
      it('verify discussion invitation email html', function(callback) {
        ...
        return _testInvitationEmailHtmlTargets(
          'discussion',
          assertions,
          callback,
        );
      ...
      it('verify email aggregation and summary for accepting an invitation to discussion', function(callback) {
        var assertions = {
          oneResourceSummaryMatch: [
            ' has accepted your invitation to the discussion &quot;',
          ],
          twoResourceSummaryMatch: [
            ' has accepted your invitation to the discussions &quot;',
          ],
          threeResourceSummaryMatch: [
            ' has accepted your invitation to the discussion &quot;',
          ],
    ...
    describe('Folder', function() {
      ...
      it('verify email aggregation and summary for accepting an invitation to folder', function(callback) {
        var assertions = {
          oneResourceSummaryMatch: [
            ' has accepted your invitation to the folder &quot;',
          ],
          twoResourceSummaryMatch: [
            ' has accepted your invitation to the folders &quot;',
          ],
          threeResourceSummaryMatch: [
            ' has accepted your invitation to the folder &quot;',
          ],
    ...
    describe('Group', function() {
      ...
      it('verify email aggregation and summary for accepting an invitation to group', function(callback) {
        var assertions = {
          oneResourceSummaryMatch: [
            ' has accepted your invitation to the group &quot;',
          ],
          twoResourceSummaryMatch: [
            ' has accepted your invitation to the groups &quot;',
          ],
          threeResourceSummaryMatch: [
            ' has accepted your invitation to the group &quot;',
          ],
  ...
  describe('Activity', function() {
    ...
    describe('Discussion', function() {
      it('verify the adapted activity summaries for discussion accept invitation activity', function(callback) {
        ...
        _testInvitationAcceptAdaptedActivities(
          'discussion',
          assertions,
          callback,
        );
  ...
  var _testInvitationAcceptAdaptedActivities = function(
    resourceType,
    assertions,
    callback,
  ) {
  ...
  var _testInvitationAcceptEmailSummary = function(
    resourceType,
    assertions,
    callback,
  ) {
        ...
        function(resourceA) {
          ...
          _assertAcceptEmailInvitation(
            ...
            function(message) {
              ...
              _.each(assertions.oneResourceSummaryMatch, function(
                oneResourceSummaryMatch,
              ) {
                _assertContains(
                  activities[0].summary.html,
                  ...
                  fns.createSucceeds(
                    ...
                    function(resourceB2) {
                      ...
                      _assertAcceptEmailInvitation(
                        ...
                        emailAssertions,
                        function(message) {
                          var activities = ActivityTestUtil.parseActivityHtml(
                            message.html,
                          );
                          assert.strictEqual(activities.length, 1);
                          ...
                          _.each(assertions.twoResourceSummaryMatch, function(
                            twoResourceSummaryMatch,
                          ) {
                            _assertContains(
                              activities[0].summary.html,
                                    ...
                                    function(resourceC3) {
                                      ...
                                      _assertAcceptEmailInvitation(
                                        ...
                                        function(message) {
                                          ...
                                          var numMatchesDisplayName = _.chain(
                                            resourceCs,
                                          )
                                            .pluck('displayName')
                                            .filter(function(displayName) {
                                              return (
                                                activities[0].summary.html.indexOf(
                                                  displayName,
                                                ) !== -1
                                              );
                                            })
                                            .size()
                                            .value();
                                          var numMatchesProfilePath = _.chain(
                                            resourceCs,
                                          )
                                            .pluck('profilePath')
  ...
  var _testInvitationEmailHtmlTargets = function(
    resourceType,
    assertions,
    callback,
  ) {
      ...
      fns.createSucceeds(
        ...
        function(resourceA) {
          ...
          EmailTestUtil.collectAndFetchAllEmails(function(messages) {
            ...
            _assertInvitationContainsResourceHtml(
              activities[0].summary.html,
              resourceA,
            );
            _assertContains(
              activities[0].summary.html,
              assertions.oneResourceSummaryMatch,
            );
                ...
                fns.createSucceeds(
                  ...
                  function(resourceB2) {
                    EmailTestUtil.collectAndFetchAllEmails(function(messages) {
                      ...
                      _assertContains(
                        activities[0].summary.html,
                        assertions.twoResourceSummaryMatch,
                      );
  ...
  var _testInvitationEmailSubject = function(
    resourceType,
    resourceType2,
    callback,
  ) {
    ...
    TestsUtil.generateTestUsers(camAdminRestContext, 5, function(
      err,
      users,
      targetUser,
      sharingUser1,
  ...
  var _testSoftDeleteForAccept = function(resourceType, callback) {
    var fns = resourceFns[resourceType];
    _testHardDeleteForAccept(resourceType, function(
      creatingUserInfo,
      acceptingUserInfo,
      resource,
    ) {
            ...
            function() {
              ActivityTestUtil.collectAndGetActivityStream(
                ...
                function(err, result) {
                  ...
                  assert.strictEqual(
                    activities.length,
                    _.size(resourceAcceptActivityInfo),
                  );
                  _.each(resources, function(resource) {
                    var activityInfo =
                      resourceAcceptActivityInfo[resource.resourceType];
                    var matchingActivities = _.filter(activities, function(
                      activity,
                    ) {
                      return (
  ...
  /*!
     ...
     * @throws {AssertionError}                 Thrown if any of the assertions fail
     */
  var _testInvitationEmailVisibilityForCreate = function(
    resourceType,
    callback,
  ) {
    var fns = resourceFns[resourceType];
  ...
  /*!
     ...
     * @throws {AssertionError}                 Thrown if any of the assertions fail
     */
  var _testInvitationEmailVisibilityForSetRoles = function(
    resourceType,
    callback,
  ) {
    var fns = resourceFns[resourceType];
    TestsUtil.generateTestUsers(camAdminRestContext, 2, function(
      ...
      fns.createSucceeds(creatingUser.restContext, 'public', [], [], function(
        resource1,
      ) {
        fns.createSucceeds(
          creatingUser.restContext,
  ...
  /*!
     ...
     * @throws {AssertionError}                 Thrown if any of the assertions fail
     */
  var _testInvitationEmailVisibilityForShare = function(
    resourceType,
    callback,
  ) {
    var fns = resourceFns[resourceType];
  ...
  var _testInvitationAcceptAuthorization = function(resourceType, callback) {
    ...
    TestsUtil.generateTestUsers(camAdminRestContext, 6, function(
      err,
      users,
      user0,
      user1,
      ...
      fns.createSucceeds(user0.restContext, 'private', [email1], [], function(
        resource,
      ) {
        // Accept as user1
        AuthzTestUtil.assertAcceptInvitationForEmailSucceeds(
            ...
            function() {
              ...
              fns.createSucceeds(
                ...
                function(resource) {
                  ...
                  AuthzInvitationsDAO.getTokensByEmails([email], function(
                    err,
                    tokensByEmail,
                  ) {
                    assert.ok(!err);
  ...
  /*!
     ...
     * @throws {AssertionError}                 Thrown if any of the assertions fail
     */
  var _testInvitationsAuthorizationForCreate = function(
    resourceType,
    callback,
  ) {
    var fns = resourceFns[resourceType];
  ...
  var _testInvitationsValidationForShare = function(resourceType, callback) {
    ...
    TestsUtil.generateTestUsers(camAdminRestContext, 1, function(
      ...
      assert.ok(!err);
      fns.createSucceeds(user0.restContext, 'public', [], [], function(
        resource,
      ) {
  ...
  /*!
     ...
     * @throws {AssertionError}                 Thrown if any of the assertions fail
     */
  var _testInvitationsAuthorizationForPublicShare = function(
    fns,
    publicTenant0,
    publicTenant1,
    privateTenant0,
  ...
  /*!
     ...
     * @throws {AssertionError}                 Thrown if any of the assertions fail
     */
  var _testInvitationsAuthorizationForLoggedinShare = function(
    fns,
    publicTenant0,
    publicTenant1,
    privateTenant0,
  ...
  /*!
     ...
     * @throws {AssertionError}                 Thrown if any of the assertions fail
     */
  var _testInvitationsAuthorizationForPrivateShare = function(
    fns,
    publicTenant0,
    publicTenant1,
    privateTenant0,
  ...
  /*!
     ...
     * @throws {AssertionError}                 Thrown if any of the assertions fail
     */
  var _testInvitationsAuthorizationForNoGuestsShare = function(
    fns,
    publicTenant0,
    publicTenant1,
    privateTenant0,
        ...
        function(resource) {
          ...
          fns.setRolesSucceeds(
            ...
            function() {
              ...
              var rolesRemove = AuthzTestUtil.createRoleChange(
                _.keys(roles),
                false,
              );
              fns.setRolesSucceeds(
  ...
  /*!
     ...
     * @throws {AssertionError}                 Thrown if any of the assertions fail
     */
  var _testInvitationsPartialRemoveRoles = function(resourceType, callback) {
    var fns = resourceFns[resourceType];
    var memberRole = resourceMemberRoles[resourceType];
        ...
        function(resource1) {
          fns.createSucceeds(
            ...
            function(resource2) {
              ...
              var roles = _.oaeObj(email, false);
              fns.setRolesSucceeds(
                userSetRoles.restContext,
                userSetRoles.restContext,
                resource1.id,
  ...
  /*!
     ...
     * @throws {AssertionError}                 Thrown if any of the assertions fail
     */
  var _testInvitationsAuthorizationForSetRoles = function(
    resourceType,
    callback,
  ) {
    var fns = resourceFns[resourceType];
  ...
  var _assertAdaptedActivities = function(
    inviterUserInfo,
    invitedUserInfo,
    otherUserInfo,
    resources,
  ...
  var _assertStandardInvitationAcceptSummaries = function(
    inviterUserInfo,
    invitedUserInfo,
    otherUserInfo,
    resources,
    ...
    _.each(resources, function(resource) {
      assert.ok(
        _.findWhere(inviterUserInfo.previewItems, { 'oae:id': resource.id }),
      );
    });

    _assertContains(
      invitedUserInfo.summary,
      'You have accepted an invitation from',
    );
    ...
    _.each(resources, function(resource) {
      assert.ok(
        _.findWhere(invitedUserInfo.previewItems, { 'oae:id': resource.id }),
      );
    });
    ...
    assert.strictEqual(
      otherUserInfo.previewItems[0]['oae:id'],
      invitedUserInfo.user.id,
    );
  ...
  /*!
     ...
     * @throws {AssertionError}                         Thrown if any of the assertions fail
     */
  var _assertAcceptEmailInvitation = function(
    invitingUserInfo,
    acceptingUserInfo,
    resources,
    assertions,
    ...
    EmailTestUtil.collectAndFetchAllEmails(function(messages) {
      ...
      assert.notEqual(
        message.subject.indexOf(invitingUserInfo.user.displayName),
        -1,
      );
  ...
  var _assertRole = function(
    ...
    fns.getMembersSucceeds(managerUserInfo.restContext, resource.id, function(
      members,
    ) {
      ...
      fns.getLibrarySucceeds(
        ...
        function(libraryItems) {
          ...
          // the resource
          var searchAssertFn = assertions.role
  ...
  /*!
     ...
     * @throws {AssertionError}                     Thrown if any of the assertions fail
     */
  var _createOneOfEachResourceType = function(
    creatingUserInfo,
    visibility,
    managerIds,
    memberIds,
    ...
    // and invitations
    PrincipalsTestUtil.assertGetMeSucceeds(
      creatingUserInfo.restContext,
      function(me) {
