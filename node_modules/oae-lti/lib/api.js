...
var LtiToolLaunchParams = require('./model').LtiToolLaunchParams;
var LtiLaunchParams = require('./model').LtiLaunchParams;
 ...
 */
var getLtiTool = (module.exports.getLtiTool = function(
  ctx,
  id,
  groupId,
  callback,
  ...
  PrincipalsApi.getFullGroupProfile(ctx, groupId, function(err, group) {
    if (err) {
      ...
      return callback({
        code: 401,
        msg: 'The current user does not have access to this LTI tool',
      });
    }
    PrincipalsApi.getMe(ctx, function(err, principal) {
      ...
      VersionAPI.getVersion(function(err, version) {
        ...
        LtiDAO.getLtiTool(id, groupId, function(err, tool) {
          ...
          var launchParams = new LtiLaunchParams(
            tool,
 ...
 */
var addLtiTool = (module.exports.addLtiTool = function(
  ctx,
  groupId,
  launchUrl,
  secret,
  ...
  PrincipalsApi.getGroup(ctx, groupId, function(err, group) {
    if (err) {
      ...
      return callback({
        code: 404,
        msg: util.format("Couldn't find group: %s", groupId),
      });
    }
 ...
 */
var getLtiTools = (module.exports.getLtiTools = function(
  ctx,
  groupId,
  callback,
) {
 ...
 * @param  {Object}      callback.err        An error that occurred, if any
 */
var deleteLtiTool = (module.exports.deleteLtiTool = function(
  ctx,
  id,
  groupId,
  callback,
