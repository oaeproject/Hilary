...
var log = require('oae-logger').logger('oae-pubsub');

var EventEmitter = require('oae-emitter').EventEmitter;
...
var publish = (module.exports.publish = function(channel, message, callback) {
  ...
  validator
    .check(channel, { code: 400, msg: 'No channel was provided.' })
    .notEmpty();
  validator
    .check(message, { code: 400, msg: 'No message was provided.' })
    .notEmpty();
