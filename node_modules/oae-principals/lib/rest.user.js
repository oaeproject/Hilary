 ...
 * @HttpResponse                        200             Terms and conditions available
 */
var _getLog = function(req, res) {
    PrincipalsAPI.getLog(req.ctx, req.query.num, req.query.tenantAlias, function(err, log) {
        if(err) {
            return res.status(err.code).send(err.msg);
        }
...
OAE.globalAdminRouter.on('get', '/api/users/log', _getLog);
OAE.tenantRouter.on('get', '/api/users/log', _getLog);
 ...
 * @HttpResponse                        200             Terms and conditions available
 */
var _getLogCreation = function(req, res) {
    PrincipalsAPI.getLogCreation(req.ctx, req.query.tenantAlias, function(err, log) {
        if(err) {
            return res.status(err.code).send(err.msg);
        }
        res.status(200).send(log);
...
OAE.globalAdminRouter.on('get', '/api/users/logCreation', _getLogCreation);
OAE.tenantRouter.on('get', '/api/users/logCreation', _getLogCreation);
