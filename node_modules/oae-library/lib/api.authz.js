 ...
 */
var resolveTargetLibraryAccess = (module.exports.resolveTargetLibraryAccess = function(
  ctx,
  libraryId,
  libraryOwner,
  callback,
    ...
    function(err, implicitRole) {
      ...
      const innerCallback = function(err, hasAnyRole) {
        if (err) {
          ...
          implicitRole &&
          TenantsUtil.isLoggedIn(ctx, libraryOwner.tenant.alias)
        ) {
 ...
 */
var resolveLibraryBucketVisibility = (module.exports.resolveLibraryBucketVisibility = function(
  libraryId,
  resource,
) {
  ...
  if (effectiveVisibility === AuthzConstants.visibility.LOGGEDIN) {
    ...
    var libraryOwnerTenantAlias = AuthzUtil.getResourceFromId(libraryId)
      .tenantAlias;
    var resourceTenantAlias = AuthzUtil.getResourceFromId(resource.id)
      .tenantAlias;
