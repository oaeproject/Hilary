...
describe('Search', function() {
    ...
    describe('Indexing', function() {
        ...
        it('verify indexing without full content item', function(callback) {
            ...
            RestAPI.Content.createLink(camAdminRestContext, 'Test Content 1', 'Test content description 1', 'public', 'http://www.sakaiproject.org/',  [], [], function(err, link) {
                assert.ok(!err);
                
                // Verify the content item exists
                RestAPI.Search.search(camAdminRestContext, 'general', ['content'], {'q': 'Test'}, function(err, results) {
                    assert.ok(!err);
