...
module.exports = function(app, callback) {
    ...
    ensureSchema(function(err) {
        ...
        PrincipalsAPI.createUser(globalContext, 'administrator', 'administrator', 'private', 'en_GB', 'Europe/London', 'Admin', 'User', 'The global admin user', function(err, userId) {
            // An error occurred.
            if (!err) {
                console.log("Admin account with userId '%s' created.", userId);
