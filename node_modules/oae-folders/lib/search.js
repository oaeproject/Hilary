 ...
 */
FoldersAPI.on(FoldersConstants.events.UPDATED_FOLDER, function(ctx, updatedFolder) {
 ...
 */
FoldersAPI.on(FoldersConstants.events.UPDATED_FOLDER_MEMBERS, function(ctx, folder, memberChangeInfo) {
