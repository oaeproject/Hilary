...
var getRevisions = (module.exports.getRevisions = function(
  ...
  Cassandra.runPagedQuery(
    ...
    function(err, rows, nextToken) {
      ...
      var revisionsToRetrieve = _.chain(rows)
 ...
 * @param  {Revision[]}     callback.revisions  Array that contains an object for each revision
 */
var getMultipleRevisions = (module.exports.getMultipleRevisions = function(
  revisionIds,
  opts,
  callback,
) {
 ...
 */
var getAllRevisionsForContent = (module.exports.getAllRevisionsForContent = function(
  contentIds,
  callback,
) {
  Cassandra.runQuery(
  ...
  Cassandra.runQuery(
    ...
    function(err, rows) {
      if (err) {
        ...
        return callback({
          code: 404,
          msg: "Couldn't find revision: " + revisionId,
        });
      }
 ...
 */
var createRevision = (module.exports.createRevision = function(
  revisionId,
  contentId,
  createdBy,
  revisionProperties,
  ...
  _copyPreviewItemsIfNecessary(
    revisionProperties.revisionId,
    revisionId,
    function(err) {
      if (err) {
        return callback(err);
 ...
 * @api private
 */
var _copyPreviewItemsIfNecessary = function(
  fromRevisionId,
  toRevisionId,
  callback,
) {
