...
describe('Transfer-discussions', function() {
    ...
    describe('Account transfer impact on discussions', function() {
        /**
                                                                ...
                                                                TransferTestUtil.generateRightDiscussion(orodan, userTarget, 'member', orodandoc[0], function(err) {
                                                                    ...
                                                                    TransferTestUtil.generateRightDiscussion(orodan, userTarget, 'manager', orodandoc[1], function(err) {
                                                                        ...
                                                                        RestAPI.Discussions.getDiscussionsLibrary(userOrigin.restContext, userOrigin.user.id, null, null, function(err, result) {
                                                                            var listDiscussionsBefore = _.map(result.results, function(element) { 
                                                                                return element.id; 
                                                                            });
                                                                            RestAPI.Discussions.getDiscussionsLibrary(userTarget.restContext, userTarget.user.id, null, null, function(err, result) {
                                                                                listDiscussionsBefore = listDiscussionsBefore.concat(_.map(result.results, function(element) { 
                                                                                    return element.id; 
                                                                                }));
                                                                                TransferTestUtil.assertInitiateTransferSucceeds(userOrigin.restContext, userOrigin.user.email, userTarget.user.email, userOrigin.user.id, function(transfer) {
                                                                                    assert.ok(transfer);
                                                                                    TransferTestUtil.assertCompleteTransferSucceeds(userOrigin.restContext, userOrigin.user.email, transfer.code, userTarget.user.email, userTarget.user.id, function(err, managers) {
                                                                                        ...
                                                                                        RestAPI.Discussions.getDiscussionsLibrary(userOrigin.restContext, userOrigin.user.id, null, null, function(err, result) {
                                                                                            RestAPI.Discussions.getDiscussionsLibrary(userTarget.restContext, userTarget.user.id, null, null, function(err, result) {
                                                                                                var listDiscussionsTargetAfter = _.map(result.results, function(element) { 
                                                                                                    return element.id; 
                                                                                                });
                                                                                                // Sort lists to compare
