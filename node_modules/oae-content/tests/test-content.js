...
describe('Content', function() {
            ...
            setUpUsers(function(contexts) {
                ...
                RestAPI.Content.createFile(contexts['nicolaas'].restContext, 'Test Content 1', 'Test content description 1', 'private', getFileStream,  [], [], function(err, contentObj) {
                    ...
                    RestAPI.Content.getContent(contexts['nicolaas'].restContext, contentObj.contentId, function(err, contentObj) {
                        assert.ok(!err);
                        assert.equal(contentObj.downloadLink, '/api/content/' + contentObj.contentId + '/download');
                        ...
                        RestAPI.Content.download(contexts['nicolaas'].restContext, contentObj.contentId, null, false, function(err, body, response) {
                            assert.ok(!err);
                            var headerKeys = _.keys(response.headers);
                            assert.ok(headerKeys.indexOf('x-accel-redirect') !== -1)

                            // Try downloading it as Simon
                            RestAPI.Content.download(contexts['simon'].restContext, contentObj.contentId, null, false, function(err, body) {
                                assert.ok(err.code, 401);

                                // Share it.
                                RestAPI.Content.shareContent(contexts['nicolaas'].restContext, contentObj.contentId, [contexts['simon'].user.id], function(err) {
                                    assert.ok(!err);
        ...
        it('verify versioned download content', function(callback) {
            setUpUsers(function(contexts) {
                ...
                RestAPI.Content.createFile(contexts['nicolaas'].restContext, 'Test Content 1', 'Test content description 1', 'private', getFileStream,  [], [], function(err, contentObj) {
                    ...
                    RestAPI.Content.updateFileBody(contexts['nicolaas'].restContext, contentObj.contentId, getSakaiLogoStream, function(err) {
                        assert.ok(!err);

                        RestAPI.Content.getRevisions(contexts['nicolaas'].restContext, contentObj.contentId, null, null, function(err, revisions) {
                            assert.ok(!err);
                            ...
                            RestAPI.Content.download(contexts['nicolaas'].restContext, contentObj.contentId, null, false, function(err, body, response) {
                                ...
                                RestAPI.Content.download(contexts['nicolaas'].restContext, contentObj.contentId, revisions[1].revisionId, false, function(err, body, response) {
                                    assert.ok(!err);
                                    assert.equal(response.statusCode, 204);
            ...
            RestAPI.User.createUser(camAdminRestContext, usernameA, 'password', 'Public User', null, function(err, userA) {
                ...
                RestAPI.User.createUser(gtAdminRestContext, usernameB, 'password', 'Private User', null, function(err, userB) {
                    ...
                    RestAPI.Content.createLink(restCtxB, 'Google', 'Google Website', 'public', 'http://google.com', [userB.id], [], function(err, contentB) {
                        ...
                        RestAPI.Content.getContent(restCtxA, contentB.contentId, function(err, contentObj) {
                            assert.ok(!err);
                            assert.ok(contentObj);
                            assert.ok(contentB.contentId, contentObj.contentId);
                            callback();
                        });
                    });
                });
            ...
            RestAPI.User.createUser(camAdminRestContext, usernameA, 'password', 'Public User', null, function(err, userA) {
                ...
                RestAPI.User.createUser(gtAdminRestContext, usernameB, 'password', 'Private User', null, function(err, userB) {
                    ...
                    RestAPI.Content.createLink(restCtxB, 'Google', 'Google Website', 'loggedin', 'http://google.com', [userB.id], [], function(err, contentB) {
                        ...
                        RestAPI.Content.shareContent(restCtxB, contentB.contentId, [userA.id], function(err) {
                            assert.ok(!err);
                            ...
                            RestAPI.Content.getContent(restCtxA, contentB.contentId, function(err, contentObj) {
                                assert.ok(!err);
                                assert.ok(contentObj);
                                assert.equal(contentB.contentId, contentObj.contentId);
                                callback();
                            });
                        });
                    });
        ...
        it('verify user from private tenant cannot share to public external tenant', function(callback) {
            ...
            RestAPI.User.createUser(camAdminRestContext, usernameA, 'password', 'Public User', null, function(err, userA) {
                ...
                TestsUtil.createTenantWithAdmin(tenantAliasB, tenantAliasB, function(err, tenantB, adminBRestContext) {
                    ...
                    RestAPI.Config.updateConfig(globalAdminRestContext, tenantAliasB, 'oae-tenants/tenantprivacy/tenantprivate', true, function(err) {
                        assert.ok(!err);
                    ...
                    RestAPI.Config.updateConfig(globalAdminRestContext, tenantAliasB, 'oae-tenants/tenantprivacy/tenantprivate', true, function(err) {
                        ...
                        RestAPI.User.createUser(adminRestCtxB, usernameB, 'password', 'Private User', null, function(err, userB) {
                            ...
                            RestAPI.Content.createLink(restCtxA, 'Google', 'Google Website', 'loggedin', 'http://google.com', [userA.id], [], function(err, contentA) {
                                ...
                                RestAPI.Content.shareContent(restCtxA, contentA.contentId, [userB.id], function(err) {
                                    assert.ok(err);
                                    assert.ok(err.code, 401);

                                    // User B access content A, but it should not be accessible because the share failed
                                    RestAPI.Content.getContent(restCtxB, contentA.contentId, function(err, contentObj) {
                                        assert.ok(err);
                                        assert.ok(err.code, 401);
                                        assert.ok(!contentObj);
                                        callback();
                            ...
                            RestAPI.Content.createLink(restCtxA, 'Google', 'Google Website', 'loggedin', 'http://google.com', [userA.id], [], function(err, loggedInContentA) {
                                ...
                                RestAPI.Content.getLibrary(restCtxA2, userA.id, null, 10, function(err, libraryA) {
                                    ...
                                    RestAPI.Content.getLibrary(restCtxB, userA.id, null, 10, function(err, libraryA) {
                                        ...
                                        assert.equal(libraryA.results[0].contentId, publicContentA.contentId);
                                        callback();
                                    });
                                });
                            });
                            ...
                            RestAPI.Content.createLink(restCtxA, 'Google', 'Google Website', 'loggedin', 'http://google.com', [userA.id], [groupA.id], function(err, loggedInContentA) {
                                ...
                                RestAPI.Content.getLibrary(restCtxA, groupA.id, null, 10, function(err, libraryA) {
                                    ...
                                    RestAPI.Content.getLibrary(restCtxB, groupA.id, null, 10, function(err, libraryB) {
                                        ...
                                        assert.equal(libraryB.results[0].contentId, publicContentA.contentId);
                                        callback();
                                    });
                                });
                            });
    ...
    describe('Content comments', function() {
        ...
        it('verify create comment', function(callback) {
            setUpUsers(function(contexts) {
                ...
                RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 1', 'Test content description 1', 'public', 'http://www.sakaiproject.org/',  [], [], function(err, contentObj) {
                    ...
                    // Get the created piece of content
                    RestAPI.Content.getContent(contexts['bert'].restContext, contentObj.contentId, function(err, retrievedContentObj) {
                        assert.ok(!err);
                        assert.equal(retrievedContentObj.contentId, contentObj.contentId);

                        // Create 10 comments
                        createComments(contexts, contentObj.contentId, 10, null, function() {

                            // Create one more and verify that it comes back as the first comment in the list
                            RestAPI.Content.createComment(contexts['bert'].restContext, contentObj.contentId, 'This comment should be on top of the list', null, function(err, comment) {
                                assert.ok(!err);
                                ...
                                assert.equal(comment.contentId, contentObj.contentId);
                                ...
                                RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, null, 10, function(err, comments) {
                                    assert.ok(!err);
            ...
            setUpUsers(function(contexts) {
                ...
                RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 1', 'Test content description 1', 'public', 'http://www.sakaiproject.org/',  [], [], function(err, contentObj) {
                    ...
                    RestAPI.Content.getContent(contexts['bert'].restContext, contentObj.contentId, function(err, retrievedContentObj) {
                        ...
                        RestAPI.Content.createComment(contexts['bert'].restContext, contentObj.contentId, 'This comment should be second in the list', null, function(err, comment) {
                            assert.ok(!err);
                            assert.ok(comment);
                            ...
                            RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, null, 10, function(err, comments) {
                                ...
                                RestAPI.Content.createComment(contexts['bert'].restContext, contentObj.contentId, 'Reply to second comment in the list', comments.results[0].commentId, function(err, comment) {
                                    assert.ok(!err);
                                    assert.equal(comment.createdBy.publicAlias, 'Bert Pareyn');
                                    ...
                                    RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, null, 10, function(err, comments) {
                                        ...
                                        RestAPI.Content.createComment(contexts['bert'].restContext, contentObj.contentId, 'A reply to the reply on the second comment in the list', comments.results[1].commentId, function(err, comment) {
                                            assert.ok(!err);
                                            assert.ok(comment);

                                            // Add a second comment to the content item
                                            RestAPI.Content.createComment(contexts['bert'].restContext, contentObj.contentId, 'This comment should be first in the list', null, function(err, comment) {
                                                assert.ok(!err);
                                                assert.ok(comment);
                                                        ...
                                                        RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content', 'Test content description', 'public', 'http://www.sakaiproject.org/',  [], [], function(err, contentObj) {
                                                            ...
                                                            createComments(contexts, contentObj.contentId, 10, null, function() {
                                                                RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, null, 10, function(err, comments) {
                                                                    ...
                                                                    createComments(contexts, contentObj.contentId, 10, comments.results[5].commentId, function() {
                                                                        RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, null, 10, function(err, comments) {
                                                                            assert.ok(!err);
                                                                            ...
                                                                            RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, comments.results[9].created, 10, function(err, comments) {
                                                                                assert.ok(!err);
            ...
            setUpUsers(function(contexts) {
                ...
                RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 1', 'Test content description 1', 'public', 'http://www.sakaiproject.org/',  [], [], function(err, contentObj) {
                    ...
                    RestAPI.Content.getContent(contexts['bert'].restContext, contentObj.contentId, function(err, retrievedContentObj) {
                        ...
                        // Create a comment
                        RestAPI.Content.createComment(contexts['bert'].restContext, contentObj.contentId, 'This comment will be deleted.', null, function(err, comment) {
                            assert.ok(!err);
                            assert.ok(comment);
                            ...
                            RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, null, 10, function(err, comments) {
                                ...
                                RestAPI.Content.createComment(contexts['bert'].restContext, contentObj.contentId, 'This is a reply on the comment that will be deleted.', comments.results[0].commentId, function(err, comment) {
                                    assert.ok(!err);
                                    assert.ok(comment);

                                    // Delete the comment
                                    RestAPI.Content.deleteComment(contexts['bert'].restContext, contentObj.contentId, comments.results[0].commentId, function(err, deleted) {
                                        assert.ok(!err);
                                        ...
                                        RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, null, 10, function(err, comments) {
                                            ...
                                            RestAPI.Content.createComment(contexts['bert'].restContext, contentObj.contentId, 'This is a reply on the reply on a comment that will be deleted.', comments.results[1].commentId, function(err, comment) {
                                                assert.ok(!err);
                                                assert.ok(comment);

                                                // Delete reply on comment
                                                RestAPI.Content.deleteComment(contexts['bert'].restContext, contentObj.contentId, comments.results[1].commentId, function(err, deleted) {
                                                    assert.ok(!err);
                                                    assert.equal(deleted.deleted, false);
                                                    ...
                                                    RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, null, 10, function(err, comments) {
                                                        ...
                                                        RestAPI.Content.deleteComment(contexts['bert'].restContext, contentObj.contentId, comments.results[2].commentId, function(err, deleted) {
                                                            assert.ok(!err);
                                                            assert.equal(deleted.deleted, true);

                                                            // Delete reply on comment
                                                            RestAPI.Content.deleteComment(contexts['bert'].restContext, contentObj.contentId, comments.results[1].commentId, function(err, deletedComment) {
                                                                assert.ok(!err);
                                                                assert.equal(deleted.deleted, true);

                                                                // Delete original comment
                                                                RestAPI.Content.deleteComment(contexts['bert'].restContext, contentObj.contentId, comments.results[0].commentId, function(err, deletedComment) {
                                                                    assert.ok(!err);
                                                                    assert.equal(deleted.deleted, true);
            ...
            setUpUsers(function(contexts) {
                ...
                RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 1', 'Test content description 1', 'public', 'http://www.sakaiproject.org/',  [], [], function(err, publicContentObj) {
                    ...
                    RestAPI.Content.createLink(contexts['nicolaas'].restContext, 'Test Content 2', 'Test content description 2', 'private', 'http://www.sakaiproject.org/',  [], [contexts['bert'].user.id], function(err, privateContentObj) {
                        ...
                        RestAPI.Content.createComment(contexts['bert'].restContext, privateContentObj.contentId, 'This is a first comment.', null, function(err, comment) {
                            assert.ok(!err);
                            assert.ok(comment);

                            RestAPI.Content.createComment(contexts['bert'].restContext, privateContentObj.contentId, 'This is a second comment.', null, function(err, comment) {
                                assert.ok(!err);
                                assert.ok(comment);

                                // Get the comments to verify they were created successfully
                                RestAPI.Content.getComments(contexts['bert'].restContext, privateContentObj.contentId, null, 10, function(err, comments) {
                                    assert.ok(!err);
                                    assert.equal(comments.results.length, 2);
                                    ...
                                    RestAPI.Content.deleteComment(contexts['bert'].restContext, privateContentObj.contentId, comment2, function(err, deleted) {
                                        assert.ok(!err);
                                        assert.equal(deleted.deleted, true);
                                        ...
                                        RestAPI.Content.getComments(contexts['bert'].restContext, privateContentObj.contentId, null, 10, function(err, comments) {
                                            ...
                                            RestAPI.Content.updateMembers(contexts['nicolaas'].restContext, privateContentObj.contentId, permissions, function(err) {
                                                assert.ok(!err);
                                                ...
                                                RestAPI.Content.deleteComment(contexts['bert'].restContext, publicContentObj.contentId, comment1, function(err, deleted) {
                                                    assert.ok(err);
                                                    assert.ok(err.code, 400);
                                                    assert.ok(!deleted);
                                                    // Get the comment to verify that it wasn't deleted
                                                    RestAPI.Content.getComments(contexts['nicolaas'].restContext, privateContentObj.contentId, null, 10, function(err, comments) {
                                                        assert.ok(!err);
                                                        assert.equal(comments.results.length, 1);
                                                        assert.equal(comments.results[0].commentId, comment1);
                                                        assert.equal(comments.results[0].createdBy.id, contexts['bert'].user.id);
                                                        ...
                                                        RestAPI.Content.createComment(contexts['bert'].restContext, publicContentObj.contentId, 'This reply on the comment shouldn\'t be accepted', comment1, function(err, comment) {
                                                            assert.ok(err);
                                                            assert.ok(err.code, 400);
                                                            assert.ok(!comment);
        ...
        it('verify delete comment validation', function(callback) {
            setUpUsers(function(contexts) {
                ...
                RestAPI.Content.createLink(contexts['nicolaas'].restContext, 'Test Content 1', 'Test content description 1', 'public', 'http://www.sakaiproject.org/',  [], [], function(err, contentObj) {
                    ...
                    RestAPI.Content.createComment(contexts['bert'].restContext, contentObj.contentId, 'This is a comment.', null, function(err, comment) {
                        assert.ok(!err);
                        assert.ok(comment);
                        ...
                        RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, null, 10, function(err, comments) {
                            ...
                            // Try to delete a comment without specifying the commentId
                            RestAPI.Content.deleteComment(contexts['bert'].restContext, contentObj.contentId, null, function(err, deleted) {
                                assert.ok(err);
                                assert.ok(err.code, 400);
                                assert.ok(!deleted);

                                // Try to delete a comment without specifying the contentId
                                RestAPI.Content.deleteComment(contexts['bert'].restContext, null, commentId, function(err, deleted) {
                                    assert.ok(err);
                                    assert.ok(err.code, 400);
                                    assert.ok(!deleted);

                                    // Verify that the comment hasn't been deleted
                                    RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, null, 10, function(err, comments) {
                                        assert.ok(!err);
                                        assert.equal(comments.results.length, 1);
                                        assert.equal(comments.results[0].createdBy.id, contexts['bert'].user.id);
        ...
        var testDeleteCommentPermissions = function(contexts, visibility, expectedDelete, callback) {
            ...
            var _canDelete = function(linkContext, commentContext, deleteContext, visibility, managers, members, expectedDelete, callback) {
                RestAPI.Content.createLink(linkContext.restContext, 'Test Content', 'Test content description', visibility, 'http://www.sakaiproject.org/', [], members, function(err, contentObj) {
                    ...
                    RestAPI.Content.createComment(commentContext.restContext, contentObj.contentId, 'Comment to check access', null, function(err, comment) {
                        if (expectedDelete) {
                            assert.ok(!err);
                            assert.ok(comment);
                        } else {
                        ...
                        RestAPI.Content.getComments(linkContext.restContext, contentObj.contentId, null, 10, function(err, comments) {
                            assert.ok(!err);
                            assert.equal(comments.results[0].level, 0);
                            ...
                            RestAPI.Content.deleteComment(deleteContext.restContext || deleteContext, contentObj.contentId, comments.results[0].commentId, function(err, deleted) {
            ...
            _canDelete(bert, bert, bert, visibility, [], [], true, function(err) {
                ...
                _canDelete(bert, simon, bert, visibility, [], [contexts['simon'].user.id], true, function(err, deleted) {
                    assert.ok(!err);
                    assert.equal(deleted.deleted, true);
                    // Delete own comment as member on piece of content (--> success)
                    _canDelete(bert, simon, simon, visibility, [], [contexts['simon'].user.id], true, function(err, deleted) {
                        assert.ok(!err);
                        assert.equal(deleted.deleted, true);
                        // Delete other's comment as member on piece of content (--> fail)
                        _canDelete(bert, bert, simon, visibility, [], [contexts['simon'].user.id], true, function(err, deleted) {
                            assert.ok(err);
                            assert.ok(!deleted);
                            // Delete own comment as logged in on piece of content (--> success)
                            _canDelete(bert, simon, simon, visibility, [], [], expectedDelete, function(err, deleted) {
                                if (expectedDelete) {
                                    assert.ok(!err);
                                    assert.equal(deleted.deleted, true);
                                } else {
                                ...
                                _canDelete(bert, bert, anonymousRestContext, visibility, [], [], true, function(err, deleted) {
                                    assert.ok(err);
                                    assert.ok(!deleted);
                                    callback();
                                });
                ...
                RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 1', 'Test content description 1', 'public', 'http://www.sakaiproject.org/',  [], [], function(err, contentObj) {
                    ...
                    RestAPI.Content.createComment(contexts['bert'].restContext, null, 'This comment should be on top of the list', null, function(err, comment) {
                        ...
                        RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, null, 10, function(err, comments) {
                            ...
                            RestAPI.Content.createComment(contexts['bert'].restContext, contentObj.contentId, null, null, function(err, comment) {
                                assert.ok(err);
                                assert.equal(err.code, 400);
                                assert.ok(!comment);
                                // Verify that the comment wasn't created
                                RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, null, 10, function(err, comments) {
                                    ...
                                    RestAPI.Content.createComment(anonymousRestContext, contentObj.contentId, 'This comment should be on top of the list', null, function(err, comment) {
                                        assert.ok(err);
                                        assert.equal(err.code, 401);
                                        assert.ok(!comment);
                                        // Verify that the comment wasn't created
        ...
        var testCommentPermissions = function(contexts, visibility, expectLoggedInComment, callback){
            ...
            RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 1', 'Test content description 1', visibility, 'http://www.sakaiproject.org/', [], [contexts['nicolaas'].user.id], function(err, contentObj) {
                ...
                RestAPI.Content.createComment(contexts['bert'].restContext, contentObj.contentId, 'Try to comment as manager', null, function(err, comment) {
                    assert.ok(!err);
                    assert.ok(comment);
                    // Verify that the comment was placed as a manager
                    RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, null, 1, function(err, comments) {
                        assert.ok(!err);
                        assert.equal(comments.results[0].body, 'Try to comment as manager');

                        // Try to comment as member
                        RestAPI.Content.createComment(contexts['nicolaas'].restContext, contentObj.contentId, 'Try to comment as member', null, function(err, comment) {
                            assert.ok(!err);
                            assert.ok(comment);
                            // Verify that the comment was placed as a member
                            RestAPI.Content.getComments(contexts['nicolaas'].restContext, contentObj.contentId, null, 1, function(err, comments) {
                                assert.ok(!err);
                                assert.equal(comments.results[0].body, 'Try to comment as member');

                                // Try to comment as logged in user
                                RestAPI.Content.createComment(contexts['simon'].restContext, contentObj.contentId, 'Try to comment as logged in user', null, function(err, comment) {
                                    ...
                                    RestAPI.Content.getComments(contexts['simon'].restContext, contentObj.contentId, null, 1, function(err, comments) {
                                        if (!expectLoggedInComment) {
                                            assert.ok(err);
                                        } else {
                                            assert.ok(!err);
                                        ...
                                        RestAPI.Content.createComment(anonymousRestContext, contentObj.contentId, 'Try to comment as an anonymous user', null, function(err, comment) {
                                            assert.ok(err);
                                            assert.ok(!comment);
    ...
    describe('Create content', function() {
            ...
            setUpUsers(function(contexts) {
                ...
                RestAPI.Content.createFile(anonymousRestContext, 'Test Content 1', 'Test content description 1', 'public', getFileStream, [], [], function(err, contentObj) {
                    ...
                    RestAPI.Content.createFile(contexts['nicolaas'].restContext, 'Test Content 2', 'Test content description 2', 'public', getFileStream, [], [], function(err, contentObj) {
                        assert.ok(!err);
                        assert.ok(contentObj.contentId);
                        assert.ok(contentObj.filename, 'sakaiger.png');
                        assert.ok(contentObj.mime, 'image/png');
        ...
        /**
         * Test whether or not passing in viewers and managers to be added to the content upon sakaidoc creation works as expected. This test will
         * create a private piece of content that will have 1 additional manager and 1 viewer. We will fetch the content as those people
         * to verify access, and then get the content as a logged in user and an anonymous user to verify they don't have access
         */
        it('verify create content with default members sakaidoc', function(callback) {
            setUpUsers(function(contexts) {
                // Create a private content item and share with 2 people
                RestAPI.Content.createSakaiDoc(contexts['nicolaas'].restContext, 'Test Content 2', 'Test content description 2', 'private', [contexts['simon'].user.id], [contexts['bert'].user.id], function(err, contentObj) {
                    assert.ok(!err);
                    assert.ok(contentObj.contentId);
    ...
    describe('Update content', function() {
        ...
        var checkNameAndDescription = function(contexts, contentId, expectedName, expectedDescription, callback) {
            ...
            RestAPI.Content.getContent(contexts['nicolaas'].restContext, contentId, function(err, contentObj) {
                ...
                assert.ok(contentObj.displayName, expectedName);
                ...
                RestAPI.Content.createLink(contexts['nicolaas'].restContext, 'Test Content 1', 'Test content description 1', 'public', 'http://www.sakaiproject.org/', [], [], function(err, contentObj) {    
                    ...
                    RestAPI.Content.shareContent(contexts['nicolaas'].restContext, contentObj.contentId, [contexts['simon'].user.id], function(err) {
                        ...
                        RestAPI.Content.updateContent(contexts['nicolaas'].restContext, contentObj.contentId, {}, function(err) {
                            ...
                            RestAPI.Content.updateContent(contexts['nicolaas'].restContext, contentObj.contentId, {'displayName': 'New Test Content 1', 'nonExisting': 'Non-existing field'}, function(err) {
                                assert.ok(err);
                                ...
                                checkNameAndDescription(contexts, contentObj.contentId, 'Test Content 1', 'Test content description 1', function() {
                                    // Change the name
                                    RestAPI.Content.updateContent(contexts['nicolaas'].restContext, contentObj.contentId, {'displayName': 'New Test Content 1'}, function(err) {
                                        assert.ok(!err);
                                        ...
                                        checkNameAndDescription(contexts, contentObj.contentId, 'New Test Content 1', 'Test content description 1', function() {
                                            ...
                                            RestAPI.Content.updateContent(contexts['nicolaas'].restContext, contentObj.contentId, {'description': 'New test content description 1'}, function(err) {
                                                ...
                                                checkNameAndDescription(contexts, contentObj.contentId, 'New Test Content 1', 'New test content description 1', function() {
                                                    ...
                                                    RestAPI.Content.updateContent(contexts['nicolaas'].restContext, contentObj.contentId, {'displayName': 'New Test Content 2', 'description': 'New test content description 2'}, function(err) {
                                                        assert.ok(!err);
                                                        ...
                                                        checkNameAndDescription(contexts, contentObj.contentId, 'New Test Content 2', 'New test content description 2', function() {
                                                            ...
                                                            RestAPI.Content.updateContent(contexts['simon'], contentObj.contentId, {'displayName': 'New Test Content 3'}, function(err) {
                                                                assert.ok(err);
                ...
                RestAPI.Content.createLink(contexts['nicolaas'].restContext, 'Test Content 2', 'Test content description 2', 'public', 'http://www.sakaiproject.org', [], [], function(err, contentObj) {
                    ...
                    RestAPI.Content.updateFileBody(contexts['nicolaas'].restContext, contentObj.contentId, getSakaiLogoStream, function(err) {
                        ...
                        RestAPI.Content.createFile(contexts['nicolaas'].restContext, 'Test Content 2', 'Test content description 2', 'public', getFileStream, [], [], function(err, contentObj) {
                            ...
                            RestAPI.Content.updateFileBody(contexts['nicolaas'].restContext, contentObj.contentId, null, function(err, revision) {
                                assert.ok(err);
                                assert.ok(!revision);

                                // Try to update by passing a string
                                RestAPI.Content.updateFileBody(contexts['nicolaas'].restContext, contentObj.contentId, 'haha, no actual file body', function(err) {
                                    assert.ok(err);

                                    // Try updating as a not-related person
                                    RestAPI.Content.updateFileBody(contexts['simon'].restContext, contentObj.contentId, getSakaiLogoStream, function(err) {
                                        assert.ok(err);
        ...
        it('verify empty revisions', function(callback) {
            setUpUsers(function(contexts) {
                ...
                RestAPI.Content.createLink(contexts['simon'].restContext, 'Sakai Foundation', 'The Sakai Foundation', 'public', 'http://www.sakaiproject.org/', [], [], function(err, contentObj) {                    
                    assert.ok(!err);
                    // Get the revisions.
                    RestAPI.Content.getRevisions(contexts['simon'].restContext, contentObj.contentId, null, null, function(err, revisions) {
                        assert.ok(!err);
        ...
        it('verify revision permissions', function(callback) {
            setUpUsers(function(contexts) {
                ...
                RestAPI.Content.createFile(contexts['simon'].restContext, 'Test Content 1', 'Test content description 1', 'private', getFileStream,  [], [], function(err, contentSimon) {
                    ...
                    RestAPI.Content.updateFileBody(contexts['simon'].restContext, contentSimon.contentId, getSakaiLogoStream, function(err) {
                        assert.ok(!err);

                        RestAPI.Content.getRevisions(contexts['simon'].restContext, contentSimon.contentId, null, null, function(err, revisionsSimon) {
                            assert.ok(!err);
                            assert.ok(revisionsSimon.length, 2);
                            ...
                            RestAPI.Content.createLink(contexts['nicolaas'].restContext, 'Sakai Foundation', 'The Sakai Foundation', 'private', 'http://www.sakaiproject.org/', [], [], function(err, contentNico) {                    
                                ...
                                RestAPI.Content.getRevisions(contexts['nicolaas'].restContext, contentSimon.contentId, null, null, function(err, revisions) {
                                    assert.equal(err.code, 401);
                                    assert.ok(!revisions);

                                    // He also can't download them.
                                    RestAPI.Content.download(contexts['nicolaas'].restContext, contentSimon.contentId, revisionsSimon[1].revisionId, false, function(err, body) {
                                        assert.equal(err.code, 401);
                                        assert.ok(!body);
                                        ...
                                        RestAPI.Content.download(contexts['nicolaas'].restContext, contentNico.contentId, revisionsSimon[1].revisionId, false, function(err, body) {
                                            assert.equal(err.code, 401);
                                            assert.ok(!body);
                                            callback();
                                        });
            ...
            setUpUsers(function(contexts) {
                ...
                RestAPI.Content.createFile(contexts['simon'].restContext, 'Test Content 1', 'Test content description 1', 'private', getFileStream,  [], [], function(err, contentObj) {
                    ...
                    RestAPI.Content.updateFileBody(contexts['simon'].restContext, contentObj.contentId, getSakaiLogoStream, function(err) {
                        ...
                        // Try to get the revisions with a missing contentId
                        RestAPI.Content.getRevisions(contexts['simon'].restContext, null, null, null, function(err) {
                            assert.ok(err.code, 400);
                            ...
                            RestAPI.Content.getRevisions(contexts['simon'].restContext, 'not-a-content-id', null, null, function(err) {
                                ...
                                RestAPI.Content.getRevisions(contexts['simon'].restContext, contentObj.contentId, null, null, function(err, revisions) {
                                    ...
                                    RestAPI.Content.download(contexts['simon'].restContext, contentObj.contentId, 'not-a-revision-id', false, function(err, body) {
                                        assert.ok(err.code, 400);
                                        assert.ok(!body);
                                        callback();
                                    });
                    ...
                    RestAPI.Content.updateMembers(contexts['nicolaas'].restContext, contentObj.contentId, permissions, function(err) {
                        ...
                        checkPieceOfContent(contexts['simon'].restContext, contexts['simon'].user.id, contentObj, true, true, true, function() {
                            checkPieceOfContent(contexts['bert'].restContext, contexts['bert'].user.id, contentObj, true, false, true, function() {
                                ...
                                RestAPI.Content.shareContent(contexts['simon'].restContext, contentObj.contentId, [contexts['branden'].user.id], function(err) {
                                    assert.ok(!err);
        ...
        it('verify file delete', function(callback) {
            setUpUsers(function(contexts) {
                RestAPI.Content.createFile(contexts['nicolaas'].restContext, 'Test Content 2', 'Test content description 2', 'public', getFileStream, [], [], function(err, contentObj) {
                    ...
                    RestAPI.Content.getRevisions(contexts['nicolaas'].restContext, contentObj.contentId, null, 1000, function(err, revisions) {
                        assert.ok(!err);
    ...
    describe('Content sharing', function() {
        ...
        var testSharing = function(contentObj, sharer, shareWith, expectShare, expectAccess, expectManager, expectInLibrary, expectedMembers, callback) {
            RestAPI.Content.shareContent(sharer.restContext, contentObj.contentId, [shareWith.user.id], function(err) {
                if (expectShare) {
                    assert.ok(!err);
                } else {
                    assert.ok(err);
        ...
        it('verify multiple sharing', function(callback) {
            setUpUsers(function(contexts) {
                ...
                prepareSharing(contexts, 'private', function(contentObj) {
                    ...
                    RestAPI.Content.shareContent(contexts['nicolaas'].restContext, contentObj.contentId, toShare, function(err) {
                        assert.ok(!err);
                                                    ...
                                                    RestAPI.Content.getLibrary(contexts['anthony'].restContext, groups['oae-team'].id, null, 10, function(err, contentItems) {
                                                        ...
                                                        checkPieceOfContent(contexts['stuart'].restContext, contexts['stuart'].user.id, contentObj, privacy === 'private' ? false : true, false, false, function() {
                                                            ...
                                                            checkPieceOfContent(contexts['branden'].restContext, contexts['branden'].user.id, contentObj, privacy === 'private' ? false : true, false, false, function() {
                                                                ...
                                                                RestAPI.Content.shareContent(contexts['anthony'].restContext, contentObj.contentId, [groups['oae-team'].id], function(err) {
