 ...
 * parameter, and at most `batchSize` rows at a time. On each iteration of `batchSize` rows, the `onEach` callback will be executed.
 ...
 */
var iterateAll = module.exports.iterateAll = function(columnNames, columnFamily, keyColumnName, opts, onEach) {
    opts = opts || {};
    ...
    return _iterateAll(columnNames, columnFamily, keyColumnName, opts.batchSize, opts.consistency, opts.slugColumnName, returnSlugColumn, onEach);
};
 ...
 * @api private
 */
var _iterateAll = function(columnNames, columnFamily, keyColumnName, batchSize, consistency, slugColumnName, returnSlugColumn, onEach, fromKey) {
    ...
    runQuery(query.query, query.parameters, function(err, rows) {
        ...
        try {
            ...
            onEach(null, validRows);
        } catch (ex) {
            return onEach(ex);
        }

        // Start the next iteration
        _iterateAll(columnNames, columnFamily, keyColumnName, batchSize, consistency, slugColumnName, returnSlugColumn, onEach, fromKey);
    });
};
