 ...
 * @BodyParam   {string}                description         Description of discussion
 * @BodyParam   {string}                displayName         Name to display for discussion
 * @BodyParam   {string}                managers            Unique identifier(s) for manager(s) of the discussion (user creating discussion is always a manager)
 * @BodyParam   {string}                members             Unique identifiers(s) for participant(s) in the discussion
 * @BodyParam   {string}                visibility          Visibility for discussion ("loggedin","private","public")
 ...
 * @QueryParam  {string}                [start]             Marker for continuing search (starts at beginning by default)
 * @Return      {DiscussionMembers}                         Returns an object containing members of discussion
 */
 ...
 * @QueryParam  {string}                [start]             Marker for continuing search (starts at beginning by default)
 * @Return      {DiscussionMessages}                        Returns an object containing messages of discussion
 */
 ...
 * @BodyParam   {string}                body                Content of new message
 * @BodyParam   {string}                replyTo             Created time for message to which the new message is a reply
...
/**
 * @REST deletedDiscussionDiscussionIdMessages/Created
 *
 * Delete a message in a discussion
 *
 * @Server      tenant
 * @Method      DELETE
 * @Path        /discussion/{discussionId}/messages{creaeted}
...
// Add the REST models for Discussions
 ...
 * @Property  {string}          role                    Role of member ("manager","member")
 */

/**
 * @RESTModel Message
 *
 * @Required  [created,id,level,messageBoxId, replyTo, threadKey]
 ...
 * @Property  {string}          id                      Unique identifier for message (discussion id + "#" + creation time)
 ...
 * @Property  {string}          threadKey               Unique identifier for message threat (concatenation of creation times + "#" terminated by "|")
 */
