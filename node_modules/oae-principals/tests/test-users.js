                          ...
                          RestAPI.User.getMe(nicolaasRestContext, (err, nicolaasMeObj) => {
                            ...
                            PrincipalsTestUtil.importUsers(
                              ...
                              (err) => {
                                ...
                                RestAPI.User.getMe(nicolaasRestContext, (
                                  err,
                                  nicolaasMeObj
                                ) => {
                                  _verifyUser(
              ...
              RestAPI.User.getMe(camAdminRestContext, (err, camAdminUser) => {
                ...
                RestAPI.User.getUser(globalAdminRestContext, camAdminUser.id, (err, user) => {
                  ...
                  RestAPI.User.getMe(globalAdminRestContext, (err, globalAdminUser) => {
                    ...
                    RestAPI.User.getUser(globalAdminRestContext, globalAdminUser.id, (
                      err,
                      user
                    ) => {
                      assert.ok(!err);
                      ...
                      RestAPI.User.getUser(camAdminRestContext, camUser.user.id, (
                        err,
                        user
                      ) => {
                        assert.ok(!err);
                        ...
                        RestAPI.User.getUser(gtAdminRestContext, camUser.user.id, (
                          err,
                          user
                        ) => {
                          assert.ok(!err);
                          ...
                          RestAPI.User.getUser(camAdminRestContext, gtUser.user.id, (
                            err,
                            user
                          ) => {
                            assert.ok(!err);
                            ...
                            RestAPI.User.getUser(gtAdminRestContext, gtUser.user.id, (
                              err,
                              user
                            ) => {
                              assert.ok(!err);
                              ...
                              RestAPI.User.getUser(camUser.restContext, camUser.user.id, (
                                err,
                                user
                              ) => {
                                assert.ok(!err);
                    ...
                    PrincipalsAPI.setGlobalAdmin(globalAdminContext, jack.user.id, true, err => {
                      ...
                      PrincipalsAPI.getUser(
                        ...
                        (err, user) => {
                          ...
                          PrincipalsAPI.setGlobalAdmin(jack.context, jane.user.id, true, (
                            err
                          ) => {
                            assert.ok(!err);
                  ...
                  RestAPI.User.setTenantAdmin(anonymousRestContext, jane.user.id, false, err => {
                    ...
                    RestAPI.User.setTenantAdmin(
                      ...
                      (err) => {
                        ...
                        RestAPI.User.setTenantAdmin(jack.restContext, jane.user.id, false, (
                          err
                        ) => {
                          assert.ok(err);
                          assert.strictEqual(err.code, 401);
