...
OAE.tenantServer.post('/api/group/create', function(req, res) {
    ...
    PrincipalsAPI.createGroup(req.ctx, req.body.alias, req.body.displayName, req.body.description, req.body.visibility, req.body.joinable, memberHash, {}, function(err, groupId) {
        if (err) {
...
/*!
 * Checks if a group alias is available
 */
...
OAE.tenantServer.get('/api/group/:id/members', function(req, res) {
    ...
    PrincipalsAPI.getGroupMembers(req.ctx, req.params.id, req.query.start, req.query.limit, function(err, members) {
        if (err) {
            return res.send(err.code, err.msg);
        }
 ...
 */
OAE.tenantServer.post('/api/group/:id/join', function(req, res) {
    req.telemetryUrl = '/api/group/id/join';
 ...
 */
OAE.tenantServer.post('/api/group/:id/leave', function(req, res) {
    req.telemetryUrl = '/api/group/id/leave';
