...
var ensureSchema = function(callback) {
    ...
    Cassandra.createColumnFamily('Principals', 'CREATE COLUMNFAMILY Principals (principalId text PRIMARY KEY, tenantAlias text, tenantAlias text, displayName text, visibility text);', callback);
};
