    ...
    MediaCoreUtil.signedRequest(
      ...
      function(err, res, body) {
        if (
          _checkError(
            err,
            'Error POSTing to create the MediaCore video item',
            res,
            body,
            callback,
          )
              ...
              function(err, res, body) {
                ...
                MediaCoreUtil.signedRequest(
                  ...
                  function(err, res, body) {
                    ...
                    var uploadReq = request.post(
                      uploadProtocol.upload_url,
                      function(err, res, body) {
                        if (
                          _checkError(
                            err,
                    ...
                    _.each(uploadProtocol.upload_post_params, function(
                      value,
                      key,
                    ) {
                    ...
                    form.append(
                      uploadProtocol.upload_file_param,
  ...
  MediaCoreUtil.signedRequest(
    ...
    function(err, res, body) {
      if (
        _checkError(
          err,
          'Error getting the thumbnail urls',
          res,
          body,
          callback,
        )
