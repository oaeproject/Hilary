...
/**
 * FIXME: `updateConfigAndWait` will be changed to this method's signature soon, in which case this method can be removed. This is
 * currently in another branch.
 */
var updateAllConfigAndWait = module.exports.updateAllConfigAndWait = function(restCtx, tenantAlias, updates, callback) {
    ...
    RestAPI.Config.updateConfig(restCtx, tenantAlias, updates, function(err) {
        if (err) {
...
var updateConfigAndWait = module.exports.updateConfigAndWait = function(restCtx, tenantAlias, configField, configValue, callback) {
    var update = {};
    update[configField] = configValue;
    return updateAllConfigAndWait(restCtx, tenantAlias, update, callback);
};
 ...
 */
var clearConfigAndWait = module.exports.clearConfigAndWait = function(restCtx, tenantAlias, configField, callback) {
    ...
    /*!
     * Monitors the result of both the clearConfig web request and the internal "config refreshed" event
     * to only callback when both the request has executed completely and the asynchronous update process
     * has completed.
     *
     * @param  {Object}     err     An error that occured in either request
    ...
    RestAPI.Config.clearConfig(restCtx, tenantAlias, [configField], function(err) {
        if (err) {
            // Remove this listener, since it may not be invoked and "leak" due to this error
            ConfigAPI.removeListener('update', _updateListener);
            return _callback(err);
