...
var ActivitySeedResource = require('oae-activity/lib/model')
...
describe('Activity', function() {
    ...
    RestAPI.Discussions.createDiscussion(
      ...
      function(err, publicDiscussion) {
        ...
        RestAPI.Discussions.createDiscussion(
          ...
          null,
          null,
          function(err, loggedinDiscussion) {
            assert.ok(!err);
            RestAPI.Discussions.createDiscussion(
              actorRestContext,
              'title',
              ...
              null,
              null,
              function(err, privateDiscussion) {
                assert.ok(!err);
    ...
    ActivityTestUtil.collectAndGetActivityStream(
      ...
      function(err, result) {
        ...
        _.each(shareActivities, function(activity) {
          retrievedObjectEntities = retrievedObjectEntities.concat(
            _getEntities(activity, 'object'),
          );
          retrievedTargetEntities = retrievedTargetEntities.concat(
            _getEntities(activity, 'target'),
          );
        });
  ...
  var _setupUsersAndDiscussions = function(callback) {
    TestsUtil.setupMultiTenantPrivacyEntities(function(
      ...
      TestsUtil.generateTestUsers(publicTenant0.adminRestContext, 1, function(
        err,
        users,
        extraPublicUser,
      ) {
  ...
  var _setupGroupsAndDiscussions = function(callback) {
    TestsUtil.setupMultiTenantPrivacyEntities(function(
      ...
      _createDiscussion(
        ...
        function(publicDiscussion, loggedinDiscussion, privateDiscussion) {
  ...
  describe('Activity API', function() {
    describe('#refreshConfiguration()', function() {
                ...
                function(err, link) {
                  ...
                  ActivityTestUtil.collectAndGetActivityStream(
                    ...
                    function(err, activityStream) {
                      ...
                      ActivityTestUtil.refreshConfiguration(null, function(
                        err,
                      ) {
                        assert.ok(!err);
      ...
      it('verify activity ttl deletes an activity after the expiry time', function(callback) {
        ...
        ActivityTestUtil.refreshConfiguration({ activityTtl: 2 }, function(
          err,
        ) {
          assert.ok(!err);
    ...
    describe('#registerActivityEntityType()', function() {
      ...
      it('verify default producer persists just the activity seed resource data', function(callback) {
        ...
        var actorResource = new ActivitySeedResource(
          testResourceType,
          testResourceId,
        );
        var objectResource = new ActivitySeedResource(
          testResourceType,
          testResourceId2,
          { testData: 'Testing' },
        );
        var targetResource = new ActivitySeedResource(
          testResourceType,
          testResourceId3,
        );
          ...
          RestAPI.Content.createLink(
            ...
            function(err, link) {
              ...
              /*!
                         ...
                         */
              var _createActivitySeed = function(
                seedOverlay,
                actorOverlay,
                objectOverlay,
                targetOverlay,
  ...
  describe('Activity Routing', function() {
    ...
    it('verify activity association caching', function(callback) {
      ...
      RestAPI.Content.createLink(
        ...
        function(err, link) {
          ...
          var associationsSession = new AssociationsSession(
            ActivityRegistry.getRegisteredActivityEntityAssociations(),
            activityResource,
          );
          var associationsCtx = associationsSession.createAssociationsContext(
            'content',
            link.id,
          );
                ...
                ConfigTestsUtil.updateConfigAndWait(
                  ...
                  function(err) {
                    ...
                    var objectResource = new ActivitySeedResource(
                      testEntityType,
                      testId,
                      { visibility: 'private', joinable: 'yes' },
                    );
                    var activitySeed = new ActivitySeed(
                      'content-create',
                      Date.now(),
                      'create',
                      actorResource,
                    ...
                    ActivityAPI.postActivity(
                      new Context(publicTenant0.tenant),
                      activitySeed,
                    );
    ...
    it('verify default resource propagation of "routes"', function(callback) {
      TestsUtil.setupMultiTenantPrivacyEntities(function(
        ...
        ActivityAPI.registerActivityEntityAssociation(
          testEntityType,
          'members',
          function(associationsCtx, entity, associationsCallback) {
            ...
            return associationsCallback(null, [
              publicTenant0.publicUser.user.id,
            ]);
          },
        );
          ...
          function(err) {
            ...
            ActivityTestUtil.collectAndGetActivityStream(
              ...
              function(err, response) {
                ...
                var contentCreateActivity = _.findWhere(response.items, {
                ...
                ActivityTestUtil.collectAndGetActivityStream(
                  ...
                  function(err, response) {
                    assert.ok(!err);
                    assert.ok(
                      !_.findWhere(response.items, {
                        'oae:activityType': 'content-create',
                      }),
                    );

                    var followActivity = _.findWhere(response.items, {
    ...
    it('verify activity association exclusion', function(callback) {
      TestsUtil.generateTestUsers(camAdminRestContext, 3, function(
        err,
        users,
        nico,
        branden,
        ...
        ActivityAPI.registerActivityEntityAssociation(
          testEntityType,
          'all',
          function(associationsCtx, entity, callback) {
                        ...
                        _assertStream(
                          ...
                          function() {
                            _assertStream(
                              ...
                              1,
                              [
                                publicTenant0.discussions.public2Extra.public
                                  .id,
                              ],
                              [publicTenant0.extraPublicUser.user.id],
                              function() {
                                    ...
                                    _assertStream(
                                      ...
                                      [
                                        ...
                                        publicTenant0.discussions.public2Extra
                                          .loggedin.id,
                                        publicTenant0.discussions
                                          .public2Loggedin.public.id,
                                        publicTenant0.discussions
                                          .public2Loggedin.loggedin.id,
                                      ],
                                      [
                                        publicTenant0.extraPublicUser.user.id,
                                        publicTenant0.loggedinUser.user.id,
                                      ...
                                      function() {
                                        ...
                                        var objectEntities = [
                                          ...
                                          publicTenant0.discussions
                                            .public2Loggedin.loggedin.id,
                                          publicTenant0.discussions
                                            .public2Loggedin.private.id,
                                          publicTenant0.discussions
                                            .loggedin2Public.public.id,
                                          publicTenant0.discussions
                                            .loggedin2Public.loggedin.id,
                                          publicTenant0.discussions
                                            .loggedin2Public.private.id,
                                          publicTenant0.discussions
                                            .private2Public.public.id,
                                          publicTenant0.discussions
                                            .private2Public.loggedin.id,
                                          publicTenant0.discussions
                                            .private2Public.private.id,
                                        ];
                                        _assertStream(
                                          publicTenant0.publicUser.restContext,
                                          publicTenant0.publicUser.user.id,
                                          ...
                                          objectEntities,
                                          [
                                            publicTenant0.extraPublicUser.user
                                              .id,
                                            publicTenant0.loggedinUser.user.id,
                                            publicTenant0.publicUser.user.id,
                                          ],
                                      ...
                                      function() {
                                        ...
                                        objectEntities = [
                                          ...
                                          publicTenant0.discussions
                                            .loggedin2Public.private.id,
                                          publicTenant0.discussions
                                            .loggedin2Extra.public.id,
                                          publicTenant0.discussions
                                            .loggedin2Extra.loggedin.id,
                                          publicTenant0.discussions
                                            .loggedin2Extra.private.id,
                                          publicTenant0.discussions
                                            .public2Loggedin.public.id,
                                          publicTenant0.discussions
                                            .public2Loggedin.loggedin.id,
                                          publicTenant0.discussions
                                            .public2Loggedin.private.id,
                                          publicTenant0.discussions
                                            .private2Loggedin.public.id,
                                          publicTenant0.discussions
                                            .private2Loggedin.loggedin.id,
                                          publicTenant0.discussions
                                            .private2Loggedin.private.id,
                                        ];
                                        _assertStream(
                                          publicTenant0.loggedinUser
                                            .restContext,
                                      ...
                                      function() {
                                        ...
                                        var objectEntities = [
                                          ...
                                          publicTenant0.discussions
                                            .private2Loggedin.private.id,
                                          publicTenant0.discussions
                                            .private2Extra.public.id,
                                          publicTenant0.discussions
                                            .private2Extra.loggedin.id,
                                          publicTenant0.discussions
                                            .private2Extra.private.id,
                                        ];
                                        _assertStream(
                                          publicTenant0.privateUser.restContext,
                                          publicTenant0.privateUser.user.id,
                            ...
                            _assertStream(
                              ...
                              function() {
                                ...
                                _assertStream(
                                  ...
                                  1,
                                  [
                                    publicTenant0.publicGroup.discussions.public
                                      .id,
                                    publicTenant0.publicGroup.discussions
                                      .loggedin.id,
                                  ],
                ...
                ActivityTestUtil.collectAndGetActivityStream(
                  ...
                  function(err, activityStream) {
                    ...
                    _.each(activityStream.items, function(activity) {
                      ...
                      assertActivityEntity(activity.object);
                      if (activity['oae:activityType'] === 'content-share') {
                        _.each(activity.target['oae:collection'], function(
                          entity,
                        ) {
                  ...
                  function(err, activityStream) {
                    ...
                    ActivityTestUtil.collectAndGetActivityStream(
                      ...
                      function(err, activityStream) {
                        ...
                        assert.equal(activityStream.items.length, 1);
                        assert.equal(
                          activityStream.items[0]['oae:activityId'],
                          firstId,
                        );
          ...
          function(err, link) {
            ...
            ActivityTestUtil.collectAndGetActivityStream(
              ...
              function(err, activityStream) {
                ...
                assert.equal(
                  activity.actor['oae:visibility'],
                  jack.user.visibility,
                );
                assert.equal(
                  activity.actor['oae:profilePath'],
                  jack.user.profilePath,
                );
                assert.equal(
                ...
                assert.equal(
                  activity.object['oae:revisionId'],
                  link.latestRevisionId,
                );
                ...
                RestAPI.Activity.getActivityStream(
                  ...
                  function(err, activityStream) {
                    ...
                    assert.equal(
                      activity.actor['visibility'],
                      jack.user.visibility,
                    );
                    assert.equal(activity.actor['locale'], 'en_GB');
                    assert.equal(
                      activity.actor['publicAlias'],
                      jack.user.publicAlias,
                    );
                    assert.ok(_.isObject(activity.actor['picture']));
                    assert.equal(
                      activity.actor['profilePath'],
                      jack.user.profilePath,
                    );
                    ...
                    _.each(activity.actor, function(value, key) {
                      assert.ok(
                        _.contains(allowedActorProperties, key),
                        key +
                          ' is not allowed on an internally formatted activity entity',
                      );
                    });
                    ...
                    assert.equal(
                      activity.object['resourceSubType'],
                      link.resourceSubType,
                    );
                    assert.equal(activity.object['createdBy'], link.createdBy);
                    assert.equal(activity.object['created'], link.created);
                    assert.equal(
                      activity.object['lastModified'],
                      link.lastModified,
                    );
                    assert.equal(
                      activity.object['profilePath'],
                      link.profilePath,
                    );
                    assert.equal(
                      activity.object['resourceType'],
                      link.resourceType,
                    );
                    assert.equal(
    ...
    it('verify an error in routed activity data does not permanently damage an aggregation bucket', function(callback) {
      ...
      ActivityAggregator.collectAllBuckets(function(err) {
        ...
        TestsUtil.generateTestUsers(camAdminRestContext, 1, function(
          ...
          ActivityDAO.getAggregateStatus = function(
            allAggregateKeys,
            callback,
          ) {
            var brokenAggregateKeyPrefix = util.format(
              'content-create#%s#activity',
              jack.user.id,
            );
            var brokenAggregateKeys = _.filter(allAggregateKeys, function(
              aggregateKey,
            ) {
            ...
            if (_.isEmpty(brokenAggregateKeys)) {
              ...
              return activityDaoGetAggregateStatusFn(
                allAggregateKeys,
                callback,
              );
            } else {
                  ...
                  function(err, linkB) {
                    ...
                    ActivityTestUtil.collectAndGetActivityStream(
                      ...
                      function(err, activityStream) {
                        ...
                        _.each(entity['oae:collection'], function(
                          collectedEntity,
                        ) {
                              ...
                              function(err, activityStream) {
                                ...
                                _.each(entity['oae:collection'], function(
                                  ...
                                  if (collectedEntity['oae:id'] === linkA.id) {
                                    ...
                                    collectedEntity['oae:id'] === linkB.id
                                  ) {
                                    hasB = true;
                                  }
                                });
                          ...
                          function(err, linkC) {
                            ...
                            ActivityTestUtil.collectAndGetActivityStream(
                              ...
                              function(err, activityStream) {
                                ...
                                entity = activityStream.items[1].object;
                                assert.ok(entity['oae:collection']);
                                entity['oae:collection'].forEach(function(
                                  collectedEntity,
                                ) {
                                  if (collectedEntity['oae:id'] === linkA.id) {
                                    hasA = true;
              ...
              function(err, link) {
                ...
                ActivityTestUtil.collectAndGetActivityStream(
                  ...
                  function(err, activityStream) {
                    ...
                    var aggregateKey = util.format(
                      'content-create#%s#activity#user:%s##__null__',
                      jack.user.id,
                      jack.user.id,
                    );

                    ActivityDAO.getAggregateStatus([aggregateKey], function(
                      err,
                      aggregateStatus,
                    ) {
                      assert.ok(!err);
                      ...
                      ActivityDAO.getAggregatedEntities(
                        [aggregateKey],
                        function(err, aggregatedEntities) {
                          ...
                          assert.ok(
                            aggregatedEntities[aggregateKey]['actors'][
                              'user:' + jack.user.id
                            ],
                          );
                          assert.ok(
                            aggregatedEntities[aggregateKey]['objects'][
                              'content:' + link.id
                            ],
                          );
                            ...
                            function(err, aggregateStatus) {
                              ...
                              ActivityDAO.getAggregatedEntities(
                                ...
                                function(err, aggregatedEntities) {
                                  assert.ok(!err);
                                  assert.ok(
                                    _.isEmpty(aggregatedEntities['actors']),
                                  );
                                  assert.ok(
                                    _.isEmpty(aggregatedEntities['objects']),
                                  );
                                  assert.ok(
                                    _.isEmpty(aggregatedEntities['targets']),
                                  );
                                ...
                                ActivityTestUtil.collectAndGetActivityStream(
                                  ...
                                  function(err, activityStream) {
                                    ...
                                    ActivityTestUtil.collectAndGetNotificationStream(
                                      mrvisser.restContext,
                                      null,
                                      function(err, notificationStream) {
                                        assert.ok(!err);
                                        assert.equal(
            ...
            ActivityTestUtil.collectAndGetActivityStream(
              ...
              function(err, activityStream) {
                ...
                ActivityDAO.getActiveAggregateKeysForActivityStreams(
                  ...
                  function(err, activeAggregateKeysForActivityStream) {
                    assert.ok(!err);
                    assert.equal(
                      activeAggregateKeysForActivityStream.length,
                      1,
                    );
                    assert.ok(
                      !_.isEmpty(activeAggregateKeysForActivityStream[0]),
                    );

                    // Verify that the notification stream has a set of keys as well
                    ActivityDAO.getActiveAggregateKeysForActivityStreams(
                      [simong.user.id + '#notification'],
                      function(err, activeAggregateKeysForNotificationStream) {
                        assert.ok(!err);
                        assert.equal(
                        ...
                        assert.ok(
                          !_.isEmpty(
                            activeAggregateKeysForNotificationStream[0],
                          ),
                        );

                        // Assert that the aggregate keys for a notification stream are different than those of an activity stream
                        var allActivityKeys = _.flatten(
                          activeAggregateKeysForActivityStream,
                        );
                        var allNotificationKeys = _.flatten(
                          ...
                          function(err) {
                            ...
                            ActivityDAO.getActiveAggregateKeysForActivityStreams(
                              ...
                              function(
                                ...
                                assert.ok(
                                  _.isEmpty(
                                    activeAggregateKeysForActivityStream[0],
                                  ),
                                );
