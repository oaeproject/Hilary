...
var joinPad = module.exports.joinPad = function(ctx, contentId, padId, groupId, callback) {
    ...
    client.createAuthorIfNotExistsFor(args, function(err, author) {
        ...
        client.createSession(session, function(err, data) {
            ...
            // Construct the URL
            var url = getPadUrl(contentId, ctx.user().id, data.sessionID, padId, author.authorID, language);
 ...
 */
var getPadUrl = module.exports.getPadUrl = function(contentId, userId, sessionId, padId, authorId, language) {
