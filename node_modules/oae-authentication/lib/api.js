...
/*!
 * Register a new ldap passport login strategy for a tenant
 *
 * @param  {Tenant}     tenant      Tenant for which we want to register the strategy
 * @param  {String}     strategyId  The tenant-discriminated ID of the strategy to bind
 * @api private
 */
strategySetup[AuthenticationConstants.providers.LDAP] = function(tenant, strategyId) {
    ...
    var strategy = new LDAPStrategy({
        ...
        var context = new Context(tenant, null);
        getOrCreateUser(context, AuthenticationConstants.providers.LDAP, externalId, displayName, opts, done);
      }
    );
