 ...
 * @param  {Number}             [minimum]   A lower bound for `val`. If this is left undefined or null, no bounding will be applied.
 * @param  {Number}             [maximum]   An upper bound for `val`. If this is left undefined or null, no bounding will be applied.
