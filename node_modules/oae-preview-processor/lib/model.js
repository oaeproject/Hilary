...
var PreviewContext = module.exports.PreviewContext = function(config, contentId) {
     ...
     */
    that.downloadRemoteFile = function(url, callback) {
        var called = false;
        var path = that.baseDir + '/' + Math.round(Math.random()*100000000);
        ...
        // Download it.
        log().trace({'contentId': contentId}, 'Downloading %s to %s', url, path);
