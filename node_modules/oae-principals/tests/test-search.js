        ...
        it('verify indexing without full group item', function(callback) {
            ...
            RestAPI.User.createUser(camAdminRestContext, doerUsername, 'password', 'Doer', null, function(err, doer) {
                ...
                RestAPI.Group.createGroup(doerRestContext, groupAlias, groupAlias, groupAlias, 'public', 'no', [], [], function(err, group) {
                    ...
                    // Verify the content item exists
                    SearchTestsUtil.searchAll(doerRestContext, 'general', null, {'resourceTypes': 'group', 'q': groupAlias}, function(err, results) {
                        assert.ok(!err);
                            ...
                            SearchTestsUtil.searchAll(doerRestContext, 'general', null, {'resourceTypes': 'group', 'q': groupAlias}, function(err, results) {
                                ...
                                MQ.submit(SearchConstants.mq.TASK_INDEX_DOCUMENT, indexJob, function() {
                                    ...
                                    SearchTestsUtil.searchAll(doerRestContext, 'general', null, {'resourceTypes': 'group', 'q': groupAlias}, function(err, results) {
                                        ...
                                        assert.equal(groupDoc.tenant.name, global.oaeTests.tenants.cam.name);
