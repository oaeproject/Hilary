 ...
 */
var transformActivities = module.exports.transformActivities = function(ctx, activities, transformerType, callback) {
...
var _getEntityTypeTransformer = function(objectType, transformerType) {
    var activityEntityType = ActivityRegistry.getRegisteredActivityEntityTypes()[objectType] || {};
...
var _addTenantInformationToActivityEntity = function(entity) {
    if (entity) {
        ...
        if (entity[ActivityConstants.properties.OAE_ID]) {
            var tenantAlias = AuthzUtil.getResourceFromId(entity[ActivityConstants.properties.OAE_ID]).tenantAlias;
