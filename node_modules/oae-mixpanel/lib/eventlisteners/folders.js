...
module.exports = function(client) {
  ...
  MixpanelUtil.listen(
    FoldersAPI,
    FoldersConstants.events.GET_FOLDER_PROFILE,
    function(ctx, folder) {
  ...
  MixpanelUtil.listen(
    ...
    function(ctx, folder, memberChangeInfo) {
      var params = getBasicFolderParameters(ctx, folder);
  ...
  MixpanelUtil.listen(
    ...
    function(ctx, principalId, visibility, start, limit, folders) {
  ...
  MixpanelUtil.listen(
    ...
    function(ctx, newFolder, oldFolder) {
      ...
      params.updatedDisplayName =
        newFolder.displayName !== oldFolder.displayName;
  ...
  MixpanelUtil.listen(
    ...
    function(ctx, folder, memberChangeInfo, opts) {
  ...
  MixpanelUtil.listen(
    ...
    function(ctx, actionContext, folder, contentItems) {
  ...
  MixpanelUtil.listen(
    ...
    function(ctx, folder, contentItems) {
      var params = getBasicFolderParameters(ctx, folder);
      params.nrOfContentItems = contentItems.length;
  ...
  MixpanelUtil.listen(
    ...
    function(ctx, message, folder, deleteType) {
      var params = getBasicFolderParameters(ctx, folder);
