        ...
        it('verify the memberships library automatically rebuilds and pages when purged', function(callback) {
            TestsUtil.generateTestUsers(camAdminRestContext, 2, function(err, users) {
                ...
                TestsUtil.generateTestGroups(branden.restContext, 110, function() {
                    ...
                    PrincipalsTestsUtil.assertGetAllMembershipsLibrarySucceeds(simon.restContext, branden.user.id, null, function(membershipsBefore) {
                        ...
                        LibraryAPI.Index.purge(PrincipalsConstants.library.MEMBERSHIPS_INDEX_NAME, branden.user.id, function(err) {
                            ...
                            PrincipalsTestsUtil.assertGetAllMembershipsLibrarySucceeds(simon.restContext, branden.user.id, null, function(membershipsAfter) {
            ...
            TestsUtil.generateTestUsers(camAdminRestContext, 2, function(err, users) {
                ...
                TestsUtil.generateTestGroups(branden.restContext, 2, function() {
                    ...
                    Cassandra.runQuery('DELETE "lastModified" FROM "Principals" WHERE "principalId" IN (?)', [groupIds], function(err) {
                        ...
                        PrincipalsTestsUtil.assertGetAllMembershipsLibrarySucceeds(simon.restContext, branden.user.id, null, function(memberships) {
                ...
                PrincipalsTestsUtil.addUserToAllGroups(publicTenant1.publicUser, publicTenant1, publicTenant2, privateTenant1, function() {
                    ...
                    TestsUtil.generateTestGroups(publicTenant1.adminRestContext, 1, function(indirectGroup) {
                        ...
                        RestAPI.Group.setGroupMembers(publicTenant1.adminRestContext, indirectGroup.group.id, changes, function(err) {
                            ...
                            PrincipalsTestsUtil.assertGetAllMembershipsLibrarySucceeds(publicTenant1.publicUser.restContext, publicTenant1.publicUser.user.id, null, function(memberships) {
                                ...
                                PrincipalsTestsUtil.assertGetAllMembershipsLibrarySucceeds(publicTenant1.adminRestContext, publicTenant1.publicUser.user.id, null, function(memberships) {
                                    _assertArraysEqual(expectedPrivateFeed, _.pluck(memberships, 'id'));

                                    // Ensure the global admin can see all groups in the memberships library feed
                                    PrincipalsTestsUtil.assertGetAllMembershipsLibrarySucceeds(globalAdminOnTenantRestContext, publicTenant1.publicUser.user.id, null, function(memberships) {
                                        _assertArraysEqual(expectedPrivateFeed, _.pluck(memberships, 'id'));

                                        // Ensure a user from the same tenant can see loggedin feed
                                        PrincipalsTestsUtil.assertGetAllMembershipsLibrarySucceeds(publicTenant1.loggedinUser.restContext, publicTenant1.publicUser.user.id, null, function(memberships) {
                                            _assertArraysEqual(expectedLoggedinFeed, _.pluck(memberships, 'id'));

                                            // Ensure anonymous user gets the public feed
                                            PrincipalsTestsUtil.assertGetAllMembershipsLibrarySucceeds(publicTenant1.anonymousRestContext, publicTenant1.publicUser.user.id, null, function(memberships) {
                                                _assertArraysEqual(expectedPublicFeed, _.pluck(memberships, 'id'));

                                                // Ensure user from another tenant gets the public feed
                                                PrincipalsTestsUtil.assertGetAllMembershipsLibrarySucceeds(publicTenant2.publicUser.restContext, publicTenant1.publicUser.user.id, null, function(memberships) {
                                                    _assertArraysEqual(expectedPublicFeed, _.pluck(memberships, 'id'));

                                                    // Ensure tenant admin from another tenant gets the public feed
                                                    PrincipalsTestsUtil.assertGetAllMembershipsLibrarySucceeds(publicTenant2.adminRestContext, publicTenant1.publicUser.user.id, null, function(memberships) {
                                                        _assertArraysEqual(expectedPublicFeed, _.pluck(memberships, 'id'));
                                                        return callback();
                                                    });
                                                });
