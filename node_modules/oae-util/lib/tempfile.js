 ...
 */
const init = module.exports.init = function(directory) {
    Temp.dir = directory;
};
 ...
 */
const TempFile = module.exports.TempFile = function(path, size) {
    const that = {};
    that.path = path;
    that.size = size;
 ...
 * @return {TempFile}
 */
const createTempFile = module.exports.createTempFile = function(options) {
    options = options || {};
