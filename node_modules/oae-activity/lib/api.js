...
var refreshConfiguration = module.exports.refreshConfiguration = function(config, callback) {
    ...
    if (config.mail.processJobs && config.mail.pollingFrequency > 0) {
        var mailPollingFrequencyInMs = config.mail.pollingFrequency * 1000;
        // Delegate to the mail poller to collect/aggregate all buckets
...
var markNotificationsRead = module.exports.markNotificationsRead = function(ctx, callback) {
    ...
    ActivityNotifications.markNotificationsRead(ctx, callback);
};
