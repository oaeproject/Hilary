 ...
 */
var logAuthnSuccess = module.exports.logAuthnSuccess = function(req, user, strategy) {
...
var handlePassportError = module.exports.handlePassportError = function(req, res, next) {
    return function(err) {
        if (err && err.message && err.message.indexOf('no strategy registered under name') === 0) {
...
var externalSuccessCallback = module.exports.externalSuccessCallback = function(req, res, user, strategy, next) {
    logAuthnSuccess(req, user, strategy);
