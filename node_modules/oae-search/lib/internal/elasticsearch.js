 ...
 */
const refreshSearchConfiguration = module.exports.refreshSearchConfiguration = function(_index, serverOpts) {
    index = _index;
 ...
 */
const createIndex = module.exports.createIndex = function(indexName, settings, callback) {
 ...
 * @param  {Object}    callback.err    An error that occurred, if any
 */
const deleteIndex = module.exports.deleteIndex = function(indexName, callback) {
    indexExists(indexName, (err, exists) => {
        if (err) {
            return callback(err);
        }
 ...
 * @param  {Object}      callback.err    An error that occurred, if any
 */
const refresh = module.exports.refresh = function(callback) {
 ...
 * @param  {Object}    callback.err        An error that occurred, if any
 */
const putMapping = module.exports.putMapping = function(typeName, fieldProperties, opts, callback) {
    opts = opts || {};
 ...
 */
const search = module.exports.search = function(query, options, callback) {
 ...
 * @param  {Object}    callback.err    An error that occurred, if any
 */
const bulk = module.exports.bulk = function(operations, callback) {
    let numOps = 0;
 ...
 * @param  {Object}    callback.err    An error that occurred, if any
 */
const del = module.exports.del = function(typeName, id, callback) {
 ...
 * @param  {Object}     callback.err    An error that occurred, if any
 */
const deleteByQuery = module.exports.deleteByQuery = function(typeName, query, options, callback) {
