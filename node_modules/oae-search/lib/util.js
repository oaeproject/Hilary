...
/**
 * Create an ElasticSearch filter that will narrow down documents to only those that belong to a
 * tenant that can interact with the specified `tenantAlias`
 *
 * @param  {String}     tenantAlias     The tenant alias for which to create the interaction filter
 * @return {Object}                     The filter that filters to only documents that belong to interacting tenants
 */
var filterInteractingTenants = module.exports.filterInteractingTenants = function(tenantAlias) {
    var interactingTenantAliases = TenantsUtil.getAllTenantsForInteraction(tenantAlias);
    return filterTerms('tenantAlias', _.union([tenantAlias], interactingTenantAliases));
};
 ...
 */
var filterScopeAndAccess = module.exports.filterScopeAndAccess = function(ctx, scope, needsFilterByExplicitAccess, callback) {
