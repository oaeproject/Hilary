...
/**
 * @RESTModel ActivityContentCollabsheet
 *
 * @Required    [displayName,id,oae:id,oae:profilePath,oae:resourceSubType,oae:revisionId,oae:tenant,oae:visibility,objectType,url]
 * @Property    {string}                    displayName                 The display name for the collaborative spreadsheet
 * @Property    {string}                    id                          The API URL for the collaborative spreadsheet
 * @Property    {ActivityImage}             image                       The thumbnail for the collaborative spreadsheet
 * @Property    {string}                    oae:id                      The id of the collaborative spreadsheet
 * @Property    {string}                    oae:profilePath             The relative path to the collaborative spreadsheet
 * @Property    {string}                    oae:resourceSubType         The content item type                           [collabsheet]
 * @Property    {string}                    oae:revisionId              The id of the current collaborative spreadsheet revision
 * @Property    {BasicTenant}               oae:tenant                  The tenant to which this collaborative spreadsheet is associated
 * @Property    {string}                    oae:visibility              The visibility of the collaborative spreadsheet    [loggedin,private,public]
 * @Property    {ActivityImage}             oae:wideImage               The wide thumbnail for the file
 * @Property    {string}                    objectType                  The type of activity entity                     [content]
 * @Property    {string}                    url                         The URL to the collaborative spreadsheet profile
 */
