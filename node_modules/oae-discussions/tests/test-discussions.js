...
describe('Discussions', function() {
    ...
    describe('Posting Messages', function() {
        ...
        /**
         * Test that verifies that the profile picture urls for a user are present in the create message response
         */
        it('verify message creation includes profile picture urls in the response', function(callback) {
            TestsUtil.generateTestUsers(camAdminRestCtx, 1, function(err, users, bert) {
                assert.ok(!err);
                ...
                RestAPI.User.uploadPicture(bert.restContext, bert.user.id, getPictureStream, cropArea, function(err) {
                    ...
                    RestAPI.Discussions.createDiscussion(bert.restContext, 'displayName', 'description', 'public', null, null, function(err, discussion) {
                        assert.ok(!err);

                        // Comment on it
                        RestAPI.Discussions.createMessage(bert.restContext, discussion.id, 'Message body', null, function(err, message) {
                            assert.ok(!err);
                            ...
                            RestAPI.Discussions.createMessage(bert.restContext, discussion.id, 'Message body', message.created, function(err, reply) {
                                assert.ok(!err);
