 ...
 * @see RestAPI.Search#search for the meaning of the method parameters.
 */
var searchAll = function(restCtx, searchType, params, opts, callback) {
  opts = _.extend({}, opts);
 ...
 */
var whenIndexingComplete = function(callback) {
 ...
 * @see RestAPI.Search#search for the meaning of the method parameters.
 */
var searchRefreshed = function(restCtx, searchType, params, opts, callback) {
  whenIndexingComplete(() => {
