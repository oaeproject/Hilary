 ...
 * @PathParam   {string}        groupId                 The id of the group this LTI tool belongs to
 * @FormParam   {string}        toolId                  The id of the new LTI tool (resource_link_id)
...
OAE.tenantRouter.on('post', '/api/lti/:groupId/create', function(req, res) {
    ...
    LtiApi.addLtiTool(req.ctx, req.body.toolId, req.params.groupId, req.body.url, req.body.secret, req.body.key, opts, function(err, tool) {
        if (err) {
            return res.send(err.code, err.msg);
        }
...
OAE.tenantRouter.on('get', '/api/lti/:groupId', function(req, res) {
    LtiApi.getLtiTools(req.ctx, req.params.groupId, function(err, results) {
        if (err) {
            return res.send(err.code, err.msg);
        }
