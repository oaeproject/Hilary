...
var generateTestUsers = module.exports.generateTestUsers = function(restCtx, total, callback, _createdUsers) {
    ...
    _ensureAuthenticated(restCtx, function(err) {
        ...
        RestAPI.User.createUser(restCtx, username, 'password', displayName, email, {}, function(err, user) {
            ...
            PrincipalsDAO.setEmailAddress(user, email.toLowerCase(), null, function(err, user) {
                assert.ok(!err);
    ...
    TenantsTestUtil.createTenantAndWait(adminCtx, tenantAlias, tenantAlias, tenantHost, function(err, tenant) {
        ...
        ConfigTestUtil.updateConfigAndWait(adminCtx, tenantAlias, {'oae-principals/recaptcha/enabled': false}, function(err) {
            ...
            RestAPI.User.createUser(anonymousCtx, 'administrator', 'administrator', 'Tenant Administrator', email, null, function(err, tenantAdmin) {
                ...
                PrincipalsDAO.setEmailAddress(tenantAdmin, email, null, function(err, tenantAdmin) {
                    if (err) {
                        return callback(err);
                    }
