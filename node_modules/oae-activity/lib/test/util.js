...
var getClient = module.exports.getClient = function(callback) {
     ...
     */
    client.subscribe = function(resourceId, streamType, token, callback) {
        var payload = {
            'stream': {
    ...
    getClient(function(client) {
        client.authenticate(data.authentication.userId, data.authentication.tenantAlias, data.authentication.signature, function(err) {
            ...
            var register = function() {
                ...
                client.subscribe(stream.resourceId, stream.streamType, stream.token, function(err) {
                    assert.ok(!err, 'Failed to register for feed ' + stream.resourceId + '#' + stream.streamType);
                    register();
                });
            };
