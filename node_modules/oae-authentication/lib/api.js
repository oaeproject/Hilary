...
var AuthenticationConfig = Config.config('oae-authentication');
...
Config.on('update', function(tenantAlias) {
 ...
 * @api private
 */
strategySetup[AuthenticationConstants.providers.SAML2] = function(tenant, strategyId) {
    var issuer = AuthenticationConfig.getValue(tenant.alias, 'saml2', 'issuer');
    var entryPoint = AuthenticationConfig.getValue(tenant.alias, 'saml2', 'entrypoint');
    ...
    var strategy = new SamlStrategy({
        ...
        var context = new Context(tenant, null);
        getOrCreateUser(context, AuthenticationConstants.providers.SAML2, username, displayName, opts, done);
    });
    passport.use(strategyId, strategy);
};
