 ...
 * */
var createMeeting = (module.exports.createMeeting = function(
  ctx,
  displayName,
  description,
  chat,
  ...
  visibility =
    visibility || Config.getValue(ctx.tenant().alias, 'visibility', 'meeting');
  ...
  ResourceActions.create(ctx, additionalMembers, createFn, function(
    err,
    meeting,
    memberChangeInfo,
  ) {
 ...
 */
var getFullMeetingProfile = (module.exports.getFullMeetingProfile = function(
  ctx,
  meetingId,
  callback,
) {
  ...
  _getMeeting(meetingId, function(err, meeting) {
    ...
    AuthzPermissions.resolveEffectivePermissions(ctx, meeting, function(
      err,
      permissions,
    ) {
      if (err) {
        ...
        return callback({
          code: 401,
          msg: 'You are not authorized to view this meeting',
        });
      }
      ...
      if (ctx.user()) {
        ...
        meeting.signature = Signature.createExpiringResourceSignature(
          ctx,
          meetingId,
        );
      }
      ...
      PrincipalsUtil.getPrincipal(ctx, meeting.createdBy, function(
        err,
        creator,
      ) {
        if (err) {
        ...
        MeetingsAPI.emit(
          MeetingsConstants.events.GET_MEETING_PROFILE,
          ctx,
          meeting,
        );
        return callback(null, meeting);
 ...
 * @param  {Function}  callback                Standard callback function
 */
var getMeetingInvitations = (module.exports.getMeetingInvitations = function(
  ctx,
  meetingId,
  callback,
) {
 ...
 * @param  {Function}  callback                Standard callback function
 */
var getMeetingMembers = (module.exports.getMeetingMembers = function(
  ctx,
  meetingId,
  start,
  limit,
  ...
  getMeeting(ctx, meetingId, function(err, meeting) {
    ...
    AuthzAPI.getAuthzMembers(meetingId, start, limit, function(
      err,
      memberRoles,
      nextToken,
    ) {
...
var updateMeeting = (module.exports.updateMeeting = function(
  ...
  _getMeeting(meetingId, function(err, meeting) {
    ...
    AuthzPermissions.canManage(ctx, meeting, function(err) {
      ...
      MeetingsDAO.updateMeeting(meeting, profileFields, function(
        err,
        updatedMeeting,
      ) {
        if (err) {
 ...
 */
var deleteMeeting = (module.exports.deleteMeeting = function(
  ctx,
  meetingId,
  callback,
) {
 ...
 * @param  {Object}     callback.err            An error that occurred, if any
 */
var setMeetingMembers = (module.exports.setMeetingMembers = function(
  ctx,
  meetingId,
  changes,
  callback,
  ...
  _getMeeting(meetingId, function(err, meeting) {
    ...
    ResourceActions.setRoles(ctx, meeting, changes, function(
      err,
      memberChangeInfo,
    ) {
      if (err) {
...
var getMessages = (module.exports.getMessages = function(
  ...
  var validator = new Validator();
  validator
    .check(meetingId, { code: 400, msg: 'Must provide a valid meeting id' })
    .isResourceId();
  validator
...
var createMessage = (module.exports.createMessage = function(
  ...
  validator
    ...
    .isLoggedInUser(ctx);
  validator
    .check(meetingId, { code: 400, msg: 'Invalid meeting id provided' })
    .isResourceId();
  validator
...
var deleteMessage = (module.exports.deleteMessage = function(
  ...
  validator
    ...
    .isLoggedInUser(ctx);
  validator
    .check(meetingId, { code: 400, msg: 'A meeting id must be provided' })
    .isResourceId();
  validator
 ...
 */
var getMeetingsLibrary = (module.exports.getMeetingsLibrary = function(
  ctx,
  principalId,
  start,
  limit,
 ...
 * @param  {Object}     callback.err    An error that occurred, if any
 */
var removeMeetingFromLibrary = (module.exports.removeMeetingFromLibrary = function(
  ctx,
  libraryOwnerId,
  meetingId,
  callback,
  ...
  _getMeeting(meetingId, function(err, meeting) {
    ...
    PrincipalsDAO.getPrincipal(libraryOwnerId, function(err, principal) {
      ...
      AuthzPermissions.canRemoveRole(ctx, principal, meeting, function(
        err,
        memberChangeInfo,
      ) {
        if (err) {
        ...
        AuthzAPI.updateRoles(meetingId, memberChangeInfo.changes, function(
          err,
        ) {
          if (err) {
            return callback(err);
...
var _getMeeting = function(meetingId, callback) {
  MeetingsDAO.getMeeting(meetingId, function(err, meeting) {
    if (err) {
      ...
      return callback({
        code: 404,
        msg: 'Could not find meeting : ' + meetingId,
      });
    }
