 ...
 *
 * Create a new collaborative document as content
 *
 * @Server      tenant
 * @Method      POST
 * @Path        /content/create
 ...
 * @FormParam   {string[]}          [managers]          Unique identifier(s) for manager(s) of the content (user creating discussion is always a manager); may string or array of strings
 * @FormParam   {string}            resourceSubType     Content type                        [collabdoc]
 * @FormParam   {string[]}          [viewers]           Unique identifiers(s) for users(s) who can access the content; may be string or array of strings
 * @FormParam   {string}            [visibility]        Visibility for content              [loggedin,private,public]
 * @Return      {BasicContent}                          The created content object
 */

/**
 * @REST postContentCreateFile
 *
 * Create new content by uploading a file
 *
 * @Server      tenant
 * @Method      POST
 * @Path        /content/create
 * @FormParam   {string}            [description]       Description of content item
 * @FormParam   {string}            displayName         Name to display for content item
 * @FormParam   {string[]}          [managers]          Unique identifier(s) for manager(s) of the content (user creating discussion is always a manager); may be string or array of strings
 * @FormParam   {string}            resourceSubType     Content type                        [file,]
 * @FormParam   {string[]}          [viewers]           Unique identifiers(s) for users(s) who can access the content; may be string or array of strings
 * @FormParam   {string}            [visibility]        Visibility for content              [loggedin,private,public]
 ...
 * @FormParam   {string}            [description]       Description of content item
 * @FormParam   {string}            displayName         Name to display for content item
 * @FormParam   {string}            link                URL for link
 * @FormParam   {string[]}          [managers]          Unique identifier(s) for manager(s) of the content (user creating discussion is always a manager); may be string or array of strings
 * @FormParam   {string}            resourceSubType     Content type                        [link]
 * @FormParam   {string[]}          [viewers]           Unique identifiers(s) for users(s) who can access the content; may be string or array of strings
 * @FormParam   {string}            [visibility]        Visibility for content              [loggedin,private,public]
 * @Return      {BasicContent}                          The created content object
 */
 ...
 * @Return      {Content}                                   The full content
 */
 ...
 * @Return      {File}                                      The file body of the content object
 */
 ...
 * @Return      {BasicContent}                              The content object
 */
 ...
 * @Return      {CollabDocInfo}                             Information on how to access the collaborative document object
 */
 ...
 * @PathParam   {string}            contentId               Unique identifier for content
 * @PathParam   {string}            revisionId              Unique identifier for content revision
 * @BodyParam   {PreviewInfo}       body                    Updated preview information
 ...
 *
 * Get a list of preview items for a specific revision
 *
 * @Server      tenant
 * @Method      GET
 * @Path        /content/{contentId}/revisions/{revisionId}/previews
 ...
 * @QueryParam  {string}            [start]             Revision at which to start (defaults to beginning)
 ...
 * @QueryParam  {string}            [start]             Member at which to start (defaults to beginning)
 ...
 * @Path        /content/{contentId}/members
 * @PathParam   {string}        contentId           Unique identifier for content
 * @BodyParam   {Permissions}   body                Permission(s) for specified user(s)
 */
 ...
 * @QueryParam  {string}            [start]             Message at which to start (defaults to beginning)
 ...
 * @QueryParam  {number}        [limit]             Maximum number of content items to return (defaults to 12, maximum of 25)
 * @QueryParam  {string}        [start]             Content item at which to start (defaults to beginning)
 * @Return      {ContentList}                       List of items in library
 */
 ...
 * @REST deleteContentContentIdMessagesCreated
 *
 * Delete a content item from a library
 *
 * @Server      tenant
 * @Method      DELETE
 ...
 *
 * Download a content item after verifying the signature information
 *
 * @Server      admin,tenant
 * @Method      GET
