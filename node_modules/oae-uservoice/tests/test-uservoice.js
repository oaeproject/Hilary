...
describe('UserVoice', function() {
    ...
    /*!
     * Before each test, ensure that the configuration has all the UserVoice SSO features enabled for the
     * Cambridge tenant
     */
    beforeEach(function(callback) {
        // Configure the subdomain and SSO key for the Cambridge tenant
