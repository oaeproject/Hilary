 ...
 */
const bootstrapModules = module.exports.bootstrapModules = function(config, callback) {
...
var bootstrapModulesInit = function(modules, config, callback) {
    ...
    async.mapSeries(modules, (moduleName, done) => {
 ...
 */
const getAvailableModules = module.exports.getAvailableModules = function() {
