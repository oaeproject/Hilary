...
var setUpTenants = function(err, callback) {
    ...
    // disable recaptcha so we can create users without a tenant admin
    var globalAdminRestCtx = TestsUtil.createGlobalAdminRestContext();
    RestAPI.Config.updateConfig(globalAdminRestCtx, null, 'oae-principals/recaptcha/enabled', false, function(err) {
