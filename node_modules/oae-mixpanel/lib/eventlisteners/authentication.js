...
module.exports = function(client, config) {
     ...
     * A user logs in
     */
    MixpanelUtil.listen(AuthenticationAPI, AuthenticationConstants.events.USER_LOGGED_IN, function(user, strategyName) {
        // Get the tenant alias from the user id
        var tenantAlias = AuthzUtil.getPrincipalFromId(user.id).tenantAlias;

        // The PP logs the admin on for every item it processes. These events
        // aren't terribly interesting, so we filter them out
     ...
     * A user logs out
     */
    MixpanelUtil.listen(AuthenticationAPI, AuthenticationConstants.events.USER_LOGGED_OUT, function(ctx) {
