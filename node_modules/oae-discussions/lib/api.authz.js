...
var canShareDiscussion = module.exports.canShareDiscussion = function(ctx, discussion, principalIds, callback) {
    ...
    AuthzAPI.canInteract(ctx, discussion.tenant.alias, principalIds, function(err, canInteract, illegalPrincipalIds) {
        if (err) {
            return callback(err);
        } else if (!canInteract) {
...
var canSetDiscussionPermissions = module.exports.canSetDiscussionPermissions = function(ctx, discussion, addMembers, callback) {
    ...
    AuthzAPI.canInteract(ctx, discussion.tenant.alias, addMembers, function(err, canInteract, illegalPrincipalIds) {
        if (err) {
            return callback(err);
        } else if (!canInteract) {
            return callback(null, false, illegalPrincipalIds);
