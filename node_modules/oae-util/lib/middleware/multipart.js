...
var log = require('oae-logger').logger('oae-util-multipart');
...
module.exports = function(formOptions) {
    ...
    return function(req, res, next) {
        ...
        (new multiparty.Form(formOptions)).parse(req, function(err, fields, files) {
            if (err) {
                log().error({
                    'err': err,
                    'req': req
                ...
                return res.send(400, 'An error ocurred while parsing the multipart form');
            }
 ...
 * @api private
 */
var _extractValue = function(value) {
