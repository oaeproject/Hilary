...
var assertCreateLinkSucceeds = module.exports.assertCreateLinkSucceeds = function(restContext, displayName, description, visibility, link, managers, members, folders, callback) {
    PrincipalsTestUtil.assertGetMeSucceeds(restContext, function(me) {
        RestAPI.Content.createLink(restContext, displayName, description, visibility, link, managers, members, folders, function(err, content) {
            assert.ok(!err);
...
var assertCreateLinkFails = module.exports.assertCreateLinkFails = function(restContext, displayName, description, visibility, link, managers, members, folders, httpCode, callback) {
    RestAPI.Content.createLink(restContext, displayName, description, visibility, link, managers, members, folders, function(err, content) {
        assert.ok(err);
        assert.strictEqual(err.code, httpCode);
        assert.ok(!content);
