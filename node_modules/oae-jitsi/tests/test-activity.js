...
describe('Meeting Activity', function() {
  ...
  describe('Meeting activities', function() {
    ...
    it('verify updating user role of a meeting results in an activity being generated', function(callback) {
      TestsUtil.generateTestUsers(camAdminRestContext, 12, function(
        err,
        users,
      ) {
        var simon = _.values(users)[0];
  ...
  describe('Meeting emails', function() {
    ...
    it('verify an email is sent to the members when a meeting is created and privacy is respected', function(callback) {
      ...
      createPrivateAndPublicUsers(camAdminRestContext, function(
        privateUser,
        publicUser,
      ) {
        // Create a meeting
        ...
        RestAPI.MeetingsJitsi.createMeeting(
          ...
          function(err, meeting) {
            ...
            EmailTestsUtil.collectAndFetchAllEmails(function(emails) {
              ...
              assert.equal(
                stringEmail.indexOf(privateUser.user.displayName),
                -1,
              );
              ...
              RestAPI.MeetingsJitsi.updateMembers(
                ...
                function(err) {
                  ...
                  EmailTestsUtil.collectAndFetchAllEmails(function(emails) {
                    ...
                    assert.notEqual(
                      stringEmail.indexOf(meeting.profilePath),
                      -1,
                    );
                    assert.notEqual(
                      stringEmail.indexOf(meeting.displayName),
                      -1,
                    );
                    ...
                    assert.equal(
                      stringEmail.indexOf(privateUser.user.email),
                      -1,
                    );
                    assert.equal(
                      stringEmail.indexOf(privateUser.user.locale),
                      -1,
                    );
