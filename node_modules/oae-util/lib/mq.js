 ...
 * @param   {Number}    [options.prefetchCount]     The number of tasks that will be distributed locally to the machine at a time
 ...
 * @param   {Object} 
 */
var bind = module.exports.bind = function(name, options, listener, callback) {
