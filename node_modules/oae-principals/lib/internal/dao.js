...
var getUserFromRow = function(row) {
    ...
    var blacklist = ['tenant', 'principalId', 'displayName', 'visibility', 'locale', 'timezone', 'publicAlias', 'smallPictureUri', 'mediumPictureUri', 'largePictureUri', 'admin:global', 'admin:tenant'];
