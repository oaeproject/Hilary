...
OAE.tenantServer.post('/api/content/:contentId/comments', function(req, res) {
    ContentAPI.createComment(req.ctx, req.params.contentId, req.body.body, null, function(err) {
        if (err) {
            return res.send(err.code, err.msg);
        }
        res.send(201);
...
OAE.tenantServer.post('/api/content/:contentId/comments/:commentId/reply', function(req, res) {
    ContentAPI.createComment(req.ctx, req.params.contentId, req.body.body, req.params.commentId, function(err) {
        if (err) {
            return res.send(err.code, err.msg);
        }
        res.send(201);
