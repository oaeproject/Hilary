 ...
 */
var startCollectingEmail = (module.exports.startCollectingEmail = function(
  startCallback,
) {
  // Start by ensuring we don't get emails that started before this collection
  // period
  collectAndFetchAllEmails(function() {
    ...
    startCallback(function(stopCallback) {
 ...
 */
var collectAndFetchAllEmails = (module.exports.collectAndFetchAllEmails = function(
  callback,
) {
  var messages = [];
  ...
  MqTestsUtil.whenTasksEmpty(ActivityConstants.mq.TASK_ACTIVITY, function() {
    ActivityNotifications.whenNotificationsEmpty(function() {
      ...
      // work
      EmailAPI.whenAllEmailsSent(function() {
        /*!
 ...
 * @param  {Object[]}   callback.messages   An array of mails that were sent out
 */
var collectAndFetchEmailsForBucket = (module.exports.collectAndFetchEmailsForBucket = function(
  bucketNumber,
  emailPreference,
  dayOfWeek,
  hourOfDay,
 ...
 */
var clearEmailCollections = (module.exports.clearEmailCollections = function(
  callback,
) {
  MqTestsUtil.whenTasksEmpty(ActivityConstants.mq.TASK_ACTIVITY, function() {
...
var _assertEmailTemplateFieldValid = function(mail, fieldName) {
  ...
  assert.strictEqual(
    ...
    -1,
    util.format(
      'Email field "%s" contained "__MSG__" placeholder: %s',
      fieldName,
      content,
    ),
  );
