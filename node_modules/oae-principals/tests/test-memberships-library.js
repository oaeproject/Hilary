                      ...
                      function(err, results) {
                        ...
                        assert.equal(
                          ...
                          '/group/' +
                            ...
                            '/' +
                            AuthzUtil.getResourceFromId(results.results[0].id)
                              .resourceId,
                        );
                        ...
                        RestAPI.Search.search(
                          ...
                          function(err, results) {
                            ...
                            assert.equal(
                              results.results[0].resourceType,
                              'group',
                            );
                            assert.equal(
                              results.results[0].profilePath,
