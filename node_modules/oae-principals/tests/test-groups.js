    ...
    describe('Groups', function() {
        ...
        var createOAEStructure = function(ctx, callback) {
            createPrincipals(ctx, function(id){
                ...
                PrincipalsAPI.addGroupMembers(ctx, 'g:cam:canadian-' + id, ['u:cam:branden-' + id], 'member', principalsAdded);
                PrincipalsAPI.addGroupMembers(ctx, 'g:cam:not-canadian-' + id, ['u:cam:simon-' + id], 'member', principalsAdded);
                PrincipalsAPI.addGroupMembers(ctx, 'g:cam:belgian-' + id, ['g:cam:west-flemish-' + id, 'g:cam:east-flemish-' + id], 'member', principalsAdded);
                PrincipalsAPI.addGroupMembers(ctx, 'g:cam:west-flemish-' + id, ['u:cam:bert-' + id], 'member', principalsAdded);
                PrincipalsAPI.addGroupMembers(ctx, 'g:cam:east-flemish-' + id, ['u:cam:nicolaas-' + id], 'member', principalsAdded);
                PrincipalsAPI.addGroupMembers(ctx, 'g:cam:oae-team-' + id, ['g:cam:backend-team-' + id, 'g:cam:ui-team-' + id], 'member', principalsAdded);
                PrincipalsAPI.addGroupMembers(ctx, 'g:cam:backend-team-' + id, ['g:cam:canadian-' + id, 'g:cam:not-canadian-' + id], 'member', principalsAdded);
                PrincipalsAPI.addGroupMembers(ctx, 'g:cam:ui-team-' + id, ['g:cam:belgian-' + id], 'member', principalsAdded);
            });
        };
        ...
        it('Test simple group structure', function(callback) {
            ...
            createAndGetUser(anonymousContext, 'test-runner' + r, 'password', 'public', 'Test', 'Runner', 'tr123', function(err, user) {
                ...
                createOAEStructure(ctx, function(id) {
                    ...
                    var bertCtx = new Context(tenant, new User('cam', 'u:cam:bert-' + id));
                    var nicoCtx = new Context(tenant, new User('cam', 'u:cam:nicolaas-' + id));
                    var brandenCtx = new Context(tenant, new User('cam', 'u:cam:branden-' + id));
                    var simonCtx = new Context(tenant, new User('cam', 'u:cam:simon-' + id));

                    // The group members should only return the direct children.
                    assertGroupMembers(ctx, 'g:cam:oae-team-' + id, [asUser, 'g:cam:backend-team-' + id, 'g:cam:ui-team-' + id], done);
                    assertGroupMembers(ctx, 'g:cam:backend-team-' + id, [asUser, 'g:cam:canadian-' + id, 'g:cam:not-canadian-' + id], done);
                    assertGroupMembers(ctx, 'g:cam:canadian-' + id, [asUser, 'u:cam:branden-' + id], done);
                    assertGroupMembers(ctx, 'g:cam:not-canadian-' + id, [asUser, 'u:cam:simon-' + id], done);
                    assertGroupMembers(ctx, 'g:cam:belgian-' + id, [asUser, 'g:cam:west-flemish-' + id, 'g:cam:east-flemish-' + id], done);
                    assertGroupMembers(ctx, 'g:cam:west-flemish-' + id, [asUser, 'u:cam:bert-' + id], done);
                    assertGroupMembers(ctx, 'g:cam:east-flemish-' + id, [asUser, 'u:cam:nicolaas-' + id], done);

                    // ALL groups should be listed against a principal.
                    assertMemberOf(bertCtx, ['g:cam:oae-team-' + id, 'g:cam:ui-team-' + id, 'g:cam:belgian-' + id, 'g:cam:west-flemish-' + id], done);
                    assertMemberOf(nicoCtx, ['g:cam:oae-team-' + id, 'g:cam:ui-team-' + id, 'g:cam:belgian-' + id, 'g:cam:east-flemish-' + id], done);
                    assertMemberOf(brandenCtx, ['g:cam:oae-team-' + id, 'g:cam:backend-team-' + id, 'g:cam:not-canadian-' + id], done);
                    assertMemberOf(simonCtx, ['g:cam:oae-team-' + id, 'g:cam:backend-team-' + id, 'g:cam:canadian-' + id], done);
                    assertMemberOf(ctx, ['g:cam:oae-team-' + id, 'g:cam:ui-team-' + id, 'g:cam:backend-team-' + id, 'g:cam:belgian-' + id,
        ...
        it('Test group exploding', function(callback) {
            ...
            createAndGetUser(anonymousContext, 'test-runner' + r, 'password', 'public', 'Test', 'Runner', 'tr123', function(err, user) {
                ...
                createOAEStructure(ctx, function(id) {
                    ...
                    assertExplodedGroupUsers(ctx, 'g:cam:oae-team-' + id, [asUser, 'u:cam:bert-' + id, 'u:cam:branden-' + id, 'u:cam:nicolaas-' + id, 'u:cam:simon-' + id], done);
                    assertExplodedGroupUsers(ctx, 'g:cam:backend-team-' + id, [asUser, 'u:cam:simon-' + id, 'u:cam:branden-' + id], done);
                    assertExplodedGroupUsers(ctx, 'g:cam:canadian-' + id, [asUser, 'u:cam:branden-' + id], done);
                    assertExplodedGroupUsers(ctx, 'g:cam:not-canadian-' + id, [asUser, 'u:cam:simon-' + id], done);
                    assertExplodedGroupUsers(ctx, 'g:cam:belgian-' + id, [asUser, 'u:cam:bert-' + id, 'u:cam:nicolaas-' + id], done);
                    assertExplodedGroupUsers(ctx, 'g:cam:west-flemish-' + id, [asUser, 'u:cam:bert-' + id], done);
                    assertExplodedGroupUsers(ctx, 'g:cam:east-flemish-' + id, [asUser, 'u:cam:nicolaas-' + id], done);
                });
            });
        });
        ...
        it('Test non-existing group', function(callback) {
            ...
            PrincipalsAPI.getGroup(ctx, "u:cam:simon", function(err, group) {
        ...
        it('Test that a group cannot be made a member of itself', function(callback) {
            var tenant = new Tenant('cam-' + Math.random(), 'Cambridge', 'Cambridge University', 3001);
            var anonymousContext = new Context(tenant, null);
            createAndGetUser(anonymousContext, 'nico', 'password', 'private', 'Nicolaas', 'Matthijs', 'nico', function(err, nico) {
                assert.ok(!err);
                var nicoCtx = new Context(tenant, nico);
        ...
        it('should test paging', function(callback) {
            ...
            createAndGetUser(anonymousContext, 'test-runner' + r, 'password', 'public', 'Test', 'Runner', 'tr123', function(err, user) {
                var ctx = new Context(tenant, user);
                createOAEStructure(ctx, function(id) {
                    var ctx = new Context(null, new User('cam', 'u:cam:bert-'+id));
