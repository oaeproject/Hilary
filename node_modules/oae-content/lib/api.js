 ...
 * * `deletedComment(ctx, content comment, deleteType)`: An existing comment has been deleted on a content item. The `ctx`, `cotnent` and target `comment` object are provided.
 */
    ...
    getContent(ctx, contentId, function(err, content) {
        ...
        MessageBoxAPI.getMessages(contentId, [commentCreatedDate], null, function(err, messages) {
            ...
            if (ctx.user().id === message.createdBy) {
                return _deleteComment(ctx, content, commentCreatedDate, callback);
            }
 ...
 */
var _deleteComment = function(ctx, content, commentCreatedTimestamp, callback) {
    ...
    MessageBoxAPI.deleteMessage(messageBoxId, commentCreatedTimestamp, {'deleteType': MessageBoxConstants.deleteTypes.LEAF}, function(err, deleteType, message) {
        ...
        ContentAPI.emit(ContentConstants.events.DELETED_COMMENT, ctx, content, comment, deleteType);
