 ...
 */
var CONFIG_COOKIE_NAME = (module.exports.CONFIG_COOKIE_NAME =
 ...
 */
var generateTestUsers = (module.exports.generateTestUsers = function(
  restCtx,
  total,
  callback,
  _createdUsers,
  ...
  if (total === 0) {
    SearchTestUtil.whenIndexingComplete(function() {
      ...
      callbackArgs.push(
        _.indexBy(_createdUsers, function(user) {
          return user.user.id;
        }),
      );
    ...
    RestAPI.Tenants.getTenant(restCtx, null, function(err, tenant) {
      ...
      RestAPI.User.createUser(
        ...
        function(err, user) {
          ...
          PrincipalsDAO.setEmailAddress(user, email.toLowerCase(), function(
            err,
            user,
          ) {
            assert.ok(!err);
 ...
 */
var generateTestGroups = (module.exports.generateTestGroups = function(
  restContext,
  total,
  callback,
  _groups,
  ...
  RestAPI.Group.createGroup(
    ...
    function(err, group) {
      assert.ok(!err);
      RestAPI.Group.getGroup(restContext, group.id, function(
        err,
        fullGroupProfile,
      ) {
        assert.ok(!err);
 ...
 */
var createTenantWithAdmin = (module.exports.createTenantWithAdmin = function(
  tenantAlias,
  tenantHost,
  callback,
) {
      ...
      ConfigTestUtil.updateConfigAndWait(
        ...
        function(err) {
          ...
          RestAPI.User.createUser(
            ...
            email,
            null,
            function(err, tenantAdmin) {
              if (err) {
                return callback(err);
              }

              // Verify their email address
              PrincipalsDAO.setEmailAddress(tenantAdmin, email, function(
                err,
                tenantAdmin,
              ) {
                if (err) {
                ...
                RestAPI.User.setTenantAdmin(
                  ...
                  function(err) {
                    ...
                    // Re-enable reCaptcha
                    var tenantAdminRestCtx = createTenantAdminRestContext(
                      tenantHost,
                    );
                    ConfigTestUtil.updateConfigAndWait(
                      tenantAdminRestCtx,
 ...
 */
var generateGroupHierarchy = (module.exports.generateGroupHierarchy = function(
  restCtx,
  groupIds,
  role,
  callback,
 ...
 */
var generateTestCassandraName = (module.exports.generateTestCassandraName = function(
  seed,
) {
  seed = seed || 'name';
 ...
 */
var generateTestElasticSearchName = (module.exports.generateTestElasticSearchName = function(
  seed,
) {
  seed = seed || 'name';
 ...
 */
var generateTestEmailAddress = (module.exports.generateTestEmailAddress = function(
  seed,
  domain,
) {
  seed = seed || 'email';
 ...
 */
var createTenantRestContext = (module.exports.createTenantRestContext = function(
  host,
  username,
  password,
) {
 ...
 */
var createTenantAdminRestContext = (module.exports.createTenantAdminRestContext = function(
  host,
) {
 ...
 */
var createGlobalRestContext = (module.exports.createGlobalRestContext = function(
  username,
  password,
) {
 ...
 */
var createTenantAdminContext = (module.exports.createTenantAdminContext = function(
  tenant,
) {
 ...
 */
var getUserFromRestContext = (module.exports.getUserFromRestContext = function(
  restCtx,
  callback,
) {
 ...
 */
var generateResourceIds = (module.exports.generateResourceIds = function(
  n,
  resourceType,
  tenantAlias,
  callback,
  ...
  for (var i = 0; i < n; i++) {
    resourceIds.push(
      util.format('%s:%s:%s', resourceType, tenantAlias, ShortId.generate()),
    );
  }
 ...
 */
var generateRandomText = (module.exports.generateRandomText = function(
  numberOfWords,
) {
 ...
 */
var createFileReadableStream = (module.exports.createFileReadableStream = function(
  filename,
  size,
) {
  return function() {
...
var setupMultiTenantPrivacyEntities = (module.exports.setupMultiTenantPrivacyEntities = function(
  ...
  _createMultiPrivacyTenants(function(
    publicTenant,
    publicTenant1,
    privateTenant,
    privateTenant1,
...
var _createMultiPrivacyTenants = function(callback) {
  ...
  _createPublicTenant(publicTenantAlias, 'public', function(
    tenant,
    tenantAdmin,
  ) {
    var publicTenant = {
    ...
    _createPublicTenant(publicTenant1Alias, 'public', function(
      tenant,
      tenantAdmin,
    ) {
      var publicTenant1 = {
      ...
      _createPrivateTenant(privateTenantAlias, function(tenant, tenantAdmin) {
        ...
        _createPrivateTenant(privateTenant1Alias, function(
          tenant,
          tenantAdmin,
        ) {
          var privateTenant1 = {
...
var _setupTenant = function(tenant, callback) {
  _createMultiPrivacyUsers(tenant, function(
    publicUser,
    loggedinUser,
    privateUser,
  ) {
    ...
    _createMultiPrivacyGroups(tenant, function(
      publicGroup,
      loggedinGroup,
      privateGroup,
    ) {
...
var _createUserWithVisibility = function(tenant, visibility, callback) {
  ...
  RestAPI.User.createUser(
    ...
    displayName,
    email,
    { visibility: visibility, publicAlias: publicAlias },
    function(err, user) {
      assert.ok(!err);
      return callback({
        user: user,
        restContext: createTenantRestContext(
          tenant.adminRestContext.hostHeader,
          username,
          password,
        ),
      });
 ...
 * @api private
 */
var _createGroupWithVisibility = function(
  tenant,
  visibility,
  memberPrincipalId,
  callback,
...
var _createPublicTenant = function(tenantAlias, hostSeed, callback) {
  createTenantWithAdmin(
    tenantAlias,
    TenantsTestUtil.generateTestTenantHost(hostSeed),
    function(err, tenant, tenantAdminRestCtx, tenantAdminUser) {
      assert.ok(!err);
      return callback(tenant, {
        user: tenantAdminUser,
        restContext: tenantAdminRestCtx,
      });
    },
  );
};
...
var createInitialTestConfig = (module.exports.createInitialTestConfig = function() {
  ...
  var envConfig = require('../../../' + (process.env.NODE_ENV || 'local'))
    .config;
 ...
 * @param  {Function}    callback                  Standard callback function
 */
var setUpBeforeTests = (module.exports.setUpBeforeTests = function(
  config,
  dropKeyspaceBeforeTest,
  callback,
) {
  Cassandra.init(config.cassandra, function(err) {
    ...
    if (dropKeyspaceBeforeTest) {
      log().info(
        'Dropping keyspace "%s" to clean up before tests',
...
var cleanUpAfterTests = (module.exports.cleanUpAfterTests = function(callback) {
  ...
  Redis.flush(function(err) {
    if (err) {
      log().error(
        { err: err },
        'Error flushing Redis data after test completion',
      );
    }
