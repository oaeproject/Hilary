...
var constructCQLQuery = function(reqBody) {
    var q = {
        'query': '',
        'params': []
    }
    ...
    for (var i in reqBody) {
        tempQuery.push('? = ?');
        q.params.push(i, reqBody[i].value);
        tenantid = reqBody[i].tenantid;
    }
...
var writeConfig = module.exports.writeConfig = function(reqBody, callback) {
    callback = callback || function() {};
    var q = constructCQLQuery(reqBody);
