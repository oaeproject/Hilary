...
describe('Authentication', function() {
  ...
  var _enableStrategy = function(strategyName, enabledCallback, resetCallback) {
    var strategyStatus = Config.getValue(
    ...
    AuthenticationTestUtil.assertUpdateAuthConfigSucceeds(
      ...
      function() {
        ...
        enabledCallback(function() {
          ...
          configUpdate[
            'oae-authentication/' + strategyName + '/enabled'
          ] = strategyStatus;
   ...
   * @param  {Function}   callback        Standard callback function
   */
  var verifyCallbackTampering = function(
    strategyName,
    method,
    parameters,
    callback,
  ...
  describe('External authentication', function() {
        ...
        function(err) {
          if (err) {
            if (err.msg === 'The hostname has already been taken') {
              ...
              var msg =
                'Did not expect an error message when reverting the localhost hostname.';
    ...
    it('verify the Twitter callback endpoint can deal with URL tampering', function(callback) {
      verifyCallbackTampering(
        'twitter',
        'GET',
        { oauth_token: 'not-valid' },
        callback,
      );
    });
    ...
    it('verify the authentication strategies are refreshed when a tenant is updated', function(callback) {
      _enableStrategy(
        ...
        function(done) {
          ...
          RestAPI.Authentication.googleRedirect(restContext, function(
            err,
            body,
            response,
          ) {
  ...
  describe('CAS authentication', function() {
    ...
    beforeEach(function(callback) {
      TestsUtil.createTestServer(function(_app, _server, _port) {
        ...
        var configUpdate = {};
        configUpdate['oae-authentication/cas/url'] =
          'http://localhost:' + _port + '/cas';
    ...
    it('verify forward to cas', function(callback) {
      _enableStrategy('cas', function(done) {
        ...
        restContext.followRedirect = false;
        RestAPI.Authentication.casRedirect(restContext, function(
          err,
          body,
          response,
        ) {
          ...
          var configUpdate = {
            'oae-authentication/cas/loginPath': '/login/something/foo',
          };
          AuthenticationTestUtil.assertUpdateAuthConfigSucceeds(
            globalAdminRestContext,
            global.oaeTests.tenants.localhost.alias,
    ...
    it('verify misconfigured attribute mapping does not break the authentication flow', function(callback) {
      _enableStrategy(
        ...
        function(done) {
          ...
          var configUpdate = {};
          configUpdate['oae-authentication/cas/mapDisplayName'] =
            '}displayname{';
          AuthenticationTestUtil.assertUpdateAuthConfigSucceeds(
            globalAdminRestContext,
            global.oaeTests.tenants.localhost.alias,
    ...
    it('verify CAS logout', function(callback) {
      var configUpdate = {};
      configUpdate['oae-authentication/cas/logoutUrl'] =
              ...
              RestAPI.Authentication.casCallback(
                ...
                function(err, body, response) {
                  ...
                  RestAPI.User.getMe(restContext, function(err, me) {
                    ...
                    // Log out
                    RestAPI.Authentication.logout(restContext, function(
                      err,
                      data,
                      response,
                    ) {
  ...
  describe('Shibboleth authentication', function() {
     ...
     */
    afterEach(function(callback) {
      var keysToClear = ['oae-authentication/shibboleth/idpEntityID'];
        ...
        function(err, body, response) {
          ...
          RestAPI.Authentication.shibbolethSPRedirect(
            ...
            function(err, body, response) {
              ...
              assert.ok(location.query);
              assert.strictEqual(
                location.query.entityID,
                'https://idp.example.com/shibboleth',
              );
              assert.strictEqual(
                location.query.target,
     ...
     * @param  {Function}       callback                    Standard callback function
     */
    var _callbackShibbolethAuthFlow = function(
      tenantRestContext,
      spRestContext,
      attributes,
      expectedRedirectUrl,
    ...
    it('verify redirection flow', function(callback) {
      _enableStrategy(
        ...
        function(done) {
          ...
          _initiateShibbolethAuthFlow('/content/bla', function(
            tenantRestContext,
            spRestContext,
          ) {
            var email = TestsUtil.generateTestEmailAddress();
     ...
     * @param  {Function}       callback             Standard callback function
     */
    var verifyInvalidDisplayNameMakesProfilePrivate = function(
      remoteUser,
      callback,
    ) {
      // Initiate the Shibboleth auth flow
        ...
        function(done) {
          ...
          RestAPI.Authentication.shibbolethSPRedirect(
            ...
            function(err, body, response) {
              ...
              RestAPI.Authentication.shibbolethSPRedirect(
                spRestContext,
                { tenantAlias: tenantAlias, signature: null, expires: null },
                function(err, body, response) {
                  assert.strictEqual(err.code, 400);
                  RestAPI.Authentication.shibbolethSPRedirect(
                    spRestContext,
                ...
                RestAPI.User.getMe(tenantRestContext, function(err, me) {
                  ...
                  _initiateShibbolethAuthFlow('/content/bla', function(
                    ...
                    _callbackShibbolethAuthFlow(
                      ...
                      '/content/bla',
                      function() {
                        RestAPI.User.getMe(tenantRestContext, function(
                          err,
                          me,
                        ) {
                          assert.ok(!err);
                ...
                RestAPI.User.getMe(tenantRestContext, function(err, me) {
                  ...
                  RestAPI.Config.getTenantConfig(
                    ...
                    function(err, config) {
                      ...
                      assert.strictEqual(
                        me.locale,
                        config['oae-principals']['user']['defaultLanguage'],
                      );
                      return done();
                    },
                  );
