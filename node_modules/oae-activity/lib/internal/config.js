...
var MINIMUM_MAIL_POLLING_FREQUENCY = 1;            // 1 minute
...
var refreshConfiguration = module.exports.refreshConfiguration = function(_config) {
    ...
    if (_config.mail.pollingFrequency < MINIMUM_MAIL_POLLING_FREQUENCY || _config.mail.pollingFrequency > MAXIMUM_MAIL_POLLING_FREQUENCY) {
        var msg = util.format('The mail polling frequency property "config.activity.mail.pollingFrequency" cannot be more than an hour or less than a minute. The value %d seconds was used instead', config.mail.pollingFrequency);
        log().warn(msg);
    }
