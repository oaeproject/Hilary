          ...
          ActivityTestsUtil.getFullySetupPushClient(data, function(client) {
            ...
            RestAPI.Content.createLink(
              ...
              function(err, contentObj) {
                assert.ok(!err);
                RestAPI.Content.getContent(simong.restContext, contentObj.id, function(
                  err,
                  contentObj
                ) {
                  assert.ok(!err);
      ...
      TestsUtil.generateTestUsers(localAdminRestContext, 2, function(err, users, branden, simon) {
        ...
        RestAPI.User.getMe(contexts['simon'].restContext, function(err, simonFull) {
          ...
          RestAPI.Content.createFile(
            ...
            function(err, contentObj) {
              assert.ok(!err);
              RestAPI.Content.getContent(contexts['simon'].restContext, contentObj.id, function(
                err,
                contentObj
              ) {
                assert.ok(!err);
      ...
      setupFixture(function(contexts, contentObj, client) {
        ...
        ActivityTestsUtil.waitForPushActivity(
          ...
          function(activity) {
            ...
            RestAPI.Content.getContent(contexts['branden'].restContext, contentObj.id, function(
              err,
              contentObj
            ) {
              assert.ok(!err);
