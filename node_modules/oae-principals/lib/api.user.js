 ...
 * @param  {Function}   callback            Standard callback function
 * @param  {Object}     callback.err        An error that occurred, if any
 * @param  {String}     callback.data       Data user
 */
...
// Tests
// var getPathExportData = module.exports.getPathExportData = function(ctx, userId, exportType, callback) {
//     // Get files path
//     var filePath = ContentUtil.getStorageBackend(ctx, null).getRootDirectory();
//     return callback(null, '/files/c/d/H1/jw/De/Ah/H1jwDeAhz/rev-d-H1gjwwlA3f/30628887_2089261997753835_881891742331174912_n.png');
//     // return callback(null, '/files' + '/u_d_Bk7Kxonnf1525245941680.zip');
// };
