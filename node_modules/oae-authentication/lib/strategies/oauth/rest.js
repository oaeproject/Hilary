 ...
 */
server.exchange(oauth2orize.exchange.clientCredentials({'userProperty': 'oaeAuthInfo'}, function(client, scope, callback) {
 ...
 * @FormParam   {string}        grant_type      Type of authorization requested     [client_credentials]
 * @FormParam   {string}        client_id       Identifier for oauth client
 * @FormParam   {string}        client_secret   Secret for oauth client
 */
 ...
 * @PathParam   {string}        userId          Id of user to which client will be associated
 * @FormParam   {string}        displayName     Name for oauth client
 * @Return      {OauthClient}                   Information for client
 */
 ...
 * @Path        /auth/oauth/clients/:userId
 * @PathParam   {string}        userId          Id of user to which client will be associated
 * @Return      {OauthClientList}               List of clients associated with user
 */
 ...
 * @PathParam   {string}        userId          Id of user to which client will be associated
 * @PathParam   {string}        clientId        Id client to update
 * @FormParam   {string}        displayName     Name for client
 * @FormParam   {string}        secret          Secret for client
 * @Return      {OauthClient}                   Updated information for client
 */
