...
var createFolder = module.exports.createFolder = function(ctx, displayName, description, visibility, members, callback) {
    ...
    var managerIds = _.chain(members)
        .keys()
    ...
    PrincipalsAPI.canManageAny(ctx, managerIds, function(err, canManageAny) {
        ...
        ResourceActions.create(ctx, members, createFn, function(err, folder) {
            if (err) {
                return callback(err);
            }
...
var shareFolder = module.exports.shareFolder = function(ctx, folderId, principalIds, callback) {
    ...
    FoldersDAO.getFolder(folderId, function(err, folder) {
        ...
        ResourceActions.share(ctx, folder, principalIds, AuthzConstants.role.VIEWER, function(err, newMembers, memberRoles) {
            if (err) {
                return callback(err);
...
var setFolderPermissions = module.exports.setFolderPermissions = function(ctx, folderId, permissionChanges, callback) {
    ...
    FoldersDAO.getFolder(folderId, function(err, folder) {
        ...
        ResourceActions.setRoles(ctx, folder, permissionChanges, function(err, membershipAfterChanges, newMembers, updatedMembers, removedMembers) {
            if (err) {
                return callback(err);
            }
