...
var _createContent = function(ctx, contentType, displayName, description, visibility, additionalMembers, otherValues, callback) {
    ...
    ContentDAO.Content.createContent(ctx.tenant().alias, ctx.user().id, contentType, displayName, description, visibility, additionalMembers, otherValues, function(err, contentObj) {
        if (err) {
            return callback(err);
        }
...
var deleteContent = module.exports.deleteContent = function(ctx, contentId, callback) {
    ...
    canManage(ctx, contentId, function(err, canManage, contentObj) {
        ...
        // Delete the content
        ContentDAO.Content.deleteContent(contentId, function(err) {
            if (err) {
                return callback(err);
            }
            ...
            // Get the members
            ContentDAO.Content.getAllContentMembers(contentId, function(err, members) {
                if (err) {
                    return callback(err);
...
var _setContentPermissions = function(ctx, contentObj, newPermissions, callback) {
    ...
    PrincipalsUtil.getPrincipals(ctx, principalIds, function(err, principals) {
        ...
        AuthzAPI.updateRoles(contentObj.id, newPermissions, function(err) {
            ...
            ContentDAO.Content.updateLibraries(contentObj, removedMembers, function(err) {
                if (err) {
