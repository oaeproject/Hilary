...
OAE.tenantServer.get('/api/following/:userId/followers', function(req, res) {
    ...
    FollowingAPI.getFollowers(ctx, userId, req.query.start, req.query.limit, function(err, followers, nextToken) {
        if (err) {
...
OAE.tenantServer.get('/api/following/:userId/following', function(req, res) {
    ...
    var ctx = req.ctx;
    var userId = req.params.userId;
    FollowingAPI.getFollowing(ctx, userId, req.query.start, req.query.limit, function(err, following, nextToken) {
        if (err) {
            return res.send(err.code, err.msg);
        }
...
OAE.tenantServer.post('/api/following/:userId/unfollow', function(req, res) {
    ...
    var ctx = req.ctx;
    var userId = req.params.userId;
    FollowingAPI.unfollow(ctx, userId, function(err, followers) {
        if (err) {
            return res.send(err.code, err.msg);
        }
