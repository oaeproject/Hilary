...
var TermsAndConditionsAPI = require('./api.termsAndConditions');
 ...
 * * `updatedGroupMembers(ctx, group, memberUpdates)`: A group's members list was updated. The `ctx`, `group` object whose membership was updated, and the hash of principalId -> role that outlines the changes that were made are provided.
 ...
 * * `leftGroup(ctx, group)`: A user left a group. The `ctx` and `group` object that was left are provided.
 */
