...
module.exports = function(config, callback) {
    ...
    SearchAPI.refreshSearchConfiguration(index.name, { hosts: hosts }, index.allowRefresh === true);
...
var ensureIndex = function(indexName, indexSettings, destroy, callback) {
    if (destroy) {
        ...
        ElasticSearch.deleteIndex(indexName, function(err) {
            ...
            return ElasticSearch.createIndex(indexName, indexSettings, function(err) {
                if (err) {
        ...
        return ElasticSearch.createIndex(indexName, indexSettings, callback);
    }
};