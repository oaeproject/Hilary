...
module.exports = function() {
  ...
  strategy.getPassportStrategy = function(tenant) {
    ...
    var key = AuthenticationConfig.getValue(
      tenant.alias,
      AuthenticationConstants.providers.GOOGLE,
      'key',
    );
    var secret = AuthenticationConfig.getValue(
      tenant.alias,
      AuthenticationConstants.providers.GOOGLE,
      'secret',
    );
    var domains = AuthenticationConfig.getValue(
      tenant.alias,
      AuthenticationConstants.providers.GOOGLE,
      'domains',
    ).split(',');
    ...
    var passportStrategy = new GoogleStrategy(options, function(
      req,
      accessToken,
      refreshToken,
      profile,
