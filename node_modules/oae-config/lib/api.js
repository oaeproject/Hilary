...
module.exports.config = function(moduleId) {
    ...
    return {
        ...
        getConfigValue: function(ctx, feature, element) {
            ...
            if (!cachedConfig[ctx.tenant().alias] || !cachedConfig[ctx.tenant().alias][moduleId] ||
                !cachedConfig[ctx.tenant().alias][moduleId][feature] || cachedConfig[ctx.tenant().alias][moduleId][feature][element] === undefined) {
                return null;
            }
            
            return cachedConfig[ctx.tenant().alias][moduleId][feature][element];
        }
    };
};
...
var getTenantConfig = module.exports.getTenantConfig = function(tenantAlias, callback) {
    ...
    callback(null, cachedConfig[tenantAlias]);
};
