...
describe('Users', function() {
    ...
    describe('Import users', function() {
        ...
        it('verify import local users and display name override', function(callback) {
            ...
            PrincipalsTestsUtil.importUsers(globalAdminRestContext, global.oaeTests.tenants.cam.alias, getCSVWithPasswordStream, 'local', null, function(err) {
                assert.ok(!err);
                            ...
                            RestAPI.User.getMe(stephenRestContext, function(err, stephenMeObj) {
                                ...
                                RestAPI.User.updateUser(nicolaasRestContext, nicolaasMeObj.id, {'displayName': 'user-zfdHliPLa'}, function (err, user) {
                                    ...
                                    RestAPI.User.getMe(nicolaasRestContext, function(err, nicolaasMeObj) {
                                        ...
                                        PrincipalsTestsUtil.importUsers(camAdminRestContext, null, getCSVWithPasswordStream, 'local', null, function(err) {
                                            assert.ok(!err);
                                                    ...
                                                    RestAPI.User.getMe(nicolaasRestContext, function(err, nicolaasMeObj) {
                                                        ...
                                                        PrincipalsTestsUtil.importUsers(camAdminRestContext, null, getCSVWithPasswordStream, 'local', null, function(err) {
                                                            ...
                                                            RestAPI.User.getMe(nicolaasRestContext, function(err, nicolaasMeObj) {
                                                                ...
                                                                PrincipalsTestsUtil.importUsers(camAdminRestContext, null, getCSVWithPasswordStream, 'local', true, function(err) {
                                                                    assert.ok(!err);
        ...
        it('verify import external users', function(callback) {
            ...
            PrincipalsTestsUtil.importUsers(globalAdminRestContext, global.oaeTests.tenants.cam.alias, getCSVWithoutPasswordStream, 'cas', null, function(err) {
                assert.ok(!err);
                                                ...
                                                RestAPI.User.getUser(camAdminRestContext, stuartUserId, function(err, stuartUserObj) {
                                                    ...
                                                    RestAPI.User.updateUser(camAdminRestContext, nicolaasUserId, {'displayName': 'user-TGdDSdadW'}, function (err, user) {
                                                        ...
                                                        RestAPI.User.getUser(camAdminRestContext, nicolaasUserId, function(err, nicolaasUserObj) {
                                                            ...
                                                            // Re-import the users to verify that the displayName is reverted back to the display name
                                                            // provided in the CSV file. This time, the import is attempted as a tenant admin
                                                            PrincipalsTestsUtil.importUsers(camAdminRestContext, null, getCSVWithoutPasswordStream, 'cas', null, function(err) {
                                                                assert.ok(!err);
                                                                        ...
                                                                        RestAPI.User.getUser(camAdminRestContext, nicolaasUserId, function(err, nicolaasUserObj) {
                                                                            ...
                                                                            PrincipalsTestsUtil.importUsers(camAdminRestContext, null, getCSVWithoutPasswordStream, 'cas', null, function(err) {
                                                                                ...
                                                                                RestAPI.User.getUser(camAdminRestContext, nicolaasUserId, function(err, nicolaasUserObj) {
                                                                                    ...
                                                                                    // Re-import the users using the `forceProfileUpdate` flag to verify that the displayName is reverted to
                                                                                    // the display name provided in the CSV file
                                                                                    PrincipalsTestsUtil.importUsers(camAdminRestContext, null, getCSVWithoutPasswordStream, 'cas', true, function(err) {
                                                                                        assert.ok(!err);
        ...
        it('verify parameter validation', function(callback) {
            ...
            PrincipalsTestsUtil.importUsers(globalAdminRestContext, 'foobar', getCSVWithoutPasswordStream, 'cas', null, function(err) {
                assert.ok(err);
                assert.ok(err.code, 400);

                // Verify that an authentication method is required
                PrincipalsTestsUtil.importUsers(globalAdminRestContext, global.oaeTests.tenants.cam.alias, getCSVWithoutPasswordStream, null, null, function(err) {
                    assert.ok(err);
                    assert.ok(err.code, 400);

                    // Verify that an existing authentication method is required
                    PrincipalsTestsUtil.importUsers(globalAdminRestContext, global.oaeTests.tenants.cam.alias, getCSVWithoutPasswordStream, 'foobar', null, function(err) {
                        assert.ok(err);
                        assert.ok(err.code, 400);
        ...
        it('verify only admins can import users', function(callback) {
            ...
            PrincipalsTestsUtil.importUsers(anonymousGlobalRestContext, global.oaeTests.tenants.cam.alias, getCSVWithoutPasswordStream, 'cas', null, function(err) {
                assert.ok(err);
                assert.ok(err.code, 401);

                // Verify that an anonymous user on a user tenant cannot import users
                PrincipalsTestsUtil.importUsers(anonymousRestContext, null, getCSVWithoutPasswordStream, 'cas', null, function(err) {
                    assert.ok(err);
                    assert.ok(err.code, 401);
                    ...
                    RestAPI.User.createUser(camAdminRestContext, userId, 'password', 'Test User', {'visibility': 'public'}, function(err, createdUser) {
                        ...
                        PrincipalsTestsUtil.importUsers(userRestContext, null, getCSVWithoutPasswordStream, 'cas', null, function(err) {
                            assert.ok(err);
                            assert.ok(err.code, 401);
                            callback();
                        });
