...
describe('Tenant Landing Pages', function() {
  ...
  it('verify the attributes are returned', function(callback) {
    TestsUtil.setupMultiTenantPrivacyEntities(function(tenant) {
      ...
      TenantsTestUtil.clearTenantLandingPage(
        ...
        function() {
          ...
          configUpdate['oae-tenants/block_1/imgUrl'] =
            'https://foo.com/img.png';
          configUpdate['oae-tenants/block_1/videoUrl'] =
            'https://foo.com/video.wav';
          configUpdate['oae-tenants/block_1/videoPlaceholder'] =
            'https://foo.com/video.placeholder.png';
          ConfigTestUtil.updateConfigAndWait(
            ...
            function() {
              ...
              RestAPI.Tenants.getLandingPage(anonymousRestContext, function(
                err,
                landingPage,
              ) {
                assert.ok(!err);
                ...
                assert.strictEqual(
                  landingPage[0].icon,
                  'https://foo.com/icon.png',
                );
                assert.strictEqual(
                  landingPage[0].imgUrl,
                  'https://foo.com/img.png',
                );
                assert.strictEqual(
                  landingPage[0].videoUrl,
                  'https://foo.com/video.wav',
                );
                assert.strictEqual(
                  landingPage[0].videoPlaceholder,
                  'https://foo.com/video.placeholder.png',
                );
      ...
      ConfigTestUtil.updateConfigAndWait(
        ...
        function() {
          ...
          RestAPI.Tenants.getLandingPage(anonymousRestContext, function(
            ...
            TestsUtil.generateTestUsers(tenant.adminRestContext, 3, function(
              err,
              users,
              frenchUser,
              defaultUser,
              ...
              RestAPI.User.updateUser(
                ...
                function(err) {
                  ...
                  RestAPI.Tenants.getLandingPage(
                    frenchUser.restContext,
                    function(err, landingPage) {
                      assert.ok(!err);
  ...
  it('verify that blocks are not returned in the config', function(callback) {
    RestAPI.Config.getTenantConfig(anonymousCamRestContext, null, function(
      err,
      config,
    ) {
      assert.ok(!err);
