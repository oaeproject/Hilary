...
describe('Principals', function() {
    ...
    describe('Utilities', function() {
        ...
        var createGroups = function(ctx, userids, callback) {
            var r = Math.round(Math.random() * 1000000);
            var groupids = [];
            PrincipalsAPI.createGroup(ctx, 'oae-team-' + r, 'OAE Team', 'public', 'yes', [], {}, function(err, groupId) {
                assert.ok(!err);
                groupids.push(groupId);
                PrincipalsAPI.createGroup(ctx, 'backend-team-' + r, 'Back-end Team', 'public', 'yes', [], {}, function(err, groupId) {
                    assert.ok(!err);
                    groupids.push(groupId);
                    PrincipalsAPI.createGroup(ctx, 'ui-team-' + r, 'UI Team', 'public', 'yes', [], {}, function(err, groupId) {
                        assert.ok(!err);
                        groupids.push(groupId);
                        callback(groupids);
                    });
