 ...
 * @param  {Number}     months              Number of months that a user has not logged in - if the type of the request is `auth`
 * @param  {Function}   callback            Standard callback function
 * @param  {Object}     callback.err        An error that occurred, if any
...
const getUsersDateLog = module.exports.getUsersDateLog = function(ctx, tenantAlias, type, months, callback) {
    ...
    PrincipalsDAO.getAllUsersForTenant(tenantAlias, function(err, users) {
        ...
        // If the type of connection is `auth` get only the connection older than someTimeAgo - {months}
        } else {
