 ...
 * @param  {Object}     callback.err                An error that occured, if any
 */
var createRequestJoinGroup = module.exports.createRequestJoinGroup = function(ctx, groupId, callback) {
    ...
    PrincipalsDAO.createRequestJoinGroup(ctx.user().id, groupId, function(err, request) {
        if (err) {
            return callback(err);
        }
...
var getRequestsJoinGroup = module.exports.getRequestsJoinGroup = function(ctx, groupId, start, limit, callback) {
    ...
    PrincipalsDAO.getRequestsJoinGroup(groupId, function(err, requests) {
        ...
        _.each(JSON.parse(requests.principalId), function(id, i, arr) {
