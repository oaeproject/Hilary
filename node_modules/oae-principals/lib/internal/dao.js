 ...
 */
var getUserToDelete = module.exports.getUserToDelete = function(actualDate, callback) {
    ...
    Cassandra.runQuery('SELECT * FROM "DataArchive"', [], function(err, rows) {
        ...
        users = _.filter(users, function(user) { return (user.fullyDeleted == 'false') && (user.deletionDate < actualDate); });
        return callback(null, users);
    });
};
