...
var initializeDocs = module.exports.initializeDocs = function(uiConfig, callback) {
    ...
    initializeFrontendDocs(uiConfig, callback);
};
 ...
 * @param  {Function}   callback         Standard callback function
 */
var initializeFrontendDocs = function(uiConfig, callback) {
    // Only parse the API files. We don't parse any other UI files yet.
    var dir = uiConfig.path + '/shared/oae/api';
    var exclude = ['oae.api.js', 'oae.bootstrap.js', 'oae.core.js'];
    parseDocs(dir, exclude, function(err, docs) {
 ...
 */
var parseDocs = function(dir, exclude, callback) {
    ...
    IO.getFileListForFolder(dir, function(err, fileNames) {
        ...
        fileNames = filterFiles(fileNames, exclude);
        ...
        _.each(fileNames, function(fileName) {
            (function(fileName) {
                ...
                IO.readFile(dir + '/' + fileName, function(err, data) {
                    done++;
                    if (!err) {
 ...
 */
var filterFiles = function(fileNames, exclude) {
