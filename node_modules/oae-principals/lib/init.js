...
var _ensureSchema = function(callback) {
    ...
    Cassandra.createColumnFamilies({
        ...
        // 
        'Request': 'CREATE TABLE "Request" ("groupId" text, "principalId" text, "role" text, PRIMARY KEY ("groupId", "principalId"))',

        // 
        'RequestByGroup': 'CREATE TABLE "RequestByGroup" ("groupId" text PRIMARY KEY, "principalId" text, "role" text)'
