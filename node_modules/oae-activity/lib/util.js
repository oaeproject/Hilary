 ...
 * @param   {Object}    [membersByRole]         Internal parameter used for recursion that aggregates all the current members by role. Same format as `callback.membersByRole`
 * @api private
 */
