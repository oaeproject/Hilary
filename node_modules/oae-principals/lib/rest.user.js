...
OAE.tenantRouter.on('post', '/api/user/guest/verify', function(req, res) {
    PrincipalsAPI.verifyGuestToken(req.ctx, req.body.token, req.body.username, req.body.password, function(err) {
        if (err) {
            return res.send(err.code, err.msg);
        }
...
OAE.tenantRouter.on('post', '/api/user/email/verify', function(req, res) {
    PrincipalsAPI.verifyEmailToken(req.ctx, req.body.token, function(err) {
        if (err) {
            return res.send(err.code, err.msg);
        }
...
/**
 * @REST postUser{UserId}EmailSend
 *
