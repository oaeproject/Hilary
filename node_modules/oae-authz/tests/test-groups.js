...
describe('Authz Groups', function() {
   ...
   */
  var verifyNoBidirectionalGroupMembership = function(
    groupId,
    memberId,
    callback,
  ) {
    AuthzAPI.hasAnyRole(memberId, groupId, function(err, hasRole) {
      ...
      AuthzAPI.getAuthzMembers(groupId, undefined, undefined, function(
        err,
        members,
      ) {
        assert.ok(!err);
   ...
   * @param  {Function}    callback   Standard callback function
   */
  var verifyBidirectionalGroupMembership = function(
    groupId,
    memberId,
    role,
    callback,
  ...
  var _setupMembershipChain = function(callback) {
    ...
    AuthzAPI.updateRoles(groupId5, _.oaeObj(userId, 'member'), function(err) {
      assert.ok(!err);
      AuthzAPI.updateRoles(groupId4, _.oaeObj(groupId5, 'member'), function(
        err,
      ) {
        assert.ok(!err);
        AuthzAPI.updateRoles(groupId3, _.oaeObj(groupId4, 'member'), function(
          err,
        ) {
          assert.ok(!err);
          AuthzAPI.updateRoles(groupId2, _.oaeObj(groupId3, 'member'), function(
            err,
          ) {
            assert.ok(!err);
            AuthzAPI.updateRoles(
              groupId1,
              _.oaeObj(groupId2, 'member'),
              function(err) {
                assert.ok(!err);
  ...
  describe('Add group member', function() {
    ...
    it('verify user gets added to group', function(callback) {
      ...
      AuthzAPI.updateRoles(groupId, _.oaeObj(memberId, 'member'), function(
        err,
        usersInvalidated,
      ) {
        assert.ok(!err);
        ...
        return verifyBidirectionalGroupMembership(
          groupId,
          memberId,
          'member',
          callback,
    ...
    it('verify user gets removed from group', function(callback) {
      ...
      AuthzAPI.updateRoles(groupId, _.oaeObj(memberId, 'member'), function(
        ...
        verifyBidirectionalGroupMembership(
          ...
          function() {
            // 3. remove the user
            AuthzAPI.updateRoles(groupId, _.oaeObj(memberId, false), function(
              err,
              usersInvalidated,
            ) {
              assert.ok(!err);
                  ...
                  function() {
                    verifyBidirectionalGroupMembership(
                      ...
                      function() {
                        ...
                        AuthzAPI.updateRoles(groupId, changes, function(
                          err,
                          usersInvalidated,
                        ) {
                          assert.ok(!err);
                                        ...
                                        function() {
                                          ...
                                          AuthzAPI.updateRoles(
                                            ...
                                            function(err, usersInvalidated) {
                                              assert.ok(!err);
                                              assert.strictEqual(
                                                usersInvalidated.length,
                                                4,
                                              );

                                              verifyNoBidirectionalGroupMembership(
                                                groupId,
                                                mrvisserId,
                                                function() {
                                                  verifyNoBidirectionalGroupMembership(
  ...
  describe('#getAuthzMembers()', function() {
    it('verify invalid group id error', function(callback) {
      AuthzAPI.getAuthzMembers('not a valid id', undefined, undefined, function(
        err,
      ) {
        assert.ok(err);
    ...
    it('verify non-group group id error', function(callback) {
      AuthzAPI.getAuthzMembers('u:cam:mrvisser', undefined, undefined, function(
        err,
      ) {
        assert.ok(err);
        assert.equal(err.code, 400);
    ...
    it('verify user paging', function(callback) {
      ...
      AuthzAPI.updateRoles(groupId, changes, function(err) {
        assert.ok(!err);
        AuthzAPI.getAuthzMembers(groupId, undefined, 10, function(
          err,
          members,
          nextToken,
        ) {
          ...
          AuthzAPI.getAuthzMembers(groupId, members[9].id, 10, function(
            err,
            members,
            nextToken,
          ) {
  ...
  describe('#getIndirectPrincipalMemberships()', function() {
     ...
     */
    var assertIndirectMemberships = function(
      principalId,
      start,
      limit,
      expectedGroups,
      ...
      AuthzAPI.getIndirectPrincipalMemberships(
        ...
        start,
        limit,
        function(err, groupIds, nextToken) {
          assert.ok(!err);
    ...
    it('verify paging on freshly cached authz memberships indirect cache', function(callback) {
      _setupMembershipChain(function(
        userId,
        groupId1,
        groupId2,
        groupId3,
    ...
    it('verify single group membership results in empty indirect membership', function(callback) {
      ...
      AuthzAPI.updateRoles(groupId, _.oaeObj(userId, 'member'), function(
        err,
        usersInvalidated,
      ) {
        assert.ok(!err);
    ...
    it('verify two direct group memberships results in empty indirect membership', function(callback) {
      ...
      AuthzAPI.updateRoles(groupId1, _.oaeObj(userId, 'member'), function(
        err,
        usersInvalidated,
      ) {
        assert.ok(!err);
        ...
        AuthzAPI.updateRoles(groupId2, _.oaeObj(userId, 'member'), function(
          err,
          usersInvalidated,
        ) {
          assert.ok(!err);
    ...
    it('verify circular group hierarchy', function(callback) {
      ...
      AuthzAPI.updateRoles(groupId1, _.oaeObj(userId, 'member'), function(
        ...
        AuthzAPI.updateRoles(groupId2, _.oaeObj(groupId1, 'member'), function(
          err,
          usersInvalidated,
        ) {
          assert.ok(!err);
          assert.strictEqual(usersInvalidated.length, 1);
          assert.strictEqual(usersInvalidated[0], userId);
          AuthzAPI.updateRoles(groupId3, _.oaeObj(groupId2, 'member'), function(
            err,
            usersInvalidated,
          ) {
            assert.ok(!err);
    ...
    it('verify paging', function(callback) {
      ...
      AuthzAPI.updateRoles(groupId1, _.oaeObj(userId, 'member'), function(err) {
        assert.ok(!err);
        AuthzAPI.updateRoles(groupId2, _.oaeObj(groupId1, 'manager'), function(
          err,
        ) {
          assert.ok(!err);
          AuthzAPI.updateRoles(groupId3, _.oaeObj(groupId1, 'member'), function(
            err,
          ) {
            assert.ok(!err);
            AuthzAPI.updateRoles(
  ...
  describe('#getAllIndirectPrincipalMemberships()', function() {
     ...
     * @throws {Error}                              An assertion error is thrown if an error occurs or the retrieved groups don't match the expected groups
     */
    var _assertAllIndirectMembershipsEquals = function(
      principalId,
      expectedGroupIds,
      callback,
    ) {
      AuthzAPI.getAllIndirectPrincipalMemberships(principalId, function(
        err,
        groupIds,
      ) {
        assert.ok(!err);
     ...
     */
    it('verify non-principal id', function(callback) {
      AuthzAPI.getAllIndirectPrincipalMemberships('c:cam:Foo.docx', function(
        err,
      ) {
        assert.ok(err);
        assert.equal(err.code, 400);
    ...
    it('verify empty membership is an empty array', function(callback) {
      var userId = AuthzUtil.toId('u', 'ipm-empty', 'mrvisser');
      AuthzAPI.getAllIndirectPrincipalMemberships(userId, function(
        err,
        groupIds,
      ) {
        assert.ok(!err);
  ...
  describe('#getAuthzMembersGraph()', function() {
    ...
    it('verify group with no members results in single node graph', function(callback) {
      TestsUtil.generateResourceIds(3, 'g', 'oae', function(
        groupId1,
        groupId2,
        groupId3,
      ) {
    ...
    it('verify group members hierarchy', function(callback) {
      TestsUtil.generateResourceIds(1, 'u', 'oae', function(userId) {
        TestsUtil.generateResourceIds(4, 'g', 'oae', function(
          groupId1,
          groupId2,
          groupId3,
          groupId4,
                  ...
                  AuthzAPI.updateRoles(
                    ...
                    function(err) {
                      ...
                      AuthzTestUtil.assertAuthzMembersGraphIdsEqual(
                        ...
                        function(graph) {
                          assert.strictEqual(
                            graph.getEdge(userId, groupId1).role,
                            'member',
                          );
                          assert.strictEqual(
                            graph.getEdge(userId, groupId2).role,
                            'manager',
                          );
                          assert.strictEqual(
                            graph.getEdge(groupId1, groupId3).role,
                            'manager',
                          );
                          assert.strictEqual(
                            graph.getEdge(groupId2, groupId3).role,
                            'member',
                          );
                          assert.strictEqual(
                            graph.getEdge(groupId3, groupId4).role,
                            'member',
                          );
  ...
  describe('#getPrincipalMemberships()', function() {
              ...
              function(err) {
                ...
                AuthzAPI.updateRoles(
                  ...
                  function(err) {
                    ...
                    AuthzAPI.getPrincipalMemberships(userId, null, 3, function(
                      err,
                      groupIds,
                      nextToken,
                    ) {
    ...
    it('verify empty membership is empty array', function(callback) {
      ...
      AuthzAPI.getPrincipalMemberships(userId, undefined, undefined, function(
        err,
        groupIds,
      ) {
        assert.ok(!err);
    ...
    it('verify paging', function(callback) {
      ...
      AuthzAPI.updateRoles(groupId1, _.oaeObj(userId, 'member'), function(err) {
        assert.ok(!err);
        AuthzAPI.updateRoles(groupId2, _.oaeObj(userId, 'manager'), function(
          err,
        ) {
          assert.ok(!err);
          AuthzAPI.updateRoles(groupId3, _.oaeObj(userId, 'member'), function(
            err,
          ) {
            assert.ok(!err);
            AuthzAPI.updateRoles(groupId4, _.oaeObj(userId, 'member'), function(
              err,
            ) {
              assert.ok(!err);
              AuthzAPI.updateRoles(
        ...
        AuthzAPI.updateRoles(
          ...
          function(err) {
            AuthzAPI.updateRoles(
              ...
              function(err) {
                assert.ok(!err);
                AuthzAPI.hasAnyRole(userId, groupId1, function(
                  err,
                  hasAnyRole,
                ) {
                  assert.ok(!err);
                  assert.ok(hasAnyRole);
                  AuthzAPI.hasAnyRole(userId, groupId2, function(
                    err,
                    hasAnyRole,
                  ) {
                    assert.ok(!err);
                    assert.ok(hasAnyRole);
                    AuthzAPI.hasAnyRole(userId, nonMemberGroupId3, function(
                      err,
                      hasAnyRole,
                    ) {
                      assert.ok(!err);
              ...
              function(err) {
                ...
                AuthzAPI.hasAnyRole(userId, groupId1, function(
                  ...
                  AuthzAPI.hasAnyRole(userId, groupId2, function(
                    ...
                    assert.ok(!err);
                    assert.ok(hasAnyRole);
                    AuthzAPI.hasAnyRole(userId, groupId3, function(
                      err,
                      hasAnyRole,
                    ) {
                      assert.ok(!err);
  ...
  describe('#computeMemberRolesAfterChanges()', function() {
    ...
    it('verify functionality when taking into account adds, removes and updates', function(callback) {
      ...
      AuthzAPI.updateRoles(groupId, rolesBefore, function(err) {
        ...
        var addBertChange = _.oaeObj(bert, 'member');
        AuthzAPI.computeMemberRolesAfterChanges(
          groupId,
          addBertChange,
          null,
          function(err, idChangeInfo) {
            assert.ok(!err);
            ...
            var mrvisserManagerChange = _.oaeObj(mrvisser, 'manager');
            AuthzAPI.computeMemberRolesAfterChanges(
              groupId,
              ...
              function(err, idChangeInfo) {
                ...
                var simonMemberChange = _.oaeObj(simong, 'member');
                AuthzAPI.computeMemberRolesAfterChanges(
                  groupId,
                  simonMemberChange,
                  null,
                  function(err, idChangeInfo) {
                    ...
                    var simonRemoveChange = _.oaeObj(simong, false);
                    AuthzAPI.computeMemberRolesAfterChanges(
                      groupId,
                      simonRemoveChange,
                      null,
                      function(err, idChangeInfo) {
                        assert.ok(!err);
                        assert.deepEqual(
                          idChangeInfo.changes,
                          simonRemoveChange,
                        );
                        assert.deepEqual(
                          idChangeInfo.roles.before,
                          rolesBefore,
                        );
                        assert.deepEqual(
                          idChangeInfo.roles.after,
                        ...
                        var unknownUser = AuthzUtil.toId(
                          'u',
                          'cmac',
                          'unknown',
                        );
                        var unknownUserRemoveChange = _.oaeObj(
                          unknownUser,
                          false,
                        );
                        AuthzAPI.computeMemberRolesAfterChanges(
      ...
      AuthzAPI.updateRoles(groupId, rolesBefore, function(err) {
        ...
        AuthzAPI.computeMemberRolesAfterChanges(
          ...
          function(err, idChangeInfo) {
            ...
            var mrvisserEditorChange = _.oaeObj(mrvisser, 'editor');
            AuthzAPI.computeMemberRolesAfterChanges(
              groupId,
              ...
              function(err, idChangeInfo) {
                ...
                var stephenViewerChange = _.oaeObj(stephen, 'viewer');
                AuthzAPI.computeMemberRolesAfterChanges(
                  groupId,
                  stephenViewerChange,
                  { promoteOnly: true },
