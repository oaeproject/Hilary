 ...
 */
var createExpiringSignature = (module.exports.createExpiringSignature = function(
  data,
  duration,
  offset,
) {
 ...
 */
var verifyExpiringSignature = (module.exports.verifyExpiringSignature = function(
  data,
  expires,
  signature,
) {
 ...
 */
var createExpiringResourceSignature = (module.exports.createExpiringResourceSignature = function(
  ctx,
  resourceId,
  duration,
  offset,
) {
  return createExpiringSignature(
    _createResourceData(ctx, resourceId),
    duration,
    offset,
  );
});
 ...
 */
var verifyExpiringResourceSignature = (module.exports.verifyExpiringResourceSignature = function(
  ctx,
  resourceId,
  expires,
  signature,
) {
  return verifyExpiringSignature(
    _createResourceData(ctx, resourceId),
    expires,
    signature,
  );
