 ...
 */
var getPrincipal = (module.exports.getPrincipal = function(
  ctx,
  principalId,
  callback,
) {
  getPrincipals(ctx, [principalId], function(err, principals) {
    if (err) {
      ...
      return callback({
        code: 404,
        msg: 'Could not find principal with id ' + principalId,
      });
    }
 ...
 */
var getPrincipals = (module.exports.getPrincipals = function(
  ctx,
  principalIds,
  callback,
) {
 ...
 */
var touchLastModified = (module.exports.touchLastModified = function(
  oldPrincipal,
  callback,
) {
  ...
  PrincipalsDAO.updatePrincipal(oldPrincipal.id, updatedProfileFields, function(
    err,
  ) {
    if (err) {
      return callback(err);
 ...
 */
var verifyEmailAddress = (module.exports.verifyEmailAddress = function(
  ctx,
  user,
  email,
  callback,
  ...
  PrincipalsDAO.setEmailAddress(user, email, function(err, updatedUser) {
    ...
    PrincipalsEmitter.emit(
      PrincipalsConstants.events.VERIFIED_EMAIL,
      ctx,
      updatedUser,
      function(errs) {
        if (errs) {
...
var hideUserData = (module.exports.hideUserData = function(ctx, user) {
  ...
  var isAdmin =
    !isAnon && ctx.user().isAdmin && ctx.user().isAdmin(user.tenant.alias);
  ...
  if (user.deleted || (needsLoggedIn && !isLoggedIn) || isPrivate) {
    ...
    // identifier
    var invalid = /https?:\/\/|shibboleth!|@/i;
 ...
 */
var createUpdatedUser = (module.exports.createUpdatedUser = function(
  user,
  fieldUpdates,
) {
  ...
  var newUser = new User(user.tenant.alias, user.id, newDisplayName, newEmail, {
    ...
    notificationsUnread:
      fieldUpdates.notificationsUnread || user.notificationsUnread,
    notificationsLastRead:
      fieldUpdates.notificationsLastRead || user.notificationsLastRead,
 ...
 */
var createPersistentUserActivityEntity = (module.exports.createPersistentUserActivityEntity = function(
  userId,
  user,
) {
  return new ActivityModel.ActivityEntity('user', userId, user.visibility, {
    user: user,
  });
});
 ...
 */
var transformPersistentUserActivityEntity = (module.exports.transformPersistentUserActivityEntity = function(
  ctx,
  userId,
  user,
) {
  ...
  if (user) {
    ...
    if (user.profilePath) {
      ...
      if (user.picture.small) {
        opts.ext[
          ActivityConstants.properties.OAE_THUMBNAIL
        ] = new ActivityModel.ActivityMediaLink(
          user.picture.small,
  ...
  return new ActivityModel.ActivityEntity(
    'user',
    globalId,
    user.visibility,
    opts,
 ...
 */
var transformPersistentUserActivityEntityToInternal = (module.exports.transformPersistentUserActivityEntityToInternal = function(
  ctx,
  userId,
  user,
) {
 ...
 */
var createPersistentGroupActivityEntity = (module.exports.createPersistentGroupActivityEntity = function(
  groupId,
  group,
) {
  return new ActivityModel.ActivityEntity('group', groupId, group.visibility, {
    group: group,
  });
});
 ...
 */
var transformPersistentGroupActivityEntity = (module.exports.transformPersistentGroupActivityEntity = function(
  ctx,
  groupId,
  group,
) {
  ...
  if (group) {
    ...
    if (!group.deleted) {
      opts.ext[ActivityConstants.properties.OAE_PROFILEPATH] =
        group.profilePath;
    }
 ...
 */
var transformPersistentGroupActivityEntityToInternal = (module.exports.transformPersistentGroupActivityEntityToInternal = function(
  ctx,
  groupId,
  group,
) {
