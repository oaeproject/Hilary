...
var emitter = module.exports = new EmitterAPI.EventEmitter();
...
var createTenantNetwork = module.exports.createTenantNetwork = function(displayName, callback) {
    ...
    var tenantNetworkQuery = Cassandra.constructUpsertCQL('TenantNetwork', 'id', tenantNetwork.id, _.omit(tenantNetwork, 'id'));
...
var updateTenantNetwork = module.exports.updateTenantNetwork = function(id, displayName, callback) {
    ...
    getTenantNetwork(id, function(err, tenantNetwork) {
        ...
        var query = Cassandra.constructUpsertCQL('TenantNetwork', 'id', id, {'displayName': displayName});
...
var deleteTenantNetwork = module.exports.deleteTenantNetwork = function(id, callback) {
    ...
    getTenantNetwork(id, function(err, tenantNetwork) {
        ...
        Cassandra.runBatchQuery(deleteQueries, function(err) {
            if (err) {
                return callback(err);
            }
...
var addTenantAliases = module.exports.addTenantAliases = function(tenantNetworkId, tenantAliases, callback) {
    ...
    getTenantNetwork(tenantNetworkId, function(err, tenantNetwork) {
        ...
        var queries = _.map(tenantAliases, function(tenantAlias) {
            return Cassandra.constructUpsertCQL('TenantNetworkTenants', ['tenantNetworkId', 'tenantAlias'], [tenantNetworkId, tenantAlias], {'value': '1'});
        });
...
var _getAllTenantNetworksFromCassandra = function(callback) {
    Cassandra.runQuery('SELECT * FROM "TenantNetwork"', null, function(err, rows) {
        if (err) {
            return callback(err);
        }

        // Convert all rows into tenant networks
        var tenantNetworks = _.chain(rows).compact().indexBy('id').value();
...
var _getAllTenantNetworkTenantAliasesFromCassandra = function(tenantNetworkIds, callback) {
    ...
    Cassandra.runInQuery('SELECT "tenantNetworkId", "tenantAlias" FROM "TenantNetworkTenants"', null, 'tenantNetworkId', tenantNetworkIds, function(err, rows) {
        if (err) {
            return callback(err);
        }
        ...
        _.each(rows, function(row) {
            tenantNetworkAliases[row.tenantNetworkId] = tenantNetworkAliases[row.tenantNetworkId] || [];
            tenantNetworkAliases[row.tenantNetworkId].push(row.tenantAlias);
        });
