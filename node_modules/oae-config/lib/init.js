...
var registerConfigAdminRestEndpoints = function(app) {
    ...
    app.server.get('/api/config', function(req, res, next) {
        // @todo replace 'global' with serverTenant.alias once CatchUnauthorizedLogin PR is merged
        ConfigAPI.getFullConfig('global', function(err, configuration) {
            if (err) {
                return res.send(err.code, err.msg);
            }
