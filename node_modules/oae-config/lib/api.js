...
var updateConfig = module.exports.updateConfig = function(ctx, tenantAlias, configValues, callback) {
    ...
    _.each(configValues, function(value, key) {
        ...
        var storageKey = util.format('%s/%s/%s', module, feature, element);
        ...
        if (optionalKey) {
            ...
            aggregatedValues[storageKey] = aggregatedValues[storageKey] || cachedTenantConfig[tenantAlias][module][feature][element] || {};
