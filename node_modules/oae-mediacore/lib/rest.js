 ...
 */
OAE.tenantServer.get('/api/mediacore/embed/:contentId', function(req, res) {
    req.telemetryUrl = '/api/mediacore/embed/contentId';
 ...
 */
OAE.tenantServer.post('/api/mediacore/encodingCallback', function(req, res) {
    req.telemetryUrl = '/api/mediacore/encodingCallback';
