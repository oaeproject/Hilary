...
LibraryAPI.Search.registerLibrarySearch('discussions-library', 'discussion');
...
var _transformContentDocuments = function(ctx, docs, callback) {
    ...
    _.each(docs, function(doc, docId) {
        ...
        result.profilePath = '/discussion/' + result.id;
...
SearchAPI.registerSearchDocumentTransformer('discussion', _transformContentDocuments);
