 ...
 * @param  {Boolean}    callback.discussion.isMember    Specifies if the current user in context is a member of the discussion
...
var getFullDiscussionProfile = module.exports.getFullDiscussionProfile = function(ctx, discussionId, callback) {
    ...
    _getDiscussion(discussionId, function(err, discussion) {
        ...
        DiscussionsAPI.Authz.resolveEffectiveDiscussionAccess(ctx, discussion, function(err, canView, canManage, canShare, canPost, isMember) {
            if (err) {
                return callback(err);
            } else if (!canView) {
