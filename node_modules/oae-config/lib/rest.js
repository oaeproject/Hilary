 ...
 * @Method      GET
 * @Path        /config/schema
 * @Return      {ConfigSchema}          The configuration schema for the current tenant
 */
 ...
 * @Method      POST
 * @Path        /config/clear
 * @FormParam   {string[]}      configFields        Array of config items to clear in the form `oae-authentication/twitter/enabled`
 */
 ...
 * @PathParam   {string}            tenantAlias     Alias of tenant
 * @Return      {Config}                            The specified tenant's configuration
 */
 ...
 * @Method      POST
 * @Path        /config
 * @FormParam   {string}            {configKey}     New value for specified key (e.g. `oae-authentication/twitter/enabled`); may be repeated for multiple keys
 */
