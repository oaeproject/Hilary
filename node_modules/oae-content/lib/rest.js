...
OAE.tenantServer.post('/api/content/:contentId/comment', function(req, res) {
    ContentAPI.postComment(req.ctx, req.params.contentId, req.body.comment, function(err) {
        if (err) {
            return res.send(err.code, err.msg);
        }
        res.send(200);
...
OAE.tenantServer.post('/api/content/:contentId/comment/:created/update', function(req, res) {
    ContentAPI.updateComment(req.ctx, req.params.contentId, req.params.created, req.body.comment, function(err) {
        if (err) {
            return res.send(err.code, err.msg);
        }
        res.send(200);
...
OAE.tenantServer.get('/api/content/:contentId/comment', function(req, res) {
...
OAE.tenantServer.del('/api/content/:contentId/comment/:created/delete', function(req, res) {
    ContentAPI.deleteComment(req.ctx, req.params.contentId, req.params.created, function(err) {
        if (err) {
            return res.send(err.code, err.msg);
        }
        res.send(200);
...
OAE.tenantServer.post('/api/content/:contentId/comment/:created/reply', function(req, res) {
    ContentAPI.postReply(req.ctx, req.params.contentId, req.params.created, req.body.comment, function(err) {
        if (err) {
            return res.send(err.code, err.msg);
        }
        res.send(200);
