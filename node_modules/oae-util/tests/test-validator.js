...
var LoginId = require('oae-principals/lib/model.user').LoginId;
...
describe('Utilities', function() {
    ...
    describe('Validator', function() {
        it('Test undefined gets checked as empty', function(callback) {
         ...
         */
        it('Test empty validator', function(callback) {
         ...
         * is working as intended
         */
        it('Test integer validator', function(callback) {
            // Single test successful
            var validator = new Validator();
         ...
         * is working as intended
         */
        it('Test email validator', function(callback) {
            // Single test successful
            var validator = new Validator();
         ...
         */
        it('Test URL validator', function(callback) {
            // Single test successful
            var validator = new Validator();
         ...
         */
        it('Test context validator', function(callback) {
            // Valid tenant
            var tenant1 = new Tenant('cam', 'Cambridge University', 2001);
            // Invalid tenant
            var tenant2 = new Tenant(null, 'Georgia Tech', 2002);
            // Valid users
            var user1 = new User(tenant1, 'u:cam:nm417', 'public', null, null, 'Nicolaas Matthijs');
            var user2 = new User(tenant1, 'u:cam:nm417', 'private', null, null, 'Nicolaas Matthijs');
            var user3 = new User(tenant1, 'u:cam:nm417', null, null, null, null, null);
            // Invalid users
            var user4 = new User(tenant1, null, 'public', null, null, 'Nicolaas Matthijs');
            var user5 = new User(tenant1, '', 'public', null, null, 'Nicolaas Matthijs');
        ...
        it('Test timezone validation', function(callback) {
            ...
            // We won't support any short hand timezones except UTC
