...
describe('Groups', function() {
        ...
        it('verify isMember and isManager', function(callback) {
            ...
            RestAPI.User.createUser(camAdminRestContext, jackUserId, 'password', 'public', 'en_GB', 'Europe/London', 'Jack', 'Doe', 'John Doe', function(err, jack) {
                ...
                RestAPI.User.createUser(camAdminRestContext, janeUserId, 'password', 'public', 'en_GB', 'Europe/London', 'Jane', 'Doe', 'Jane Doe', function(err, jane) {
                    ...
                    RestAPI.User.createUser(camAdminRestContext, joeUserId, 'password', 'public', 'en_GB', 'Europe/London', 'Joe', 'Doe', 'Joe Doe', function(err, joe) {
                        assert.ok(!err);
    ...
    describe('#getGroupMembers()', function() {
        ...
        it('verify respect visibility', function(callback) {
            ...
            RestAPI.User.createUser(camAdminRestContext, brandenUserId, 'password', 'public', 'en_GB', 'Europe/London', 'Test', 'Runner', 'tr123', function(err, branden) {
                assert.ok(!err);
    ...
    describe('#setGroupMembers()', function() {
        ...
        it('verify simple member adding', function(callback) {
            ...
            RestAPI.User.createUser(camAdminRestContext, brandenUserId, 'password', 'public', 'en_GB', 'Europe/London', 'Test', 'Runner', 'tr123', function(err, branden) {
                ...
                RestAPI.User.createUser(camAdminRestContext, nicolaasUserId, 'password', 'public', 'en_GB', 'Europe/London', 'Test', 'Runner', 'tr123', function(err, nicolaas) {
                    assert.ok(!err);
                    var nicolaasRestContext = new RestContext(global.oaeTests.tenants.cam.baseUrl, nicolaasUserId, 'password');
                    ...
                    RestAPI.Group.createGroup(johnRestContext, groupId, 'Test Group', "Group", 'public', 'yes', [], [], function(err, groupObj) {
                        ...
                        RestAPI.Group.setGroupMembers(brandenRestContext, groupObj.id, membersToAdd, function(err) {
                            ...
                            RestAPI.Group.memberOf(nicolaasRestContext, nicolaas.id, null, null, function(err, groupMemberships) {
                                assert.ok(!err);
                                assert.equal(groupMemberships.length, 0);
                                            ...
                                            RestAPI.Group.setGroupMembers(johnRestContext, groupObj.id, membersToAdd, function(err) {
                                                ...
                                                RestAPI.Group.setGroupMembers(brandenRestContext, groupObj.id, membersToAdd, function(err) {
                                                    ...
                                                    RestAPI.Group.memberOf(nicolaasRestContext, nicolaas.id, null, null, function(err, groupMemberships) {
                                                        ...
                                                        assert.equal(groupMemberships[0].id, groupObj.id);
                            ...
                            RestAPI.Group.setGroupMembers(johnRestContext, newGroup.id, membersToAdd, function(err) {
                                ...
                                RestAPI.Group.getGroupMembers(johnRestContext, newGroup.id, null, null, function(err, members) {
                                    ...
                                    RestAPI.Group.memberOf(joeRestContext, joe.id, null, null, function(err, memberships) {
                                        ...
                                        assert.equal(memberships[0].id, newGroup.id);
        ...
        it('verify add members no access', function(callback) {
            ...
            RestAPI.User.createUser(camAdminRestContext, simonUserId, 'password', 'public', 'en_GB', 'Europe/London', 'Test', 'Runner', 'tr123', function(err, simon) {
                assert.ok(!err);
                var simonRestContext = new RestContext(global.oaeTests.tenants.cam.baseUrl, simonUserId, 'password');
                // Create a second user to use inside of test
                var nicolaasUserId = TestsUtil.generateTestUserId('nicolaas');
                RestAPI.User.createUser(camAdminRestContext, nicolaasUserId, 'password', 'public', 'en_GB', 'Europe/London', 'Test', 'Runner', 'tr123', function(err, nicolaas) {
                    assert.ok(!err);
                                            ...
                                            RestAPI.Group.setGroupMembers(johnRestContext, groupObj.id, membersToAdd, function(err) {
                                                ...
                                                RestAPI.Group.setGroupMembers(simonRestContext, groupObj.id, membersToAdd, function(err) {
                                                    ...
                                                    RestAPI.Group.memberOf(nicolaasRestContext, nicolaas.id, null, null, function(err, memberships) {
                                                        assert.ok(!err);
                                                        assert.equal(memberships.length, 1);
                                                        assert.equal(memberships[0].id, groupObj.id);
                                                        callback();
                                                    });
                                                });
                                            });
                        ...
                        RestAPI.Group.createGroup(johnRestContext, cambridgeGroupId, 'Test Group', "Group", 'public', 'yes', [], [], function(err, cambridge) {
                            ...
                            RestAPI.Group.setGroupMembers(johnRestContext, managedByCambridge.id, membersToAdd, function(err) {
                                ...
                                RestAPI.Group.setGroupMembers(johnRestContext, cambridge.id, membersToAdd, function(err) {
                                    ...
                                    AuthzAPI.isAllowed(simon.id, 'manager', managedByCambridge.id, function(err, isAllowed) {
                                        assert.ok(!err);
                                        ...
                                        RestAPI.Group.setGroupMembers(simonRestContext, managedByCambridge.id, membersToAdd, function(err) {
                                            ...
                                            RestAPI.Group.memberOf(nicolaasRestContext, nicolaas.id, null, null, function(err, memberships) {
                                                assert.ok(!err);
                                                assert.equal(memberships.length, 1);
                                                assert.equal(memberships[0].id, managedByCambridge.id);
                                                callback();
                                            });
                                        });
                                    });
                ...
                RestAPI.User.createUser(camAdminRestContext, brandenUserId, 'password', 'public', 'en_GB', 'Europe/London', 'Test', 'Runner', 'tr123', function(err, branden) {
                    ...
                    TestsUtil.generateTestGroups(nicolaasRestContext, 3, function(err, groups) {
                        ...
                        RestAPI.Group.memberOf(nicolaasRestContext, nicolaas.id, null, null, function(err, memberships) {
                            ...
                            assert.ok(groupIds.indexOf(memberships[0].id) !== -1);
                            assert.ok(groupIds.indexOf(memberships[1].id) !== -1);
                            assert.ok(groupIds.indexOf(memberships[2].id) !== -1);
    ...
    describe('#simple group structure', function() {
        ...
        var createPrincipals = function(callback) {
            ...
            var createPrincipal = function(type, identifier, metadata1, metadata2) {
                var principalId = TestsUtil.generateTestUserId(identifier);
                if (type === 'group') {
                    RestAPI.Group.createGroup(johnRestContext, principalId, metadata1, metadata2, 'public', 'yes', [], [], function(err, groupObj) {
                        assert.ok(!err);
                        createdPrincipals[identifier] = groupObj;
                        if (_.keys(createdPrincipals).length === 11) {
                            callback(createdPrincipals);
                        }
                    });
                } else {
                    RestAPI.User.createUser(camAdminRestContext, principalId, 'password', 'public', 'en_GB', 'Europe/London', metadata1, metadata2, identifier, function(err, userObj) {
                        assert.ok(!err);
                        var userRestContext = new RestContext(global.oaeTests.tenants.cam.baseUrl, principalId, 'password');
            ...
            createPrincipal('group', 'oae-team', 'OAE Team', 'The OAE Team');
            createPrincipal('group', 'backend-team', 'Backend Team', 'The Backend team');
            createPrincipal('group', 'ui-team', 'UI Team', 'The UI team');
            createPrincipal('group', 'canadian', 'Canadian Team', 'The Canadian team');
            createPrincipal('group', 'not-canadian', 'Not Canadian Team', 'The not Canadian team');
            createPrincipal('group', 'belgian', 'Belgian Team', 'The Belgian team');
            createPrincipal('group', 'west-flemish', 'West Flemish Team', 'The West Flemish team');
            createPrincipal('group', 'east-flemish', 'East Flemish Team', 'The East Flemish team');
        ...
        assertMemberOf = function(createdPrincipals, userIdentifier, expectedGroups, callback) {
            RestAPI.Group.memberOf(createdPrincipals[userIdentifier], createdPrincipals[userIdentifier].id, null, null, function(err, memberships) {
                assert.ok(!err);
                assert.equal(memberships.length, expectedGroups.length);
                // Morph results to hash for easy access.
                var hash = _.groupBy(memberships, function(membership) { return membership.id; });
        ...
        it('verify group visibility', function(callback) {
            ...
            var assertGroupVisibility = function(restContext, groupObj, expectedMembers, expectedMemberLength, callback) {
                ...
                RestAPI.Group.getGroup(restContext, groupObj.id, function(err, retrievedGroupObj) {
                    assert.ok(!err);
                    assert.ok(retrievedGroupObj.id, groupObj.id);
                    assert.ok(retrievedGroupObj.name, groupObj.name);
