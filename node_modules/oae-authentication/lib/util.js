 ...
 */
var setupAuthMiddleware = (module.exports.setupAuthMiddleware = function(
  config,
  server,
) {
 ...
 */
var hashAndComparePassword = (module.exports.hashAndComparePassword = function(
  plainTextPassword,
  hashedPassword,
) {
 ...
 */
var getStrategyId = (module.exports.getStrategyId = function(
  tenant,
  strategyName,
) {
 ...
 */
var logAuthenticationSuccess = (module.exports.logAuthenticationSuccess = function(
  req,
  authInfo,
  strategyName,
) {
 ...
 */
var handlePassportError = (module.exports.handlePassportError = function(
  req,
  res,
  next,
) {
  return function(err) {
    if (err) {
      ...
      if (err.reason && err.msg) {
        log().warn({ err: err, host: req.hostname }, err.msg);
        return res.redirect('/?authentication=failed&reason=' + err.reason);

        // If someone tried to sign in with a disabled strategy
      } else if (
        err.message &&
        err.message.indexOf('Unknown authentication strategy') === 0
      ) {
        log().warn(
          { host: req.hostname },
          'Authentication attempt with disabled strategy',
        );
 ...
 */
var handleExternalSetup = (module.exports.handleExternalSetup = function(
  strategyId,
  passportOptions,
  req,
  res,
 ...
 */
var validateRedirectUrl = (module.exports.validateRedirectUrl = function(
  redirectUrl,
) {
  ...
  if (redirectUrl.charAt(0) !== '/') {
    ...
    log().warn(
      { redirectUrl: redirectUrl },
      'Possible Open Redirect attack detected',
    );
  }
 ...
 */
var handleExternalGetOrCreateUser = (module.exports.handleExternalGetOrCreateUser = function(
  req,
  authProvider,
  externalId,
  providerProperties,
  ...
  if (!opts.email) {
    ...
    var invitationInfo = _getRequestInvitationInfo(req);
  ...
  var ctx = new Context(req.tenant);
 ...
 * @param  {Function}   next            The next middleware that should be executed
 */
var handleExternalCallback = (module.exports.handleExternalCallback = function(
  strategyId,
  req,
  res,
  next,
  ...
  passport.authenticate(strategyId, {}, function(
    err,
    user,
    challenges,
    status,
    ...
    if (err) {
      ...
      log().warn(
        { challenges: challenges, status: status },
 ...
 */
var handleLogin = (module.exports.handleLogin = function(
  strategyId,
  user,
  req,
  res,
 ...
 */
var constructCallbackUrl = (module.exports.constructCallbackUrl = function(
  tenant,
  strategy,
) {
 ...
 */
var setProfileParameter = (module.exports.setProfileParameter = function(
  profileParameters,
 ...
 * @api private
 */
var _getRequestInvitationInfo = function(req) {
  var redirectUrl = validateRedirectUrl(req.cookies.redirectUrl);
  var parsedRedirectUrl = url.parse(redirectUrl, true);
