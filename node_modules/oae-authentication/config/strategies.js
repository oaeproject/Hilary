...
module.exports = {
    ...
    'google': {
        ...
        'elements': {
            ...
            'hostedDomain': new Fields.Text('Google hosted domain', 'Google hosted domain. e.g., Google apps domain (optional)', '', {'suppress': true})
        }
    },
    'twitter': {
    ...
    'cas': {
        ...
        'elements': {
            ...
            'basepath': new Fields.Text('Base path', 'The base path on the CAS authentication server. e.g., /cas', '', {'suppress': true}),
