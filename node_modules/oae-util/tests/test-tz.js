...
describe('TZ', function() {
    ...
    describe('#getRailsTimeZoneFromTZInfo()', function() {
         ...
         */
        it('verify proper rails conversion', function() {
            assert.equal(TZ.getRailsTimezoneFromTZInfo('Europe/Brussels'), 'Brussels');
            assert.equal(TZ.getRailsTimezoneFromTZInfo('America/Los_Angeles'), 'Pacific Time (US & Canada)');
            assert.equal(TZ.getRailsTimezoneFromTZInfo('Canada/Yukon'), 'Pacific Time (US & Canada)');
            assert.equal(TZ.getRailsTimezoneFromTZInfo('Europe/Zurich'), 'Amsterdam');
        });
    });
