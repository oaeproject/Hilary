 ...
 * @FormParam   {string[]}      [managers]              Unique identifier(s) for users and groups to add, or email addresses to invite, as manager of the group. The user creating the group will be added as a manager automatically
 * @FormParam   {string[]}      [members]               Unique identifier(s) for users and groups to add, or email addresses to invite, as members of the group
