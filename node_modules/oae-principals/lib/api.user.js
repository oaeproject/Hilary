...
var _getOrCreateGuestUser = function(ctx, email, callback) {
    ...
    PrincipalsDAO.getUserByEmail(email, function(err, user) {
        ...
        if (tenant) {
            ...
            //   1.  The authentication strategy releases the email address when the invited
            //       user signs into the system (and local authentication isn't used)
            //   2.  We consider the given email address as verified as the invited person
            //       will otherwise never learn about the system
