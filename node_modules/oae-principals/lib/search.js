...
var _transformUserDocuments = function(ctx, docs, callback) {
    ...
    for (var i = 0; i < docIds.length; i++) {
        ...
        if (user.mediumPictureUri) {
            result.thumbnailUrl = PrincipalsUtil.getSignedPictureUrl(doc.fields.tenantAlias, user.mediumPictureUri);
        }
...
var _transformGroupDocuments = function(ctx, docs, callback) {
    var transformedDocs = _.map(docs, function(doc) {
        ...
        // A search doc doesn't contain any sensitive data, we can expose everything.
        ...
        if (doc.fields.thumbnailUrl) {
            result.thumbnailUrl = PrincipalsUtil.getSignedPictureUrl(doc.fields.tenantAlias, doc.fields.thumbnailUrl);
        }
