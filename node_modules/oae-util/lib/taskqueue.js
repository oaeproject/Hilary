 ...
 * @param  {Function}   callback                Standard callback function
 */
const bind = module.exports.bind = function(taskQueueId, listener, options, callback) {
    options = options || {};
 ...
 */
const unbind = module.exports.unbind = function(taskQueueId, callback) {
 ...
 * @param  {Function}   callback        Standard callback function
 */
const submit = module.exports.submit = function(taskQueueId, taskData, callback) {
