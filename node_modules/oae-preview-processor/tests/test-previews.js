...
describe('Preview processor', function() {
    ...
    describe('Preview generation', function() {
        ...
        var _purgePreviewsQueue = function(callback) {
            ...
            // We need to bind to the queue so the MQ utility knows of its existency
            // We do not receive messages on it however as we only want the purge the queue
        ...
        var _reprocessWithHandler = function(restCtx, filters, handler, callback) {
            ...
            MQ.unbind(PreviewConstants.MQ.TASK_REGENERATE_PREVIEWS, function(err) {
                ...
                MQ.bind(PreviewConstants.MQ.TASK_REGENERATE_PREVIEWS, _handler, null, function(err) {
                    assert.ok(!err);
                ...
                PreviewAPI.enable(function(err) {
                    ...
                    MQ.unbind(PreviewConstants.MQ.TASK_GENERATE_PREVIEWS, function(err) {
                        ...
                        MQTestUtil.whenTasksEmpty(PreviewConstants.MQ.TASK_GENERATE_PREVIEWS, function() {
                            ...
                            MQ.bind(PreviewConstants.MQ.TASK_GENERATE_PREVIEWS, reprocessTracker, null, function(err) {
                                assert.ok(!err);

                                // Missing filters is invalid
                                MQ.submit(PreviewConstants.MQ.TASK_REGENERATE_PREVIEWS, {}, function() {
                                    MQTestUtil.whenTasksEmpty(PreviewConstants.MQ.TASK_REGENERATE_PREVIEWS, function() {
                                        MQTestUtil.whenTasksEmpty(PreviewConstants.MQ.TASK_GENERATE_PREVIEWS, function() {
                                            ...
                                            MQ.submit(PreviewConstants.MQ.TASK_REGENERATE_PREVIEWS, {'filters': {'content': {'foo': 'bar'}}}, function() {
                                                MQTestUtil.whenTasksEmpty(PreviewConstants.MQ.TASK_REGENERATE_PREVIEWS, function() {
                                                    MQTestUtil.whenTasksEmpty(PreviewConstants.MQ.TASK_GENERATE_PREVIEWS, function() {
                                                        assert.equal(contentToBeReprocessed.length, 0);

                                                        // Unknown revision filter is invalid
                                                        MQ.submit(PreviewConstants.MQ.TASK_REGENERATE_PREVIEWS, {'filters': {'revision': {'foo': 'bar'}}}, function() {
                                                            MQTestUtil.whenTasksEmpty(PreviewConstants.MQ.TASK_REGENERATE_PREVIEWS, function() {
                                                                MQTestUtil.whenTasksEmpty(PreviewConstants.MQ.TASK_GENERATE_PREVIEWS, function() {
                                                                    assert.equal(contentToBeReprocessed.length, 0);
                                                                    return callback();
