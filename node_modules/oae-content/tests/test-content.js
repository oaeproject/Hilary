    ...
    describe('Content comments', function() {
        ...
        var createComments = function(contexts, contentId, numComments, replyTo, callback) {
            ...
            var createComment = function() {
                RestAPI.Content.createComment(getRandomCommenter(), contentId, getRandomComment(), replyTo, function(err) {
                    commentCreated(err);
                });
            };
                                            ...
                                            RestAPI.Content.createComment(contexts['bert'].restContext, contentObj.contentId, 'This comment should be first in the list', null, function(err) {
                                                ...
                                                RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, null, 10, function(err, comments) {
                                                    ...
                                                    RestAPI.Content.createComment(contexts['bert'].restContext, null, 'This is an updated comment', '1231654351', function(err) {
                                                        ...
                                                        RestAPI.Content.createComment(contexts['bert'].restContext, 'contentId', null, '1231654351', function(err) {
                                                            assert.ok(err);
        ...
        it('verify delete comment access', function(callback) {
            setUpUsers(function(contexts) {
                 ...
                 * @param {RestContext}  commentContext   The RestContext object of a user to comment on the content item on
                 ...
                 * @param {Function}     _callback        Standard callback function executed after the content has been created, commented on and deleted
                 * @param {Object}       _callback.err    Error object coming from deleting a comment
                 */
                var canDelete = function(linkContext, commentContext, deleteContext, visibility, managers, members, _callback) {
                    RestAPI.Content.createLink(linkContext, 'Test Content', 'Test content description', visibility, 'http://www.sakaiproject.org/', [], members, function(err, contentObj) {
                        ...
                        RestAPI.Content.createComment(commentContext, contentObj.contentId, 'Comment to check access', null, function(err) {
                            assert.ok(!err);
        ...
        it('verify create comment access', function(callback) {
            setUpUsers(function(contexts) {
                ...
                RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 1', 'Test content description 1', 'private', 'http://www.sakaiproject.org/', [], [], function(err, contentObj) {
                    assert.ok(!err);
                    assert.ok(contentObj.contentId);
                    RestAPI.Content.createComment(contexts['bert'].restContext, contentObj.contentId, 'This is a comment as a manager of a private content item', null, function(err) {
                        assert.ok(!err);
                        ...
                        RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 2', 'Test content description 2', 'private', 'http://www.sakaiproject.org/', [contexts['simon'].user.id], [contexts['nicolaas'].user.id], function(err, contentObj) {
                            assert.ok(!err);
                            assert.ok(contentObj.contentId);
                            RestAPI.Content.createComment(contexts['nicolaas'].restContext, contentObj.contentId, 'This is Nico\'s comment as a member of a private content item', null, function(err) {
                                assert.ok(!err);
                                ...
                                RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 3', 'Test content description 3', 'private', 'http://www.sakaiproject.org/', [], [], function(err, contentObj) {
                                    assert.ok(!err);
                                    assert.ok(contentObj.contentId);
                                    RestAPI.Content.createComment(contexts['nicolaas'].restContext, contentObj.contentId, 'This is Nico\'s comment on a private content item', null, function(err) {
                                        assert.ok(err);
                                        assert.equal(err.code, 401);
                                        ...
                                        RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 4', 'Test content description 4', 'private', 'http://www.sakaiproject.org/', [], [], function(err, contentObj) {
                                            assert.ok(!err);
                                            assert.ok(contentObj.contentId);
                                            RestAPI.Content.createComment(anonymousRestContext, contentObj.contentId, 'This is Nico\'s comment as a member of a private content item', null, function(err) {
                                                assert.ok(err);
                                                assert.equal(err.code, 401);
                                                ...
                                                RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 5', 'Test content description 5', 'loggedin', 'http://www.sakaiproject.org/', [], [], function(err, contentObj) {
                                                    assert.ok(!err);
                                                    assert.ok(contentObj.contentId);
                                                    RestAPI.Content.createComment(contexts['nicolaas'].restContext, contentObj.contentId, 'This is Nico\'s comment on a loggedin content item', null, function(err) {
                                                        assert.ok(!err);
                                                        ...
                                                        RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 6', 'Test content description 6', 'loggedin', 'http://www.sakaiproject.org/', [], [], function(err, contentObj) {
                                                            assert.ok(!err);
                                                            assert.ok(contentObj.contentId);
                                                            RestAPI.Content.createComment(anonymousRestContext, contentObj.contentId, 'This is an anonymous comment on a loggedin content item', null, function(err) {
                                                                assert.ok(err);
                                                                assert.equal(err.code, 401);
                                                                ...
                                                                RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 7', 'Test content description 7', 'loggedin', 'http://www.sakaiproject.org/', [], [], function(err, contentObj) {
                                                                    assert.ok(!err);
                                                                    assert.ok(contentObj.contentId);
                                                                    RestAPI.Content.createComment(contexts['nicolaas'].restContext, contentObj.contentId, 'This is Nico\'s comment on a public content item', null, function(err) {
                                                                        assert.ok(!err);
                                                                        ...
                                                                        RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 8', 'Test content description 8', 'loggedin', 'http://www.sakaiproject.org/', [], [], function(err, contentObj) {
                                                                            assert.ok(!err);
                                                                            assert.ok(contentObj.contentId);
                                                                            RestAPI.Content.createComment(anonymousRestContext, contentObj.contentId, 'This is an anonymous comment on a public content item', null, function(err) {
                                                                                assert.ok(err);
                                                                                assert.equal(err.code, 401);
                                                                                callback();
                                                                            });
