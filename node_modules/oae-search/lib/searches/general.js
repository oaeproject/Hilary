...
var _createQuery = function(ctx, opts) {
    ...
    if (hasContent) {
        ...
        query.bool.should.push(SearchUtil.createHasChildQuery(ContentConstants.search.MAPPING_CONTENT_BODY, SearchUtil.createQueryStringQuery(opts.q, ['content_body']), 'max'));
    }
