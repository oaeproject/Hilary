        ...
        it('verify index created content', function(callback) {
            ...
            RestAPI.User.createUser(camAdminRestContext, doerUsername, 'password', 'Doer', null, function(err, doer) {
                ...
                RestAPI.Content.createLink(doerRestContext, 'Sakai Foundation', 'Link to Sakai Foundation Website', 'public', 'http://www.sakaifoundation.org', [], [], function(err, content) {
                    ...
                    SearchTestsUtil.searchRefreshed(doerRestContext, 'general', null, {'resourceTypes': 'content', 'q': 'Sakai'}, function(err, results) {
                        assert.ok(!err);
    ...
    describe('General Search Parameters', function() {
        ...
        it('verifies a variety of valid and invalid values for the resourceTypes parameter', function(callback) {
            ...
            RestAPI.User.createUser(camAdminRestContext, uniqueString, 'password', uniqueString, null, function(err, user) {
                ...
                RestAPI.Group.createGroup(jackRestContext, uniqueString, uniqueString, uniqueString, 'public', 'no', [], [], function(err, group) {
                    assert.ok(!err);
    ...
    describe('Content Search', function() {
        ...
        it('verify deleted content unsearchable', function(callback) {
            ...
            RestAPI.User.createUser(camAdminRestContext, doerUsername, 'password', 'Doer', null, function(err, doer) {
                ...
                RestAPI.Content.createLink(doerRestContext, uniqueString, uniqueString, 'public', 'http://www.sakaifoundation.org', [], [], function(err, content) {
                    assert.ok(!err);
                            ...
                            TestsUtil.generateTestGroups(doerRestContext, 5, function(err, groups) {
                                ...
                                TestsUtil.generateGroupHierarchy(doerRestContext, groupIds, 'member', function(err) {
                                    ...
                                    TestsUtil.generateGroupHierarchy(doerRestContext, [groupIds[4], jack.id], 'member', function(err) {
                                        ...
                                        RestAPI.Content.createLink(doerRestContext, uniqueString, 'Test content description 1', 'public', 'http://www.sakaiproject.org/',  [], [groupIds[0]], function(err, contentObj) {
                                            assert.ok(!err);
                            ...
                            TestsUtil.generateTestGroups(doerRestContext, 5, function(err, groups) {
                                ...
                                TestsUtil.generateGroupHierarchy(doerRestContext, groupIds, 'member', function(err) {
                                    ...
                                    TestsUtil.generateGroupHierarchy(doerRestContext, [groupIds[4], jack.id], 'member', function(err) {
                                        ...
                                        RestAPI.Content.createLink(doerRestContext, uniqueString, 'Test content description 1', 'loggedin', 'http://www.sakaiproject.org/',  [], [groupIds[0]], function(err, contentObj) {
                                            assert.ok(!err);
                            ...
                            TestsUtil.generateTestGroups(doerRestContext, 5, function(err, groups) {
                                ...
                                TestsUtil.generateGroupHierarchy(doerRestContext, groupIds, 'member', function(err) {
                                    ...
                                    TestsUtil.generateGroupHierarchy(doerRestContext, [groupIds[4], jack.id], 'member', function(err) {
                                        ...
                                        RestAPI.Content.createLink(doerRestContext, uniqueString, 'Test content description 1', 'private', 'http://www.sakaiproject.org/',  [], [groupIds[0]], function(err, contentObj) {
                                            assert.ok(!err);
                ...
                RestAPI.User.createUser(gtAdminRestContext, sithUsername, 'password', 'Sithy Sitherson', null, function(err, sith) {
                    ...
                    RestAPI.User.createUser(camAdminRestContext, jackUsername, 'password', 'Jack McJackerson', null, function(err, jack) {
                        ...
                        RestAPI.User.createUser(camAdminRestContext, janeUsername, 'password', 'Janey McJaneFace', null, function(err, jane) {
                            ...
                            RestAPI.Group.createGroup(jackRestContext, groupAlias, groupAlias, uniqueString, 'public', 'no', [], [sith.id], function(err, group) {
                                assert.ok(!err);
                                ...
                                RestAPI.User.createUser(gtAdminRestContext, sithUsername, 'password', 'Sithy Sitherson', null, function(err, sith) {
                                    ...
                                    RestAPI.User.createUser(camAdminRestContext, jackUsername, 'password', 'Jack McJackerson', null, function(err, jack) {
                                        ...
                                        RestAPI.User.createUser(camAdminRestContext, janeUsername, 'password', 'Janey McJaneFace', null, function(err, jane) {
                                            ...
                                            // Create the group, including sith as a user
                                            RestAPI.Group.createGroup(jackRestContext, groupAlias, groupAlias, uniqueStringA, 'loggedin', 'no', [], [sith.id], function(err, group) {
                                                assert.ok(!err);

                                                // Create the joinable group, including sith as a user
                                                RestAPI.Group.createGroup(jackRestContext, groupAliasJoinable, groupAliasJoinable, uniqueStringB, 'loggedin', 'request', [], [sith.id], function(err, groupJoinable) {
                                                    assert.ok(!err);
        ...
        it('verify search indexing is not case-sensitive', function(callback) {
            ...
            RestAPI.User.createUser(camAdminRestContext, doerUsername, 'password', 'Doer', null, function(err, doer) {
                ...
                RestAPI.Content.createLink(doerRestContext, 'Sakai Xyzforedgengram', 'Link to Sakai Foundation Website', 'public', 'http://www.sakaifoundation.org', [], [], function(err, content) {
                    ...
                    // Search for just the first 3 characters to ensure it matches "Xyzforedgengram"
                    SearchTestsUtil.searchRefreshed(doerRestContext, 'general', null, {'q': 'sakai'}, function(err, results) {
                        assert.ok(!err);
                        assert.ok(_getDocById(results, content.id));
                        callback();
                    });
    ...
    describe('Search Options', function() {
        ...
        it('verify resourceType scope param', function(callback) {
            ...
            RestAPI.User.createUser(camAdminRestContext, jackUsername, 'password', 'Jack JickMackerson', null, function(err, jack) {
                ...
                RestAPI.Group.createGroup(camAdminRestContext, groupAlias, groupAlias, 'A group for Jack', 'public', 'no', [], [], function(err, group) {
                    assert.ok(!err);

                    RestAPI.Content.createLink(camAdminRestContext, 'Sakai Foundation', 'Link to Jack', 'public', 'http://www.sakaifoundation.org', [], [], function(err, content) {
                        assert.ok(!err);
        ...
        /**
         * Test that verifies that the limit parameter is both lower as upper bounded.
         */
        it('verify limit option has an upper bound', function(callback) {
            TestsUtil.generateTestUsers(camAdminRestContext, 35, function(err, users) {
                ...
                SearchTestsUtil.searchRefreshed(jackCtx, 'general', null, {'q': '', 'limit': 10}, function(err, results) {
                    assert.ok(!err);
