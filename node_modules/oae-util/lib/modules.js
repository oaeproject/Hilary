...
var bootstrapModules = module.exports.bootstrapModules = function(config, callback) {
    initAvailableModules(config, function(err, modules) {
        if (err) {
            return callback(err);
...
var bootstrapModulesInit = function(modules, config, callback) {
    ...
    var initModule = function() {
        if (currentModule === modules.length) {
            ...
            var path = __dirname + '/../../../node_modules/' + module + '/lib/init.js';
...
var bootstrapModulesRest = function(modules) {
    for (var m = 0; m < modules.length; m++) {
        var path = __dirname + '/../../../node_modules/' + modules[m] + '/lib/rest.js';
        var exists = fs.existsSync(path);
        if (exists) {
 ...
 */
var initAvailableModules = module.exports.initAvailableModules = function(config, callback) {
    IO.getFileListForFolder(__dirname + '/../../../node_modules', function(err, modules) {
        if (err) {
            return callback(err);
        }
