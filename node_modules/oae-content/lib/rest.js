...
OAE.tenantServer.post('/api/content/create', function(req, res) {
    ...
    // File creation
        ...
        ContentAPI.createFile(req.ctx, req.body.name, req.body.description, req.body.visibility, req.body.additionalMembers, uploadedFile, function(err, contentObj) {
            if (err) {
...
OAE.tenantServer.del('/api/content/:contentId/comments/:commentId', function(req, res) {
    ContentAPI.deleteComment(req.ctx, req.params.contentId, req.params.commentId, function(err, comment) {
        if (err) {
            return res.send(err.code, err.msg);
        }
