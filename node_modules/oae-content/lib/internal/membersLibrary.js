...
var log = require('oae-logger').logger('content-memberslibrary');
 ...
 * @param  {Object}     [callback.err]  An error that occurred, if any
 */
var insert = (module.exports.insert = function(
  contentItem,
  principals,
  callback,
) {
 ...
 * @param  {Object}     [callback.err]  An error that occurred, if any
 */
var remove = (module.exports.remove = function(
  contentItem,
  principalIds,
  callback,
) {
...
var _insert = function(contentItem, principals, callback) {
  var entries = _.map(principals, function(principal) {
    return {
      id: contentItem.id,
      resource: principal,
    };
