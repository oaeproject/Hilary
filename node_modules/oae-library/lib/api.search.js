 ...
 */
module.exports.registerLibrarySearch = function(
  searchName,
  resourceTypes,
  options,
) {
  ...
  options.getLibraryOwner =
    options.getLibraryOwner || PrincipalsDAO.getPrincipal;
  ...
  SearchAPI.registerSearch(searchName, function(ctx, opts, callback) {
    ...
    options.getLibraryOwner(opts.libraryOwnerId, function(err, libraryOwner) {
      ...
      LibraryAPI.Authz.resolveTargetLibraryAccess(
        ...
        libraryOwner,
        function(err, canAccess, visibility) {
          if (err) {
            return callback(err);
          } else if (!canAccess) {
            return callback({
          ...
          var filterFunction = _.isFunction(options.searches[visibility])
            ? options.searches[visibility]
            : _defaultLibraryFilter(
                resourceTypes,
                visibility,
                options.association,
              );
