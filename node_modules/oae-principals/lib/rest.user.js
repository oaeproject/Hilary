 ...
 * @BodyParam   {NewUser}           body            Information about the user to create
 * @Return      {User}                              Returns an object containing updated user profile
 */
 ...
 * @Method      POST
 * @Path        /user/import
 * @BodyParam   {UserImportInfo}    body            Information about users to import
 ...
 * @Path        /user/{id}
 * @PathParam   {string}        id                  The ID of the user
 * @BodyParam   {NewProfile}    body                New profile for user
