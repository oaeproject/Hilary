 ...
 * @param  {String}     visibility          The visibility of the library feed to fetch. Should be one of `AuthzConstants.visibility`'s values
 ...
 * @param  {String}         [profileFields.joinable]        New joinability setting for the group. Should be one of `AuthzConstants.joinable`'s values
 * @param  {Function}       callback                        Standard callback function
