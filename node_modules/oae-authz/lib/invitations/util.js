 ...
 */
var computeInvitationRolesAfterChanges = (module.exports.computeInvitationRolesAfterChanges = function(
  authzResourceId,
  changes,
  opts,
  callback,
  ...
  OaeUtil.invokeIfNecessary(
    ...
    function(err, invitations) {
      ...
      var invitationRolesBefore = _.chain(invitations)
        ...
        .value();
      var idChangeInfo = AuthzUtil.computeRoleChanges(
      ...
      return callback(
        null,
        AuthzModel.EmailChangeInfo.fromIdChangeInfo(idChangeInfo),
      );
    },
  );
});
