...
describe('Configuration', function() {
    ...
    describe('Internal Configuration API', function() {
        ...
        it('verify the last updated timestamp increases when updated', function(callback) {
            ...
            TestsUtil.createTenantWithAdmin(tenantAlias, host, function(err, tenant, tenantAdminRestContext) {
                assert.ok(!err);
                ...
                ConfigTestUtil.updateConfigAndWait(tenantAdminRestContext, null, {'oae-principals/recaptcha/enabled': true}, function(err) {
                    ...
                    let newRecaptchaUpdateTime = PrincipalsConfig.getLastUpdated(tenantAlias, 'recaptcha', 'enabled').getTime();
                    assert.ok(_.max([recaptchaUpdateTime, newRecaptchaUpdateTime]) === newRecaptchaUpdateTime);
                    return callback();
                });
            });
        });
