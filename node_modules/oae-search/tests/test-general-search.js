...
describe('General Search', function() {
            ...
            TestsUtil.generateTestUsers(camAdminRestContext, 1, function(err, users) {
                ...
                SearchTestsUtil.searchRefreshed(anonymousRestContext, 'general', null, {'resourceTypes': 'user', 'q': 'Visser'}, function(err, results) {
                    ...
                    var updateProperties = {
                        'displayName': 'Branden Visser' + mrvisser.user.id,
    ...
    describe('Group Indexing', function() {
        ...
        it('verify index created group', function(callback) {
            TestsUtil.generateTestGroups(camAdminRestContext, 1, function(err, groups) {
                ...
                SearchTestsUtil.searchRefreshed(anonymousRestContext, 'general', null, {'resourceTypes': 'group', 'q': oaeTeam.displayName}, function(err, results) {
                    assert.ok(!err);
        ...
        it('verify index updated group', function(callback) {
            ...
            RestAPI.User.createUser(camAdminRestContext, doerUsername, 'password', 'Doer', null, function(err, doer) {
                ...
                TestsUtil.generateTestGroups(doerRestContext, 1, function(err, groups) {
                    ...
                    SearchTestsUtil.searchRefreshed(doerRestContext, 'general', null, {'resourceTypes': 'group', 'q': xyzTeam.displayName}, function(err, results) {
                        assert.ok(!err);
                        ...
                        var displayName = 'Team testverifyindexupdatedgroup' + xyzTeam.id;
                        RestAPI.Group.updateGroup(doerRestContext, xyzTeam.id, {'displayName': displayName}, function(err) {
                            assert.ok(!err);
    ...
    describe('Content Search', function() {
        ...
        /**
         * Test that verifies that content searches on a permeable tenant only return results from that tenant
         * and other permeable tenants
         */
        it('verify content tenant separation', function(callback) {
            TestsUtil.setupMultiTenantPrivacyEntities(function(publicTenant, publicTenant1, privateTenant, privateTenant1) {

                // Create content on both tenants.
                var uniqueString = TestsUtil.generateTestUserId('content');
                RestAPI.Content.createLink(privateTenant.publicUser.restContext, uniqueString, uniqueString, 'public', 'http://www.oaeproject.org/',  [], [], function(err, contentOnPrivateTenant) {
                    assert.ok(!err);
                    RestAPI.Content.createLink(publicTenant.publicUser.restContext, uniqueString, uniqueString, 'public', 'http://www.oaeproject.org/',  [], [], function(err, contentOnPublicTenant) {
                        assert.ok(!err);

                        // Do some sanity checks first, to make sure the content items are indexed.
                        searchForResource(privateTenant.publicUser.restContext, contentOnPrivateTenant, true, function() {
                            searchForResource(publicTenant.publicUser.restContext, contentOnPublicTenant, true, function() {

                                // Users from private tenants cannot show up.
                                searchForResource(publicTenant.publicUser.restContext, contentOnPrivateTenant, false, function() {
                                    searchForResource(publicTenant.publicUser.restContext, contentOnPrivateTenant, false, function() {
                                        searchForResource(publicTenant.publicUser.restContext, contentOnPrivateTenant, false, function() {
                                            searchForResource(publicTenant.anonymousRestContext, contentOnPrivateTenant, false, function() {

                                                // When searching from the private tenant, users from other tenants cannot show up.
                                                searchForResource(privateTenant.publicUser.restContext, contentOnPublicTenant, false, function() {
                                                    searchForResource(privateTenant.publicUser.restContext, contentOnPublicTenant, false, function() {
                                                        searchForResource(privateTenant.publicUser.restContext, contentOnPublicTenant, false, function() {
                                                            searchForResource(privateTenant.anonymousRestContext, contentOnPublicTenant, false, function() {
                                                                callback();
                                                            });
                                                        });
                                                    });
    ...
    describe('User Search Visibility', function() {
        ...
        /**
         * Test that verifies that user searches on a permeable tenant only return results from that tenant
         * and other permeable tenants
         */
        it('verify user tenant separation', function(callback) {
            TestsUtil.setupMultiTenantPrivacyEntities(function(publicTenant, publicTenant1, privateTenant, privateTenant1) {

                // Do some sanity checks first, to make sure the users are indexed.
                searchForResource(privateTenant.publicUser.restContext, privateTenant.publicUser.user, true, function() {
                    searchForResource(publicTenant.publicUser.restContext, publicTenant.publicUser.user, true, function() {

                        // Users from private tenants cannot show up.
                        searchForResource(publicTenant.publicUser.restContext, privateTenant.publicUser.user, false, function() {
                            searchForResource(publicTenant.publicUser.restContext, privateTenant.loggedinUser.user, false, function() {
                                searchForResource(publicTenant.publicUser.restContext, privateTenant.privateUser.user, false, function() {
                                    searchForResource(publicTenant.anonymousRestContext, privateTenant.privateUser.user, false, function() {

                                        // When searching from the private tenant, users from other tenants cannot show up.
                                        searchForResource(privateTenant.publicUser.restContext, publicTenant.publicUser.user, false, function() {
                                            searchForResource(privateTenant.publicUser.restContext, publicTenant.loggedinUser.user, false, function() {
                                                searchForResource(privateTenant.publicUser.restContext, publicTenant.privateUser.user, false, function() {
                                                    searchForResource(privateTenant.anonymousRestContext, publicTenant.publicUser.user, false, function() {
                                                        callback();
                                                    });
                                                });
                                            });
    ...
    describe('Group Search Visibility', function() {
                                                                                    ...
                                                                                    SearchTestsUtil.searchRefreshed(lukeSkywalkerRestContext, 'general', null, {'resourceTypes': 'group', 'q': 'joinable', 'includeExternal': true}, function(err, results) {
                                                                                        ...
                                                                                        SearchTestsUtil.searchRefreshed(jackRestContext, 'general', null, {'resourceTypes': 'group', 'q': 'skywalker', 'includeExternal': true}, function(err, results) {
                                                                                            ...
                                                                                            SearchTestsUtil.searchRefreshed(globalAdminOnTenantRestContext, 'general', null, {'resourceTypes': 'group', 'q': 'skywalker', 'includeExternal': true}, function(err, results) {
                                                                                                ...
                                                                                                var groupDoc = _getDocById(results, privateTenantGroup.id);
                                                                                                assert.ok(groupDoc);
                                                                                                assert.equal(groupDoc.joinable, privateTenantGroup.joinable);
                                                                                                assert.equal(groupDoc.displayName, privateTenantGroup.displayName);
                                                                                                assert.equal(groupDoc.tenantAlias, privateTenantGroup.tenant.alias);
                                                                                                assert.equal(groupDoc.visibility, privateTenantGroup.visibility);
                                                                                                assert.equal(groupDoc.resourceType, privateTenantGroup.resourceType);
                                                                                                assert.equal(groupDoc.tenant.alias, privateTenantGroup.tenant.alias);
        ...
        /**
         * Test that verifies that group searches on a permeable tenant only return results from that tenant
         * and other permeable tenants
         */
        it('verify groups tenant separation', function(callback) {
            TestsUtil.setupMultiTenantPrivacyEntities(function(publicTenant, publicTenant1, privateTenant, privateTenant1) {
                ...
                searchForResource(privateTenant.publicUser.restContext, privateTenant.publicUser.user, true, function() {
                    searchForResource(publicTenant.publicUser.restContext, publicTenant.publicUser.user, true, function() {
                        ...
                        // Users from private tenants cannot show up.
                        searchForResource(publicTenant.publicUser.restContext, privateTenant.publicGroup, false, function() {
                            searchForResource(publicTenant.publicUser.restContext, privateTenant.loggedinGroup, false, function() {
                                searchForResource(publicTenant.publicUser.restContext, privateTenant.privateGroup, false, function() {
                                    searchForResource(publicTenant.anonymousRestContext, privateTenant.privateGroup, false, function() {

                                        // When searching from the private tenant, users from other tenants cannot show up.
                                        searchForResource(privateTenant.publicUser.restContext, publicTenant.publicGroup, false, function() {
                                            searchForResource(privateTenant.publicUser.restContext, publicTenant.loggedinGroup, false, function() {
                                                searchForResource(privateTenant.publicUser.restContext, publicTenant.privateGroup, false, function() {
                                                    searchForResource(privateTenant.anonymousRestContext, publicTenant.publicGroup, false, function() {
                                                        callback();
                                                    });
                                                });
                                            });
                ...
                RestAPI.Content.createLink(restCtx, 'Theological reasoning', null, 'public', 'http://www.apereo.org', [], [], function(err, contentA) {
                    ...
                    RestAPI.Content.createLink(restCtx, 'Independent workforce', null, 'public', 'http://www.apereo.org', [], [], function(err, contentB) {
                        ...
                        RestAPI.Group.createGroup(restCtx, groupDisplayName, 'A really awesome group', 'public', 'no', [], [], function(err, group) {
                            ...
                            SearchTestsUtil.searchRefreshed(restCtx, 'general', null, {'q': 'Team'}, function(err, results) {
                                assert.ok(!err);
    ...
    describe('Search Options', function() {
            ...
            RestAPI.User.createUser(camAdminRestContext, jackUsername, 'password', 'Jack JickMackerson', null, function(err, jack) {
                ...
                RestAPI.Group.createGroup(camAdminRestContext, group1Alias, 'A really awesome group', 'private', 'no', [], [jack.id], function(err, group1) {
                    ...
                    RestAPI.Group.createGroup(camAdminRestContext, group2Alias, 'A really awesome group', 'private', 'no', [], [group1.id], function(err, group2) {
                        ...
                        SearchTestsUtil.searchRefreshed(jackCtx, 'general', null, {'q': 'awesome'}, function(err, results) {
                            assert.ok(!err);
                            ...
                            SearchTestsUtil.searchRefreshed(jackCtx, 'general', null, {'q': 'awesome', 'includeIndirect': false}, function(err, results) {
                                assert.ok(!err);
        ...
        it('verify limit parameter validation', function(callback) {
            TestsUtil.generateTestUsers(camAdminRestContext, 35, function(err, users) {
                ...
                SearchTestsUtil.searchRefreshed(jackCtx, 'general', null, {'q': '', 'limit': 8}, function(err, results) {
                    assert.ok(!err);
                    assert.equal(results.results.length, 8);

                    // Verify that searches have an upper limit.
                    RestAPI.Search.search(jackCtx, 'general', null, {'q': '', 'limit': 1000}, function(err, results) {
                        assert.ok(!err);
                        assert.equal(results.results.length, 25);

                        // Verify that searches have a lower limit.
                        RestAPI.Search.search(jackCtx, 'general', null, {'q': '', 'limit': -1}, function(err, results) {
                            assert.ok(!err);
                            assert.equal(results.results.length, 1);

                            // Verify that searches have a lower limit.
                            RestAPI.Search.search(jackCtx, 'general', null, {'q': '', 'limit': 0}, function(err, results) {
                                assert.ok(!err);
                                assert.equal(results.results.length, 1);
                                callback();
                            });
