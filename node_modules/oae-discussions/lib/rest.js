 ...
 * @BodyParam   {Members}               body                Unique identifiers(s) for participant(s) in the discussion
 * @Return      {void}
 */
...
/**
 * @RESTModel NewDiscussion
 *
 * @Required    [description,displayName,visibility]
 * @Property    {string}        description         Description of discussion
 * @Property    {string}        displayName         Name to display for discussion
 * @Property    {string}        managers            Unique identifier(s) for manager(s) of the discussion (user creating discussion is always a manager)
 * @Property    {string}        members             Unique identifiers(s) for participant(s) in the discussion
 * @Property    {string}        visibility          Visibility for discussion           [loggedin,private,public]
 */

/**
 * @RESTModel UpdatedDiscussion
 *
 * @Required    [discussionId]
 * @Property    {string}        discussionId        Unique identifier for discusion to update
 * @Property    {string}        description         Description of discussion
 * @Property    {string}        displayName         Name to display for discussion
 * @Property    {string}        visibility          Visibility for discussion           [loggedin,private,public]
 */
