...
describe('Authentication', function() {
    ...
    it('Test local auth', function(callback) {
        ...
        TenantApi.getTenantByPort(2001, function(err, tenant) {
            ...
            PrincipalsAPI.createUser(ctx, username, 'password', 'public', 'en_GB', 'Europe/London', 'John', 'Doe', 'John Doe', function(err, userObj) {
                assert.ok(!err);
                ...
                request.post({
                    ...
                    request.get('http://localhost:2001/api/me', function(err, response, body) {
                        ...
                        assert.equal(userObj.id, data.userId);
    ...
    it('Test you cannot login with a user account from tenant A on tenant B', function(callback) {
        ...
        PrincipalsAPI.createUser(anonA, username, 'password', 'public', 'en_GB', 'Europe/London', 'John', 'Doe', 'John Doe', function(err, userObj) {
            assert.ok(!err);
