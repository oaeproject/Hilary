...
describe('User emails', function() {
  ...
  describe('Verification', function() {
    ...
    it('verify validation when verifying an email address', function(callback) {
      ...
      PrincipalsTestUtil.assertCreateUserSucceeds(restContext, params, function(
        user,
        token,
      ) {
    ...
    it('verify a token from another user cannot be used', function(callback) {
      ...
      var restContextUser1 = TestsUtil.createTenantRestContext(
        global.oaeTests.tenants.cam.host,
      );
      PrincipalsTestUtil.assertCreateUserSucceeds(
        restContextUser1,
        paramsUser1,
        function(user1, tokenUser1) {
          AuthenticationTestUtil.assertLocalLoginSucceeds(
            restContextUser1,
            ...
            function() {
              ...
              var restContextUser2 = TestsUtil.createTenantRestContext(
                global.oaeTests.tenants.cam.host,
              );
              PrincipalsTestUtil.assertCreateUserSucceeds(
                restContextUser2,
                paramsUser2,
                function(user2, tokenUser2) {
                  AuthenticationTestUtil.assertLocalLoginSucceeds(
                    restContextUser2,
              ...
              PrincipalsTestUtil.assertCreateUserSucceeds(
                ...
                function(user) {
                  ...
                  stopCollectingEmail(function(messages) {
                    ...
                    EmailTestsUtil.startCollectingEmail(function(
                      stopCollectingEmail,
                    ) {
                    ...
                    function() {
                      ...
                      PrincipalsTestUtil.assertUserEmailMappingEquals(
                        ...
                        function() {
                          ...
                          RestAPI.User.getMe(simong.restContext, function(
                            err,
                            me,
                          ) {
                            assert.ok(!err);
