 ...
 * @param   {String}        [opts.params[0]]        The resource type to search. One of: 'all', 'content', 'group', 'user' (Default: 'all');
...
module.exports = function(ctx, opts, callback) {
    // Sanitize the search options required by general search
    opts = opts || {};
    opts.resourceType = SearchUtil.getResourceTypeParam(opts.params[0]);
