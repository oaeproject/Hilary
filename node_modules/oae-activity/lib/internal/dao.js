...
var saveAggregatedEntities = module.exports.saveAggregatedEntities = function(aggregates, callback) {
    ...
    aggregateKeys.forEach(function(aggregateKey) {
        ...
        _appendAggregatedEntityQueries(aggregate, 'actors', queries);
        _appendAggregatedEntityQueries(aggregate, 'objects', queries);
        _appendAggregatedEntityQueries(aggregate, 'targets', queries);
    });
 ...
 */
var _appendAggregatedEntityQueries = function(aggregate, entityType, queries) {
    var sets = [];
    var params = [];
