...
OAE.tenantRouter.on('post', '/api/content/create', function(req, res) {
    ...
    console.log('/api/content/create');
...
var _createContent = function(ctx, resourceSubType, displayName, description, visibility, link, uploadedFile, additionalMembers, folderIds, callback) {
    ...
    } else if (resourceSubType === 'doodle') {
        return ContentAPI.createDoodle(ctx, displayName, description, visibility, additionalMembers, folderIds, callback);

    // Not a recognized file type
    } else {
        return callback({'code': 400, 'msg': 'Unrecognized resourceSubType. Accepted values are "link", "file", "collabdoc" and "doodle"'});
    }
};
...
OAE.tenantRouter.on('post', '/api/content/:contentId/members', function(req, res) {
    ...
    console.log('/api/content/:contentId/members');
