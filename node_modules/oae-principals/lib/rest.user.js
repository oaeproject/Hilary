...
OAE.tenantServer.post('/api/user/create', function(req, res) {
    ...
    var needsReCaptcha = PrincipalsConfig.getConfigValue(req.ctx, 'recaptcha', 'enabled');
    ...
    recaptcha.checkAnswer(PrincipalsConfig.getConfigValue(req.ctx, 'recaptcha', 'privateKey'), req.connection.remoteAddress, req.body.recaptchaChallenge, req.body.recaptchaResponse);
});
