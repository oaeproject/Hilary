 ...
 * @param  {String}     key               Path to file on S3
 * @param  {Function}   callback          Standard callback function
 * @param  {Object}     callback.err      An error that occurred, if any
 * @param  {String}     callback.url      A signed S3 URL for a video preview
 */
var getSignedVideoUrl = module.exports.getSignedVideoUrl = function(ctx, key, callback) {
    if (!key) {
        return callback();
    }
