 ...
 * @param  {String}     userId          The id of the user whose email address should be marked as verified
 * @param  {Function}   callback        Standard callback function
 * @param  {Object}     callback.err    An error object, if any
 */
var validateToken = module.exports.validateToken = function(token, userId, callback) {
    var queries = [];
    ...
    queries.push(Cassandra.constructUpsertCQL('Principals', 'principalId', userId, {'emailVerified': true}));
