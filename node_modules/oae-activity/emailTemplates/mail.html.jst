<%
    ...
    var renderHeader = function() {
        ...
        greeting = util.url.ensureAbsoluteLinks(greeting, baseUrl);
...
<%
    ...
    var renderPreviewTile = function(entity, wide) {
        ...
        if (entity.resourceType === 'user' && entity.visibility === 'private') {
            ...
            str += '<a href="' + util.url.ensureAbsoluteLink(entity.profilePath, baseUrl) + '" title="' + util.html.encodeForHTMLAttribute(entity.displayName) + '" target="_blank">';
        }
        ...
        if (entity.resourceType === 'user' && entity.visibility === 'private') {
            ...
            str += '                                <a href="' + util.url.ensureAbsoluteLink(entity.profilePath, baseUrl) + '" title="' + util.html.encodeForHTMLAttribute(entity.displayName) + '" target="_blank" class="preview-tile-title wrapped">' + title + '</a>';
        }
        str += '                                </h3></td>';
        if (entity.resourceType !== 'user') {
            str += '                            <td><img src="' + util.url.ensureAbsoluteLink(icon, baseUrl) + '" alt="' + i18nVisibility + '" class="preview-tile-metadata-visibility" /></td>';
        }
        str += '                            </tr>';
        str += '                            <tr>';
