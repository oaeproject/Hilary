    ...
    retriever.getImage(ctx, url, function(err, path, opts) {
        ...
        PreviewImages.resizeImages(ctx, path, sizes, function(err) {
            ...
            PreviewImages.cropThumbnail(ctx, path, function(err) {
                ...
                var params = {};
                opts = opts || {};
                if (opts.displayName && ctx.content.displayName === url && typeof opts.displayName === 'string') {
                    params.displayName = ent.decode(opts.displayName);
                }
                if (opts.description && !ctx.content.description && typeof opts.description === 'string') {
                    params.description = ent.decode(opts.description);
                }
