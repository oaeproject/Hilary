    ...
    _getUserIdFromLoginId(loginId, function(err, userId) {
        if (err && err.code !== 404) {
            ...
            OaeUtil.invokeIfNecessary(opts.invitationToken, AuthzInvitationsDAO.getEmailByToken, opts.invitationToken, function(err, email) {
                ...
                OaeUtil.invokeIfNecessary(shouldCheckEmail, validateEmailBelongsToTenant, ctx, opts.email, function(err) {
                    if (err) {
                        return callback(err);
                    }
 ...
 * @api private
 */
var validateEmailBelongsToTenant = function(ctx, email, callback) {
