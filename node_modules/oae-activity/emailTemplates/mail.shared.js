 ...
 */
var getEmailSubject = module.exports.getEmailSubject = function(util, recipient, activities) {
 ...
 */
var getEmailSummary = module.exports.getEmailSummary = function(util, recipient, activities, baseUrl) {
    var emailPreference = recipient.emailPreference;
    if (emailPreference === 'immediate') {
...
var _getAllEntities = function(activities, entityType) {
    ...
    _.each(activities, function(activity) {
        ...
        if (entity.objectType === 'collection') {
            _.each(entity[ActivityConstants.properties.OAE_COLLECTION], function(entity) {
