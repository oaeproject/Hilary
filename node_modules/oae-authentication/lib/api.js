        ...
        if (err && err.code !== 404) {
            ...
            if (opts.email) {
                PrincipalsDAO.getUserByEmail(opts.email, function(err, user) {
                    ...
                    // At this point, we found a user with the given email address. If this
                    // user is trying to create an account from a source we don't trust, we
                    // bail out of the user creation process
