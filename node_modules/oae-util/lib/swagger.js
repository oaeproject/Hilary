...
var documentModule = module.exports.documentModule = function(moduleName, callback) {
    ...
    var complete = _.after(dirsToProcess.length, callback);
    _.each(dirsToProcess, function(dir) {
        var files = [];
        readdirp({'root': util.format('node_modules/%s/%s', moduleName, dir), 'fileFilter': '*.js'})
            ...
            .on('error', function(err) {
                ...
                var done = _.after(files.length, complete);
