                                                                                    ...
                                                                                    AuthzAPI.getAllRoles(contexts['nicolaas'].user.id, contentObj.id, function(err, roles) {
                                                                                        ...
                                                                                        AuthzAPI.getAllRoles(contexts['ian'].user.id, contentObj.id, function(err, roles) {
                                                                                            ...
                                                                                            AuthzAPI.getAllRoles(contexts['anthony'].user.id, contentObj.id, function(err, roles) {
                                                                                                ...
                                                                                                return ContentTestUtil.assertGetContentMembersFails(contexts['nicolaas'].restContext, contentObj.id, null, null, 401, callback);
                                                                                            });
                                                                                        });
                                                                                    });
                                                                                });
        ...
        var setUpContentPermissions = function(contexts, privacy, callback) {
            ...
            RestAPI.Content.createLink(contexts['nicolaas'].restContext, 'Test Content 1', 'Test content description 1', privacy, 'http://www.oaeproject.org/', [], [], function(err, contentObj) {
                ...
                checkPieceOfContent(contexts['nicolaas'].restContext, contexts['nicolaas'].user.id, contentObj, true, true, true, true, function() {
                    ...
                    ContentTestUtil.assertGetContentMembersSucceeds(contexts['nicolaas'].restContext, contentObj.id, null, null, function(members) {
                        assert.ok(!err);
                        ...
                        ContentTestUtil.assertUpdateContentMembersFails(contexts['nicolaas'].restContext, contexts['nicolaas'].restContext, contentObj.id, {}, 400, function() {

                            // Make another user manager of the content
                            var permissions = {};
                            permissions[contexts['simon'].user.id] = 'manager';
                            ContentTestUtil.assertUpdateContentMembersSucceeds(contexts['nicolaas'].restContext, contexts['nicolaas'].restContext, contentObj.id, permissions, function(err) {
                                assert.ok(!err);
