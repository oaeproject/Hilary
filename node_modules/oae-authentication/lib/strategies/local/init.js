...
module.exports = function(config) {
  ...
  strategy.getPassportStrategy = function(tenant) {
    var passportStrategy = new LocalStrategy(
      ...
      function(req, username, password, done) {
        ...
        AuthenticationAPI.checkPassword(
          tenant.alias,
          username,
          password,
          function(err, userId) {
  ...
  var adminLocalPassportStrategyName = AuthenticationUtil.getStrategyId(
    globalTenant,
    AuthenticationConstants.providers.LOCAL,
  );
  passport.use(
    adminLocalPassportStrategyName,
    strategy.getPassportStrategy(globalTenant),
  );
};
