...
describe('Principals Delete and Restore', function() {
    ...
    describe('Registration', function() {
        ...
        it('verify registering multiple delete and restore handlers with the same name results in an exception', function(callback) {
            ...
            PrincipalsDelete.registerGroupDeleteHandler('test-throws', function(group, membershipsGraph, membersGraph, callback) { return callback(); });
            PrincipalsDelete.registerGroupRestoreHandler('test-throws', function(group, membershipsGraph, membersGraph, callback) { return callback(); });
            ...
            TestsUtil.generateTestUsers(camAdminRestContext, 1, function(err, users, manager) {
                TestsUtil.generateTestGroups(manager.restContext, 1, function(group) {
                    PrincipalsTestUtil.assertDeleteGroupSucceeds(camAdminRestContext, manager.restContext, group.group.id, function() {
                        ...
                        PrincipalsTestUtil.assertGetGroupMembersFails(camAdminRestContext, group.group.id, null, null, 404, function() {
                            PrincipalsTestUtil.assertGetGroupMembersFails(manager.restContext, group.group.id, null, null, 404, function() {

                                // Restore the group
                                PrincipalsTestUtil.assertRestoreGroupSucceeds(camAdminRestContext, camAdminRestContext, group.group.id, function() {

                                    // Ensure the members list is as expected from before it was deleted
                                    PrincipalsTestUtil.assertGroupMembersEquals(manager.restContext, group.group.id, [manager.user.id], function(members) {
                                        return callback();
                                    });
                                });
                            });
        ...
        it('verify deleting and restoring groups removes and restores access to updating group members', function(callback) {
            ...
            TestsUtil.generateTestUsers(camAdminRestContext, 2, function(err, users, manager, member) {
                TestsUtil.generateTestGroups(manager.restContext, 2, function(childGroup, parentGroup) {
                    ...
                    PrincipalsTestUtil.assertSetGroupMembersSucceeds(manager.restContext, parentGroup.group.id, permissionChanges, function() {
                        ...
                        PrincipalsTestUtil.assertDeleteGroupSucceeds(camAdminRestContext, manager.restContext, parentGroup.group.id, function() {
                            ...
                            PrincipalsTestUtil.assertSetGroupMembersFails(camAdminRestContext, parentGroup.group.id, permissionChanges, 404, function() {
                                PrincipalsTestUtil.assertSetGroupMembersFails(manager.restContext, parentGroup.group.id, permissionChanges, 404, function() {
                                    ...
                                    PrincipalsTestUtil.assertRestoreGroupSucceeds(camAdminRestContext, camAdminRestContext, parentGroup.group.id, function() {
                                        ...
                                        PrincipalsTestUtil.assertSetGroupMembersSucceeds(manager.restContext, parentGroup.group.id, permissionChanges, function(members) {
                                            return callback();
                                        });
                                    });
                                });
    ...
    describe('Memberships', function() {
        ...
        it('verify deleting a group removes indirect memberships from memberships library', function(callback) {
                ...
                TestsUtil.generateTestGroups(manager.restContext, 2, function(childGroup, parentGroup) {
                    TestsUtil.generateGroupHierarchy(manager.restContext, [parentGroup.group.id, childGroup.group.id], 'member', function() {
                        PrincipalsTestUtil.assertDeleteGroupSucceeds(camAdminRestContext, manager.restContext, childGroup.group.id, function() {
                            ...
                            // indication that it is deleted
                            PrincipalsTestUtil.assertGroupMembersEquals(manager.restContext, parentGroup.group.id, [manager.user.id, childGroup.group.id], function(members) {
            ...
            it('verify deleting and restoring a group removes and adds access to its members search', function(callback) {
                ...
                TestsUtil.generateTestUsers(camAdminRestContext, 1, function(err, users, manager) {
                    TestsUtil.generateTestGroups(manager.restContext, 1, function(group) {
                        ...
                        // Ensure the memberships library can be searched
                        SearchTestUtil.assertSearchContains(manager.restContext, 'members', [group.group.id], null, [manager.user.id], function(response) {

                            // Delete the group
                            PrincipalsTestUtil.assertDeleteGroupSucceeds(camAdminRestContext, manager.restContext, group.group.id, function() {

                                // Ensure the memberships search now results in a 404
                                SearchTestUtil.assertSearchFails(manager.restContext, 'members', [group.group.id], null, 404, function() {
            ...
            it('verify deleting and restoring a group results in it still showing up in members search with a deletion indication', function(callback) {
                ...
                TestsUtil.generateTestUsers(camAdminRestContext, 2, function(err, users, manager, member) {
                    TestsUtil.generateTestGroups(manager.restContext, 4, function(parentGroup, childGroup1, childGroup2, childGroup3) {
                        ...
                        PrincipalsTestUtil.assertSetGroupMembersSucceeds(manager.restContext, parentGroup.group.id, roleChanges, function() {

                            // Ensure we see all the groups in members search
                            SearchTestUtil.assertSearchContains(manager.restContext, 'members', [parentGroup.group.id], null, memberIds, function(response) {
                                ...
                                PrincipalsTestUtil.assertDeleteGroupSucceeds(camAdminRestContext, manager.restContext, childGroup1.group.id, function() {
                                    SearchTestUtil.assertSearchContains(manager.restContext, 'members', [parentGroup.group.id], null, memberIds, function(response) {
                                        ...
                                        // Ensure the document that represents the deleted group indicates it is deleted
                    ...
                    SearchTestUtil.assertSearchFails(publicTenant1.anonymousRestContext, 'deleted', null, null, 401, function() {
                        SearchTestUtil.assertSearchFails(publicTenant1.publicUser.restContext, 'deleted', null, null, 401, function() {
                            ...
                            SearchTestUtil.assertSearchSucceeds(publicTenant1.adminRestContext, 'deleted', null, null, function(response) {
                                SearchTestUtil.assertSearchSucceeds(globalAdminOnTenantRestContext, 'deleted', null, null, function(response) {
                ...
                TestsUtil.setupMultiTenantPrivacyEntities(function(publicTenant1, publicTenant2) {
                    ...
                    PrincipalsTestUtil.assertUpdateGroupsSucceeds(publicTenant1.adminRestContext, tenant1GroupIds, {'description': description}, function(tenant1GroupsUpdated) {
                        PrincipalsTestUtil.assertUpdateGroupsSucceeds(publicTenant2.adminRestContext, tenant2GroupIds, {'description': description}, function(tenant2GroupsUpdated) {
                            ...
                            // Delete the groups in both of our tenants, LOL!!!
                            PrincipalsTestUtil.assertDeleteGroupsSucceeds(publicTenant1.adminRestContext, publicTenant1.adminRestContext, tenant1GroupIds, function() {
                                PrincipalsTestUtil.assertDeleteGroupsSucceeds(publicTenant2.adminRestContext, publicTenant2.adminRestContext, tenant2GroupIds, function() {
                                    ...
                                    // Ensure global admin can search all tenants together with _all/default scope
                                    SearchTestUtil.assertSearchContains(globalAdminRestContext, 'deleted', null, {'q': description}, allGroupIds, function() {
                                        SearchTestUtil.assertSearchContains(globalAdminRestContext, 'deleted', null, {'q': description, 'scope': '_all'}, allGroupIds, function() {
                                            ...
                                            // Ensure global admin can search tenant1 and tenant2 alone using scope
                        ...
                        PrincipalsTestUtil.assertUpdateGroupsSucceeds(publicTenant2.adminRestContext, tenant2GroupIds, {'description': description}, function(tenant2GroupsUpdated) {
                            ...
                            PrincipalsTestUtil.assertDeleteGroupsSucceeds(publicTenant1.adminRestContext, publicTenant1.adminRestContext, tenant1GroupIds, function() {
                                PrincipalsTestUtil.assertDeleteGroupsSucceeds(publicTenant2.adminRestContext, publicTenant2.adminRestContext, tenant2GroupIds, function() {
                                    ...
                                    // Ensure that scope is ignored for tenant1 admin, they can only search deleted resources for tenant1
                                    SearchTestUtil.assertSearchContains(publicTenant1.adminRestContext, 'deleted', null, {'q': description}, tenant1GroupIds, function() {
                                        SearchTestUtil.assertSearchNotContains(publicTenant1.adminRestContext, 'deleted', null, {'q': description}, tenant2GroupIds, function() {
                                            SearchTestUtil.assertSearchContains(publicTenant1.adminRestContext, 'deleted', null, {'q': description, 'scope': '_all'}, tenant1GroupIds, function() {
                                                SearchTestUtil.assertSearchNotContains(publicTenant1.adminRestContext, 'deleted', null, {'q': description, 'scope': '_all'}, tenant2GroupIds, function() {
                                                    SearchTestUtil.assertSearchContains(publicTenant1.adminRestContext, 'deleted', null, {'q': description, 'scope': publicTenant2.tenant.alias}, tenant1GroupIds, function() {
                                                        SearchTestUtil.assertSearchNotContains(publicTenant1.adminRestContext, 'deleted', null, {'q': description, 'scope': publicTenant2.tenant.alias}, tenant2GroupIds, function() {

                                                            // Ensure that scope is ignored for tenant2 admin, they can only search deleted resources for tenant2
                                                            SearchTestUtil.assertSearchContains(publicTenant2.adminRestContext, 'deleted', null, {'q': description}, tenant2GroupIds, function() {
                                                                SearchTestUtil.assertSearchNotContains(publicTenant2.adminRestContext, 'deleted', null, {'q': description}, tenant1GroupIds, function() {
                                                                    SearchTestUtil.assertSearchContains(publicTenant2.adminRestContext, 'deleted', null, {'q': description, 'scope': '_all'}, tenant2GroupIds, function() {
                                                                        SearchTestUtil.assertSearchNotContains(publicTenant2.adminRestContext, 'deleted', null, {'q': description, 'scope': '_all'}, tenant1GroupIds, function() {
                                                                            SearchTestUtil.assertSearchContains(publicTenant2.adminRestContext, 'deleted', null, {'q': description, 'scope': publicTenant1.tenant.alias}, tenant2GroupIds, function() {
                                                                                SearchTestUtil.assertSearchNotContains(publicTenant2.adminRestContext, 'deleted', null, {'q': description, 'scope': publicTenant1.tenant.alias}, tenant1GroupIds, function() {
                                                                                    return callback();
                                                                                });
                                                                            });
                                                                        });
