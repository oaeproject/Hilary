...
var createDiscussion = module.exports.createDiscussion = function(ctx, displayName, description, visibility, members, opts, callback) {
    ...
    validator.check(displayName, {'code': 400, 'msg': 'Must provide a displayName for the discussion'}).isShortString();
    if (description) {
        validator.check(description, {'code': 400, 'msg': 'A description can be at most a medium-sized string'}).isMediumString();
    }
...
var updateDiscussion = module.exports.updateDiscussion = function(ctx, discussionId, profileFields, callback) {
    ...
    _.each(profileFields, function(value, field) {
        ...
        if (field === 'visibility') {
            ...
            validator.check(value, {'code': 400, 'msg': 'A displayName can be at most a short-sized string'}).isShortString();
        } else if (field === 'description') {
            validator.check(value, {'code': 400, 'msg': 'A description can be at most a medium-sized string'}).isMediumString();
        }
    });
...
var createMessage = module.exports.createMessage = function(ctx, discussionId, body, replyToCreatedTimestamp, callback) {
    ...
    validator.check(body, {'code': 400, 'msg': 'A discussion body must be provided and can at most a long string.'}).isLongString();
