            ...
            request.get({
                ...
                for (module in modules) {
                    if (module === 'oae-authentication') {
                        if (modules[module]['twitter']) {
                            for (var el in modules[module]['twitter'].elements) {
                                if (el === 'enabled') {
                                    if (modules[module]['twitter'].elements[el].defaultValue === false) {
                                        val = modules[module]['twitter'].elements[el].defaultValue;
                                    }
                                }
                            }
                        }
                ...
                for (module in modules) {
                    if (module === 'oae-authentication') {
                        if (modules[module]['twitter']) {
                            for (var el in modules[module]['twitter'].elements) {
                                if (el === 'enabled') {
                                    if (modules[module]['twitter'].elements[el].defaultValue === true) {
                                        val = modules[module]['twitter'].elements[el].defaultValue;
                                    }
                                }
                            }
