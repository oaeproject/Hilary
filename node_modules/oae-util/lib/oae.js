...
module.exports.init = function(config, callback) {
    ...
    server.configure(function() {
        ...
        server.use(express.session({ secret: 'this secret is so secret that its totally secret', store: new CassandraStore(), 'tenant': serverTenant.alias}));
...
var _bootstrap = function(app, callback) {
    getAvailableModules(function(modules) {
        if (modules.length) {
            console.log('Starting modules: %s', modules.join(', '));
