...
describe('Profiles', function() {
    ...
    describe('Profile section visibility', function() {
        ...
        /**
         * Test that verifies that profiles sections of a private user are only accessible to the user and admin. Also verifies that the
         * user themself and the admin user can see the profile.
         */
