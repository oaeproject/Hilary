...
describe('Loodle create', function () {
    ...
    describe('create a loodle in a group', function () {
        ...
        it('should be accessible for all the users who are part of the group');

        it('should be accessible for all the users who have been explicitly invated and the user who created the loodle');

        it('should have the users who have been explicitly invated, the user who created the loodle and the group users as participants');
