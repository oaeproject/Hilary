                ...
                RestAPI.Tenants.getTenant(camAdminRestContext, null, function(err, tenant) {
                    ...
                    RestAPI.Tenants.updateTenant(camAdminRestContext, null, {'displayName': 'Queens College'}, function(err) {
                        ...
                        RestAPI.Tenants.getTenant(camAdminRestContext, null, function(err, tenant) {
                            ...
                            RestAPI.Tenants.updateTenant(globalAdminRestContext, 'camtest', {'host': 'oxford.oae.com'}, function(err) {
                                assert.ok(!err);
                                ...
                                RestAPI.Tenants.getTenant(camAdminRestContext, null, function(err, tenant) {
                                    ...
                                    var oxfordCamAdminRestContext = TestsUtil.createTenantAdminRestContext('oxford.oae.com');
                                    RestAPI.Tenants.getTenant(oxfordCamAdminRestContext, null, function(err, tenant) {
                                        assert.ok(!err);
                                        assert.ok(tenant);
                                        assert.equal(tenant.alias, 'camtest');
                                        assert.equal(tenant.host, 'oxford.oae.com');
                                        assert.equal(tenant.displayName, 'Queens College');
