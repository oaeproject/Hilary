...
describe('Content Activity', function() {
    ...
    before(function(callback) {
        ...
        suitable_files = {
            ...
            'thumbnail.png': getFunctionThatReturnsFileStream('sakai-logo.png'),
            'wide.png': getFunctionThatReturnsFileStream('sakaiger.png')
        };
        suitable_sizes = {
    ...
    describe('Posting Activities', function() {
        ...
        it('verify a content-revision activity is generated when a content item\'s body has been updated', function(callback) {
            ...
            RestAPI.User.createUser(camAdminRestContext, jackUsername, 'password', 'Jack McJackerson', null, function(err, jack) {
                ...
                RestAPI.Content.createFile(jackCtx, 'Test Content 1', 'Test content description 1', 'private', getFunctionThatReturnsFileStream('sakaiger.png'),  [], [], function(err, content) {
                    assert.ok(!err);
                    assert.ok(content);
