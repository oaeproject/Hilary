 ...
 */
var generateTestFolders = (module.exports.generateTestFolders = function(
  restContext,
  numFolders,
  callback,
  _folders,
 ...
 * @throws {AssertionError}                         Thrown if an error occurred generating the folders
 */
var generateTestFoldersWithVisibility = (module.exports.generateTestFoldersWithVisibility = function(
  restContext,
  numFolders,
  visibility,
  callback,
 ...
 */
var setupMultiTenantPrivacyEntities = (module.exports.setupMultiTenantPrivacyEntities = function(
  callback,
) {
  // Base the folders privacy setup on content. We then create folders to go along with them
  ContentTestUtil.setupMultiTenantPrivacyEntities(function(
    publicTenant,
    publicTenant1,
    privateTenant,
    privateTenant1,
 ...
 */
var assertAddContentItemsToFolderSucceeds = (module.exports.assertAddContentItemsToFolderSucceeds = function(
  restContext,
  folderId,
  contentIds,
  callback,
 ...
 */
var assertAddContentItemsToFolderFails = (module.exports.assertAddContentItemsToFolderFails = function(
  restContext,
  folderId,
  contentIds,
  httpCode,
 ...
 */
var assertAddContentItemToFoldersSucceeds = (module.exports.assertAddContentItemToFoldersSucceeds = function(
  restContext,
  folderIds,
  contentId,
  callback,
  ...
  assertAddContentItemsToFolderSucceeds(
    ...
    function() {
      ...
      return assertAddContentItemToFoldersSucceeds(
        restContext,
        folderIds,
        contentId,
        callback,
 ...
 */
var assertRemoveContentItemsFromFolderSucceeds = (module.exports.assertRemoveContentItemsFromFolderSucceeds = function(
  restContext,
  folderId,
  contentIds,
  callback,
  ...
  getAllFolderContentItems(restContext, folderId, null, function(
    ...
    RestAPI.Folders.removeContentItemsFromFolder(
      restContext,
      folderId,
      contentIds,
      function(err) {
 ...
 * @throws {AssertionError}                     Thrown if the request did not fail in the expected manner
 */
var assertRemoveContentItemsFromFolderFails = (module.exports.assertRemoveContentItemsFromFolderFails = function(
  restContext,
  folderId,
  contentIds,
  httpCode,
 ...
 * @throws {AssertionError}                     Thrown if the request did not fail in the expected manner
 */
var assertCreateFolderFails = (module.exports.assertCreateFolderFails = function(
  restContext,
  displayName,
  description,
  visibility,
 ...
 */
var assertCreateFolderSucceeds = (module.exports.assertCreateFolderSucceeds = function(
  restContext,
  displayName,
  description,
  visibility,
  ...
  _getAllFoldersInLibraries(allMemberInfos, function(
    principalFoldersLibrariesBeforeCreate,
  ) {
    // Create the folder
    RestAPI.Folders.createFolder(
      restContext,
      ...
      function(err, createdFolder) {
        ...
        RestAPI.User.getMe(restContext, function(err, me) {
          ...
          PrincipalsAPI.canManageAny(ctx, managerIds, function(err, canManage) {
            ...
            getAllFolderMembers(restContext, createdFolder.id, null, function(
              membersAfterCreate,
            ) {
              ...
              AuthzTestUtil.assertGetInvitationsSucceeds(
                ...
                function(result) {
                  ...
                  _getAllFoldersInLibraries(allMemberInfos, function(
                    ...
                    var allMemberInfoIds = _.chain(allMemberInfos)
                      .pluck('profile')
                      .pluck('id')
                      .value();
 ...
 * @throws {AssertionError}                     Thrown if the request did not fail in the expected manner
 */
var assertGetFolderFails = (module.exports.assertGetFolderFails = function(
  restContext,
  folderId,
  httpCode,
  callback,
 ...
 */
var assertGetFolderSucceeds = (module.exports.assertGetFolderSucceeds = function(
  restContext,
  folderId,
  callback,
) {
 ...
 * @throws {AssertionError}                         Thrown if the request did not fail in the expected manner
 */
var assertUpdateFolderSucceeds = (module.exports.assertUpdateFolderSucceeds = function(
  restContext,
  folderId,
  updates,
  callback,
) {
  RestAPI.Folders.updateFolder(restContext, folderId, updates, function(
    err,
    folder,
  ) {
    assert.ok(!err);
 ...
 * @throws {AssertionError}                     Thrown if the request did not fail in the expected manner
 */
var assertUpdateFolderFails = (module.exports.assertUpdateFolderFails = function(
  restContext,
  folderId,
  updates,
  httpCode,
 ...
 * @throws {AssertionError}                     Thrown if the request did not fail in the expected manner
 */
var assertUpdateFolderContentVisibilityFails = (module.exports.assertUpdateFolderContentVisibilityFails = function(
  restContext,
  folderId,
  visibility,
  httpCode,
 ...
 * @throws {AssertionError}                     Thrown if the request did not fail in the expected manner
 */
var assertDeleteFolderFails = (module.exports.assertDeleteFolderFails = function(
  restContext,
  folderId,
  httpCode,
  callback,
 ...
 */
var assertDeleteFolderSucceeds = (module.exports.assertDeleteFolderSucceeds = function(
  restContext,
  folderId,
  deleteContent,
  callback,
) {
  RestAPI.Folders.deleteFolder(restContext, folderId, deleteContent, function(
    err,
  ) {
    assert.ok(!err);
 ...
 * @throws {AssertionError}                     Thrown if the request did not fail in the expected manner
 */
var assertGetFolderContentLibraryFails = (module.exports.assertGetFolderContentLibraryFails = function(
  restContext,
  folderId,
  start,
  limit,
  ...
  RestAPI.Folders.getFolderContentLibrary(
    restContext,
    folderId,
    start,
    limit,
 ...
 * @throws {AssertionError}                         Thrown if the request did not succeed
 */
var assertGetFolderContentLibrarySucceeds = (module.exports.assertGetFolderContentLibrarySucceeds = function(
  restContext,
  folderId,
  start,
  limit,
 ...
 */
var assertFolderEquals = (module.exports.assertFolderEquals = function(
  restContext,
  folderId,
  contentIds,
  callback,
 ...
 * @throws {AssertionError}                     Thrown if the request did not fail in the expected manner
 */
var assertGetFolderMembersFails = (module.exports.assertGetFolderMembersFails = function(
  restContext,
  folderId,
  start,
  limit,
  ...
  RestAPI.Folders.getFolderMembers(
    restContext,
    folderId,
    start,
    limit,
...
var assertGetAllFolderMembersSucceeds = (module.exports.assertGetAllFolderMembersSucceeds = function(
  restContext,
  folderId,
  opts,
  callback,
 ...
 * @throws {AssertionError}                         Thrown if the request did not succeed
 */
var assertGetFolderMembersSucceeds = (module.exports.assertGetFolderMembersSucceeds = function(
  restContext,
  folderId,
  start,
  limit,
...
var assertGetAllFoldersLibrarySucceeds = (module.exports.assertGetAllFoldersLibrarySucceeds = function(
  restContext,
  principalId,
  opts,
  callback,
 ...
 * @throws {AssertionError}                         Thrown if the request did not succeed
 */
var assertGetFoldersLibrarySucceeds = (module.exports.assertGetFoldersLibrarySucceeds = function(
  restContext,
  principalId,
  start,
  limit,
  ...
  RestAPI.Folders.getFoldersLibrary(
    restContext,
    principalId,
    start,
    limit,
 ...
 * @throws {AssertionError}                         Thrown if the request did not fail in the expected manner
 */
var assertGetFoldersLibraryFails = (module.exports.assertGetFoldersLibraryFails = function(
  restContext,
  principalId,
  start,
  limit,
 ...
 * @throws {AssertionError}                         Thrown if the request did not fail in the expected manner
 */
var assertRemoveFolderFromLibraryFails = (module.exports.assertRemoveFolderFromLibraryFails = function(
  restContext,
  principalId,
  folderId,
  httpCode,
  ...
  RestAPI.Folders.removeFolderFromLibrary(
    restContext,
    principalId,
    folderId,
    function(err, result) {
 ...
 * @throws {AssertionError}                         Thrown if the request failed
 */
var assertRemoveFolderFromLibrarySucceeds = (module.exports.assertRemoveFolderFromLibrarySucceeds = function(
  restContext,
  principalId,
  folderId,
  callback,
 ...
 * @throws {AssertionError}                     Thrown if the request did not succeed
 */
var assertShareFolderSucceeds = (module.exports.assertShareFolderSucceeds = function(
  managerRestContext,
  actorRestContext,
  folderId,
  viewers,
  ...
  getAllFolderMembers(managerRestContext, folderId, null, function(results) {
    ...
    AuthzTestUtil.assertGetInvitationsSucceeds(
      ...
      folderId,
      function(result) {
        var emailRolesBefore = AuthzTestUtil.getEmailRolesFromResults(
          result.results,
        );
        ...
        _getAllFoldersInLibraries(viewerInfos, function(
          principalFoldersLibrariesBeforeShare,
        ) {
          // Share the folder with all the principals and wait for the library updates to complete
          RestAPI.Folders.shareFolder(
            actorRestContext,
            folderId,
            viewerIds,
            function(err) {
                    ...
                    getAllFolderMembers(
                      ...
                      function(results) {
                        ...
                        _getAllFoldersInLibraries(viewerInfos, function(
                          ...
                          _.each(principalFoldersLibrariesAfterShare, function(
                            foldersLibrary,
                            principalId,
                          ) {
                            assert.ok(
                          ...
                          _purgeFoldersLibraries(viewerInfoIds, function() {
                            ...
                            _getAllFoldersInLibraries(viewerInfos, function(
                              ...
                              _.each(
                                principalFoldersLibrariesAfterShare,
                                function(foldersLibrary, principalId) {
                                  assert.ok(
                                    _.chain(foldersLibrary)
                                      .pluck('id')
                                      .contains(foldersLibrary, folderId),
 ...
 * @throws {AssertionError}                     Thrown if the request did not fail in the expected manner
 */
var assertShareFolderFails = (module.exports.assertShareFolderFails = function(
  managerRestContext,
  actorRestContext,
  folderId,
  viewerIds,
  ...
  RestAPI.Folders.shareFolder(actorRestContext, folderId, viewerIds, function(
    err,
  ) {
    assert.ok(err);
    assert.strictEqual(err.code, httpCode);
 ...
 * @throws {AssertionError}                     Thrown if the request did not fail in the expected manner
 */
var assertUpdateFolderMembersFails = (module.exports.assertUpdateFolderMembersFails = function(
  managerRestContext,
  actorRestContext,
  folderId,
  memberUpdates,
 ...
 * @throws {AssertionError}                         Thrown if the request did not succeed
 */
var assertUpdateFolderMembersSucceeds = (module.exports.assertUpdateFolderMembersSucceeds = function(
  managerRestContext,
  actorRestContext,
  folderId,
  memberUpdateInfos,
  ...
  getAllFolderMembers(managerRestContext, folderId, null, function(results) {
    ...
    AuthzTestUtil.assertGetInvitationsSucceeds(
      ...
      function(result) {
        ...
        _getAllFoldersInLibraries(memberInfos, function(
          principalFoldersLibrariesBeforeUpdate,
        ) {
          RestAPI.Folders.updateFolderMembers(
            actorRestContext,
            folderId,
                ...
                function(result) {
                  ...
                  getAllFolderMembers(
                    ...
                    function(results) {
                      ...
                      _getAllFoldersInLibraries(memberInfos, function(
                        principalFoldersLibrariesAfterUpdate,
                      ) {
                        _.each(roleChange, function(change, memberId) {
                          var foldersLibrary =
                            principalFoldersLibrariesAfterUpdate[memberId];
                          if (foldersLibrary) {
                            var containsFolder = _.chain(foldersLibrary)
                              .pluck('id')
                              .contains(folderId)
                              .value();
                            if (change === false) {
 ...
 */
var assertFullFoldersLibraryEquals = (module.exports.assertFullFoldersLibraryEquals = function(
  restContext,
  principalId,
  expectedFolderIds,
  ensureOrder,
 ...
 * @throws {AssertionError}                         Thrown if any assertions failed
 */
var assertFolderSearchEquals = (module.exports.assertFolderSearchEquals = function(
  restContext,
  folderId,
  q,
  expectedContent,
 ...
 * @throws {AssertionError}                         Thrown if any assertions failed
 */
var assertGeneralFolderSearchEquals = (module.exports.assertGeneralFolderSearchEquals = function(
  restContext,
  q,
  expectedFolders,
  missingFolders,
  ...
  SearchTestUtil.searchAll(
    ...
    'general',
    null,
    { resourceTypes: 'folder', q: q, scope: '_network' },
    function(err, results) {
      assert.ok(!err);
 ...
 * @throws {AssertionError}                         Thrown if any assertions failed
 */
var assertFolderLibrarySearch = (module.exports.assertFolderLibrarySearch = function(
  restContext,
  principalId,
  q,
  expectedFolders,
 ...
 * @throws {AssertionError}                         Thrown if any assertions failed
 */
var assertFolderSearchFails = (module.exports.assertFolderSearchFails = function(
  restContext,
  folderId,
  httpCode,
  callback,
 ...
 * @throws {AssertionError}                             Thrown if any assertions failed
 */
var assertFullFolderMembersEquals = (module.exports.assertFullFolderMembersEquals = function(
  restContext,
  folderId,
  expectedMemberRoles,
  callback,
 ...
 */
var getAllFoldersInLibrary = (module.exports.getAllFoldersInLibrary = function(
  restContext,
  principalId,
  opts,
  callback,
 ...
 * @param  {Object[]}       callback.responses      All the raw web responses that were received for each page request
 */
var getAllFolderContentItems = (module.exports.getAllFolderContentItems = function(
  restContext,
  folderId,
  opts,
  callback,
 ...
 * @param  {Object[]}       callback.responses      All the raw web responses that were received for each page request
 */
var getAllFolderMembers = (module.exports.getAllFolderMembers = function(
  restContext,
  folderId,
  opts,
  callback,
 ...
 * @throws {AssertionError}                     Thrown if the request did not fail in the expected manner
 */
var assertCreateMessageFails = (module.exports.assertCreateMessageFails = function(
  restContext,
  folderId,
  body,
  replyTo,
  ...
  RestAPI.Folders.createMessage(restContext, folderId, body, replyTo, function(
    err,
  ) {
    assert.ok(err);
    assert.strictEqual(err.code, httpCode);
 ...
 * @throws {AssertionError}                             Thrown if the request failed
 */
var assertCreateMessageSucceeds = (module.exports.assertCreateMessageSucceeds = function(
  restContext,
  folderId,
  body,
  replyTo,
 ...
 * @throws {AssertionError}                     Thrown if the request did not fail in the expected manner
 */
var assertGetMessagesFails = (module.exports.assertGetMessagesFails = function(
  restContext,
  folderId,
  start,
  limit,
  ...
  RestAPI.Folders.getMessages(restContext, folderId, start, limit, function(
    err,
    result,
  ) {
    assert.ok(err);
 ...
 * @throws {AssertionError}                     Thrown if the request failed
 */
var assertGetMessagesSucceeds = (module.exports.assertGetMessagesSucceeds = function(
  restContext,
  folderId,
  start,
  limit,
 ...
 * @throws {AssertionError}                         Thrown if the request did not fail in the expected manner
 */
var assertDeleteMessageFails = (module.exports.assertDeleteMessageFails = function(
  restContext,
  folderId,
  messageCreated,
  httpCode,
  ...
  RestAPI.Folders.deleteMessage(restContext, folderId, messageCreated, function(
    err,
    result,
  ) {
    assert.ok(err);
 ...
 * @throws {AssertionError}                         Thrown if the request failed
 */
var assertDeleteMessageSucceeds = (module.exports.assertDeleteMessageSucceeds = function(
  restContext,
  folderId,
  messageCreated,
  callback,
...
var _setupTenant = function(tenant, callback) {
  _createMultiPrivacyFolders(tenant.adminRestContext, function(
    publicFolder,
    loggedinFolder,
    privateFolder,
  ) {
...
var _createMultiPrivacyFolders = function(restContext, callback) {
  _createFolderWithVisibility(restContext, 'public', function(publicFolder) {
    _createFolderWithVisibility(restContext, 'loggedin', function(
      loggedinFolder,
    ) {
      _createFolderWithVisibility(restContext, 'private', function(
        privateFolder,
      ) {
 ...
 * @api private
 */
var _getAllFoldersInLibraries = function(
  principalInfos,
  callback,
  _principalIdFolders,
) {
