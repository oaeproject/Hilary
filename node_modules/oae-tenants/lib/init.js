...
module.exports = function(config, callback) {
    ...
    ensureSchema(function(err) {
        ...
        TenantsAPI.initializeTenantMiddleware(callback);
    });
};
...
var ensureSchema = function(callback) {
    Cassandra.createColumnFamily('Tenant', 'CREATE COLUMNFAMILY Tenant (alias text PRIMARY KEY, name text, baseUrl text, active boolean, deleted boolean);', callback);
};
