    ...
    describe('Local authentication', function() {
        ...
        it('verify cookie expiration for mobile and non-mobile browsers', function(callback) {
            ...
            RestAPI.User.createUser(camAdminRestContext, userId, 'password', 'Test User', null, function(err, createdUser) {
                ...
                _getCookiesForUserAgents(userRestContext, userId, 'password', allUserAgents, function(userAgentCookies) {
                    assert.strictEqual(_.keys(userAgentCookies).length, allUserAgents.length);

                    // Ensure each mobile user agent has a cookie with an explicit expiry time
