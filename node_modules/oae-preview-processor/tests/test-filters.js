...
var FilterGenerator = require('oae-preview-processor/lib/filters')
  .FilterGenerator;
...
describe('Preview processor - filters', function() {
  ...
  describe('Filtering', function() {
    ...
    var _filterAndAssert = function(filters, expectations) {
      ...
      assert.ok(!filterGenerator.hasErrors());
      assert.equal(
        filterGenerator.needsRevisions(),
        expectations.needsRevisions,
      );
      ...
      for (i = 0; i < filteredContent.length; i++) {
        assert.equal(
          filteredContent[i].id,
          expectations.revisionStage[i].contentId,
        );
        for (
          var r = 0;
          r < expectations.revisionStage[i].revisions.length;
          r++
        ) {
          assert.equal(
