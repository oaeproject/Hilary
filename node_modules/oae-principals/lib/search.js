...
var _transformUserDocuments = function(ctx, docs, callback) {
    ...
    for (var i = 0; i < docIds.length; i++) {
        ...
        // If there is a thumbnail in the search document, we add it on the user object. It will be removed from it if the current user
        ...
        if (user.mediumPictureUri) {
            result.thumbnailUrl = PrincipalsUtil.getSignedPictureUrl(ctx, ctx.tenant().alias, user.mediumPictureUri);
        }
