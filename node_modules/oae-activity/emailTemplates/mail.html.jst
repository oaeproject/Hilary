...
<%
    ...
    var renderPreviewTile = function(entity, wide) {
        ...
        var str = '';
        str += '<td class="preview-thumbnail-container' + (wide ? ' preview-thumbnail-container-wide' : '') + '" style="background-image: url(' + thumbnailUrl+ ');" valign="bottom">';
        str += '    <a href="' + baseUrl + entity.profilePath + '" title="' + util.html.encodeForHTMLAttribute(entity.displayName) + '" target="_blank" style="width: 162px;padding: 0; margin: 0;">';
        str += '        <table style="width: 162px; height: 162px; padding: 0; margin: 0;" cellpadding="0" cellspacing="0">';
        str += '            <tr>';
        ...
        str += '                                <td><h3><a href="' + baseUrl + entity.profilePath + '" title="' + util.html.encodeForHTMLAttribute(entity.displayName) + '" target="_blank" class="preview-tile-title-description">' + util.html.encodeForHTML(util.text.truncate(entity.displayName, 80)) + '</a></h3></td>';
        if (entity.resourceType !== 'user') {
            str += '                            <td><img src="' + baseUrl + '/ui/img/icons/' + entity.visibility + '.png" alt="' + entity.visibility + '" /></td>';
        }
        str += '                            </tr>';
        str += '                            <tr>';
