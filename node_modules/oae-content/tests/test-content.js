...
describe('Content', function() {
     ...
     */ 
     var setUpGroups = function(contexts, callback) {
        var r = Math.floor(Math.random() * 10000);
        var groups = [new Group(contexts[0].tenant(), null, 'UI Dev Team ' + r, 'UI Dev Group', 'public', 'yes'),
                      new Group(contexts[3].tenant(), null, 'Back-end Dev Team ' + r, 'Back-end Dev Group', 'public', 'yes'),
                      new Group(contexts[4].tenant(), null, 'OAE Team ' + r, 'OAE Team Group', 'public', 'yes')];
        // Create UI Dev Group
        // Make Bert a member
        var bertMember = {};
        bertMember[contexts[2].user().id] = 'manager';
        PrincipalsAPI.createGroup(contexts[0], groups[0].name, groups[0].description, 'public', 'yes', bertMember, {}, function(err, principal_id) {
            groups[0].id = principal_id;
            // Create Back-end Dev Group
            // Make Simon a member
            var simonMember = {};
            simonMember[contexts[1].user().id] = 'member';
            PrincipalsAPI.createGroup(contexts[3], groups[1].name, groups[1].description, 'public', 'yes', simonMember, {}, function(err, principal_id) {
                ...
                PrincipalsAPI.createGroup(contexts[4], groups[2].name, groups[2].description, 'public', 'yes', members, {}, function(err, principal_id) {
