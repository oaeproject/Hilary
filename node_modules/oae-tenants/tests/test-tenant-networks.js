...
describe('Tenant Networks', function() {
  ...
  it('verify get tenant networks authorization', function(callback) {
    TestsUtil.generateTestUsers(camAdminRestContext, 1, function(
      ...
      RestAPI.Tenants.getTenantNetworks(anonymousCamRestContext, function(
        err,
        tenantNetwork,
      ) {
        assert.ok(err);
        ...
        RestAPI.Tenants.getTenantNetworks(mrvisser.restContext, function(
          err,
          tenantNetwork,
        ) {
          assert.ok(err);
          ...
          RestAPI.Tenants.getTenantNetworks(camAdminRestContext, function(
            err,
            tenantNetwork,
          ) {
            assert.ok(err);
  ...
  it('verify get tenant networks fetches all tenant networks with associated tenants expanded into their full model', function(callback) {
    TenantsTestUtil.generateTestTenantNetworks(
      globalAdminRestContext,
      3,
      function(tenantNetwork0, tenantNetwork1, tenantNetwork2) {
        ...
        RestAPI.Tenants.addTenantAliases(
          ...
          function(err) {
            ...
            RestAPI.Tenants.getTenantNetworks(globalAdminRestContext, function(
              err,
              tenantNetworks,
            ) {
              assert.ok(!err);
              ...
              TenantsTestUtil.assertTenantsEqual(
                camTenant,
                global.oaeTests.tenants.cam,
              );
              TenantsTestUtil.assertTenantsEqual(
                gtTenant,
                global.oaeTests.tenants.gt,
              );
  ...
  it('verify create tenant network validation', function(callback) {
    ...
    RestAPI.Tenants.createTenantNetwork(globalAdminRestContext, null, function(
      err,
      tenantNetwork,
    ) {
      assert.ok(err);
  ...
  it('verify update tenant network validation', function(callback) {
    TenantsTestUtil.generateTestTenantNetworks(
      globalAdminRestContext,
      1,
      function(originalTenantNetwork) {
                      ...
                      function(err, tenantNetwork) {
                        ...
                        RestAPI.Tenants.updateTenantNetwork(
                          ...
                          function(err, tenantNetwork) {
                            ...
                            RestAPI.Tenants.getTenantNetworks(
                              globalAdminRestContext,
                              function(err, tenantNetworks) {
                                assert.ok(!err);
                                assert.ok(
                                  tenantNetworks[originalTenantNetwork.id],
                                );
                                assert.equal(
                                  tenantNetworks[originalTenantNetwork.id]
                                    .displayName,
                                  ...
                                  function(err, tenantNetwork) {
                                    ...
                                    RestAPI.Tenants.getTenantNetworks(
                                      ...
                                      function(err, tenantNetworks) {
                                        assert.ok(!err);
                                        assert.ok(
                                          tenantNetworks[tenantNetwork.id],
                                        );
                                        assert.equal(
                                          tenantNetworks[tenantNetwork.id]
                                            .displayName,
      ...
      function(originalTenantNetwork) {
        ...
        RestAPI.Tenants.deleteTenantNetwork(
          ...
          function(err) {
            ...
            TenantNetworksAPI.deleteTenantNetwork(
              TestsUtil.createGlobalAdminContext(),
              null,
              function(err) {
                assert.ok(err);
                            ...
                            function(err) {
                              ...
                              RestAPI.Tenants.getTenantNetworks(
                                ...
                                function(err, tenantNetworks) {
                                  ...
                                  assert.ok(
                                    _.isArray(
                                      tenantNetworks[tenantNetwork.id].tenants,
                                    ),
                                  );
                                  assert.strictEqual(
                                    tenantNetworks[tenantNetwork.id].tenants
