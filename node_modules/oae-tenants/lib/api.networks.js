 ...
 */
const createTenantNetwork = module.exports.createTenantNetwork = function(ctx, displayName, callback) {
 ...
 */
const getTenantNetworks = module.exports.getTenantNetworks = function(ctx, callback) {
    const validator = new Validator();
 ...
 */
const updateTenantNetwork = module.exports.updateTenantNetwork = function(ctx, id, displayName, callback) {
    const validator = new Validator();
 ...
 * @param  {Object}     callback.err    An error that occurred, if any
 */
const deleteTenantNetwork = module.exports.deleteTenantNetwork = function(ctx, id, callback) {
    const validator = new Validator();
 ...
 * @param  {Object}     callback.err        An error that occurred, if any
 */
const addTenantAliases = module.exports.addTenantAliases = function(ctx, tenantNetworkId, tenantAliases, callback) {
    const validator = new Validator();
    validator.check(null, {'code': 401, 'msg': 'Must be a global administrator user to update a tenant network'}).isGlobalAdministratorUser(ctx);
 ...
 * @param  {Object}     callback.err        An error that occurred, if any
 */
const removeTenantAliases = module.exports.removeTenantAliases = function(ctx, tenantNetworkId, tenantAliases, callback) {
    const validator = new Validator();
    validator.check(null, {'code': 401, 'msg': 'Must be a global administrator user to update a tenant network'}).isGlobalAdministratorUser(ctx);
    validator.check(tenantNetworkId, {'code': 400, 'msg': 'Must specify a tenant network id'}).notEmpty();
