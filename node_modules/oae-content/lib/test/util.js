 ...
 */
var assertCreateLinkSucceeds = (module.exports.assertCreateLinkSucceeds = function(
  restContext,
  displayName,
  description,
  visibility,
    ...
    RestAPI.Content.createLink(
      ...
      function(err, content) {
        ...
        getAllContentMembers(restContext, content.id, null, function(result) {
          ...
          AuthzTestUtil.assertGetInvitationsSucceeds(restContext, 'content', content.id, function(
            result
          ) {
 ...
 * @throws {AssertionError}                     Thrown if any assertions fail
 */
var assertCreateLinkFails = (module.exports.assertCreateLinkFails = function(
  restContext,
  displayName,
  description,
  visibility,
 ...
 * @throws {AssertionError}                 Thrown if any assertions fail
 */
var assertGetContentFails = (module.exports.assertGetContentFails = function(
  restContext,
  contentId,
  httpCode,
  callback
 ...
 * @throws {AssertionError}                     Thrown if any assertions fail
 */
var assertDeleteContentSucceeds = (module.exports.assertDeleteContentSucceeds = function(
  restContext,
  contentId,
  callback
) {
 ...
 */
var assertEtherpadContentEquals = (module.exports.assertEtherpadContentEquals = function(
  actualContent,
  expectedContent
) {
  ...
  expectedContent =
    '<!DOCTYPE HTML>' + '<html>' + '<body>' + expectedContent + '<br>' + '</body>' + '</html>';
 ...
 */
var assertGetContentMembersFails = (module.exports.assertGetContentMembersFails = function(
  restContext,
  contentId,
  start,
  limit,
 ...
 */
var assertGetContentMembersSucceeds = (module.exports.assertGetContentMembersSucceeds = function(
  restContext,
  contentId,
  start,
  limit,
 ...
 */
var assertUpdateContentMembersFails = (module.exports.assertUpdateContentMembersFails = function(
  managerRestContext,
  actorRestContext,
  contentId,
  roleChanges,
  ...
  getAllContentMembers(managerRestContext, contentId, null, function(result) {
    ...
    AuthzTestUtil.assertGetInvitationsSucceeds(managerRestContext, 'content', contentId, function(
      result
    ) {
 ...
 */
var assertUpdateContentMembersSucceeds = (module.exports.assertUpdateContentMembersSucceeds = function(
  managerRestContext,
  actorRestContext,
  contentId,
  roleChanges,
 ...
 * @throws {AssertionError}                     Thrown if there is an error ensuring that the request fails in the specified manner
 */
var assertShareContentFails = (module.exports.assertShareContentFails = function(
  managerRestContext,
  actorRestContext,
  contentId,
  memberIds,
 ...
 */
var assertShareContentSucceeds = (module.exports.assertShareContentSucceeds = function(
  managerRestContext,
  actorRestContext,
  contentId,
  memberIds,
          ...
          function(result) {
            ...
            getAllContentMembers(managerRestContext, contentId, null, function(membersAfterUpdate) {
              ...
              _purgeMembersLibrary(contentId, function() {
                ...
                getAllContentMembers(managerRestContext, contentId, null, function(
                  membersAfterUpdate
                ) {
                  AuthzTestUtil.assertMemberRolesEquals(
                    memberRolesBefore,
 ...
 */
var getAllContentMembers = (module.exports.getAllContentMembers = function(
  restContext,
  contentId,
  opts,
  callback,
  ...
  assertGetContentMembersSucceeds(restContext, contentId, _nextToken, opts.batchSize, function(
    result
  ) {
 ...
 */
var assertGetAllContentLibrarySucceeds = (module.exports.assertGetAllContentLibrarySucceeds = function(
  restContext,
  principalId,
  opts,
  callback,
 ...
 */
var assertGetContentLibrarySucceeds = (module.exports.assertGetContentLibrarySucceeds = function(
  restContext,
  principalId,
  opts,
  callback
  ...
  opts = opts || {};
  RestAPI.Content.getLibrary(restContext, principalId, opts.start, opts.limit, function(
    err,
    result
  ) {
    assert.ok(!err);
...
var _setupTenant = function(tenant, callback) {
  _createMultiPrivacyContent(tenant.adminRestContext, function(
    publicContent,
    loggedinContent,
    privateContent
  ) {
  ...
  TestsUtil.generateTestUsers(adminRestContext, nrOfUsers, function(err, users) {
    ...
    RestAPI.Content.createCollabDoc(
      ...
      function(err, contentObj) {
        ...
        let restContexts = _.pluck(userValues, 'restContext');
        async.each(
          restContexts,
          (eachUserToJoin, exit) => {
 ...
 * @param  {Object}         callback.user..         An object containing the user profile and a rest context for the next user of the set of users that was created
 */
var createCollabsheet = (module.exports.createCollabsheet = function(
  adminRestContext,
  nrOfUsers,
  nrOfJoinedUsers,
  callback
