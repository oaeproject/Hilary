 ...
 */
var Context = module.exports.Context = function(tenant, user, locale, imposter) {
    var that = {};
     ...
     * of the current user
     *
     * @param  {String}   [loc]     The locale to use on this context
     * @return {String}             The locale associated to the current execution context
     */
    that.locale = function(loc) {
        // We set the default language to null, but locale middleware serializes that to a
        // string: https://github.com/jed/locale/issues/12
        if (loc && loc !== 'null') {
            locale = loc;
        }
        return locale;
