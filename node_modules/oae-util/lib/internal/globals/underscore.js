...
_.mixin({
   ...
   */
  oaeObj: function(/*key0, val0, key1, val1, ...*/) {
    var result = {};
    _.chain(arguments)
      .toArray()
      // Group the array of arguments into pairs: [[key0, val0], [key1, val1], ...]
      .groupBy(function(arg, i) {
        return Math.floor(i / 2);
      })
      .each(function(keyAndValue) {
   ...
   */
  oaeExtendDefined: function(source, extendWith) {
    return _.extend(
      source,
      _.omit(extendWith, function(value) {
