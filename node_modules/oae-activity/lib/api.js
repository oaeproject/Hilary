...
var LibraryAuthz = require('oae-library/lib/api.authz');
...
var ActivityEmail = require('./internal/email');
...
var refreshConfiguration = (module.exports.refreshConfiguration = function(
  ...
  if (config.processActivityJobs && config.collectionPollingFrequency > 0) {
    var collectionPollingFrequencyInMs =
      config.collectionPollingFrequency * 1000;
  ...
  if (config.processActivityJobs && config.mail.pollingFrequency > 0) {
    var mailPollingFrequencyInMs = config.mail.pollingFrequency * 1000;
    // Collect and send email
    mailPollingTimer = setInterval(
      ActivityEmail.collectAllBuckets,
      mailPollingFrequencyInMs,
    );
  }
 ...
 */
var registerActivityStreamType = (module.exports.registerActivityStreamType = function(
  activityStreamType,
  options,
) {
 ...
 */
var getRegisteredActivityStreamType = (module.exports.getRegisteredActivityStreamType = function(
  activtyStreamType,
) {
 ...
 */
var registerActivityType = (module.exports.registerActivityType = function(
  activityType,
  options,
) {
 ...
 */
var registerActivityEntityType = (module.exports.registerActivityEntityType = function(
  activityEntityType,
  options,
) {
 ...
 */
var registerActivityEntityAssociation = (module.exports.registerActivityEntityAssociation = function(
  activityEntityType,
  associationName,
  associationFunction,
) {
 ...
 */
var getActivityStream = (module.exports.getActivityStream = function(
  ctx,
  principalId,
  start,
  limit,
  ...
  transformerType =
    transformerType || ActivityConstants.transformerTypes.ACTIVITYSTREAMS;
    ...
    LibraryAuthz.resolveTargetLibraryAccess(
      ...
      function(err, hasAccess, visibility) {
        if (err) {
          ...
          return callback({
            code: 401,
            msg: 'You cannot access this activity stream',
          });
        }

        var activityStreamType = 'activity';
 ...
 */
var getNotificationStream = (module.exports.getNotificationStream = function(
  ctx,
  userId,
  start,
  limit,
  ...
  var tenantAlias = AuthzUtil.getResourceFromId(userId).tenantAlias;
  if (ctx.user().id !== userId && ctx.user().isAdmin(tenantAlias)) {
    return callback({
      code: 401,
      msg: 'You are not allowed to view this notification stream',
    });
  }
 ...
 * @param  {Object}     callback.err    An error that occurred, if any
 */
var markNotificationsRead = (module.exports.markNotificationsRead = function(
  ctx,
  callback,
) {
  var validator = new Validator();
 ...
 * @param  {Object}        callback.err        An error that occurred, if any
 */
var postActivity = (module.exports.postActivity = function(
  ctx,
  activitySeed,
  callback,
) {
  ...
  var validator = new Validator();
  validator
    .check(null, { code: 400, msg: 'No activity seed provided.' })
    .isObject(activitySeed);
  if (activitySeed) {
    validator
    ...
    if (activitySeed.objectResource) {
      validator
        .check(activitySeed.objectResource.resourceId, {
          code: 400,
          msg:
            'Object of activity seed was specified and did not have a resourceId',
        })
        .notEmpty();
      validator
        .check(activitySeed.objectResource.resourceType, {
          code: 400,
          msg:
            'Object of activity seed was specified and did not have a resourceType',
        })
        .notEmpty();
    }
    ...
    if (activitySeed.targetResource) {
      validator
        .check(activitySeed.targetResource.resourceId, {
          code: 400,
          msg:
            'Target of activity seed was specified and did not have a resourceId',
        })
        .notEmpty();
      validator
        .check(activitySeed.targetResource.resourceType, {
          code: 400,
          msg:
            'Target of activity seed was specified and did not have a resourceType',
        })
        .notEmpty();
    }
  }
 ...
 * @api private
 */
var _getActivityStream = function(
  ctx,
  activityStreamId,
  start,
  limit,
  ...
  ActivityDAO.getActivities(activityStreamId, start, limit, function(
    err,
    activities,
    nextToken,
  ) {
