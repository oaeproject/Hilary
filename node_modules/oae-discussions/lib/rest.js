...
/*!
 * Get a user's discussions library
 */
OAE.tenantServer.post('/api/discussions/library/:principalId', function(req, res) {
    req.telemetryUrl = '/api/discussions/library/principalId';
    DiscussionsAPI.Discussions.getDiscussions(req.ctx, req.params.principalId, req.body.start, req.body.limit, function(err, discussions, nextToken) {
        if (err) {
            return res.send(err.code, err.msg);
        }

        res.send(200, {'results': results, 'nextToken': nextToken});
    });
});
...
OAE.tenantServer.get('/api/discussions/:discussionId/members', function(req, res) {
    req.telemetryUrl = '/api/discussions/id/members';
    DiscussionsAPI.Discussions.getDiscussionMembers(req.ctx, req.params.discussionId, req.body.start, req.body.limit, function(err, members){
        if (err) {
            return res.send(err.code, err.msg);
        }
...
OAE.tenantServer.get('/api/discussions/:discussionId/messages', function(req, res) {
    ...
    DiscussionsAPI.Discussions.getMessages(req.ctx, req.params.discussionId, req.body.start, req.body.limit, function(err, messages) {
        if (err) {
            return res.send(err.code, err.msg);
        }
...
OAE.tenantServer.post('/api/discussions/:discussionId/messages', function(req, res) {
    req.telemetryUrl = '/api/discussions/id/messages';
    DiscussionAPI.Discussions.createMessage(req.ctx, req.params.discussionId, req.body.body, req.body.replyTo, function(err, message) {
        if (err) {
            return res.send(err.code, err.msg);
        }
...
OAE.tenantServer.del('/api/discussions/:discussionId/messages/:created', function(req, res) {
    ...
    DiscussionAPI.Discussions.deleteMessage(req.ctx, req.params.discussionId, req.params.created, function(err, message) {
        if (err) {
            return res.send(err.code, err.msg);
        }
