 ...
 * @param  {String}     contentObj              The content profile of the pad that should be joined
 * @param  {String}     contentObj.padId        The unique identifier of the pad that should be joined
 * @param  {String}     contentObj.groupId      The unique identifier of the group that is associated to this pad
 * @param  {Function}   callback                Standard callback method
 * @param  {Object}     callback.err            An error that occurred, if any
 ...
 *
 * @param  {String}     contentObj                  The content profile of the pad to get the URL for
 * @param  {String}     contentObj.id               The ID of the piece of content
 * @param  {String}     contentObj.etherpadPadId    The ID of the pad in etherpad
 * @param  {String}     contentObj.displayName      The title of the content
