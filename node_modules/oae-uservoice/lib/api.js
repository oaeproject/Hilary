...
var getUrlInfo = module.exports.getUrlInfo = function(ctx, expiresIn, callback) {
    ...
    if (!enabled) {
        return callback({'code': 400, 'msg': 'The User Voice integration is not enabled for this tenant'});
    } else if (!subdomain) {
        return callback({'code': 400, 'msg': 'The User Voice subdomain is not configured for this tenant'});
    }
