...
var setUpTenants = function(err, callback) {
    ...
    TenantsAPI.createTenant('camtest', 'Cambridge University Test', 2001, 'http://localhost:2001', function(err, tenant) {
        global.oaeTests.tenants.cam = tenant;
        // Create the Georgia Tech tenant
        TenantsAPI.createTenant('gttest', 'Georgia Tech Test', 2002, 'http://localhost:2002', function(err, tenant) {
