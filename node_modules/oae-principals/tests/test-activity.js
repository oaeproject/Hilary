...
describe('Principals Activity', () => {
  ...
  describe('Activity Entity Model', () => {
    ...
    const _getPictureStream = function() {
      const file = __dirname + '/data/restroom.jpg';
                              ...
                              err => {
                                ...
                                ActivityTestsUtil.collectAndGetActivityStream(
                                  ...
                                  (err, activityStream) => {
                                    ...
                                    const actor = activity.actor; // Public user
                                    const object = activity.object; // Private user
                                    const target = activity.target; // Group
                                    assert.ok(actor);
                                    assert.ok(object);
                                    assert.ok(target);
