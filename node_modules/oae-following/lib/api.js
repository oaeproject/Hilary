 ...
 */
var getFollowers = (module.exports.getFollowers = function(
  ctx,
  userId,
  start,
  limit,
  ...
  validator
    .check(userId, { code: 400, msg: 'You must specify a valid user id' })
    .isUserId();
  ...
  PrincipalsDAO.getPrincipal(userId, function(err, user) {
    ...
    FollowingAuthz.canViewFollowers(ctx, user, function(err) {
      ...
      FollowingDAO.getFollowers(userId, start, limit, function(
        err,
        followerUserIds,
        nextToken,
      ) {
        ...
        AuthzUtil.filterDeletedIds(followerUserIds, function(
          err,
          followerUserIds,
        ) {
          if (err) {
 ...
 */
var getFollowing = (module.exports.getFollowing = function(
  ctx,
  userId,
  start,
  limit,
  ...
  PrincipalsDAO.getPrincipal(userId, function(err, user) {
    ...
    FollowingAuthz.canViewFollowing(ctx, user, function(err) {
      ...
      FollowingDAO.getFollowing(userId, start, limit, function(
        err,
        followingUserIds,
        nextToken,
      ) {
        ...
        AuthzUtil.filterDeletedIds(followingUserIds, function(
          err,
          followingUserIds,
        ) {
          if (err) {
...
var follow = (module.exports.follow = function(ctx, followedUserId, callback) {
  ...
  PrincipalsDAO.getPrincipal(followedUserId, function(err, followedUser) {
    ...
    FollowingAuthz.canFollow(ctx, followedUser, function(err) {
      ...
      FollowingDAO.isFollowing(ctx.user().id, [followedUserId], function(
        err,
        following,
      ) {
        if (err) {
        ...
        FollowingDAO.saveFollows(ctx.user().id, [followedUserId], function(
          err,
        ) {
          if (err) {
            return callback(err);
 ...
 * @param  {Object}     callback.err        An error that occurred, if any
 */
var unfollow = (module.exports.unfollow = function(
  ctx,
  unfollowedUserId,
  callback,
) {
