...
describe('Authentication', function() {
    ...
    var verifyEndpointIsDisabled = function(strategyName, method, callback) {
        ...
        ConfigTestUtil.updateConfigAndWait(globalAdminRestContext, 'localhost', 'oae-authentication/' + strategyName + '/enabled', true, function() {

            // Wait until the authentication api has finished refreshing its strategies
            AuthenticationAPI.once('refreshedStrategies', function(tenantAlias) {
