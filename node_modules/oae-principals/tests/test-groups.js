...
describe('Groups', function() {
    ...
    describe('Create group', function() {
        ...
        it('verify that missing description is accepted', function(callback) {
            RestAPI.Group.createGroup(johnRestContext, 'Group title', null, 'public', undefined, [], [], function(err, groupObj) {
                ...
                // Empty descriptions should be fine as well.
        ...
        /**
         * Test that verifies that creating a group with a displayName that is too long is not possible.
         */
        ...
        /**
         * Test that verifies that creating a group with a description that is too long is not possible.
         */
    ...
    describe('Get group', function() {
        ...
        it('verify group properties', function(callback) {
            RestAPI.Group.createGroup(johnRestContext, 'Group title', 'Group description', 'private', 'request', [], [], function(err, groupObj) {
                assert.ok(!err);
                RestAPI.Group.getGroup(johnRestContext, groupObj.id, function(err, groupData) {
                    ...
                    assert.equal(groupObj.profilePath, '/group/' + groupObj.tenant.alias + '/' + AuthzUtil.getResourceFromId(groupObj.id).resourceId);
                    assert.ok(_.isObject(groupObj.tenant));
                    assert.equal(_.keys(groupData.tenant).length, 2);
                    assert.equal(groupData.tenant.displayName, global.oaeTests.tenants.cam.displayName);
                    assert.equal(groupData.tenant.alias, global.oaeTests.tenants.cam.alias);
                    callback();
                });
            });
        });
    ...
    describe('Update group', function() {
        ...
        it ('verify successful update', function(callback) {
            RestAPI.Group.createGroup(johnRestContext, 'Group title', 'Group description', 'private', 'request', [], [], function(err, newGroup) {
                ...
                RestAPI.Group.updateGroup(johnRestContext, newGroup.id, profileFields, function(err, updatedGroup) {
                    assert.ok(!err);
                    ...
                    assert.ok(updatedGroup.isManager);
                    assert.ok(updatedGroup.isMember);
        ...
        /**
         * Test that verifies that a displayName that is too long causes the update to file
         */
        ...
        /**
         * Test that verifies that a description that is too long causes the update to file
         */
        it('verify invalid description', function(callback) {
            ...
            RestAPI.Group.createGroup(johnRestContext, 'displayName', 'description', 'private', 'request', [], [], function(err, newGroup) {
                ...
                RestAPI.Group.updateGroup(johnRestContext, newGroup.id, {'description': description}, function(err, updatedGroup) {
                    ...
                    // An empty description is fine though
    ...
    describe('Get group members', function() {
        ...
        it('verify administrators can view group members', function(callback) {
            ...
            RestAPI.Admin.loginOnTenant(globalAdminRestContext, 'localhost', function(err, globalAdminOnLocalhostRestCtx) {
                assert.ok(!err);
    ...
    describe('Member of', function() {
         ...
         */
        it('verify invalid principal in memberOf', function(callback) {
            RestAPI.Group.memberOf(camAdminRestContext, 'aninvalidid', null, null, function(err, memberships) {
                assert.ok(err);
                assert.equal(err.code, 400);
                ...
                var adminCtx = TestsUtil.createGlobalAdminContext();
                PrincipalsAPI.memberOf(adminCtx, null, null, null, function(err, memberships) {
                    assert.ok(err);
                    assert.equal(err.code, 400);
                    assert.ok(!memberships);
                    return callback();
    ...
    describe('Group visibility', function() {
        ...
        it('verify group visibility', function(callback) {
            ...
            TestsUtil.generateTestUsers(camAdminRestContext, 2, function(err, users) {
                assert.ok(!err);
                var nicolaas = _.values(users)[0].user;
                var nicolaasRestContext = _.values(users)[0].restContext;
                var brandenRestContext = _.values(users)[1].restContext;

                // Create a user on another tenant.
                TestsUtil.generateTestUsers(gtAdminRestContext, 1, function(err, users) {
                    assert.ok(!err);
                    var gtUserRestContext = _.values(users)[0].restContext;

                    // Create a group and add nicolaas as a member
                    RestAPI.Group.createGroup(johnRestContext, 'Test Group', 'Group', 'public', 'no', [], [nicolaas.id], function(err, groupObj) {
                        assert.ok(!err);
                        ...
                        assertGroupVisibility(johnRestContext, groupObj, true, true, 2, function() {
                            assertGroupVisibility(nicolaasRestContext, groupObj, true, true, 2, function() {
                                assertGroupVisibility(brandenRestContext, groupObj, true, true, 2, function() {
                                    assertGroupVisibility(anonymousRestContext, groupObj, true, true, 2, function() {
                                        assertGroupVisibility(gtUserRestContext, groupObj, true, true, 2, function() {
                                                    ...
                                                    assertGroupVisibility(nicolaasRestContext, groupObj, true, true, 2, function() {
                                                        assertGroupVisibility(brandenRestContext, groupObj, true, true, 2, function() {
                                                            assertGroupVisibility(anonymousRestContext, groupObj, false, false, null, function() {
                                                                assertGroupVisibility(gtUserRestContext, groupObj, false, false, null, function() {
                                                                    ...
                                                                    RestAPI.Group.updateGroup(johnRestContext, groupObj.id, {'visibility': 'private'}, function(err) {
                                                                        ...
                                                                        assertGroupVisibility(johnRestContext, groupObj, true, true, 2, function() {
                                                                            assertGroupVisibility(nicolaasRestContext, groupObj, true, true, 2, function() {
                                                                                assertGroupVisibility(brandenRestContext, groupObj, false, false, null, function() {
                                                                                    assertGroupVisibility(anonymousRestContext, groupObj, false, false, null, function() {
                                                                                        assertGroupVisibility(gtUserRestContext, groupObj, false, false, null, function() {
                                                                                            ...
                                                                                            RestAPI.Group.updateGroup(johnRestContext, groupObj.id, {'joinable': 'yes'}, function(err) {
                                                                                                ...
                                                                                                assertGroupVisibility(johnRestContext, groupObj, true, true, 2, function() {
                                                                                                    assertGroupVisibility(nicolaasRestContext, groupObj, true, true, 2, function() {
                                                                                                        assertGroupVisibility(brandenRestContext, groupObj, true, false, null, function() {
                                                                                                            assertGroupVisibility(anonymousRestContext, groupObj, false, false, null, function() {
                                                                                                                assertGroupVisibility(gtUserRestContext, groupObj, false, false, null, function() {
                                                                                                                    callback();
                                                                                                                });
