...
describe('Content', function() {
    ...
    it('Test get content', function(callback) {
        setUpUsers(function(contexts) {
            ...
            ContentAPI.createLink(contexts[0], 'public', 'Test Content 1', 'Test content description 1', 'http://www.sakaiproject.org/', {}, function(err, contentObj) {
                assert.ok(!err);
    ...
    it('Test create link', function(callback) {
        setUpUsers(function(contexts) {
            ...
            ContentAPI.createLink(new Context(tenant1), 'public', 'Test Content 1', 'Test content description 1', 'http://www.sakaiproject.org/', {}, function(err, contentObj) {
                assert.ok(err);
                assert.ok(!contentObj);
                // Create one with all required fields
                ContentAPI.createLink(contexts[0], 'public', 'Test Content 2', 'Test content description 2', 'http://www.sakaiproject.org/', {}, function(err, contentObj) {
                    assert.ok(!err);
                    assert.ok(contentObj.contentId);
                    // Create one without description
                    ContentAPI.createLink(contexts[0], 'public', 'Test Content 3', null, 'http://www.sakaiproject.org/', {}, function(err, contentObj) {
                        assert.ok(!err);
                        assert.ok(contentObj.contentId);
                        // Create one without URL
                        ContentAPI.createLink(contexts[0], 'public', 'Test Content 4', 'Test content description 4', null, {}, function(err, contentObj) {
                            assert.ok(err);
                            assert.ok(!contentObj);
                            // Create one without a valid URL
                            ContentAPI.createLink(contexts[0], 'public', 'Test Content 5', 'Test content description 5', 'Just a string', {}, function(err, contentObj) {
                                assert.ok(err);
                                assert.ok(!contentObj);
                                // Create one without title
                                ContentAPI.createLink(contexts[0], 'public', null, 'Test content description 6', 'http://www.sakaiproject.org/', {}, function(err, contentObj) {
                                    assert.ok(err);
                                    assert.ok(!contentObj);
                                    // Create one without visibility
                                    ContentAPI.createLink(contexts[0], null, 'Test Content 7', 'Test content description 7', 'http://www.sakaiproject.org/', {}, function(err, contentObj) {
                                        assert.ok(!err);
                                        assert.ok(contentObj.contentId);
    ...
    it('Test create file', function(callback) {
        setUpUsers(function(contexts) {
            // Create one as anon user
            ContentAPI.createFile(new Context(tenant1), 'public', 'Test Content 1', 'Test content description 1', {}, function(err, contentObj) {
                assert.ok(err);
                assert.ok(!contentObj);
                // Create one with all required fields
                ContentAPI.createFile(contexts[0], 'public', 'Test Content 2', 'Test content description 2', {}, function(err, contentObj) {
                    assert.ok(!err);
                    assert.ok(contentObj.contentId);
                    // Create one without description
                    ContentAPI.createFile(contexts[0], 'public', 'Test Content 3', null, {}, function(err, contentObj) {
                        assert.ok(!err);
                        assert.ok(contentObj.contentId);
                        // Create one without title
                        ContentAPI.createFile(contexts[0], 'public', null, 'Test content description 4', {}, function(err, contentObj) {
                            assert.ok(err);
                            assert.ok(!contentObj);
                            // Create one without visibility
                            ContentAPI.createFile(contexts[0], null, 'Test Content 5', 'Test content description 6', {}, function(err, contentObj) {
                                assert.ok(!err);
                                assert.ok(contentObj.contentId);
                                // Check if the visibility has been set to public (default)
                                ContentAPI.getContent(contexts[0], contentObj.contentId, function(err, contentObj) {
    ...
    it('Test create sakai doc', function(callback) {
        setUpUsers(function(contexts) {
            // Create one as anon user
            ContentAPI.createSakaiDoc(new Context(tenant1), 'public', 'Test Content 1', 'Test content description 1', {}, function(err, contentObj) {
                assert.ok(err);
                assert.ok(!contentObj);
                // Create one with all required fields
                ContentAPI.createSakaiDoc(contexts[0], 'public', 'Test Content 2', 'Test content description 2', {}, function(err, contentObj) {
                    assert.ok(!err);
                    assert.ok(contentObj.contentId);
                    // Create one without description
                    ContentAPI.createSakaiDoc(contexts[0], 'public', 'Test Content 3', null, {}, function(err, contentObj) {
                        assert.ok(!err);
                        assert.ok(contentObj.contentId);
                        // Create one without title
                        ContentAPI.createSakaiDoc(contexts[0], 'public', null, 'Test content description 4', {}, function(err, contentObj) {
                            assert.ok(err);
                            assert.ok(!contentObj);
                            // Create one without permission
                            ContentAPI.createSakaiDoc(contexts[0], null, 'Test Content 5', 'Test content description 5', {}, function(err, contentObj) {
                                assert.ok(!err);
                                assert.ok(contentObj.contentId);
    ...
    it('Test create logged in content item', function(callback) {
        setUpUsers(function(contexts) {
            ...
            ContentAPI.createLink(contexts[0], 'loggedin', 'Test Content 1', 'Test content description 1', 'http://www.sakaiproject.org/', {}, function(err, contentObj) {    
                assert.ok(!err);
                assert.ok(contentObj.contentId);
                // Get the piece of content as the person who created the content
                checkPieceOfContent(contexts[0], contexts[0].user().id, contentObj, true, true, true, function() {
    ...
    it('Test create private content item', function(callback) {
        setUpUsers(function(contexts) {
            ...
            ContentAPI.createLink(contexts[0], 'private', 'Test Content 1', 'Test content description 1', 'http://www.sakaiproject.org/', {}, function(err, contentObj) {    
                assert.ok(!err);
                assert.ok(contentObj.contentId);
                // Get the piece of content as the person who created the content
                checkPieceOfContent(contexts[0], contexts[0].user().id, contentObj, true, true, true, function() {
    ...
    it('Test create content with default members', function(callback) {
        setUpUsers(function(contexts) {
            ...
            ContentAPI.createLink(contexts[0], 'private', 'Test Content 1', 'Test content description 1', 'http://www.sakaiproject.org/', additionalMembers, function(err, contentObj) {   
                assert.ok(!err);
                assert.ok(contentObj.contentId);
                // Get the piece of content as the person who created the content
                checkPieceOfContent(contexts[0], contexts[0].user().id, contentObj, true, true, true, function() {
    ...
    var setUpContentPermissions = function(contexts, privacy, callback) {
        // Create a public content item
        ContentAPI.createLink(contexts[0], privacy, 'Test Content 1', 'Test content description 1', 'http://www.sakaiproject.org/', {}, function(err, contentObj) {    
            assert.ok(!err);
            assert.ok(contentObj.contentId);
            // Get the piece of content as the person who created the content
            checkPieceOfContent(contexts[0], contexts[0].user().id, contentObj, true, true, true, function() {
    ...
    var testGroupAccess = function(contexts, groups, privacy, callback) {
        ...
        ContentAPI.createLink(contexts[4], privacy, 'Test Content 1', 'Test content description 1', 'http://www.sakaiproject.org/', {}, function(err, contentObj) {    
            assert.ok(!err);
            assert.ok(contentObj.contentId);
