...
var AuthzSearch = require('./search');
...
var ensureSchema = function(callback) {
    Cassandra.createColumnFamilies({
        ...
        // Invitations schema
        'AuthzInvitations': 'CREATE TABLE "AuthzInvitationsByResourceId" ("resourceId" text, "email" text, "inviterUserId" text, "role" text, PRIMARY KEY ("resourceId", "email"))',
        'AuthzInvitationsResourceIdByEmail': 'CREATE TABLE "AuthzInvitationsResourceIdByEmail" ("email" text, "resourceId" text, PRIMARY KEY ("resourceId", "email"))',
        'AuthzInvitationsTokenByEmail': 'CREATE TABLE "AuthzInvitationsTokenByEmail" ("email" text PRIMARY KEY, "token" text)',
        'AuthzInvitationsEmailByToken': 'CREATE TABLE "AuthzInvitationsEmailByToken" ("token" text PRIMARY KEY, "email" text)'
