 ...
 *
 * @Required    [created,createdBy,description,displayName,id,lastModified,profilePath,tenant,visibility]
 ...
 * @RESTModel Folder
 *
 * @Required    [canManage,canShare,canAddItem,created,createdBy,description,displayName,id,lastModified,profilePath,tenant,visibility]
 * @Property    {boolean}               canAddItem          Whether the current user is allowed to add content to the folder
...
/**
 * @RESTModel FolderContentLibrary
 *
 * @Required    [{contentId}]
 * @Property    {string}                {contentId}         The id of the content item that should be added to or removed from the content library
 */
 ...
 * @Property    {Folder[]}              results             List of folders in the folder library
 */
