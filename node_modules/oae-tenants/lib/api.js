 ...
 * @param   {Function}  callback   A function(err) specifying the tenant information that was persisted.
 */
var updateTenant = module.exports.updateTenant = function(port, name, callback) {
    ...
    Cassandra.runQuery('UPDATE Tenant USING CONSISTENCY QUORUM SET name = ? WHERE port = ?', [name, port], function(err) {
        if (!err) {
            callback(false);
        } else {
            callback(err);
