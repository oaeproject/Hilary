 ...
 * @param {String}          resourceSubType                 The type of content for which this processor should be registered. Usually one of `file`, `document` and `link`
...
var registerProcessor = module.exports.registerProcessor = function(processorId, resourceSubType, mimeTypes, ranking, processorCallback) {
    ...
    validator.check(resourceSubType, 'Missing content type').notEmpty();
 ...
 *
 * @param  {String}     resourceSubType The type of content. Typically, 'file', 'document' or 'link'
