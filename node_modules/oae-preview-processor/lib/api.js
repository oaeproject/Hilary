...
var enable = module.exports.enable = function(callback) {
    ...
    MQ.bind(PreviewConstants.MQ.GENERATE_PREVIEWS, _handleGeneratePreviewsTask, options, function(err) {
        if (err) {
...
var disable = module.exports.disable = function(callback) {
    ...
    MQ.unbind(PreviewConstants.MQ.GENERATE_PREVIEWS, function(err) {
        if (err) {
...
var unregisterProcessor = module.exports.unregisterProcessor = function(processorId) {
    ...
    Object.keys(_processors).forEach(function(contentType) {
        Object.keys(_processors[contentType]).forEach(function(mimeType) {
            var newProcessors = [];
            _processors[contentType][mimeType].forEach(function(processor) {
...
var submitForProcessing = module.exports.submitForProcessing = function(contentId) {
    MQ.submit(PreviewConstants.MQ.GENERATE_PREVIEWS, {'id': contentId});
};
