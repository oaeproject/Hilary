...
var generateTestUsers = module.exports.generateTestUsers = function(restCtx, total, callback) {
    ...
    var userCreated = function(err, userObj, username) {
        ...
        if (_.keys(createdUsers).length === total) {
            var callbackArgs = _.union([null, createdUsers], _.values(createdUsers));
    ...
    var createUsers = function() {
        var _createUser = function() {
            ...
            var email = util.format('%s@oae-email.com', username);
            RestAPI.User.createUser(restCtx, username, 'password', displayName, {'email': email}, function(err, userObj) {
