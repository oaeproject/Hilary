...
const Invitation = require('oae-authz/lib/invitations/model').Invitation;
const ResourceActions = require('oae-resource/lib/actions');
const ResourceConstants = require('oae-resource/lib/constants').ResourceConstants;

const DiscussionsAPI = require('oae-discussions');
const DiscussionsConstants = require('oae-discussions/lib/constants').DiscussionsConstants;
 ...
 */
ResourceActions.when(ResourceConstants.events.ACCEPTED_INVITATION, (ctx, invitationHashes, memberChangeInfosByResourceId, inviterUsersById, token, callback) => {
    ...
    DiscussionsDAO.getDiscussionsById(discussionIds, null, (err, discussions) => {
        ...
        _.each(discussions, (discussion) => {
            ...
            return DiscussionsAPI.emit(DiscussionsConstants.events.UPDATED_DISCUSSION_MEMBERS, invitationCtx, discussion, memberChangeInfo, {invitation});
        });
    });
});
