...
/**
 * Get a parameter as an array. If the state of the parameter is unspecified (i.e., `null` or `undefined`), it will be
 * expressed as an empty array. If the parameter is not an array, it will be expressed as a single element array containing
 * the value. If the parameter is already an array, it will be returned as-is
 *
 * @param   {Anything}      val     The value to retrieve as an array
 * @return  {Anything[]}            The value as an array, as described in the summary
 */
var getArrayParam = module.exports.getArrayParam = function(val) {
    if (isUnspecified(val)) {
        return [];
