        ...
        it('verifies locale-specific template selection', function(callback) {
            TestsUtil.generateTestUsers(camAdminRestContext, 2, function(err, users) {
                ...
                EmailTestsUtil.sendEmail('oae-tests', 'TestCaOverride', mrvisser.user, null, null, function(err, message) {
                    ...
                    assert.equal(message.from, util.format('"Apereo OAE" <noreply@%s>', mrvisser.restContext.hostHeader));
                    ...
                    EmailTestsUtil.sendEmail('oae-tests', 'TestCaOverride', nico.user, null, null, function(err, message) {
                        ...
                        message = message._message;
                        assert.equal(message.from, util.format('"Apereo OAE" <noreply@%s>', nico.restContext.hostHeader));
                    ...
                    EmailTestsUtil.sendEmail('oae-tests', 'TestOverrideOverrides', mrvisser.user, null, null, function(err, message) {
                        ...
                        EmailTestsUtil.sendEmail('oae-tests', 'TestOverrideOverrides', nico.user, null, null, function(err, message) {
                            ...
                            EmailTestsUtil.sendEmail('oae-tests', 'TestOverrideOverrides', stuart.user, null, null, function(err, message) {
                                ...
                                message = message._message;
                                assert.equal(message.from, util.format('"Apereo OAE" <noreply@%s>', stuart.restContext.hostHeader));
                                ...
                                EmailTestsUtil.sendEmail('oae-tests', 'TestOverrideOverrides', clay.user, null, null, function(err, message) {
                                    ...
                                    message = message._message;
                                    assert.equal(message.from, util.format('"Apereo OAE" <noreply@%s>', clay.restContext.hostHeader));
                ...
                ConfigTestUtil.updateConfigAndWait(camAdminRestContext, null, {'oae-email/general/from': 'noreply@blahblahblah.com'}, function(err) {
                    ...
                    RestAPI.Content.createLink(coenego.restContext, 'Google', 'Google', 'private', 'http://www.google.com', [], [simong.user.id], function(err, link) {
                        ...
                        EmailTestsUtil.collectAndFetchEmails(function(messages) {
                            ...
                            assert.strictEqual(messages[0]['_message']['to'], simong.user.email);
                            assert.strictEqual(messages[0]['_message']['from'], 'noreply@blahblahblah.com');
                            ...
                            RestAPI.Config.clearConfig(camAdminRestContext, null, ['oae-email/general/from'], function(err) {
                                ...
                                RestAPI.Content.createComment(simong.restContext, link.id, 'I have never seen something like this before!', null, function(err, comment) {
                                    ...
                                    EmailTestsUtil.collectAndFetchEmails(function(messages) {
                                        ...
                                        assert.strictEqual(messages[0]['_message']['to'], coenego.user.email);
                                        assert.equal(messages[0]['_message']['from'], util.format('"Apereo OAE" <noreply@%s>', coenego.restContext.hostHeader));
                                        return callback();
                                    });
                                });
                            });
            ...
            TestsUtil.generateTestUsers(camAdminRestContext, 2, function(err, users, mrvisser, simong) {
                ...
                RestAPI.Content.createLink(mrvisser.restContext, 'Google', 'Google', 'private', 'http://www.google.com', [], [simong.user.id], function(err, link) {
                    ...
                    EmailTestsUtil.collectAndFetchEmails(function(messages) {
                        assert.ok(messages);
                        assert.ok(!_.isEmpty(messages));
                        assert.ok(messages[0]['_headers']['Message-Id']);
                        assert.ok(MSGID_OK.test(messages[0]['_headers']['Message-Id']));
                        return callback();
                    });
                });
            });
