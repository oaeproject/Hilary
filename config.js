 ...
 * @param  {String}     globalAdminInternalAddress  The hostname on which the global admin server can be reached by oae services such as the preview processor.
...
config.servers = {
    ...
    'globalAdminInternalAddress': undefined,
