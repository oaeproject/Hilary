...
module.exports = function(client) {
     ...
     */
    MixpanelUtil.listen(DiscussionsAPI, DiscussionsConstants.events.RETRIEVED_DISCUSSION_PROFILE, function(ctx, discussion) {
        var params = MixpanelUtil.getBasicParameters(ctx);
        params.id = discussion.id;
        params.visibility = discussion.visibility;
        client.track(DiscussionsConstants.events.RETRIEVED_DISCUSSION_PROFILE, params);
        client.people.increment(params.distinct_id, DiscussionsConstants.events.RETRIEVED_DISCUSSION_PROFILE);
    });

    /*!
     * Creating a discussion
     */
    MixpanelUtil.listen(DiscussionsAPI, DiscussionsConstants.events.CREATED_DISCUSSION, function(ctx, discussion, members) {
        var params = MixpanelUtil.getBasicParameters(ctx);
        params.id = discussion.id;
        params.visibility = discussion.visibility;
     ...
     */
    MixpanelUtil.listen(DiscussionsAPI, DiscussionsConstants.events.UPDATED_DISCUSSION, function(ctx, oldDiscussion, newDiscussion) {
        var params = MixpanelUtil.getBasicParameters(ctx);
        params.id = newDiscussion.id;
        params.newVisibility = newDiscussion.visibility;
        params.oldVisibility = oldDiscussion.oldVisibility;
     ...
     */
    MixpanelUtil.listen(DiscussionsAPI, DiscussionsConstants.events.UPDATED_DISCUSSION_MEMBERS, function(ctx, discussion, permissionChanges, newMemberIds, updatedMemberIds, removedMemberIds) {
