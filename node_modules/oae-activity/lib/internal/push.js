 ...
 */
ActivityEmitter.on(ActivityConstants.events.ROUTED_ACTIVITIES, function(routedActivities) {
    ...
    _.each(routedActivities, function(streamTypeActivities, resourceId) {
        ...
        _.each(streamTypeActivities, function(activity, streamType) {
            ...
            var streamOptions = ActivityRegistry.getRegisteredActivityStreamType(streamType);
            if (OaeUtil.getObjectProperty(streamOptions, 'push.delivery.phase', 'routing') === 'routing') {
...
/*!
 * Send aggregated activitie to the push exchange
 */
ActivityEmitter.on(ActivityConstants.events.DELIVERED_ACTIVITIES, function(deliveredActivities) {
    ...
    _.each(deliveredActivities, function(streamTypeActivities, resourceId) {
        ...
        _.each(streamTypeActivities, function(activityInfo, streamType) {
            ...
            var streamOptions = ActivityRegistry.getRegisteredActivityStreamType(streamType);
            if (OaeUtil.getObjectProperty(streamOptions, 'push.delivery.phase', 'routing') === 'aggregation') {
