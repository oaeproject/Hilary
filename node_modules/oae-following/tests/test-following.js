...
describe('Following', function() {
  ...
  it('verify follow validation', function(callback) {
    TestsUtil.generateTestUsers(camAdminRestContext, 2, function(
      ...
      // Verify a non-valid id
      RestAPI.Following.follow(bert.restContext, 'not-a-valid-id', function(
        err,
      ) {
        assert.ok(err);
        assert.equal(err.code, 400);
        ...
        // Verify a resource id that is not a user
        RestAPI.Following.follow(bert.restContext, 'g:not-a:user-id', function(
          err,
        ) {
          assert.ok(err);
          assert.equal(err.code, 400);
  ...
  it('verify paging of the following feed', function(callback) {
    TestsUtil.generateTestUsers(camAdminRestContext, 10, function(
      ...
      var followingUserIds = _.map(_.values(testUsers), function(testUser) {
