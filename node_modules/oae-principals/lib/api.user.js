...
* @param  {type} disableUsers {description}
* @param  {type} callback     {description}
* @return {type} {description}
*/
var deleteOrRestoreUsersByTenancy = module.exports.deleteOrRestoreUsersByTenancy = function (tenantAlias, disableUsers, callback) {
...
var _getAllUsersForTenant = function (tenantAlias, callback) {
     ...
     */
    var _aggregateUsers = function (principalHashes, callback) {
...
* @param  {type} usersToRestore {description}
* @param  {type} afterRestored  {description}
* @return {type} {description}
*/
var _restorePrincipals = function (usersToRestore, afterRestored) {
    async
        .map(usersToRestore, function(eachUser, transformed) {
            PrincipalsDAO.restorePrincipal(eachUser.principalId, function(err) {
                transformed(null, eachUser);
            });
