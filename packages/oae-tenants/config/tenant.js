...
export const title = 'OAE Tenant Module';
export const block_1 = _createBlock({
  type: 'search',
  xs: '12',
  sm: '12',
  md: '12',
...
export const block_2 = _createBlock({
  type: 'video',
  xs: '12',
  sm: '12',
  md: '8',
...
export const block_3 = _createBlock({
  type: 'text',
  xs: '12',
  sm: '6',
  md: '4',
...
export const block_5 = _createBlock({
  type: 'iconText',
  xs: '12',
  sm: '6',
  md: '4',
...
export const block_8 = _createBlock();
export const block_9 = _createBlock();
export const block_10 = _createBlock();
export const block_11 = _createBlock();
export const block_12 = _createBlock();
