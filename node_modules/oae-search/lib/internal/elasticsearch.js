 ...
 * @param  {Object}     callback.err    An error that occurred, if any
 */
var deleteByQuery = module.exports.deleteByQuery = function(typeName, query, options, callback) {
    log().trace({'typeName': typeName, 'query': query, 'options': options}, 'Deleting search documents by query');
