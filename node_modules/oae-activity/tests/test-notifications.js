...
describe('Notifications', function() {
  ...
  describe('Notification Stream', function() {
    ...
    it('verify anonymous cannot get a notification stream', function(callback) {
      TestsUtil.generateTestUsers(camAdminRestContext, 1, function(
        ...
        assert.ok(!err);
        RestAPI.Activity.getNotificationStream(
          ...
          function(err, content) {
            ...
            ActivityTestsUtil.collectAndGetNotificationStream(
              ...
              function(err, notificationStream) {
                ...
                assert.equal(
                  notificationStream.items[0].actor['oae:id'],
                  mrvisser.user.id,
                );
                assert.equal(
  ...
  describe('Mark Notifications Read', function() {
    ...
    it('verify anonymous cannot mark a notification stream as read', function(callback) {
      RestAPI.Activity.markNotificationsRead(anonymousCamRestContext, function(
        err,
      ) {
        assert.ok(err);
        assert.equal(err.code, 401);
                  ...
                  RestAPI.User.getMe(simong.restContext, function(err, me) {
                    ...
                    ActivityTestsUtil.markNotificationsAsRead(
                      ...
                      function(result) {
                        ...
                        assert.strictEqual(
                          lastReadTime,
                          OaeUtil.getNumberParam(lastReadTime),
                        );
                ...
                RestAPI.Content.createLink(
                  ...
                  function(err, link) {
                    ...
                    EmailTestsUtil.collectAndFetchAllEmails(function(messages) {
                      ...
                      var seed = new ActivityModel.ActivitySeed(
