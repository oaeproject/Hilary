...
var TenantConfig = ConfigAPI.config('oae-tenants');
...
var _constructCallbackUrl = function(tenant, strategy) {
    var usehttps = TenantConfig.getValue(tenant.alias, 'web', 'usehttps');
    var url = (usehttps) ? 'https://' : 'http://';
    url += tenant.host + '/api/auth/' + strategy + '/callback';
    return url;
};
...
strategySetup[AuthenticationConstants.providers.CAS] = function(tenant, strategyId) {
    ...
    var usehttps = TenantConfig.getValue('web', 'usehttps');
    var protocol = (usehttps) ? 'https' : 'http';

    var strategy = new CasStrategy({
        'serverBase': protocol + '://' + tenant.host,
        'allow': '',
        'service': protocol + '://' + tenant.host + '/api/auth/cas/callback',
        'casHost': casHost,
