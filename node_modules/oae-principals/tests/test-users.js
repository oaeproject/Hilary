...
describe('Users', function() {
  ...
  describe('Full User Profile Decorators', function() {
    ...
    it('verify register full user profile decorator error scenarios', function(callback) {
      ...
      PrincipalsAPI.registerFullUserProfileDecorator(testId, function(
        ctx,
        user,
        callback,
      ) {
    ...
    it('verify various user profile decorator response types', function(callback) {
      ...
      TestsUtil.generateTestUsers(camAdminRestContext, 1, function(err, user) {
        ...
        RestAPI.User.getUser(user.restContext, user.user.id, function(
          err,
          userProfile,
        ) {
          assert.ok(!err);
    ...
    it('verify a user profile decorator cannot overwrite existing user properties', function(callback) {
      ...
      PrincipalsAPI.registerFullUserProfileDecorator('visibility', function(
        ctx,
        user,
        callback,
      ) {
  ...
  describe('Create user', function() {
                ...
                function() {
                  ...
                  PrincipalsTestUtil.assertCreateUserFails(
                    ...
                    function() {
                      ...
                      AuthzInvitationsDAO.getOrCreateTokensByEmails(
                        [email],
                        function(err, emailTokens) {
                          assert.ok(!err);
        ...
        function(err, recaptchaTenant) {
          ...
          ConfigTestUtil.updateConfigAndWait(
            ...
            function(err) {
              ...
              var recaptchaAnonymousRestContext = TestsUtil.createTenantRestContext(
                host,
              );
              PrincipalsTestUtil.assertCreateUserFails(
                    ...
                    function(createdUser) {
                      ...
                      assert.equal(
                        ...
                        '/user/' +
                          ...
                          '/' +
                          AuthzUtil.getResourceFromId(createdUser.id)
                            .resourceId,
                      );
                      var userRestContext = TestsUtil.createTenantRestContext(
                        global.oaeTests.tenants.cam.host,
                        params.username,
                        params.password,
                      );
                                            ...
                                            function(err, userObj) {
                                              ...
                                              RestAPI.User.createUserOnTenant(
                                                ...
                                                function(err, userObj) {
                                                  ...
                                                  var email6 = TestsUtil.generateTestEmailAddress(
                                                    null,
                                                    global.oaeTests.tenants.cam
                                                      .emailDomains[0],
                                                  );
                                                  RestAPI.User.createUserOnTenant(
                                                    ...
                                                    function(err, userObj) {
                                                      ...
                                                      newUsername = TestsUtil.generateTestUserId();
                                                      var email7 = TestsUtil.generateTestEmailAddress(
                                                        null,
        ...
        function(err) {
          ...
          ConfigTestUtil.updateConfigAndWait(
            ...
            function(err) {
              ...
              _verifyCreateUserWithEmailDomain(
                tenantHost,
                emailDomain1,
                function() {
                  _verifyCreateUserWithEmailDomain(
                      ...
                      RestAPI.Tenants.updateTenant(
                        ...
                        function(err) {
                          ...
                          _verifyCreateUserWithEmailDomain(
                            ...
                            emailDomain1,
                            function() {
                              _verifyCreateUserWithEmailDomainFails(
                                tenantHost,
                                emailDomain2,
                                function() {
                                  return callback();
     ...
     * @api private
     */
    var _verifyCreateUserWithEmailDomain = function(
      tenantHost,
      emailDomain,
      callback,
    ) {
      ...
      return PrincipalsTestUtil.assertCreateUserSucceeds(
        restContext,
        params,
        callback,
      );
     ...
     * @api private
     */
    var _verifyCreateUserWithEmailDomainFails = function(
      tenantHost,
      emailDomain,
      callback,
    ) {
      ...
      return PrincipalsTestUtil.assertCreateUserFails(
        restContext,
        params,
        400,
        callback,
              ...
              RestAPI.User.createUser(
                ...
                function(err) {
                  ...
                  RestAPI.Authentication.login(
                    ...
                    function(err) {
                      assert.ok(!err);
                      RestAPI.User.getMe(userRestContext, function(
                        err,
                        meData,
                      ) {
                        assert.ok(!err);
            ...
            function(err) {
              ...
              RestAPI.User.createUser(
                ...
                function(err, createdUser2) {
                  ...
                  var acceptLanguageRestContext = new RestContext(
                    'http://localhost:2001',
                    {
      ...
      RestAPI.User.getMe(acceptLanguageRestContext, function(err, meData) {
        ...
        RestAPI.User.getMe(acceptLanguageRestContext, function(err, meData) {
          ...
          RestAPI.User.getMe(acceptLanguageRestContext, function(err, meData) {
            ...
            RestAPI.User.getMe(acceptLanguageRestContext, function(
              err,
              meData,
            ) {
              assert.ok(!err);
              ...
              RestAPI.User.getMe(acceptLanguageRestContext, function(
                ...
                var acceptLanguageRestContext = new RestContext(
                  'http://localhost:2001',
                  {
                    hostHeader: global.oaeTests.tenants.cam.host,
                    additionalHeaders: {
                      'Accept-Language': 'qq-ZZ, zz-ZZ;q=0.50, qq-QQ;q=0.30',
                    },
                  },
                );
                RestAPI.User.getMe(acceptLanguageRestContext, function(
    ...
    var getDataFileStream = function(filename) {
      return function() {
        return fs.createReadStream(
          util.format('%s/data/%s', __dirname, filename),
        );
      };
    };
      ...
      TestsUtil.createTenantWithAdmin(tenantAlias, tenantHost, function(
        ...
        PrincipalsTestUtil.importUsers(
          ...
          function(err) {
            ...
            var nicolaasRestContext = TestsUtil.createTenantRestContext(
              tenant.host,
              'user-zfdHliPLa',
              'password1',
            );
            RestAPI.User.getMe(nicolaasRestContext, function(
              err,
              nicolaasMeObj,
            ) {
              _verifyUser(
              ...
              var simonRestContext = TestsUtil.createTenantRestContext(
                tenant.host,
                'user-HlKKreaDP',
                'password4',
              );
              RestAPI.User.getMe(simonRestContext, function(err, simonMeObj) {
                ...
                var stuartRestContext = TestsUtil.createTenantRestContext(
                  tenant.host,
                  'user-IrewPDSAw',
                  'password5',
                );
                RestAPI.User.getMe(stuartRestContext, function(
                  err,
                  stuartMeObj,
                ) {
                  _verifyUser(
                  ...
                  var stephenRestContext = TestsUtil.createTenantRestContext(
                    tenant.host,
                    'user-bbLwAWxpd',
                    'password26',
                  );
                  RestAPI.User.getMe(stephenRestContext, function(
                    err,
                    stephenMeObj,
                  ) {
                    _verifyUser(
      ...
      TestsUtil.createTenantWithAdmin(tenantAlias, tenantHost, function(
        ...
        PrincipalsTestUtil.importUsers(
          ...
          function(err) {
            ...
            var mrvisser1RestContext = TestsUtil.createTenantRestContext(
              tenant.host,
              'userdefaultvisibilitytest1',
              'password',
            );
            RestAPI.User.getMe(mrvisser1RestContext, function(
              err,
              createdUser,
            ) {
              assert.ok(!err);
                ...
                function(err) {
                  ...
                  PrincipalsTestUtil.importUsers(
                    ...
                    function(err) {
                      ...
                      var mrvisser2RestContext = TestsUtil.createTenantRestContext(
                        tenant.host,
                        'userdefaultvisibilitytest2',
                        'password',
                      );
                      RestAPI.User.getMe(mrvisser2RestContext, function(
                        err,
                        createdUser,
                      ) {
                        assert.ok(!err);
                            ...
                            AuthenticationAPI.getUserIdFromLoginId(
                              ...
                              function(err) {
                                ...
                                RestAPI.User.getUser(
                                  tenantAdminRestContext,
                                  simonUserId,
                                  function(err, simonUserObj) {
                                    assert.ok(!err);
                                    assert.ok(simonUserObj);
                                    assert.equal(
                                      simonUserObj.displayName,
                                      'Gaeremynck',
                                    );
                                    assert.equal(
                                      simonUserObj.email,
        ...
        PrincipalsTestUtil.importUsers(
          ...
          function(err) {
            ...
            RestAPI.User.getMe(userRestContext, function(err, me) {
              ...
              assert.strictEqual(
                me.email,
                'user1@users.with.another.email.domain.tests.com',
              );
  ...
  describe('Get user', function() {
    ...
    it('verify get user', function(callback) {
      ...
      TestsUtil.generateTestUsers(camAdminRestContext, 1, function(
        ...
        RestAPI.User.getUser(globalAdminRestContext, jack.user.id, function(
          err,
          retrievedUser,
        ) {
          assert.ok(!err);
          ...
          // Get the user
          RestAPI.User.getUser(anonymousRestContext, jack.user.id, function(
            err,
            retrievedUser,
          ) {
            assert.ok(!err);
                      ...
                      function(err, retrievedUser) {
                        ...
                        assert.equal(
                          ...
                          '/user/' +
                            retrievedUser.tenant.alias +
                            '/' +
                            AuthzUtil.getResourceFromId(retrievedUser.id)
                              .resourceId,
                        );
                        assert.ok(_.isObject(retrievedUser.tenant));
                        assert.equal(_.keys(retrievedUser.tenant).length, 3);
    ...
    it('verify that the me feed returns a tenant object', function(callback) {
      TestsUtil.setupMultiTenantPrivacyEntities(function(
        ...
        RestAPI.User.getMe(publicTenant1.publicUser.restContext, function(
          err,
          meData,
        ) {
          assert.ok(!err);
          ...
          assert.strictEqual(
            ...
            publicTenant1.tenant.displayName,
          );
          ...
          assert.deepEqual(
            ...
            publicTenant1.tenant.emailDomains,
          );

          // Verify it for an anonymous user
          RestAPI.User.getMe(publicTenant1.anonymousRestContext, function(
            err,
            meData,
          ) {
            assert.ok(!err);
            ...
            RestAPI.User.getMe(privateTenant1.publicUser.restContext, function(
              err,
              meData,
            ) {
              assert.ok(!err);
              ...
              assert.strictEqual(
                meData.tenant.displayName,
                privateTenant1.tenant.displayName,
              );
              assert.strictEqual(
                meData.tenant.alias,
              ...
              RestAPI.User.getMe(privateTenant1.anonymousRestContext, function(
                err,
                meData,
              ) {
                assert.ok(!err);
        ...
        RestAPI.User.setTenantAdmin(
          ...
          function(err) {
            ...
            RestAPI.Admin.loginAsUser(
              ...
              function(err, simonImpersonatingMrvisserRestContext) {
                assert.ok(!err);

                // Get the me feed of the impersonator to verify the data model
                RestAPI.User.getMe(
                  simonImpersonatingMrvisserRestContext,
                  function(err, me) {
                    assert.ok(!err);
                    ...
                    assert.equal(
                      me.imposter.tenant.alias,
                      simon.user.tenant.alias,
                    );
                    assert.equal(
                      me.imposter.tenant.displayName,
                      simon.user.tenant.displayName,
                    );
                    assert.equal(me.imposter.id, simon.user.id);
                    assert.equal(
                      me.imposter.displayName,
                      simon.user.displayName,
                    );
                    ...
                    assert.equal(
                      me.imposter.publicAlias,
                      simon.user.publicAlias,
                    );
                    assert.equal(
                      me.imposter.profilePath,
                      simon.user.profilePath,
                    );
                    assert.equal(
                      me.imposter.resourceType,
                      simon.user.resourceType,
                    );
    ...
    it('verify visibility of isGlobalAdmin and isTenantAdmin properties', function(callback) {
      ...
      TestsUtil.generateTestUsers(camAdminRestContext, 1, function(
        ...
        // Create a GT user
        TestsUtil.generateTestUsers(gtAdminRestContext, 1, function(
          err,
          gtUsers,
          gtUser,
        ) {
            ...
            function(err, user) {
              ...
              RestAPI.User.getUser(
                ...
                function(err, user) {
                  ...
                  RestAPI.User.getMe(camAdminRestContext, function(
                    err,
                    camAdminUser,
                  ) {
                    assert.ok(!err);
                    ...
                    RestAPI.User.getUser(
                      ...
                      function(err, user) {
                        ...
                        RestAPI.User.getMe(globalAdminRestContext, function(
                          err,
                          globalAdminUser,
                        ) {
                          assert.ok(!err);
                          assert.strictEqual(
                            globalAdminUser.isGlobalAdmin,
                            true,
                          );
                          assert.strictEqual(
                            globalAdminUser.isTenantAdmin,
                            false,
                          );
                          RestAPI.User.getUser(
                            globalAdminRestContext,
    ...
    it('verify get user by ugly username', function(callback) {
      ...
      RestAPI.User.createUser(
        ...
        email1,
        { visibility: 'public' },
        function(err, userObj1) {
          assert.ok(!err);
          assert.ok(userObj1);

          // Get the user
          RestAPI.User.getUser(anonymousRestContext, userObj1.id, function(
            err,
            retrievedUser1,
          ) {
            assert.ok(!err);
                  ...
                  function(err, retrievedUser2) {
                    ...
                    assert.equal(
                      ...
                      '/user/' +
                        ...
                        '/' +
                        AuthzUtil.getResourceFromId(retrievedUser2.id)
                          .resourceId,
                    );
                    return callback();
                  },
                ...
                RestAPI.User.getMe(jack.restContext, function(err, me) {
                  ...
                  assert.equal(
                    ...
                    '/user/' +
                      me.tenant.alias +
                      '/' +
                      AuthzUtil.getResourceFromId(me.id).resourceId,
                  );
                    ...
                    RestAPI.User.getMe(jack.restContext, function(err, me) {
                      ...
                      PrincipalsTestUtil.assertUpdateUserSucceeds(
                        ...
                        function(user, token) {
                          ...
                          // Assert there's no need to verify the email address (as it hasn't changed)
                          RestAPI.User.getMe(jack.restContext, function(
                            err,
                            me,
                          ) {
                            assert.ok(!err);
  ...
  describe('User visibility', function() {
    /*!
         ...
         * @param  {Function}      callback                Standard callback function
         */
    var verifyProfilePermissions = function(
      restContext,
      userToCheck,
      expectAccess,
      expectedDisplayName,
    ...
    it('verify user permissions', function(callback) {
      ...
      RestAPI.User.createUser(
        ...
        function(err, jack) {
          assert.ok(!err);
          assert.ok(jack);
          var jackRestContext = TestsUtil.createTenantRestContext(
            global.oaeTests.tenants.cam.host,
            jackUserId,
            'password',
          );
          ...
          RestAPI.User.createUser(
            ...
            function(err, jane) {
              assert.ok(!err);
              assert.ok(jane);
              var janeRestContext = TestsUtil.createTenantRestContext(
                global.oaeTests.tenants.cam.host,
                janeUserId,
                'password',
              );
    ...
    it('verify loggedin user is hidden beyond tenant scope', function(callback) {
      ...
      RestAPI.User.createUser(
        ...
        function(err, userA) {
          assert.ok(!err);
          var restCtxA = TestsUtil.createTenantRestContext(
            global.oaeTests.tenants.cam.host,
            usernameA,
            'password',
          );
          ...
          RestAPI.User.createUser(
            ...
            function(err, userB) {
              assert.ok(!err);
              var restCtxB = TestsUtil.createTenantRestContext(
                global.oaeTests.tenants.gt.host,
                usernameB,
                'password',
              );
      ...
      TestsUtil.generateTestUsers(camAdminRestContext, 3, function(
        ...
        RestAPI.User.setTenantAdmin(
          ...
          function(err) {
            ...
            PrincipalsAPI.getUser(globalAdminContext, jane.user.id, function(
              err,
              user,
            ) {
              assert.ok(!err);
                                    ...
                                    function(err) {
                                      ...
                                      PrincipalsAPI.setGlobalAdmin(
                                        ...
                                        function(err) {
                                          ...
                                          PrincipalsAPI.setGlobalAdmin(
                                            new Context(
                                              global.oaeTests.tenants.global,
                                            ),
                                            sam.user.id,
                                            false,
                                            function(err) {
                      ...
                      RestAPI.User.getMe(joe.restContext, function(err, meObj) {
                        ...
                        RestAPI.User.updateUser(
                          ...
                          function(err) {
                            ...
                            RestAPI.User.getMe(jane.restContext, function(
                              err,
                              meObj,
                            ) {
                              assert.ok(!err);
                              ...
                              assert.equal(
                                ...
                                '/user/' +
                                  meObj.tenant.alias +
                                  '/' +
                                  AuthzUtil.getResourceFromId(meObj.id)
                                    .resourceId,
                              );
