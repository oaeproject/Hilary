...
var _handleRegeneratePreviewsTask = function(data, callback) {
    ...
    if (!data.filters) {
        ...
        return callback({'code': 400, 'msg': 'An regenerate previewsinvalid task was submitted to the regenerate previews task queue.'});
    }
...
var _initializeDefaultProcessors = function(callback) {
    ...
    OfficeProcessor.init(config.previews.office, function(err) {
        ...
        PDFProcessor.init(config.previews, callback);
    });
};
