 ...
 * @FormParam   {string[]}          [managers]          Unique identifier(s) for users and groups to add, or email addresses to invite, as managers of the discussion. The user creating the discussion will be added as a manager automatically
 * @FormParam   {string[]}          [members]           Unique identifier(s) for users and groups to add, or email addresses to invite, as members of the discussion
