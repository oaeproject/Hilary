 ...
 */
const Discussion = module.exports.Discussion = function(tenant, id, createdBy, displayName, description, visibility, created, lastModified) {
    const resourceId = AuthzUtil.getResourceFromId(id).resourceId;
    const that = {};
    that.tenant = tenant;
    that.id = id;
