 ...
 */
OAE.tenantRouter.on('get', '/api/lti/:groupId/:id', function(req, res) {
    LtiApi.getLtiTool(req.ctx, req.params.id, req.params.groupId, function(err, tool) {
        if (err) {
 ...
 */
OAE.tenantRouter.on('delete', '/api/lti/:groupId/:id', function(req, res) {
    LtiApi.deleteLtiTool(req.ctx, req.params.id, req.params.groupId, function(err) {
        if (err) {
            return res.send(err.code, err.msg);
        }
