...
var test = module.exports.test = function(ctx, content, callback) {
    if (content.resourceSubType === 'file' && MediaCoreConfig.getValue('admin', 'mediacore', 'enabled')) {
        if (_isVideo(content.mime) || _isAudio(content.mime)) {
    ...
    ctx.download(function(err, path) {
        ...
        request.post({
            ...
            MediaCoreDAO.saveContentRevisionId(mediaId, ctx.contentId, ctx.revisionId, function(err) {
                ...
                var uploadType = (_isVideo(content.mime)) ? 'video' : 'audio';
                ...
                request.post({
                    ...
                    'json': {
                        ...
                        'upload_name': content.displayName,
                        'upload_size': content.size
                    }
                }, function(err, res, body) {
