...
var _handleSignedDownload = function(req, res) {
    ContentAPI.verifySignedDownloadQueryString(req.ctx, req.query, function(err, downloadInfo) {
        ...
        return _handleDownload(res, downloadInfo);
    });
};
 ...
 * @Method      POST
 * @Path        /content/create
 * @BodyParam   {NewContent}         body                   Information about content to create
 * @FormParam   {File}               file                   Binary contents of file
 * @Return      {Content}                                   Returns an object representing the content
 */
 ...
 * @Return      {ContentProfile}                            Returns an object representing full content profile
 */
 ...
 * @BodyParam   {UpdatedContent}        body                Updated content information
 * @Return      {Content}                                   Returns an object representing the updated content
 */
 ...
 * @Return      {File}                                      Returns the content object
 */
...
/**
 * @REST postContentContentIdPublish
 *
 ...
 * @PathParam   {string}             contentId              Unique identifier for collaborative document to publish
 * @Return      {Content}                                   Returns an object representing the content
 */
 ...
 * @Return      {CollabDoc}                                 Returns an object representing the collaborative document
 */
 ...
 * @PathParam   {string}             contentId              Unique identifier for content
 * @PathParam   {string}             revisionId             Unique identifier for content revision
 * @BodyParam   {PreviewInfo}        body                   Information about preview item
 ...
 * @PathParam   {string}             contentId              Unique identifier for content
 * @PathParam   {string}             revisionId             Unique identifier for content revision
 * @Return      {PreviewList}                               Returns preview information for content
 */
 ...
 * @Return      {File}                                      Returns the preview item
 */
 ...
 * @Return      {RevisionsResponse}                     Returns an object containing revisions information
 */
 ...
 * @PathParam   {string}            contentId           Unique identifier for content
 * @PathParam   {string}            revisionId          Unique identifier for content revision
 * @Return      {Revision}                              Returns an object containing revision information
 */
 ...
 * @PathParam   {string}            contentId           Unique identifier for content
 * @PathParam   {string}            revisionId          Unique identifier for content revision
 * @Return      {Revision}                              Returns an object containing new revision information
 */
 ...
 * @Return      {MembersResponse}                       Returns an object containing member information
 */
 ...
 * @Path        /content/{contentId}/members
 * @PathParam   {string}                contentId           Unique identifier for content
 * @BodyParam   {MemberPermissionList}  body                List of users and associated permission
 */
 ...
 * @PathParam   {string}        contentId           Unique identifier for content
 * @BodyParam   {ViewerList}    body                List of users with whom to share content
 */
 ...
 * @PathParam   {string}        contentId           Unique identifier for content
 * @BodyParam   {NewMessage}    body                Comment for content
 */
 ...
 * @Return      {File}                              Returns the content item
 */
 ...
 * @api private
 */
var _handleDownload = function(res, downloadInfo) {
 ...
 * @RESTModel Content
 *
 * @Required    [created,createdBy,description,displayName,id,lastModified,latestRevisionId,previews,resourceSubType,tenantAlias,visibility]
 ...
 * @Property    {number}     created            Timestamp at which this content item was created in milliseconds since epoch
 * @Property    {User}       createdBy          User who created this content item
 * @Property    {string}     description        Description of the content item
 * @Property    {string}     displayName        Title of the content item
...
/**
 * @RESTModel MemberPermissionList
 *
 * @Required    [{userId}]
 * @Property    {string}       {userId}         Permission for named user [false,manager,viewwer]
 */

/**
 * @RESTModel NewContent
 *
 * @Required    [description,displayName,resourceSubType,visibility]
 ...
 * @Property    {string[]}      manager             Unique identifier(s) for manager(s) of the content (user creating discussion is always a manager)
 * @Property    {string[]}      viewer              Unique identifiers(s) for users(s) who can access the content
 ...
 *
 * @Required    [contentMetadata,previewMetadata,status]
 ...
 * @Property    {UpdatedPreview}    previewMetadata     Updated information about preview
 * @Property    {PreviewSize}       sizes               Size of preview image
 * @Property    {string}            status              Status of preview processing        [done,error,ignored,pending]
 */
 ...
 * @RESTModel Revision
 *
 * @Required [created,createdBy,contentId,opts,previews,previewsId,revisionId]
 * @Property    {string}        contentId       Unique content ID of the piece of content
