    ...
    describe('Update group', function() {
        ...
        it ('verify successful update', function(callback) {
            RestAPI.Group.createGroup(johnRestContext, 'Group title', 'Group description', 'private', 'request', [], [], function(err, newGroup) {
                ...
                RestAPI.Group.updateGroup(johnRestContext, newGroup.id, profileFields, function(err, newGroup) {
                    assert.ok(!err);
                    assert.equal(newGroup.displayName, 'new group name');
        ...
        it ('verify update non-existent group', function(callback) {
            ...
            RestAPI.Group.updateGroup(johnRestContext, groupId, {'joinable': 'yes'}, function(err, newGroup) {
        ...
        it ('verify updating a group with no parameters', function(callback) {
            RestAPI.Group.createGroup(johnRestContext, 'Group title', 'Group description', 'private', 'request', [], [], function(err, newGroup) {
                assert.ok(!err);
                RestAPI.Group.updateGroup(johnRestContext, newGroup.id, {}, function(err, newGroup) {
                    assert.equal(err.code, 400);
                    assert.ok(!newGroup);
                    callback();
                });
        ...
        it ('verify invalid joinable', function(callback) {
            RestAPI.Group.createGroup(johnRestContext, 'Group title', 'Group description', 'private', 'request', [], [], function(err, newGroup) {
                assert.ok(!err);
                RestAPI.Group.updateGroup(johnRestContext, newGroup.id, {'joinable': 'invalid'}, function(err, newGroup) {
                    assert.equal(err.code, 400);
                    assert.ok(!newGroup);
                    callback();
                });
        ...
        it('verify invalid visibility', function(callback) {
            RestAPI.Group.createGroup(johnRestContext, 'Group title', 'Group description', 'private', 'request', [], [], function(err, newGroup) {
                assert.ok(!err);
                RestAPI.Group.updateGroup(johnRestContext, newGroup.id, {'visibility': 'invalid'}, function(err, newGroup) {
                    assert.equal(err.code, 400);
                    assert.ok(!newGroup);
                    callback();
                });
        ...
        it('verify group visibility', function(callback) {
            ...
            RestAPI.User.createUser(camAdminRestContext, nicolaasUserId, 'password', 'Nicolaas Matthijs', null, function(err, nicolaas) {
                ...
                RestAPI.User.createUser(camAdminRestContext, brandenUserId, 'password', 'Branden Visser', null, function(err, branden) {
                    ...
                    RestAPI.Group.createGroup(johnRestContext, 'Test Group', 'Group', 'public', 'yes', [], [nicolaas.id], function(err, groupObj) {
                        assert.ok(!err);
