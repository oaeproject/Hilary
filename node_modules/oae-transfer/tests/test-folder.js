...
describe('Transfer-folder', function() {
    ...
    describe('Account transfer impact on folders', function() {
         ...
         */
        it('verify if transfer update the permission if the target user have less right than origin user', function(callback) {
            // Generate user in cam tenant
            TestsUtil.generateTestUsers(camAdminRestContext, 2, function(err, users, mrvisser, userOrigin) {
                assert.ok(!err);
                // Generate user in gt tenant
         ...
         */
        it('verify if transfer do not update the permission if the target user have more right than origin user', function(callback) {
            // Generate user in cam tenant
            TestsUtil.generateTestUsers(camAdminRestContext, 2, function(err, users, mrvisser, userOrigin) {
                assert.ok(!err);
                // Generate user in gt tenant
