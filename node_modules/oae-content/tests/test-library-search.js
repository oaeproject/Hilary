...
describe('Library Search', function() {
    ...
    TestsUtil.generateTestUsers(camAdminRestContext, 1, function(err, users, simon) {
      ...
      RestAPI.Content.createLink(
        ...
        function(err, content) {
          assert.ok(!err);
          RestAPI.Content.createComment(simon.restContext, content.id, 'abcdefghi', null, function(
            err,
            comment
          ) {
            assert.ok(!err);
  ...
  describe('User Libraries', function() {
    ...
    it('verify the principal id gets validated', function(callback) {
      SearchTestsUtil.searchAll(camAdminRestContext, 'content-library', [''], null, function(
        err,
        results
      ) {
        ...
        TestsUtil.generateTestUsers(gtAdminRestContext, 1, function(err, users, darthVader) {
          ...
          RestAPI.Content.createLink(
            ...
            function(err, content) {
              ...
              RestAPI.Content.shareContent(doer.restContext, content.id, [jack.user.id], function(
                err
              ) {
                assert.ok(!err);
            ...
            function(err, group) {
              ...
              RestAPI.Content.createLink(
                ...
                function(err, content) {
                  ...
                  RestAPI.Content.shareContent(doer.restContext, content.id, [group.id], function(
                    err
                  ) {
                    assert.ok(!err);
