...
/**
 * Get the swagger resources list through the REST API.
 *
 * @param  {RestContext}  restCtx             Standard REST Context object that contains the current tenant URL and the current user credentials
 * @param  {Function}     callback            Standard callback method
 * @param  {Object}       callback.err        Error object containing error code and error message
 * @param  {ResourceList} callback.resources  Swagger resource list
 */
...
/**
 * Get the swagger api declaration of a particular resource through the REST API.
 *
 * @param  {RestContext}  restCtx             Standard REST Context object that contains the current tenant URL and the current user credentials
 * @param  {String}         resourceId          The resource to get the documentation for
 * @param  {Function}       callback            Standard callback method
 * @param  {Object}         callback.err        Error object containing error code and error message
 * @param  {ApiDeclaration} callback.api        Swagger api declaration
 */
var getSwaggerApi = module.exports.getSwaggerApi = function(restCtx, resourceId, callback) {
    console.log(RestUtil.encodeURIComponent(resourceId));
    RestUtil.RestRequest(restCtx, '/api/swagger/' + RestUtil.encodeURIComponent(resourceId), 'GET', null, callback);
};
