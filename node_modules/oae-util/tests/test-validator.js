...
describe('Utilities', function() {
    ...
    describe('Validator', function() {
        ...
        /**
         * Test whether or not the validator used to check for a logged in OAE
        ...
        it('verify context validator', function(callback) {
            ...
            // Invalid users
            var user4 = new User(tenant1.alias, null, 'nm417', 'public', 'Nicolaas', 'Matthijs', 'Nicolaas Matthijs');
            var user5 = new User(tenant1.alias, '', 'nm417', 'public', 'Nicolaas', 'Matthijs', 'Nicolaas Matthijs');
            ...
            assert.equal(validator.getErrorCount(), 4);
        ...
        it('verify isGlobalAdministratorUser validation', function(callback) {
            ...
            assert.equal(errors[2], 'An invalid tenant has been passed in');
