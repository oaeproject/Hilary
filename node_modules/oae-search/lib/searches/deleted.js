...
module.exports = function(ctx, opts, callback) {
    ...
    SearchUtil.filterScopeAndAccess(ctx, opts.scope, {'explicit': false}, function(err, filterScopeAndAccess) {
        if (err) {
            return callback(err);
        }
