...
module.exports = function(client) {
  ...
  MixpanelUtil.listen(
    ...
    function(ctx, principalId, visibility, start, limit, principals) {
  ...
  MixpanelUtil.listen(
    PrincipalsAPI,
    PrincipalsConstants.events.CREATED_USER,
    function(ctx, user) {
      var params = getBasicUserParameters(ctx, user);
