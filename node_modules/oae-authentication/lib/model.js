 ...
 * @param  {String}     signature       A signature that's valid for this host, userId, tenant and becomeUserId
 * @param  {String}     userId          The userId that needs to be passed to the tenant endpoint; this is the user that will be logged in
 * @param  {String}     [becomeUserId]  The id of the user the authenticating user is trying to "become". When the session is started with this token, the user represented by `userId` will be an "imposter" of the becomeUser in the session
 */
var SignedAuthenticationToken = module.exports.SignedAuthenticationToken = function(expires, protocol, host, signature, userId, becomeUserId) {
    var that = {};
