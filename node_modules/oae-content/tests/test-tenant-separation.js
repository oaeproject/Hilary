  ...
  describe('Tenant separation', function() {
      ...
      RestAPI.User.getMe(targetRestContext, function(err, me) {
        ...
        RestAPI.Content.shareContent(
          ...
          function(err) {
            ...
            var targetId = AuthzUtil.isEmail(targetPrincipalId)
              ? me.id
              : targetPrincipalId;
                                        ...
                                        verifyShare(
                                          ...
                                          function() {
                                            verifyShare(
                                              publicTenantB.adminRestContext,
                                              publicTenantB.publicContent,
                                              publicTenantA.loggedinUser.user
                                                .id,
    ...
    it('verify content sharing permutations from actor to object', function(callback) {
      ContentTestUtil.setupMultiTenantPrivacyEntities(function(
        ...
        TestsUtil.generateTestUsers(publicTenantA.adminRestContext, 3, function(
          err,
          users,
        ) {
          assert.ok(!err);
    ...
    it('verify content sharing permutations from actor to target (users)', function(callback) {
      ContentTestUtil.setupMultiTenantPrivacyEntities(function(
        ...
        // Create some more users as we can only share it with a target user once.
        TestsUtil.generateTestUsers(publicTenantB.adminRestContext, 3, function(
          err,
          users,
        ) {
          assert.ok(!err);
                      ...
                      RestAPI.Content.getLibrary(
                        ...
                        function(err, libraryA) {
                          ...
                          RestAPI.Content.getLibrary(
                            ...
                            null,
                            10,
                            function(err, libraryB) {
                              assert.ok(!err);
                              assert.equal(libraryB.results.length, 1);
                              assert.equal(
                                libraryB.results[0].id,
                                publicContentA.id,
                              );
                              return callback();
                            },
                ...
                RestAPI.Content.updateMembers(
                  ...
                  function(err) {
                    ...
                    RestAPI.Content.getMembers(
                      ...
                      function(err, data) {
                        assert.ok(!err);
                        var sharedMember = _.find(data.results, function(
                          member,
                        ) {
