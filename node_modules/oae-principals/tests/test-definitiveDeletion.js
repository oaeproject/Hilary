                    ...
                    PrincipalsTestUtil.generateLinks(userToDelete.restContext, 'private', 1, function(err, link) {
                        ...
                        PrincipalsTestUtil.generateCollabdocs(userToDelete.restContext, 'private', 1, function(err, collabdoc) {
                            ...
                            PrincipalsTestUtil.assertDefinitiveDeletionUsersSucceeds(camAdminRestContext, userToDelete, userArchive, function(err, resUserArchive) { 
                                ...
                                // Generate rights 
                                PrincipalsTestUtil.generateRightContent(userArchive, otherUser, 'manager', file[0], function(err) {
                                    assert.ok(!err);
                                    PrincipalsTestUtil.generateRightContent(userArchive, otherUser, 'manager', link[0], function(err) {
                                        assert.ok(!err);
                                        PrincipalsTestUtil.generateRightContent(userArchive, otherUser, 'manager', collabdoc[0], function(err) {
                                            assert.ok(!err);
