...
var setUpTenants = module.exports.setUpTenants = function(callback) {
    ...
    TenantsTestUtil.createTenantAndWait(globalAdminRestContext, 'camtest', 'Cambridge University Test', 'cambridge.oae.com', null, function(err, tenant) {
        assert.ok(!err);
        global.oaeTests.tenants.cam = tenant;

        // Create the Georgia Tech tenant
        TenantsTestUtil.createTenantAndWait(globalAdminRestContext, 'gttest', 'Georgia Tech Test', 'gt.oae.com', null, function(err, tenant) {
            assert.ok(!err);
...
var createTenantWithAdmin = module.exports.createTenantWithAdmin = function(tenantAlias, tenantHost, callback) {
    ...
    TenantsTestUtil.createTenantAndWait(adminCtx, tenantAlias, tenantAlias, tenantHost, null, function(err, tenant) {
        if (err) {
            return callback(err);
        }
...
var _createMultiPrivacyTenants = function(callback) {
    ...
    _createPublicTenant(publicTenantAlias, function(tenant, tenantAdmin) {
        var publicTenant = {
            'tenant': tenant,
        ...
        _createPublicTenant(publicTenant1Alias, function(tenant, tenantAdmin) {
            var publicTenant1 = {
                'tenant': tenant,
                'adminUser': tenantAdmin,
                'adminRestContext': tenantAdmin.restContext,
...
var _createPrivateTenant = function(tenantAlias, callback) {
    _createPublicTenant(tenantAlias, function(tenant, tenantAdmin) {
...
var _createPublicTenant = function(tenantAlias, callback) {
    createTenantWithAdmin(tenantAlias, tenantAlias, function(err, tenant, tenantAdminRestCtx, tenantAdminUser) {
        assert.ok(!err);
