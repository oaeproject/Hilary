 ...
 * @param {String}                  title               The title for this group
 ...
 * @param {Array<Userids>}          managers            An array of userids that should be made managers (Optional)
 * @param {Array<Userids>}          members             An array of userids that should be made members (Optional)
 ...
 */
var createGroup = module.exports.createGroup = function (context, title, description, visibility, joinable, managers, members, callback) {
    var postData = {
        'name': title
    }
    if (description) {
    ...
    RestUtil.switchUser(context, function(err, response, body) {
        request.post({
            'url': 'http://' + context.baseUrl + '/api/group/create',
            'method': 'POST',
            'form': postData
        }, function(err, response, body) {
            if (err) {
                return callback(new RestUtil.OaeError('Something went wrong trying to contact the server: ' + err));
            } else if (response.statusCode !== 201) {
                return callback(new RestUtil.RestError(response.statusCode, 'Could not create group: ' + body));
            }
     ...
     RestUtil.switchUser(context, function(err, response, body) {
        request.get('http://' + context.baseUrl + '/api/group/' + groupId, function(err, response, body) {
            if (err) {
                ...
                return callback(new RestUtil.RestError(response.statusCode, 'Could not get the group: ' + body));
            }
            callback(null, JSON.parse(body));
        });
    });
    ...
    RestUtil.switchUser(context, function(err, response, body) {
        request.post({
            ...
            if (err) {
                ...
                return callback(new RestUtil.RestError(response.statusCode, 'Could not update the group: ' + body));
            }
            callback(null);
        });
    });
    ...
    RestUtil.switchUser(context, function(err, response, body) {
        request.get(url, function(err, response, body) {
            if (err) {
                ...
                return callback(new RestUtil.RestError(response.statusCode, 'Could not get the group members: ' + body));
            }
            callback(null, JSON.parse(body));
        });
    });
    ...
    RestUtil.switchUser(context, function(err, response, body) {
        request.post({
            ...
            if (err) {
                ...
                return callback(new RestUtil.RestError(response.statusCode, 'Could not update the group members: ' + body));
            }
            callback(null);
        });
    });
    ...
    RestUtil.switchUser(context, function(err, response, body) {
        request.get('http://' + context.baseUrl + '/api/group/memberships/' + userid, function(err, response, body) {
            if (err) {
                ...
                return callback(new RestUtil.RestError(response.statusCode, 'Could not get the user his memberships: ' + body));
            }
            callback(null, JSON.parse(body));
        });
    });
