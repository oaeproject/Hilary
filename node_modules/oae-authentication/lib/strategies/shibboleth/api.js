 ...
 * parameters are valid the full tenant object will be returned
 *
...
/**
 * Get the URL where a users should be redirected to once mod_shib has
...
/**
 * Get a user by its ID. A signate is passed in that will be validated prior
