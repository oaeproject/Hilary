    ...
    it('verify it gives an error when subdomain is not properly configured for the tenant', function(callback) {
      ...
      UservoiceTestUtil.setConfig(
        ...
        function() {
          ...
          UservoiceTestUtil.assertRedirectHasError(
            camAdminRestContext,
            400,
            function() {
              ...
              UservoiceTestUtil.setConfig(
                ...
                function() {
                  // Ensure redirect gives a 400 error
                  return UservoiceTestUtil.assertRedirectHasError(
                    camAdminRestContext,
                    400,
                    callback,
                  );
  ...
  describe('Profiles', function() {
    ...
    it('verify it does not transfer private or loggedin user information', function(callback) {
      TestsUtil.generateTestUsers(camAdminRestContext, 3, function(
        ...
        var loggedinProfile = UservoiceProfile.createUservoiceProfile(
          loggedinUser,
        );
        ...
        var privateProfile = UservoiceProfile.createUservoiceProfile(
          privateUser,
        );
    ...
    it('verify it properly maps the user locale to either a UserVoice-supported locale or nothing', function(callback) {
      TestsUtil.generateTestUsers(camAdminRestContext, 1, function(
        ...
        assert.equal(
          UservoiceProfile.createUservoiceProfile(mrvisser).locale,
          'nl',
        );
