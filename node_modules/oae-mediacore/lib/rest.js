 ...
 * @HttpResponse                        500                 Error communicating with MediaCore server
 * @HttpResponse                        500                 Error parsing MediaCore response as JSON
 ...
 * @FormParam   {string}          media_id     The MediaCore item id
 * @Return      {void}
 ...
 * @HttpResponse                  500          Error parsing MediaCore response as JSON
 * @HttpResponse                  500          There was an unexpected error communicating with the media server. Code: ...
 */
