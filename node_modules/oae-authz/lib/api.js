...
var getPrincipalMembershipsGraph = module.exports.getPrincipalMembershipsGraph = function(principalId, callback) {
    ...
    Cassandra.runAllPagesQuery('AuthzMembershipsCache', 'principalId', principalId, 'groupId', null, function(err, pages) {
        if (err) {
            return callback(err);
...
var getRolesForPrincipalsAndResourceType = module.exports.getRolesForPrincipalsAndResourceType = function(principalIds, resourceType, callback) {
    ...
    var entries = {};
    _.each(principalIds, function(principalId) {
        Cassandra.runAllPagesQuery('AuthzRoles', 'principalId', principalId, 'resourceId', {'start': start, 'end': end}, function(err, pages) {
            if (err) {
                if (!finished) {
                    finished = true;
                    return callback(err);
