 ...
 */
exports.create = function (currentUser, contentId, name, description, additionalMembers, callback) {
	...
	getToken(currentUser, function (err, token) {
		...
		async.waterfall([
			...
			function createLoodle (end) {
				LoodleDAO.createLoodle(token, name, description, end);
			},
			// Save in db the matching contentId - loodleId
			function saveMatch (loodleId, end) {
...
exports.emitUpdateScheduleNotification = function (ctx, contentId, callback) {
	...
	log().info('emitUpdateScheduleNotification');
...
exports.emitUpdateVoteNotification = function (ctx, contentId, callback) {
	...
	log().info('emitUpdateVoteNotification');
