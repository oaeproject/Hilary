 ...
 * @param  {String}     contentType     The type of content this content item represents (e.g. file, sakaidoc, link)
 ...
 */
module.exports.Content = function(tenant, id, visibility, displayName, description, contentType, createdBy, created, lastModified) {
    var that = {};
