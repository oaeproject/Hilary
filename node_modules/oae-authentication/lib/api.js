 ...
 * @param  {String}       [opts.email]       The user his email address
 ...
 * A strategy needs to be registered during the start-up phase and will then be made active when the server
 ...
 * @throws {Error}                      An Error is thrown if another strategy was already registered with that name
 */
