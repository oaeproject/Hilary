 ...
 */
var createLtiTool = (module.exports.createLtiTool = function(
  id,
  groupId,
  launchUrl,
  secret,
  ...
  Cassandra.runQuery(query, parameters, function(err) {
    ...
    var ltiTool = new LtiTool(id, groupId, launchUrl, secret, consumerKey, {
 ...
 */
var getLtiTool = (module.exports.getLtiTool = function(id, groupId, callback) {
  Cassandra.runQuery(
 ...
 */
var getLtiToolsByGroupId = (module.exports.getLtiToolsByGroupId = function(
  groupId,
  callback,
) {
  Cassandra.runQuery(
    'SELECT * FROM "LtiTools" WHERE "groupId" = ?',
    [groupId],
    function(err, rows) {
      if (err) {
        return callback(err);
