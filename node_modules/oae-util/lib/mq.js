 ...
 *
 */
let rejectMessage = module.exports.rejectMessage = function(message, requeue, callback) {
    channel.reject(message, requeue); //.then(() => {
    // channelWrapper.nack(message, false, requeue).then(() => {
    return callback();
    // });
};
...
var init = module.exports.init = function(mqConfig, callback) {
    ...
    if (!connection) {
        ...
        // TODO fix this according to config
        connection = amqp.connect(['amqp://localhost'], {json: true});

            connection.on('connect', function() {
            });
            connection.on('disconnect', function(params) {
            });
        // amqp.connect(['amqp://localhost'], {}, (conn) => {
            // connection = conn;
            ...
            // TODO take care of this, maybe put it in setup function above?
...
var declareExchange = module.exports.declareExchange = function(exchangeName, exchangeOptions, callback) {
    ...
    // channel.assertExchange(exchangeName, exchangeOptions.type, exchangeOptions, (err, exchange) => {
    // TODO this is using promises!
...
var declareQueue = module.exports.declareQueue = function(queueName, queueOptions, callback) {
    ...
    // channel.assertQueue(queueName, queueOptions, function(err, queue) {
    // TODO this is using promises!
...
var _processBindQueue = function() {
    ...
    if (queuesToBind.length > 0 && !isWorking) {
        ...
        // channel.bindQueue(todo.queueName, todo.exchangeName, todo.routingKey, {}, function(err, ok) {
        // TODO this is using promises!
...
var subscribeQueue = module.exports.subscribeQueue = function(queueName, subscribeOptions, listener, callback) {
    ...
    channel.consume(queueName, function(msg) {
        ...
        // messageObj.deliveryInfo = deliveryInfo;
        // messageObj.exchange = msg.fields.exchange;
        // messageObj.routingKey = msg.fields.routingKey;

        // TODO I have no idea what I'm doing next:
        let headers =  msg.properties;
        let data = JSON.parse(msg.content.toString());
        let deliveryInfo = msg.fields;
        // deliveryInfo.exchange = data.exchange;
        // deliveryInfo.routingKey = data.routingKey;
        // deliveryInfo.queue = queues[queueName];
        ...
        try {
            ...
            listener(messageObj, function(err) {
                if (err) {
                    log().error({
                        'err': err,
                        'queueName': queueName,
