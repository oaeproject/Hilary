        ...
        it('verify footer template', function(callback) {
            TestsUtil.generateTestUsers(camAdminRestContext, 3, function(err, users, simong, nico, mrvisser) {
                ...
                EmailTestsUtil.collectAndFetchAllEmails(function() {
                     ...
                     * @param  {Boolean}        [assertions.expectInstance]             Whether or not the instance information should be present. Default: `false`
                     * @param  {Boolean}        [assertions.expectHostingOrganization]  Whether or not the host organization information should be present. Default: `false`
                    ...
                    var _assertEmailFooter = function(message, assertions) {
                        ...
                        if (assertions.expectHostingOrganization) {
                            ...
                            EmailTestsUtil.collectAndFetchAllEmails(function(messages) {
                                ...
                                ConfigTestUtil.updateConfigAndWait(globalAdminRestContext, null, updateConfigInstance, function(err) {
                                    ...
                                    RestAPI.Content.updateContent(mrvisser.restContext, link.id, {'displayName': 'Update 1'}, function(err, link) {
                                        assert.ok(!err);
                                        EmailTestsUtil.collectAndFetchAllEmails(function(messages) {
                                            _assertEmailFooter(messages[0], {'expectInstance': true});
                                            ...
                                            ConfigTestUtil.clearConfigAndWait(globalAdminRestContext, null, instanceConfigFields, function(err) {
                                                ...
                                                ConfigTestUtil.updateConfigAndWait(globalAdminRestContext, null, updateConfigHostingOrganization, function(err) {
                                                    ...
                                                    RestAPI.Content.updateContent(mrvisser.restContext, link.id, {'displayName': 'Update 2'}, function(err, link) {
                                                        assert.ok(!err);
                                                        EmailTestsUtil.collectAndFetchAllEmails(function(messages) {
                                                            _assertEmailFooter(messages[0], {'expectHostingOrganization': true});
                                                            ...
                                                            ConfigTestUtil.updateConfigAndWait(globalAdminRestContext, null, updateConfigInstance, function(err) {
                                                                ...
                                                                RestAPI.Content.updateContent(mrvisser.restContext, link.id, {'displayName': 'Update 3'}, function(err, link) {
                                                                    ...
                                                                    EmailTestsUtil.collectAndFetchAllEmails(function(messages) {
                                                                        _assertEmailFooter(messages[0], {
                                                                            'expectInstance': true,
                                                                            'expectHostingOrganization': true
                                                                        });
