 ...
 * @param  {Function}   callback        Standard callback function, invoked when the child search document has been created against the search index
 * @param  {Object}     callback.err    An error that occurred, if any
 */
var registerMessageSearchDocument = module.exports.registerMessageSearchDocument = function(name, resourceTypes, producer, callback) {
 ...
 */
var deleteMessageSearchDocument = module.exports.deleteMessageSearchDocument = function(name, resourceId, message) {
    var children = {};
