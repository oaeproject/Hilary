...
describe('Discussions', function() {
  ...
  beforeEach(function() {
    camAnonymousRestCtx = TestsUtil.createTenantRestContext(
      global.oaeTests.tenants.cam.host,
    );
    camAdminRestCtx = TestsUtil.createTenantAdminRestContext(
      global.oaeTests.tenants.cam.host,
    );
  });
  ...
  describe('Creating Discussions', function() {
    ...
    it('verify successful discussion creation and model', function(callback) {
      DiscussionsTestsUtil.setupMultiTenantPrivacyEntities(function(
        publicTenant,
      ) {
        var displayName = 'test-create-displayName';
        var description = 'test-create-description';
    ...
    it('verify update discussion validation', function(callback) {
      ...
      TestsUtil.generateTestUsers(camAdminRestCtx, 1, function(err, user) {
        ...
        RestAPI.Discussions.createDiscussion(
          ...
          null,
          null,
          function(err, createdDiscussion) {
            assert.ok(!err);
          ...
          function(err, discussion) {
            ...
            RestAPI.Discussions.updateDiscussion(
              ...
              function(err, discussion) {
                ...
                assert.ok(
                  parseInt(discussion.created, 10) <
                      ...
                      function(err, discussion) {
                        ...
                        RestAPI.Discussions.getDiscussion(
                          ...
                          function(err, discussion) {
                            ...
                            permissionChange[publicTenant.publicUser.user.id] =
                              'manager';
  ...
  describe('Deleting Discussions', function() {
    ...
    it('verify deleting a discussion properly cleans up associations', function(callback) {
      TestsUtil.generateTestUsers(camAdminRestCtx, 1, function(
        err,
        users,
        branden,
      ) {
    ...
    it('verify deleting a discussion', function(callback) {
      TestsUtil.generateTestUsers(camAdminRestCtx, 2, function(
        err,
        users,
        branden,
        simon,
        ...
        RestAPI.Discussions.createDiscussion(
          ...
          function(err, discussion) {
            ...
            RestAPI.Discussions.getDiscussion(
              branden.restContext,
              discussion.id,
              function(err, fetchedDiscussion) {
                assert.ok(!err);
                assert.ok(discussion);
                ...
                RestAPI.Discussions.getDiscussionMembers(
                  ...
                  function(err, members) {
                    ...
                    _.each(members.results, function(member) {
                      if (
                        member.profile.id === publicTenant.loggedinUser.user.id
                      ) {
                        hadPublicUser = true;
                        ...
                        member.profile.id === publicTenant.privateUser.user.id
                      ) {
                  ...
                  function(err, members) {
                    ...
                    RestAPI.Discussions.getDiscussionMembers(
                      ...
                      function(err, members) {
                        ...
                        _.each(members.results, function(member) {
                          assert.ok(
                            !_.contains(seenMembers, member.profile.id),
                          );
                        });
            ...
            RestAPI.Discussions.getDiscussionsLibrary(
              ...
              function(err, items) {
                ...
                assert.equal(
                  ...
                  publicTenant.publicDiscussion.createdBy,
                );
                assert.equal(
                  discussion.displayName,
                  publicTenant.publicDiscussion.displayName,
                ...
                assert.equal(
                  discussion.created,
                  publicTenant.publicDiscussion.created,
                );
                assert.ok(discussion.lastModified);
                return callback();
              },
              ...
              function(err, discussion2) {
                ...
                RestAPI.Discussions.getDiscussionsLibrary(
                  ...
                  function(err, items) {
                    ...
                    var oldLastModified =
                      discussion2.lastModified - 1 * 60 * 61 * 1000;
  ...
  describe('Messages', function() {
                  ...
                  function(err, message) {
                    ...
                    RestAPI.Discussions.createMessage(
                      ...
                      function(err, replyMessage) {
                        ...
                        assert.notEqual(
                          parseInt(replyMessage.created, 10),
                          NaN,
                        );
                                ...
                                RestAPI.Discussions.getMessages(
                                  ...
                                  function(err, messages) {
                                    ...
                                    _.each(messages.results, function(message) {
                                      ...
                                      if (
                                        message.createdBy.id === bert.user.id
                                      ) {
                                        assert.ok(
                                          message.createdBy.picture.small,
                                        );
                                        assert.ok(
                                          message.createdBy.picture.medium,
                                        );
                                        assert.ok(
                                          message.createdBy.picture.large,
                                        );
    ...
    it('verify listing messages, model and permissions', function(callback) {
      /*!
             ...
             */
      var _assertMessageModel = function(
        messageToTest,
        ...
        assert.equal(
          messageToTest.messageBoxId,
          messageToTestAgainst.messageBoxId,
        );
        ...
        assert.equal(
          messageToTest.createdBy.tenant.alias,
        ...
        assert.equal(
          messageToTest.createdBy.visibility,
          creatorToTestAgainst.visibility,
        );

        // Privacy check
        if (userScrubbed) {
          assert.equal(
            messageToTest.createdBy.displayName,
            creatorToTestAgainst.publicAlias,
          );
        } else {
          assert.equal(
            messageToTest.createdBy.displayName,
            creatorToTestAgainst.displayName,
          );
        }
      };
        ...
        RestAPI.Discussions.createMessage(
          ...
          function(err, publicMessage1) {
            ...
            RestAPI.Discussions.createMessage(
              ...
              function(err, replyPublicMessage1) {
                assert.ok(!err);
    ...
    /*!
         ...
         */
    var _assertDeleteMessagePermissions = function(
      tenant,
      managerUser,
      memberUser,
      nonMemberUser,
