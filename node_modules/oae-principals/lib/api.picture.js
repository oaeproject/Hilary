    ...
    ImageUtil.autoOrient(file.path, {'removeInput': true}, function(err, orientedFile) {
        ...
        ImageUtil.convertToJPG(orientedFile.path, function(err, convertedFile) {
            ...
            ContentUtil.getStorageBackend(ctx).store(ctx.tenant().alias, convertedFile, options, function(err, largePictureUri) {
                ...
                return PrincipalsDAO.updatePrincipal(principalId, {'largePictureUri': largePictureUri}, null, callback);
            });
        });
    });
};
...
var _saveCroppedPictureUris = function(ctx, principal, smallPictureUri, mediumPictureUri, callback) {
    ...
    PrincipalsDAO.updatePrincipal(principal.id, profileFields, null, function(err) {
        if (err) {
            return callback(err);
        }
