 ...
 *
 * @param  {String}     strategyName    The name under which this strategy should be registered. This string will be used in the Passport registry mechanisme
 * @param  {Strategy}   strategy        The OAE strategy that needs to be registered.
 * @throws {Error}                      If another strategy was already registered with that name.
 */
...
var refreshStrategies = module.exports.refreshStrategies = function(tenant) {
    _.forEach(strategies, function(strategy, strategyName) {
