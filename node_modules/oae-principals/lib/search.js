 ...
 * @api private
 */
var _produceUserSearchDocuments = function(resources, callback, _documents, _errors) {
    ...
    if (resource.user) {
        ...
        return _produceUserSearchDocuments(resources, callback, _documents, _errors);
    }
 ...
 * @api private
 */
var _produceGroupSearchDocuments = function(resources, callback, _documents, _errors) {
    _documents = _documents || [];
    _errors = _errors || [];
    if (_.isEmpty(resources)) {
        return callback(_errors, _documents);
    ...
    if (resource.group) {
        ...
        return _produceGroupSearchDocuments(resources, callback, _documents, _errors);
    }
