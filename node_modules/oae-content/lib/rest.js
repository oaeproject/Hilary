 ...
 * @FormParam   {string[]}          [managers]          Unique identifier(s) for users and groups to add, or email addresses to invite, as managers of the collaborative document. The user creating the collaborative document will be added as a manager automatically
 * @FormParam   {string[]}          [editors]           Unique identifier(s) for users and groups to add, or email addresses to invite, as editors of the collaborative document
 * @FormParam   {string[]}          [viewers]           Unique identifier(s) for users and groups to add, or email addresses to invite, as members of the collaborative document
 ...
 * @FormParam   {string[]}          [managers]          Unique identifier(s) for users and groups to add, or email addresses to invite, as managers of the file. The user creating the file will be added as a manager automatically
 * @FormParam   {string[]}          [viewers]           Unique identifier(s) for users and groups to add, or email addresses to invite, as members of the file
 ...
 * @FormParam   {string[]}          [managers]          Unique identifier(s) for users and groups to add, or email addresses to invite, as managers of the link. The user creating the link will be added as a manager automatically
 * @FormParam   {string[]}          [viewers]           Unique identifier(s) for users and groups to add, or email addresses to invite, as members of the link
 ...
 * @FormParam   {string[]}      viewers             Unique identifier(s) for users and groups or email addresses to share the content item with
 * @Return      {void}
