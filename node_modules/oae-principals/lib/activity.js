 ...
 */
PrincipalsAPI.on(PrincipalsConstants.events.CREATED_GROUP, function(
  ctx,
  group,
  memberChangeInfo,
) {
 ...
 */
PrincipalsAPI.on(PrincipalsConstants.events.UPDATED_GROUP, function(
  ctx,
  newGroup,
  oldGroup,
) {
 ...
 */
PrincipalsAPI.on(PrincipalsConstants.events.UPDATED_GROUP_MEMBERS, function(
  ctx,
  group,
  oldGroup,
  memberChangeInfo,
  ...
  _.each(addedMemberIds, function(memberId) {
    var objectResourceType = PrincipalsUtil.isGroup(memberId)
      ? 'group'
      : 'user';
    var objectResource = new ActivityModel.ActivitySeedResource(
      objectResourceType,
 ...
 */
PrincipalsAPI.on(PrincipalsConstants.events.JOINED_GROUP, function(
  ctx,
  group,
  oldGroup,
  memberChangeInfo,
...
var _userProducer = function(resource, callback) {
  ...
  if (user) {
    return callback(
      null,
      PrincipalsUtil.createPersistentUserActivityEntity(user.id, user),
    );
  }
...
var _userTransformer = function(ctx, activityEntities, callback) {
  ...
  _.keys(activityEntities).forEach(function(activityId) {
    ...
    _.keys(activityEntities[activityId]).forEach(function(entityId) {
      ...
      transformedActivityEntities[activityId][
        entityId
      ] = PrincipalsUtil.transformPersistentUserActivityEntity(
        ctx,
        entityId,
        entity.user,
      );
...
var _groupProducer = function(resource, callback) {
  ...
  if (group) {
    return callback(
      null,
      PrincipalsUtil.createPersistentGroupActivityEntity(group.id, group),
    );
  }
...
var _groupTransformer = function(ctx, activityEntities, callback) {
  ...
  _.keys(activityEntities).forEach(function(activityId) {
    ...
    _.keys(activityEntities[activityId]).forEach(function(entityId) {
      ...
      transformedActivityEntities[activityId][
        entityId
      ] = PrincipalsUtil.transformPersistentGroupActivityEntity(
        ctx,
        entityId,
        entity.group,
      );
 ...
 */
ActivityAPI.registerActivityEntityAssociation('user', 'self', function(
  associationsCtx,
  entity,
  callback,
) {
 ...
 */
ActivityAPI.registerActivityEntityAssociation('group', 'self', function(
  associationsCtx,
  entity,
  callback,
) {
 ...
 */
ActivityAPI.registerActivityEntityAssociation('group', 'members', function(
  associationsCtx,
  entity,
  callback,
) {
 ...
 */
ActivityAPI.registerActivityEntityAssociation('group', 'managers', function(
  associationsCtx,
  entity,
  callback,
) {
