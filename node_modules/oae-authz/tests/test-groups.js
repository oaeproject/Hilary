...
describe('Authz Groups', function() {
     ...
     */
    var _setupMembershipChain = function(callback) {
        ...
        AuthzAPI.updateRoles(groupId5, _.oaeObj(userId, 'member'), function(err) {
            assert.ok(!err);
            AuthzAPI.updateRoles(groupId4, _.oaeObj(groupId5, 'member'), function(err) {
                assert.ok(!err);
                AuthzAPI.updateRoles(groupId3, _.oaeObj(groupId4, 'member'), function(err) {
                    assert.ok(!err);
                    AuthzAPI.updateRoles(groupId2, _.oaeObj(groupId3, 'member'), function(err) {
                        assert.ok(!err);
                        AuthzAPI.updateRoles(groupId1, _.oaeObj(groupId2, 'member'), function(err) {
                            assert.ok(!err);
    ...
    describe('Add group member', function() {
        it('verify invalid group id error', function(callback) {
            AuthzAPI.updateRoles('not a valid id', _.oaeObj('u:cam:mrvisser', 'member'), function(err, usersInvalidated) {
                assert.ok(err);
        ...
        it('verify non-group group id error', function(callback) {
            AuthzAPI.updateRoles('u:cam:mrvisser', _.oaeObj('u:cam:mrvisser', 'member'), function(err, usersInvalidated) {
                assert.ok(err);
                assert.strictEqual(err.code, 400);
                assert.ok(!usersInvalidated);
                return callback();
        ...
        it('verify invalid member id error', function(callback) {
            AuthzAPI.updateRoles('g:oae:oae-team', _.oaeObj('not a valid id', 'member'), function(err, usersInvalidated) {
                assert.ok(err);
                assert.strictEqual(err.code, 400);
                assert.ok(!usersInvalidated);
                return callback();
        ...
        it('verify non-principal member id error', function(callback) {
            AuthzAPI.updateRoles('g:oae:oae-team', _.oaeObj('c:content:id', 'member'), function(err, usersInvalidated) {
                assert.ok(err);
                assert.strictEqual(err.code, 400);
                assert.ok(!usersInvalidated);
                return callback();
        ...
        it('verify null role error', function(callback) {
            AuthzAPI.updateRoles('g:oae:oae-team', _.oaeObj('u:cam:mrvisser', null), function(err, usersInvalidated) {
                assert.ok(err);
                assert.strictEqual(err.code, 400);
                assert.ok(!usersInvalidated);
                return callback();
        ...
        it('verify undefined role error', function(callback) {
            AuthzAPI.updateRoles('g:oae:oae-team', _.oaeObj('u:cam:mrvisser', undefined), function(err, usersInvalidated) {
                assert.ok(err);
                assert.strictEqual(err.code, 400);
                assert.ok(!usersInvalidated);
                return callback();
        ...
        it('verify user gets added to group', function(callback) {
            ...
            AuthzAPI.updateRoles(groupId, _.oaeObj(memberId, 'member'), function(err, usersInvalidated) {
                assert.ok(!err);
        ...
        it('verify update user membership role', function(callback) {
            ...
            AuthzAPI.updateRoles(groupId, _.oaeObj(memberId, 'member'), function(err, usersInvalidated) {
                ...
                verifyBidirectionalGroupMembership(groupId, memberId, 'member', function() {
                    AuthzAPI.updateRoles(groupId, _.oaeObj(memberId, 'manager'), function(err, usersInvalidated) {
                        assert.ok(!err);
                        assert.strictEqual(usersInvalidated.length, 1);
                        assert.strictEqual(usersInvalidated[0], memberId);
    ...
    describe('Remove group member', function() {
        ...
        it('verify invalid group id error', function(callback) {
            AuthzAPI.updateRoles('not a valid id', _.oaeObj('u:cam:mrvisser', false), function(err, usersInvalidated) {
                assert.ok(err);
                assert.strictEqual(err.code, 400);
                assert.ok(!usersInvalidated);
                assert.ok(!usersInvalidated);
        ...
        it('verify non-group group id error', function(callback) {
            AuthzAPI.updateRoles('u:cam:mrvisser', _.oaeObj('u:cam:mrvisser', false), function(err, usersInvalidated) {
                assert.ok(err);
                assert.strictEqual(err.code, 400);
                assert.ok(!usersInvalidated);
                return callback();
        ...
        it('verify invalid member id error', function(callback) {
            AuthzAPI.updateRoles('g:oae:oae-team', _.oaeObj('not a valid id', false), function(err, usersInvalidated) {
                assert.ok(err);
                assert.strictEqual(err.code, 400);
                assert.ok(!usersInvalidated);
                return callback();
        ...
        it('verify non-principal member id error', function(callback) {
            AuthzAPI.updateRoles('g:oae:oae-team', _.oaeObj('c:content:id', false), function(err, usersInvalidated) {
                assert.ok(err);
                assert.strictEqual(err.code, 400);
                assert.ok(!usersInvalidated);
                return callback();
        ...
        it('verify user gets removed from group', function(callback) {
            ...
            AuthzAPI.updateRoles(groupId, _.oaeObj(memberId, 'member'), function(err, usersInvalidated) {
                ...
                verifyBidirectionalGroupMembership(groupId, memberId, 'member', function() {
                    ...
                    // 3. remove the user
                    AuthzAPI.updateRoles(groupId, _.oaeObj(memberId, false), function(err, usersInvalidated) {
                        assert.ok(!err);
                        assert.strictEqual(usersInvalidated.length, 1);
                        assert.strictEqual(usersInvalidated[0], memberId);
    ...
    describe('#getAuthzMembers()', function() {
        ...
        it('verify get user from group', function(callback) {
            ...
            AuthzAPI.updateRoles(groupId, _.oaeObj(memberId, 'member'), function(err) {
                assert.ok(!err);
                AuthzAPI.getAuthzMembers(groupId, undefined, undefined, function(err, members) {
                    assert.ok(!err);
                    assert.ok(members);
    ...
    describe('#getIndirectPrincipalMemberships()', function() {
        ...
        it('verify paging on freshly cached authz memberships indirect cache', function(callback) {
            _setupMembershipChain(function(userId, groupId1, groupId2, groupId3, groupId4, groupId5) {
            ...
            _setupMembershipChain(function(userId, groupId1, groupId2, groupId3, groupId4, groupId5) {
                ...
                assertIndirectMemberships(userId, null, null, [groupId1, groupId2, groupId3, groupId4], function(groupIds, nextToken) {
                    assertIndirectMemberships(groupId5, null, null, [groupId1, groupId2, groupId3], function(groupIds, nextToken) {
                        ...
                        AuthzAPI.updateRoles(groupId3, _.oaeObj(groupId4, false), function(err, usersInvalidated) {
                            assert.ok(!err);
                            assert.strictEqual(usersInvalidated.length, 1);
                            ...
                            assertIndirectMemberships(userId, null, null, [groupId4], function(groupIds, nextToken) {
                                ...
                                assertIndirectMemberships(groupId5, null, null, [], function(groupIds, nextToken) {
                                    ...
                                    AuthzAPI.updateRoles(groupId3, _.oaeObj(groupId4, 'member'), function(err, usersInvalidated) {
                                        assert.ok(!err);
                                        assert.strictEqual(usersInvalidated.length, 1);
                                        assert.strictEqual(usersInvalidated[0], userId);
        ...
        it('verify single group membership results in empty indirect membership', function(callback) {
            ...
            AuthzAPI.updateRoles(groupId, _.oaeObj(userId, 'member'), function(err, usersInvalidated) {
                assert.ok(!err);
                assert.strictEqual(usersInvalidated.length, 1);
                assert.strictEqual(usersInvalidated[0], userId);
        ...
        it('verify two direct group memberships results in empty indirect membership', function(callback) {
            ...
            AuthzAPI.updateRoles(groupId1, _.oaeObj(userId, 'member'), function(err, usersInvalidated) {
                assert.ok(!err);
                assert.strictEqual(usersInvalidated.length, 1);
                assert.strictEqual(usersInvalidated[0], userId);

                AuthzAPI.updateRoles(groupId2, _.oaeObj(userId, 'member'), function(err, usersInvalidated) {
                    assert.ok(!err);
                    assert.strictEqual(usersInvalidated.length, 1);
                    assert.strictEqual(usersInvalidated[0], userId);
        ...
        it('verify simple group hierarchy', function(callback) {
            ...
            AuthzAPI.updateRoles(groupId1, _.oaeObj(userId, 'member'), function(err, usersInvalidated) {
                ...
                AuthzAPI.updateRoles(groupId1, _.oaeObj(nonMemberGroupId3, 'member'), function(err, usersInvalidated) {
                    assert.ok(!err);
                    assert.strictEqual(usersInvalidated.length, 0);

                    AuthzAPI.updateRoles(groupId2, _.oaeObj(groupId1, 'member'), function(err, usersInvalidated) {
                        assert.ok(!err);
                        assert.strictEqual(usersInvalidated.length, 1);
                        assert.strictEqual(usersInvalidated[0], userId);
        ...
        it('verify circular group hierarchy', function(callback) {
            ...
            AuthzAPI.updateRoles(groupId1, _.oaeObj(userId, 'member'), function(err, usersInvalidated) {
                ...
                AuthzAPI.updateRoles(groupId2, _.oaeObj(groupId1, 'member'), function(err, usersInvalidated) {
                    ...
                    assert.strictEqual(usersInvalidated.length, 1);
                    assert.strictEqual(usersInvalidated[0], userId);
                    AuthzAPI.updateRoles(groupId3, _.oaeObj(groupId2, 'member'), function(err, usersInvalidated) {
                        assert.ok(!err);
                        assert.strictEqual(usersInvalidated.length, 1);
                        assert.strictEqual(usersInvalidated[0], userId);
                        AuthzAPI.updateRoles(groupId1, _.oaeObj(groupId3, 'member'), function(err, usersInvalidated) {
                            assert.ok(!err);
                            assert.strictEqual(usersInvalidated.length, 1);
                            assert.strictEqual(usersInvalidated[0], userId);
        ...
        it('verify paging', function(callback) {
            ...
            AuthzAPI.updateRoles(groupId1, _.oaeObj(userId, 'member'), function(err) {
                assert.ok(!err);
                AuthzAPI.updateRoles(groupId2, _.oaeObj(groupId1, 'manager'), function(err) {
                    assert.ok(!err);
                    AuthzAPI.updateRoles(groupId3, _.oaeObj(groupId1, 'member'), function(err) {
                        assert.ok(!err);
                        AuthzAPI.updateRoles(groupId4, _.oaeObj(groupId1, 'member'), function(err) {
                            assert.ok(!err);
                            AuthzAPI.updateRoles(groupId5, _.oaeObj(groupId1, 'manager'), function(err) {
                                assert.ok(!err);
                                AuthzAPI.updateRoles(groupId6, _.oaeObj(groupId1, 'member'), function(err) {
                                    assert.ok(!err);
                                    AuthzAPI.updateRoles(groupId7, _.oaeObj(groupId1, 'manager'), function(err) {
                                        assert.ok(!err);
    ...
    describe('#getAllIndirectPrincipalMemberships()', function() {
         ...
         * @throws {Error}                              An assertion error is thrown if an error occurs or the retrieved groups don't match the expected groups
         */
        var _assertAllIndirectMembershipsEquals = function(principalId, expectedGroupIds, callback) {
            AuthzAPI.getAllIndirectPrincipalMemberships(principalId, function(err, groupIds) {
                assert.ok(!err);
        ...
        it('verify cache invalidation', function(callback) {
            _setupMembershipChain(function(userId, groupId1, groupId2, groupId3, groupId4, groupId5) {
                ...
                // Get the indirect memberships for our user and a group so they get cached
                _assertAllIndirectMembershipsEquals(userId, [groupId1, groupId2, groupId3, groupId4], function() {
                    _assertAllIndirectMembershipsEquals(groupId5, [groupId1, groupId2, groupId3], function() {
                        ...
                        AuthzAPI.updateRoles(groupId3, _.oaeObj(groupId4, false), function(err, usersInvalidated) {
                            ...
                            _assertAllIndirectMembershipsEquals(userId, [groupId4], function() {
                                // Get all the indirect memberships for group5, it should have no
                                // indirect memberships
                                _assertAllIndirectMembershipsEquals(groupId5, [], function() {
                                    // Restore the link between group3 and group4
                                    AuthzAPI.updateRoles(groupId3, _.oaeObj(groupId4, 'member'), function(err, usersInvalidated) {
                                        assert.ok(!err);
                                        assert.strictEqual(usersInvalidated.length, 1);
         ...
         */
        it('verify invalid principal id', function(callback) {
            AuthzAPI.getAllIndirectPrincipalMemberships('not an id', function(err) {
                assert.ok(err);
                assert.equal(err.code, 400);
                return callback();
            });
         ...
         */
        it('verify non-principal id', function(callback) {
            AuthzAPI.getAllIndirectPrincipalMemberships('c:cam:Foo.docx', function(err) {
                assert.ok(err);
                assert.equal(err.code, 400);
                return callback();
            });
        ...
        it('verify empty membership is an empty array', function(callback) {
            var userId = AuthzUtil.toId('u', 'ipm-empty', 'mrvisser');
            AuthzAPI.getAllIndirectPrincipalMemberships(userId, function(err, groupIds) {
                assert.ok(!err);
                assert.ok(groupIds);
                assert.equal(groupIds.length, 0);
                return callback();
         ...
         */
        it('verify paging', function(callback) {
            var userId = AuthzUtil.toId('u', 'aipm-p', shortid.generate());
            var groupIds = _.times(230, function() {
            ...
            _.each(groupIds.slice(1), function(groupId, i) {
                graph.addEdge(groupId, groupIds[i]);
            });

            // Create the membership hierarchy
            AuthzTestUtil.assertCreateMembershipsGraphSucceeds(graph, function() {

                // Ensure the paged indirect memberships give all the groups when the cache hasn't
                // been initialized for the user
                _assertAllIndirectMembershipsEquals(userId, groupIds.slice(0, -1), function() {
        ...
        it('verify group members hierarchy', function(callback) {
            TestsUtil.generateResourceIds(1, 'u', 'oae', function(userId) {
                TestsUtil.generateResourceIds(4, 'g', 'oae', function(groupId1, groupId2, groupId3, groupId4) {
                    ...
                    AuthzAPI.updateRoles(groupId1, _.oaeObj(userId, 'member'), function(err) {
                        assert.ok(!err);
                        AuthzAPI.updateRoles(groupId2, _.oaeObj(userId, 'manager'), function(err) {
                            assert.ok(!err);
                            ...
                            AuthzAPI.updateRoles(groupId3, change, function(err) {
                                ...
                                AuthzAPI.updateRoles(groupId4, _.oaeObj(groupId3, 'member'), function(err) {
                                    assert.ok(!err);
    ...
    describe('#getPrincipalMemberships()', function() {
        ...
        it('verify single group membership', function(callback) {
            ...
            AuthzAPI.updateRoles(groupId, _.oaeObj(userId, 'member'), function(err) {
                assert.ok(!err);
        ...
        it('verify two direct group membership', function(callback) {
            ...
            AuthzAPI.updateRoles(groupId1, _.oaeObj(userId, 'member'), function(err) {
                assert.ok(!err);
                AuthzAPI.updateRoles(groupId2, _.oaeObj(userId, 'member'), function(err) {
                    assert.ok(!err);
        ...
        it('verify simple group hierarchy', function(callback) {
            ...
            AuthzAPI.updateRoles(groupId1, _.oaeObj(userId, 'member'), function(err) {
                assert.ok(!err);
                AuthzAPI.updateRoles(groupId1, _.oaeObj(nonMemberGroupId3, 'member'), function(err) {
                    assert.ok(!err);
                    AuthzAPI.updateRoles(groupId2, _.oaeObj(groupId1, 'member'), function(err) {
                        assert.ok(!err);
        ...
        it('verify circular group hierarchy', function(callback) {
            ...
            AuthzAPI.updateRoles(groupId1, _.oaeObj(userId, 'member'), function(err) {
                ...
                AuthzAPI.updateRoles(groupId2, _.oaeObj(groupId1, 'member'), function(err) {
                    assert.ok(!err);
                    AuthzAPI.updateRoles(groupId3, _.oaeObj(groupId2, 'member'), function(err) {
                        assert.ok(!err);
                        AuthzAPI.updateRoles(groupId1, _.oaeObj(groupId3, 'member'), function(err) {
                            assert.ok(!err);
        ...
        it('verify paging', function(callback) {
            ...
            AuthzAPI.updateRoles(groupId1, _.oaeObj(userId, 'member'), function(err) {
                ...
                AuthzAPI.updateRoles(groupId2, _.oaeObj(userId, 'manager'), function(err) {
                    assert.ok(!err);
                    AuthzAPI.updateRoles(groupId3, _.oaeObj(userId, 'member'), function(err) {
                        assert.ok(!err);
                        AuthzAPI.updateRoles(groupId4, _.oaeObj(userId, 'member'), function(err) {
                            assert.ok(!err);
                            AuthzAPI.updateRoles(groupId5, _.oaeObj(userId, 'manager'), function(err) {
                                assert.ok(!err);
                                AuthzAPI.updateRoles(groupId6, _.oaeObj(userId, 'member'), function(err) {
                                    assert.ok(!err);
                                    AuthzAPI.updateRoles(groupId7, _.oaeObj(userId, 'manager'), function(err) {
                                        assert.ok(!err);
    ...
    describe('#computeMemberRolesAfterChanges()', function() {
        it('verify functionality', function(callback) {
            ...
            AuthzAPI.updateRoles(groupId, permissions, function(err) {
                ...
                var changes = _.oaeObj(bert, 'member');
                AuthzAPI.computeMemberRolesAfterChanges(groupId, changes, function(err, permissions, newMembers, updateMembers, removedMembers) {
                    assert.ok(!err);
                    ...
                    changes = _.oaeObj(mrvisser, 'manager');
                    AuthzAPI.computeMemberRolesAfterChanges(groupId, changes, function(err, permissions, newMembers, updateMembers, removedMembers) {
                        assert.ok(!err);
                        ...
                        changes = _.oaeObj(simong, 'member');
                        AuthzAPI.computeMemberRolesAfterChanges(groupId, changes, function(err, permissions, newMembers, updateMembers, removedMembers) {
                            assert.ok(!err);
                            assert.equal(_.keys(permissions).length, 2);
                            assert.equal(newMembers.length, 0);
                            ...
                            AuthzAPI.computeMemberRolesAfterChanges(groupId, changes, function(err, permissions, newMembers, updateMembers, removedMembers) {
                                ...
                                changes = _.oaeObj(unknownUser, false);
                                AuthzAPI.computeMemberRolesAfterChanges(groupId, changes, function(err, permissions, newMembers, updateMembers, removedMembers) {
                                    assert.ok(!err);
                                    assert.equal(_.keys(permissions).length, 2);
                                    assert.equal(newMembers.length, 0);
