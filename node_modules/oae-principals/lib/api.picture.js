...
var _storePicture = function(ctx, principal, file, callback) {
    ContentAPI.getStorageBackend(ctx).store(ctx, file, function(err, largePictureUri) {
        ...
        Cassandra.runQuery(q.query, q.parameters, function(err) {
            ...
            principal.largePicture = PrincipalsUtil.getSignedPictureUrl(ctx.tenant().alias, largePictureUri);
...
var _saveUrisToCassandra = function(ctx, principal, smallPictureUri, mediumPictureUri, callback) {
    ...
    Cassandra.runQuery(q.query, q.parameters, function(err) {
        ...
        newPrincipal.smallPicture = PrincipalsUtil.getSignedPictureUrl(ctx.tenant().alias, smallPictureUri);
        newPrincipal.mediumPicture = PrincipalsUtil.getSignedPictureUrl(ctx.tenant().alias, mediumPictureUri);
