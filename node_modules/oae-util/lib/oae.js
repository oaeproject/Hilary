...
var _bootstrap = function(app, callback) {
    initializeAvailableModules(function(modules) {
        if (modules.length) {
 ...
 */
var initializeAvailableModules = function(callback) {
 ...
 * @return   {String[]}   cachedAvailableModules Returns an Array of strings representing the names of the available modules
 */
