...
var getRevisions = module.exports.getRevisions = function(contentId, start, limit, callback) {
    ...
    Cassandra.runPagedColumnQuery('RevisionByContent', 'contentId', contentId, start, limit, {'reversed': true}, function(err, row) {
        ...
        Cassandra.runQuery('SELECT revisionId, contentId, created, createdBy FROM Revisions WHERE revisionId IN (?)', [revisionsToRetrieve], function(err, rows) {
            if (err) {
                return callback(err);
            }
 ...
 */
var createRevision = module.exports.createRevision = function(contentId, tenantAlias, createdBy, opts, callback) {
