...
describe('Activity push', function() {
    ...
    it('verify an invalid user id results in a error', function(callback) {
      ActivityTestUtil.getPushClient(function(client) {
        ...
        client.on('close', function() {
          assert.ok(
            receivedResponse,
            'Expected to receive a message before closing the socket',
          );
          callback();
        });
      });
  ...
  describe('Subscribing', function() {
                        ...
                        function(err, googleLink) {
                          ...
                          ActivityTestUtil.collectAndGetActivityStream(
                            ...
                            function(err) {
                              ...
                              ActivityTestUtil.getFullySetupPushClient(
                                data,
                                function(client) {
          ...
          ActivityTestUtil.collectAndGetActivityStream(
            ...
            function(err) {
              ...
              ActivityTestUtil.getFullySetupPushClient(data, function(clientA) {
                ActivityTestUtil.getFullySetupPushClient(data, function(
                  clientB,
                ) {
                ...
                client.on('message', function(message) {
                  ...
                  if (message.streamType === 'notification') {
                    ...
                    assert.equal(
                      ...
                      simong.user.publicAlias,
                    );
                    assert.equal(
                      activity.actor['lastModified'],
                      simong.user.lastModified,
                    );
     ...
     */
    it('verify aggregation phase messages indicate whether the activity agregated with an older activity', function(callback) {
      TestsUtil.generateTestUsers(camAdminRestContext, 2, function(
        err,
        users,
        mrvisser,
