 ...
 * @param    {Boolean}    tenantOverride     If tenants can override this setting or not
 */
var Boolean = module.exports.Boolean = function(name, description, defaultValue, tenantOverride) {
    return {
 ...
 * @param    {Boolean}    tenantOverride     If tenants can override this setting or not
 */
var Text = module.exports.Text = function(name, description, defaultValue, tenantOverride) {
    return {
        'description': description,
        'defaultValue': defaultValue,
        'name': name,
 ...
 * @param    {Boolean}    tenantOverride     If tenants can override this setting or not
 */
var Textarea = module.exports.Textarea = function(name, description, defaultValue, tenantOverride) {
    return {
        'description': description,
        'defaultValue': defaultValue,
        'name': name,
 ...
 */
var Radio = module.exports.Radio = function(name, description, defaultValue, tenantOverride, group) {
    return {
        'description': description,
        'defaultValue': defaultValue,
        'group': group,
 ...
 */
var List = module.exports.List = function(name, description, defaultValue, tenantOverride, list) {
    return {
        'description': description,
        'defaultValue': defaultValue,
        'list': list,
 ...
 * @param    {Boolean}    tenantOverride     If tenants can override this setting or not
 */
var ArrayMultipleChoice = module.exports.ArrayMultipleChoice = function(name, description, defaultValue, optionArr, choiceArr, tenantOverride) {
    return {
        'description': description,
        'defaultValue': defaultValue,
        'optionArr': optionArr,
 ...
 * @param    {Boolean}    tenantOverride     If tenants can override this setting or not
 */
var ExpandableObject = module.exports.ExpandableObject = function(name, description, obj, tenantOverride) {
    return {
        'description': description,
        'defaultValue': obj,
        'name': name,
 ...
 * @param    {Boolean}    tenantOverride     If tenants can override this setting or not
 */
var treeStructure = module.exports.treeStructure = function(name, description, tree, tenantOverride) {
    return {
        'description': description,
        'defaultValue': tree,
        'name': name,
