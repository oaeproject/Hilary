...
/*!
 * Register the local login strategy for the given tenant.
 */
strategySetup[AuthenticationConstants.providers.LOCAL] = function(tenant, strategyId) {
    passport.use(strategyId, new LocalStrategy());
};
