                        ...
                        RestAPI.Discussions.createDiscussion(mrvisser.restContext, 'A talk', 'about computers', 'public', [], [], function(err, discussion) {
                            ...
                            RestAPI.Discussions.createMessage(simong.restContext, discussion.id, '<b>Nice discussion.</b>\n\nWould read again', null, function(err, simongMessage) {
                                ...
                                EmailTestsUtil.collectAndFetchEmails(function(emails) {
                                    ...
                                    // The email should contain "Nice discussion." followed by 2 <br />'s
                                    assert.notEqual(stringEmail.indexOf('&lt;b&gt;Nice discussion.&lt;&#x2f;b&gt;<br/><br/>'), -1);
            ...
            TestsUtil.generateTestUsers(camAdminRestContext, 2, function(err, users) {
                ...
                RestAPI.User.updateUser(coenego.restContext, coenego.user.id, {'email': 'coenego' + Math.random() + '@email.com'}, function(err) {
                    ...
                    RestAPI.User.updateUser(simong.restContext, simong.user.id, {'email': 'simong' + Math.random() + '@email.com'}, function(err) {
                        ...
                        RestAPI.Discussions.createDiscussion(coenego.restContext, 'A talk', 'about computers', 'public', [], [], function(err, discussion) {
                            assert.ok(!err);

                            // Post a new message
                            var comment = '<p class="comment"><span>Nice</span> <strong>discussion</strong>, would <em>read</em> again</p><style><!-- body{display:none;} --></style>';
                            RestAPI.Discussions.createMessage(simong.restContext, discussion.id, comment, null, function(err, simongMessage) {
                                assert.ok(!err);
