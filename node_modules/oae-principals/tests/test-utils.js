...
var createUsers = function(test, callback) {
    ...
    PrincipalsAPI.createUser(tenant, 'nm417-' + r, 'password' + r, 'public', 'Nicolaas', 'Matthijs', 'Nicolaas Matthijs', function(err, id) {
        test.ok(!err);
        userids.push(id);
        PrincipalsAPI.createUser(tenant, 'simong-' + r, 'password' + r, 'loggedin', 'Simon', 'Gaeremynck', 'Simon Gaeremynck', function(err, id) {
            test.ok(!err);
            userids.push(id);
            PrincipalsAPI.createUser(tenant, 'branden-' + r, 'password' + r, 'private', 'Branden', 'Visser', 'Branden Visser', function(err, id) {
                test.ok(!err);
                userids.push(id);
                PrincipalsAPI.createUser(tenant, 'physx-' + r, 'password' + r, 'public', 'Bert', 'Pareyn', 'Bert Pareyn', function(err, id) {
                    test.ok(!err);
                    userids.push(id);
                    callback(userids);
                });
...
module.exports.testIdentifiers = function(test) {
    ...
    test.ok(PrincipalUtil.isGroup(id));

    id = roleUtils.toUuid("u", "cam", "simong");
    test.ok(PrincipalUtil.isUser(id));
