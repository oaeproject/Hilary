    ...
    describe('Indexing', function() {
        ...
        it('verify indexing without full user item', function(callback) {
            ...
            RestAPI.User.createUser(camAdminRestContext, username, username, username, null, function(err, user) {
                ...
                RestAPI.Search.search(camAdminRestContext, 'general', ['user'], {'q': username}, function(err, results) {
                    assert.ok(!err);
        ...
        it('verify indexing without full group item', function(callback) {
            ...
            RestAPI.Group.createGroup(camAdminRestContext, groupAlias, groupAlias, groupAlias, 'public', 'no', [], [], function(err, group) {
                ...
                // Verify the content item exists
                RestAPI.Search.search(camAdminRestContext, 'general', ['group'], {'q': groupAlias}, function(err, results) {
                    assert.ok(!err);
