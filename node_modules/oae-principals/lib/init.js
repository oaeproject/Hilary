...
module.exports = function(config, callback) {
    ...
    // Initialize search entities for principals
...
var ensureSchema = function(callback) {
    ...
    Cassandra.createColumnFamily('Principals', 'CREATE COLUMNFAMILY Principals (principalId text PRIMARY KEY, alias text, tenant text, displayName text, visibility text);', callback);
};
