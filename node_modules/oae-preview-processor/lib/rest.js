...
/**
 * @REST adminPostContentReprocessPreviews
 *
 * Reprocess previews for content items that match a set of filters. This operation can be extremely resource-intensive; use with care.
 *
 * @Server      admin
 * @Method      POST
 * @Path        /content/reprocessPreviews
 * @FormParam   {string}            content_resourceSubType       Content of specified sub-type ("collabdoc","file","link")
 * @FormParam   {string}            revision_mimeType             Content of specified MIME type, e.g. "application/pdf"
 * @FormParam   {string[]}          revision_previewsStatus       Content with any of specified preview status values, ("ignored","error")
 * @FormParam   {number}            revision_createdAfter         Content created after specified time (epoch format)
 * @FormParam   {number}            revision_createdBefore        Content created before specified time (epoch format)
 * @FormParam   {string}            revision_createdBy            Content created by specified user (e.g. "u:tenant:123def")
 * @Return      {void}
 */
...
/**
 * @REST adminPostContentContentIdRevisionRevisionIdReprocessPreview
 *
 ...
 * @PathParam   {string}        contentId       Unique identifier of content to reprocess
 * @PathParam   {string}        revisionId      Unique identifier of revision to reprocess
 * @Return      {void}
 */
OAE.globalAdminRouter.on('post', '/api/content/:contentId/revision/:revisionId/reprocessPreview', _handleReprocessPreview);

/**
* @REST tenantPostContentContentIdRevisionRevisionIdReprocessPreview
*
* Reprocess a single revision's preview for a content item
*
* @Server      tenant
