 ...
 * @HttpResponse                    400                 An invalid discussion visibility option has been provided. Must be one of: ...
 ...
 * @HttpResponse                    400                 The memberId: ... is not a valid member id
 * @HttpResponse                    400                 The role: ... is not a valid member role for a discussion
...
OAE.tenantRouter.on('post', '/api/discussion/create', function(req, res) {
    ...
    _.each(req.body.managers, function(manager) {
        roles[manager] = DiscussionsConstants.roles.MANAGER;
    });
    _.each(req.body.members, function(member) {
        roles[member] = DiscussionsConstants.roles.MEMBER;
    });
 ...
 * @HttpResponse                    400                 An invalid visibility was specified. Must be one of: ...
 * @HttpResponse                    400                 Invalid resource id provided
 * @HttpResponse                    400                 The field ... is not a valid field. Must be one of: ...
 * @HttpResponse                    400                 You should at least one profile field to update
 * @HttpResponse                    401                 You are not authorized to update this discussion
 * @HttpResponse                    401                 You must be authenticated to update a discussion
 */
 ...
 * @HttpResponse                401                 You must be authenticated to delete a discussion
 * @HttpResponse                404                 Could not find discussion: ...
 */
 ...
 * @HttpResponse                        401                 You are not authorized to delete a discussion from this library
 * @HttpResponse                        401                 You must be authenticated to remove a discussion from a library
 * @HttpResponse                        404                 Could not find discussion: ...
 */
 ...
 * @HttpResponse                        401                 You have to be logged in to be able to share a discussion
 * @HttpResponse                        404                 Could not find discussion: ...
 */
 ...
 * @HttpResponse                            400                 The member id: ... is not a valid member id
 * @HttpResponse                            400                 The requested change results in a discussion with no managers
 * @HttpResponse                            400                 The role : ...is not a valid value. Must be one of: ...
 * @HttpResponse                            400                 The role change: ... is not a valid value. Must either be a string, or false
 ...
 * @HttpResponse                            401                 You have to be logged in to be able to change discussion permissions
 * @HttpResponse                            404                 Could not find discussion: ...
 */
 ...
 * @HttpResponse                401                 Only authenticated users can post on discussions
 ...
 * @HttpResponse                        401                 Only authenticated users can delete messages
 ...
 * @HttpResponse                        404                 The specified message does not exist
 */
