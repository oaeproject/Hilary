...
var log = require('oae-logger').logger('oae-loodle-init');
...
module.exports = function(config, callback) {
    log().info('Initializing the oae-loodle module');
	Cassandra.createColumnFamilies({
		'LoodleTokenByUser': 'CREATE TABLE "LoodleTokenByUser" ("userId" text PRIMARY KEY, "token" text)',
		'LoodleIdByContent': 'CREATE TABLE "LoodleIdByContent" ("contentId" text PRIMARY KEY, "loodleId" text)'
	}, callback);
};
