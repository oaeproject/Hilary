...
var systemTenant = require('oae-tenants/lib/model').SystemTenant;

/**
 * The User model
 *
 * @param {Tenant} tenant      The tenant this user belongs to.
...
module.exports.User = function(tenant, id, username, visibility, locale, timezone, firstName, lastName, displayName, isGlobalAdmin, isTenantAdmin) {
     ...
     *
     * @param  {String}  tenantAlias The alias of the tenant this user is supposed to be an admin of.
    ...
    that.isAdmin = function() {
        return (that.isTenantAdmin() || that.isGlobalAdmin());
    };
