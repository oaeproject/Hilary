...
var getConfig = (module.exports.getConfig = function(tenantAlias) {
  return {
    ...
    collectionId: MediaCoreConfig.getValue(
      tenantAlias,
      'mediacore',
      'collectionId',
    ),
 ...
 */
var getSignedUrl = (module.exports.getSignedUrl = function(
  url,
  queryString,
  keyId,
  secretKey,
 ...
 */
var signedRequest = (module.exports.signedRequest = function(
  tenantAlias,
  method,
  path,
  queryString,
