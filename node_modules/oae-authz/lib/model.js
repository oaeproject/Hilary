 ...
 */
module.exports.IdRoles = function(idRoles) {
 ...
 */
var IdChangeInfo = (module.exports.IdChangeInfo = function(
  changes,
  roles,
  ids,
) {
 ...
 */
var MemberChangeInfo = (module.exports.MemberChangeInfo = function(
  changes,
  roles,
  members,
) {
...
MemberChangeInfo.fromIdChangeInfo = function(idChangeInfo, membersById) {
  var getMemberById = _.propertyOf(membersById);
  var members = {
 ...
 */
var EmailChangeInfo = (module.exports.EmailChangeInfo = function(
  changes,
  roles,
  emails,
) {
