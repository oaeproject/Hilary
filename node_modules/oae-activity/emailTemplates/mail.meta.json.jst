...
var getSubject = function(util, emailPreference, activities) {
    ...
    if (emailPreference === 'immediate') {
        if (activities.length === 1) {
            ...
            message = util.i18n.translate('__MSG__EMAIL_SUBJECT_MULTIPLE__');
        }
    } else if (emailPreference === 'daily') {
        message = util.i18n.translate('__MSG__EMAIL_SUBJECT_DAILY__');
    } else if (emailPreference === 'weekly') {
        message = util.i18n.translate('__MSG__EMAIL_SUBJECT_WEEKLY__');
    }
