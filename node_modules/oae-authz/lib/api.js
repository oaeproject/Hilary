 ...
 **/
var getDirectRoles = (module.exports.getDirectRoles = function(
  principalIds,
  resourceId,
  callback,
) {
 ...
 */
var getAllRoles = (module.exports.getAllRoles = function(
  principalId,
  resourceId,
  callback,
) {
...
var _getIndirectRoles = function(principalId, resourceId, callback) {
  ...
  _getResourceGroupMembers(resourceId, function(err, groups) {
    ...
    _checkGroupMembershipsForUser(principalId, groupIds, function(
      err,
      memberships,
    ) {
      if (err) {
 ...
 */
var hasRole = (module.exports.hasRole = function(
  principalId,
  resourceId,
  role,
  callback,
  ...
  validator
    ...
    .isNonUserResourceId();
  validator
    .check(role, { code: 400, msg: 'Invalid role provided' })
    .isValidRole();
  if (validator.hasErrors()) {
    return callback(validator.getFirstError());
  }
 ...
 */
var hasAnyRole = (module.exports.hasAnyRole = function(
  principalId,
  resourceId,
  callback,
) {
 ...
 */
var updateRoles = (module.exports.updateRoles = function(
  resourceId,
  changes,
  callback,
) {
...
var _updateRoles = function(resourceId, changes, callback) {
    ...
    .map(function(role, principalId) {
      if (role) {
        ...
        return [
          ...
          {
            query:
              'UPDATE "AuthzMembers" SET "role" = ? WHERE "resourceId" = ? AND "memberId" = ?',
        ...
        return [
          {
            query:
              'DELETE FROM "AuthzRoles" WHERE "principalId" = ? AND "resourceId" = ?',
            parameters: [principalId, resourceId],
          },
          {
            query:
              'DELETE FROM "AuthzMembers" WHERE "resourceId" = ? AND "memberId" = ?',
  ...
  getAuthzMembersGraph(_.keys(groupsToInvalidate), function(err, graph) {
    ...
    queries = _.union(
      queries,
      _getInvalidateMembershipsCacheQueries(usersToInvalidate),
    );
 ...
 */
var getAllAuthzMembers = (module.exports.getAllAuthzMembers = function(
  resourceId,
  callback,
  _members,
  _nextToken,
 ...
 * @param  {String}      callback.nextToken      The value to provide in the `start` parameter to get the next set of results
 */
var getAuthzMembers = (module.exports.getAuthzMembers = function(
  resourceId,
  start,
  limit,
  callback,
...
var _explodeGroupMemberships = function(principalId, callback) {
  ...
  _getAuthzGroupMembershipsGraph([principalId], function(err, graph) {
    ...
    var authzMembershipsIndirectCacheQueries = _.map(
      indirectMemberships,
      function(groupId) {
        return {
          query:
    ...
    Cassandra.runBatchQuery(
      _.union(
        authzMembershipsCacheQueries,
        authzMembershipsIndirectCacheQueries,
      ),
      function(err) {
        if (err) {
          return callback(err);
 ...
 */
var getAuthzMembersGraph = (module.exports.getAuthzMembersGraph = function(
  resourceIds,
  callback,
  _graph,
  _resourceIds,
  ...
  getAuthzMembers(resourceId, null, 10000, function(err, members) {
    ...
    _.each(members, function(member) {
      ...
      if (
        ...
        node &&
        !_.contains(_resourceIds, member.id)
      ) {
 ...
 */
var getPrincipalMembershipsGraph = (module.exports.getPrincipalMembershipsGraph = function(
  principalId,
  callback,
) {
  var validator = new Validator();
    ...
    function(err, rows) {
      ...
      _.each(rows, function(row) {
        ...
        _.each(memberRoles, function(memberRole) {
          ...
          graph.addEdge(memberRole.memberId, groupId, {
 ...
 * @param  {String}         callback.nextToken  The value to provide in the `start` parameter to get the next set of results
 */
var getPrincipalMemberships = (module.exports.getPrincipalMemberships = function(
  principalId,
  start,
  limit,
  callback,
  ...
  Cassandra.runPagedQuery(
    ...
    limit,
    null,
    function(err, rows, nextToken, startMatched) {
      if (err) {
        return callback(err);
 ...
 */
var getAllIndirectPrincipalMemberships = (module.exports.getAllIndirectPrincipalMemberships = function(
  principalId,
  callback,
  _groupIds,
  _nextToken,
  ...
  getIndirectPrincipalMemberships(principalId, _nextToken, 100, function(
    err,
    groupIds,
    nextToken,
  ) {
 ...
 * @param  {String}         callback.nextToken      The value to provide in the `start` parameter to get the next set of results
 */
var getIndirectPrincipalMemberships = (module.exports.getIndirectPrincipalMemberships = function(
  principalId,
  start,
  limit,
  callback,
  ...
  return _getIndirectPrincipalMembershipsFromCache(
    principalId,
    start,
    limit,
    callback,
 ...
 * @api private
 */
var _getIndirectPrincipalMembershipsFromCache = function(
  principalId,
  start,
  limit,
  callback,
  ...
  Cassandra.runPagedQuery(
    ...
    function(err, rows, nextToken, startMatched) {
      ...
      // the population
      return _getIndirectPrincipalMembershipsByExplosion(
        principalId,
        start,
        limit,
        callback,
 ...
 * @api private
 */
var _getIndirectPrincipalMembershipsByExplosion = function(
  principalId,
  start,
  limit,
  callback,
...
var _getAuthzGroupMembershipsGraph = function(principalIds, callback, _graph) {
  ...
  getRolesForPrincipalsAndResourceType(
    ...
    function(err, principalParentRole) {
      if (err) {
        return callback(err);
      }
  ...
  return _.chain(userIds)
    .map(function(userId) {
      return [
        ...
        {
          query:
            'DELETE FROM "AuthzMembershipsIndirectCache" WHERE "principalId" = ?',
          parameters: [userId],
        },
      ];
    })
 ...
 */
var getAllRolesForPrincipalAndResourceType = (module.exports.getAllRolesForPrincipalAndResourceType = function(
  principalId,
  resourceType,
  callback,
) {
 ...
 */
var getRolesForPrincipalAndResourceType = (module.exports.getRolesForPrincipalAndResourceType = function(
  principalId,
  resourceType,
  start,
  limit,
 ...
 */
var getRolesForPrincipalsAndResourceType = (module.exports.getRolesForPrincipalsAndResourceType = function(
  principalIds,
  resourceType,
  callback,
) {
  ...
  _.each(principalIds, function(principalId) {
    Cassandra.runAllPagesQuery(
      ...
      function(err, rows) {
        ...
        _.each(rows, function(row) {
          var resourceId = row.get('resourceId');
          var role = row.get('role');

          entries[principalId] = entries[principalId] || {};
          entries[principalId][resourceId] =
            entries[principalId][resourceId] || {};
 ...
 */
var computeMemberRolesAfterChanges = (module.exports.computeMemberRolesAfterChanges = function(
  resourceId,
  memberRoles,
  opts,
  callback,
  ...
  OaeUtil.invokeIfNecessary(
    ...
    null,
    10000,
    function(err, memberIdsWithRoleBefore) {
      if (err) {
        return callback(err);
      }
      ...
      return callback(
        null,
        AuthzUtil.computeRoleChanges(memberRolesBefore, memberRoles, opts),
      );
    },
  );
});
 ...
 */
var resolveEffectiveRole = (module.exports.resolveEffectiveRole = function(
  user,
  resource,
  rolesPriority,
  callback,
) {
  resolveImplicitRole(user, resource, rolesPriority, function(
    err,
    implicitRole,
    canInteract,
  ) {
 ...
 */
var resolveImplicitRole = (module.exports.resolveImplicitRole = function(
  principal,
  resource,
  rolesPriority,
  callback,
  ...
  var tenantsCanInteract = TenantsUtil.canInteract(
