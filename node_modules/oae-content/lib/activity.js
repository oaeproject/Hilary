...
ActivityAPI.registerActivityEntityProducer('content', function(activityType, entityType, resource, callback) {
    ...
    ContentAPI._getContent(resource.resourceId, function(err, content) {
        ...
        TenantsAPI.getTenantByAlias(content.tenant, function(err, tenant) {
            ...
            return callback(null, new ActivityModel.ActivityEntity('content', globalId, opts));
        });
    });
});
...
ActivityAPI.registerActivityEntityProducer('content-comment', function(activityType, entityType, resource, callback) {
    ...
    ContentAPI._getContent(comment.contentId, function(err, content) {
        ...
        TenantsAPI.getTenantByAlias(content.tenant, function(err, tenant) {
            ...
            return callback(null, new ActivityModel.ActivityEntity('content-comment', globalId, opts));
        });
    });
});
...
ActivityAPI.registerActivityRouter('content', function(activityType, entityType, entity, callback) {
    ...
    return _routeContent(activityType, entityType, entity[ActivityConstants.properties.OAE_ID], entity[ActivityConstants.properties.OAE_VISIBILITY], callback);
});
...
ActivityAPI.registerActivityRouter('content-comment', function(activityType, entityType, entity, callback) {
    ...
    return _routeContent(activityType, entityType, entity[ContentConstants.activity.PROP_OAE_CONTENT_ID], entity[ActivityConstants.properties.OAE_VISIBILITY], callback);
});
