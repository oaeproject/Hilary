 ...
 * @param  {Boolean}    [options.push.delivery.routing]             When `true`, indicates the single activity should be pushed to the client at the time it is routed. Default: `true`
 * @param  {Boolean}    [options.push.delivery.aggregation]         When `true`, indicates the aggregated activity should be pushed to the client when it is aggregated into the persistent stream (not applicable for transient streams). Default: `true`
