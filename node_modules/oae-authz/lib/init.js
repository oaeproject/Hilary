...
var ensureSchema = function(callback) {
    Cassandra.createColumnFamilies({
        'AuthzRoles': "CREATE COLUMNFAMILY AuthzRoles (principalId text PRIMARY KEY) WITH comment='Holds all of the role assigments between resources and principals';",
        'AuthzMembers': "CREATE COLUMNFAMILY AuthzMembers (resourceId text PRIMARY KEY) WITH comment='Holds all the members for a resource in one row';",
        'AuthzMembershipsCache': "CREATE COLUMNFAMILY AuthzMembershipsCache (principalId text PRIMARY KEY) WITH comment='Holds a cache of all of the direct and indirect memberships of a principal'"
    }, callback);
};
