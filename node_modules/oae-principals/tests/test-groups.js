...
describe('Principals', function() {
    ...
    describe('Groups', function() {
        ...
        var createAndGetUser = function(ctx, username, password, visibility, firstName, lastName, displayName, callback) {
            PrincipalsAPI.createUser(ctx, username, password, visibility, 'en_GB', 'Europe/London', firstName, lastName, displayName, function(err, createdUser) {
                assert.ok(!err);
                PrincipalsAPI.getUser(ctx, createdUser.id, callback);
            });
        };
