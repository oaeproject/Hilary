...
describe('Publications', function() {
    ...
    describe('#createPublication()', function() {
        ...
        it('verify functionality', function(callback) {
            ...
            RestAPI.Publications.createPublication(camAdminRestCtx, [generateRandomSourceId()], 'A displayName', 'journal article', 1388676959000, ['An author'], extra, function(err, data) {
                assert.ok(!err);
