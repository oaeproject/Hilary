...
describe('Authentication', function() {
  ...
  describe('Local authentication', function() {
    /*!
         ...
         */
    var _getCookiesForUserAgents = function(
      restContext,
      username,
      password,
      userAgents,
      ...
      RestAPI.Authentication.logout(restContext, function(err) {
        ...
        RestAPI.Authentication.login(restContext, username, password, function(
          err,
        ) {
          assert.ok(!err);
          ...
          _userAgentCookies[
            userAgent
          ] = restContext.cookieJar._jar.getCookiesSync(restContext.host);
    ...
    it('verify cookie expiration for mobile and non-mobile browsers', function(callback) {
      ...
      var allUserAgents = _.chain(mobileUserAgents)
        ...
        function(err, createdUser) {
          ...
          _getCookiesForUserAgents(
            ...
            function(userAgentCookies) {
              assert.strictEqual(
                _.keys(userAgentCookies).length,
                allUserAgents.length,
              );
