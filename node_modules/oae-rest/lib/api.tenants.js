 ...
 * @param  {String}           alias                           The alias of the tenant that needs to be updated
 ...
 * @param  {Object}           callback.err                    Error object containing error code and error message
 */
var updateTenant = module.exports.updateTenant = function(restCtx, alias, tenantName, callback) {
    RestUtil.RestRequest(restCtx, '/api/tenant/' + RestUtil.encodeURIComponent(alias), 'POST', tenantUpdates, callback);
};
