...
<<<<<<< HEAD:node_modules/oae-principals/tests/test-util.js
var RoleUtils = require('oae-roles/lib/util');

var PrincipalUtil = require('oae-principals/lib/util');
...
module.exports.testIdentifiers = function(test) {
    ...
    id = roleUtils.toUuid("c", "cam", "foo.doc");
>>>>>>> master:node_modules/oae-principals/tests/test-utils.js
    test.ok(!PrincipalUtil.isUser(id));
    test.ok(!PrincipalUtil.isUser(id));
    test.done();
};
