...
describe('Library Search', function() {
    ...
    before(function(callback) {
        ...
        // Log in the admins so their cookie jar is set up appropriately
        RestAPI.User.getMe(camAdminRestContext, function(err, meObj) {
            RestAPI.User.getMe(gtAdminRestContext, function(err, meObj) {
                callback();
            });
        });
    });
    ...
    describe('User Libraries', function() {
                ...
                RestAPI.User.createUser(camAdminRestContext, jackUsername, 'password', 'Jack McJackerson', null, function(err, jack) {
                    ...
                    RestAPI.User.createUser(camAdminRestContext, janeUsername, 'password', 'Jane McJaneFace', null, function(err, jane) {
                        ...
                        RestAPI.Content.createLink(camAdminRestContext, 'Apereo Website', 'The website of the Apereo Foundation', 'public', 'http://www.apereofoundation.org', [], [], function(err, content) {
                            ...
                            RestAPI.Content.share(camAdminRestContext, content.contentId, [ jack.id ], function(err) {
                                assert.ok(!err);
        ...
        it('verify anonymous and cross-tenant user cannot see loggedin user library item', function(callback) {
            var jackUsername = TestsUtil.generateTestUserId('jack');
            var janeUsername = TestsUtil.generateTestUserId('jane');
            var darthVaderUsername = TestsUtil.generateTestUserId('darthVader');
        ...
        it('verify only self and admin can see private user library item', function(callback) {
            var jackUsername = TestsUtil.generateTestUserId('jack');
            var janeUsername = TestsUtil.generateTestUserId('jane');
            var darthVaderUsername = TestsUtil.generateTestUserId('darthVader');
    ...
    describe('Group Libraries', function() {
        ...
        it('verify all users see public group library item', function(callback) {
            var jackUsername = TestsUtil.generateTestUserId('jack');
            var janeUsername = TestsUtil.generateTestUserId('jane');
                        ...
                        RestAPI.Group.setGroupMembers(camAdminRestContext, group.id, membership, function(err) {
                            ...
                            RestAPI.User.createUser(camAdminRestContext, janeUsername, 'password', 'Jane McJaneFace', null, function(err, jane) {
                                ...
                                RestAPI.Content.createLink(camAdminRestContext, 'Apereo Website', 'The website of the Apereo Foundation', 'public', 'http://www.apereofoundation.org', [], [], function(err, content) {
                                    ...
                                    // share the content with the group.
                                    RestAPI.Content.share(camAdminRestContext, content.contentId, [ group.id ], function(err) {
                                        assert.ok(!err);
        ...
        it('verify anonymous and cross-tenant users cannot see loggedin group library item', function(callback) {
            var jackUsername = TestsUtil.generateTestUserId('jack');
            var janeUsername = TestsUtil.generateTestUserId('jane');
            var groupAlias = TestsUtil.generateTestUserId('group');
            var darthVaderUsername = TestsUtil.generateTestUserId('darthVader');
        ...
        it('verify only member and admin users can see private group library item', function(callback) {
            var jackUsername = TestsUtil.generateTestUserId('jack');
            var janeUsername = TestsUtil.generateTestUserId('jane');
            var groupAlias = TestsUtil.generateTestUserId('group');
            var darthVaderUsername = TestsUtil.generateTestUserId('darthVader');
