 ...
 */
var putTenantInMaintenanceMode = module.exports.putTenantInMaintenanceMode = function(tenants, needsMaintenance, callback) {
    callback = callback || function() {};
    var queries = []
 ...
 * @param {Function} callback            Callback function executed when request is completed.
 */
var deleteTenant = module.exports.deleteTenant = function(tenants, callback) {
    callback = callback || function() {};
    var queries = []
    for (var i in tenants) {
        queries.push({
