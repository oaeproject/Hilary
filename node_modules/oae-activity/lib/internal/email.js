 ...
 *   2.  Stop aggregating for those users their email activity streams. This is to ensure that later emails don't include old activities
 *   3.  Unqueue the users from the email bucket
 *   4.  Collect all the activities from the users their email streams
 *   5.  Remove the activities from the activity streams as they are no longer required
 *   6.  Construct the actual emails and send them out
 *
 ...
 * collection cycle. This timestamp isn't an exact match with the oldest activity in order to have some
 * buffer.
 *
