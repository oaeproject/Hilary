            ...
            _collectBucketBatch(bucketNumber, ActivityConfig.getConfig().collectionBatchSize, function(collectionErr, empty) {
                ...
                ActivityCluster.releaseBucket(bucketNumber, lockId, function(releaseErr, hadLock) {
                    ...
                    if (!hadLock) {
                        ...
                        log().error({
                            'collectionExpiry': ActivityConfig.getConfig().collectionExpiry,
                            'collectionBatchSize': ActivityConfig.getConfig().collectionBatchSize
                        ...
                        ActivityDAO.deliverActivities(activityStreamUpdates, function(err) {
                            ...
                            _.keys(activityStreamUpdates).forEach(function(route) {
                                _.keys(activityStreamUpdates[route]).forEach(function(activityId) {
                                    ...
                                    Telemetry.appendDuration('activity.deliveryLatency.time', activity.published);
                                });
                            });
                            ...
                            ActivityDAO.deleteActivities(activitiesToDelete, function(err) {
                                ...
                                ActivityDAO.updateAggregateStatus(statusUpdates, function(err) {
                                    ...
                                    ActivityDAO.deleteQueuedActivities(bucketNumber, queuedActivitiesToDelete, function(err) {
                                        ...
                                        Telemetry.incr('activity.collected.count', numCollected);
                                        Telemetry.incr('activity.delivered.count', numDelivered);
...
var _isExpired = function(aggregateStatus, published) {
    var aggregateIdleExpiryInMs = ActivityConfig.getConfig().aggregateIdleExpiry * 1000;
    var aggregateMaxExpiryInMs = ActivityConfig.getConfig().aggregateMaxExpiry * 1000;
