...
var _updateFolderContentVisibility = function(ctx, folder, visibility, callback, _start, _failedContent) {
    ...
    FoldersContentLibrary.list(folder, 'private', {'start': _start, 'limit': 40}, function(err, contentIds, nextToken) {
        if (err) {
        ...
        ContentDAO.Content.getMultipleContentItems(contentIds, null, function(err, contentItems) {
            ...
            var done = _.after(contentItems.length, function() {
                ...
                if (nextToken) {
                    _updateFolderContentVisibility(ctx, folder, visibility, callback, nextToken, _failedContent);
