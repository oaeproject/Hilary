...
describe('Configuration', function() {
  ...
  describe('Schema', function() {
    ...
    it('verify get schema global', function(callback) {
      RestAPI.Config.getSchema(globalAdminRestContext, function(err, schema) {
        ...
        assert.strictEqual(
          schema['oae-authentication']['twitter'].elements['enabled']
            .defaultValue,
          true,
        );

        // Verify that the anonymous users can't retrieve the schema
        RestAPI.Config.getSchema(anonymousGlobalRestContext, function(
          err,
          schema,
        ) {
          assert.ok(err);
    ...
    it('verify get schema tenant', function(callback) {
      RestAPI.Config.getSchema(camAdminRestContext, function(err, schema) {
        ...
        RestAPI.Config.getSchema(johnRestContext, function(err, schema) {
          ...
          RestAPI.Config.getSchema(anonymousCamRestContext, function(
            err,
            schema,
          ) {
            assert.ok(err);
    ...
    it('verify defaultValue always returns', function(callback) {
      RestAPI.Config.getSchema(globalAdminRestContext, function(err, schema) {
        assert.ok(!err);
        assert.equal(
          schema['oae-email']['general'].elements['fromAddress'].defaultValue,
          '',
        );
        return callback();
      });
  ...
  describe('Internal Configuration API', function() {
    ...
    it('verify validation', function(callback) {
      ...
      var AuthenticationConfig = ConfigAPI.config('oae-authentication');
      assert.equal(
        AuthenticationConfig.getValue(global.oaeTests.tenants.cam.alias),
        null,
      );
    ...
    it('verify the last updated timestamp increases when updated', function(callback) {
      ...
      TestsUtil.createTenantWithAdmin(tenantAlias, host, function(
        err,
        tenant,
        ...
        var recaptchaUpdateTime = PrincipalsConfig.getLastUpdated(
          tenantAlias,
          'recaptcha',
          'enabled',
        ).getTime();
  ...
  describe('REST Configuration API', function() {
    ...
    it('verify get global config', function(callback) {
      ...
      RestAPI.Config.getTenantConfig(globalAdminRestContext, null, function(
        err,
        config,
      ) {
        assert.ok(!err);
    ...
    it('verify get tenant config', function(callback) {
      // Get the config as an admin user
      RestAPI.Config.getTenantConfig(camAdminRestContext, null, function(
        err,
        config,
      ) {
        assert.ok(!err);
        ...
        RestAPI.Config.getTenantConfig(johnRestContext, null, function(
          err,
          config,
        ) {
          assert.ok(!err);
                ...
                function(err) {
                  ...
                  RestAPI.Config.getTenantConfig(
                    ...
                    function(err, config) {
                      ...
                      assert.ok(
                        _.isObject(
                          config['oae-principals']['termsAndConditions'][
                            'text'
                          ],
                        ),
                      );
                              ...
                              function(err) {
                                ...
                                RestAPI.Config.getTenantConfig(
                                  ...
                                  function(err, config) {
                                    ...
                                    var configUpdate = {
                                      'oae-principals/termsAndConditions/text/en_CA':
                                        'Canadian English',
                                      'oae-principals/termsAndConditions/text/en_GB':
                                        'British English',
                        ...
                        function(err, config) {
                          ...
                          RestAPI.Config.getTenantConfig(
                            ...
                            function(err, config) {
                              ...
                              assert.ok(config);
                              assert.equal(
                                config['oae-principals']['recaptcha'][
                                  'privateKey'
                                ],
                                null,
                              );
                            ...
                            function(err) {
                              ...
                              RestAPI.Config.getTenantConfig(
                                ...
                                function(err, config) {
                                  ...
                                  assert.ok(config);
                                  assert.strictEqual(
                                    config['oae-authentication']['local'][
                                      'enabled'
                                    ],
                                    false,
                                  );
                          ...
                          ConfigTestUtil.updateConfigAndWait(
                            ...
                            function(err) {
                              ...
                              RestAPI.Config.getTenantConfig(
                                globalAdminRestContext,
                                null,
                                function(err, testSetEmptyStringConfig) {
                                  assert.ok(!err);
                                  assert.equal(
                                    testSetEmptyStringConfig['oae-content'][
                                      'storage'
                                    ]['amazons3-access-key'],
                                    'blahblahblah',
                                  );
                                  ...
                                  ConfigTestUtil.updateConfigAndWait(
                                    ...
                                    function(err) {
                                      ...
                                      RestAPI.Config.getTenantConfig(
                                        ...
                                        function(
                                          err,
                                          testSetEmptyStringConfig,
                                        ) {
                                          assert.ok(!err);
                                          assert.strictEqual(
                                            testSetEmptyStringConfig[
                                              'oae-content'
                                            ]['storage']['amazons3-access-key'],
                                            '',
                                          );
          ...
          function(err) {
            ...
            RestAPI.Config.getTenantConfig(
              ...
              function(err, config) {
                assert.ok(!err);
                assert.equal(
                  config['oae-principals']['group']['visibility'],
                  'private',
                );
          ...
          function(err) {
            ...
            RestAPI.Config.getTenantConfig(
              ...
              function(err, config) {
                assert.ok(!err);
                assert.equal(
                  config['oae-content']['storage']['backend'],
                  'amazons3',
                );
