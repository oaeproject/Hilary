...
var cacheWidgetManifests = function() {
    ...
    readdirp({ 'root': uiDirectory + '/node_modules/', 'directoryFilter': ['!.bin'], 'fileFilter': 'manifest.json' })
        .on('data', function (entry) {
            // Extract the widget id from the path. We split on backward slash (\)
            // for Windows and forward slash (/) for other operating systems
...
/**
 * @return the configured ui directory path in the system
 */
