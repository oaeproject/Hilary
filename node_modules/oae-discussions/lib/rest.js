 ...
 */
OAE.tenantRouter.on('post', '/api/discussion/:discussionId', function(
  req,
  res,
) {
 ...
 * @HttpResponse                404                 Could not find the specified discussion
 */
OAE.tenantRouter.on('delete', '/api/discussion/:discussionId', function(
  req,
  res,
) {
  DiscussionsAPI.Discussions.deleteDiscussion(
    req.ctx,
    req.params.discussionId,
 ...
 */
OAE.tenantRouter.on('get', '/api/discussion/library/:principalId', function(
  req,
  res,
) {
  ...
  DiscussionsAPI.Discussions.getDiscussionsLibrary(
    ...
    req.query.start,
    limit,
    function(err, discussions, nextToken) {
      if (err) {
        return res.status(err.code).send(err.msg);
      }

      res.status(200).send({ results: discussions, nextToken: nextToken });
    },
  );
});
...
OAE.tenantRouter.on(
  'delete',
  '/api/discussion/library/:principalId/:discussionId',
  function(req, res) {
 ...
 * @HttpResponse                        404                 Could not find the specified discussion
 */
OAE.tenantRouter.on('post', '/api/discussion/:discussionId/share', function(
  req,
  res,
) {
  ...
  DiscussionsAPI.Discussions.shareDiscussion(
    req.ctx,
    req.params.discussionId,
    members,
    function(err) {
 ...
 * @HttpResponse                            404                 Could not find the specified discussion
 */
OAE.tenantRouter.on('post', '/api/discussion/:discussionId/members', function(
  req,
  res,
) {
 ...
 * @HttpResponse                        404                 Could not find the specified discussion
 */
OAE.tenantRouter.on('get', '/api/discussion/:discussionId/members', function(
  req,
  res,
) {
...
OAE.tenantRouter.on(
  'get',
  '/api/discussion/:discussionId/invitations',
  function(req, res) {
 ...
 * @HttpResponse                        404                 Could not find the specified discussion
 */
OAE.tenantRouter.on('get', '/api/discussion/:discussionId/messages', function(
  req,
  res,
) {
  var limit = OaeUtil.getNumberParam(req.query.limit, 10, 1, 25);
 ...
 * @HttpResponse                404                 Could not find the specified discussion
 */
OAE.tenantRouter.on('post', '/api/discussion/:discussionId/messages', function(
  req,
  res,
) {
...
OAE.tenantRouter.on(
  'delete',
  '/api/discussion/:discussionId/messages/:created',
  function(req, res) {
