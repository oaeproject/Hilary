...
// Vote update
ActivityAPI.registerActivityType(ContentConstants.activity.ACTIVITY_LOODLE_UPDATE_VOTES, {
    'groupBy': [{'object': true}],
    'streams': {
        'activity': {
            'router': {
...
// Schedule update
ActivityAPI.registerActivityType(ContentConstants.activity.ACTIVITY_LOODLE_UPDATE_SCHEDULES, {
    'groupBy': [{'object': true}],
    'streams': {
        'activity': {
            'router': {
 ...
 */
ContentAPI.on(ContentConstants.events.EDITED_DOODLE_SCHEDULES, function (ctx, contentObj) {

    var millis = Date.now();
    var actorResource = new ActivityModel.ActivitySeedResource('user', ctx.user().id, {'user': ctx.user()});
    var objectResource = new ActivityModel.ActivitySeedResource('content', contentObj.id, {'content': contentObj});
    var activitySeed = new ActivityModel.ActivitySeed(ContentConstants.activity.ACTIVITY_LOODLE_UPDATE_SCHEDULES, millis, ActivityConstants.verbs.UPDATE, actorResource, objectResource);
    ActivityAPI.postActivity(ctx, activitySeed);
 ...
 */
ContentAPI.on(ContentConstants.events.EDITED_DOODLE_VOTES, function (ctx, contentObj) {

    var millis = Date.now();
    var actorResource = new ActivityModel.ActivitySeedResource('user', ctx.user().id, {'user': ctx.user()});
    var objectResource = new ActivityModel.ActivitySeedResource('content', contentObj.id, {'content': contentObj});
    var activitySeed = new ActivityModel.ActivitySeed(ContentConstants.activity.ACTIVITY_LOODLE_UPDATE_VOTES, millis, ActivityConstants.verbs.UPDATE, actorResource, objectResource);
    ActivityAPI.postActivity(ctx, activitySeed);
