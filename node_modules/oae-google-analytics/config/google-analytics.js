...
module.exports = {
    ...
    'google-analytics': {
        ...
        'elements': {
            'globalEnabled': new Fields.Bool('Global GA enabled', 'Global Google Analytics enabled', false, {'valueVisibility': 'private', 'tenantOverride': false}),
            'globalTrackingId': new Fields.Text('Global GA tracking-ID', 'The Global Google Analytics tracking-ID', '', {'valueVisibility': 'private', 'tenantOverride': false}),
