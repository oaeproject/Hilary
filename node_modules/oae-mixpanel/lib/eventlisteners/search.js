...
module.exports = function(client) {
    ...
    MixpanelUtil.listen(SearchAPI, SearchConstants.events.SEARCH, function(ctx, searchType, opts, results) {
        ...
        // an autosuggest. There's no inherit searchType or option that
        // determines this. However, a `general` search with an `_interact`
        // scope through just the `user` and `group` resource types is
        // considered to be an autosuggest search
