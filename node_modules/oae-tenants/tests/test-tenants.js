...
describe('Tenants', function() {
    ...
    describe('Get tenant', function() {
        ...
        it('verify get all tenants', function(callback) {
            ...
            RestAPI.Tenant.getTenants(globalAdminRestContext, function(err, tenants) {
                assert.ok(!err);
                assert.ok(tenants);
        ...
        it('verify get tenant by alias', function(callback) {
            ...
            TenantsAPI.getTenant('camtest', function(err, tenant) {
                assert.ok(!err);
                assert.equal(tenant.alias, 'camtest');
                ...
                // Get the GT tenant
                TenantsAPI.getTenant('gttest', function(err, tenant) {
                    assert.ok(!err);
                    ...
                    TenantsAPI.getTenant('non-existing', function(err, tenant) {
                        assert.ok(err);
                        assert.ok(!tenant);
                        callback();
                    });
