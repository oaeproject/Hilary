                                    ...
                                    TestsUtil.generateGroupHierarchy(doerRestContext, [groupIds[4], jack.id], 'member', function(err) {
                                        ...
                                        RestAPI.Content.createLink(doerRestContext, 'Test Content 1', 'Test content description 1', 'public', 'http://www.sakaiproject.org/',  [], [groupIds[0]], function(err, contentObj) {
                                            ...
                                            SearchTestsUtil.searchAll(anonymousRestContext, 'general', ['all'], { 'q': 'Content' }, function(err, results) {
                                                ...
                                                assert.equal(contentDoc.general, undefined);
                                                assert.equal(contentDoc.sort, undefined);

                                                // Verify tenant admin can see it
                                                SearchTestsUtil.searchAll(camAdminRestContext, 'general', ['all'], { 'q': 'Content' }, function(err, results) {                                    
                                                    assert.ok(!err);
                                                    ...
                                                    SearchTestsUtil.searchAll(janeRestContext, 'general', ['all'], { 'q': 'Content' }, function(err, results) {                                    
                                                        assert.ok(!err);
                                                        ...
                                                        SearchTestsUtil.searchAll(janeRestContext, 'general', ['all'], { 'q': 'Content' }, function(err, results) {
                                                            ...
                                                            SearchTestsUtil.searchAll(jackRestContext, 'general', ['all'], { 'q': 'Content' }, function(err, results) {
                                                                assert.ok(!err);
                    ...
                    RestAPI.User.createUser(camAdminRestContext, janeUsername, 'password', 'Janey McJaneFace', null, function(err, jane) {
                        ...
                        SearchTestsUtil.searchAll(darthVaderRestContext, 'general', ['user'], {'q': 'Jack'}, function(err, results) {
                            ...
                            SearchTestsUtil.searchAll(darthVaderRestContext, 'general', ['user'], {'q': 'Jack', 'includeExternal': true}, function(err, results) {
                                ...
                                assert.equal(jackDoc.general, undefined);
                                assert.equal(jackDoc.sort, undefined);
                                assert.equal(jackDoc._type, undefined);

                                // Verify not hidden for anonymous
                                SearchTestsUtil.searchAll(anonymousRestContext, 'general', ['user'], {'q': 'Jack'}, function(err, results) {
                                    assert.ok(!err);
                                    var jackDoc = _getDocById(results, jack.id);
                                    assert.ok(jackDoc);
                                    assert.equal(jackDoc.id, jack.id);
                                    ...
                                    SearchTestsUtil.searchAll(janeRestContext, 'general', ['user'], {'q': 'Jack'}, function(err, results) {
                                        assert.ok(!err);
                                        var jackDoc = _getDocById(results, jack.id);
                                        assert.ok(jackDoc);
                                        assert.equal(jackDoc.id, jack.id);
                                        ...
                                        SearchTestsUtil.searchAll(camAdminRestContext, 'general', ['user'], {'q': 'Jack'}, function(err, results) {
                                            assert.ok(!err);
                                            var jackDoc = _getDocById(results, jack.id);
                                            assert.ok(jackDoc);
                                            assert.equal(jackDoc.id, jack.id);
                        ...
                        RestAPI.User.createUser(camAdminRestContext, janeUsername, 'password', 'Janey McJaneFace', null, function(err, jane) {
                            ...
                            RestAPI.Group.createGroup(jackRestContext, groupAlias, groupAlias, 'A really awesome group', 'public', 'no', [], [sith.id], function(err, group) {
                                ...
                                SearchTestsUtil.searchAll(anonymousRestContext, 'general', ['group'], {'q': 'awesome'}, function(err, results) {
                                    ...
                                    assert.equal(groupDoc.general, undefined);
                                    ...
                                    SearchTestsUtil.searchAll(darthVaderRestContext, 'general', ['group'], {'q': 'awesome'}, function(err, results) {
                                        ...
                                        SearchTestsUtil.searchAll(darthVaderRestContext, 'general', ['group'], {'q': 'awesome', 'includeExternal': true}, function(err, results) {
                                            assert.ok(!err);
                                            var groupDoc = _getDocById(results, group.id);
                                            assert.ok(groupDoc);
                                            assert.equal(groupDoc.tenantAlias, group.tenant);
                                            ...
                                            SearchTestsUtil.searchAll(sithRestContext, 'general', ['group'], {'q': 'awesome'}, function(err, results) {
                                                assert.ok(!err);
                                                var groupDoc = _getDocById(results, group.id);
                                                assert.ok(groupDoc);
                                                assert.equal(groupDoc.tenantAlias, group.tenant);
                                                ...
                                                SearchTestsUtil.searchAll(janeRestContext, 'general', ['group'], {'q': 'awesome'}, function(err, results) {
                                                    assert.ok(!err);
                                                    var groupDoc = _getDocById(results, group.id);
                                                    assert.ok(groupDoc);
                                                    assert.equal(groupDoc.tenantAlias, group.tenant);
                                                    ...
                                                    SearchTestsUtil.searchAll(jackRestContext, 'general', ['group'], {'q': 'awesome'}, function(err, results) {
                                                        assert.ok(!err);
                                                        var groupDoc = _getDocById(results, group.id);
                                                        assert.ok(groupDoc);
                                                        assert.equal(groupDoc.tenantAlias, group.tenant);
                                                    ...
                                                    SearchTestsUtil.searchAll(anonymousRestContext, 'general', ['group'], {'q': 'awesome'}, function(err, results) {
                                                        ...
                                                        SearchTestsUtil.searchAll(anonymousRestContext, 'general', ['group'], {'q': 'joinable'}, function(err, results) {
                                                            ...
                                                            SearchTestsUtil.searchAll(darthVaderRestContext, 'general', ['group'], {'q': 'awesome', 'includeExternal': true}, function(err, results) {
                                                                ...
                                                                SearchTestsUtil.searchAll(darthVaderRestContext, 'general', ['group'], {'q': 'joinable', 'includeExternal': true}, function(err, results) {
                                                                    assert.ok(!err);
                                                                    var groupDoc = _getDocById(results, groupJoinable.id);
                                                                    assert.ok(groupDoc);
                                                                    ...
                                                                    SearchTestsUtil.searchAll(sithRestContext, 'general', ['group'], {'q': 'awesome'}, function(err, results) {
                                                                        ...
                                                                        SearchTestsUtil.searchAll(janeRestContext, 'general', ['group'], {'q': 'awesome'}, function(err, results) {
                                                                            ...
                                                                            SearchTestsUtil.searchAll(jackRestContext, 'general', ['group'], {'q': 'awesome'}, function(err, results) {
                                                                                ...
                                                                                SearchTestsUtil.searchAll(lukeSkywalkerRestContext, 'general', ['group'], {'q': 'skywalker'}, function(err, results) {
                                                                                    assert.ok(!err);
                                                                                    ...
                                                                                    SearchTestsUtil.searchAll(lukeSkywalkerRestContext, 'general', ['group'], {'q': 'joinable', 'includeExternal': true}, function(err, results) {
                                                                                        assert.ok(!err);
                                                                                        var groupDoc = _getDocById(results, groupJoinable.id);
                                                                                        assert.ok(!groupDoc);
                                                                                        ...
                                                                                        SearchTestsUtil.searchAll(jackRestContext, 'general', ['group'], {'q': 'skywalker', 'includeExternal': true}, function(err, results) {
                                                                                            assert.ok(!err);
                                                                                            var groupDoc = _getDocById(results, privateTenantGroup.id);
                                                                                            assert.ok(!groupDoc);
                                                                                            callback();
