...
module.exports = {
    ...
    'general': {
        ...
        'elements': {
            ...
            'baseUrl': new Fields.Text('Base URL', 'UserVoice account base URL (e.g. https://acme.uservoice.com)', '', {'tenantOverride': false, 'suppress': false}),
            'subdomain': new Fields.Text('Subdomain', 'UserVoice account subdomain (e.g., "acme" for "acme.uservoice.com")', '', {'tenantOverride': false, 'suppress': false}),
