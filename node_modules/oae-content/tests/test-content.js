...
describe('Content', function() {
    ...
    describe('Content comments', function() {
        ...
        /**
         * Test that verifies that the profile picture urls for a user are present in the create comment response
         */
        it('verify create comment includes profile picture urls in the response', function(callback) {
            TestsUtil.generateTestUsers(camAdminRestContext, 1, function(err, users, bert) {
                assert.ok(!err);

                // Give Bert a picture
                var getPictureStream = function() {
                    var file = __dirname + '/../../oae-principals/tests/data/restroom.jpg';
                    return fs.createReadStream(file);
                };
