...
module.exports = function(tenant) {
    ...
    // When a login fails, the user is redirected to /login where he
    ...
    tenant.server.post('/api/auth/login',
        tenant.passport.authenticate('local', { 'successRedirect': '/api/auth/me',
