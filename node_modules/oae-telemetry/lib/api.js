...
var init = module.exports.init = function(_telemetryConfig, callback) {
    ...
    if (telemetryConfig.enabled && telemetryConfig.publisher) {
        ...
        // Immediately try and reset telemetry data so if the servers are rebooted it doesn't put off the reset for potentially another
        // full day
        _resetTelemetryData(function(err) {
            if (err) {
                return callback(err);
            }
            ...
            resetIntervalId = setInterval(_resetTelemetryData, telemetryConfig.resetInterval * 1000);
...
var reset = module.exports.reset = function(callback) {
    ...
    _resetCounts(function() {
        // Also remove the reset the locks
...
* @api private
*/
var _resetTelemetryData = function(callback) {
 ...
 * @api private
 */
var _resetCounts = function(callback) {
...
/**
 * Determine whether or not the telemetry module is enabled.
 *
