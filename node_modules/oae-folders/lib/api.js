 ...
 */
var createFolder = (module.exports.createFolder = function(
  ctx,
  displayName,
  description,
  visibility,
  ...
  visibility =
    visibility ||
    FoldersConfig.getValue(ctx.tenant().alias, 'visibility', 'folder');
  roles = roles || {};
  ...
  _.each(roles, function(role) {
    validator
      .check(role, {
        code: 400,
        msg: util.format(
          'The role "%s" is not a valid member role for a folder',
          role,
        ),
      })
  ...
  PrincipalsAPI.canManageAny(ctx, managerIds, function(err, canManageAny) {
    if (err && err.code !== 404) {
      ...
      return callback({
        code: 400,
        msg: 'One or more target principals could not be found',
      });
 ...
 */
var updateFolder = (module.exports.updateFolder = function(
  ctx,
  folderId,
  updates,
  callback,
  ...
  validator
    .check(folderId, {
      code: 400,
      msg: util.format(
        'The folder id "%s" is not a valid resource id',
        folderId,
      ),
    })
    .isResourceId();
  validator
    .check(updates, { code: 400, msg: 'Missing update information' })
    .isObject(updates);
 ...
 */
var updateFolderContentVisibility = (module.exports.updateFolderContentVisibility = function(
  ctx,
  folderId,
  visibility,
  callback,
  ...
  validator
    ...
    .isResourceId();
  validator
    .check(visibility, { code: 400, msg: 'Missing visibility value' })
    .notEmpty();
  validator
    .check(visibility, {
      code: 400,
 ...
 * @api private
 */
var _updateFolderContentVisibility = function(
  ctx,
  folder,
  visibility,
  callback,
  ...
  FoldersAuthz.getContentInFolder(folder, function(err, contentIds) {
    ...
    ContentDAO.Content.getMultipleContentItems(contentIds, null, function(
      err,
      contentItems,
    ) {
      if (err) {
 ...
 */
var getFullFolderProfile = (module.exports.getFullFolderProfile = function(
  ctx,
  folderId,
  callback,
) {
...
var _getFullFolderProfile = function(ctx, folder, callback) {
  AuthzPermissions.resolveEffectivePermissions(ctx, folder, function(
    err,
    permissions,
  ) {
    if (err) {
      ...
      return callback({
        code: 401,
        msg: 'You are not authorized to view this folder',
      });
    }
    ...
    if (ctx.user()) {
      ...
      folder.signature = Signature.createExpiringResourceSignature(
        ctx,
        folder.id,
      );
    }
 ...
 */
var deleteFolder = (module.exports.deleteFolder = function(
  ctx,
  folderId,
  deleteContent,
  callback,
  ...
  var validator = new Validator();
  validator
    .check(folderId, { code: 400, msg: 'A folder id must be provided' })
    .isResourceId();
  validator
    .check(null, {
      code: 401,
          ...
          function(errs) {
            ...
            FoldersAuthz.getContentInFolder(folder, function(err, contentIds) {
              ...
              if (deleteContent) {
                ...
                return _removeAuthzFolderFromContentItems(
                  folder,
                  contentIds,
                  callback,
                );
 ...
 * @api private
 */
var _removeAuthzFolderFromContentItems = function(
  folder,
  contentIds,
  callback,
) {
 ...
 */
var getFolderMembers = (module.exports.getFolderMembers = function(
  ctx,
  folderId,
  start,
  limit,
  ...
  getFolder(ctx, folderId, function(err, folder) {
    ...
    AuthzAPI.getAuthzMembers(folder.groupId, start, limit, function(
      err,
      memberRoles,
      nextToken,
    ) {
      ...
      PrincipalsUtil.getPrincipals(ctx, _.pluck(memberRoles, 'id'), function(
        err,
        memberProfiles,
      ) {
        if (err) {
 ...
 */
var getFolderInvitations = (module.exports.getFolderInvitations = function(
  ctx,
  folderId,
  callback,
) {
 ...
 * @param  {Object}         callback.err    An error that occurred, if any
 */
var resendFolderInvitation = (module.exports.resendFolderInvitation = function(
  ctx,
  folderId,
  email,
  callback,
 ...
 * @param  {Object}     callback.err    An error that occurred, if any
 */
var shareFolder = (module.exports.shareFolder = function(
  ctx,
  folderId,
  principalIds,
  callback,
 ...
 * @param  {Object}     callback.err    An error that occurred, if any
 */
var setFolderPermissions = (module.exports.setFolderPermissions = function(
  ctx,
  folderId,
  changes,
  callback,
    ...
    validator
      .check(role, {
        ...
        msg:
          'The role change: ' +
          role +
          ' is not a valid value. Must either be a string, or false',
      })
      .isValidRoleChange();
    if (role) {
      validator
  ...
  FoldersDAO.getFolder(folderId, function(err, folder) {
    ...
    ResourceActions.setRoles(ctx, folder, changes, function(
      err,
      memberChangeInfo,
    ) {
      if (err) {
 ...
 * @param  {Object}     callback.err    An error that occurred, if any
 */
var addContentItemsToFolder = (module.exports.addContentItemsToFolder = function(
  ctx,
  folderId,
  contentIds,
  callback,
  ...
  FoldersDAO.getFolder(folderId, function(err, folder) {
    ...
    ContentDAO.Content.getMultipleContentItems(contentIds, null, function(
      ...
      FoldersAuthz.canAddItemsToFolder(ctx, folder, contentItems, function(
        err,
      ) {
        if (err && err.code !== 401) {
          return callback(err);
 ...
 * @api private
 */
var _addContentItemsToFolderLibrary = (module.exports._addContentItemsToFolderLibrary = function(
  ctx,
  actionContext,
  folder,
  contentItems,
 ...
 * @param  {Object}     callback.err    An error that occurred, if any
 */
var removeContentItemsFromFolder = (module.exports.removeContentItemsFromFolder = function(
  ctx,
  folderId,
  contentIds,
  callback,
  ...
  validator
    .check(null, {
      code: 401,
      msg:
        'You have to be authenticated to be able to remove an item from a folder',
    })
    .isLoggedInUser(ctx);
  validator
    .check(folderId, { code: 400, msg: 'A valid folder id must be provided' })
  ...
  FoldersDAO.getFolder(folderId, function(err, folder) {
    ...
    AuthzPermissions.canManage(ctx, folder, function(err) {
      ...
      ContentDAO.Content.getMultipleContentItems(contentIds, null, function(
        ...
        _removeContentItemsFromFolder(folder, contentIds.slice(), function(
          err,
        ) {
          if (err) {
            return callback(err);
 ...
 */
var getFoldersLibrary = (module.exports.getFoldersLibrary = function(
  ctx,
  principalId,
  start,
  limit,
    ...
    LibraryAPI.Authz.resolveTargetLibraryAccess(
      ...
      function(err, hasAccess, visibility) {
        if (err) {
          ...
          return callback({
            code: 401,
            msg: 'You do not have have access to this library',
          });
        }
        ...
        FoldersFoldersLibrary.list(
          ...
          function(err, folderIds, nextToken) {
            if (err) {
              return callback(err);
            }
 ...
 */
var getManagedFolders = (module.exports.getManagedFolders = function(
  ctx,
  callback,
) {
  if (!ctx.user()) {
    return callback({
      code: 401,
      msg: 'Anonymous users cannot manage folders',
    });
  }
 ...
 * @param  {Object}         callback.err        An error that occurred, if any
 */
var removeFolderFromLibrary = (module.exports.removeFolderFromLibrary = function(
  ctx,
  principalId,
  folderId,
  callback,
  ...
  FoldersDAO.getFolder(folderId, function(err, folder) {
    ...
    PrincipalsDAO.getPrincipal(principalId, function(err, principal) {
      ...
      AuthzPermissions.canRemoveRole(ctx, principal, folder, function(
        err,
        memberChangeInfo,
      ) {
        if (err) {
        ...
        AuthzAPI.updateRoles(folder.groupId, memberChangeInfo.changes, function(
          err,
        ) {
          if (err) {
            return callback(err);
 ...
 */
var getFolderContentLibrary = (module.exports.getFolderContentLibrary = function(
  ctx,
  folderId,
  start,
  limit,
    ...
    LibraryAPI.Authz.resolveTargetLibraryAccess(
      ...
      function(err, hasAccess, visibility) {
        ...
        FoldersContentLibrary.list(
          ...
          visibility,
          { start: start, limit: limit },
          function(err, contentIds, nextToken) {
            if (err) {
              return callback(err);
            }
 ...
 */
var createMessage = (module.exports.createMessage = function(
  ctx,
  folderId,
  body,
  ...
  validator
    ...
    .isLoggedInUser(ctx);
  validator
    .check(folderId, { code: 400, msg: 'Invalid folder id provided' })
    .isResourceId();
  validator
    .check(body, { code: 400, msg: 'A message body must be provided' })
    .notEmpty();
  validator
    .check(body, {
      code: 400,
 ...
 */
var deleteMessage = (module.exports.deleteMessage = function(
  ctx,
  folderId,
  messageCreatedDate,
  callback,
    ...
    MessageBoxAPI.getMessages(
      ...
      function(err, messages) {
        if (err) {
          ...
          return callback({
            code: 404,
            msg: 'The specified message does not exist',
          });
        }
        ...
        AuthzPermissions.canManageMessage(ctx, folder, message, function(err) {
          ...
          MessageBoxAPI.deleteMessage(
            ...
            function(err, deleteType, deletedMessage) {
              if (err) {
                return callback(err);
              }
 ...
 */
var getMessages = (module.exports.getMessages = function(
  ctx,
  folderId,
  start,
  limit,
  ...
  var validator = new Validator();
  validator
    .check(folderId, { code: 400, msg: 'Must provide a valid folder id' })
    .isResourceId();
  validator
    .check(limit, { code: 400, msg: 'Must provide a valid limit' })
    .isInt();
  if (validator.hasErrors()) {
    return callback(validator.getFirstError());
  }
  ...
  FoldersDAO.getFolder(folderId, function(err, folder) {
    ...
    AuthzPermissions.canView(ctx, folder, function(err) {
      ...
      MessageBoxAPI.getMessagesFromMessageBox(
        ...
        limit,
        null,
        function(err, messages, nextToken) {
          if (err) {
            return callback(err);
          }
...
var _augmentFolder = function(ctx, folder) {
  ...
  if (folder.previews && folder.previews.wideUri) {
    folder.previews.wideUrl = ContentUtil.getSignedDownloadUrl(
      ctx,
      folder.previews.wideUri,
    );
  }
  return folder;
};
