...
var getContentRevisionId = module.exports.getContentRevisionId = function(zencoderId, callback) {
    Cassandra.runQuery('SELECT * FROM "ZencoderPreviewToContentIdMap" WHERE "zencoderId" = ?', [zencoderId], function(err, rows) {
        if (err) {
            return callback(err);
...
var saveContentRevisionId = module.exports.saveContentRevisionId = function(zencoderId, contentId, revisionId, callback) {
    var q = Cassandra.constructUpsertCQL('ZencoderPreviewToContentIdMap', 'zencoderId', zencoderId, {
        'contentId': contentId,
