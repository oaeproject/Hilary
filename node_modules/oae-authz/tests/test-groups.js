...
describe('Authz Groups', function() {
    ...
    describe('#getIndirectPrincipalMemberships()', function() {
        ...
        it('verify paging on freshly cached authz memberships indirect cache', function(callback) {
            var groupId1 = AuthzUtil.toId('g', 'ipm-order', 'a');
            var groupId2 = AuthzUtil.toId('g', 'ipm-order', 'b');
            var groupId3 = AuthzUtil.toId('g', 'ipm-order', 'c');
            var groupId4 = AuthzUtil.toId('g', 'ipm-order', 'd');
            var groupId5 = AuthzUtil.toId('g', 'ipm-order', 'e');
                    ...
                    AuthzAPI.updateRoles(groupId3, makeMembershipChange(groupId4, 'member'), function(err) {
                        ...
                        AuthzAPI.updateRoles(groupId2, makeMembershipChange(groupId3, 'member'), function(err) {
                            ...
                            AuthzAPI.updateRoles(groupId1, makeMembershipChange(groupId2, 'member'), function(err) {
                                ...
                                // Get 3 memberships for mrvisser for the first time, ensuring we get the first 3 lexical groups
                                AuthzAPI.getIndirectPrincipalMemberships(userId, null, 3, function(err, groupIds, nextToken) {
                                    assert.ok(!err);
                                    ...
                                    AuthzAPI.getIndirectPrincipalMemberships(userId, nextToken, 3, function(err, groupIds, nextToken) {
                                        assert.ok(!err);
