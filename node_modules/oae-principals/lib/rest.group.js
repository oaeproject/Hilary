 ...
 * @FormParam   {string}        [managers]              Unique identifier(s) for manager(s) of the group; may also be array
 * @FormParam   {string}        [members]               Unique identifiers(s) for member(s) of the group; may also be array
 ...
 * @param  {String}         [profileFields.visibility]      New visibility setting for the group. Should be one of `AuthzConstants.visibility`'s values
 * @param  {String}         [profileFields.joinable]        New joinability setting for the group. Should be one of
*/
