 ...
 */
MeetingsAPI.on(MeetingsConstants.events.CREATED_MEETING, function(
  ctx,
  meeting,
  memberChangeInfo,
) {
  ...
  if (extraMembers.length === 1) {
    ...
    var targetResourceType = PrincipalsUtil.isGroup(extraMember)
      ? 'group'
      : 'user';
 ...
 */
MeetingsAPI.on(MeetingsConstants.events.UPDATED_MEETING_MEMBERS, function(
  ctx,
  meeting,
  memberChangeInfo,
  opts,
  ...
  var meetingResource = new ActivityModel.ActivitySeedResource(
    'meeting-jitsi',
    meeting.id,
    { 'meeting-jitsi': meeting },
  );
 ...
 */
MeetingsAPI.on(MeetingsConstants.events.UPDATED_MEETING, function(
  ctx,
  newMeeting,
  oldMeeting,
) {
 ...
 */
MeetingsAPI.on(MeetingsConstants.events.CREATED_MEETING_MESSAGE, function(
  ctx,
  message,
  meeting,
) {
  ...
  var objectResource = new ActivityModel.ActivitySeedResource(
    ...
    message.id,
    { meetingId: meeting.id, message: message },
  );
...
var _meetingTransformer = function(ctx, activityEntities, callback) {
  ...
  _.each(activityEntities, function(entities, activityId) {
    ...
    _.each(entities, function(entity, entityId) {
      ...
      transformedActivityEntities[activityId][
        entityId
      ] = _transformPersistentMeetingActivityEntity(ctx, entity);
    });
  });
 ...
 * @see ActivityAPI#registerActivityEntityType
 */
var _meetingMessageInternalTransformer = function(
  ctx,
  activityEntities,
  callback,
) {
 ...
 */
ActivityAPI.registerActivityEntityAssociation('meeting-jitsi', 'self', function(
  associationsCtx,
  entity,
  callback,
) {
