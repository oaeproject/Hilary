...
module.exports = function(tenant) {
     ...
     */
    tenant.api.post('/api/content/:contentId/members', function(req, res) {
     ...
     * Share content
     */
    tenant.api.post('/api/content/:contentId/share', function(req, res) {
     ...
     * Library
     */
    tenant.api.get('/api/content/library/:principalId', function(req, res) {
