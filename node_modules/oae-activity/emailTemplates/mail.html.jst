<%
    ...
    var getEmailSummary = function() {
        if (user.emailPreference === 'immediate') {
            ...
            _.each(activities, function(activity) {
                if (activity.activity.actor !== actor && actor !== null) {
                    isSingleActor = false;
                }
            ...
            if (isSingleActor && actor.objectType !== 'collection') {
                ...
                return util.i18n.translate('ACTIVITY_EMAIL_SUMMARY_IMMEDIATE_SINGLE_ACTOR', {
                    'actorURL': url,
    ...
    var renderHeader = function() {
        ...
        str += '            </tr>';
        str += '            <tr id="greeting">';
        str += '                <td><h1>' + util.i18n.translate('ACTIVITY_EMAIL_GREETING', {'name': util.html.encodeForHTML(user.displayName)}) + '</h1></td>';
        str += '            </tr>';
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <div class="activity-summary-container">
                                                <div><%= util.i18n.translate(activity.summary.i18nKey, activity.summary.i18nArguments) %></div>
