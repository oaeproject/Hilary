                                    ...
                                    client.subscribe(
                                      ...
                                      function(err) {
                                        ...
                                        RestAPI.Content.getContent(
                                          branden.restContext,
                                          contentObj.id,
                                          function(err, contentObjForBranden) {
                                            assert.ok(!err);
                                            client.subscribe(
                                              contentObj.id,
                                              'activity',
        ...
        RestAPI.User.updateUser(
          ...
          function(err) {
            ...
            var _assertAndCallback = _.after(2, function() {
              ...
              assert.strictEqual(activity.object.body, 'Cup a Soup');
              assert.strictEqual(
                activity.object.createdBy.visibility,
                'private',
              );
              assert.strictEqual(
                activity.object.createdBy.displayName,
                'Ma Baker',
              );
              return client.close(callback);
            });
