...
var sendEmail = module.exports.sendEmail = function(templateModule, templateId, toUser, data, opts, callback) {
    ...
    return _sendEmail(emailInfo, callback);
};
 ...
 * @api private
 */
var _sendEmail = function(emailInfo, callback) {
...
/**
 * Given email headers and `sendEmail` options, generate a message hash for
 * the message that is a valid hexadecimal string.
 *
