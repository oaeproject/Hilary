...
var getStorageBackend = (module.exports.getStorageBackend = function(ctx, uri) {
  ...
  if (uri) {
    ...
    backendName = ContentConfig.getValue(
      ctx.tenant().alias,
      'storage',
      'backend',
    );
    if (!backendName) {
      log(ctx).error(
        'There was no storage backend configured, this should not happen',
      );
      throw new Error(
        'There was no storage backend configured for name: ' + backendName,
      );
    }
  }
 ...
 */
var augmentContent = (module.exports.augmentContent = function(
  ctx,
  content,
  duration,
  offset,
  ...
  content.signature = Signature.createExpiringResourceSignature(
    ctx,
    content.id,
  );
 ...
 */
var getSignedDownloadUrl = (module.exports.getSignedDownloadUrl = function(
  ctx,
  uri,
  duration,
  offset,
  ...
  var downloadStrategy = getStorageBackend(ctx, uri).getDownloadStrategy(
    ctx.tenant().alias,
    uri,
  );
  if (
...
var verifySignedDownloadQueryString = (module.exports.verifySignedDownloadQueryString = function(
  ...
  if (qs.expires) {
    return Signature.verifyExpiringSignature(
      { uri: qs.uri },
      qs.expires,
      qs.signature,
    )
 ...
 */
var createPersistentContentActivityEntity = (module.exports.createPersistentContentActivityEntity = function(
  content,
) {
 ...
 */
var transformPersistentContentActivityEntity = (module.exports.transformPersistentContentActivityEntity = function(
  ctx,
  entity,
  previews,
) {
  ...
  opts.ext[ContentConstants.activity.PROP_OAE_CONTENT_TYPE] =
    content.resourceSubType;
  opts.ext[ContentConstants.activity.PROP_OAE_CONTENT_MIMETYPE] = content.mime;
  opts.ext[ContentConstants.activity.PROP_OAE_REVISION_ID] =
 ...
 */
var transformPersistentContentActivityEntityToInternal = (module.exports.transformPersistentContentActivityEntityToInternal = function(
  ctx,
  entity,
  previews,
) {
