...
describe('Preview processor', function() {
    ...
    describe('Preview generation', function() {
        ...
        /**
         * Mock the SlideShare REST API if the tests are run in a CI environment
         *
        ...
        var _mockSlideShareIfNecessary = function(serverStartedCallback) {
            // If we're not running in a CI environment, we don't mock the SlideShare API and talk to it directly
        ...
        var _mockSlideShare = function(returnError, returnBadData, serverStartedCallback) {
            // If we're running in a CI environment, we mock the SlideShare API
            TestsUtil.createTestServer(function(app, server, port) {
        ...
        it('verify SlideShare link processing works', function(callback) {
            ...
            // If we're running the tests on the build environment, we mock the slideshare API as it is 
            // too annoying to have failing builds due to external factors (packet routing, API availabaility)
