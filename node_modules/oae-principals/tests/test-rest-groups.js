...
describe('Group REST endpoints', function() {
    ...
    before(function(callback) {
        ...
        PrincipalAPI.createUser(tenantCtx, 'john-' + r, 'password', 'public', 'en_GB', 'Europe/London', 'John', 'Doe', 'John Doe', function(err, id) {
            johnCtx = new RestAPI.Context(global.oaeTests.tenants.cam.baseUrl, id, 'password');
            callback();
        });
    });
    ...
    describe('#createGroup()', function() {
        ...
        it('verify missing name', function(callback) {
            RestAPI.Groups.createGroup(johnCtx, undefined, 'Group description', 'public', 'yes', [], [], function(err, data) {
        ...
        it('verify that missing visibility uses tenant default', function(callback) {
            var r = Math.floor(Math.random()*100000);
            RestAPI.Groups.createGroup(johnCtx, 'group-' + r, 'Group description', undefined, 'yes', [], [], function(err, data) {
                assert.ok(!err);
        ...
        it('verify that missing joinable uses tenant default', function(callback) {
            var r = Math.floor(Math.random()*100000);
            RestAPI.Groups.createGroup(johnCtx, 'group-' + r, 'Group description', 'public', undefined, [], [], function(err, data) {
                assert.ok(!err);
        ...
        it('verify that members can be specified on group creation', function(callback) {
            ...
            var r = Math.floor(Math.random()*100000);
            PrincipalAPI.createUser(tenantCtx, 'jack-' + r, 'password', 'public', 'en_GB', 'Europe/London', 'Jack', 'Doe', 'John Doe', function(err, jack) {
                assert.ok(!err);
                PrincipalAPI.createUser(tenantCtx, 'jane-' + r, 'password', 'public', 'en_GB', 'Europe/London', 'Jane', 'Doe', 'Jane Doe', function(err, jane) {
                    assert.ok(!err);
                    RestAPI.Groups.createGroup(johnCtx, 'group-' + r, 'Group description', 'public', 'yes', [jane], [jack], function(err, data) {
                        assert.ok(!err);
        ...
        it('verify that group creation fails if an invalid userid is specified as manager', function(callback) {
            var r = Math.floor(Math.random()*100000);
            RestAPI.Groups.createGroup(johnCtx, 'group-' + r, 'Group description', 'public', 'yes', ['totally-invalid'], [], function(err, data) {
                assert.equal(err.code, 400);
                callback();
            });
        });
        ...
        it('verify that group creation fails if an unknown user is specified as manager', function(callback) {
            var r = Math.floor(Math.random()*100000);
            RestAPI.Groups.createGroup(johnCtx, 'group-' + r, 'Group description', 'public', 'yes', ['u:camtest:totally-unknown'], [], function(err, data) {
                assert.equal(err.code, 400);
                callback();
            });
        });
        ...
        it('verify that group creation succeeds given a valid request', function(callback) {
            var r = Math.floor(Math.random()*100000);
            RestAPI.Groups.createGroup(johnCtx, 'group-' + r, 'Group description', 'public', 'yes', [], [], function(err, data) {
                assert.ok(!err);
                callback();
            });
        });
    ...
    describe('#getGroup()', function() {
        ...
        it('verify isMember and isManager', function(callback) {
            ...
            PrincipalAPI.createUser(tenantCtx, 'jack-' + r, 'password', 'public', 'en_GB', 'Europe/London', 'Jack', 'Doe', 'John Doe', function(err, jack) {
                ...
                PrincipalAPI.createUser(tenantCtx, 'jane-' + r, 'password', 'public', 'en_GB', 'Europe/London', 'Jane', 'Doe', 'Jane Doe', function(err, jane) {
                    ...
                    PrincipalAPI.createUser(tenantCtx, 'joe-' + r, 'password', 'public', 'en_GB', 'Europe/London', 'Jane', 'Doe', 'Jane Doe', function(err, joe) {
                        assert.ok(!err);
                        var joeCtx = new RestAPI.Context(global.oaeTests.tenants.cam.baseUrl, joe, 'password');

                        RestAPI.Groups.createGroup(johnCtx, 'group-' + r, 'Group description', 'public', 'yes', [jane], [jack], function(err, newGroup) {
                            assert.ok(!err);
        ...
        it('verify group properties', function(callback) {
            var r = Math.floor(Math.random()*100000);
            RestAPI.Groups.createGroup(johnCtx, 'group-' + r, 'Group description', 'private', 'request', [], [], function(err, newGroup) {
                assert.ok(!err);
                RestAPI.Groups.getGroup(johnCtx, newGroup.id, function(err, groupData) {
                    assert.ok(!err);
                    assert.ok(groupData.isMember);
                    assert.ok(groupData.isManager);
                    assert.equal(groupData.name, 'group-' + r);
        ...
        it('verify paging', function(callback) {
            ...
            var userCreated = function(err, userid) {
                ...
                if (userids.length === 10) {
                    // Add them to a group.
                    RestAPI.Groups.createGroup(johnCtx, 'group-' + r, 'Group description', 'private', 'request', [], userids, function(err, newGroup) {
            ...
            for (var i = 0; i < 10; i++) {
                ...
                PrincipalAPI.createUser(tenantCtx, 'random-user-' + r, 'password', 'public', 'en_GB', 'Europe/London', 'John', 'Doe', 'John Doe', userCreated);
            }
        });
        ...
        it('verify it actually works', function(callback) {
            ...
            PrincipalAPI.createUser(tenantCtx, 'jack-' + r, 'password', 'public', 'en_GB', 'Europe/London', 'Jack', 'Doe', 'John Doe', function(err, jack) {
                ...
                PrincipalAPI.createUser(tenantCtx, 'jane-' + r, 'password', 'public', 'en_GB', 'Europe/London', 'Jane', 'Doe', 'Jane Doe', function(err, jane) {
                    ...
                    var r = Math.floor(Math.random()*10000000);
                    RestAPI.Groups.createGroup(jackCtx, 'alfa-' + r, 'Group description', 'private', 'request', [], [], function(err, newGroup) {
                        var r = Math.floor(Math.random()*10000000);
                        RestAPI.Groups.createGroup(jackCtx, 'beta-' + r, 'Group description', 'private', 'request', [], [], function(err, newGroup) {
