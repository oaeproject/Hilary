 ...
 * @Property    {string[]}                  configFields                Config values in the form `oae-authentication/twitter/enabled`; may be single string or array of strings
 */
 ...
 *
 * @Required    [defaultValue,description,globalAdmin,name,suppress,tenantOverride,type]
