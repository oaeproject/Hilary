        ...
        (error /* , tenant1 */) => {
          ...
          TenantsTestUtil.createTenantAndWait(
            ...
            (error, tenant2) => {
              ...
              }, pipe(union(shouldBeGuestEmailAddresses), map(TenantsAPI.getTenantByEmail), pluck('alias'))(shouldBeGuest));
              ...
              }, pipe(union(shouldMatchCambridgeEmailAddresses), map(TenantsAPI.getTenantByEmail), pluck('alias'))(shouldMatchCambridge));
