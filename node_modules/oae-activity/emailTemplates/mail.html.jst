...
<%
    ...
    var renderPreviewTile = function(entity, wide) {
        ...
        if (entity.resourceType === 'user' && entity.visibility === 'private') {
            str += '                                <span class="preview-tile-title wrapped-tile">' + title + '</span>';
        } else {
            str += '                                <a href="' + shared.ensureAbsoluteLink(entity.profilePath, baseUrl) + '" title="' + util.html.encodeForHTMLAttribute(entity.displayName) + '" target="_blank" class="preview-tile-title wrapped-tile">' + title + '</a>';
        }
        str += '                                </h3></td>';
        if (entity.resourceType !== 'user') {
