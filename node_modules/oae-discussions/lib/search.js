 ...
 */
DiscussionsAPI.on(DiscussionsConstants.events.DELETED_DISCUSSION, function(
  ctx,
  discussion,
) {
...
DiscussionsAPI.on(
  ...
  function(ctx, message, discussion, deleteType) {
 ...
 * @api private
 */
var _produceDiscussionMessageDocuments = function(
  resources,
  callback,
  _documents,
  _errs,
  ...
  if (resource.messages) {
    ...
    return _produceDiscussionMessageDocuments(
      resources,
      callback,
      _documents,
      _errs,
...
SearchAPI.registerSearchDocumentProducer(
  'discussion',
  _produceDiscussionSearchDocuments,
);
...
SearchAPI.registerReindexAllHandler('discussion', function(callback) {
  ...
  var _onEach = function(discussionRows, done) {
    ...
    log().info(
      'Firing re-indexing task for %s discussions.',
      discussionResources.length,
    );

    SearchAPI.postIndexTask('discussion', discussionResources, {
      resource: true,
      children: true,
    });
