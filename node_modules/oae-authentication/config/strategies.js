...
module.exports = {
    ...
    'google': {
        ...
        'elements': {
            'enabled': new Fields.Bool('Google Authentication Enabled', 'Allow Google authentication for tenant', true)
        }
    },
    'twitter': {
    ...
    'saml2': {
        ...
        'tenantOverride': true,
        'elements': {
            'enabled': new Fields.Bool('SAML 2.0 Authentication Enabled', 'Allow SAML 2.0 authentication for tenant', false),
