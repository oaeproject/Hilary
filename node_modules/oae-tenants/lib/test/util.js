 ...
 */
var whenTenantChangePropagated = (module.exports.whenTenantChangePropagated = function(
  callback,
) {
 ...
 */
var generateTestTenants = (module.exports.generateTestTenants = function(
  globalAdminRestCtx,
  numToCreate,
  callback,
  _created,
 ...
 */
var createTenantAndWait = (module.exports.createTenantAndWait = function(
  globalAdminRestCtx,
  alias,
  displayName,
  host,
 ...
 */
var updateTenantAndWait = (module.exports.updateTenantAndWait = function(
  restContext,
  tenantAlias,
  update,
  callback,
 ...
 */
var stopTenantAndWait = (module.exports.stopTenantAndWait = function(
  restContext,
  tenantAlias,
  callback,
) {
 ...
 */
var startTenantAndWait = (module.exports.startTenantAndWait = function(
  restContext,
  tenantAlias,
  callback,
) {
 ...
 */
var generateTestTenantNetworks = (module.exports.generateTestTenantNetworks = function(
  globalAdminRestCtx,
  numToCreate,
  callback,
  _created,
  ...
  RestAPI.Tenants.createTenantNetwork(
    globalAdminRestCtx,
    ShortId.generate(),
    function(err, tenantNetwork) {
      assert.ok(!err);
      _created.push(tenantNetwork);
      return generateTestTenantNetworks(
        globalAdminRestCtx,
        numToCreate,
        callback,
        _created,
 ...
 */
var assertTenantsEqual = (module.exports.assertTenantsEqual = function(
  actual,
  expected,
) {
 ...
 */
var generateTestTenantAlias = (module.exports.generateTestTenantAlias = function(
  seed,
) {
  seed = seed || 'tenant';
 ...
 */
var generateTestTenantHost = (module.exports.generateTestTenantHost = function(
  seed,
) {
  seed = seed || 'host';
 ...
 */
var clearTenantLandingPage = (module.exports.clearTenantLandingPage = function(
  adminRestContext,
  callback,
) {
  var config = {};
  ...
  ConfigTestUtil.updateConfigAndWait(adminRestContext, null, config, function(
    err,
  ) {
    assert.ok(!err);
    return callback();
