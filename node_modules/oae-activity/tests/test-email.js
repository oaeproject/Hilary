...
describe('Activity Email', function() {
                        ...
                        refreshConfiguration(false, false, {}, function(config) {
                            ...
                            RestAPI.Content.createLink(simong.restContext, 'Google', 'Google', 'public', 'http://www.google.ca', [], [nico.user.id], function(err, link) {
                                ...
                                EmailTestsUtil.collectAndFetchEmails(function(messages) {
                                    ...
                                    var now = new TZ.Date('UTC');
                                    var offsetInHours = Math.ceil(new TZ.Date('Etc/GMT+5').getTimezoneOffset() / 60);
                                    var hours = (config.mail.daily.hour - offsetInHours) % 24;
                                    ActivityEmail.collectMails(0, 'daily', now.getDay(), hours, function(err, empty, users) {
                                        assert.ok(!err);
                        ...
                        ConfigTestUtil.updateConfigAndWait(restContext, null, {'oae-principals/user/timezone': 'Etc/GMT+5'}, function(err) {
                            ...
                            RestAPI.Content.createLink(simong.restContext, 'Google', 'Google', 'public', 'http://www.google.ca', [], [nico.user.id], function(err, link) {
                                ...
                                ActivityTestsUtil.collectAndGetActivityStream(nico.restContext, nico.user.id, null, function(err) {
                                    ...
                                    // inbox at 1am on Tuesday, we should send out an email at 20h on Monday
                                            ...
                                            ConfigTestUtil.updateConfigAndWait(restContext, null, {'oae-principals/user/timezone': 'Etc/GMT-5'}, function(err) {
                                                ...
                                                RestAPI.Content.createLink(simong.restContext, 'Google', 'Google', 'public', 'http://www.google.ca', [], [nico.user.id], function(err, link) {
                                                    ...
                                                    ActivityTestsUtil.collectAndGetActivityStream(nico.restContext, nico.user.id, null, function(err) {
                                                        ...
                                                        // As the collector is in the UTC timezone, Nico in UTC-5 and mails should be in the user their 
                                                        // inbox at 1am on Tuesday, we should send out an email at 4am on Wednesday
                        ...
                        ConfigTestUtil.updateConfigAndWait(restContext, null, {'oae-principals/user/timezone': 'Etc/GMT+5'}, function(err) {
                            ...
                            RestAPI.Content.createLink(simong.restContext, 'Google', 'Google', 'public', 'http://www.google.ca', [], [nico.user.id], function(err, link) {
                                ...
                                ActivityTestsUtil.collectAndGetActivityStream(nico.restContext, nico.user.id, null, function(err) {
                                    ...
                                    // As the collector is in the UTC timezone, Nico in UTC+5 and mails should be in the user their 
                                    // inbox at 1am, we should send out an email at 20h
    ...
    it('verify two distinct aggregated activities aggregate during email collection', function(callback) {
        TestsUtil.generateTestUsers(camAdminRestContext, 3, function(err, users, simong, nico, branden) {
            ...
            refreshConfiguration(false, false, {'collectionPollingFrequency': -1, 'aggregateIdleExpiry': 1}, function() {
                                ...
                                setTimeout(RestAPI.Content.createComment, 1100, nico.restContext, contentObj.id, 'Comment C', null, function(err, commentC) {
                                    ...
                                    RestAPI.Content.createComment(branden.restContext, contentObj.id, 'Comment D', null, function(err, commentD) {
                                        ...
                                        EmailTestsUtil.collectAndFetchEmails(function(messages) {
                                            ...
                                            assert.equal(simongMessage['_message'].html.match(/class="comment"/g).length, 4);
