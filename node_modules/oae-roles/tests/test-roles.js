...
describe('Roles', function() {
     ...
     */
    it('should keep users with the same userid from different tenants maintain distinct role associations', function(callback) {
    ...
    it('Verify the functionality of the api.hasRole function', function(callback) {
    ...
    it('Verify the functionality of the api.setRoles function', function(callback) {
    ...
    it('Verify the functionality of the api.getRolesForResourceType function', function(callback) {
    ...
    it('Verify the functionality of the api.getAssociationsForPrincipalsAndResourceType function', function(callback) {
        var baseViewerContentId = 'contentIView';
        var baseManagerContentId = 'contentIManage';
    ...
    it('Verify the functionality of the api.testExplodeGroupHierarchy function', function(callback) {
