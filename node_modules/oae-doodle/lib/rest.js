...
OAE.tenantRouter.on('post', '/api/doodle/:loodleId/schedule', function (req, res) {

    DoodleAPI.addSchedule(req.ctx, req.params.loodleId, req.body, function (err) {
        res.end(err);
    });
});
...
OAE.tenantRouter.on('put', '/api/doodle/:loodleId/votes', function (req, res) {
    ...
    console.log('/api/doodle/:loodleId/votes');
