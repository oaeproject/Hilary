...
var log = require('oae-logger').logger('profiles');
...
module.exports = function(tenant) {
    log().info('Initializing profiles rest endpoints for tenant %s', tenant.alias);
    ...
    tenant.server.post('/api/user/:id/profile/:section', function(req, res) {
        req.telemetryUrl = '/api/user/id/profile/section';
