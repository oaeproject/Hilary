 ...
 * @throws {AssertionError}                     Thrown if any of the assertions fail
 */
var assertUpdateGroupsSucceeds = function(
  restCtx,
  groupIds,
  profileFields,
  callback,
 ...
 * @throws {AssertionError}                 Thrown if any of the assertions fail
 */
var assertUpdateGroupSucceeds = function(restCtx, groupId, profileFields, callback) {
 ...
 * @throws {AssertionError}                     Thrown if any of the assertions fail
 */
var assertUpdateUsersSucceeds = function(
  restCtx,
  userIds,
  profileFields,
  callback,
 ...
 */
var assertUpdateUserSucceeds = function(restCtx, userId, update, callback) {
 ...
 * @throws {AssertionError}                 Thrown if any of the assertions fail
 */
var assertUploadUserPicturesSucceeds = function(
  restCtx,
  userIds,
  opts,
  callback,
 ...
 * @throws {AssertionError}                 Thrown if any of the assertions fail
 */
var assertUploadUserPictureSucceeds = function(restCtx, userId, opts, callback) {
  opts = opts || {};
  opts.x = opts.x || 0;
  opts.y = opts.y || 0;
 ...
 */
var assertMembershipsLibrariesEquals = function(restCtx, expectedMemberships, callback, _userIds) {
  if (!_userIds) {
 ...
 */
var assertMembershipsLibraryEquals = function(restCtx, userId, expectedMembershipIds, callback) {
 ...
 */
var assertMembershipsLibrariesContains = function(restCtx, userIds, containsIds, callback) {
 ...
 * @throws {AssertionError}                 Thrown if there is an issue getting the memberships or if they are not as expected
 */
var assertMembershipsLibraryContains = function(restCtx, userId, containsIds, callback) {
  assertGetAllMembershipsLibrarySucceeds(restCtx, userId, null, memberships => {
    assert.deepEqual(
      _.chain(memberships)
        .pluck('id')
 ...
 * @throws {AssertionError}                 Thrown if there is an issue getting any of the memberships or if they are not as expected
 */
var assertMembershipsLibrariesNotContains = function(restCtx, userIds, notContainsIds, callback) {
  userIds = userIds.slice();
  if (_.isEmpty(userIds)) {
    return callback();
  }
 ...
 * @throws {AssertionError}                         Thrown if there is an issue getting the memberships or if they are not as expected
 */
var assertMembershipsLibraryNotContains = function(restCtx, userId, notContainsIds, callback) {
  assertGetAllMembershipsLibrarySucceeds(restCtx, userId, null, memberships => {
    assert.ok(
      _.chain(memberships)
        .pluck('id')
 ...
 */
var assertDeleteGroupsSucceeds = function(
  adminRestCtx,
  deleterRestCtx,
  groupIds,
  callback,
 ...
 */
var assertDeleteGroupSucceeds = function(adminRestCtx, deleterRestCtx, groupId, callback) {
 ...
 */
var assertDeleteUsersSucceeds = function(
  adminRestCtx,
  deleterRestCtx,
  userIds,
  callback,
 ...
 */
var assertDeleteUserSucceeds = function(adminRestCtx, deleterRestCtx, userId, callback) {
 ...
 */
var assertGetAllMembersLibraryEquals = function(restCtx, groupId, expectedMemberIds, callback) {
 ...
 */
var getAllMembershipsLibraries = function(restCtx, userIds, opts, callback, _membershipsLibraries) {
  userIds = userIds.slice();
 ...
 */
var assertGetAllMembershipsLibrarySucceeds = function(
  restCtx,
  userId,
  opts,
  callback,
 ...
 */
var assertGetAllMembersLibrarySucceeds = function(
  restCtx,
  groupId,
  opts,
  callback,
 ...
 */
var assertVerifyEmailsSucceeds = function(userInfoTokens, callback) {
  if (_.isEmpty(userInfoTokens)) {
    return callback();
  }

  const userInfoToken = userInfoTokens.pop();
  const userInfo = userInfoToken.userInfo;
  const token = userInfoToken.token;
 ...
 */
var assertVerifyEmailSucceeds = function(restCtx, userId, token, callback) {
 ...
 * @throws {AssertionError}                 Thrown if the operation is unsuccessful
 */
var assertGetEmailTokenSucceeds = function(restCtx, userId, callback) {
 ...
 * @throws {AssertionError}                 Thrown if the operation is successful
 */
var assertDeleteEmailTokenFails = function(restCtx, userId, httpCode, callback) {
 ...
 */
var onceVerificationEmailSent = function(email, assertions, callback) {
