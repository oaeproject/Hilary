...
module.exports = {
    ...
    'previews': {
        ...
        'tenantOverride': true,
        'elements': {
            'expiration_minimum': new Fields.Text('Minimum Time', 'The minimum amount of time (in seconds) that a signature should be valid', 15*60*60),
            'expiration_maximum': new Fields.Text('Maximum Time', 'The maximum amount of time (in seconds) that a signature should be valid', 30*60*60)
        }
    }
};
