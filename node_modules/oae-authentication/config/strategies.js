...
module.exports = {
    ...
    'cas': {
        ...
        'elements': {
            ...
            'logoutUrl': new Fields.Text('Logout URL', 'The URL where the user should be redirected to when logging out of OAE. This should be a full url including a valid protocol(http://)', '', {'suppress': true}),
