 ...
 * This will only look for the group in the tenant as determined by the context.
 *
 * @param  {Context}                context         The current context.
 ...
 * @param  {Object}                 callback.group  The group object
 */
var getGroupByAlias = module.exports.getGroupByAlias = function(context, alias, callback) {
    var id = AuthzUtil.toUuid(Constants.PRINCIPAL_TYPE_GROUP, context.tenant().alias, alias);
    getGroup(context, id, callback);
};
 ...
 */
var getFullGroupProfile = module.exports.getFullGroupProfile = function(context, group_id, callback) {
    getGroup(context, group_id, function(err, group) {
        ...
        AuthzAPI.getAllRoles(context.user().id, group_id, function(err, roles) {
            if (err) {
                return callback(err);
            }
            group.isMember = (roles[Constants.roles.MEMBER] || roles[Constants.roles.MANAGER]);
            group.isManager = (roles[Constants.roles.MANAGER]);
...
var setGroupMembers = module.exports.setGroupMembers = function(ctx, groupUuid, members, callback) {
    ...
    canManage(ctx, groupUuid, function(err, canManage) {
        if (err) {
            return callback(err);
        } else if (!canManage) {
...
var updateGroup = module.exports.updateGroup = function(context, groupId, profileFields, callback) {
    ...
    canManage(context, groupId, function(err, canManage) {
        if (err) {
            return callback(err);
        }
        if (!canManage) {
...
var canManage = module.exports.canManage = function(ctx, groupUuid, callback) {
    ...
    if (currentUserUuid !== null) {
        getGroup(ctx, groupUuid, function(err, group) {
            ...
            _canManage(ctx, groupUuid, function(err, canManage) {
                if (err) {
                    return callback(err);
                }
...
var _canManage = function(context, groupUuid, callback) {
    AuthzAPI.isAllowed(userUuid(context), Constants.roles.MANAGER, groupUuid, callback);
};
