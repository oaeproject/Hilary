...
var getFollowers = module.exports.getFollowers = function(userId, start, limit, callback) {
    Cassandra.runPagedColumnQuery('FollowingUsersFollowers', 'userId', userId, start, limit, null, function(err, row, nextToken) {
        if (err) {
            return callback(err);
        }
...
var getFollowing = module.exports.getFollowing = function(userId, start, limit, callback) {
    Cassandra.runPagedColumnQuery('FollowingUsersFollowing', 'userId', userId, start, limit, null, function(err, row, nextToken) {
        if (err)  {
            return callback(err);
        }
