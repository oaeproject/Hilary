...
describe('Tenants', function() {
    ...
    describe('Get tenant', function() {
        ...
        it('verify get all tenants', function(callback) {
            var tenant1Alias = TestsUtil.generateRandomText().toLowerCase();
            ...
            RestAPI.Tenants.getTenants(globalAdminRestContext, function(err, tenants) {
                ...
                // Create a new tenant
                TenantsTestUtil.createTenantAndWait(globalAdminRestContext, tenant1Alias, tenant1Description, tenant1Host, function(err) {
                    assert.ok(!err);
    ...
    describe('Tenant actions', function() {
        ...
        it('verify create tenant as anonymous user fails', function(callback) {
            ...
            TenantsTestUtil.createTenantAndWait(anonymousGlobalRestContext, tenant1Alias, tenant1Description, tenant1Host, function(err) {
                assert.ok(err);
        ...
        it('verify create tenant', function(callback) {
            ...
            TenantsTestUtil.createTenantAndWait(globalAdminRestContext, tenant1Alias, tenant1Description, tenant1Host, function(err, tenant) {
                assert.ok(!err);
                assert.ok(tenant);
        ...
        it('verify create tenant uppercase alias', function(callback) {
            var tenant1Alias = TestsUtil.generateRandomText().toUpperCase();
            var tenant1Description = TestsUtil.generateRandomText();
            var tenant1Host = TestsUtil.generateRandomText().toLowerCase();
            ...
            TenantsTestUtil.createTenantAndWait(globalAdminRestContext, tenant1Alias, tenant1Description, tenant1Host, function(err) {
                ...
                RestAPI.Tenants.getTenant(uppercaseRestContext, null, function(err, tenant) {
                    assert.ok(!err);
                    assert.ok(tenant);
                    assert.equal(tenant.alias, tenant1Alias.toLowerCase());
                    assert.equal(tenant.host, tenant1Host);
                    callback();
                });
            });
        ...
        it('verify recreating deleted tenant with same hostname or alias', function(callback) {
            ...
            TenantsTestUtil.createTenantAndWait(globalAdminRestContext, tenant1Alias, tenant1Description, tenant1Host, function(err) {
                ...
                RestAPI.Tenants.deleteTenant(globalAdminRestContext, tenant1Alias, function(err) {
                    ...
                    TenantsTestUtil.createTenantAndWait(globalAdminRestContext, tenant1Alias, tenant1Description, tenant1Host + 'change', function(err) {
                        assert.ok(err);
                        assert.equal(err.code, 400);

                        // Try recreating the tenant using the same hostname
                        TenantsTestUtil.createTenantAndWait(globalAdminRestContext, tenant1Alias + 'change', tenant1Description, tenant1Host, function(err) {
                            assert.ok(err);
                            assert.equal(err.code, 400);
                            callback();
                        });
