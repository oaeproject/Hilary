 ...
 *                                      need to be updated/inserted and the values represent the new column values
 * @param  {String}     consistency     The consistency level that should be used for the query (e.g. QUORUM). This
 *                                      is optional in case this function would be used to construct the segments of
 *                                      a batch query
 ...
 */
module.exports.constructUpsertCQL = function(cf, rowKey, rowValue, values, consistency) {
 ...
 * @param {String} value String that will be converted to Boolean if it matches: 'true', 'false', '1' or '0'
    ...
    pool.cql(query, parameters, function(err, results) {
        ...
        if (results) {
            for (var i = 0, l = results.length; i < l; ++i) {
                for (var ii = 0, ll = results[i].length; ii < ll; ++ii) {
                    results[i][ii].value = castToBoolean(results[i][ii].value);
                }
            }
        }
