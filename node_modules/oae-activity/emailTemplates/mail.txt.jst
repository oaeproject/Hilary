<%
    ...
    var summary = util.html.toText(shared.getEmailSummary(util, user.emailPreference, activities, baseUrl), false);
%>
...
var footer = '';
footer += util.html.toText(shared.ensureAbsoluteLinks(util.i18n.translate('__MSG__EMAIL_CHANGE_PREFRENCES__', {'url': url}), baseUrl), true) + '\n';
