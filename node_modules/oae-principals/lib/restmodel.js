 ...
 * @RESTModel CropInfo
 *
 * @Required    [principalId,width,x,y]
 * @Property    {string}        principalId             The ID of the principal to crop the large picture for
 * @Property    {number}        width                   The width of the square that needs to be cropped out
 * @Property    {number}        x                       The x coordinate of the topleft corner to start cropping
 * @Property    {number}        y                       The y coordinate of the topleft corner to start cropping
 */
 ...
 * @Property    {string}        profilePath             URL for group's main page
 ...
 * @Property    {Group[]}       results                 Array of members associated with object
 ...
 * @RESTModel NewGroup
 *
 * @Required    [description,displayName,joinable,visibility]
 * @Property    {string}        description             Description of group
 * @Property    {string}        displayName             Name to display for group
 * @Property    {string}        joinable                Can users join group            [no,request,yes]
 * @Property    {string[]}      managers                Unique identifier(s) for manager(s) of the group
 * @Property    {string[]}      members                 Unique identifiers(s) for member(s) of the group
 * @Property    {string}        visibility              Visibility for group            [loggedin,private,public]
 */

/**
 * @RESTModel NewProfile
 *
 * @Required    []
 * @Property    {string}        emailPreference         Email preferences for user [daily,immediate,weekly]
 * @Property    {string}        locale                  Locale for user (e.g. en_US)
 ...
 * @RESTModel NewUser
 *
 * @Required    [displayName,password,username]
 * @Property    {boolean}       acceptedTC              Has user accepted terms and conditions
 * @Property    {string}        displayName             Name to display for user
 * @Property    {string}        email                   Email address for user
 * @Property    {string}        emailPreference         Email preferences for user      [daily,immediate,weekly]
 * @Property    {string}        locale                  Locale for user (e.g. en_US)
 * @Property    {string}        password                Local password for user
 * @Property    {string}        publicAlias             Public alias for user
...
/**
 * @RESTModel UserImportInfo
 *
 * @Required    [authenticationStrategy]
 * @Property    {string}        authenticationStrategy  How are users authenticated       [cas,facebook,google,ldap,local,oauth,shibboleth,signed,twitter]
 * @Property    {boolean}       forceProfileUpdate      If true, indicates that profiles should be updated with the given data, not just created. Otherwise, profiles will only be created if they don't already have a matching external id in the provided authentication strategy
 * @Property    {string}        tenantAlias             The target tenant in which to import the users. Defaults to the tenant on which the request was made
 */
