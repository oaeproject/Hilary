...
OAE.tenantRouter.on('get', '/api/meeting-jitsi/:meetingId', function(req, res) {
  MeetingsAPI.Meetings.getFullMeetingProfile(
    req.ctx,
...
OAE.tenantRouter.on(
  'get',
  '/api/meeting-jitsi/:meetingId/invitations',
  function(req, res) {
    MeetingsAPI.Meetings.getMeetingInvitations(
      req.ctx,
      req.params.meetingId,
 ...
 * @HttpResponse                        404                 Could not find the specified meeting
 */
OAE.tenantRouter.on('get', '/api/meeting-jitsi/:meetingId/members', function(
  req,
  res,
) {
...
OAE.tenantRouter.on('put', '/api/meeting-jitsi/:meetingId', function(req, res) {
  MeetingsAPI.Meetings.updateMeeting(
    req.ctx,
    req.params.meetingId,
    req.body,
    function(err, meeting) {
 ...
 * @HttpResponse                404                 Could not find the specified meeting
 */
OAE.tenantRouter.on('delete', '/api/meeting-jitsi/:meetingId', function(
  req,
  res,
) {
  MeetingsAPI.Meetings.deleteMeeting(req.ctx, req.params.meetingId, function(
    err,
  ) {
    if (err) {
      return res.status(err.code).send(err.msg);
 ...
 * @HttpResponse                            404                 Could not find the specified meeting
 */
OAE.tenantRouter.on('put', '/api/meeting-jitsi/:meetingId/members', function(
  req,
  res,
) {
  ...
  MeetingsAPI.Meetings.setMeetingMembers(
    req.ctx,
    req.params.meetingId,
    permissionUpdates,
    function(err) {
 ...
 * @HttpResponse                        404                 Could not find the specified meeting
 */
OAE.tenantRouter.on('get', '/api/meeting-jitsi/:meetingId/messages', function(
  req,
  res,
) {
  var limit = OaeUtil.getNumberParam(req.query.limit, 10, 1, 25);
 ...
 * @HttpResponse                404                 Could not find the specified meeting
 */
OAE.tenantRouter.on('post', '/api/meeting-jitsi/:meetingId/messages', function(
  req,
  res,
) {
...
OAE.tenantRouter.on(
  'delete',
  '/api/meeting-jitsi/:meetingId/messages/:created',
  function(req, res) {
 ...
 */
OAE.tenantRouter.on('get', '/api/meeting-jitsi/library/:principalId', function(
  req,
  res,
) {
  ...
  MeetingsAPI.Meetings.getMeetingsLibrary(
    ...
    req.query.start,
    limit,
    function(err, meetings, nextToken) {
      if (err) {
        return res.status(err.code).send(err.msg);
      }

      res.status(200).send({ results: meetings, nextToken: nextToken });
    },
  );
});
...
OAE.tenantRouter.on(
  'delete',
  '/api/meeting-jitsi/library/:principalId/:meetingId',
  function(req, res) {
