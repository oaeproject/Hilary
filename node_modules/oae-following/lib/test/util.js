 ...
 */
var followAll = module.exports.followAll = function(followedUserId, followerUsers, callback) {
    ...
    RestAPI.Following.follow(followerUser.restContext, followedUserId, function(err) {
        assert.ok(!err);
        return followAll(followedUserId, followerUsers, callback);
    });
};
...
/**
 * Search the follower user from the following list and the followed user from the follower list from each user.
 *
 * @param  {String}         followerUserId              The id of the follower user
 * @param  {RestContext}    followerRestCtx             The REST context that can be used to execute requests on behalf of the follower user
 * @param  {String}         followedUserId              The id of the expected followed user
 ...
 *
 * @param  {Object[]}   results     An array of search documents to search
