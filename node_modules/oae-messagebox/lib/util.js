 ...
 */
var createPersistentMessageActivityEntity = (module.exports.createPersistentMessageActivityEntity = function(
  message,
  callback,
) {
  PrincipalsDAO.getPrincipal(message.createdBy.id, function(
    err,
    createdByUser,
  ) {
    if (err) {
      ...
      MessageBoxAPI.getMessages(
        ...
        function(err, messages) {
          if (err) {
            ...
            return callback({
              code: 404,
              msg: 'The message could not be found',
            });
          }
          ...
          if (parent && !parent.deleted) {
            ...
            PrincipalsDAO.getPrincipal(parent.createdBy, function(
              err,
              parentUser,
            ) {
              if (err) {
              ...
              return callback(
                null,
                _createPersistentMessageActivityEntity(message, context),
              );
            });
          } else {
 ...
 */
var transformPersistentMessageActivityEntity = (module.exports.transformPersistentMessageActivityEntity = function(
  ctx,
  entity,
  profilePath,
  urlFormat,
) {
  var context = entity.messageContext || {};
  var tenant = ctx.tenant();
  var transformedEntity = _transformMessageActivityEntity(
    ctx,
    entity,
    entity.message,
    urlFormat,
  ...
  if (context.parent) {
    transformedEntity[
      MessageBoxConstants.activity.IN_REPLY_TO
    ] = _transformMessageActivityEntity(
      ctx,
      entity,
      context.parent,
      urlFormat,
 ...
 * @api private
 */
var _transformMessageActivityEntity = function(
  ctx,
  entity,
  message,
  urlFormat,
  ...
  var globalId =
    'http://' + tenant.host + util.format(urlFormat, message.created);
  ...
  opts.ext[MessageBoxConstants.activity.PROP_OAE_MESSAGE_BOX_ID] =
    message.messageBoxId;
  opts.ext[MessageBoxConstants.activity.PROP_OAE_THREAD_KEY] =
    message.threadKey;
 ...
 */
var transformPersistentMessageActivityEntityToInternal = (module.exports.transformPersistentMessageActivityEntityToInternal = function(
  ctx,
  message,
) {
