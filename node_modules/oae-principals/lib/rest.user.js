...
OAE.tenantRouter.on('get', '/api/user/:userId/export/:exportType', function(req, res) {
    PrincipalsAPI.exportData(req.ctx, req.params.userId, req.params.exportType, function(err, data) {
        if (err) {
            return res.status(err.code).send(err.msg);
        }

        // fs.appendFile('log.txt', data.txtFile, function (err) {
        //     if (err) {
        //         console.log('err')
        ...
        // res.setHeader('Content-Disposition', data)
        ...
        //     res.end(data.txtFile);
        //     return res.download(writeStream, data.txtFile);
        // });
        ...
        // res.setHeader('Content-type', 'text/plain');
        // return res.download('filename.txt', data);
