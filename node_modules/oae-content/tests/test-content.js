...
describe('Content', function() {
    ...
    var setUpUsers = function(callback) {
        ...
        var contexts = [new Context(tenant1, new User(tenant1, 'u:cam:nm417-' + r, 'nm417-' + r, 'public', 'en_GB', 'Europe/London', 'Nicolaas', 'Matthijs', 'Nicolaas Matthijs')),
                        new Context(tenant1, new User(tenant1, 'u:cam:simong-' + r, 'simong-' + r, 'loggedin', 'en_GB', 'Europe/London', 'Simon', 'Gaeremynck', 'Simon Gaeremynck')),
                        new Context(tenant1, new User(tenant1, 'u:cam:bp323-' + r, 'bp323-' + r, 'private', 'en_GB', 'Europe/London', 'Bert', 'Pareyn', 'Bert Pareyn')),
                        new Context(tenant1, new User(tenant1, 'u:cam:branden-' + r, 'branden-' + r, 'private', 'en_GB', 'Europe/London', 'Branden', 'Visser', 'Branden Visser')),
                        new Context(tenant1, new User(tenant1, 'u:cam:arwhyte-' + r, 'arwhyte-' + r, 'public', 'en_GB', 'Europe/London', 'Anthony', 'Whyte', 'Anthony Whyte')),
                        new Context(tenant2, new User(tenant2, 'u:gt:stuart-' + r, 'stuart-' + r, 'public', 'en_GB', 'Europe/London', 'Stuart', 'Freeman', 'Stuart Freeman'))];
        var done = 0;
        ...
        for (var u = 0; u < contexts.length; u++) {
            ...
            PrincipalsAPI.createUser(contexts[u], user.username, 'password' + u, user.visibility, user.locale, user.timezone, user.firstName, user.lastName, user.displayName, createUserDone);
        }
    };
     ...
     */ 
     var setUpGroups = function(contexts, callback) {
        ...
        PrincipalsAPI.createGroup(contexts[0], groups[0].alias, groups[0].name, groups[0].description, 'public', 'yes', bertMember, {}, function(err, principal_id) {
            groups[0].id = principal_id;
            // Create Back-end Dev Group
            // Make Simon a member
            var simonMember = {};
            simonMember[contexts[1].user().id] = 'member';
            PrincipalsAPI.createGroup(contexts[3], groups[1].alias, groups[1].name, groups[1].description, 'public', 'yes', simonMember, {}, function(err, principal_id) {
                groups[1].id = principal_id;
                ...
                PrincipalsAPI.createGroup(contexts[4], groups[2].alias, groups[2].name, groups[2].description, 'public', 'yes', members, {}, function(err, principal_id) {
                    groups[2].id = principal_id;
                    callback(groups);
                });
            });
        });
