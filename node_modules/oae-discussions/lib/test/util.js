 ...
 * @throws {AssertionError}                 Thrown if the request fails
 */
var assertUpdateDiscussionMembersSucceeds = module.exports.assertUpdateDiscussionMembersSucceeds = function(restContext, discussionId, updates, callback) {
    RestAPI.Discussions.updateDiscussionMembers(restContext, discussionId, updates, function(err) {
        assert.ok(!err);
