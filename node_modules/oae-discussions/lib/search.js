 ...
 */
const init = module.exports.init = function(callback) {
    return MessageBoxSearch.registerMessageSearchDocument(DiscussionsConstants.search.MAPPING_DISCUSSION_MESSAGE, ['discussion'], (resources, callback) => {
 ...
 */
DiscussionsAPI.on(DiscussionsConstants.events.DELETED_DISCUSSION_MESSAGE, (ctx, message, discussion, deleteType) => {
 ...
 * @api private
 */
var _produceDiscussionMessageDocuments = function(resources, callback, _documents, _errs) {
    ...
    if (resource.messages) {
        const documents = MessageBoxSearch.createMessageSearchDocuments(DiscussionsConstants.search.MAPPING_DISCUSSION_MESSAGE, resource.id, resource.messages);
    ...
    MessageBoxSearch.createAllMessageSearchDocuments(DiscussionsConstants.search.MAPPING_DISCUSSION_MESSAGE, resource.id, resource.id, (err, documents) => {
        if (err) {
