 ...
 * @api private
 */
var _produceResourceFollowersDocuments = function(resources, callback, _documents, _errors) {
    ...
    _getAllIds(FollowingDAO.getFollowers, resource.id, null, 100, function(err, followerUserIds) {
        if (err) {
            _errors.push(err);
            return _produceResourceFollowersDocuments(resources, callback, _documents, _errors);
        }
 ...
 * @api private
 */
var _produceResourceFollowingDocuments = function(resources, callback, _documents, _errors) {
    _documents = _documents || [];
    _errors = _errors || [];
    if (_.isEmpty(resources)) {
        return callback(_errors, _documents);
    ...
    _getAllIds(FollowingDAO.getFollowing, resource.id, null, 100, function(err, followingUserIds) {
        ...
        return _produceResourceFollowingDocuments(resources, callback, _documents, _errors);
    });
};
