...
var _generatePictureURLs = function(ctx, principal) {
    if (principal.picture.smallUri) {
        principal.picture.small = getSignedPictureUrl(ctx.tenant().alias, principal.picture.smallUri);
    }
    if (principal.picture.mediumUri) {
        principal.picture.medium = getSignedPictureUrl(ctx.tenant().alias, principal.picture.mediumUri);
    }
    if (principal.picture.largeUri) {
        principal.picture.large = getSignedPictureUrl(ctx.tenant().alias, principal.picture.largeUri);
    }
};
