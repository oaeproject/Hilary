        ...
        try {
            ...
            _.each(doc.endpoints, function(endpoint) {
                ...
                _.each(endpoint.formParams, function(formParam) {
                    endpoint.parameters.push(SwaggerParamTypes.form(formParam.name, formParam.description, _convertRJDArrayDefToSwagger(formParam.type), formParam.required, formParam.defaultValue));
                });
