 ...
 * @api private
 */
var _produceMeetingMessageDocuments = function(
  resources,
  callback,
  _documents,
  _errs,
  ...
  if (resource.messages) {
    ...
    return _produceMeetingMessageDocuments(
      resources,
      callback,
      _documents,
      _errs,
...
SearchAPI.registerSearchDocumentProducer(
  'meeting-jitsi',
  _produceMeetingSearchDocuments,
);
 ...
 */
MeetingsAPI.on(MeetingsConstants.events.DELETED_MEETING, function(
  ctx,
  meeting,
) {
 ...
 */
MeetingsAPI.on(MeetingsConstants.events.DELETED_MEETING_MESSAGE, function(
  ctx,
  message,
  meeting,
  deleteType,
...
SearchAPI.registerReindexAllHandler('meeting-jitsi', function(callback) {
  ...
  var _onEach = function(meetingRows, done) {
    ...
    log().info(
      'Firing re-indexing task for %s meetings.',
      meetingResources.length,
    );

    SearchAPI.postIndexTask('meeting-jitsi', meetingResources, {
      resource: true,
      children: true,
    });
