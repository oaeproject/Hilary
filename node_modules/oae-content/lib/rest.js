 ...
 */
var verifySignedDownload = function(req, res) {
...
OAE.globalAdminRouter.on('get', '/api/download/signed', verifySignedDownload);
OAE.tenantRouter.on('get', '/api/download/signed', verifySignedDownload);
