...
var createPrincipals = function(test, ctx, callback) {
...
var createOAEStructure = function(test, ctx, callback) {
    createPrincipals(test, ctx, function(id){
        var checks = 0;
...
exports.testSimpleGroupStructure = function(test) {
    createAndGetUser(tenant, 'test-runner', 'password', 'public', 'Test', 'Runner', 'tr123', function(err, user) {
        var ctx = new Context(tenant, user);
        createOAEStructure(test, ctx, function(id) {
...
exports.testAddMemberNoAccess = function(test) {
    ...
    // 1. create the users
    createAndGetUser(tenant, 'mrvisser', 'password', 'public', 'Test', 'Runner', 'tr123', function(err, mrvisser) {
        test.ok(!err);

        var mrvisserCtx = new Context(tenant, mrvisser);
        createAndGetUser(tenant, 'nicolaas', 'password', 'public', 'Test1', 'Runner1', 'nicolaas', function(err, nico) {
            test.ok(!err);

            var nicoCtx = new Context(tenant, nico);
            createAndGetUser(tenant, 'simong', 'password', 'public', 'Test2', 'Runner2', 'simong', function(err, simong) {
                test.ok(!err);
...
var createAndGetUser = function(tenant, username, password, visibility, firstName, lastName, displayName, callback) {
    api.createUser(tenant, username, password, visibility, firstName, lastName, displayName, function(err, id) {
