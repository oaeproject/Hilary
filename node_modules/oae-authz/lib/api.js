 ...
 * a version of `getRolesForPrincipalAndResourceType` that pages.
 *
...
var resolveImplicitRole = module.exports.resolveImplicitRole = function(ctx, resourceId, resourceTenantAlias, resourceVisibility, rolesPriority, callback) {
    ...
    // Check admin access
    } else if (user.isAdmin(resourceTenantAlias)) {
        // The user is an administrator of the resource's tenant, give them the highest allowable
        // access
        return callback(null, _.last(rolesPriority), true);
    }
