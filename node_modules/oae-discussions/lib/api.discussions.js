 ...
 */
var createDiscussion = function(ctx, displayName, description, visibility, roles, opts, callback) {
  visibility =
 ...
 */
var updateDiscussion = function(ctx, discussionId, profileFields, callback) {
  var allVisibilities = _.values(AuthzConstants.visibility);
 ...
 * @param  {Object}     callback.err        An error that occurred, if any
 */
var deleteDiscussion = function(ctx, discussionId, callback) {
  var validator = new Validator();
  validator
    .check(discussionId, { code: 400, msg: 'A discussion id must be provided' })
    .isResourceId();
 ...
 */
var getDiscussionsLibrary = function(ctx, principalId, start, limit, callback) {
  ...
  PrincipalsDAO.getPrincipal(principalId, function(err, principal) {
    ...
    LibraryAPI.Authz.resolveTargetLibraryAccess(ctx, principal.id, principal, function(
      err,
      hasAccess,
      visibility
    ) {
 ...
 */
var getDiscussion = function(ctx, discussionId, callback) {
  var validator = new Validator();
  validator
 ...
 */
var getFullDiscussionProfile = function(ctx, discussionId, callback) {
  var validator = new Validator();
  validator
    .check(discussionId, { code: 400, msg: 'discussionId must be a valid resource id' })
    .isResourceId();
 ...
 */
var getDiscussionMembers = function(ctx, discussionId, start, limit, callback) {
  limit = OaeUtil.getNumberParam(limit, 10, 1);
 ...
 */
var getDiscussionInvitations = function(ctx, discussionId, callback) {
  var validator = new Validator();
  validator
 ...
 * @param  {Object}         callback.err    An error that occurred, if any
 */
var resendDiscussionInvitation = function(ctx, discussionId, email, callback) {
  var validator = new Validator();
  validator
    .check(discussionId, { code: 400, msg: 'A valid resource id must be specified' })
    .isResourceId();
 ...
 * @param  {Object}     callback.err        An error that occurred, if any
 */
var shareDiscussion = function(ctx, discussionId, principalIds, callback) {
  var validator = new Validator();
  validator
  ...
  _getDiscussion(discussionId, function(err, discussion) {
    ...
    ResourceActions.share(ctx, discussion, principalIds, AuthzConstants.role.MEMBER, function(
      err,
      memberChangeInfo
    ) {
      if (err) {
 ...
 */
var setDiscussionPermissions = function(ctx, discussionId, changes, callback) {
  var validator = new Validator();
  validator
    .check(null, {
      code: 401,
 ...
 * @param  {Object}     callback.err    An error that occurred, if any
 */
var removeDiscussionFromLibrary = function(ctx, libraryOwnerId, discussionId, callback) {
  var validator = new Validator();
  validator
    .check(null, {
      code: 401,
 ...
 */
var createMessage = function(ctx, discussionId, body, replyToCreatedTimestamp, callback) {
  var validator = new Validator();
  validator
 ...
 */
var deleteMessage = function(ctx, discussionId, messageCreatedDate, callback) {
  var validator = new Validator();
  validator
  ...
  _getDiscussion(discussionId, function(err, discussion) {
    ...
    MessageBoxAPI.getMessages(discussionId, [messageCreatedDate], { scrubDeleted: false }, function(
      err,
      messages
    ) {
      if (err) {
 ...
 * @param  {String}         callback.nextToken      The value to provide in the `start` parameter to get the next set of results
 */
var getMessages = function(ctx, discussionId, start, limit, callback) {
  limit = OaeUtil.getNumberParam(limit, 10, 1);
  ...
  getDiscussion(ctx, discussionId, function(err, discussion) {
    ...
    MessageBoxAPI.getMessagesFromMessageBox(discussionId, start, limit, null, function(
      err,
      messages,
      nextToken
    ) {
