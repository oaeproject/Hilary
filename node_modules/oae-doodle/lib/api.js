            ...
            async.forEachOf(additionalMembers, function (value, userId, done) {
                ...
                async.series({
                    ...
                    addUserToLoodle: function (finish) {
                        LoodleDAO.addUserToLoodle(token, loodleId, userId, finish);
                    }
                }, done);
    ...
    async.waterfall([
        ...
        function (currentUserToken, done) {
            ...
            async.forEachOf(changes, function (role, userId, end) {
                updateMember(ctx, loodleId, userId, currentUserToken, end);
            }, done);
 ...
 * @param callback
 */
var updateMember = function (ctx, contentId, userId, currentUserToken, callback) {
    ...
    async.series({
        ...
        // associateUserToLoodleIfNeeded: async.apply(LoodleDAO.addUserIfNeeded, loodleId, userId, currentUserToken)
        associateUserToLoodleIfNeeded: function (done) {
            LoodleDAO.addUserIfNeeded(loodleId, userId, currentUserToken, done);
        }
