 ...
 */
var createUser = module.exports.createUser = function(ctx, username, password, visibility, locale, timezone, firstName, lastName, displayName, callback) {
 ...
 */
var getTenantUser = module.exports.getTenantUser = function(ctx, username, callback) {
 ...
 */
var checkPassword = module.exports.checkPassword = function(tenant, username, password, callback) {
 ...
 * @param  {Object}     callback.err        Error object.
 * @param  {Boolean}    callback.success    Whether or not changing the password was successful
 */
