 ...
 * @return {String}                     `val` if it is valid. `defaultVal` otherwise
 */
const getSortDirParam = module.exports.getSortDirParam = function(val, defaultVal, sortBy) {
...
const createQuery = module.exports.createQuery = function(query, filter, opts) {
    ...
    const sortBy = {[opts.sortBy]: getSortDirParam(opts.sort, SearchConstants.sort.direction.ASC, opts.sortBy)};
