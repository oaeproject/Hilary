 ...
 * @param  {String[]}       filters.revision.createdBy          Filter the revisions based on who created them. This should be a user ID
...
var FilterGenerator = module.exports.FilterGenerator = function(filters) {
    ...
    if (!filters || !_.isObject(filters) || _.keys(filters).length === 0 || (!filters.content && !filters.revision)) {
