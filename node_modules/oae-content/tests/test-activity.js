...
describe('Content Activity', function() {
  ...
  var _setup = function(callback) {
    // Generate some users
    TestsUtil.generateTestUsers(camAdminRestContext, 7, function(
      err,
      users,
      simong,
      nico,
      ...
      TestsUtil.generateTestGroups(simong.restContext, 2, function(groupA, groupB) {
        ...
        RestAPI.Group.setGroupMembers(simong.restContext, groupA.group.id, groupAmembers, function(
          err
        ) {
          assert.ok(!err);
          var groupBmembers = {};
  ...
  describe('Routes', function() {
      ...
      TestsUtil.generateTestUsers(camAdminRestContext, 1, function(err, users, jack) {
        ...
        RestAPI.Content.createLink(
          ...
          function(err, link) {
            ...
            RestAPI.Content.shareContent(camAdminRestContext, link.id, [jack.user.id], function(
              err
            ) {
              assert.ok(!err);
                  ...
                  ContentTestUtil.publishCollabDoc(contentObj.id, branden.user.id, function() {
                    ...
                    EmailTestsUtil.collectAndFetchAllEmails(function(emails) {
                      ...
                      ActivityTestsUtil.collectAndGetNotificationStream(
                        ...
                        function(err, data) {
                          assert.ok(!err);
                          var notificationSimon = _getActivity(
                            data,
                            'content-revision',
                            'object',
                            contentObj.id
                          ...
                          ActivityTestsUtil.collectAndGetNotificationStream(
                            ...
                            function(err, data) {
                              assert.ok(!err);
                              var notificationNico = _getActivity(
                                data,
                                'content-revision',
                                'object',
                                contentObj.id
                              ...
                              ActivityTestsUtil.collectAndGetNotificationStream(
                                ...
                                function(err, data) {
                                  assert.ok(!err);
                                  var notificatioBranden = _getActivity(
                                    data,
                                    'content-revision',
                                    'object',
                                    contentObj.id
    ...
    it('verify an activity is generated regardless of whether there was an update to a is collaborative document since the last revision', function(callback) {
      ContentTestUtil.createCollabDoc(camAdminRestContext, 2, 2, function(
        contentObj,
        users,
        simon,
        nico
              ...
              function(err) {
                ...
                RestAPI.Content.restoreRevision(
                  ...
                  function(err, revisionObj) {
                    ...
                    ActivityTestsUtil.collectAndGetActivityStream(brandenCtx, null, null, function(
                      err,
                      data
                    ) {
                      assert.ok(!err);
                      var activity = _getActivity(
                        data,
                      ...
                      ActivityTestsUtil.collectAndGetActivityStream(simonCtx, null, null, function(
                        err,
                        data
                      ) {
                        assert.ok(!err);
                        ...
                        ActivityTestsUtil.collectAndGetActivityStream(nicoCtx, null, null, function(
                          err,
                          data
                        ) {
                          assert.ok(!err);
                  ...
                  function(err) {
                    ...
                    ActivityTestsUtil.collectAndGetActivityStream(
                      ...
                      function(err) {
                        ...
                        ActivityDAO.getActivities(contentObj.id + '#activity', null, 25, function(
                          err,
                          activities
                        ) {
                          assert.ok(!err);
      ...
      TestsUtil.generateTestUsers(camAdminRestContext, 4, function(
        ...
        RestAPI.Content.createLink(
          ...
          function(err, link) {
            ...
            RestAPI.Content.createComment(bert.restContext, link.id, 'Comment A', null, function(
              err,
              commentA
            ) {
              assert.ok(!err);
              ...
              ActivityTestsUtil.collectAndGetNotificationStream(simon.restContext, null, function(
                err,
                activityStream
              ) {
                assert.ok(!err);
                assert.ok(
                  _.find(activityStream.items, function(activity) {
                    return activity['oae:activityType'] === 'content-comment';
                  })
                );

                ActivityTestsUtil.collectAndGetNotificationStream(nico.restContext, null, function(
                  err,
                  activityStream
                ) {
                  assert.ok(!err);
                  ...
                  RestAPI.Content.createComment(
                    ...
                    function(err, commentA) {
                      ...
                      ActivityTestsUtil.collectAndGetNotificationStream(
                        ...
                        function(err, activityStream) {
                          assert.ok(!err);
                          var commentActivities = _.filter(activityStream.items, function(
                            activity
                          ) {
                            return activity['oae:activityType'] === 'content-comment';
                          });
            ...
            ActivityTestsUtil.collectAndGetActivityStream(
              ...
              function(err, activityStream) {
                ...
                RestAPI.Admin.loginOnTenant(
                  ...
                  null,
                  function(err, globalTenantAdminRestContext) {
                    assert.ok(!err);
                                          ...
                                          function(err) {
                                            ...
                                            ActivityTestsUtil.collectAndGetActivityStream(
                                              ...
                                              function(err, activityStream) {
                                                ...
                                                var signedDownloadUrl = url.parse(
      ...
      TestsUtil.generateTestUsers(camAdminRestContext, 1, function(err, users, jack) {
        ...
        RestAPI.Content.createLink(
          ...
          function(err, link) {
            ...
            RestAPI.Content.createComment(jack.restContext, link.id, 'Comment A', null, function(
              err,
              commentA
            ) {
              assert.ok(!err);

              RestAPI.Content.createComment(jack.restContext, link.id, 'Comment B', null, function(
                err,
                commentB
              ) {
                assert.ok(!err);
            ...
            RestAPI.Content.updateContent(
              ...
              function(err) {
                ...
                ActivityTestsUtil.collectAndGetActivityStream(
                  ...
                  function(err, activityStream) {
                    assert.ok(!err);
                    var createActivity = _getActivity(
                      activityStream,
                      'content-create',
                      'object',
                      link.id
                    );
                    var updateActivity = _getActivity(
                      activityStream,
                      'content-update',
                      'object',
                      link.id
          ...
          function(err, link) {
            ...
            RestAPI.Content.shareContent(camAdminRestContext, link.id, [jack.user.id], function(
              ...
              ActivityTestsUtil.collectAndGetActivityStream(
                ...
                function(err, activityStream) {
                  assert.ok(!err);
                  var shareActivity = _getActivity(
                    activityStream,
                    'content-share',
                    'object',
                    link.id
            ...
            RestAPI.Content.updateFileBody(
              ...
              function(err) {
                ...
                ActivityTestsUtil.collectAndGetActivityStream(
                  ...
                  function(err, activityStream) {
                    assert.ok(!err);
                    var revisionActivity = _getActivity(
                      activityStream,
                      'content-revision',
                      'object',
                      content.id
            ...
            RestAPI.Content.updateContent(
              ...
              function(err) {
                ...
                ActivityTestsUtil.collectAndGetActivityStream(
                  ...
                  function(err, activityStream) {
                    assert.ok(!err);
                    var updateVisibilityActivity = _getActivity(
                      activityStream,
      ...
      TestsUtil.generateTestUsers(camAdminRestContext, 1, function(err, users, jack) {
        ...
        RestAPI.Content.createLink(
          ...
          function(err, googleLink) {
            ...
            ActivityTestsUtil.collectAndGetActivityStream(jack.restContext, null, null, function(
              err,
              activityStream
            ) {
              assert.ok(!err);
