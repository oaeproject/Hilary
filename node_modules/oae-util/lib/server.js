...
module.exports.setupServer = function(port, _config) {
    ...
    _applyAvailabilityHandling(server, app, port);
 ...
 */
module.exports.setupRouter = function(app) {
    var that = {};
    that.routes = [];
    ...
    that.on = function(method, route, handler, telemetryUrl) {
        if (_.isString(method) && (_.isString(route) || _.isRegExp(route)) && (_.isFunction(handler) || _.isArray(handler))) {
            that.routes.push({
                'method': method,
                'route': route,
                'handler': handler,
            ...
            throw new Error('Method and route should be Strings, and handler should be a function');
        }
    };
