...
var IO = require('./io');
var log = require('oae-logger').logger('modules');
...
var bootstrapModules = module.exports.bootstrapModules = function(config, callback) {
    initAvailableModules(function(modules) {
        if (modules.length) {
...
var bootstrapModulesInit = function(modules, config, callback) {
    ...
    var initModule = function() {
        if (currentModule === modules.length) {
            ...
            var path = 'node_modules/' + modules[currentModule] + '/lib/init.js';
            currentModule++;
            var exists = fs.existsSync(path);
            if (exists) {
                require(modules[m] + '/lib/init')(config, function(err) {
                    if (err) {
                        return callback(err);
                    }
                    initModule();
