 ...
 * @param  {Function(err, created)} callback Callback method that provides an error object (if any)
 *                                           and a boolean that states whether keyspaces and CFs were created.
 */
                    ...
                    var installModule = function(module) {
                        ...
                        IO.pathExists(path, function(exists) {
                            if (exists) {
                                ...
                                require(module + "/install/install");
                            }
