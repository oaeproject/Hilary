...
var createDiscussion = module.exports.createDiscussion = function(createdBy, displayName, description, visibility, opts, callback) {
    ...
    var query = Cassandra.constructUpsertCQL('Discussions', 'id', discussionId, storageHash);
...
var updateDiscussion = module.exports.updateDiscussion = function(discussion, profileFields, callback) {
    ...
    var query = Cassandra.constructUpsertCQL('Discussions', 'id', discussion.id, storageHash);
    Cassandra.runQuery(query.query, query.parameters, function(err) {
        if (err) {
            return callback(err);
        }
...
var getDiscussionsById = module.exports.getDiscussionsById = function(discussionIds, fields, callback) {
    ...
    if (fields) {
        ...
        query = util.format('SELECT %s FROM "Discussions"', columns.join(','));
    } else {
        query = 'SELECT * FROM "Discussions"';
    }

    Cassandra.runInQuery(query, parameters, 'id', discussionIds, function(err, rows) {
        if (err) {
            return callback(err);
        }
...
var iterateAll = module.exports.iterateAll = function(properties, batchSize, onEach, callback) {
    ...
    Cassandra.iterateAll(properties, 'Discussions', 'id', {'batchSize': batchSize}, _iterateAllOnEach, callback);
};
