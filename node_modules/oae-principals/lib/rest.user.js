...
OAE.globalAdminRouter.on('get', '/api/tenant/:tenantAlias/users', _getUsersForTenant);
OAE.tenantRouter.on('get', '/api/tenant/:tenantAlias/users', _getUsersForTenant);
