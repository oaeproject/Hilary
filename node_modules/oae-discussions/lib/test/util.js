 ...
 */
const setupMultiTenantPrivacyEntities = module.exports.setupMultiTenantPrivacyEntities = function(callback) {
...
var _createDiscussionWithVisibility = function(restCtx, visibility, callback) {
    ...
    RestAPI.Discussions.createDiscussion(restCtx, 'displayName-' + randomId, 'description-' + randomId, visibility, null, null, (err, discussion) => {
        assert.ok(!err);
 ...
 */
const assertCreateDiscussionSucceeds = module.exports.assertCreateDiscussionSucceeds = function(restContext, displayName, description, visibility, managers, members, callback) {
    PrincipalsTestUtil.assertGetMeSucceeds(restContext, (me) => {
        RestAPI.Discussions.createDiscussion(restContext, displayName, description, visibility, managers, members, (err, discussion) => {
 ...
 * @throws {AssertionError}                         Thrown if any assertions fail
 */
const assertCreateDiscussionFails = module.exports.assertCreateDiscussionFails = function(restContext, displayName, description, visibility, managers, members, httpCode, callback) {
    RestAPI.Discussions.createDiscussion(restContext, displayName, description, visibility, managers, members, (err, discussion) => {
        assert.ok(err);
 ...
 * @throws {AssertionError}                 Thrown if any assertions fail
 */
const assertGetDiscussionFails = module.exports.assertGetDiscussionFails = function(restContext, discussionId, httpCode, callback) {
 ...
 * @throws {AssertionError}                         Thrown if any assertions fail
 */
const assertDeleteDiscussionSucceeds = module.exports.assertDeleteDiscussionSucceeds = function(restContext, discussionId, callback) {
 ...
 */
const assertUpdateDiscussionSucceeds = module.exports.assertUpdateDiscussionSucceeds = function(restContext, discussionId, updates, callback) {
 ...
 */
const assertShareDiscussionSucceeds = module.exports.assertShareDiscussionSucceeds = function(managerRestContext, actorRestContext, discussionId, targetIds, callback) {
 ...
 */
const assertShareDiscussionFails = module.exports.assertShareDiscussionFails = function(managerRestContext, actorRestContext, discussionId, targetIds, httpCode, callback) {
    // Get the discussion members before sharing
    getAllDiscussionMembers(managerRestContext, discussionId, null, (result) => {
        const memberRolesBefore = AuthzTestUtil.getMemberRolesFromResults(result);
 ...
 * @throws {AssertionError}                 Thrown if the request fails
 */
const assertUpdateDiscussionMembersSucceeds = module.exports.assertUpdateDiscussionMembersSucceeds = function(managerRestContext, actorRestContext, discussionId, updates, callback) {
    // Get the discussion members before sharing
    getAllDiscussionMembers(managerRestContext, discussionId, null, (result) => {
        const memberRolesBefore = AuthzTestUtil.getMemberRolesFromResults(result);
 ...
 * @throws {AssertionError}                     Thrown if there is an error ensuring that the request fails in the specified manner
 */
const assertUpdateDiscussionMembersFails = module.exports.assertUpdateDiscussionMembersFails = function(managerRestContext, actorRestContext, discussionId, updates, httpCode, callback) {
    // Get the discussion members before sharing
    getAllDiscussionMembers(managerRestContext, discussionId, null, (result) => {
        const memberRolesBefore = AuthzTestUtil.getMemberRolesFromResults(result);
...
var assertGetAllDiscussionsLibrarySucceeds = module.exports.assertGetAllDiscussionsLibrarySucceeds = function(restContext, principalId, opts, callback, _discussions, _responses, _nextToken) {
    ...
    opts = opts || {};
    opts.batchSize = opts.batchSize || 25;
    assertGetDiscussionsLibrarySucceeds(restContext, principalId, {'start': _nextToken, 'limit': opts.batchSize}, (result) => {
        _responses.push(result);
