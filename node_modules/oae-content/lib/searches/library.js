 ...
 * @param   {String[]}      opts.params         An array of required parameters for the search
 * @param   {String}        opts.params[0]      The principal whose library to search
...
module.exports = function(ctx, opts, callback) {
    ...
    opts = opts || {};
    opts.principalId = opts.params[0];
