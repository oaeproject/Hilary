...
var PreviewContext = module.exports.PreviewContext = function(config, contentId) {
     ...
     * @param {String} size The size of this file. One of 'small', 'normal', 'large' or 'thumbnail'.
     */
    ...
    that.savePreviews = function(callback) {
        ...
        RestAPI.Content.addPreviewItems(that.tenantRestContext, contentId, 'done', files, {}, callback);
    };
