 ...
 * @param  {Object}      callback.err        An error that occurred, if any
 */
var saveDateLastLogIn = module.exports.saveDateLastLogIn = function(user, date, callback) {
    callback = callback || function() {};
    Cassandra.runQuery('UPDATE "Principals" SET "lastLog" = ? WHERE "principalId" = ?', [date, user.id], function(err) {
        if (err) {
            return callback(err);
        }
        return callback(null);
