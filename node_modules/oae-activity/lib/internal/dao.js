 ...
 * @param  {Object}    callback.err                         An error that occurred, if any
 */
var indexAggregateData = module.exports.indexAggregateData = function(statusUpdatesByActivityStreamIds, callback) {
    var activityStreamIds = _.keys(statusUpdatesByActivityStreamIds);
    ...
    _.each(statusUpdatesByActivityStreamIds, function(statusUpdatesByActivityStreamId, activityStreamId) {
