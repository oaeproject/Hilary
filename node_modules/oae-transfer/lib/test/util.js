 ...
 */
var assertInitiateTransferSucceeds = module.exports.assertInitiateTransferSucceeds = function(restContext, originalEmail, targetEmail, originalUserId, callback) {
    RestAPI.Transfer.initiateTransfer(restContext, originalUserId, originalEmail, targetEmail, function(err, createdTransfer) {
...
/**
 * Cancel a transfer, ensuring that it fails in a specified way
 *
 ...
 * @throws {AssertionError}                         Thrown if the request did not fail in the expected manner
 */
var assertCancelTransferFails = module.exports.assertCancelTransferFails = function(restContext, originalEmail, code, originalUserId, httpCode, callback) {
    RestAPI.Transfer.cancelTransfer(restContext, originalEmail, code, originalUserId, function(err) {
        assert.ok(err);
        assert.strictEqual(err.code, httpCode);
        return callback();
    });
...
/**
 * Cancel a transfer, ensuring that the request is successful
 *
 * @param  {RestContext}        restContext         The REST context to use when deleting the transfer
 * @param  {String}             originalEmail       The originalEmail of the transfer to delete
 * @param  {String}             code                The transfer code of the transfer to delete
 ...
 * @throws {AssertionError}                         Thrown if the request did not fail in the expected manner
 */
var assertCancelTransferSucceeds = module.exports.assertCancelTransferSucceeds = function(restContext, originalEmail, code, originalUserId, callback) {
    RestAPI.Transfer.cancelTransfer(restContext, originalEmail, code, originalUserId, function(err) {
        assert.ok(!err);
        return callback();
    });
...
/**
 * Complete transfer, ensuring that the request is successful
 *
 * @param  {RestContext}        restContext         The REST context to use when deleting the transfer
 ...
 */
var assertCompleteTransferSucceeds = module.exports.assertCompleteTransferSucceeds = function(restContext, originalEmail, code, targetEmail, targetUserId, callback) {
    RestAPI.Transfer.completeTransfer(restContext, originalEmail, code, targetEmail, targetUserId, function(err, managers) {
        assert.ok(!err);
...
/**
 * Complete transfer, ensuring that it fails in a specified way
 *
 * @param  {RestContext}        restContext         The REST context to use when deleting the transfer
 * @param  {String}             originalEmail       The originalEmail of the transfer 
 * @param  {String}             code                The code write by the user
 ...
 * @throws {AssertionError}                         Thrown if the request failed
 */
var assertCompleteTransferFails = module.exports.assertCompleteTransferFails = function(restContext, originalEmail, code, targetEmail, targetUserId, httpCode, callback) {
    RestAPI.Transfer.completeTransfer(restContext, originalEmail, code, targetEmail, targetUserId, function(err) {
        assert.ok(err);
        assert.strictEqual(err.code, httpCode);
        return callback();
    });
