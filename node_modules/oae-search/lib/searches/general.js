...
var _search = function(ctx, opts, callback) {
    ...
    var query = SearchUtil.createGeneralQuerySupportingMessages(opts.q);
            ...
            SearchUtil.filterOr(
                ...
                SearchUtil.filterAnd(
                    ...
                    SearchUtil.filterOr(
                        ...
                        // I can see all public resources within my tenant
                        // and if I specified to view external resources, I can see the public resources of
                        // the tenants I can interact with.
                        SearchUtil.filterAnd(
