 ...
 * @param  {Boolean}    [options.passReqToCallback]     Whether or not the `verify` function will have a request as its first parameter
 * @param  {Function}   verify                          A standard passport verify function that gets called so you can get or create the OAE user account
 * @param  {Request}    [verify.req]                    This will be the request if `options.passReqToCallback` is specified. Otherwise, this parameter is removed and `verify.profile` is the first parameter instead
