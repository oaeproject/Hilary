 ...
 */
var getStandardResourcePropagation = (module.exports.getStandardResourcePropagation = function(
  resourceVisibility,
  resourceJoinable,
  callback,
) {
 ...
 */
var getAllAuthzMembersByRole = (module.exports.getAllAuthzMembersByRole = function(
  resourceId,
  callback,
) {
  AuthzAPI.getAuthzMembers(resourceId, null, 10000, function(err, members) {
    ...
    _getAllAuthzGroupMembersByRole(groupMembersByRole, function(
      err,
      indirectMembersByRole,
    ) {
      if (err) {
        return callback(err);
      }
 ...
 */
var createActivityStreamId = (module.exports.createActivityStreamId = function(
  resourceId,
  activityStreamType,
) {
 ...
 */
var parseActivityStreamId = (module.exports.parseActivityStreamId = function(
  activityStreamId,
) {
