...
OAE.tenantServer.get('/api/content/:contentId/messages', function(req, res) {
    ContentAPI.getComments(req.ctx, req.params.contentId, req.query.start, req.query.limit, function(err, messages) {
        if (err) {
            return res.send(err.code, err.msg);
        }
...
OAE.tenantServer.get('/api/content/library/:principalId', function(req, res) {
    ...
    ContentAPI.getLibraryItems(req.ctx, req.params.principalId, req.query.start, req.query.limit, function(err, items, nextToken) {
        if (err) {
            return res.send(err.code, err.msg);
        }
