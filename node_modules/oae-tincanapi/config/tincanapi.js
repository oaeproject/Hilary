...
module.exports = {
    ...
    'lrs': {
        ...
        'elements': {
            'enabled': new Fields.Bool('LRS enabled', 'Learning Record Store enabled for tenant', false, {'suppress': true}),
            ...
            'endpoint': new Fields.Text('LRS URL', 'The TinCan API REST endpoint URL', 'https://cloud.scorm.com/tc/3HQ4Q12B57/statements', {'suppress': true})
        }
    }
};
