                        ...
                        ActivityTestsUtil.collectAndGetNotificationStream(
                          ...
                          function(err, notificationStream) {
                            ...
                            RestAPI.User.getMe(simong.restContext, function(err, me) {
                              ...
                              RestAPI.Activity.markNotificationsRead(simong.restContext, function(
                                err
                              ) {
                  ...
                  RestAPI.Content.createLink(
                    ...
                    (err, link) => {
                      ...
                      EmailTestsUtil.collectAndFetchAllEmails(messages => {
                        ...
                        let objectResource = new ActivityModel.ActivitySeedResource(
                          'content',
                          link.id
                        );
                        let seed = new ActivityModel.ActivitySeed(
