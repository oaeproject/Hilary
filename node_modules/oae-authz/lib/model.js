 ...
 */
var IdChangeInfo = module.exports.IdChangeInfo = function(changes, roles, ids) {
    return {
        'changes': changes,
        'roles': roles,
        'ids': ids
 ...
 */
var MemberChangeInfo = module.exports.MemberChangeInfo = function(changes, roles, members) {
    return {
        'changes': changes,
        'roles': roles,
        'members': members
 ...
 */
var EmailChangeInfo = module.exports.EmailChangeInfo = function(changes, roles, emails) {
    return {
        'changes': changes,
        'roles': roles,
        'emails': emails
