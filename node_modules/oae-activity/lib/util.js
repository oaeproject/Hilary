...
/**
 * Get all the direct and indirect members of the given resource, keyed by their role.
 *
 ...
 *
 * @param   {Object}    groupRoles              An object keyed by a role whose values are a list of principal ids that have that role directly on the resource
 * @param   {Function}  callback                Invoked when the process completes
 * @param   {Object}    callback.err            An error that occurred, if any
