<%
    ...
    var renderHeader = function() {
        ...
        var greeting = util.i18n.translate('__MSG__EMAIL_GREETING__', {'displayName': util.html.encodeForHTML(user.displayName)});
...
<%
    ...
    var renderFooter = function() {
        ...
        str +=   '<td align="center">';
        str +=       util.i18n.translate('__MSG__EMAIL_CHANGE_PREFRENCES__', {'url': url}) + '<br />';
