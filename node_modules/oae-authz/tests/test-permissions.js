...
describe('Authz-Permissions', function() {
    ...
    describe('#hasRole()', function() {
        ...
        it('verify empty data', function(callback) {
            var userId = AuthzUtil.toUuid('u', 'ia-empty', 'mrvisser');
            var resourceId = AuthzUtil.toUuid('c', 'ia-empty', 'SomeContent');
        ...
        it('verify direct permission', function(callback) {
            var userId = AuthzUtil.toUuid('u', 'ia-direct', 'mrvisser');
            var resourceId = AuthzUtil.toUuid('c', 'ia-direct', 'SomeContent');
        ...
        it('verify direct single group permission', function(callback) {
            var groupId = AuthzUtil.toUuid('g', 'ia-single', 'oae-team');
            var userId = AuthzUtil.toUuid('u', 'ia-single', 'mrvisser');
            var resourceId = AuthzUtil.toUuid('c', 'ia-single', 'SomeContent');
        ...
        it('verify direct multi group permission', function(callback) {
            var groupId1 = AuthzUtil.toUuid('g', 'ia-multi', 'oae-team');
            var groupId2 = AuthzUtil.toUuid('g', 'ia-multi', 'oae-backend-team');
            var userId = AuthzUtil.toUuid('u', 'ia-multi', 'mrvisser');
            var resourceId = AuthzUtil.toUuid('c', 'ia-multi', 'SomeContent');
        ...
        it('verify multi group hierarchy permission', function(callback) {
            var groupId1 = AuthzUtil.toUuid('g', 'ia-hier', 'oae-team');
            var groupId2 = AuthzUtil.toUuid('g', 'ia-hier', 'oae-backend-team');
            var userId = AuthzUtil.toUuid('u', 'ia-hier', 'mrvisser');
            var resourceId = AuthzUtil.toUuid('c', 'ia-hier', 'SomeContent');
        ...
        it('verify circular group hierarchy permission', function(callback) {
            var groupId1 = AuthzUtil.toUuid('g', 'ia-circ', 'oae-team');
            var groupId2 = AuthzUtil.toUuid('g', 'ia-circ', 'oae-backend-team');
            var groupId3 = AuthzUtil.toUuid('g', 'ia-circ', 'oae-ui-team');
            var userId = AuthzUtil.toUuid('u', 'ia-circ', 'mrvisser');
            var resourceId = AuthzUtil.toUuid('c', 'ia-circ', 'SomeContent');
    ...
    describe('#hasAnyRole()', function() {
        ...
        it('verify empty data', function(callback) {
            var userId = AuthzUtil.toUuid('u', 'iaa-empty', 'mrvisser');
            var resourceId = AuthzUtil.toUuid('c', 'iaa-empty', 'SomeContent');
        ...
        it('verify direct permission', function(callback) {
            var userId = AuthzUtil.toUuid('u', 'iaa-direct', 'mrvisser');
            var resourceId = AuthzUtil.toUuid('c', 'iaa-direct', 'SomeContent');
            AuthzAPI.updateRoles(resourceId, makeChange(userId, 'viewer'), function(err) {
                assert.ok(!err);
                AuthzAPI.hasAnyRole(userId, resourceId, function(err, hasAnyRole) {
                    assert.ok(!err);
        ...
        it('verify direct single group permission', function(callback) {
            var groupId = AuthzUtil.toUuid('g', 'iaa-single', 'oae-team');
            var userId = AuthzUtil.toUuid('u', 'iaa-single', 'mrvisser');
            var resourceId = AuthzUtil.toUuid('c', 'ia-single', 'SomeContent');
