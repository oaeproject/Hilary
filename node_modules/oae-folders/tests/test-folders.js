...
describe('Folders', function() {
  ...
  before(function(callback) {
    ...
    camAnonymousRestContext = TestsUtil.createTenantRestContext(
      global.oaeTests.tenants.cam.host,
    );
    gtAdminRestContext = TestsUtil.createTenantAdminRestContext(
      global.oaeTests.tenants.gt.host,
    );
    gtAnonymousRestContext = TestsUtil.createTenantRestContext(
      global.oaeTests.tenants.gt.host,
    );
    callback();
  });
  ...
  var _memberUpdate = function(principalInfo, roleChange) {
    ...
    if (_.isObject(principalInfo)) {
      ...
      memberUpdate[profile.id] = _.extend({}, principalInfo, {
        role: roleChange,
      });
    } else {
  ...
  describe('Create Folder', function() {
          ...
          function(createdFolder) {
            ...
            FoldersTestUtil.assertGetFolderSucceeds(
              ...
              function(fetchedFolder) {
                ...
                assert.equal(
                  fetchedFolder.displayName,
                  createdFolder.displayName,
                );
                assert.equal(
                  fetchedFolder.description,
                  createdFolder.description,
                );
                assert.equal(
                  fetchedFolder.visibility,
                  createdFolder.visibility,
                );
                ...
                assert.equal(
                  fetchedFolder.profilePath,
                  createdFolder.profilePath,
                );
                assert.equal(
                  fetchedFolder.resourceType,
                  createdFolder.resourceType,
                );
                ...
                assert.equal(
                  ...
                  mrvisser.user.locale,
                );
                assert.equal(
                  fetchedFolder.createdBy.timezone,
                  mrvisser.user.timezone,
                );
                assert.equal(
    ...
    it('verify folder creation authorization', function(callback) {
      FoldersTestUtil.setupMultiTenantPrivacyEntities(function(
        publicTenant,
        publicTenant1,
        privateTenant,
        privateTenant1,
                                        ...
                                        FoldersTestUtil.assertCreateFolderFails(
                                          ...
                                          function() {
                                            FoldersTestUtil.assertCreateFolderFails(
                                              ...
                                              'private',
                                              [
                                                privateTenant.privateUser.user
                                                  .id,
                                              ],
                                              null,
                                              401,
     ...
     */
    var createAndVerifyManager = function(
      user,
      managers,
      viewers,
      expectedManager,
            ...
            function(members) {
              if (expectedManager) {
                var member = _.find(members, function(member) {
                  return (
                    member.profile.id === user.user.id &&
                    member.role === 'manager'
                  );
                });
                assert.ok(member);
    ...
    it('verify the creator is only made a manager when he cannot manage indirectly', function(callback) {
      TestsUtil.generateTestUsers(camAdminRestContext, 3, function(
        ...
        assert.ok(!err);
        TestsUtil.generateTestGroups(simong.restContext, 1, function(
          simongGroup,
        ) {
          TestsUtil.generateTestGroups(nico.restContext, 6, function(
            nicoGroup1,
            nicoGroup2,
            nicoGroup3,
            nicoGroup4,
            ...
            TestsUtil.generateGroupHierarchy(
              ...
              function() {
                TestsUtil.generateGroupHierarchy(
                  ...
                  'manager',
                  function() {
                    var roleChange = AuthzTestUtil.createRoleChange(
                      [stuart.user.id],
                      'member',
                    );
                          ...
                          function(err, folder) {
                            ...
                            RestAPI.Folders.updateFolderContentVisibility(
                              ...
                              function(err, data) {
                                ...
                                assert.strictEqual(
                                  data.failedContent.length,
                                  1,
                                );
                                assert.strictEqual(
                                  data.failedContent[0].id,
                                  nicosLink.id,
                                );
  ...
  describe('Get Folder', function() {
    ...
    it('verify get folder validation', function(callback) {
      TestsUtil.generateTestUsers(camAdminRestContext, 1, function(
        ...
        assert.ok(!err);
        FoldersTestUtil.generateTestFolders(mrvisser.restContext, 1, function(
          folder,
        ) {
                        ...
                        FoldersTestUtil.assertShareFolderSucceeds(
                          ...
                          function() {
                            FoldersTestUtil.assertGetFolderSucceeds(
                              ...
                              function(fetchedFolder) {
                                assert.strictEqual(
                                  fetchedFolder.canManage,
                                  false,
                                );
                                assert.strictEqual(
                                  fetchedFolder.canShare,
                                  false,
                                );
                                assert.strictEqual(
                                  fetchedFolder.canAddItem,
                                  false,
                                );
  ...
  describe('Delete Folder', function() {
    ...
    it('verify delete folder validation', function(callback) {
      TestsUtil.generateTestUsers(camAdminRestContext, 1, function(
        ...
        assert.ok(!err);
        FoldersTestUtil.generateTestFolders(simong.restContext, 1, function(
          folder,
        ) {
  ...
  describe('Share Folder', function() {
    ...
    it('verify sharing validation', function(callback) {
      ...
      TestsUtil.generateTestUsers(camAdminRestContext, 1, function(
        ...
        assert.ok(!err);
        FoldersTestUtil.generateTestFolders(camAdminRestContext, 1, function(
          folder,
        ) {
                                        ...
                                        FoldersTestUtil.assertShareFolderFails(
                                          ...
                                          function() {
                                            FoldersTestUtil.assertShareFolderFails(
                                              ...
                                              publicTenant.privateFolder.id,
                                              [
                                                privateTenant.loggedinUser.user
                                                  .id,
                                              ],
                                              401,
                                              function() {
  ...
  describe('Get Folder Members', function() {
    ...
    it('verify get folder members gets all viewers and managers', function(callback) {
      TestsUtil.generateTestUsers(camAdminRestContext, 16, function(
        err,
        users,
        mrvisser,
      ) {
        ...
        FoldersTestUtil.generateTestFolders(mrvisser.restContext, 1, function(
          ...
          _.each(managerUsers, function(managerUser) {
            ...
            memberUpdates[managerUser.user.id] = _.extend({}, managerUser, {
              role: 'manager',
            });
          });
          ...
          _.each(viewerUsers, function(viewerUser) {
            ...
            memberUpdates[viewerUser.user.id] = _.extend({}, viewerUser, {
              role: 'viewer',
            });
          });
        ...
        FoldersTestUtil.generateTestFolders(mrvisser.restContext, 1, function(
          ...
          FoldersTestUtil.assertUpdateFolderMembersFails(
            ...
            function() {
              ...
              _.each(users, function(user, userId) {
                memberUpdateInfos[userId] = _.extend({}, user, {
                  role: 'viewer',
                });
              });
    ...
    it('verify users get the appropriate folders library visibility', function(callback) {
      ...
      TestsUtil.setupMultiTenantPrivacyEntities(function(
        ...
        FoldersTestUtil.generateTestFoldersWithVisibility(
          ...
          3,
          'public',
          function(publicFolder1, publicFolder2, publicFolder3) {
            FoldersTestUtil.generateTestFoldersWithVisibility(
              publicTenant.publicUser.restContext,
              3,
              'loggedin',
              function(loggedinFolder1, loggedinFolder2, loggedinFolder3) {
                FoldersTestUtil.generateTestFoldersWithVisibility(
                  publicTenant.publicUser.restContext,
                  3,
                  'private',
                  function(privateFolder1, privateFolder2, privateFolder3) {
                    var publicFolderIds = _.pluck(
                      [publicFolder1, publicFolder2, publicFolder3],
                      'id',
                    );
                    var loggedinFolderIds = _.pluck(
                      [loggedinFolder1, loggedinFolder2, loggedinFolder3],
                      'id',
                    );
                    var privateFolderIds = _.pluck(
                      [privateFolder1, privateFolder2, privateFolder3],
                      'id',
                    );

                    var expectedPublicFoldersLibraryIds = publicFolderIds.slice();
                    var expectedLoggedinFoldersLibraryIds = _.union(
                      publicFolderIds,
                      loggedinFolderIds,
                    );
                    var expectedPrivateFoldersLibraryIds = _.chain(
                      publicFolderIds,
                    )
                      ...
                      function(folders, responses) {
                        ...
                        FoldersTestUtil.getAllFoldersInLibrary(
                          ...
                          function(folders, responses) {
                            ...
                            assert.strictEqual(
                              _.last(responses).results.length,
                              16,
                            );
                            assert.strictEqual(
                              _.last(responses).nextToken,
                              null,
                            );
                            return callback();
                          },
  ...
  describe('Get Managed Folders', function() {
    ...
    it('verify get managed folders', function(callback) {
      ...
      TestsUtil.generateTestUsers(camAdminRestContext, 2, function(
        ...
        FoldersTestUtil.generateTestFolders(simong.restContext, 1, function(
          ...
          FoldersTestUtil.generateTestFolders(nico.restContext, 1, function(
            nicosFolder,
          ) {
            ...
            FoldersTestUtil.assertUpdateFolderMembersSucceeds(
              ...
              function() {
                ...
                RestAPI.Folders.getManagedFolders(simong.restContext, function(
                  err,
                  folders,
                ) {
                  assert.ok(!err);
    ...
    it('verify get managed folders validation', function(callback) {
      ...
      RestAPI.Folders.getManagedFolders(camAnonymousRestContext, function(
        err,
        folders,
      ) {
        assert.ok(err);
  ...
  describe('Add Items to Folder', function() {
    ...
    it('verify only administrators and managers of folders can add content items to them', function(callback) {
      FoldersTestUtil.setupMultiTenantPrivacyEntities(function(
        ...
        RestAPI.User.getMe(publicTenant.adminRestContext, function(
          err,
          publicTenantAdminMe,
        ) {
          assert.ok(!err);
                    ...
                    function() {
                      ...
                      FoldersTestUtil.getAllFolderContentItems(
                        ...
                        function(contentItems) {
                          ...
                          var memberUpdates = _memberUpdate(
                            publicTenant.publicUser,
                            'manager',
                          );
                                                  ...
                                                  function() {
                                                    FoldersTestUtil.assertAddContentItemsToFolderFails(
                                                      ...
                                                      function() {
                                                        ...
                                                        var contentMemberUpdate = _memberUpdate(
                                                          publicTenant
                                                            .publicUser.user.id,
                                                        );
        ...
        FoldersTestUtil.generateTestFolders(camAdminRestContext, 1, function(
          ...
          RestAPI.Content.createLink(
            ...
            function(err, link) {
              ...
              TestsUtil.generateTestGroups(camAdminRestContext, 3, function(
                group1,
                group2,
                group3,
              ) {
                                  ...
                                  FoldersTestUtil.assertRemoveContentItemsFromFolderSucceeds(
                                    ...
                                    function() {
                                      ...
                                      FoldersTestUtil.getAllFolderContentItems(
                                        ...
                                        folder.id,
                                        null,
                                        function(contentItems, responses) {
                                          assert.strictEqual(
                                            contentItems.length,
                                            3,
                                          );
                                          assert.ok(
                                            _.findWhere(contentItems, {
                                              id: link3.id,
                                            }),
                                          );
                                          assert.ok(
  ...
  describe('Content Integration', function() {
    ...
    it('verify folder ids can be specified when creating content', function(callback) {
      ...
      TestsUtil.generateTestUsers(camAdminRestContext, 1, function(
        ...
        FoldersTestUtil.generateTestFolders(simong.restContext, 3, function(
          folder1,
          folder2,
          folder3,
        ) {
