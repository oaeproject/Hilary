...
var log = require('oae-logger').logger('oae-authentication-signed');
...
Strategy.prototype.authenticate = function(req) {
    ...
    PrincipalsAPI.getUser(context, userId, function(err, user) {
        ...
        log().info({login: user.id, headers: req.headers, tenantAdmin: user.isTenantAdmin(tenant), globalAdmin: user.isGlobalAdmin(), tenant: tenant});
        self.success(user);
    });
};
