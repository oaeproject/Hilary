...
var HTML_FILE = Path.normalize(__dirname + '/../../../static/collabdoc/collabdoc.html');
var CSS_FILE = Path.normalize(__dirname + '/../../../static/collabdoc/collabdoc.css');
...
var _getWrappedEtherpadHtml = function(ctx, etherpadHtml, callback) {
    ...
    if (wrapperHtml) {
        ...
        fs.readFile(HTML_FILE, function(err, content) {
            if (err) {
