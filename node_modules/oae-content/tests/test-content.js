...
describe('Content', function() {
    ...
    it('Test get content', function(callback) {
        setUpUsers(function(contexts) {
            ...
            ContentAPI.createContent(contexts[0], 'public', 'Test Content 1', 'Test content description 1', 'link', function(err, contentObj) {
                assert.ok(!err);
    ...
    it('Test create content', function(callback) {
        setUpUsers(function(contexts) {
            ...
            ContentAPI.createContent(new Context(tenant1), 'public', 'Test Content 1', 'Test content description 1', 'link', function(err, contentObj) {
                assert.ok(err);
                assert.ok(!contentObj);
     ...
     * for various people
     */
    it('Test create pricate content item', function(callback) {
        setUpUsers(function(contexts) {
    ...
    /**
     * Test that will exercise the updateContent profile function. A piece of content will be updated with invalid parameters,
     * then the name will be updated, the description will be updated, both name and description will be updated at the same
     * time, and we will attempt to update the profile as a non-manager. After all of these, we'll check if the correct metadata
     * is still on the content.
     */
        ...
        setUpUsers(function(contexts) {
            ...
            ContentAPI.createContent(contexts[0], contentObj.visibility, contentObj.name, contentObj.description, contentObj.contentType, function(err, content) {
                ...
                ContentAPI.shareContent(contexts[0], contentObj.contentId, [contexts[1].user().id], function(err) {
                    ...
                    ContentAPI.updateContentProfile(contexts[0], contentObj.contentId, {}, function(err) {
                        assert.ok(err);
                        // Invalid content metadata update (unexisting field)
                        ContentAPI.updateContentProfile(contexts[0], contentObj.contentId, {'name': 'New Test Content 1', 'nonExisting': 'Non-existing field'}, function(err) {
                            assert.ok(err);
                            ...
                            checkNameAndDescription(contexts, contentObj.contentId, 'Test Content 1', 'Test content description 1', function() {
                                // Change the name
                                ContentAPI.updateContentProfile(contexts[0], contentObj.contentId, {'name': 'New Test Content 1'}, function(err) {
                                    assert.ok(!err);
                                    ...
                                    checkNameAndDescription(contexts, contentObj.contentId, 'New Test Content 1', 'Test content description 1', function() {
                                        ...
                                        ContentAPI.updateContentProfile(contexts[0], contentObj.contentId, {'description': 'New test content description 1'}, function(err) {
                                            assert.ok(!err);
                                            ...
                                            checkNameAndDescription(contexts, contentObj.contentId, 'New Test Content 1', 'New test content description 1', function() {
                                                ...
                                                ContentAPI.updateContentProfile(contexts[0], contentObj.contentId, {'name': 'New Test Content 2', 'description': 'New test content description 2'}, function(err) {
                                                    assert.ok(!err);
                                                    ...
                                                    checkNameAndDescription(contexts, contentObj.contentId, 'New Test Content 2', 'New test content description 2', function() {
                                                        ...
                                                        ContentAPI.updateContentProfile(contexts[1], contentObj.contentId, {'name': 'New Test Content 3'}, function(err) {
                                                            assert.ok(err);
    ...
    /**
     * Test that will exercise the updateVisibility function for content. This test will create a public content item, try to give it
     * a non-existing visibility, then make it visible to logged in users, then make it private and then try to change the visibility
     * as a non-manager. After all of those, we check if the manager, viewer, logged in user and anonymous user have access as
     * expected.
     */
            ...
            ContentAPI.createContent(contexts[0], contentObj.visibility, contentObj.name, contentObj.description, contentObj.contentType, function(err, content) {
                ...
                ContentAPI.shareContent(contexts[0], contentObj.contentId, [contexts[1].user().id], function(err) {
                    ...
                    checkAccessAndLibrary(contexts, contentObj.contentId, true, true, function() {
                        ...
                        ContentAPI.updateVisibility(contexts[0], contentObj.contentId, null, function(err) {
                            assert.ok(err);
                            // Check that the access remains unchanged
                            checkAccessAndLibrary(contexts, contentObj.contentId, true, true, function() {
                                // Try an unknown visibility update
                                ContentAPI.updateVisibility(contexts[0], contentObj.contentId, 'unknown-option', function(err) {
                                    assert.ok(err);
                                    // Check that the access remains unchanged
                                    checkAccessAndLibrary(contexts, contentObj.contentId, true, true, function() {
                                        // Make the content logged in only
                                        ContentAPI.updateVisibility(contexts[0], contentObj.contentId, 'loggedin', function(err) {
                                            assert.ok(!err);
                                            ...
                                            checkAccessAndLibrary(contexts, contentObj.contentId, true, false, function() {
                                                ...
                                                ContentAPI.updateVisibility(contexts[0], contentObj.contentId, 'private', function(err) {
                                                    assert.ok(!err);
                                                    // Check that everyone can get the content as expected, check library presence as expected
                                                    checkAccessAndLibrary(contexts, contentObj.contentId, false, false, function() {
                                                        // Try update as non-manager
                                                        ContentAPI.updateVisibility(contexts[1], contentObj.contentId, 'public', function(err) {
                                                            assert.ok(err);
                                                            // Check that everyone can get the content as expected, check library presence as expected
                                                            checkAccessAndLibrary(contexts, contentObj.contentId, false, false, function() {
                                                                callback();
