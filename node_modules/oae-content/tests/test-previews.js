...
describe('File previews', function() {
    ...
    it('verify negative preview expires are not possible', function(callback) {
        createPreviews(function(contexts, contentObj, previews) {
            ...
            checkPreviewsConfigExpiration(contexts['nicolaas'].restContext, contentObj.contentId, 100, 5, function() {
                // negative settings --> should result in defaults
                checkPreviewsConfigExpiration(contexts['nicolaas'].restContext, contentObj.contentId, -10, 500, function() {
                    checkPreviewsConfigExpiration(contexts['nicolaas'].restContext, contentObj.contentId, 100, -500, callback);
                });
            });
        });
    });
