...
module.exports = function() {
  ...
  strategy.getPassportStrategy = function(tenant) {
    ...
    var adminDn = AuthenticationConfig.getValue(
      tenant.alias,
      'ldap',
      'adminDn',
    );
    var adminPassword = AuthenticationConfig.getValue(
      tenant.alias,
      'ldap',
      'adminPassword',
    );
    var searchBase = AuthenticationConfig.getValue(
      tenant.alias,
      'ldap',
      'searchBase',
    );
    var searchFilter = AuthenticationConfig.getValue(
      tenant.alias,
      'ldap',
      'searchFilter',
    );
    ...
    var mapExternalId = AuthenticationConfig.getValue(
      tenant.alias,
      'ldap',
      'mapExternalId',
    );
