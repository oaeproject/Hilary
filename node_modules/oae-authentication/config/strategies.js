...
module.exports = {
    ...
    'cas': {
        ...
        'elements': {
            ...
            'name': new Fields.Text('Name', 'A name that users will recognize as their identity provider', ''),
            'url': new Fields.Text('Host', 'The URL at which the CAS server can be reached. This should include http(s)://, any non-standard port and have no trailing slash', '', {'suppress': true}),
            'basepath': new Fields.Text('Base path', 'The base path on the CAS authentication server', '/cas', {'suppress': true}),
            ...
            'mapTimezone': new Fields.Text('Timezone', 'The attibute(s) that should be used to construct the timezone. e.g., <%= timezone %>', '', {'suppress': true})
        }
    },
    'ldap': {
