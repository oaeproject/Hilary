 ...
 *
 * @param   {String}    railsTimezone   The rails timezone to map
 * @return  {String}                    The TZInfo identifier that represents the associated rails timezone
 */
var getTimezoneFromRails = module.exports.getTimezoneFromRails = function(railsTimezone) {
    return RailsMappings[railsTimezone];
};
