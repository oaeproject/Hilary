 ...
 * @HttpResponse                401                     You must be a global administrator to create a global administraotr user
 * @HttpResponse                401                     You must be authenticated to the global admin tenant to create a global administrator user
 */
 ...
 * @HttpResponse                400                     A LoginId must be provided
 * @HttpResponse                400                     A tenant administrator cannot be created on the global admin tenant
 * @HttpResponse                400                     The specified email preference is invalid
 * @HttpResponse                400                     The specified visibility setting is unknown
 * @HttpResponse                400                     This login id already exists and is already associated to a user
 * @HttpResponse                400                     You must provide a display name
 ...
 * @HttpResponse                500                     Could not create a proper CQL query
 */
 ...
 * @HttpResponse        400         An authentication strategy must be provided
 * @HttpResponse        400         An existing tenant alias must be provided
 * @HttpResponse        400         Invalid size on the CSV file
 * @HttpResponse        400         Missing name on the CSV file
 * @HttpResponse        400         Missing size on the CSV file
 * @HttpResponse        400         The specified authentication strategy is
