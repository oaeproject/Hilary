 ...
 */
OAE.tenantRouter.on('get', '/api/mediacore/embed/:contentId', function(
  req,
  res,
) {
  MediaCoreAPI.getEmbedInfo(req.ctx, req.params.contentId, function(
    err,
    embedInfo,
  ) {
    if (err) {
 ...
 * @HttpResponse                  500          There was an unexpected error communicating with the media server
 */
OAE.tenantRouter.on('post', '/api/mediacore/encodingCallback', function(
  req,
  res,
) {
