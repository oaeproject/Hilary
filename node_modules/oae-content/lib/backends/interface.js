 ...
 * @param {Function}    callback            A callback method
 * @param {Object}      callback.err        An error object (if any)
 * @param {String}      callback.file       A URI that can be used to retrieve the filebody.
 * @param {String}      callback.file.path  The path of the file
 * @param {String}      callback.file.name  The name of the file
 * @param {String}      callback.file.size  Filesize in bytes
 */
 ...
 * @returns {Object}                            An object that holds a `code` key and a `url` key. If the code is `204` it's assumed that this should be an X-Accel-Redirect via nginx, if it's a 301 or 302 the provided url is a complete url to an outside source.
 */
