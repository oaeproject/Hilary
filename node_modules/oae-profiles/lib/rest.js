...
module.exports = function(tenant) {
    ...
    // Get all sections.
    tenant.server.get('/api/users/:id/profile', function(req, res) {
    ...
    tenant.server.get('/api/users/:id/profile/:section', function(req, res) {
    ...
    tenant.server.get('/api/users/:id/visibility', function(req, res) {
    ...
    tenant.server.post('/api/users/:id/profile', function(req, res) {
    ...
    tenant.server.post('/api/users/:id/profile/:section/visibility', function(req, res) {
