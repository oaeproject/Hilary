    ...
    describe('User Indexing', function() {
        ...
        it('verify index created user', function(callback) {
            TestsUtil.generateTestUsers(camAdminRestContext, 1, function(err, users) {
                ...
                SearchTestsUtil.searchAll(anonymousRestContext, 'general', ['user'], null, function(err, results) {
                    assert.ok(!err);
        ...
        it('verify index updated user', function(callback) {
            TestsUtil.generateTestUsers(camAdminRestContext, 1, function(err, users) {
                ...
                RestAPI.Authentication.login(anonymousRestContext, mrvisser.restContext.userId, mrvisser.restContext.userPassword, function(err) {
                    ...
                    SearchTestsUtil.searchAll(mrvisser.restContext, 'general', ['user'], { 'q': 'Visser' }, function(err, results) {
                        assert.ok(!err);
                        assert.ok(!_getDocById(results, mrvisser.user.id));
                        ...
                        RestAPI.User.updateUser(mrvisser.restContext, mrvisser.user.id, updateProperties, function(err) {
                            ...
                            SearchTestsUtil.searchAll(anonymousRestContext, 'general', ['user'], { 'q': 'Visser' }, function(err, results) {
                                assert.ok(!err);
    ...
    describe('Group Indexing', function() {
        ...
        it('verify index created group', function(callback) {
            TestsUtil.generateTestGroups(camAdminRestContext, 1, function(err, groups) {
                ...
                SearchTestsUtil.searchAll(anonymousRestContext, 'general', ['group'], null, function(err, results) {
                    assert.ok(!err);
        ...
        it('verify index updated group', function(callback) {
            ...
            RestAPI.User.createUser(camAdminRestContext, doerUsername, 'password', 'Doer', null, function(err, doer) {
                ...
                TestsUtil.generateTestGroups(doerRestContext, 1, function(err, groups) {
                    ...
                    SearchTestsUtil.searchAll(doerRestContext, 'general', ['group'], { 'q': 'Xyz' }, function(err, results) {
                        assert.ok(!err);
        ...
        it('verify index created content', function(callback) {
            ...
            RestAPI.User.createUser(camAdminRestContext, doerUsername, 'password', 'Doer', null, function(err, doer) {
                ...
                RestAPI.Content.createLink(doerRestContext, 'Sakai Foundation', 'Link to Sakai Foundation Website', 'public', 'http://www.sakaifoundation.org', [], [], function(err, content) {
                    ...
                    SearchTestsUtil.searchAll(doerRestContext, 'general', ['content'], { 'q': 'Sakai' }, function(err, results) {
                        assert.ok(!err);
        ...
        it('verify index updated content', function(callback) {
            ...
            RestAPI.User.createUser(camAdminRestContext, doerUsername, 'password', 'Doer', null, function(err, doer) {
                ...
                RestAPI.Content.createLink(doerRestContext, 'Sakai Foundation', 'Link to Sakai Foundation Website', 'public', 'http://www.sakaifoundation.org', [], [], function(err, content) {
                    ...
                    SearchTestsUtil.searchAll(doerRestContext, 'general', ['content'], { 'q': 'Apereo' }, function(err, results) {
                        assert.ok(!err);
                        assert.ok(!_getDocById(results, content.contentId));
            ...
            RestAPI.User.createUser(camAdminRestContext, doerUsername, 'password', 'Doer', null, function(err, doer) {
                ...
                RestAPI.Content.createLink(doerRestContext, 'Sakai Foundation', 'Link to Sakai Foundation Website', 'public', 'http://www.sakaifoundation.org', [], [], function(err, link) {
                    ...
                    RestAPI.Content.createLink(doerRestContext, 'Apereo Foundation', 'Link to Apereo Foundation Website', 'public', 'http://www.apereo.org', [], [], function(err, link) {
                        ...
                        SearchTestsUtil.searchRefreshed(doerRestContext, 'general', ['all'], {'limit': 1}, function(err, results) {
                            assert.ok(!err);
                            assert.ok(results);
                            ...
                            SearchTestsUtil.searchRefreshed(doerRestContext, 'general', ['all'], {'limit': 1, 'start': 0}, function(err, results) {
                                assert.ok(!err);
                                assert.ok(results);
                                assert.ok(results.results);
                                assert.equal(results.results.length, 1);
                                ...
                                SearchTestsUtil.searchRefreshed(doerRestContext, 'general', ['all'], {'limit': 1, 'start': 1}, function(err, results) {
                                    assert.ok(!err);
                                    assert.ok(results);
                                    assert.ok(results.results);
                                    assert.equal(results.results.length, 1);
                                ...
                                TestsUtil.generateGroupHierarchy(doerRestContext, groupIds, 'member', function(err) {
                                    ...
                                    TestsUtil.generateGroupHierarchy(doerRestContext, [groupIds[4], jack.id], 'member', function(err) {
                                        ...
                                        RestAPI.Content.createLink(doerRestContext, 'Test Content 1', 'Test content description 1', 'public', 'http://www.sakaiproject.org/',  [], [groupIds[0]], function(err, contentObj) {
                                            ...
                                            SearchTestsUtil.searchAll(anonymousRestContext, 'general', ['all'], { 'q': 'Content' }, function(err, results) {
                                                assert.ok(!err);
                                                ...
                                                SearchTestsUtil.searchAll(camAdminRestContext, 'general', ['all'], { 'q': 'Content', '_refresh': false }, function(err, results) {
                                                    assert.ok(!err);
                                                    ...
                                                    SearchTestsUtil.searchAll(janeRestContext, 'general', ['all'], { 'q': 'Content', '_refresh': false }, function(err, results) {
                                                        assert.ok(!err);
                                                        ...
                                                        SearchTestsUtil.searchAll(janeRestContext, 'general', ['all'], { 'q': 'Content', '_refresh': false }, function(err, results) {
                                                            ...
                                                            SearchTestsUtil.searchAll(jackRestContext, 'general', ['all'], { 'q': 'Content', '_refresh': false }, function(err, results) {
                                                                assert.ok(!err);
                                    ...
                                    TestsUtil.generateGroupHierarchy(doerRestContext, [groupIds[4], jack.id], 'member', function(err) {
                                        ...
                                        RestAPI.Content.createLink(doerRestContext, 'Test Content 1', 'Test content description 1', 'loggedin', 'http://www.sakaiproject.org/',  [], [groupIds[0]], function(err, contentObj) {
                                            ...
                                            SearchTestsUtil.searchAll(anonymousRestContext, 'general', ['all'], { 'q': 'Content' }, function(err, results) {
                                                ...
                                                SearchTestsUtil.searchAll(darthVaderRestContext, 'general', ['all'], { 'q': 'Content', 'includeExternal': true }, function(err, results) {
                                                    assert.ok(!err);
                                                    assert.ok(!_getDocById(results, contentObj.contentId));
                                    ...
                                    TestsUtil.generateGroupHierarchy(doerRestContext, [groupIds[4], jack.id], 'member', function(err) {
                                        ...
                                        RestAPI.Content.createLink(doerRestContext, 'Test Content 1', 'Test content description 1', 'private', 'http://www.sakaiproject.org/',  [], [groupIds[0]], function(err, contentObj) {
                                            ...
                                            SearchTestsUtil.searchAll(anonymousRestContext, 'general', ['all'], { 'q': 'Content' }, function(err, results) {
                                                ...
                                                // Verify cross-tenant user cannot see it
                                                SearchTestsUtil.searchAll(darthVaderRestContext, 'general', ['all'], { 'q': 'Content', 'includeExternal': true, '_refresh': false }, function(err, results) {
                                                    assert.ok(!err);
                                                    assert.ok(!_getDocById(results, contentObj.contentId));
            ...
            RestAPI.User.createUser(gtAdminRestContext, darthVaderUsername, 'password', 'Darth Vader', null, function(err, darthVader) {
                ...
                RestAPI.User.createUser(camAdminRestContext, jackUsername, 'password', 'Jack McJackerson', jackOpts, function(err, jack) {
                    ...
                    RestAPI.User.createUser(camAdminRestContext, janeUsername, 'password', 'Janey McJaneFace', null, function(err, jane) {
                        ...
                        SearchTestsUtil.searchAll(darthVaderRestContext, 'general', ['user'], {'q': 'Jack'}, function(err, results) {
                            assert.ok(!err);
                            var jackDoc = _getDocById(results, jack.id);
                            assert.ok(!jackDoc);

                            // Verify visible for cross-tenant user on external search
                            SearchTestsUtil.searchAll(darthVaderRestContext, 'general', ['user'], {'q': 'Jack', 'includeExternal': true}, function(err, results) {
                                assert.ok(!err);
                                var jackDoc = _getDocById(results, jack.id);
                                assert.ok(jackDoc);
                                ...
                                SearchTestsUtil.searchAll(anonymousRestContext, 'general', ['user'], {'q': 'Jack', '_refresh': false}, function(err, results) {
                                    assert.ok(!err);
                                    var jackDoc = _getDocById(results, jack.id);
                                    assert.ok(jackDoc);
                                    assert.equal(jackDoc.id, jack.id);
                                    ...
                                    SearchTestsUtil.searchAll(janeRestContext, 'general', ['user'], {'q': 'Jack', '_refresh': false}, function(err, results) {
                                        assert.ok(!err);
                                        var jackDoc = _getDocById(results, jack.id);
                                        assert.ok(jackDoc);
                                        assert.equal(jackDoc.id, jack.id);
                                        ...
                                        SearchTestsUtil.searchAll(camAdminRestContext, 'general', ['user'], {'q': 'Jack', '_refresh': false}, function(err, results) {
                                            assert.ok(!err);
                                            var jackDoc = _getDocById(results, jack.id);
                                            assert.ok(jackDoc);
                                            assert.equal(jackDoc.id, jack.id);
                ...
                RestAPI.User.createUser(camAdminRestContext, jackUsername, 'password', 'Jack McJackerson', jackOpts, function(err, jack) {
                    ...
                    RestAPI.User.createUser(camAdminRestContext, janeUsername, 'password', 'Janey McJaneFace', null, function(err, jane) {
                        ...
                        SearchTestsUtil.searchAll(darthVaderRestContext, 'general', ['user'], {'q': 'Jack'}, function(err, results) {
                            ...
                            SearchTestsUtil.searchAll(darthVaderRestContext, 'general', ['user'], {'q': 'Jack', 'includeExternal': true, '_refresh': false}, function(err, results) {
                                assert.ok(!err);
                                var jackDoc = _getDocById(results, jack.id);
                                assert.ok(!jackDoc);
                    ...
                    RestAPI.User.createUser(camAdminRestContext, jackUsername, 'password', 'Jack McJackerson', null, function(err, jack) {
                        ...
                        RestAPI.User.createUser(camAdminRestContext, janeUsername, 'password', 'Janey McJaneFace', null, function(err, jane) {
                            ...
                            RestAPI.Group.createGroup(jackRestContext, groupAlias, groupAlias, 'A really awesome group', 'public', 'no', [], [sith.id], function(err, group) {
                                ...
                                SearchTestsUtil.searchAll(anonymousRestContext, 'general', ['group'], {'q': 'awesome'}, function(err, results) {
                                    assert.ok(!err);
                                    ...
                                    SearchTestsUtil.searchAll(darthVaderRestContext, 'general', ['group'], {'q': 'awesome'}, function(err, results) {
                                        assert.ok(!err);
                                        var groupDoc = _getDocById(results, group.id);
                                        assert.ok(!groupDoc);

                                        // Verify cross-tenant user can query the group with includeExternal
                                        SearchTestsUtil.searchAll(darthVaderRestContext, 'general', ['group'], {'q': 'awesome', 'includeExternal': true, '_refresh': false}, function(err, results) {
                                            assert.ok(!err);
                                            var groupDoc = _getDocById(results, group.id);
                                            assert.ok(groupDoc);
                                            assert.equal(groupDoc.tenantAlias, group.tenant);
                                            ...
                                            SearchTestsUtil.searchAll(sithRestContext, 'general', ['group'], {'q': 'awesome', '_refresh': false}, function(err, results) {
                                                assert.ok(!err);
                                                var groupDoc = _getDocById(results, group.id);
                                                assert.ok(groupDoc);
                                                assert.equal(groupDoc.tenantAlias, group.tenant);
                                                ...
                                                SearchTestsUtil.searchAll(janeRestContext, 'general', ['group'], {'q': 'awesome', '_refresh': false}, function(err, results) {
                                                    assert.ok(!err);
                                                    var groupDoc = _getDocById(results, group.id);
                                                    assert.ok(groupDoc);
                                                    assert.equal(groupDoc.tenantAlias, group.tenant);
                                                    ...
                                                    SearchTestsUtil.searchAll(jackRestContext, 'general', ['group'], {'q': 'awesome', '_refresh': false}, function(err, results) {
                                                        assert.ok(!err);
                                                        var groupDoc = _getDocById(results, group.id);
                                                        assert.ok(groupDoc);
                                                        assert.equal(groupDoc.tenantAlias, group.tenant);
                                            ...
                                            RestAPI.Group.createGroup(jackRestContext, groupAlias, groupAlias, 'A really awesome group', 'loggedin', 'no', [], [sith.id], function(err, group) {
                                                ...
                                                RestAPI.Group.createGroup(jackRestContext, groupAliasJoinable, groupAliasJoinable, 'A really super joinable group', 'loggedin', 'request', [], [sith.id], function(err, groupJoinable) {
                                                    ...
                                                    SearchTestsUtil.searchAll(anonymousRestContext, 'general', ['group'], {'q': 'awesome'}, function(err, results) {
                                                        ...
                                                        SearchTestsUtil.searchAll(anonymousRestContext, 'general', ['group'], {'q': 'joinable'}, function(err, results) {
                                                            assert.ok(!err);
                                                            ...
                                                            SearchTestsUtil.searchAll(darthVaderRestContext, 'general', ['group'], {'q': 'awesome', 'includeExternal': true, '_refresh': false}, function(err, results) {
                                                                ...
                                                                SearchTestsUtil.searchAll(darthVaderRestContext, 'general', ['group'], {'q': 'joinable', 'includeExternal': true, '_refresh': false}, function(err, results) {
                                                                    assert.ok(!err);
                                                                    var groupDoc = _getDocById(results, groupJoinable.id);
                                                                    assert.ok(groupDoc);
                                                                    ...
                                                                    SearchTestsUtil.searchAll(sithRestContext, 'general', ['group'], {'q': 'awesome', '_refresh': false}, function(err, results) {
                                                                        ...
                                                                        SearchTestsUtil.searchAll(janeRestContext, 'general', ['group'], {'q': 'awesome', '_refresh': false}, function(err, results) {
                                                                            ...
                                                                            SearchTestsUtil.searchAll(jackRestContext, 'general', ['group'], {'q': 'awesome', '_refresh': false}, function(err, results) {
                                                                                ...
                                                                                SearchTestsUtil.searchAll(lukeSkywalkerRestContext, 'general', ['group'], {'q': 'skywalker', '_refresh': false}, function(err, results) {
                                                                                    assert.ok(!err);
                                                                                    ...
                                                                                    SearchTestsUtil.searchAll(lukeSkywalkerRestContext, 'general', ['group'], {'q': 'joinable', 'includeExternal': true, '_refresh': false}, function(err, results) {
                                                                                        assert.ok(!err);
                                                                                        var groupDoc = _getDocById(results, groupJoinable.id);
                                                                                        assert.ok(!groupDoc);
                                                                                        ...
                                                                                        SearchTestsUtil.searchAll(jackRestContext, 'general', ['group'], {'q': 'skywalker', 'includeExternal': true, '_refresh': false}, function(err, results) {
                                                                                            assert.ok(!err);
                                                                                            var groupDoc = _getDocById(results, privateTenantGroup.id);
                                                                                            assert.ok(!groupDoc);
                                                                                            callback();
                                            ...
                                            RestAPI.Group.createGroup(jackRestContext, groupAlias, groupAlias, 'A really awesome group', 'private', 'no', [], [sith.id], function(err, group) {
                                                ...
                                                RestAPI.Group.createGroup(jackRestContext, groupAliasJoinable, groupAliasJoinable, 'A really super joinable group', 'private', 'request', [], [sith.id], function(err, groupJoinable) {
                                                    ...
                                                    SearchTestsUtil.searchAll(anonymousRestContext, 'general', ['group'], {'q': 'awesome'}, function(err, results) {
                                                        ...
                                                        SearchTestsUtil.searchAll(anonymousRestContext, 'general', ['group'], {'q': 'joinable', '_refresh': false}, function(err, results) {
                                                            assert.ok(!err);
                                                            var groupDoc = _getDocById(results, groupJoinable.id);
                                                            assert.ok(!groupDoc);
        ...
        it('verify edgengram analyzer of 3 for auto-suggest', function(callback) {
            ...
            RestAPI.User.createUser(camAdminRestContext, doerUsername, 'password', 'Doer', null, function(err, doer) {
                ...
                RestAPI.Content.createLink(doerRestContext, 'Sakai Xyzforedgengram', 'Link to Sakai Foundation Website', 'public', 'http://www.sakaifoundation.org', [], [], function(err, content) {
                    ...
                    SearchTestsUtil.searchAll(doerRestContext, 'general', ['all'], {'q': 'Xyz'}, function(err, results) {
                        assert.ok(!err);
                        assert.ok(_getDocById(results, content.contentId));
                        callback();
                    });
        ...
        it('verify search indexing is not case-sensitive', function(callback) {
            ...
            RestAPI.User.createUser(camAdminRestContext, doerUsername, 'password', 'Doer', null, function(err, doer) {
                ...
                RestAPI.Content.createLink(doerRestContext, 'Sakai Xyzforedgengram', 'Link to Sakai Foundation Website', 'public', 'http://www.sakaifoundation.org', [], [], function(err, content) {
                    ...
                    // Search for just the first 3 characters to ensure it matches "Xyzforedgengram"
                    SearchTestsUtil.searchAll(doerRestContext, 'general', ['all'], {'q': 'sakai'}, function(err, results) {
                        assert.ok(!err);
                        assert.ok(_getDocById(results, content.contentId));
                        callback();
                    });
            ...
            RestAPI.User.createUser(camAdminRestContext, jackUsername, 'password', 'Jack JickMackerson', null, function(err, jack) {
                ...
                RestAPI.Group.createGroup(camAdminRestContext, groupAlias, groupAlias, 'A really awesome group', 'public', 'no', [], [], function(err, group) {
                    ...
                    RestAPI.Content.createLink(camAdminRestContext, 'Sakai Foundation', 'Link to Sakai Foundation Website', 'public', 'http://www.sakaifoundation.org', [], [], function(err, content) {
                        ...
                        SearchTestsUtil.searchAll(jackCtx, 'general', ['user'], null, function(err, results) {
                            assert.ok(!err);
                            ...
                            SearchTestsUtil.searchAll(jackCtx, 'general', ['group'], {'_refresh': false}, function(err, results) {
                                assert.ok(!err);
                                ...
                                SearchTestsUtil.searchAll(jackCtx, 'general', ['content'], {'_refresh': false}, function(err, results) {
                                    assert.ok(!err);
                                    assert.ok(_getDocById(results, content.contentId));
                                    assert.equal(_.filter(results.results, function(result) { return result.resourceType === 'user' }).length, 0);
                                    assert.equal(_.filter(results.results, function(result) { return result.resourceType === 'group' }).length, 0);
            ...
            RestAPI.User.createUser(camAdminRestContext, jackUsername, 'password', 'Jack JickMackerson', null, function(err, jack) {
                ...
                RestAPI.Group.createGroup(camAdminRestContext, group1Alias, group1Alias, 'A really awesome group', 'private', 'no', [], [jack.id], function(err, group1) {
                    ...
                    RestAPI.Group.createGroup(camAdminRestContext, group2Alias, group2Alias, 'A really awesome group', 'private', 'no', [], [group1.id], function(err, group2) {
                        ...
                        SearchTestsUtil.searchAll(jackCtx, 'general', ['all'], {'q': 'awesome'}, function(err, results) {
                            assert.ok(!err);
                            ...
                            SearchTestsUtil.searchAll(jackCtx, 'general', ['all'], {'q': 'awesome', 'includeIndirect': false, '_refresh': false}, function(err, results) {
                                assert.ok(!err);
