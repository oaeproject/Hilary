  ...
  describe('Multipart Uploads', function() {
    ...
    it('verify multiple files can be uploaded in the same request parameter', function(callback) {
      TestsUtil.createTestServer(function(app, server, port) {
        ...
        var opts = {
          method: 'POST',
          url: 'http://localhost:' + port + '/testUploadFiles',
        };
  ...
  describe('Cookies', function() {
    ...
    it('verify a fixed cookie name is used', function(callback) {
      TestsUtil.generateTestUsers(camAdminRestContext, 1, function(
        ...
        PrincipalsTestUtil.assertGetMeSucceeds(simong.restContext, function(
          me,
        ) {
          assert.ok(!me.anon);

          // Get the cookies from the cookie har
          var cookies = simong.restContext.cookieJar.getCookies(
            'http://localhost',
          );
