                ...
                FoldersTestUtil.assertShareFolderSucceeds(publicTenant.publicUser.restContext, publicTenant.publicFolder.id, [publicTenant.loggedinUser], function() {
                    FoldersTestUtil.assertShareFolderSucceeds(publicTenant.publicUser.restContext, publicTenant.loggedinFolder.id, [publicTenant.loggedinUser], function() {
                        FoldersTestUtil.assertShareFolderFails(publicTenant.publicUser.restContext, publicTenant.privateFolder.id, [publicTenant.loggedinUser.user.id], 401, function() {
                            ...
                            FoldersTestUtil.assertShareFolderFails(publicTenant.publicUser.restContext, publicTenant.loggedinFolder.id, [publicTenant.privateUser.user.id], 401, function() {
                                FoldersTestUtil.assertShareFolderFails(publicTenant.publicUser.restContext, publicTenant.loggedinFolder.id, [publicTenant1.publicUser.user.id], 401, function() {
                                    FoldersTestUtil.assertShareFolderFails(publicTenant.publicUser.restContext, publicTenant.loggedinFolder.id, [publicTenant1.loggedinUser.user.id], 401, function() {
                                        FoldersTestUtil.assertShareFolderFails(publicTenant.publicUser.restContext, publicTenant.loggedinFolder.id, [publicTenant1.privateUser.user.id], 401, function() {
                                            FoldersTestUtil.assertShareFolderFails(publicTenant.publicUser.restContext, publicTenant.loggedinFolder.id, [privateTenant.publicUser.user.id], 401, function() {
                                                FoldersTestUtil.assertShareFolderFails(publicTenant.publicUser.restContext, publicTenant.loggedinFolder.id, [privateTenant.loggedinUser.user.id], 401, function() {
                                                    return FoldersTestUtil.assertShareFolderFails(publicTenant.publicUser.restContext, publicTenant.loggedinFolder.id, [privateTenant.privateUser.user.id], 401, callback);
                                                });
                                            });
                                        });
                                    });
                    ...
                    FoldersTestUtil.assertShareFolderSucceeds(publicTenant.publicUser.restContext, publicTenant.publicFolder.id, [publicTenant.loggedinUser], function() {
                        FoldersTestUtil.assertShareFolderSucceeds(publicTenant.publicUser.restContext, publicTenant.loggedinFolder.id, [publicTenant.loggedinUser], function() {
                            FoldersTestUtil.assertShareFolderSucceeds(publicTenant.publicUser.restContext, publicTenant.privateFolder.id, [publicTenant.loggedinUser], function() {
                                ...
                                FoldersTestUtil.assertShareFolderFails(publicTenant.publicUser.restContext, publicTenant.privateFolder.id, [publicTenant.privateUser.user.id], 401, function() {
                                    FoldersTestUtil.assertShareFolderSucceeds(publicTenant.publicUser.restContext, publicTenant.privateFolder.id, [publicTenant1.publicUser], function() {
                                        FoldersTestUtil.assertShareFolderFails(publicTenant.publicUser.restContext, publicTenant.privateFolder.id, [publicTenant1.loggedinUser.user.id], 401, function() {
                                            FoldersTestUtil.assertShareFolderFails(publicTenant.publicUser.restContext, publicTenant.privateFolder.id, [publicTenant1.privateUser.user.id], 401, function() {
                                                FoldersTestUtil.assertShareFolderFails(publicTenant.publicUser.restContext, publicTenant.privateFolder.id, [privateTenant.publicUser.user.id], 401, function() {
                                                    FoldersTestUtil.assertShareFolderFails(publicTenant.publicUser.restContext, publicTenant.privateFolder.id, [privateTenant.loggedinUser.user.id], 401, function() {
                                                        return FoldersTestUtil.assertShareFolderFails(publicTenant.publicUser.restContext, publicTenant.privateFolder.id, [privateTenant.privateUser.user.id], 401, callback);
                                                    });
                                                });
                                            });
                                        });
                        ...
                        FoldersTestUtil.assertShareFolderSucceeds(publicTenant.adminRestContext, publicTenant.privateFolder.id, [publicTenant.loggedinUser], function() {
                            ...
                            FoldersTestUtil.assertShareFolderSucceeds(publicTenant.adminRestContext, publicTenant.privateFolder.id, [publicTenant.privateUser], function() {
                                FoldersTestUtil.assertShareFolderSucceeds(publicTenant.adminRestContext, publicTenant.privateFolder.id, [publicTenant1.publicUser], function() {
                                    FoldersTestUtil.assertShareFolderFails(publicTenant.adminRestContext, publicTenant.privateFolder.id, [publicTenant1.loggedinUser.user.id], 401, function() {
                                        FoldersTestUtil.assertShareFolderFails(publicTenant.adminRestContext, publicTenant.privateFolder.id, [publicTenant1.privateUser.user.id], 401, function() {
                                            FoldersTestUtil.assertShareFolderFails(publicTenant.adminRestContext, publicTenant.privateFolder.id, [privateTenant.publicUser.user.id], 401, function() {
                                                FoldersTestUtil.assertShareFolderFails(publicTenant.adminRestContext, publicTenant.privateFolder.id, [privateTenant.loggedinUser.user.id], 401, function() {
                                                    return FoldersTestUtil.assertShareFolderFails(publicTenant.adminRestContext, publicTenant.privateFolder.id, [privateTenant.privateUser.user.id], 401, callback);
                                                });
                                            });
                                        });
                                    });
                    ...
                    FoldersTestUtil.assertUpdateFolderMembersSucceeds(publicTenant.adminRestContext, folder.id, _memberUpdate(publicTenant.loggedinUser, 'manager'), function() {
                        ...
                        FoldersTestUtil.assertUpdateFolderMembersSucceeds(publicTenant.adminRestContext, publicTenant.loggedinFolder.id, _memberUpdate(publicTenant.privateUser), function() {
                            FoldersTestUtil.assertUpdateFolderMembersSucceeds(publicTenant.adminRestContext, publicTenant.loggedinFolder.id, _memberUpdate(publicTenant1.publicUser), function() {
                                FoldersTestUtil.assertUpdateFolderMembersFails(publicTenant.adminRestContext, publicTenant.loggedinFolder.id, _memberUpdate(publicTenant1.loggedinUser.user.id), 401, function() {
                                    FoldersTestUtil.assertUpdateFolderMembersFails(publicTenant.adminRestContext, publicTenant.loggedinFolder.id, _memberUpdate(publicTenant1.privateUser.user.id), 401, function() {
                                        FoldersTestUtil.assertUpdateFolderMembersFails(publicTenant.adminRestContext, publicTenant.loggedinFolder.id, _memberUpdate(privateTenant.publicUser.user.id), 401, function() {
                                            FoldersTestUtil.assertUpdateFolderMembersFails(publicTenant.adminRestContext, publicTenant.loggedinFolder.id, _memberUpdate(privateTenant.loggedinUser.user.id), 401, function() {
                                                return FoldersTestUtil.assertUpdateFolderMembersFails(publicTenant.adminRestContext, publicTenant.loggedinFolder.id, _memberUpdate(privateTenant.privateUser.user.id), 401, callback);
                                            });
                                        });
                                    });
                                });
                    ...
                    FoldersTestUtil.assertUpdateFolderMembersSucceeds(publicTenant.adminRestContext, publicTenant.publicFolder.id, _memberUpdate(publicTenant.publicUser), function() {
                        FoldersTestUtil.assertUpdateFolderMembersFails(publicTenant.publicUser.restContext, publicTenant.publicFolder.id, _memberUpdate(publicTenant.loggedinUser.user.id), 401, function() {
                            ...
                            FoldersTestUtil.assertUpdateFolderMembersSucceeds(publicTenant.adminRestContext, publicTenant.publicFolder.id, _memberUpdate(publicTenant.publicUser, 'manager'), function() {
                                ...
                                FoldersTestUtil.assertUpdateFolderMembersFails(publicTenant.publicUser.restContext, publicTenant.publicFolder.id, _memberUpdate(publicTenant.privateUser.user.id), 401, function() {
                                    FoldersTestUtil.assertUpdateFolderMembersSucceeds(publicTenant.publicUser.restContext, publicTenant.publicFolder.id, _memberUpdate(publicTenant1.publicUser), function() {
                                        FoldersTestUtil.assertUpdateFolderMembersFails(publicTenant.publicUser.restContext, publicTenant.publicFolder.id, _memberUpdate(publicTenant1.loggedinUser.user.id), 401, function() {
                                            FoldersTestUtil.assertUpdateFolderMembersFails(publicTenant.publicUser.restContext, publicTenant.publicFolder.id, _memberUpdate(publicTenant1.privateUser.user.id), 401, function() {
                                                FoldersTestUtil.assertUpdateFolderMembersFails(publicTenant.publicUser.restContext, publicTenant.publicFolder.id, _memberUpdate(privateTenant.publicUser.user.id), 401, function() {
                                                    FoldersTestUtil.assertUpdateFolderMembersFails(publicTenant.publicUser.restContext, publicTenant.publicFolder.id, _memberUpdate(privateTenant.loggedinUser.user.id), 401, function() {
                                                        return FoldersTestUtil.assertUpdateFolderMembersFails(publicTenant.publicUser.restContext, publicTenant.publicFolder.id, _memberUpdate(privateTenant.privateUser.user.id), 401, callback);
                                                    });
                                                });
                                            });
                                        });
