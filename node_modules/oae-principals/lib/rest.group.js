...
OAE.tenantRouter.on('delete', '/api/group/:groupId', function(req, res) {
    PrincipalsAPI.deleteGroup(req.ctx, req.params.groupId, function(err, group) {
        if (err) {
            return res.send(err.code, err.msg);
        }
 ...
 * @Return      {Group}                             The basic group profile of the restored group
...
OAE.tenantRouter.on('post', '/api/group/:groupId/restore', function(req, res) {
    PrincipalsAPI.restoreGroup(req.ctx, req.params.groupId, function(err, group) {
        if (err) {
            return res.send(err.code, err.msg);
        }
