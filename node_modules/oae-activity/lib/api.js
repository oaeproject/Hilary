 ...
 *
 * @param   {ActivitySeed}      activitySeed            The activity seed that was used to post the activity
 * @param   {ActivityObject}    actor                   The actor activity entity for which to generate routes
 * @param   {ActivityObject}    object                  The object activity entity for which to generate routes
 * @param   {ActivityObject}    target                  The target activity entity for which to generate routes
 * @param   {Function}          callback                Invoked when the process completes
 * @param   {Object}            callback.err            An error that occurred, if any
 ...
 * @param   {ActivityObject}        activityObject      The activity entity for which the routes are being generated
 * @param   {Function}              callback            Invoked when the process completes
 * @param   {Object}                callback.err        An error that occurred, if any
 ...
 * @param   {Function}              callback                Invoked when the process completes
 * @param   {Object}                callback.err            An error that occurred, if any
 * @param   {ActivityObject}        callback.activityObject The activity entity that was produced
