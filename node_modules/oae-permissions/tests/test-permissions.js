...
module.exports.testIndirectPermission = function(test) {
    ...
    principals.api.createUser(tenant, 'runner', 'password', 'public', 'Runner', 'Runner', 'Runner Runner', function(err, runnerUuid) {
        principals.api.getUser(runnerUuid, function(err, runner) {
...
module.exports.testGetAllPermissionsDirect = function(test) {
    ...
    // 1. set up the group hierarchy
    principals.api.createUser(tenant, 'mrvisser', 'password', 'public', 'Branden', 'Visser', 'Branden Visser', function(err, mrvisserUuid) {
        test.ok(!err);

        principals.api.getUser(mrvisserUuid, function(err, mrvisser) {
            test.ok(!err);
