...
var queueUsersForEmail = module.exports.queueUsersForEmail = function(users, callback) {
    ...
    _.each(users, function(user) {
        ...
        var bucketId = createEmailBucketIdForUser(user.id, user.emailPreference, timezone);
...
/**
 * Given a user ID, his email preference and a timezone, return the approriate email bucket ID
 *
 ...
 * @param  {String}     timezone            The timezone in which this email should be scheduled. Defaults to `Etc/UTC`
