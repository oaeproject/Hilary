            ...
            function(err, discussion) {
              ...
              ActivityTestsUtil.collectAndGetActivityStream(
                ...
                function(err, activityStream) {
                  ...
                  assert.equal(
                    entity.object['oae:visibility'],
                    discussion.visibility,
                  );
                  assert.equal(
                    entity.object['oae:profilePath'],
                    discussion.profilePath,
                  );
                  assert.equal(
                    entity.object['displayName'],
                ...
                function(err, message) {
                  ...
                  ActivityTestsUtil.collectAndGetActivityStream(
                    ...
                    function(err, activityStream) {
                      ...
                      assert.equal(
                        entity.object['oae:messageBoxId'],
                        message.messageBoxId,
                      );
                      assert.equal(
                        entity.object['oae:threadKey'],
                        message.threadKey,
                      );
                        ...
                        function(err, nicosMessage) {
                          ...
                          ActivityTestsUtil.collectAndGetActivityStream(
                            ...
                            function(err, activityStream) {
                              ...
                              assert.equal(
                                entity.object['oae:collection'].length,
                                2,
                              );
                              var originalMessage = _.find(
                                entity.object['oae:collection'],
                                function(activityMessage) {
                                  return (
                                    activityMessage['oae:id'] === message.id
                                  );
                                },
                              );
                              assert.ok(originalMessage);
                              assert.equal(
                                originalMessage['oae:id'],
                                message.id,
                              );
                              assert.equal(
                              ...
                              assert.equal(
                                reply['inReplyTo']['oae:id'],
                                message.id,
                              );

                              // Verify both actors are present
                              assert.equal(
                                entity.actor['objectType'],
                                'collection',
                              );
                              var simonEntity = _.find(
                              ...
                              assert.equal(
                                ...
                                '/user/' +
                                  ...
                                  '/' +
                                  AuthzUtil.getResourceFromId(simon.user.id)
                                    .resourceId,
                              );

                              var nicoEntity = _.find(
                                entity.actor['oae:collection'],
                                function(userEntity) {
                              ...
                              assert.equal(
                                ...
                                '/user/' +
                                  ...
                                  '/' +
                                  AuthzUtil.getResourceFromId(nico.user.id)
                                    .resourceId,
                              );
                        ...
                        RestAPI.Discussions.createMessage(
                          ...
                          function(err, message) {
                            ...
                            ActivityTestsUtil.collectAndGetNotificationStream(
                              ...
                              function(err, activityStream) {
                                assert.ok(!err);
                                var messageActivities = _.filter(
                ...
                RestAPI.Discussions.createMessage(
                  ...
                  function(err, simongMessage) {
                    ...
                    EmailTestsUtil.collectAndFetchAllEmails(function(emails) {
                      ...
                      assert.notEqual(
                        email.subject.indexOf('swappedFromPublicAlias'),
                        -1,
                      );
                      ...
                      assert.notEqual(
                        stringEmail.indexOf(discussion.profilePath),
                        -1,
                      );
                      assert.notEqual(
                        stringEmail.indexOf(discussion.displayName),
                        -1,
                      );
                      ...
                      assert.notEqual(
                        stringEmail.indexOf('Would read again</p>'),
                        -1,
                      );
