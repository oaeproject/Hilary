...
var _ensureSchema = function(callback) {
    ...
    Cassandra.createColumnFamilies({
        ...
        'DataArchive': 'CREATE TABLE "DataArchive" ("archiveId" text, "principalId" text, "resourceId" text, "deletionDate" text, "fullyDeleted" text, PRIMARY KEY ("archiveId", "principalId"))'
