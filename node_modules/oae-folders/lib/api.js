...
var createFolder = module.exports.createFolder = function(ctx, displayName, description, visibility, roles, callback) {
    ...
    PrincipalsAPI.canManageAny(ctx, managerIds, function(err, canManageAny) {
        ...
        ResourceActions.create(ctx, roles, createFn, function(err, folder, changes) {
            if (err) {
                return callback(err);
            }
...
var shareFolder = module.exports.shareFolder = function(ctx, folderId, principalIds, callback) {
    ...
    FoldersDAO.getFolder(folderId, function(err, folder) {
        ...
        ResourceActions.share(ctx, folder, principalIds, AuthzConstants.role.VIEWER, function(err, changes, roles, addedMembers) {
            if (err) {
                return callback(err);
            ...
            var allMemberIdsBeforeShare = _.keys(roles.before);
            ...
            OaeUtil.invokeIfNecessary(_testLibraryUpdateThreshold(folder), FoldersFoldersLibrary.update, allMemberIdsBeforeShare, folder, null, function(err, updatedFolder) {
                ...
                FoldersFoldersLibrary.insert(addedMemberIds, folder, function(err) {
                    ...
                    FoldersAPI.emit(FoldersConstants.events.UPDATED_FOLDER_MEMBERS, ctx, folder, changes, addedMemberIds, [], []);
                    return callback();
                });
            });
        });
...
var setFolderPermissions = module.exports.setFolderPermissions = function(ctx, folderId, changes, callback) {
    ...
    FoldersDAO.getFolder(folderId, function(err, folder) {
        ...
        ResourceActions.setRoles(ctx, folder, changes, function(err, changes, roles, members) {
            if (err) {
                return callback(err);
            }
            ...
            FoldersFoldersLibrary.insert(addedMemberIds, folder, function(err) {
                ...
                FoldersFoldersLibrary.remove(removedMemberIds, folder, function(err) {
                    ...
                    var updateMemberIds = _.keys(roles.after);
                    OaeUtil.invokeIfNecessary(_testLibraryUpdateThreshold(folder), FoldersFoldersLibrary.update, updateMemberIds, folder, null, function(err) {
                        ...
                        FoldersAPI.emit(FoldersConstants.events.UPDATED_FOLDER_MEMBERS, ctx, folder, changes, addedMemberIds, updatedMemberIds, removedMemberIds);
                        return callback();
                    });
                });
            });
