 ...
 * - `{globalAdminOnly: true, suppress: true}`                         Values that only the global admin can view, you don't want to expose and want the tenant to be able to override (e.g. private key)
 * - `{globalAdminOnly: true}`                                         Values that only the global admin can view, you want to expose and want the tenant to be able to override
 * - `{globalAdminOnly: true, tenantOverride: false}`                  Values that only the global admin can view, you want to expose and don't want the tenant to be able to override
 * - `{globalAdminOnly: true, tenantOverride: false, suppress: true}`  Values that only the global admin can view, you don't want to expose and don't want the tenant to override (e.g. stopping a tenant)
 * - `{suppress: true}`                                                Values that global and tenant admins can view, you don't want to expose and want the tenant to be able to override (most configuration)
 * - `{}`                                                              Values that global and tenant admins can view, you want to expose and want the tenant to be able to override
 * - `{tenantOverride: false}`                                         Values that global and tenant admins can view, you want to expose and don't want the tenant to override
 * - `{tenantOverride: false, suppress: true}`                         Values that global and tenant admins can view, you don't want to expose and don't want the tenant to override (e.g. stopping a tenant)
 *
 ...
 * @param  {Boolean}    [options.tenantOverride]    Whether or not tenant and global admins should be able to override this value for a tenant. Defaults to `true`
 * @param  {Boolean}    [options.suppress]          Whether or not this config element can be retrieved by regular users. Defaults to `false`
 * @param  {Boolean}    [options.globalAdminOnly]   Whether or not this config element is only viewable by global admin users. Defaults to `false`
 * @api private
 */
