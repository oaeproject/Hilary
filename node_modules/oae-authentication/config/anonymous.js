    ...
    "oae-authentication": {
        ...
        "anonymous": {
            ...
            "schema": new Fields.ArrayFieldSet({
                "href": new Fields.Text('Configure link', 'Configure link to page', '/', true)
            }),
            "elements": {
                ...
                "requireuser": new Fields.ExpandableObject("Require logged in user", "Pages that require that the user is logged in", {
                    "me": {
                        "href": new Fields.Text(null, null, '/me', true)
                    },
                    "devme": {
                        "href": new Fields.Text(null, null, '/dev/me.html', true)
                    },
                    "create": {
                        "href": new Fields.Text(null, null, '/create', true)
                    },
                    "devcreate": {
                        "href": new Fields.Text(null, null, '/dev/createnew.html', true)
                    }
                }, true),
                "requireanon": new Fields.ExpandableObject("Require anonymous user", "Pages that require that the user to be anonymous", {
                    "register": {
                        "href": new Fields.Text(null, null, '/register', true)
                    },
                    "devregister": {
                        "href": new Fields.Text(null, null, '/dev/create_new_account.html', true)
                    }
                }, true),
                ...
                "requireprocessing": new Fields.ExpandableObject("Require processing", "List op pages that require additional processing to determine whether the page can be shown to the current user. These pages are then required to call the sakai.api.Security.showPage themselves", {
                    "devuser": {
                        "href": new Fields.Text(null, null, '/dev/user.html', true)
                    },
                    "me": {
                        "href": new Fields.Text(null, null, '/me', true)
                    },
                    ...
                    "devcontent": {
                        "href": new Fields.Text(null, null, '/dev/content_profile.html', true)
                    },
                    "content": {
                        "href": new Fields.Text(null, null, '/content', true)
                    }
                }, true)
            }
        }
