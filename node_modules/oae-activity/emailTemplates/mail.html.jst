                                            ...
                                            <% _.each(activity.allComments, function(comment) {
                                                ...
                                                <div class="activity-comment-container comment-level-<%= comment['oae:level'] %>">
                                                    ...
                                                    <div class="activity-comment">
                                                        <a href="<%= shared.ensureAbsoluteLink(comment.author['oae:profilePath'], baseUrl) %>" title="<%= util.html.encodeForHTMLAttribute(comment.author.displayName) %>" class="wrapped">
