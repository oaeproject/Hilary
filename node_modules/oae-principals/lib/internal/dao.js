 ...
 *
 * @param  {String}  principalId    A string that may or may not be a group id
 ...
 *
 * @param  {String}  principalId    A string that may or may not be a user id
...
var getUserFromRow = function(row) {
    ...
    for (var i = 0; i < keys.length; i++) {
        if (!_.contains(blacklist, keys[i]) && !_.isFunction(user[keys[i]])) {
