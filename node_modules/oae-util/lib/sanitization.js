 ...
 */
const encodeForHTML = module.exports.encodeForHTML = function(value) {
    if (!value) {
        return '';
    }
 ...
 */
const encodeForHTMLAttribute = module.exports.encodeForHTMLAttribute = function(value) {
    if (!value) {
        return '';
    }
 ...
 */
const encodeForURL = module.exports.encodeForURL = function(value) {
    if (!value) {
        return '';
    }
