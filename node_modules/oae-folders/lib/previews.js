 ...
 */
var whenPreviewsComplete = (module.exports.whenPreviewsComplete = function(
  callback,
) {
  previewCounter.whenZero(function() {
    MQTestUtil.whenTasksEmpty(
      ...
      function() {
        return MQTestUtil.whenTasksEmpty(
...
var _reprocessFoldersThatContainContent = function(contentId) {
  ...
  FoldersAuthz.getFoldersForContent(contentId, function(err, folders) {
    if (err) {
      log().error(
        { err: err, contentId: contentId },
        'Unable to get the folders a piece of content resides in',
      );
      previewCounter.decr();
      return;
    }
