...
var isLoggedIn = module.exports.isLoggedIn = function(ctx, tenantAlias) {
    ...
    return (!isAnon && (isGlobalAdmin || ctx.user().tenant === tenantAlias));
}
 ...
 * @return  {Boolean}                       True if the tenant boundaries should allow these two tenants to interact with one another
 */
