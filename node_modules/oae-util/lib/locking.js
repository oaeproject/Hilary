...
var acquire = (module.exports.acquire = function(lockKey, expiresIn, callback) {
  ...
  validator
    .check(expiresIn, {
      code: 400,
      msg:
        'The maximum number of seconds for which to hold the lock needs to be specified',
    })
    .notNull();
  validator
    .check(expiresIn, {
      code: 400,
      msg:
        'The maximum number of seconds for which to hold the lock needs to be an integer',
    })
    .isInt();
