 ...
 * @param  {String}    [opts.emailPreference]  The user's email preference (One of PrincipalsConstants.emailPreference)
 ...
 * @param  {Object}         profileFields   Object that represent the profile fields that should be updated. Possible keys are visibility, displayName, publicAlias, locale and emailPreference
 * @param  {Function}       callback        Standard callback function
 * @param  {Object}         callback.err    Error object containing the error message
 ...
 *
 * @param  {Context}   ctx            The current context
 * @param  {Object}    authInfo       An object containing the current user and the strategy that was used to sign in
 * @param  {Function}  callback       Standard callback function
 * @param  {Object}    callback.err   Error object containing the error message
 * @param  {Object}    callback.data  The me feed data for the user
 */
var getMe = module.exports.getMe = function(ctx, authInfo, callback) {
    if (!ctx.user()) {
        var anonMe = {
            'anon': true,
    ...
    getUser(ctx, ctx.user().id, function(err, data) {
        ...
        if (authInfo.strategyId) {
            data.authenticationStrategy = AuthenticationUtil.parseStrategyId(authInfo.strategyId).strategyName;
        }
