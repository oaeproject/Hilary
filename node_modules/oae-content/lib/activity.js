 ...
 */
ActivityAPI.registerActivityRouter('content', function(activityType, entityType, resource, callback) {
    // Extract the OAE ID from the activity object to get the content id
    return _routeContent(activityType, entityType, resource.resourceId, callback);
});

/*!
 * Routes an activity that occurred for a comment activity entity
 */
ActivityAPI.registerActivityRouter('content-comment', function(activityType, entityType, resource, callback) {
    // Extract the parent content id from the activity object, as the routes are identical
    return _routeContent(activityType, entityType, resource.resourceData.comment.contentId, callback);
});
