...
var initializeTinCanAPI = module.exports.initializeTinCanAPI = function(_config, callback) {
    ...
    ActivityAPI.on(ActivityConstants.events.ROUTED_ACTIVITIES, _processActivities);
 ...
 * @api private
 */
var _processActivities = function(activitySeed, routedActivities) {
 ...
 */
var sendStatementsToLRS = module.exports.sendActivitiesToLRS = function(statements, tenantAlias) {
