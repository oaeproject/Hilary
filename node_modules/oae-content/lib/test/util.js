...
var assertUpdateContentMembersFails = module.exports.assertUpdateContentMembersFails = function(managerRestContext, actorRestContext, contentId, roleChanges, httpCode, callback) {
    ...
    getAllContentMembers(managerRestContext, contentId, null, function(membersBeforeUpdate) {
        membersBeforeUpdate = AuthzTestUtil.getMemberRolesFromResults(membersBeforeUpdate);
        ...
        RestAPI.Content.updateMembers(actorRestContext, contentId, roleChanges, function(err) {
            ...
            getAllContentMembers(managerRestContext, contentId, null, function(membersAfterUpdate) {
                AuthzTestUtil.assertMembershipEquals(membersBeforeUpdate, null, AuthzTestUtil.getMemberRolesFromResults(membersAfterUpdate));
...
var assertUpdateContentMembersSucceeds = module.exports.assertUpdateContentMembersSucceeds = function(managerRestContext, actorRestContext, contentId, roleChanges, callback) {
    ...
    getAllContentMembers(managerRestContext, contentId, null, function(membersBeforeUpdate) {
        ...
        RestAPI.Content.updateMembers(actorRestContext, contentId, roleChanges, function(err) {
            ...
            // Get the content members again and ensure they have the expected members and roles
            getAllContentMembers(managerRestContext, contentId, null, function(membersAfterUpdate) {
                AuthzTestUtil.assertMembershipEquals(membersBeforeUpdate, roleChanges, AuthzTestUtil.getMemberRolesFromResults(membersAfterUpdate));
...
var assertShareContentSucceeds = module.exports.assertShareContentSucceeds = function(managerRestContext, actorRestContext, contentId, memberIds, callback) {
    ...
    getAllContentMembers(managerRestContext, contentId, null, function(membersBeforeUpdate) {
        ...
        _.each(memberIds, function(memberId) {
            if (!membersBeforeUpdate[memberId]) {
                membersBeforeUpdate[memberId] = 'viewer';
            }
        });
        ...
        RestAPI.Content.shareContent(actorRestContext, contentId, memberIds, function(err) {
            ...
            // Get the content members again and ensure they have the expected members and roles
            getAllContentMembers(managerRestContext, contentId, null, function(membersAfterUpdate) {
                AuthzTestUtil.assertMembershipEquals(membersBeforeUpdate, roleChange, AuthzTestUtil.getMemberRolesFromResults(membersAfterUpdate));
 ...
 *
 * @param  {RestContext}    adminRestContext        The rest context of an admin with which a user can be created
 * @param  {Function}       callback                Standard callback function
 ...
 */
var createContentAndInviteGuest = module.exports.createContentAndInviteGuest = function(adminRestContext, callback) {
    TestsUtil.generateTestUsers(adminRestContext, 1, function(err, users, inviter) {
        assert.ok(!err);
        ...
        RestAPI.Content.createLink(inviter.restContext, 'Apereo', 'Apereo', 'private', 'http://www.apereo.org', [], [], [], function(err, link) {
            ...
            PrincipalsTestUtil.whenGuestEmailSent(email, true, function(token) {
...
/**
 * Assert that a piece of content can be shared with a set of users and a guest. Note
 * that 1 guest must be specified
 *
 * @param  {RestContext}    restContext                     The rest context of a user that can share the content item
 * @param  {String}         contentId                       The id of the content item that should be shared
 * @param  {String[]}       principalIdsAndEmailAddress     A set of principal ids and one email address.
 * @param  {Function}       callback                        Standard callback function
 * @param  {String}         callback.token                  The token that was sent to the guest's email address
 */
var assertShareWithUsersAndGuest = module.exports.assertShareWithUsersAndGuest = function(restContext, contentId, principalIdsAndEmailAddress, callback) {
    RestAPI.Content.shareContent(restContext, contentId, principalIdsAndEmailAddress, function(err) {
        assert.ok(!err);
    });

    PrincipalsTestUtil.whenGuestEmailSent(null, true, callback);
};
