...
describe('Folders', function() {
    ...
    describe('Create Folder', function() {
         ...
         * @param  {Boolean}        isManager       Whether or not the folder creator should be an explicit manager
         * @param  {Function}       callback        Standard callback function
         */
        var createAndVerifyManager = function(user, managers, viewers, isManager, callback) {
            RestAPI.Folders.createFolder(user.restContext, 'test', 'test', null, null, null, function(err, folder) {
                assert.ok(!err);
        ...
        it('verify the creator is only made a manager when he cannot manage indirectly', function(callback) {
            TestsUtil.generateTestUsers(camAdminRestContext, 2, function(err, users, simong, nico) {
                ...
                TestsUtil.generateTestGroups(simong.restContext, 1, function(simongGroup) {
                    TestsUtil.generateTestGroups(nico.restContext, 1, function(nicoGroup) {

                        createAndVerifyManager(simong, null, null, true, function() {
                            createAndVerifyManager(simong, [nico.user.id], null, true, function() {
                                createAndVerifyManager(simong, null, [simongGroup], true, function() {
                                    createAndVerifyManager(simong, [simongGroup], null, false, function() {
                                        createAndVerifyManager(simong, [simongGroup, nicoGroup], null, false, function() {
                                            createAndVerifyManager(simong, [nico, simongGroup, nicoGroup], null, false, function() {
                                                return callback();
                                            });
                                        });
                                    });
