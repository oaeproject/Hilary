...
describe('Authz-Permissions', function() {
    ...
    describe('#hasRole()', function() {
        ...
        it('verify empty data', function(callback) {
            var userId = AuthzUtil.toId('u', 'ia-empty', 'mrvisser');
            var resourceId = AuthzUtil.toId('c', 'ia-empty', 'SomeContent');
        ...
        it('verify direct permission', function(callback) {
            var userId = AuthzUtil.toId('u', 'ia-direct', 'mrvisser');
            var resourceId = AuthzUtil.toId('c', 'ia-direct', 'SomeContent');
        ...
        it('verify direct single group permission', function(callback) {
            var groupId = AuthzUtil.toId('g', 'ia-single', 'oae-team');
            var userId = AuthzUtil.toId('u', 'ia-single', 'mrvisser');
            var resourceId = AuthzUtil.toId('c', 'ia-single', 'SomeContent');
        ...
        it('verify multi group hierarchy permission', function(callback) {
            var groupId1 = AuthzUtil.toId('g', 'ia-hier', 'oae-team');
            var groupId2 = AuthzUtil.toId('g', 'ia-hier', 'oae-backend-team');
            var userId = AuthzUtil.toId('u', 'ia-hier', 'mrvisser');
            var resourceId = AuthzUtil.toId('c', 'ia-hier', 'SomeContent');
    ...
    describe('#hasAnyRole()', function() {
        ...
        it('verify empty data', function(callback) {
            var userId = AuthzUtil.toId('u', 'iaa-empty', 'mrvisser');
            var resourceId = AuthzUtil.toId('c', 'iaa-empty', 'SomeContent');
        ...
        it('verify direct permission', function(callback) {
            var userId = AuthzUtil.toId('u', 'iaa-direct', 'mrvisser');
            var resourceId = AuthzUtil.toId('c', 'iaa-direct', 'SomeContent');
            AuthzAPI.updateRoles(resourceId, makeChange(userId, 'viewer'), function(err) {
                assert.ok(!err);
                AuthzAPI.hasAnyRole(userId, resourceId, function(err, hasAnyRole) {
                    assert.ok(!err);
        ...
        it('verify direct single group permission', function(callback) {
            var groupId = AuthzUtil.toId('g', 'iaa-single', 'oae-team');
            var userId = AuthzUtil.toId('u', 'iaa-single', 'mrvisser');
            var resourceId = AuthzUtil.toId('c', 'ia-single', 'SomeContent');
