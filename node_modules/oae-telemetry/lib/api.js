...
/**
 * Will set the key `telemetryUrl` to the url for this request.
 * API endpoints can override this value, so telemetry data can be grouped.
 * When the headers on the response are sent, the total duration will be
 * added to the telemetry counters.
 * This method will:
...
module.exports.request = function(req, res) {
    if (config.enabled) {
        ...
        res.on('header', function(header){
            ...
            serverTelemetry.append(req.method + '.' +  req.telemetryUrl + '.time', duration);
        });
    }
};
