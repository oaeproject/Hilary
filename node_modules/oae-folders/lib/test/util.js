 ...
 * @param  {String}             folderId        The id of the folder to which to try and create the message
 ...
 * @param  {String}             messageCreated      The timestamp of the message thad be retrieved
 * @param  {Number}             httpCode            The expected failure HTTP code of the request
 * @param  {Function}           callback            Standard callback function
 * @throws {AssertionError}                         Thrown if the request did not fail in the expected manner
 */
