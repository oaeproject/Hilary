...
module.exports.init = function(config, callback) {
    ...
    const globalAdminServer = module.exports.globalAdminServer = Server.setupServer(config.servers.globalAdminPort, config);
    const tenantServer = module.exports.tenantServer = Server.setupServer(config.servers.tenantPort, config);
    const tenantRouter = module.exports.tenantRouter = Server.setupRouter(tenantServer);
    const globalAdminRouter = module.exports.globalAdminRouter = Server.setupRouter(globalAdminServer);
 ...
 */
const registerPreShutdownHandler = module.exports.registerPreShutdownHandler = function(name, maxTimeMillis, handler) {
