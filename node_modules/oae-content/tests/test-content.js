...
describe('Content', function() {
  ...
  before(function(callback) {
    ...
    RestAPI.User.getMe(camAdminRestContext, function(err, meObj) {
      ...
      TaskQueue.unbind(PreviewConstants.MQ.TASK_REGENERATE_PREVIEWS, function(
        err,
      ) {
        assert.ok(!err);
  ...
  var checkPieceOfContent = function(
    ...
    RestAPI.Content.getContent(restCtx, contentObj.id, function(
      err,
      retrievedContent,
    ) {
      if (expectAccess) {
        ...
        assert.equal(
          retrievedContent.tenant.displayName,
          contentObj.tenant.displayName,
        );
        ...
        assert.equal(
          retrievedContent.resourceSubType,
          contentObj.resourceSubType,
        );
      ...
      RestAPI.Content.getLibrary(restCtx, libraryToCheck, null, 10, function(
        err,
        contentItems,
      ) {
                    ...
                    RestAPI.Content.getContent(
                      ...
                      function(err, retrievedContentObj) {
                        ...
                        ContentAPI.getContent(null, null, function(err) {
                          assert.equal(err.code, 400);
                          ContentAPI.getContent(null, 'invalid-id', function(
                            err,
                          ) {
                            assert.equal(err.code, 400);
                            callback();
  ...
  describe('Download content', function() {
              ...
              function(err, contentObj) {
                ...
                RestAPI.Content.download(
                  ...
                  function(err, response) {
                    ...
                    assert.ok(
                      headerKeys.indexOf('x-lighttpd-send-file') !== -1,
                    );
                          ...
                          function(err) {
                            ...
                            RestAPI.Content.download(
                              ...
                              function(err, response) {
                                ...
                                var headerKeys = _.keys(response.headers);
                                assert.ok(
                                  headerKeys.indexOf('x-accel-redirect') !== -1,
                                );
                                assert.ok(
                                  headerKeys.indexOf('x-sendfile') !== -1,
                                );
                                assert.ok(
                                  headerKeys.indexOf('x-lighttpd-send-file') !==
                                    -1,
                                );
    ...
    it('verify validation of signed urls', function(callback) {
      setUpUsers(function(contexts) {
        ...
        var tenant = TenantsAPI.getTenant(
          contexts['branden'].user.tenant.alias,
        );
  ...
  describe('Content comments', function() {
                                ...
                                RestAPI.Content.getComments(
                                  ...
                                  function(err, comments) {
                                    ...
                                    _.each(comments.results, function(comment) {
                                      ...
                                      if (
                                        comment.createdBy.id === bert.user.id
                                      ) {
                                        assert.ok(
                                          comment.createdBy.picture.small,
                                        );
                                        assert.ok(
                                          comment.createdBy.picture.medium,
                                        );
                                        assert.ok(
                                          comment.createdBy.picture.large,
                                        );
                      ...
                      function(err, comments) {
                        ...
                        RestAPI.Content.createComment(
                          ...
                          function(err, comment1) {
                            assert.ok(!err);
                            assert.equal(
                              comment1.createdBy.publicAlias,
                              'Bert Pareyn',
                            );
        ...
        RestAPI.Content.createLink(
          ...
          function(err, contentObj) {
            ...
            createComments(_.values(users), contentObj.id, 8, null, function() {
              ...
              RestAPI.Content.getComments(ctx, contentObj.id, null, 3, function(
                err,
                comments,
              ) {
                assert.ok(!err);
     ...
     */
    var testDeleteCommentPermissions = function(
      contexts,
      visibility,
      expectedDelete,
      callback,
                              ...
                              function(err, comment) {
                                ...
                                RestAPI.Content.getComments(
                                  ...
                                  function(err, comments) {
                                    ...
                                    var commentBody = TestsUtil.generateRandomText(
                                      10000,
                                    );
                                    RestAPI.Content.createComment(
                                      contexts['bert'].restContext,
     ...
     * @param  {Function}    callback                 Standard callback function
     */
    var testCommentPermissions = function(
      contexts,
      visibility,
      expectLoggedInComment,
      callback,
    ) {
                                          ...
                                          function() {
                                            ...
                                            RestAPI.Content.updateContent(
                                              ...
                                              function(err, updatedContentObj) {
                                                ...
                                                assert.ok(
                                                  updatedContentObj.isManager,
                                                );
                                                assert.equal(
                                                  updatedContentObj.createdBy
                                                    .id,
                                                  contexts['nicolaas'].user.id,
                                                );
                                                assert.ok(
          ...
          function(err, contentObj) {
            ...
            RestAPI.Content.getRevisions(
              ...
              function(err, revisions) {
                ...
                assert.equal(
                  revisions.results[0].createdBy.displayName,
                  'Nicolaas Matthijs',
                );
                assert.equal(
                  revisions.results[0].createdBy.resourceType,
                  'user',
                );
                assert.equal(
                  ...
                  '/user/' +
                    ...
                    AuthzUtil.getResourceFromId(
                      revisions.results[0].createdBy.id,
                    ).resourceId,
                );
                  ...
                  function(err, revision) {
                    ...
                    RestAPI.Content.updateFileBody(
                      ...
                      function(err, updatedContentObj, response) {
                        ...
                        assert.equal(
                          updatedContentObj.previews.status,
                          'pending',
                        );
                        assert.equal(
                          _.keys(updatedContentObj.previews).length,
                          1,
                        );
                        ...
                        assert.notEqual(
                          contentObj.size,
                          updatedContentObj.size,
                        );
                        assert.notEqual(
                          contentObj.filename,
                          updatedContentObj.filename,
                        );
                        ...
                        function(err, firstPage) {
                          ...
                          RestAPI.Content.getRevisions(
                            ...
                            function(err, secondPage) {
                              ...
                              _.each(secondPage.results, function(
                                secondPageRevision,
                              ) {
                                _.each(firstPage.results, function(
                                  firstPageRevision,
                                ) {
                                  assert.notEqual(
  ...
  describe('Content permissions', function() {
    ...
    it('verify getting content members paging', function(callback) {
      TestsUtil.generateTestUsers(camAdminRestContext, 10, function(
        err,
        users,
      ) {
        assert.ok(!err);
          ...
          function(content) {
            ...
            var roleChanges = _.object([
              [
                util.format(
                  '%s:%s',
                  targetUserInfo.user.email,
                  targetUserInfo.user.id,
                ),
                'manager',
              ],
            ]);
      ...
      TestsUtil.generateTestUsers(camAdminRestContext, 4, function(
        ...
        ContentTestUtil.assertCreateLinkSucceeds(
          ...
          function(content) {
            // Set the roles of the content item
            var roleChanges = _.object([
              [targetUserInfoA.user.email, 'manager'],
            ]);
                      ...
                      function(members) {
                        ...
                        ContentTestUtil.assertGetAllContentLibrarySucceeds(
                          ...
                          function(contentItems) {
                            assert.ok(
                              _.findWhere(contentItems, { id: content.id }),
                            );
