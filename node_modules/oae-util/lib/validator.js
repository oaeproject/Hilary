 ...
 *     * not null
 *     * At least character in length.
 *     * At most 1000 characters in length.
 *
 * Usage:
 * ```
 * var validator = new Validator();
...
Validator.prototype.isShortString = function() {
    var nrOfErrors = this.getErrorCount();
    this.notEmpty();
    // Only do the length check if the notEmpty check didn't fail.
    if (nrOfErrors === this.getErrorCount()) {
        this.len(1, 1000);
    }
};
 ...
 *     * not null
 *     * At least character in length.
 *     * At most a 100.000 characters in length.
 *
 * Usage:
 * ```
 * var validator = new Validator();
