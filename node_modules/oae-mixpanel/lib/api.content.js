 ...
 * or the current tenant, depending on if the request is performed on the
 * global admin tenant or a user tenant.
...
var getUploadedFilesFileSize = module.exports.getUploadedFilesFileSize = function(ctx, callback) {
    ...
    var options = MixPanelUtil.createExporterOptions('createdContent', alias, {
