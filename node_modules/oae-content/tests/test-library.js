...
describe('Content Libraries', function() {
  ...
  it('verify getLibrary parameter validation', function(callback) {
    TestsUtil.generateTestUsers(camAdminRestCtx, 1, function(err, users) {
      ...
      RestAPI.Content.getLibrary(simon.restContext, ' ', null, null, function(err, data) {
        ...
        RestAPI.Content.getLibrary(simon.restContext, 'invalid-user-id', null, null, function(
          err,
          data
        ) {
          assert.equal(err.code, 400);

          RestAPI.Content.getLibrary(simon.restContext, 'c:cam:bleh', null, null, function(
            err,
            data
          ) {
            assert.equal(err.code, 400);

            RestAPI.Content.getLibrary(simon.restContext, 'u:cam:bleh', null, null, function(
              err,
              data
            ) {
      ...
      RestAPI.Content.createLink(
        ...
        function(err, contentObj) {
          ...
          RestAPI.Content.deleteContent(nicolaas.restContext, contentObj.id, function(err) {
            ...
            RestAPI.Content.getLibrary(nicolaas.restContext, nicolaas.user.id, null, null, function(
              err,
              data
            ) {
              assert.ok(!err);
        ...
        function(err, contentObj) {
          ...
          RestAPI.Content.shareContent(
            ...
            function(err) {
              ...
              RestAPI.Content.getLibrary(simon.restContext, simon.user.id, null, null, function(
                err,
                data
              ) {
                assert.ok(!err);
  ...
  it('verify a piece of content can be removed after a tenant becomes private', function(callback) {
    ...
    TestsUtil.createTenantWithAdmin(tenantAliasA, tenantHostA, function(
      err,
      tenantA,
      adminRestCtxA
    ) {
      assert.ok(!err);
      TestsUtil.createTenantWithAdmin(tenantAliasB, tenantHostB, function(
        err,
        tenantB,
        adminRestCtxB
      ) {
          ...
          TestsUtil.generateTestUsers(adminRestCtxB, 1, function(err, users) {
            ...
            RestAPI.Content.createLink(
              ...
              function(err, contentObj) {
                ...
                RestAPI.Content.getLibrary(userB.restContext, userB.user.id, null, null, function(
                  err,
                  data
                ) {
                  assert.ok(!err);
    ...
    TestsUtil.generateTestUsers(camAdminRestCtx, 3, function(err, users) {
      ...
      TestsUtil.generateTestGroups(nicolaas.restContext, 3, function(group, parent, grandParent) {
        ...
        TestsUtil.generateGroupHierarchy(nicolaas.restContext, groupIds, 'manager', function() {
          ...
          RestAPI.Group.setGroupMembers(nicolaas.restContext, group.group.id, permissions, function(
            err
          ) {
            assert.ok(!err);
    ...
    RestAPI.Content.getLibrary(restCtx, libraryOwnerId, null, null, function(err, items) {
      if (!expectAccess) {
        ...
        _.each(expectedItems, function(expectedContentItem) {
          assert.ok(
            _.filter(items.results, function(content) {
  ...
  it('verify user libraries', function(callback) {
    ...
    createUserAndLibrary(camAdminRestCtx, 'private', function(
      privateUser,
      privateUserPrivateContent,
      privateUserLoggedinContent,
      privateUserPublicContent
    ) {
      createUserAndLibrary(camAdminRestCtx, 'loggedin', function(
        loggedinUser,
        loggedinUserPrivateContent,
        loggedinUserLoggedinContent,
        loggedinUserPublicContent
      ) {
        createUserAndLibrary(camAdminRestCtx, 'public', function(
          publicUser,
  ...
  it('verify group libraries', function(callback) {
    ...
    TestsUtil.generateTestUsers(camAdminRestCtx, 3, function(err, users) {
      ...
      createGroupAndLibrary(groupCreator.restContext, 'private', function(
        privateGroup,
        privateGroupPrivateContent,
        privateGroupLoggedinContent,
        privateGroupPublicContent
      ) {
        createGroupAndLibrary(groupCreator.restContext, 'loggedin', function(
          loggedinGroup,
          loggedinGroupPrivateContent,
          loggedinGroupLoggedinContent,
          loggedinGroupPublicContent
        ) {
          createGroupAndLibrary(groupCreator.restContext, 'public', function(
            publicGroup,
                                  ...
                                  function() {
                                    checkLibrary(
                                      ...
                                      function() {
                                        ...
                                        TestsUtil.generateTestUsers(gtAdminRestCtx, 1, function(
                                          err,
                                          users
                                        ) {
