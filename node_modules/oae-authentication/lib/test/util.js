...
var Cookie = require('oae-rest/node_modules/tough-cookie').Cookie;
 ...
 */
var assertFacebookLoginSucceeds = module.exports.assertFacebookLoginSucceeds = function(tenantHost, opts, callback) {
    opts = opts || {};
    ...
    RestAPI.User.getMe(restContext, function(err) {
        ...
        var cookie = null;
        if (opts.redirectUrl) {
            // cookie = request.cookie(util.format('redirectUrl=%s', encodeURIComponent(opts.redirectUrl)));
            cookie = new Cookie({
                key: 'redirectUrl',
        ...
        RestAPI.Authentication.facebookCallback(restContext, {'code': 'foo'}, function(err, body, response) {
            if (opts.redirectUrl) {
 ...
 */
var assertFacebookLoginFails = module.exports.assertFacebookLoginFails = function(tenantHost, email, reason, callback) {
