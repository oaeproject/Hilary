...
var _getResetPasswordSecret = function(req, res) {
  AuthenticationAPI.getResetPasswordSecret(
    req.ctx,
    req.params.username,
    function(err, token) {
      if (err) {
...
OAE.tenantRouter.on(
  'get',
  '/api/auth/local/reset/secret/:username',
  _getResetPasswordSecret,
);
...
var _getUserLoginIds = function(req, res) {
  AuthenticationAPI.getUserLoginIds(req.ctx, req.params.userId, function(
    err,
    loginIds,
  ) {
    if (err) {
