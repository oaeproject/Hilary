...
OAE.tenantServer.post('/api/content/:contentId/previews', function(req, res) {
    ...
    ContentAPI.setPreviewItems(req.ctx, req.params.contentId, req.body.revisionId, req.body.status, req.files, sizes, contentMetadata, previewMetadata, function(err) {
        if (err) {
            return res.send(err.code, err.msg);
        }
        res.send(201);
 ...
 */
OAE.tenantServer.get('/api/content/:id/previews/:item', function(req, res) {
    ...
    ContentAPI.verifySignedPreviewItem(req.ctx, req.params.id, req.params.item, signature, function(err, result) {
        if (err) {
            return res.send(err.code, err.msg);
        }
