 ...
 * @param  {Boolean}        [enabled]           Whether or not User Voice should be enabled. When unspecified, the configuration value will not change
 * @param  {Boolean}        [https]             Whether or not HTTPS should be used when directing users to User Voice. When unspecified, the configuration value will not change
 * @param  {String}         [subdomain]         The subdomain of the User Voice URL. When unspecified, the configuration value will not change
 * @param  {String}         [ssoKey]            The secret key configured in User Voice to use for secure encryption. When unspecified, the configuration value will not change
 * @param  {Function}       callback            Standard callback function
 * @throws {AssertionError}                     An error that occurred, if any
 */
var setConfig = module.exports.setConfig = function(adminRestContext, enabled, https, subdomain, ssoKey, callback) {
    var configUpdates = {};
...
var clearConfig = module.exports.clearConfig = function(adminRestContext, callback) {
    return setConfig(adminRestContext, false, false, '', '', callback);
};
