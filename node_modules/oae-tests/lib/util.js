...
var generateTestUsers = module.exports.generateTestUsers = function(restCtx, total, callback) {
    ...
    for (var u = 0; u < total; u++) {
        RestAPI.User.createUser(createAdminRestContext(restCtx.baseUrl), generateTestUserId('random-user'), 'password', 'John Doe', null, userCreated);
    }
};
 ...
 *                                              tenant
 */
var createAnonymousRestContext = module.exports.createAnonymousRestContext = function(baseUrl) {
 ...
 *                                              tenant
 */
var createAdminRestContext = module.exports.createAdminRestContext = function(baseUrl) {
