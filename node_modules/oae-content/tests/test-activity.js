...
describe('Content Activity', function() {
    ...
    describe('Routes', function() {
        ...
        it('verify routing to content members', function(callback) {
            ...
            var opts = {'email': 'me@mrvisser.ca'};

            RestAPI.User.createUser(camAdminRestContext, jackUsername, 'password', 'Jack McJackerson', opts, function(err, jack) {
                assert.ok(!err);
                var jackCtx = TestsUtil.createTenantRestContext(global.oaeTests.tenants.cam.host, jackUsername, 'password');

                RestAPI.User.createUser(camAdminRestContext, janeUsername, 'password', 'Jane', opts, function(err, jane) {
                    assert.ok(!err);

                    RestAPI.User.createUser(camAdminRestContext, managerGroupMemberUsername, 'password', 'Jane', opts, function(err, managerGroupMember) {
                        assert.ok(!err);
