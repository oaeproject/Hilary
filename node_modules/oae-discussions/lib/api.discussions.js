 ...
 */
var createDiscussion = (module.exports.createDiscussion = function(
  ctx,
  displayName,
  description,
  visibility,
  ...
  visibility =
    visibility ||
    DiscussionsConfig.getValue(ctx.tenant().alias, 'visibility', 'discussion');
  roles = roles || {};
  opts = opts || {};
  ...
  _.each(roles, function(role, memberId) {
    validator
      .check(role, {
        code: 400,
        msg:
          'The role: ' + role + ' is not a valid member role for a discussion',
      })
 ...
 */
var updateDiscussion = (module.exports.updateDiscussion = function(
  ctx,
  discussionId,
  profileFields,
  callback,
    ...
    if (field === 'visibility') {
      validator
        .check(value, {
          code: 400,
          msg:
            'An invalid visibility was specified. Must be one of: ' +
            allVisibilities.join(', '),
        })
        .isIn(allVisibilities);
    } else if (field === 'displayName') {
      validator
        .check(value, { code: 400, msg: 'A display name cannot be empty' })
        .notEmpty();
      validator
        .check(value, {
          code: 400,
      ...
      validator
        .check(value, { code: 400, msg: 'A description cannot be empty' })
        .notEmpty();
      validator
        .check(value, {
          code: 400,
  ...
  _getDiscussion(discussionId, function(err, discussion) {
    ...
    AuthzPermissions.canManage(ctx, discussion, function(err) {
      ...
      DiscussionsDAO.updateDiscussion(discussion, profileFields, function(
        err,
        updatedDiscussion,
      ) {
        if (err) {
 ...
 * @param  {Object}     callback.err        An error that occurred, if any
 */
var deleteDiscussion = (module.exports.deleteDiscussion = function(
  ctx,
  discussionId,
  callback,
) {
 ...
 */
var getDiscussionsLibrary = (module.exports.getDiscussionsLibrary = function(
  ctx,
  principalId,
  start,
  limit,
    ...
    LibraryAPI.Authz.resolveTargetLibraryAccess(
      ...
      function(err, hasAccess, visibility) {
        ...
        LibraryAPI.Index.list(
          ...
          function(err, entries, nextToken) {
            if (err) {
              return callback(err);
            }
            ...
            DiscussionsDAO.getDiscussionsById(discussionIds, null, function(
              err,
              discussions,
            ) {
              if (err) {
 ...
 */
var getDiscussion = (module.exports.getDiscussion = function(
  ctx,
  discussionId,
  callback,
) {
 ...
 */
var getFullDiscussionProfile = (module.exports.getFullDiscussionProfile = function(
  ctx,
  discussionId,
  callback,
) {
  ...
  _getDiscussion(discussionId, function(err, discussion) {
    ...
    AuthzPermissions.resolveEffectivePermissions(ctx, discussion, function(
      err,
      permissions,
    ) {
      if (err) {
        ...
        return callback({
          code: 401,
          msg: 'You are not authorized to view this discussion',
        });
      }
      ...
      if (ctx.user()) {
        ...
        discussion.signature = Signature.createExpiringResourceSignature(
          ctx,
          discussionId,
        );
      }
      ...
      PrincipalsUtil.getPrincipal(ctx, discussion.createdBy, function(
        err,
        creator,
      ) {
        if (err) {
 ...
 */
var getDiscussionMembers = (module.exports.getDiscussionMembers = function(
  ctx,
  discussionId,
  start,
  limit,
  ...
  getDiscussion(ctx, discussionId, function(err, discussion) {
    ...
    AuthzAPI.getAuthzMembers(discussionId, start, limit, function(
      err,
      memberRoles,
      nextToken,
    ) {
 ...
 */
var getDiscussionInvitations = (module.exports.getDiscussionInvitations = function(
  ctx,
  discussionId,
  callback,
) {
 ...
 * @param  {Object}         callback.err    An error that occurred, if any
 */
var resendDiscussionInvitation = (module.exports.resendDiscussionInvitation = function(
  ctx,
  discussionId,
  email,
  callback,
 ...
 * @param  {Object}     callback.err        An error that occurred, if any
 */
var shareDiscussion = (module.exports.shareDiscussion = function(
  ctx,
  discussionId,
  principalIds,
  callback,
 ...
 */
var setDiscussionPermissions = (module.exports.setDiscussionPermissions = function(
  ctx,
  discussionId,
  changes,
  callback,
  ...
  validator
    .check(null, {
      code: 401,
      msg:
        'You have to be logged in to be able to change discussion permissions',
    })
    .isLoggedInUser(ctx);
  validator
    .check(discussionId, {
  ...
  _getDiscussion(discussionId, function(err, discussion) {
    ...
    ResourceActions.setRoles(ctx, discussion, changes, function(
      err,
      memberChangeInfo,
    ) {
      if (err) {
 ...
 * @param  {Object}     callback.err    An error that occurred, if any
 */
var removeDiscussionFromLibrary = (module.exports.removeDiscussionFromLibrary = function(
  ctx,
  libraryOwnerId,
  discussionId,
  callback,
  ...
  _getDiscussion(discussionId, function(err, discussion) {
    ...
    PrincipalsDAO.getPrincipal(libraryOwnerId, function(err, principal) {
      ...
      AuthzPermissions.canRemoveRole(ctx, principal, discussion, function(
        err,
        memberChangeInfo,
      ) {
        if (err) {
        ...
        AuthzAPI.updateRoles(discussionId, memberChangeInfo.changes, function(
          err,
        ) {
          if (err) {
            return callback(err);
...
var createMessage = (module.exports.createMessage = function(
  ...
  validator
    ...
    .isResourceId();
  validator
    .check(body, { code: 400, msg: 'A discussion body must be provided' })
    .notEmpty();
  validator
    .check(body, {
      code: 400,
  ...
  _getDiscussion(discussionId, function(err, discussion) {
    ...
    MessageBoxAPI.getMessages(
      ...
      function(err, messages) {
        ...
        AuthzPermissions.canManageMessage(ctx, discussion, message, function(
          err,
        ) {
          if (err) {
            return callback(err);
...
var _getDiscussion = function(discussionId, callback) {
  DiscussionsDAO.getDiscussion(discussionId, function(err, discussion) {
    if (err) {
      ...
      return callback({
        code: 404,
        msg: 'Could not find discussion: ' + discussionId,
      });
    }
