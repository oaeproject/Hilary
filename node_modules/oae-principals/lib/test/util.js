 ...
 * @throws {AssertionError}                     Thrown if there is an issue deleting the groups or any of the assertions fail
 */
var assertDeleteUsersSucceeds = module.exports.assertDeleteUsersSucceeds = function(ctx, deletedUser, userArchive, callback) {
    ctx.user = function () { 
 ...
 * @throws {AssertionError}                     Thrown if the request failed
 */
var assertDoesNotFollow = module.exports.assertDoesNotFollow = function(followerId, followedId, callback) {
    FollowingDAO.getFollowers(followedId, null, null, function(err, followers) {
        if (err) {
            return callback(err);
        }
        var follower = _.find(followers, function(follower) { return follower === followerId; });
        assert.ok(!follower);
        return callback();
    });
};
