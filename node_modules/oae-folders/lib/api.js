...
var createFolder = module.exports.createFolder = function(ctx, displayName, description, visibility, members, callback) {
    ...
    validator.check(visibility, {'code': 400, 'msg': 'An invalid folder visibility option has been provided. Must be one of: ' + allVisibilities.join(', ')}).isValidVisibility();
...
var updateFolder = module.exports.updateFolder = function(ctx, folderId, updates, callback) {
    ...
    if (updates.visibility) {
        validator.check(updates.visibility, {'code': 400, 'msg': 'An invalid folder visibility option has been provided. Must be one of: ' + allVisibilities.join(', ')}).isValidVisibility();
    }
