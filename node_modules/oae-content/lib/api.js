                ...
                getComments(ctx, contentId, comment.created, 1, function(err, comments) {
                    ...
                    if (comments.length > 0 && comments[0].replyTo === commentId) {
                        ...
                        Cassandra.runQuery(q, [true, commentId], function(err) {
                            var deletedComment = new Comment(comment.commentId, null, null, null, comment.created, comment.level, comment.replyTo, false);
                        ...
                        Cassandra.runBatchQuery(queries, 'QUORUM', function(err) {
                            ...
                            var deletedComment = new Comment(comment.commentId, null, contentId, ctx.user(), comment.created, 0, comment.replyTo, true);
