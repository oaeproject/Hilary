...
var _setRole = function(principalUuid, resourceUuid, role, callback) {
    Cassandra.runQuery('UPDATE AuthzRoles USING CONSISTENCY QUORUM SET ? = ? WHERE principalId = ?', [resourceUuid, role, principalUuid], callback);
}
...
var _removeRole = function(principalUuid, resourceUuid, callback) {
    Cassandra.runQuery('DELETE ? FROM AuthzRoles USING CONSISTENCY QUORUM WHERE principalId = ?', [resourceUuid, principalUuid], callback);
}
