...
describe('Authentication', function() {
    ...
    var verifyEndpointIsDisabled = function(strategyName, method, callback) {
        ...
        var update = {};
        update['oae-authentication/' + strategyName + '/enabled'] = true;
        ConfigTestUtil.updateConfigAndWait(globalAdminRestContext, 'localhost', update, function(err) {
            assert.ok(!err);
        });
        ...
        AuthenticationAPI.once(AuthenticationConstants.events.REFRESHED_STRATEGIES, function(tenant) {
            ...
            request(options, function (err, response, body) {
                ...
                // Now disable it
                update['oae-authentication/' + strategyName + '/enabled'] = false;
                ConfigTestUtil.updateConfigAndWait(globalAdminRestContext, 'localhost', update, function() {
                    assert.ok(!err);
                });
    ...
    var verifyForward = function(strategy, host, callback) {
        ...
        // Enable strategy
        var update = {};
        update['oae-authentication/' + strategy + '/enabled'] = true;
        ...
        AuthenticationAPI.once(AuthenticationConstants.events.REFRESHED_STRATEGIES, function(tenant) {
            request(options, function(err, res, body) {
                ...
                update['oae-authentication/' + strategy + '/enabled'] = strategyStatus;
                ConfigTestUtil.updateConfigAndWait(globalAdminRestContext, null, update, function(err) {
                    assert.ok(!err);
                });
                AuthenticationAPI.once(AuthenticationConstants.events.REFRESHED_STRATEGIES, function(tenant) {
