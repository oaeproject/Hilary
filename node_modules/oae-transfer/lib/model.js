 ...
 * @param  {Date}       completed           Completion date of the transfer
 */
let Transfer = module.exports.Transfer = function (originalUserId, code, originalEmail, targetEmail, targetUserId, state, completed) {
    var that = {};
