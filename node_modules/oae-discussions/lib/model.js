 ...
 *
 * @param  {Object}         tenant          An object that represents the tenant to which this discussion belongs
 * @param  {String}         id              The id of the discussion
 * @param  {String}         createdBy       The id of the user who created the discussion
 * @param  {String}         displayName     The displayName of the discussion
 ...
 * @param  {String|Number}  created         The timestamp (millis since the epoch) that the discussion was created
 * @param  {String|Number}  lastModified    The timestamp (millis since the epoch) that the discussion was last modified (or received the last message)
 * @return {Discussion}                     The discussion with the data provided
 */
var Discussion = module.exports.Discussion = function(tenant, id, createdBy, displayName, description, visibility, created, lastModified) {
    ...
    that.profilePath = '/discussion/' + tenant.alias + '/' + resourceId;
