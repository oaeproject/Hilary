 ...
 * @param  {Function}       callback                Standard callback function
 * @param  {Object}         callback.err            An error that occurred, if any
 * @param  {Object}         callback.transfer       User's transfer
 */
...
/**
 * Get folder or group by its group id.
 * 
 * @param {Object} ctx              Context
 ...
 * @api private
 */
 var getFolderOrGroupByGroupId = module.exports.getFolderOrGroupByGroupId = function (ctx, resourceId, callback) {
...
var _getTTLTransfer = function (ctx, callback) {
    ...
    Cassandra.runQuery('SELECT "value" FROM "Config" WHERE "tenantAlias" = ? AND "configKey" = ?', [ctx.tenant().alias, configkey], function(err, result) {
        ...
        if (_.isEmpty(result)) {
            return callback(null, defaultTime * SECONDS_IN_A_DAY);
