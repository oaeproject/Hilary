...
describe('Notifications', function() {
    ...
    describe('Notification Stream', function() {
         ...
         */
        it('verify anonymous cannot get a notification stream', function(callback) {
         ...
         */
        it('verify a notification is never sent to the actor of an activity', function(callback) {
         ...
         */
        it('verify a notification is sent when creating content with a user member', function(callback) {
            TestsUtil.generateTestUsers(camAdminRestContext, 2, function(err, createdUsers) {
                assert.ok(!err);
                var mrvisser = createdUsers[_.keys(createdUsers)[0]];
                var simong = createdUsers[_.keys(createdUsers)[1]];
        ...
        it('verify unread notifications count', function(callback) {
            TestsUtil.generateTestUsers(camAdminRestContext, 2, function(err, createdUsers, mrvisser, simong) {
                assert.ok(!err);
                ...
                RestAPI.User.getMe(simong.restContext, function(err, me) {
                    ...
                    RestAPI.Content.createLink(mrvisser.restContext, 'Google', 'Google', 'private', 'http://www.google.ca', [], [simong.user.id], [], function(err, link0) {
                        assert.ok(!err);
                        ActivityTestsUtil.collectAndGetNotificationStream(simong.restContext, null, function(err, notificationStream) {
                            assert.ok(!err);
                            ...
                            RestAPI.User.getMe(simong.restContext, function(err, me) {
                                ...
                                RestAPI.Content.createLink(mrvisser.restContext, 'Google', 'Google', 'private', 'http://www.google.ca', [], [simong.user.id], [], function(err, link1) {
                                    assert.ok(!err);
                                    ActivityTestsUtil.collectAndGetNotificationStream(simong.restContext, null, function(err, notificationStream) {
                                        assert.ok(!err);
                                        ...
                                        RestAPI.User.getMe(simong.restContext, function(err, me) {
                                            ...
                                            RestAPI.Activity.markNotificationsRead(simong.restContext, function(err) {
                                                ...
                                                RestAPI.User.getMe(simong.restContext, function(err, me) {
                                                    ...
                                                    RestAPI.Content.createLink(mrvisser.restContext, 'Google', 'Google', 'private', 'http://www.google.ca', [], [simong.user.id], [], function(err, link2) {
                                                        assert.ok(!err);
                                                        RestAPI.Content.createLink(mrvisser.restContext, 'Google', 'Google', 'private', 'http://www.google.ca', [], [simong.user.id], [], function(err, link3) {
                                                            assert.ok(!err);
                                                            ActivityTestsUtil.collectAndGetNotificationStream(simong.restContext, null, function(err, notificationStream) {
                                                                assert.ok(!err);
                                                                ...
                                                                var linkIdsInFeed = _.pluck(notificationStream.items[0].object['oae:collection'], ActivityConstants.properties.OAE_ID);
    ...
    describe('Mark Notifications Read', function() {
         ...
         */
        it('verify anonymous cannot mark a notification stream as read', function(callback) {
         ...
         */
        it('verify toggling of notifications read', function(callback) {
            TestsUtil.generateTestUsers(camAdminRestContext, 2, function(err, createdUsers) {
                assert.ok(!err);
                var mrvisser = createdUsers[_.keys(createdUsers)[0]];
                var simong = createdUsers[_.keys(createdUsers)[1]];
                                            ...
                                            RestAPI.Content.createLink(mrvisser.restContext, 'Google', 'Google', 'private', 'http://www.google.ca', [], [simong.user.id], [], function(err, thirdContentObj) {
                                                ...
                                                ActivityTestsUtil.collectAndGetNotificationStream(simong.restContext, null, function(err, notificationStream) {
                                                    ...
                                                    RestAPI.User.getMe(simong.restContext, function(err, me) {
                                                        ...
                                                        ActivityTestsUtil.markNotificationsAsRead(simong.restContext, function(result) {
                                                            RestAPI.Content.createLink(mrvisser.restContext, 'Google', 'Google', 'private', 'http://www.google.ca', [], [simong.user.id], [], function(err, fourthContentObj) {
                                                                assert.ok(!err);

                                                                RestAPI.Discussions.createDiscussion(mrvisser.restContext, 'Google', 'Google', 'private', [], [simong.user.id], function(err, discussion) {
                                                                    assert.ok(!err);

                                                                    // Ensure the notifications get delivered but don't aggregate with the older "marked as read" item
                                                                    ActivityTestsUtil.collectAndGetNotificationStream(simong.restContext, null, function(err, notificationStream) {
                                                                        assert.ok(!err);
                                                                        assert.equal(notificationStream.items.length, 4);
                                                                        ActivityTestsUtil.assertActivity(notificationStream.items[0], 'discussion-create', 'create', mrvisser.user.id, discussion.id);
                                                                        ActivityTestsUtil.assertActivity(notificationStream.items[1], 'content-create', 'create', mrvisser.user.id, fourthContentObj.id, simong.user.id);
