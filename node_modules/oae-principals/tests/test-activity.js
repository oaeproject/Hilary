                            ...
                            RestAPI.Group.setGroupMembers(camAdminRestContext, managerGroup.id, membership, function(err) {
                                ...
                                RestAPI.Group.createGroup(camAdminRestContext, targetGroupAlias, targetGroupAlias, targetGroupAlias, 'public', 'yes', [managerGroup.id], [memberGroup.id], function(err, targetGroup) {
                                    ...
                                    RestAPI.Group.setGroupMembers(jackCtx, targetGroup.id, membership, function(err) {
                                        ...
                                        RestAPI.Group.updateGroup(camAdminRestContext, targetGroup.id, {'displayName': 'Ha ha I make change'}, function(err) {
                                            assert.ok(!err);
                            ...
                            RestAPI.Group.createGroup(camAdminRestContext, groupAlias, groupAlias, groupAlias, 'public', 'no', [publicUser.id], [], function(err, group) {
                                ...
                                RestAPI.Group.uploadPicture(camAdminRestContext, group.id, getPictureStream, sizes, function(err) {
                                    ...
                                    RestAPI.Group.setGroupMembers(publicUserRestContext, group.id, memberships, function(err) {
                                        ...
                                        RestAPI.Activity.getActivityStream(publicUserRestContext, publicUser.id, null, function(err, activityStream) {
                                            assert.ok(!err);
                    ...
                    RestAPI.User.uploadPicture(camAdminRestContext, group.id, getPictureStream, sizes, function(err) {
                        ...
                        RestAPI.Content.createLink(userRestContext, 'Google', 'Google', 'public', 'http://www.google.ca', [], [], function(err, link) {
                            ...
                            RestAPI.Content.shareContent(camAdminRestContext, link.contentId, [group.id], function(err) {
                                ...
                                RestAPI.Activity.getActivityStream(camAdminRestContext, user.id, null, function(err, activityStream) {
                                    assert.ok(!err);
                ...
                RestAPI.User.createUser(camAdminRestContext, janeUsername, 'password', 'Jane', null, function(err, jane) {
                    ...
                    RestAPI.User.createUser(camAdminRestContext, brandenUsername, 'password', 'Branden', null, function(err, branden) {
                        ...
                        RestAPI.Group.createGroup(jackCtx, groupAlias, groupAlias, groupAlias, 'public', 'yes', [], [], function(err, group) {
                            ...
                            RestAPI.Group.setGroupMembers(janeCtx, group.id, membership, function(err) {
                                assert.ok(!err);

                                // Join as branden
                                membership = {};
                                membership[branden.id] = 'member';
                                RestAPI.Group.setGroupMembers(brandenCtx, group.id, membership, function(err) {
                                    assert.ok(!err);
