...
var ensureSchema = function(callback) {
    Cassandra.createColumnFamily('Tenant', 'CREATE COLUMNFAMILY Tenant (port text PRIMARY KEY, alias text, name text, description text, baseUrl text, active boolean, deleted boolean)', callback);
};
