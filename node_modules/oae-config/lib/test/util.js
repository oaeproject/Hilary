 ...
 */
var updateConfigAndWait = module.exports.updateConfigAndWait = function(restCtx, tenantAlias, update, callback) {
    ...
    RestAPI.Config.updateConfig(restCtx, tenantAlias, update, function(err) {
        if (err) {
