 ...
 * @param  {Function}               options.producer                                    The implementation of the entity producer (see comment summary for more information)
 ...
 * @param  {Function}               options.transformer                                 The implementation of the entity transformer (see comment summary for more information)
 ...
 * @param  {Function}               options.propagation                                 The function that determines for an entity how it should be propagated among potential routes
