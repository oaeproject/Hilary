...
(function(){
            ...
            $.ajax({
                ...
                success: function() {
                    $.each(data, function(i, item){
                        $('#' + item.option.replace(/\//g, '\\/')).attr('data-originalvalue', item.value);
                    });
                    showSuccess({
    ...
    /**
     * Gets the data for configurable modules
     * @param {Function} callback Callback function executed after the request completes. Passes through the returned data
     */
    ...
    /**
     * TODO: write REST endpoint that gives back available tests
     */
    ...
    var initializeTests = function() {
        getTests(function(availableTests) {
            renderTemplate('admin_tests_template', {
                'modules': availableTests,
                'context': context
            }, $('#admin_tests_container'));
        });
    };

    var showLogin = function() {
        renderTemplate('admin_login_template', {}, $('#admin_login_container'));
    };
