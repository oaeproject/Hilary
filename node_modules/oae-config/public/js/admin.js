                    ...
                    static: [
                        {
                            ...
                            children: [
                                {
                                    data:  "__MSG__PRECLINICAL_MEDICINE__",
                                    attributes: {
                                        'id': 'preclinicalmedicine'
                                    }
                                },
                                {
                                    data: "__MSG__PRECLINICAL_DENTISTRY__",
                                    attributes: {
                                        'id': 'preclinicaldentistry'
                                    }
                                },
                                {
                                    data: "__MSG__CLININCAL_MEDICINE__",
                                    attributes: {
                                        'id': 'clinicalmedicine'
                                    }
                                },
                                {
                                    data: "__MSG__CLINICAL_DENTISTRY__",
                                    attributes: {
                                        'id': 'clinicaldentistry'
                                    }
                                },
                                {
                                    data: "__MSG__MEDICINE_AND_DENTISTRY_OTHERS__",
                                    attributes: {
