    ...
    describe('Updates', function() {
      ...
      it('verify setting group members updates the group members library', function(callback) {
        TestsUtil.generateTestUsers(camAdminRestContext, 2, function(
          ...
          assert.ok(!err);
          TestsUtil.generateTestGroups(user1.restContext, 2, function(
            group,
            group2,
          ) {
      ...
      it('verify that ranking gives precedence to picture visibility, profile visibility and role, respectively', function(callback) {
        TestsUtil.setupMultiTenantPrivacyEntities(function(tenant1, tenant2) {
          PrincipalsTestUtil.assertUpdateGroupSucceeds(
            ...
            { joinable: 'yes' },
            function() {
              TestsUtil.generateTestUsers(tenant1.adminRestContext, 3, function(
                err,
                users,
                publicWithPicture,
                loggedinWithPicture,
