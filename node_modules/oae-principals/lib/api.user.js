...
var exportData = module.exports.exportData = function(ctx, userId, exportType, callback) {
    ...
    PrincipalsDAO.getPrincipal(userId, function(err, principal) {
        ...
        personalData.personalDetails = 'Personal id : ' + principal.id
                    + '\nPersonal name : ' + principal.displayName
                    + '\nPersonal e-mail : ' + principal.email; 

        // Get profile picture if exist
        _extractProfilePicture(ctx, principal, personalData, function(err, personalData) {
            if (err) {
                return callback(err);
            }

            // Get personal data 
            _exportContentData(ctx, userId, exportType, personalData, function(err, zipFile) {
                if (err) {
                    return callback(err);
                }
 ...
 * @param  {Objetc}     callback.personalData       Object contain all the data
 */
var _extractProfilePicture = function(ctx, principal, personalData, callback) {
    if (_.isEmpty(principal.picture)) {
        ...
        personalData.profilePicture = {'path': path + '/' + pathLargePicture[1], 'imageName': imageName};
...
var _collabdocToTxt = function(ctx, collabdocs, personalData, callback) {
    ...
    async.mapSeries(collabdocs, function(collabdoc, callback) {
...
var _linkToTxt = function(ctx, links, personalData, callback) {
    ...
    async.mapSeries(links, function(link, callback) {
...
var _discussionToTxt = function(ctx, discussions, personalData, callback) {
    ...
    async.mapSeries(discussions, function(discussion, callback) {
...
_objectToZipFile = function(personalData, callback) {
    ...
    const compressUploadedData = (callback) => {
        if (personalData.upload) {
            ...
            async.mapSeries(personalData.upload, function(uploadedFile, callback) {
    ...
    const compressCollabDocs = (callback) => {
        if (personalData.collabdoc) {
            ...
            async.mapSeries(personalData.collabdoc, function(collabdoc, callback) {
    ...
    const compressLinks = (callback) => {
        if (personalData.link) {
            ...
            async.mapSeries(personalData.link, function(link, callback) {
    ...
    const compressMeetings = (callback) => {
        if (personalData.meeting) {
            ...
            async.mapSeries(personalData.meeting, function(meeting, callback) {
    ...
    const compressDiscussions = (callback) => {
        if (personalData.discussion) {
            ...
            async.mapSeries(personalData.discussion, function(discussion, callback) {
