...
var ensureSchema = function(callback) {
    ...
    Cassandra.createColumnFamily('Principals', 'CREATE COLUMNFAMILY Principals (principalId text PRIMARY KEY, alias text, tenant text, visibility text);', callback);
};
...
var ensureSearchTypes = function(callback) {
    ...
    var groupSchema = _.extend(basePrincipalSchema, { 'description': { 'type': 'string', 'store': 'yes', 'index': 'no' }});
    ...
    SearchAPI.putMapping('group', groupSchema, function(err) {
        ...
        SearchAPI.putMapping('user', basePrincipalSchema, callback);
    });
}
