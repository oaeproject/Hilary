...
var SearchAPI = require('oae-search/lib/api');
...
module.exports = function(config, callback) {
    ensureSchema(function(err) {
        ...
        SearchAPI.registerAndCreateChildSearchDocumentMapping(SearchConstants.resourceMembersMappingName, require('./search/resourceMembersSchema'), function(err) {
            if (err) {
                return callback(err);
            }

            return SearchAPI.registerAndCreateChildSearchDocumentMapping(SearchConstants.resourceMembershipsMappingName, require('./search/resourceMembershipsSchema'), callback);
        });
    });
};
