...
module.exports.ensureSchema = function(callback) {
    ...
    Cassandra.createColumnFamilies({
        'Content': "create columnfamily Content (contentId text PRIMARY KEY, tenant text, visibility text, title text, description text, contentType text, lastModified text);",
        'ContentMembers': "create columnfamily ContentMembers (contentId text PRIMARY KEY);",
        'LibraryByPrinciple': "create columnfamily LibraryByPrinciple (principalId text PRIMARY KEY);",
    }, callback);
};
...
module.exports.dropSchema = function(callback) {
    callback = callback || function() {};
    Cassandra.dropColumnFamilies(['Content', 'ContentMembers', 'LibraryByPrinciple'], callback);
};