...
describe('Content', function() {
    ...
    describe('Content comments', function() {
         ...
         *
         * @param    {Object[]}    contexts       Array of user content objects
         ...
         * @param    {String}      [replyTo]      The ID of the content to reply to
         * @param    {Function}    callback       Standard callback function executed when all checks have finished
         */
        var createComments = function(contexts, contentId, numComments, replyTo, callback) {
             ...
             * @return   {Context}    REST Context object for a user
             */
            ...
            var createComment = function() {
                if (replyTo) {
                    RestAPI.Content.createReply(getRandomCommenter(), contentId, replyTo, getRandomComment(), function(err) {
                        commentCreated(err);
                    });
                } else {
                    RestAPI.Content.createComment(getRandomCommenter(), contentId, getRandomComment(), function(err) {
                        commentCreated(err);
                    });
                }
            };
                ...
                RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 1', 'Test content description 1', 'public', 'http://www.sakaiproject.org/',  [], [], function(err, contentObj) {
                    ...
                    RestAPI.Content.getContent(contexts['bert'].restContext, contentObj.contentId, function(err, retrievedContentObj) {
                        ...
                        createComments(contexts, contentObj.contentId, 10, null, function() {
                            ...
                            RestAPI.Content.createComment(contexts['bert'].restContext, contentObj.contentId, 'This comment should be on top of the list', function(err) {

                                // Get the comments and verify that the item on top of the list is the correct one
                                RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, '', 10, function(err, comments) {
                                    assert.ok(!err);
                                    ...
                                    RestAPI.Content.createComment(contexts['bert'].restContext, null, 'This comment should be on top of the list', function(err) {
                                        assert.ok(err);
                                        assert.equal(err.code, 400);

                                        // Try to create a comment without a comment
                                        RestAPI.Content.createComment(contexts['bert'].restContext, contentObj.contentId, null, function(err) {
                                            assert.ok(err);
                                            assert.equal(err.code, 400);

                                            // Try to create a comment as an anonymous user
                                            RestAPI.Content.createComment(anonymousRestContext, contentObj.contentId, 'This comment should be on top of the list', function(err) {
                                                assert.ok(err);
            ...
            setUpUsers(function(contexts) {
                ...
                RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 1', 'Test content description 1', 'public', 'http://www.sakaiproject.org/',  [], [], function(err, contentObj) {
                    ...
                    RestAPI.Content.getContent(contexts['bert'].restContext, contentObj.contentId, function(err, retrievedContentObj) {
                        ...
                        RestAPI.Content.createComment(contexts['bert'].restContext, contentObj.contentId, 'This comment should be second in the list', function(err) {
                            assert.ok(!err);
                            ...
                            RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, '', 10, function(err, comments) {
                                ...
                                RestAPI.Content.createReply(contexts['bert'].restContext, contentObj.contentId, comments.results[0].commentId, 'Reply to second comment in the list', function(err) {
                                    assert.ok(!err);
                                    ...
                                    RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, '', 10, function(err, comments) {
                                        ...
                                        RestAPI.Content.createReply(contexts['bert'].restContext, contentObj.contentId, comments.results[1].commentId, 'A reply to the reply on the second comment in the list', function(err) {
                                            assert.ok(!err);

                                            // Add a second comment to the content item
                                            RestAPI.Content.createComment(contexts['bert'].restContext, contentObj.contentId, 'This comment should be first in the list', function(err) {
                                                assert.ok(!err);
                                                ...
                                                RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, '', 10, function(err, comments) {
                                                    ...
                                                    RestAPI.Content.createReply(contexts['bert'].restContext, null, '1231654351', 'This is an updated comment', function(err) {
                                                        assert.ok(err);

                                                        // Try to post a reply without a creation date of the comment to update
                                                        RestAPI.Content.createReply(contexts['bert'].restContext, 'contentId', null, 'This is an updated comment', function(err) {
                                                            assert.ok(err);

                                                            // Try to post a reply without a comment
                                                            RestAPI.Content.createReply(contexts['bert'].restContext, 'contentId', '1231654351', null, function(err) {
                                                                assert.ok(err);
        ...
        /**
         * Test that will retrieve a comment on content
         */
        it('verify retrieve comment', function(callback) {
            setUpUsers(function(contexts) {
                // Create a piece of content
                RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 1', 'Test content description 1', 'public', 'http://www.sakaiproject.org/',  [], [], function(err, contentObj) {
                    assert.ok(!err);
            ...
            setUpUsers(function(contexts) {
                ...
                RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 1', 'Test content description 1', 'public', 'http://www.sakaiproject.org/',  [], [], function(err, contentObj) {
                    ...
                    RestAPI.Content.getContent(contexts['bert'].restContext, contentObj.contentId, function(err, retrievedContentObj) {
                        ...
                        // Create a comment
                        RestAPI.Content.createComment(contexts['bert'].restContext, contentObj.contentId, 'This comment will be deleted.', function(err) {
                            assert.ok(!err);
                            ...
                            RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, '', 10, function(err, comments) {
                                ...
                                RestAPI.Content.createReply(contexts['bert'].restContext, contentObj.contentId, comments.results[0].commentId, 'This is a reply on the comment that will be deleted.', function(err) {
                                    assert.ok(!err);
                                    ...
                                    RestAPI.Content.deleteComment(contexts['bert'].restContext, contentObj.contentId, comments.results[0].commentId, function(err) {
                                        ...
                                        RestAPI.Content.getComments(contexts['bert'].restContext, contentObj.contentId, '', 10, function(err, comments) {
                                            ...
                                            RestAPI.Content.createReply(contexts['bert'].restContext, contentObj.contentId, comments.results[1].commentId, 'This is a reply on the reply on a comment that will be deleted.', function(err) {
                                                assert.ok(!err);
        ...
        /**
         * Test that will verify delete access to content and comments
         */
        it('verify delete comment access', function(callback) {
            setUpUsers(function(contexts) {

                var bert = contexts['bert'].restContext;
                var nicolaas = contexts['nicolaas'].restContext;
                var simon = contexts['simon'].restContext;

                var checkAccess = function(linkContext, commentContext, deleteContext, visibility, managers, members, _callback) {
                    RestAPI.Content.createLink(linkContext, 'Test Content', 'Test content description', visibility, 'http://www.sakaiproject.org/', [], members, function(err, contentObj) {
                        assert.ok(!err);
                        assert.ok(contentObj.contentId);

                        RestAPI.Content.createComment(commentContext, contentObj.contentId, 'Comment to check access', function(err) {
                            assert.ok(!err);

                            RestAPI.Content.getComments(linkContext, contentObj.contentId, '', 10, function(err, comments) {
                                assert.ok(!err);

                                RestAPI.Content.deleteComment(deleteContext, contentObj.contentId, comments.results[0].commentId, function(err) {
                                    _callback(err);
                                });
                            });
                        });
                ...
                // Delete own comment as manager on (private) piece of content (--> success)
                checkAccess(bert, bert, bert, 'private', [], [], function(err) {
                    assert.ok(!err);
                    // Delete other's comment as manager on (private) piece of content (--> success)
                    checkAccess(bert, simon, bert, 'private', [], [contexts['simon'].user.id], function(err) {
                        assert.ok(!err);
                        // Delete own comment as member on (private) piece of content (--> success)
                        checkAccess(bert, simon, simon, 'private', [], [contexts['simon'].user.id], function(err) {
                            assert.ok(!err);
                            // Delete other's comment as member on (private) piece of content (--> fail)
                            checkAccess(bert, bert, simon, 'private', [], [contexts['simon'].user.id], function(err) {
                                assert.ok(err);
                                // Delete comment as anonymous on (private) piece of content (--> fail)
                                checkAccess(bert, bert, anonymousRestContext, 'private', [], [], function(err) {
                                    assert.ok(err);
                                    // Delete own comment as manager on (loggedin) piece of content (--> success)
                                    checkAccess(bert, bert, bert, 'loggedin', [], [], function(err) {
                                        assert.ok(!err);
                                        // Delete other's comment as manager on (loggedin) piece of content (--> success)
                                        checkAccess(bert, simon, bert, 'loggedin', [], [contexts['simon'].user.id], function(err) {
                                            assert.ok(!err);
                                            // Delete own comment as member on (loggedin) piece of content (--> success)
                                            checkAccess(bert, simon, simon, 'loggedin', [], [contexts['simon'].user.id], function(err) {
                                                assert.ok(!err);
                                                // Delete other's comment as member on (loggedin) piece of content (--> fail)
                                                checkAccess(bert, bert, simon, 'loggedin', [], [contexts['simon'].user.id], function(err) {
                                                    assert.ok(err);
                                                    // Delete own comment as logged in on (loggedin) piece of content (--> success)
                                                    checkAccess(bert, simon, simon, 'loggedin', [], [], function(err) {
                                                        assert.ok(!err);
                                                        // Delete comment as anonymous on (loggedin) piece of content (--> fail)
                                                        checkAccess(bert, bert, anonymousRestContext, 'loggedin', [], [], function(err) {
                                                            assert.ok(err);
                                                            // Delete own comment as manager on (public) piece of content (--> success)
                                                            checkAccess(bert, bert, bert, 'public', [], [], function(err) {
                                                                assert.ok(!err);
                                                                // Delete other's comment as manager on (public) piece of content (--> success)
                                                                checkAccess(bert, simon, bert, 'public', [], [contexts['simon'].user.id], function(err) {
                                                                    assert.ok(!err);
                                                                    // Delete own comment as member on (public) piece of content (--> success)
                                                                    checkAccess(bert, simon, simon, 'public', [], [contexts['simon'].user.id], function(err) {
                                                                        assert.ok(!err);
                                                                        // Delete other's comment as member on (public) piece of content (--> fail)
                                                                        checkAccess(bert, bert, simon, 'public', [], [contexts['simon'].user.id], function(err) {
                                                                            assert.ok(err);
                                                                            // Delete own comment as logged in on (public) piece of content (--> success)
                                                                            checkAccess(bert, simon, simon, 'public', [], [], function(err) {
                                                                                assert.ok(!err);
                                                                                // Delete comment as anonymous on (public) piece of content (--> fail)
                                                                                checkAccess(bert, bert, anonymousRestContext, 'public', [], [], function(err) {
                                                                                    assert.ok(err);
                                                                                    callback();
                                                                                });
                                                                            });
        ...
        /**
         * Test that will verify create access to content and comments
         */
        it('verify create comment access', function(callback) {
            setUpUsers(function(contexts) {
                // Comment as manager on (private) piece of content (--> success)
                RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 1', 'Test content description 1', 'private', 'http://www.sakaiproject.org/', [], [], function(err, contentObj) {
                    assert.ok(!err);
                    assert.ok(contentObj.contentId);

                    RestAPI.Content.createComment(contexts['bert'].restContext, contentObj.contentId, 'This is a comment as a manager of a private content item', function(err) {
                        assert.ok(!err);

                        // Comment as member on (private) piece of content (--> success)
                        RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 2', 'Test content description 2', 'private', 'http://www.sakaiproject.org/', [contexts['simon'].user.id], [contexts['nicolaas'].user.id], function(err, contentObj) {
                            assert.ok(!err);
                            assert.ok(contentObj.contentId);

                            RestAPI.Content.createComment(contexts['nicolaas'].restContext, contentObj.contentId, 'This is Nico\'s comment as a member of a private content item', function(err) {
                                assert.ok(!err);

                                RestAPI.Content.createComment(contexts['simon'].restContext, contentObj.contentId, 'This is Simon\'s comment as an added manager of a private content item', function(err) {
                                    assert.ok(!err);

                                    // Comment as logged in user on private piece of content (--> fail)
                                    RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 3', 'Test content description 3', 'private', 'http://www.sakaiproject.org/', [], [], function(err, contentObj) {
                                        assert.ok(!err);
                                        assert.ok(contentObj.contentId);

                                        RestAPI.Content.createComment(contexts['nicolaas'].restContext, contentObj.contentId, 'This is Nico\'s comment on a private content item', function(err) {
                                            assert.ok(err);
                                            assert.equal(err.code, 401);

                                            // Comment as anonymous on private piece of content (--> fail)
                                            RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 4', 'Test content description 4', 'private', 'http://www.sakaiproject.org/', [], [], function(err, contentObj) {
                                                assert.ok(!err);
                                                assert.ok(contentObj.contentId);

                                                RestAPI.Content.createComment(anonymousRestContext, contentObj.contentId, 'This is Nico\'s comment as a member of a private content item', function(err) {
                                                    assert.ok(err);
                                                    assert.equal(err.code, 401);

                                                    // Comment as logged in user on logged in piece of content (--> success)
                                                    RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 5', 'Test content description 5', 'loggedin', 'http://www.sakaiproject.org/', [], [], function(err, contentObj) {
                                                        assert.ok(!err);
                                                        assert.ok(contentObj.contentId);

                                                        RestAPI.Content.createComment(contexts['nicolaas'].restContext, contentObj.contentId, 'This is Nico\'s comment on a loggedin content item', function(err) {
                                                            assert.ok(!err);

                                                            // Comment as anonymous user on logged in piece of content (--> fail)
                                                            RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 6', 'Test content description 6', 'loggedin', 'http://www.sakaiproject.org/', [], [], function(err, contentObj) {
                                                                assert.ok(!err);
                                                                assert.ok(contentObj.contentId);

                                                                RestAPI.Content.createComment(anonymousRestContext, contentObj.contentId, 'This is an anonymous comment on a loggedin content item', function(err) {
                                                                    assert.ok(err);
                                                                    assert.equal(err.code, 401);

                                                                    // Comment as logged in user on public content (--> success)
                                                                    RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 7', 'Test content description 7', 'loggedin', 'http://www.sakaiproject.org/', [], [], function(err, contentObj) {
                                                                        assert.ok(!err);
                                                                        assert.ok(contentObj.contentId);

                                                                        RestAPI.Content.createComment(contexts['nicolaas'].restContext, contentObj.contentId, 'This is Nico\'s comment on a public content item', function(err) {
                                                                            assert.ok(!err);

                                                                            // Comment as anonymous user on public content (--> fail)
                                                                            RestAPI.Content.createLink(contexts['bert'].restContext, 'Test Content 8', 'Test content description 8', 'loggedin', 'http://www.sakaiproject.org/', [], [], function(err, contentObj) {
                                                                                assert.ok(!err);
                                                                                assert.ok(contentObj.contentId);

                                                                                RestAPI.Content.createComment(anonymousRestContext, contentObj.contentId, 'This is an anonymous comment on a public content item', function(err) {
                                                                                    assert.ok(err);
                                                                                    assert.equal(err.code, 401);
                                                                                    callback();
                                                                                });
