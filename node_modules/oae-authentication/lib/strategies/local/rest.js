...
var _handleCreateTenantAdminUser = function(req, res) {
    ...
    var opts = _getGlobalAdminOptParameters(req.body);
...
OAE.tenantRouter.on('post', '/api/auth/createTenantAdminUser', _handleCreateTenantAdminUser);
 ...
 * @api private
 */
var _getGlobalAdminOptParameters = function(parameters) {
    return {
        'email': parameters.email,
        'locale': parameters.locale || req.ctx.locale(),
