...
/**
 * Posts a comment on the specified content item
 */
var postComment = module.exports.postComment = function(ctx, contentId, comment, callback) {
    callback = callback || function() {};

    // Verify that this user can place comments on the content item
...
var getComments = module.exports.getComments = function(ctx, contentId, start, limit, callback) {
    ...
    //Cassandra.runQuery('SELECT * FROM Comments USING CONSISTENCY QUORUM WHERE contentId = ?', [contentId], function (err, pagedRows) {
        ...
        //Cassandra.runQuery('SELECT FIRST ' + paging.limit + ' ?..\'\' FROM CommentsByCommentId USING CONSISTENCY QUORUM WHERE commentId IN (?)', [paging.start, commentIds], function (err, detailRows) {
