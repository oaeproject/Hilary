...
var markNotificationsRead = module.exports.markNotificationsRead = function(userId, callback) {
    ...
    ActivityDAO.clearNotificationsUnreadCount(userId, function(err) {
        ...
        PrincipalsDAO.updatePrincipal(userId, profileFields, function(err) {
            ...
            // Remove any activities in this user's email activity stream (if any)
            var emailActivityStreamId = ActivityUtil.createActivityStreamId(userId, 'email');
            ActivityDAO.clearActivityStream(emailActivityStreamId, function(err) {
                if (err) {
                    log().error({'err': err}, 'Could not clear the activity stream');
                    return callback(err);
                }
                ...
                var notificationActivityStreamId = ActivityUtil.createActivityStreamId(userId, 'notification');
