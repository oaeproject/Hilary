...
describe('Search', function() {
    ...
    before(function(callback) {
        ...
        // Prep the preview processor if it's enabled
    ...
    describe('Indexing', function() {
        ...
        it('verify full-text indexing of pdf', function(callback) {
            ...
            ConfigTestUtil.updateConfigAndWait(globalAdminRestContext, 'admin', {'oae-content/storage/backend': 'test'}, function(err) {
                ...
                _createContentAndWait(pdfStream, function(restCtx, content) {
                    // Verify we can find the content from text in the body of the PDF
                    SearchTestsUtil.searchAll(restCtx, 'general', null, {'resourceTypes': 'content', 'q': 'b4c3f09e74f58b0aeee34d9c3cd9333a'}, function(err, results) {
                        assert.ok(!err);
