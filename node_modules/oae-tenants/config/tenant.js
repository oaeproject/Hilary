...
var _createBlock = function(opts) {
  ...
  return {
    ...
    elements: {
      ...
      xs: new Fields.List(
        'XS Block width',
        'Block width at extra small resolution',
        xs,
        widths,
        { suppress: true },
      ),
      sm: new Fields.List(
        'SM Block width',
        'Block width at small resolution',
        sm,
        widths,
        { suppress: true },
      ),
      md: new Fields.List(
        'MD Block width',
        'Block width at medium resolution',
        md,
        widths,
        { suppress: true },
      ),
      lg: new Fields.List(
        'LG Block width',
        'Block width at large resolution',
        lg,
        widths,
        { suppress: true },
      ),
      minHeight: new Fields.Text(
        'Block minimum height',
        'Minimum height for the block in px',
        opts.minHeight,
        { suppress: true },
      ),
      ...
      bgColor: new Fields.Text(
        'Block background color',
        'Background color for the block',
        opts.bgColor,
        { suppress: true },
      ),
      titleColor: new Fields.Text(
        'Block title color',
        'Title color for the block',
        opts.titleColor,
        { suppress: true },
      ),
      textColor: new Fields.Text(
        'Block text color',
      ...
      icon: new Fields.Text('Block icon', 'Icon for the block', opts.icon, {
        suppress: true,
      }),
      imgUrl: new Fields.Text('Image URL', 'Image URL', opts.imgUrl, {
        suppress: true,
      }),
      videoUrl: new Fields.Text('Video URL', 'Video URL', opts.videoUrl, {
        suppress: true,
      }),
