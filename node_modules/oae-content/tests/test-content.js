                ...
                RestAPI.Tenant.createTenant(globalAdminRestContext, tenantAliasB, tenantAliasB, tenantAliasB, function(err, tenantB) {
                    ...
                    RestAPI.User.createUser(restCtxB, usernameB, 'password', 'Private User', null, function(err, userB) {
                        ...
                        RestAPI.Content.createLink(restCtxB, 'Google', 'Google Website', 'loggedin', 'http://google.com', [userB.id], [], function(err, contentB) {
                            ...
                            RestAPI.Content.share(restCtxB, contentB.contentId, [ userA.id ], function(err) {
                                assert.ok(!err);
        ...
        it('verify user from private tenant cannot share to public external tenant', function(callback) {
            ...
            RestAPI.User.createUser(anonymousRestContext, usernameA, 'password', 'Public User', null, function(err, userA) {
                ...
                RestAPI.Tenant.createTenant(globalAdminRestContext, tenantAliasB, tenantAliasB, tenantAliasB, function(err, tenantB) {
                    ...
                    RestAPI.Config.setConfig(globalAdminRestContext, tenantAliasB, 'oae-tenants/tenantprivacy/tenantprivate', true, function(err) {
                        assert.ok(!err);
                    ...
                    RestAPI.Config.setConfig(globalAdminRestContext, tenantAliasB, 'oae-tenants/tenantprivacy/tenantprivate', true, function(err) {
                        ...
                        RestAPI.User.createUser(restCtxB, usernameB, 'password', 'Private User', null, function(err, userB) {
                            ...
                            RestAPI.Content.createLink(restCtxA, 'Google', 'Google Website', 'loggedin', 'http://google.com', [ userA.id ], [], function(err, contentA) {
                                ...
                                RestAPI.Content.share(restCtxA, contentA.contentId, [ userB.id ], function(err) {
                                    assert.ok(err);
                                    assert.ok(err.code, 401);
