...
describe('Authentication', function() {
    ...
    describe('Google authentication', function() {
         ...
         * @param  {Function}       callback    Standard callback function
         */
        var setGoogleDomains = function(domains, callback) {
            var configUpdate = {};
            configUpdate['oae-authentication/google/domains'] = domains;
            ConfigTestUtil.updateConfigAndWait(globalAdminRestContext, global.oaeTests.tenants.localhost.alias, configUpdate, function(err) {
                assert.ok(!err);
            });
         ...
         */
        var mockGoogleSignInRequests = function(email) {
         ...
         * @param  {Function}   callback            Standard callback function
         */
        var assertGoogleLogin = function(email, expectSuccess, callback) {
            // Mock the requests the google passport strategy will make
            mockGoogleSignInRequests(email);
        ...
        it('verify authentication can be scoped to a set of domains', function(callback) {
            _enableStrategy('google', function(done) {
                ...
                // Try with no domains
                setGoogleDomains('', function() {
                    assertGoogleLogin('simon@foo.com', true, function() {
                        assertGoogleLogin('simon@bar.com', true, function() {
                            assertGoogleLogin('simon@baz.com', true, function() {

                                // Try with a single domain
                                setGoogleDomains('foo.com', function() {
                                    assertGoogleLogin('simon@foo.com', true, function() {
                                        assertGoogleLogin('simon@bar.com', false, function() {
                                            assertGoogleLogin('simon@baz.com', false, function() {

                                                // Try with multiple domains
                                                setGoogleDomains('foo.com,bar.com', function() {
                                                    assertGoogleLogin('simon@foo.com', true, function() {
                                                        assertGoogleLogin('simon@bar.com', true, function() {
                                                            assertGoogleLogin('simon@baz.com', false, function() {

                                                                // Try with multiple domains and trailing spaces
                                                                setGoogleDomains('foo.com, bar.com', function() {
                                                                    assertGoogleLogin('simon@foo.com', true, function() {
                                                                        assertGoogleLogin('simon@bar.com', true, function() {
                                                                            assertGoogleLogin('simon@baz.com', false, function() {
