...
describe('Content Activity', function() {
  ...
  before(function(callback) {
    ...
    anonymousGtRestContext = TestsUtil.createTenantRestContext(
    ...
    suitableFiles = {
      'file.small.jpg': getFunctionThatReturnsFileStream(
        'apereo-conference-2013.jpeg',
      ),
  ...
  var _setup = function(callback) {
    ...
    TestsUtil.generateTestUsers(camAdminRestContext, 7, function(
      ...
      TestsUtil.generateTestGroups(simong.restContext, 2, function(
        groupA,
        groupB,
      ) {
                  ...
                  function(err, bertComment) {
                    ...
                    ActivityTestsUtil.collectAndGetActivityStream(
                      ...
                      function(err, activityStream) {
                        ...
                        assert.equal(
                          activityStream.items[0].object['oae:collection']
                            .length,
                          2,
                        );
                        callback();
                  ...
                  function(err, mrvisserComment) {
                    ...
                    ActivityTestsUtil.collectAndGetActivityStream(
                      ...
                      function(err, activityStream) {
                        ...
                        assert.ok(
                          activityStream.items[0].object.author.image.url,
                        );
                        assert.ok(
                          activityStream.items[0].object.author.image.url.indexOf(
                            'expired',
                          ) === -1,
                        );
                        callback();
            ...
            RestAPI.Content.joinCollabDoc(
              ...
              function(err, data) {
                ...
                etherpadClient.setText(args, function(err) {
                  assert.ok(!err);
                  ContentTestUtil.publishCollabDoc(
                    contentObj.id,
                    branden.user.id,
                    function() {
                      ...
                      ActivityTestsUtil.collectAndGetActivityStream(
                        ...
                        function(err) {
                          ...
                          var activityStreamId = util.format(
                            '%s#activity',
                            branden.user.id,
                          );
                          Cassandra.runQuery(
                    ...
                    ContentTestUtil.publishCollabDoc(
                      ...
                      function() {
                        ...
                        EmailTestsUtil.collectAndFetchAllEmails(function(
                          ...
                          assert.notEqual(
                            simonEmail.html.indexOf(contentObj.profilePath),
                            -1,
                          );
                          ...
                          assert.notEqual(
                            nicoEmail.html.indexOf(contentObj.profilePath),
                            -1,
                          );

                          // No email should have been sent to Branden
                          var brandenEmail = _getEmail(
                            emails,
                            branden.user.email,
                          );
                            ...
                            function(err, data) {
                              ...
                              ActivityTestsUtil.collectAndGetNotificationStream(
                                ...
                                function(err, data) {
                                  ...
                                  assert.equal(
                                    notificationNico['actor']['oae:id'],
                                    branden.user.id,
                                  );
                                  assert.equal(
                                    notificationNico['object']['oae:id'],
                                    contentObj.id,
                                  );
                        ...
                        function(err, data) {
                          ...
                          RestAPI.Content.getRevision(
                            ...
                            function(err, revision) {
                              ...
                              assert.ok(
                                revision.etherpadHtml.indexOf(args.text) > -1,
                              );
                              return callback();
                            },
                          );
                        ...
                        RestAPI.Content.createComment(
                          ...
                          function(err, commentA) {
                            ...
                            ActivityTestsUtil.collectAndGetNotificationStream(
                              ...
                              function(err, activityStream) {
                                assert.ok(!err);
                                var commentActivities = _.filter(
  ...
  describe('Activity Entity Models', function() {
    ...
    it('verify the content entity model contains the correct content information', function(callback) {
      ...
      var _assertStandardLinkModel = function(entity, contentId) {
        ...
        assert.equal(
          entity['oae:profilePath'],
          '/content/camtest/' + resourceId,
        );
                        ...
                        ActivityTestsUtil.collectAndGetActivityStream(
                          ...
                          function(err, activityStream) {
                            ...
                            var _validateComment = function(
                              ...
                              assert.equal(
                                entity['oae:messageBoxId'],
                                comment.messageBoxId,
                              );
                              assert.equal(
                                entity['oae:threadKey'],
                                comment.threadKey,
                              );
                            ...
                            activity.object['oae:collection'].forEach(function(
                              entity,
                            ) {
              ...
              function(err, yahooLink) {
                ...
                ActivityTestsUtil.collectAndGetActivityStream(
                  ...
                  function(err, activityStream) {
                    ...
                    if (
                      aggregate.object['oae:collection'][0]['oae:id'] ===
                        googleLink.id &&
                      aggregate.object['oae:collection'][1]['oae:id'] ===
                        yahooLink.id
                    ) {
                          ...
                          function(err, activityStream) {
                            ...
                            assert.equal(
                              ...
                              '/user/' +
                                ...
                                '/' +
                                AuthzUtil.getResourceFromId(jack.user.id)
                                  .resourceId,
                            );
                              ...
                              function(err, activityStream) {
                                ...
                                assert.equal(
                                  ...
                                  '/content/' +
                                    link.tenant.alias +
                                    '/' +
                                    AuthzUtil.getResourceFromId(link.id)
                                      .resourceId,
                                );
                                assert.equal(
                                  activity.target['oae:id'],
                                ...
                                assert.equal(
                                  ...
                                  '/user/' +
                                    ...
                                    '/' +
                                    AuthzUtil.getResourceFromId(jane.user.id)
                                      .resourceId,
                                );
                ...
                RestAPI.Content.createComment(
                  ...
                  function(err, simongComment) {
                    ...
                    EmailTestsUtil.collectAndFetchAllEmails(function(messages) {
                      ...
                      assert.notEqual(
                        stringEmail.indexOf(link.profilePath),
                        -1,
                      );
                      assert.notEqual(
                        stringEmail.indexOf(link.displayName),
                        -1,
                      );

                      // Ensure simong's private info is *nowhere* to be found
                      assert.equal(
                        stringEmail.indexOf(simong.user.displayName),
                        -1,
                      );
                      ...
                      RestAPI.Content.createComment(
                        ...
                        function(err, nicolaasComment) {
                          ...
                          EmailTestsUtil.collectAndFetchAllEmails(function(
                            ...
                            assert.ok(
                              _.contains(emailAddresses, simong.user.email),
                            );
                            assert.ok(
                              _.contains(emailAddresses, mrvisser.user.email),
                            );
                            return callback();
                          });
                        },
                  ...
                  RestAPI.Content.shareContent(
                    ...
                    function(err) {
                      ...
                      EmailTestsUtil.collectAndFetchAllEmails(function(
                        ...
                        assert.equal(
                          stringEmail.indexOf(simong.user.email),
                          -1,
                        );
                        assert.equal(
                          stringEmail.indexOf(simong.user.locale),
                          -1,
                        );
