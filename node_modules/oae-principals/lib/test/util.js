...
/**
 * Download log creation date
 *
 * @return {Object}                An object containing the entity data that can be transformed into a UI group activity entity
 */
var getLogCreation = module.exports.getLogCreation = function(camAdminRestContext, tenantAlias, callback) {
    PrincipalsAPI.getLogCreation(camAdminRestContext, tenantAlias, function(err, log) {
        assert.ok(!err);
        assert.ok(log);
        csvToJson(log, function(obj) {
 ...
 * @return {Object}                 An object containing the entity data that can be transformed into a UI group activity entity
 */
var getLog = module.exports.getLog = function(camAdminRestContext, num, tenantAlias, callback) {
    PrincipalsAPI.getLog(camAdminRestContext, num, tenantAlias, function(err, log) {
        assert.ok(!err);
        assert.ok(log);
        csvToJson(log, function(obj) {
            return callback(null, obj);
