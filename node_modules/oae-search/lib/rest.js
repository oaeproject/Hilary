 ...
 * @PathParam   {string}                searchType          The type of search to execute       [followers,following,general,members]
 * @QueryParam  {number}                [limit]             Maximum number of documents to return (defaults to 10)
 * @QueryParam  {string}                [q]                 Search phrase
 * @QueryParam  {string[]}              [resourceTypes]     Type of resources to search [all,user,group,content,discussion]
 * @QueryParam  {string}                scope               Scope of the search, defaults to _network [_all,_interact,_network,_tenant]
 * @QueryParam  {string}                [sort]              Sort direction (defaults to asc) [asc,desc]
 * @QueryParam  {number}                [start]             Index at which to start (defaults to 0)
