...
var generatePreviews = module.exports.generatePreviews = function(ctx, contentObj, callback) {
    ...
    request(options, function(err, response) {
        ...
        var generateThumbnail = function() {
            var bareContentType = contentType.split(';')[0];
            if (bareContentType === 'text/html' || bareContentType.substring(0, 6) === 'image/') {
                ...
                log().info({'contentId': ctx.contentId, 'msg': 'Skipping screenshot of unsupported type'});
                callback();
            }
        };
