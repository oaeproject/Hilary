                ...
                RestAPI.User.getMe(jack.restContext, function(err, me) {
                    ...
                    RestAPI.Authentication.logout(jack.restContext, function(err, body, response) {
                        ...
                        RestAPI.User.getMe(jack.restContext, function(err, me) {
                            ...
                            AuthenticationAPI.emitter.once(AuthenticationConstants.events.REFRESHED_STRATEGIES, function(tenant) {
                ...
                RestAPI.Authentication.logout(userRestContext, function(err, body, response) {
                    ...
                    RestAPI.Authentication.getResetPasswordSecret(anonymousCamRestContext, username, function(err, body, response) {
                        ...
                        Cassandra.runQuery('SELECT "secret" FROM "AuthenticationLoginId" WHERE "loginId" = ?', [loginId.tenantAlias + ':' + loginId.provider + ':' + loginId.externalId], function(err, rows) {
                            ...
                            var newPassword = '';
                            RestAPI.Authentication.resetPassword(anonymousCamRestContext, username, secret, newPassword, function(err) {
                                assert.ok(err);
                                assert.equal(err.code, 400);
