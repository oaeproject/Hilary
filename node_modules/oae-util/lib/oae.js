...
module.exports.init = function(config, callback) {
  ...
  process.on('SIGTERM', function() {
    Shutdown.shutdown(
      PRESHUTDOWN_DEFAULT_TIMEOUT_MILLIS,
      SHUTDOWN_GRACE_TIME_MILLIS,
    );
  });

  // Start up the global and tenant servers
  var globalAdminServer = (module.exports.globalAdminServer = Server.setupServer(
    config.servers.globalAdminPort,
    config,
  ));
  var tenantServer = (module.exports.tenantServer = Server.setupServer(
    config.servers.tenantPort,
    config,
  ));
  var tenantRouter = (module.exports.tenantRouter = Server.setupRouter(
    tenantServer,
  ));
  var globalAdminRouter = (module.exports.globalAdminRouter = Server.setupRouter(
    globalAdminServer,
  ));
  ...
  Modules.bootstrapModules(config, function(err) {
    ...
    Server.postInitializeServer(
      module.exports.globalAdminServer,
      module.exports.globalAdminRouter,
    );
    Server.postInitializeServer(
      module.exports.tenantServer,
 ...
 */
var registerPreShutdownHandler = (module.exports.registerPreShutdownHandler = function(
  name,
  maxTimeMillis,
  handler,
) {
