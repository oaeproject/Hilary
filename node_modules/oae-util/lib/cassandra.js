 ...
 */
let runAutoPagedQuery = module.exports.runAutoPagedQuery = function(query, parameters, callback) {
    ...
    let rows = [];
    client.stream(query, parameters, { prepare: true })
            ...
            if (!returnKeyColumn) {
                ...
                _.each(row.keys(), (eachKey) => {
                    if (eachKey !== keyColumnName) {
                        newRowContent.push({ key: eachKey, value: row.get(eachKey),
